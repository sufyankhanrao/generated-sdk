...
from shelldigitalpayments.http.proxy_settings import (
    ProxySettings,
)
...
class Configuration(HttpClientConfiguration):
    ...
    def mpp_token_credentials(self):
        """Return current mpp_token_credentials."""
        return self._mpp_token_credentials

    @property
    def o_auth_token_post_credentials(self):
        """Return current o_auth_token_post_credentials."""
    ...
    def clone_with(self, http_client_instance=None,
                   ...
                   retry_statuses=None, retry_methods=None, proxy_settings=None,
                   environment=None, mpp_token_credentials=None,
                   o_auth_token_post_credentials=None):
        ...
        o_auth_token_post_credentials =\
            (o_auth_token_post_credentials
            or self.o_auth_token_post_credentials)
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        default_config = cls(
            ...
            mpp_token_credentials=MppTokenCredentials.from_environment(),
            o_auth_token_post_credentials=OAuthTokenPostCredentials.from_environment(),
        )
