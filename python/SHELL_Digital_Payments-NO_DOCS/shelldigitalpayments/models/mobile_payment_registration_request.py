...
from shelldigitalpayments.models.collecting_company import (
    CollectingCompany,
)
...
class MobilePaymentRegistrationRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a MobilePaymentRegistrationRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        reference_id =\
            ...
            if dictionary.get("referenceId") else None
        pan = dictionary.get("pan") if dictionary.get("pan") else None
        pan_expiry =\
            dictionary.get("panExpiry")\
            if dictionary.get("panExpiry") else None
        ...
        payer_id =\
            ...
            if dictionary.get("PayerId") else None
        col_co_id =\
        ...
        if dictionary.get("CollectingCompanies") is not None:
            collecting_companies = [
                CollectingCompany.from_dictionary(x)
