...
class OauthTokenPostRequestBody(object):
    ...
    def __init__(self,
        ...
        """Initialize a OauthTokenPostRequestBody instance."""
    ...
    def from_dictionary(cls,
        ...
        grant_type =\
            ...
            if dictionary.get("grant_type") else "client_credentials"
        client_id =\
            dictionary.get("client_id")\
            if dictionary.get("client_id") else "SOFflRakNlwnWlxfOXQ4GHDVyqGawuKA"
        client_secret =\
            dictionary.get("client_secret")\
            if dictionary.get("client_secret") else "cRnWgw7gACqM3gVS"
