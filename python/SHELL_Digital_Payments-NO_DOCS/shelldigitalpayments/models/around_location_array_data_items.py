...
from shelldigitalpayments.models.around_location_array_data_items_loc import (
    AroundLocationArrayDataItemsLoc,
)
from shelldigitalpayments.models.around_location_array_data_items_opening_hours_items import (  # noqa: E501
...
class AroundLocationArrayDataItems(object):
    ...
    def __init__(self,
        ...
        """Initialize a AroundLocationArrayDataItems instance."""
    ...
    def from_dictionary(cls,
        ...
        loc = AroundLocationArrayDataItemsLoc.from_dictionary(
            dictionary.get("loc"))\
            if dictionary.get("loc") else None
        mpp_station_id =\
            dictionary.get("mpp_station_id")\
            if dictionary.get("mpp_station_id") else None
        double_site_id =\
            dictionary.get("double_site_id")\
            if dictionary.get("double_site_id") else APIHelper.SKIP
        opening_hours = None
        if dictionary.get("opening_hours") is not None:
            opening_hours = [
                AroundLocationArrayDataItemsOpeningHoursItems.from_dictionary(x)
                    for x in dictionary.get("opening_hours")
            ]
        else:
            opening_hours = APIHelper.SKIP
        telephone =\
            dictionary.get("telephone")\
            if dictionary.get("telephone") else APIHelper.SKIP
        authorisation_code =\
            dictionary.get("authorisation_code")\
            if dictionary.get("authorisation_code") else APIHelper.SKIP
        mp_preauth =\
            dictionary.get("mp_preauth")\
            if dictionary.get("mp_preauth") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"double_site_id={(self.double_site_id
                     if hasattr(self, 'double_site_id') else None)!r}, "
                ...
                f"mp_preauth={(self.mp_preauth
                     if hasattr(self, 'mp_preauth') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"double_site_id={(self.double_site_id
                     if hasattr(self, 'double_site_id') else None)!s}, "
                f"opening_hours={(self.opening_hours
                ...
                f"mp_preauth={(self.mp_preauth
                     if hasattr(self, 'mp_preauth') else None)!s})")
