...
class PrepareFuelingRequestDeviceDetailsItems(object):
    ...
    def __init__(self,
        ...
        """Initialize a PrepareFuelingRequestDeviceDetailsItems instance."""
    ...
    def from_dictionary(cls,
        ...
        os_version =\
            ...
            if dictionary.get("osVersion") else APIHelper.SKIP
        other_device_information =\
            dictionary.get("otherDeviceInformation")\
            if dictionary.get("otherDeviceInformation") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"os_version={(self.os_version
                     if hasattr(self, 'os_version') else None)!r}, "
                f"other_device_information={(self.other_device_information
                     if hasattr(self, 'other_device_information') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"os_version={(self.os_version
                     if hasattr(self, 'os_version') else None)!s}, "
                f"other_device_information={(self.other_device_information
                     if hasattr(self, 'other_device_information') else None)!s})")
