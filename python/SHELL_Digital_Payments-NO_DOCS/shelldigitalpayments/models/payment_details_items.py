...
from shelldigitalpayments.models.payment_properties import (
    PaymentProperties,
)
...
class PaymentDetailsItems(object):
    ...
    def __init__(self,
        ...
        """Initialize a PaymentDetailsItems instance."""
    ...
    def from_dictionary(cls,
        ...
        payment_method_id =\
            ...
            if dictionary.get("paymentMethodId") else None
        payment_properties = PaymentProperties.from_dictionary(
            dictionary.get("paymentProperties"))\
            if dictionary.get("paymentProperties") else None
        payment_category =\
            dictionary.get("paymentCategory")\
            if dictionary.get("paymentCategory") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"payment_category={(self.payment_category
                     if hasattr(self, 'payment_category') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"payment_category={(self.payment_category
                     if hasattr(self, 'payment_category') else None)!s}, "
