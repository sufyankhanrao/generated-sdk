...
class FinaliseFuelingRequestPayment(object):
    ...
    def __init__(self,
        ...
        """Initialize a FinaliseFuelingRequestPayment instance."""
    ...
    def from_dictionary(cls,
        ...
        card_last_digits =\
            dictionary.get("cardLastDigits")\
            if dictionary.get("cardLastDigits") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"card_last_digits={(self.card_last_digits
                     if hasattr(self, 'card_last_digits') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"card_last_digits={(self.card_last_digits
                     if hasattr(self, 'card_last_digits') else None)!s})")
