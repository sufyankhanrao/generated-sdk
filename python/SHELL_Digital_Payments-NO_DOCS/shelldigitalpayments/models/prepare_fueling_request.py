...
from shelldigitalpayments.models.loyalty_details import (
    LoyaltyDetails,
)
from shelldigitalpayments.models.payment_details_items import (
    PaymentDetailsItems,
)
from shelldigitalpayments.models.prepare_fueling_request_device_details_items import (
...
class PrepareFuelingRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a PrepareFuelingRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        latitude =\
            ...
            if dictionary.get("latitude") else None
        longitude =\
            dictionary.get("longitude")\
            if dictionary.get("longitude") else None
        station_id =\
            dictionary.get("stationId")\
            if dictionary.get("stationId") else None
        pump_id = dictionary.get("pumpId") if dictionary.get("pumpId") else None
        source_application =\
            dictionary.get("sourceApplication")\
            if dictionary.get("sourceApplication") else None
        payment_details = None
        if dictionary.get("paymentDetails") is not None:
            payment_details = [
                PaymentDetailsItems.from_dictionary(x)
                    for x in dictionary.get("paymentDetails")
            ]
        maximum_fueling_amount =\
            dictionary.get("maximumFuelingAmount")\
            if dictionary.get("maximumFuelingAmount") else APIHelper.SKIP
        loyalty_details = None
        if dictionary.get("loyaltyDetails") is not None:
            loyalty_details = [
                LoyaltyDetails.from_dictionary(x)
                    for x in dictionary.get("loyaltyDetails")
            ]
        else:
            loyalty_details = APIHelper.SKIP
        device_type =\
        ...
        if dictionary.get("deviceDetails") is not None:
            device_details = [
                PrepareFuelingRequestDeviceDetailsItems.from_dictionary(x)
                    for x in dictionary.get("deviceDetails")
            ]
        else:
            device_details = APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"maximum_fueling_amount={(self.maximum_fueling_amount
                     if hasattr(self, 'maximum_fueling_amount') else None)!r}, "
                f"station_id={self.station_id!r}, "
                f"pump_id={self.pump_id!r}, "
                f"loyalty_details={(self.loyalty_details
                     if hasattr(self, 'loyalty_details') else None)!r}, "
                ...
                f"device_details={(self.device_details
                     if hasattr(self, 'device_details') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"maximum_fueling_amount={(self.maximum_fueling_amount
                     if hasattr(self, 'maximum_fueling_amount') else None)!s}, "
                f"station_id={self.station_id!s}, "
                f"pump_id={self.pump_id!s}, "
                f"loyalty_details={(self.loyalty_details
                     if hasattr(self, 'loyalty_details') else None)!s}, "
                ...
                f"device_details={(self.device_details
                     if hasattr(self, 'device_details') else None)!s})")
