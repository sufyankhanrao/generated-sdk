...
from shelldigitalpayments.exceptions.station_locator_bad_request_exception import (
    StationLocatorBadRequestException,
)
from shelldigitalpayments.exceptions.station_locator_forbidden_exception import (
    StationLocatorForbiddenException,
)
from shelldigitalpayments.exceptions.station_locator_internal_server_error_exception import (  # noqa: E501
    StationLocatorInternalServerErrorException,
)
from shelldigitalpayments.exceptions.station_locator_not_found_exception import (
    StationLocatorNotFoundException,
)
from shelldigitalpayments.exceptions.station_locator_unauthorized_exception import (
    StationLocatorUnauthorizedException,
)
from shelldigitalpayments.http.http_method_enum import (
    HttpMethodEnum,
)
from shelldigitalpayments.models.around_location_array import (
    AroundLocationArray,
)
...
class StationLocatorController(BaseController):
    ...
    def __init__(self, config):
        """Initialize StationLocatorController object."""
    ...
    def stationlocator_v_1_stations_get_around_location(self,
                                                        ...
                                                        amenities=None,
                                                        countries=None):
        """Perform a GET request to /SiteData/v1/stations/.
