...
from shelldigitalpayments.controllers.digital_payment_enablement_controller import (
    DigitalPaymentEnablementController,
)
from shelldigitalpayments.controllers.fueling_controller import (
    FuelingController,
)
from shelldigitalpayments.controllers.partner_notification_controller import (
    PartnerNotificationController,
)
from shelldigitalpayments.controllers.shell_api_platform_security_authentication_controller import (  # noqa: E501
    ShellAPIPlatformSecurityAuthenticationController,
)
from shelldigitalpayments.controllers.station_locator_controller import (
    StationLocatorController,
)
from shelldigitalpayments.http.auth.mpp_token import (
    MppToken,
)
from shelldigitalpayments.http.auth.o_auth_token_post import (
    OAuthTokenPost,
)


class ShellDigitalPaymentsClient(object):
    """Client that provide access to the ShellDigitalPaymentsClient APIs."""

    @LazyProperty
    def shell_api_platform_security_authentication(self):
        """Provide access to the
        ShellAPIPlatformSecurityAuthenticationController endpoints.
        """
        return ShellAPIPlatformSecurityAuthenticationController(self.global_configuration)

    @LazyProperty
    def digital_payment_enablement(self):
        """Provide access to the DigitalPaymentEnablementController endpoints."""
        return DigitalPaymentEnablementController(self.global_configuration)

    @LazyProperty
    def station_locator(self):
        """Provide access to the StationLocatorController endpoints."""
        return StationLocatorController(self.global_configuration)

    @LazyProperty
    def fueling(self):
        """Provide access to the FuelingController endpoints."""
        return FuelingController(self.global_configuration)

    @LazyProperty
    def partner_notification(self):
        """Provide access to the PartnerNotificationController endpoints."""
    ...
    def __init__(self, http_client_instance=None,
        ...
        """Initialize a new instance of ShellDigitalPaymentsClient."""
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        Returns:
            ShellDigitalPaymentsClient instance.
