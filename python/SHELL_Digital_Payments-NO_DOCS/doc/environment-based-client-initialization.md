...
client = ShellDigitalPaymentsClient.from_environment(
...
MPP_TOKEN_AUTHORIZATION=ExampleAuthorization
O_AUTH_TOKEN_POST_X_APIGEE_AUTHORIZATION=ExampleXApigeeAuthorization
