...
from typecombinatorglobal.http.proxy_settings import (
    ProxySettings,
)
...
class Configuration(HttpClientConfiguration):
    ...
    def clone_with(self, http_client_instance=None,
                   ...
                   environment=None, port=None, sub_url=None):
        ...
        return Configuration(
            ...
            environment=environment, port=port, sub_url=sub_url,
        )
    ...
    environments = {
        Environment.PRODUCTION: {
            Server.DEFAULT: "http://localhost:{port}/{subUrl}",
        },
    }
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        sub_url = os.getenv("SUB_URL", "multitype/global")
