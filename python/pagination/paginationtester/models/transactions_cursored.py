...
class TransactionsCursored(object):
    ...
    def __init__(self,
        ...
        """Initialize a TransactionsCursored instance."""
    ...
    def from_dictionary(cls,
        ...
        next_cursor =\
            ...
            if "nextCursor" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"next_cursor={(self.next_cursor
                     if hasattr(self, 'next_cursor') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"next_cursor={(self.next_cursor
                     if hasattr(self, 'next_cursor') else None)!s})")
