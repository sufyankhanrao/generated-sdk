...
from paginationtester.configuration import (
    Configuration,
    Environment,
)
...
from paginationtester.controllers.transaction_controller import (
    TransactionController,
)


class PaginationtesterClient(object):
    """Client that provide access to the PaginationtesterClient APIs."""
    ...
    def __init__(self, http_client_instance=None,
        ...
        """Initialize a new instance of PaginationtesterClient."""
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        Returns:
            PaginationtesterClient instance.
