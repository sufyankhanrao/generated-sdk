...
class TransactionController(BaseController):
    ...
    def fetch_with_offset(self,
        ...
        Args:
            offset (int, optional): The number of records to skip before selecting
                transactions.
            limit (int, optional): Number of transactions per page.
            success_on_empty_page (bool, optional): Should return 200 success code on
                the calls after the last batch of paginated data.

        Returns:
            PagedIterable: An instance of PagedIterable, to be used as an iterator.
                Paginated list of transactions (Offset-based)
    ...
    def fetch_with_cursor(self,
        ...
        Args:
            cursor (str, optional): The unique identifier (cursor) to fetch the next
                set of results.
            limit (int, optional): Number of transactions per page.
            success_on_empty_page (bool, optional): Should return 200 success code on
                the calls after the last batch of paginated data.
        ...
        Returns:
            PagedIterable: An instance of PagedIterable, to be used as an iterator.
                Paginated list of transactions (Cursor-based)
    ...
    def fetch_with_link(self,
        ...
        Returns:
            PagedIterable: An instance of PagedIterable, to be used as an iterator.
                Paginated list of transactions (Link-based)
    ...
    def fetch_with_page(self,
        ...
        Returns:
            PagedIterable: An instance of PagedIterable, to be used as an iterator.
                Paginated list of transactions (Page-based)
