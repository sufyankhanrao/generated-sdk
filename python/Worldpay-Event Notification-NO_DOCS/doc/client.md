...
## Enterprise API: Merchant Account Created Client
...
| Name | Description |
|  --- | --- |
| get_details_associated_with_a_merchant_created_notification | Gets GetDetailsAssociatedWithAMerchantCreatedNotificationController |
| complete_notification | Gets CompleteNotificationController |
