...
from enterpriseapimerchantaccountcreated.http.proxy_settings import (
    ProxySettings,
)
...
class Configuration(HttpClientConfiguration):
    ...
    environments = {
        Environment.PRODUCTION: {
            Server.DEFAULT: "https://apis.stage.worldpay.com/enterprise/eventnotifications/v2/notifications",
        },
    }
