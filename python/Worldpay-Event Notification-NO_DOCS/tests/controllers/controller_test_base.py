...
from enterpriseapimerchantaccountcreated.enterpriseapimerchantaccountcreated_client import (  # noqa: E501
    EnterpriseapimerchantaccountcreatedClient,
)
...
class ControllerTestBase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.client = EnterpriseapimerchantaccountcreatedClient(config=cls.config)
