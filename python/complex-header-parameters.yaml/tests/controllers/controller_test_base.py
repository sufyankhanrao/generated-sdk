...
from complexheaderparametersapi.complexheaderparametersapi_client import (
    ComplexheaderparametersapiClient,
)
...
class ControllerTestBase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.client = ComplexheaderparametersapiClient(config=cls.config)
