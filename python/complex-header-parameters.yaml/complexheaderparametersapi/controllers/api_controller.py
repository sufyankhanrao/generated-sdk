...
from complexheaderparametersapi.configuration import Server
from complexheaderparametersapi.http.api_response import ApiResponse
from complexheaderparametersapi.controllers.base_controller import BaseController
from complexheaderparametersapi.utilities.union_type_lookup import UnionTypeLookUp
from apimatic_core.request_builder import RequestBuilder
from apimatic_core.response_handler import ResponseHandler
from apimatic_core.types.parameter import Parameter
from complexheaderparametersapi.http.http_method_enum import HttpMethodEnum
from complexheaderparametersapi.models.success_response import SuccessResponse
...
class APIController(BaseController):
    ...
    def retrieve_checkout_order(self,
        ...
        """Does a GET request to /header/v2/checkout/orders.
    ...
    def submit_vehicle_information(self,
                                   vehicle_header):
        """Does a GET request to /header/vehicle.
    ...
    def submit_a_one_of_vehicle(self,
                                one_of_vehicle):
        """Does a GET request to /header/oneOfVehicles.
        ...
        return super().new_api_call_builder.request(
            ...
            .header_param(Parameter()
                          ...
                          .validator(lambda value: UnionTypeLookUp.get('OneOfVehicle').validate(value)))
            .header_param(Parameter()
                          .key('accept')
                          .value('application/json'))
        ).response(
    ...
    def submit_a_map_of_vehicles(self,
                                 map_of_vehicles):
        """Does a GET request to /header/vehiclesMap.
    ...
    def submit_an_array_of_vehicles(self,
                                    array_of_vehicles):
        """Does a GET request to /header/vehiclesArray.
