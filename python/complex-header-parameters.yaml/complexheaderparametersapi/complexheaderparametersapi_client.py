...
from complexheaderparametersapi.controllers.api_controller import (
    APIController,
)
...
class ComplexheaderparametersapiClient(object):
    """Client that provide access to the ComplexheaderparametersapiClient APIs."""
    ...
    def __init__(self, http_client_instance=None,
        ...
        """Initialize a new instance of ComplexheaderparametersapiClient."""
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        Returns:
            ComplexheaderparametersapiClient instance.
