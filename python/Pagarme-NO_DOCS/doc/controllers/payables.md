...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`ListPayablesResponse`](../../doc/models/list-payables-response.md).
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`GetPayableResponse`](../../doc/models/get-payable-response.md).
