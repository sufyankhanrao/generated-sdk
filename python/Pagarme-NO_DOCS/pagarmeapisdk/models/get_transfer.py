...
from pagarmeapisdk.models.get_transfer_source_response import (
    GetTransferSourceResponse,
)
from pagarmeapisdk.models.get_transfer_target_response import (
...
class GetTransfer(object):
    ...
    def __init__(self,
        ...
        """Initialize a GetTransfer instance."""
    ...
    def from_dictionary(cls,
        ...
        gateway_id =\
            ...
            if dictionary.get("gateway_id") else None
        ...
        source = GetTransferSourceResponse.from_dictionary(
            dictionary.get("source"))\
            if dictionary.get("source") else None
        target = GetTransferTargetResponse.from_dictionary(
        ...
        funding_date = APIHelper.RFC3339DateTime.from_value(
            ...
            if dictionary.get("funding_date") else APIHelper.SKIP
        funding_estimated_date = APIHelper.RFC3339DateTime.from_value(
            dictionary.get("funding_estimated_date")).datetime\
            if dictionary.get("funding_estimated_date") else APIHelper.SKIP
