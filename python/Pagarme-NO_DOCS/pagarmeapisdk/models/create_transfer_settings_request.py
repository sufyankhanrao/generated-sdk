...
class CreateTransferSettingsRequest(object):
    ...
    def __init__(self,
                 ...
                 transfer_day=None):
        """Initialize a CreateTransferSettingsRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        transfer_enabled =\
            ...
            if "transfer_enabled" in dictionary.keys() else None
        transfer_interval =\
            dictionary.get("transfer_interval")\
            if dictionary.get("transfer_interval") else None
        transfer_day =\
            dictionary.get("transfer_day")\
            if dictionary.get("transfer_day") else None
