...
class GetPayableResponse(object):
    ...
    def __init__(self,
        ...
        if original_payment_date is not APIHelper.SKIP:
            self.original_payment_date =\
                 APIHelper.apply_datetime_converter(
                original_payment_date, APIHelper.RFC3339DateTime) if original_payment_date else None
        ...
        if accrual_at is not APIHelper.SKIP:
            self.accrual_at =\
                 APIHelper.apply_datetime_converter(
                accrual_at, APIHelper.RFC3339DateTime) if accrual_at else None
    ...
    def from_dictionary(cls,
        ...
        anticipation_fee =\
            ...
            if "anticipation_fee" in dictionary.keys() else APIHelper.SKIP
        fraud_coverage_fee =\
        ...
        split_id =\
            ...
            if "split_id" in dictionary.keys() else APIHelper.SKIP
        bulk_anticipation_id =\
            dictionary.get("bulk_anticipation_id")\
            if "bulk_anticipation_id" in dictionary.keys() else APIHelper.SKIP
        anticipation_id =\
            dictionary.get("anticipation_id")\
            if "anticipation_id" in dictionary.keys() else APIHelper.SKIP
        recipient_id =\
            dictionary.get("recipient_id")\
            if "recipient_id" in dictionary.keys() else APIHelper.SKIP
        originator_model =\
            dictionary.get("originator_model")\
            if "originator_model" in dictionary.keys() else APIHelper.SKIP
        originator_model_id =\
            dictionary.get("originator_model_id")\
            if "originator_model_id" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"anticipation_fee={(self.anticipation_fee
                     if hasattr(self, 'anticipation_fee') else None)!r}, "
                ...
                f"split_id={(self.split_id
                     if hasattr(self, 'split_id') else None)!r}, "
                f"bulk_anticipation_id={(self.bulk_anticipation_id
                     if hasattr(self, 'bulk_anticipation_id') else None)!r}, "
                f"anticipation_id={(self.anticipation_id
                     if hasattr(self, 'anticipation_id') else None)!r}, "
                f"recipient_id={(self.recipient_id
                     if hasattr(self, 'recipient_id') else None)!r}, "
                f"originator_model={(self.originator_model
                     if hasattr(self, 'originator_model') else None)!r}, "
                f"originator_model_id={(self.originator_model_id
                     if hasattr(self, 'originator_model_id') else None)!r}, "
                f"payment_date={(self.payment_date
                     if hasattr(self, 'payment_date') else None)!r}, "
                f"original_payment_date={(self.original_payment_date
                     if hasattr(self, 'original_payment_date') else None)!r}, "
                f"mtype={(self.mtype if hasattr(self, 'mtype') else None)!r}, "
                f"payment_method={(self.payment_method
                     if hasattr(self, 'payment_method') else None)!r}, "
                f"accrual_at={(self.accrual_at
                     if hasattr(self, 'accrual_at') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"anticipation_fee={(self.anticipation_fee
                     if hasattr(self, 'anticipation_fee') else None)!s}, "
                f"fraud_coverage_fee={(self.fraud_coverage_fee
                ...
                f"split_id={(self.split_id
                     if hasattr(self, 'split_id') else None)!s}, "
                f"bulk_anticipation_id={(self.bulk_anticipation_id
                     if hasattr(self, 'bulk_anticipation_id') else None)!s}, "
                f"anticipation_id={(self.anticipation_id
                     if hasattr(self, 'anticipation_id') else None)!s}, "
                f"recipient_id={(self.recipient_id
                     if hasattr(self, 'recipient_id') else None)!s}, "
                f"originator_model={(self.originator_model
                     if hasattr(self, 'originator_model') else None)!s}, "
                f"originator_model_id={(self.originator_model_id
                     if hasattr(self, 'originator_model_id') else None)!s}, "
                f"payment_date={(self.payment_date
                     if hasattr(self, 'payment_date') else None)!s}, "
                f"original_payment_date={(self.original_payment_date
                     if hasattr(self, 'original_payment_date') else None)!s}, "
                f"mtype={(self.mtype if hasattr(self, 'mtype') else None)!s}, "
                f"payment_method={(self.payment_method
                     if hasattr(self, 'payment_method') else None)!s}, "
                f"accrual_at={(self.accrual_at
                     if hasattr(self, 'accrual_at') else None)!s}, "
                f"created_at={(self.created_at
