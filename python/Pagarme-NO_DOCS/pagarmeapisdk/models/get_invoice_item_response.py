...
class GetInvoiceItemResponse(object):
    ...
    def from_dictionary(cls,
        ...
        subscription_item_id =\
            ...
            if "subscription_item_id" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"price_bracket={(self.price_bracket
                     if hasattr(self, 'price_bracket') else None)!r}, "
                f"quantity={(self.quantity
                     if hasattr(self, 'quantity') else None)!r}, "
                f"name={(self.name if hasattr(self, 'name') else None)!r}, "
                f"subscription_item_id={(self.subscription_item_id
                     if hasattr(self, 'subscription_item_id') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"price_bracket={(self.price_bracket
                     if hasattr(self, 'price_bracket') else None)!s}, "
                f"quantity={(self.quantity
                     if hasattr(self, 'quantity') else None)!s}, "
                f"name={(self.name if hasattr(self, 'name') else None)!s}, "
                f"subscription_item_id={(self.subscription_item_id
                     if hasattr(self, 'subscription_item_id') else None)!s})")
