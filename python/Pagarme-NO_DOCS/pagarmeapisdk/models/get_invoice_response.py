...
class GetInvoiceResponse(object):
    ...
    def __init__(self,
        ...
        if billing_at is not APIHelper.SKIP:
            self.billing_at =\
                 APIHelper.apply_datetime_converter(
                billing_at, APIHelper.RFC3339DateTime) if billing_at else None
        if seen_at is not APIHelper.SKIP:
            self.seen_at =\
                 APIHelper.apply_datetime_converter(
                seen_at, APIHelper.RFC3339DateTime) if seen_at else None
    ...
    def from_dictionary(cls,
        ...
        total_discount =\
            ...
            if "total_discount" in dictionary.keys() else APIHelper.SKIP
        total_increment =\
            dictionary.get("total_increment")\
            if "total_increment" in dictionary.keys() else APIHelper.SKIP
        subscription_id =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"billing_at={(self.billing_at
                     if hasattr(self, 'billing_at') else None)!r}, "
                f"seen_at={(self.seen_at
                     if hasattr(self, 'seen_at') else None)!r}, "
                f"total_discount={(self.total_discount
                     if hasattr(self, 'total_discount') else None)!r}, "
                f"total_increment={(self.total_increment
                     if hasattr(self, 'total_increment') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"billing_at={(self.billing_at
                     if hasattr(self, 'billing_at') else None)!s}, "
                f"seen_at={(self.seen_at
                     if hasattr(self, 'seen_at') else None)!s}, "
                f"total_discount={(self.total_discount
                     if hasattr(self, 'total_discount') else None)!s}, "
                f"total_increment={(self.total_increment
                     if hasattr(self, 'total_increment') else None)!s}, "
                f"subscription_id={(self.subscription_id
