...
from pagarmeapisdk.models.get_setup_response import (
    GetSetupResponse,
)
from pagarmeapisdk.models.get_subscription_boleto_response import (
    GetSubscriptionBoletoResponse,
)
from pagarmeapisdk.models.get_subscription_item_response import (
    GetSubscriptionItemResponse,
)
from pagarmeapisdk.models.get_subscription_split_response import (
...
class GetSubscriptionResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a GetSubscriptionResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        code =\
            dictionary.get("code")\
            if "code" in dictionary.keys() else APIHelper.SKIP
        ...
        interval_count =\
            ...
            if "interval_count" in dictionary.keys() else APIHelper.SKIP
        billing_type =\
            dictionary.get("billing_type")\
            if "billing_type" in dictionary.keys() else APIHelper.SKIP
        ...
        if "next_billing_at" in dictionary.keys():
            next_billing_at = APIHelper.RFC3339DateTime.from_value(
                ...
                if dictionary.get("next_billing_at") else None

        else:
            next_billing_at = APIHelper.SKIP
        billing_day =\
            dictionary.get("billing_day")\
            if "billing_day" in dictionary.keys() else APIHelper.SKIP
        minimum_price =\
            dictionary.get("minimum_price")\
            if "minimum_price" in dictionary.keys() else APIHelper.SKIP
        ...
        boleto_due_days =\
            ...
            if "boleto_due_days" in dictionary.keys() else APIHelper.SKIP
        ...
        if "boleto" in dictionary.keys():
            ...
            boleto = APIHelper.SKIP
        manual_billing =\
            dictionary.get("manual_billing")\
            if "manual_billing" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"interval_count={(self.interval_count
                     if hasattr(self, 'interval_count') else None)!r}, "
                f"billing_type={(self.billing_type
                     if hasattr(self, 'billing_type') else None)!r}, "
                f"current_cycle={(self.current_cycle
                     if hasattr(self, 'current_cycle') else None)!r}, "
                ...
                f"increments={(self.increments
                     if hasattr(self, 'increments') else None)!r}, "
                ...
                f"manual_billing={(self.manual_billing
                     if hasattr(self, 'manual_billing') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"interval_count={(self.interval_count
                     if hasattr(self, 'interval_count') else None)!s}, "
                f"billing_type={(self.billing_type
                     if hasattr(self, 'billing_type') else None)!s}, "
                f"current_cycle={(self.current_cycle
                     if hasattr(self, 'current_cycle') else None)!s}, "
                f"payment_method={(self.payment_method
                ...
                f"increments={(self.increments
                     if hasattr(self, 'increments') else None)!s}, "
                f"boleto_due_days={(self.boleto_due_days
                ...
                f"manual_billing={(self.manual_billing
                     if hasattr(self, 'manual_billing') else None)!s})")
