...
class CreateSubscriptionBoletoRequest(object):
    ...
    def from_dictionary(cls,
        ...
        interest = CreateInterestRequest.from_dictionary(
            dictionary.get("interest"))\
            if "interest" in dictionary.keys() else APIHelper.SKIP
        fine = CreateFineRequest.from_dictionary(
            dictionary.get("fine"))\
            if "fine" in dictionary.keys() else APIHelper.SKIP
        max_days_to_pay_past_due =\
