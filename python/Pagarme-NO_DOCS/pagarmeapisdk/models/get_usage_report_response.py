...
class GetUsageReportResponse(object):
    ...
    def from_dictionary(cls,
        ...
        usage_report_url =\
            ...
            if "usage_report_url" in dictionary.keys() else APIHelper.SKIP
        grouped_report_url =\
            dictionary.get("grouped_report_url")\
            if "grouped_report_url" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"usage_report_url={(self.usage_report_url
                     if hasattr(self, 'usage_report_url') else None)!r}, "
                f"grouped_report_url={(self.grouped_report_url
                     if hasattr(self, 'grouped_report_url') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"usage_report_url={(self.usage_report_url
                     if hasattr(self, 'usage_report_url') else None)!s}, "
                f"grouped_report_url={(self.grouped_report_url
                     if hasattr(self, 'grouped_report_url') else None)!s})")
