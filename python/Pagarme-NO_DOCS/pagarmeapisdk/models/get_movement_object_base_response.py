...
class GetMovementObjectBaseResponse(object):
    ...
    def from_dictionary(cls,
        ...
        object =\
            ...
            if dictionary.get("object") else "MovementObject"
        ...
        created_at =\
            ...
            if "created_at" in dictionary.keys() else APIHelper.SKIP
        mtype =\
            dictionary.get("type")\
            if "type" in dictionary.keys() else APIHelper.SKIP
        charge_id =\
            dictionary.get("charge_id")\
            if "charge_id" in dictionary.keys() else APIHelper.SKIP
        gateway_id =\
...
class GetMovementObjectFeeCollectionResponse(GetMovementObjectBaseResponse):
    ...
    def from_dictionary(cls,
        ...
        payment_date =\
            ...
            if "payment_date" in dictionary.keys() else APIHelper.SKIP
        recipient_id =\
            dictionary.get("recipient_id")\
            if "recipient_id" in dictionary.keys() else APIHelper.SKIP
        object =\
            dictionary.get("object")\
            if dictionary.get("object") else "feeCollection"
        id = dictionary.get("id") if "id" in dictionary.keys() else APIHelper.SKIP
        status =\
            dictionary.get("status")\
            if "status" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"recipient_id={(self.recipient_id
                     if hasattr(self, 'recipient_id') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"recipient_id={(self.recipient_id
                     if hasattr(self, 'recipient_id') else None)!s})")
...
class GetMovementObjectPayableResponse(GetMovementObjectBaseResponse):
    ...
    def from_dictionary(cls,
        ...
        anticipation_fee =\
            ...
            if dictionary.get("anticipation_fee") else None
        fraud_coverage_fee =\
            dictionary.get("fraud_coverage_fee")\
            if dictionary.get("fraud_coverage_fee") else None
        installment =\
            dictionary.get("installment")\
            if dictionary.get("installment") else None
        split_id =\
            dictionary.get("split_id")\
            if dictionary.get("split_id") else None
        bulk_anticipation_id =\
            dictionary.get("bulk_anticipation_id")\
            if dictionary.get("bulk_anticipation_id") else None
        anticipation_id =\
            dictionary.get("anticipation_id")\
            if dictionary.get("anticipation_id") else None
        recipient_id =\
            dictionary.get("recipient_id")\
            if dictionary.get("recipient_id") else None
        originator_model =\
            dictionary.get("originator_model")\
            if dictionary.get("originator_model") else None
        originator_model_id =\
            dictionary.get("originator_model_id")\
            if dictionary.get("originator_model_id") else None
        payment_date =\
            dictionary.get("payment_date")\
        ...
        liquidation_arrangement_id =\
            ...
            if dictionary.get("liquidation_arrangement_id") else None
        fee =\
            dictionary.get("fee")\
            if "fee" in dictionary.keys() else APIHelper.SKIP
        object =\
            dictionary.get("object")\
            if dictionary.get("object") else "payable"
        id = dictionary.get("id") if "id" in dictionary.keys() else APIHelper.SKIP
        status =\
            dictionary.get("status")\
            if "status" in dictionary.keys() else APIHelper.SKIP
...
class GetMovementObjectRefundResponse(GetMovementObjectBaseResponse):
    ...
    def from_dictionary(cls,
        ...
        fraud_coverage_fee =\
            dictionary.get("fraud_coverage_fee")\
            if "fraud_coverage_fee" in dictionary.keys() else APIHelper.SKIP
        charge_fee_recipient_id =\
            dictionary.get("charge_fee_recipient_id")\
            if "charge_fee_recipient_id" in dictionary.keys() else APIHelper.SKIP
        bank_account_id =\
            dictionary.get("bank_account_id")\
            if "bank_account_id" in dictionary.keys() else APIHelper.SKIP
        local_transaction_id =\
            dictionary.get("local_transaction_id")\
            if "local_transaction_id" in dictionary.keys() else APIHelper.SKIP
        updated_at =\
            dictionary.get("updated_at")\
            if "updated_at" in dictionary.keys() else APIHelper.SKIP
        object =\
            dictionary.get("object")\
            if dictionary.get("object") else "refund"
        id = dictionary.get("id") if "id" in dictionary.keys() else APIHelper.SKIP
        status =\
            dictionary.get("status")\
            if "status" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"{base_repr[base_repr.find('(') + 1:-1]}, "
                f"fraud_coverage_fee={(self.fraud_coverage_fee
                     if hasattr(self, 'fraud_coverage_fee') else None)!r}, "
                f"charge_fee_recipient_id={(self.charge_fee_recipient_id
                     if hasattr(self, 'charge_fee_recipient_id') else None)!r}, "
                f"bank_account_id={(self.bank_account_id
                     if hasattr(self, 'bank_account_id') else None)!r}, "
                f"local_transaction_id={(self.local_transaction_id
                     if hasattr(self, 'local_transaction_id') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"{base_str[base_str.find('(') + 1:-1]}, "
                f"fraud_coverage_fee={(self.fraud_coverage_fee
                     if hasattr(self, 'fraud_coverage_fee') else None)!s}, "
                f"charge_fee_recipient_id={(self.charge_fee_recipient_id
                     if hasattr(self, 'charge_fee_recipient_id') else None)!s}, "
                f"bank_account_id={(self.bank_account_id
                     if hasattr(self, 'bank_account_id') else None)!s}, "
                f"local_transaction_id={(self.local_transaction_id
                     if hasattr(self, 'local_transaction_id') else None)!s}, "
                f"updated_at={(self.updated_at
...
class GetMovementObjectTransferResponse(GetMovementObjectBaseResponse):
    ...
    def from_dictionary(cls,
        ...
        source_type =\
            ...
            if "source_type" in dictionary.keys() else APIHelper.SKIP
        source_id =\
            dictionary.get("source_id")\
            if "source_id" in dictionary.keys() else APIHelper.SKIP
        target_type =\
            dictionary.get("target_type")\
            if "target_type" in dictionary.keys() else APIHelper.SKIP
        target_id =\
            dictionary.get("target_id")\
            if "target_id" in dictionary.keys() else APIHelper.SKIP
        fee =\
            dictionary.get("fee")\
            if "fee" in dictionary.keys() else APIHelper.SKIP
        funding_date =\
            dictionary.get("funding_date")\
            if "funding_date" in dictionary.keys() else APIHelper.SKIP
        funding_estimated_date =\
            dictionary.get("funding_estimated_date")\
            if "funding_estimated_date" in dictionary.keys() else APIHelper.SKIP
        bank_account =\
            dictionary.get("bank_account")\
            if "bank_account" in dictionary.keys() else APIHelper.SKIP
        object =\
            dictionary.get("object")\
            if dictionary.get("object") else "transfer"
        id = dictionary.get("id") if "id" in dictionary.keys() else APIHelper.SKIP
        status =\
            dictionary.get("status")\
            if "status" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"target_type={(self.target_type
                     if hasattr(self, 'target_type') else None)!r}, "
                f"target_id={(self.target_id
                     if hasattr(self, 'target_id') else None)!r}, "
                f"fee={(self.fee if hasattr(self, 'fee') else None)!r}, "
                f"funding_date={(self.funding_date
                     if hasattr(self, 'funding_date') else None)!r}, "
                f"funding_estimated_date={(self.funding_estimated_date
                     if hasattr(self, 'funding_estimated_date') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"target_type={(self.target_type
                     if hasattr(self, 'target_type') else None)!s}, "
                f"target_id={(self.target_id
                     if hasattr(self, 'target_id') else None)!s}, "
                f"fee={(self.fee if hasattr(self, 'fee') else None)!s}, "
                f"funding_date={(self.funding_date
                     if hasattr(self, 'funding_date') else None)!s}, "
                f"funding_estimated_date={(self.funding_estimated_date
                     if hasattr(self, 'funding_estimated_date') else None)!s}, "
                f"bank_account={(self.bank_account
...
class GetMovementObjectSettlementResponse(GetMovementObjectBaseResponse):
    ...
    def from_dictionary(cls,
        ...
        brand =\
            ...
            if "brand" in dictionary.keys() else APIHelper.SKIP
        payment_date =\
            dictionary.get("payment_date")\
            if "payment_date" in dictionary.keys() else APIHelper.SKIP
        recipient_id =\
        ...
        document_type =\
            ...
            if "document_type" in dictionary.keys() else APIHelper.SKIP
        document =\
            dictionary.get("document")\
            if "document" in dictionary.keys() else APIHelper.SKIP
        contract_obligation_id =\
            dictionary.get("contract_obligation_id")\
            if "contract_obligation_id" in dictionary.keys() else APIHelper.SKIP
        liquidation_arrangement_id =\
            dictionary.get("liquidation_arrangement_id")\
            if "liquidation_arrangement_id" in dictionary.keys() else APIHelper.SKIP
        external_engine_payment_id =\
            dictionary.get("external_engine_payment_id")\
            if "external_engine_payment_id" in dictionary.keys() else APIHelper.SKIP
        object =\
            dictionary.get("object")\
            if dictionary.get("object") else "settlement"
        id = dictionary.get("id") if "id" in dictionary.keys() else APIHelper.SKIP
        status =\
            dictionary.get("status")\
            if "status" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"document={(self.document
                     if hasattr(self, 'document') else None)!r}, "
                f"contract_obligation_id={(self.contract_obligation_id
                     if hasattr(self, 'contract_obligation_id') else None)!r}, "
                f"liquidation_arrangement_id={(self.liquidation_arrangement_id
                     if hasattr(self, 'liquidation_arrangement_id') else None)!r}, "
                f"external_engine_payment_id={(self.external_engine_payment_id
                     if hasattr(self, 'external_engine_payment_id') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"document={(self.document
                     if hasattr(self, 'document') else None)!s}, "
                f"contract_obligation_id={(self.contract_obligation_id
                     if hasattr(self, 'contract_obligation_id') else None)!s}, "
                f"liquidation_arrangement_id={(self.liquidation_arrangement_id
                     if hasattr(self, 'liquidation_arrangement_id') else None)!s}, "
                f"external_engine_payment_id={(self.external_engine_payment_id
                     if hasattr(self, 'external_engine_payment_id') else None)!s})")
