...
class GetAddressResponse(object):
    ...
    def from_dictionary(cls,
        ...
        complement =\
            ...
            if "complement" in dictionary.keys() else APIHelper.SKIP
        zip_code =\
        ...
        line_1 =\
            ...
            if "line_1" in dictionary.keys() else APIHelper.SKIP
        line_2 =\
            dictionary.get("line_2")\
            if "line_2" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"complement={(self.complement
                     if hasattr(self, 'complement') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"complement={(self.complement
                     if hasattr(self, 'complement') else None)!s}, "
                f"zip_code={(self.zip_code
