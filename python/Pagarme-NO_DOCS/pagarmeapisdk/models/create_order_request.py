...
from pagarmeapisdk.models.create_antifraud_request import (
    CreateAntifraudRequest,
)
from pagarmeapisdk.models.create_customer_request import (
    CreateCustomerRequest,
)
from pagarmeapisdk.models.create_device_request import (
    CreateDeviceRequest,
)
from pagarmeapisdk.models.create_location_request import (
    CreateLocationRequest,
)
from pagarmeapisdk.models.create_order_item_request import (
...
class CreateOrderRequest(object):
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("items") is not None:
            items = [
                CreateOrderItemRequest.from_dictionary(x)
        ...
        if dictionary.get("payments") is not None:
            payments = [
                CreatePaymentRequest.from_dictionary(x)
        ...
        antifraud_enabled =\
            dictionary.get("antifraud_enabled")\
            if "antifraud_enabled" in dictionary.keys() else APIHelper.SKIP
        ip = dictionary.get("ip") if dictionary.get("ip") else APIHelper.SKIP
        session_id =\
            dictionary.get("session_id")\
            if dictionary.get("session_id") else APIHelper.SKIP
        location = CreateLocationRequest.from_dictionary(
            dictionary.get("location"))\
            if "location" in dictionary.keys() else APIHelper.SKIP
        device = CreateDeviceRequest.from_dictionary(
            dictionary.get("device"))\
            if "device" in dictionary.keys() else APIHelper.SKIP
        currency =\
            dictionary.get("currency")\
            if dictionary.get("currency") else APIHelper.SKIP
        antifraud = CreateAntifraudRequest.from_dictionary(
            dictionary.get("antifraud"))\
            if "antifraud" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"antifraud_enabled={(self.antifraud_enabled
                     if hasattr(self, 'antifraud_enabled') else None)!r}, "
                f"ip={(self.ip if hasattr(self, 'ip') else None)!r}, "
                f"session_id={(self.session_id
                     if hasattr(self, 'session_id') else None)!r}, "
                ...
                f"antifraud={(self.antifraud
                     if hasattr(self, 'antifraud') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"antifraud_enabled={(self.antifraud_enabled
                     if hasattr(self, 'antifraud_enabled') else None)!s}, "
                f"ip={(self.ip if hasattr(self, 'ip') else None)!s}, "
                f"session_id={(self.session_id
                     if hasattr(self, 'session_id') else None)!s}, "
                f"location={(self.location
                ...
                f"antifraud={(self.antifraud
                     if hasattr(self, 'antifraud') else None)!s}, "
                f"submerchant={(self.submerchant
