...
class GetBankAccountResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a GetBankAccountResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        holder_name =\
            ...
            if "holder_name" in dictionary.keys() else APIHelper.SKIP
        holder_type =\
            dictionary.get("holder_type")\
            if "holder_type" in dictionary.keys() else APIHelper.SKIP
        bank =\
            dictionary.get("bank")\
            if "bank" in dictionary.keys() else APIHelper.SKIP
        branch_number =\
            dictionary.get("branch_number")\
            if "branch_number" in dictionary.keys() else APIHelper.SKIP
        branch_check_digit =\
            dictionary.get("branch_check_digit")\
            if "branch_check_digit" in dictionary.keys() else APIHelper.SKIP
        account_number =\
            dictionary.get("account_number")\
            if "account_number" in dictionary.keys() else APIHelper.SKIP
        account_check_digit =\
            dictionary.get("account_check_digit")\
            if "account_check_digit" in dictionary.keys() else APIHelper.SKIP
        mtype =\
            dictionary.get("type")\
        ...
        pix_key =\
            ...
            if "pix_key" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"holder_name={(self.holder_name
                     if hasattr(self, 'holder_name') else None)!r}, "
                f"holder_type={(self.holder_type
                     if hasattr(self, 'holder_type') else None)!r}, "
                f"bank={(self.bank if hasattr(self, 'bank') else None)!r}, "
                f"branch_number={(self.branch_number
                     if hasattr(self, 'branch_number') else None)!r}, "
                f"branch_check_digit={(self.branch_check_digit
                     if hasattr(self, 'branch_check_digit') else None)!r}, "
                f"account_number={(self.account_number
                     if hasattr(self, 'account_number') else None)!r}, "
                f"account_check_digit={(self.account_check_digit
                     if hasattr(self, 'account_check_digit') else None)!r}, "
                ...
                f"pix_key={(self.pix_key
                     if hasattr(self, 'pix_key') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"holder_name={(self.holder_name
                     if hasattr(self, 'holder_name') else None)!s}, "
                f"holder_type={(self.holder_type
                     if hasattr(self, 'holder_type') else None)!s}, "
                f"bank={(self.bank if hasattr(self, 'bank') else None)!s}, "
                f"branch_number={(self.branch_number
                     if hasattr(self, 'branch_number') else None)!s}, "
                f"branch_check_digit={(self.branch_check_digit
                     if hasattr(self, 'branch_check_digit') else None)!s}, "
                f"account_number={(self.account_number
                     if hasattr(self, 'account_number') else None)!s}, "
                f"account_check_digit={(self.account_check_digit
                     if hasattr(self, 'account_check_digit') else None)!s}, "
                ...
                f"pix_key={(self.pix_key
                     if hasattr(self, 'pix_key') else None)!s})")
