...
from pagarmeapisdk.models.get_withdraw_source_response import (
    GetWithdrawSourceResponse,
)
from pagarmeapisdk.models.get_withdraw_target_response import (
...
class GetWithdrawResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a GetWithdrawResponse instance."""
        ...
        if funding_date is not APIHelper.SKIP:
            self.funding_date =\
                 APIHelper.apply_datetime_converter(
                funding_date, APIHelper.RFC3339DateTime) if funding_date else None
        if funding_estimated_date is not APIHelper.SKIP:
            self.funding_estimated_date =\
                 APIHelper.apply_datetime_converter(
                funding_estimated_date, APIHelper.RFC3339DateTime) if funding_estimated_date else None
    ...
    def from_dictionary(cls,
        ...
        if "funding_date" in dictionary.keys():
            funding_date = APIHelper.RFC3339DateTime.from_value(
                dictionary.get("funding_date")).datetime\
                if dictionary.get("funding_date") else None

        else:
            funding_date = APIHelper.SKIP
        if "funding_estimated_date" in dictionary.keys():
            funding_estimated_date = APIHelper.RFC3339DateTime.from_value(
                dictionary.get("funding_estimated_date")).datetime\
                if dictionary.get("funding_estimated_date") else None
