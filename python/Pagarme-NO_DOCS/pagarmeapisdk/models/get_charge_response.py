...
class GetChargeResponse(object):
    ...
    def from_dictionary(cls,
        ...
        canceled_amount =\
            ...
            if "canceled_amount" in dictionary.keys() else APIHelper.SKIP
        paid_amount =\
            dictionary.get("paid_amount")\
            if "paid_amount" in dictionary.keys() else APIHelper.SKIP
        interest_and_fine_paid =\
            dictionary.get("interest_and_fine_paid")\
            if "interest_and_fine_paid" in dictionary.keys() else APIHelper.SKIP
        recurrency_cycle =\
            dictionary.get("recurrency_cycle")\
            if "recurrency_cycle" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"last_transaction={(self.last_transaction
                     if hasattr(self, 'last_transaction') else None)!r}, "
                ...
                f"canceled_amount={(self.canceled_amount
                     if hasattr(self, 'canceled_amount') else None)!r}, "
                f"paid_amount={(self.paid_amount
                     if hasattr(self, 'paid_amount') else None)!r}, "
                f"interest_and_fine_paid={(self.interest_and_fine_paid
                     if hasattr(self, 'interest_and_fine_paid') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"last_transaction={(self.last_transaction
                     if hasattr(self, 'last_transaction') else None)!s}, "
                f"invoice={(self.invoice
                ...
                f"canceled_amount={(self.canceled_amount
                     if hasattr(self, 'canceled_amount') else None)!s}, "
                f"paid_amount={(self.paid_amount
                     if hasattr(self, 'paid_amount') else None)!s}, "
                f"interest_and_fine_paid={(self.interest_and_fine_paid
                     if hasattr(self, 'interest_and_fine_paid') else None)!s}, "
                f"recurrency_cycle={(self.recurrency_cycle
