...
class CreateSubscriptionRequest(object):
    ...
    def __init__(self,
        ...
        if start_at is not APIHelper.SKIP:
            self.start_at =\
                ...
                start_at, APIHelper.RFC3339DateTime) if start_at else None
    ...
    def from_dictionary(cls,
        ...
        customer = CreateCustomerRequest.from_dictionary(
        ...
        billing_type =\
            ...
            if dictionary.get("billing_type") else None
        statement_descriptor =\
            dictionary.get("statement_descriptor")\
            if dictionary.get("statement_descriptor") else None
        description =\
        ...
        interval_count =\
            ...
            if dictionary.get("interval_count") else None
        pricing_scheme = CreatePricingSchemeRequest.from_dictionary(
        ...
        shipping = CreateShippingRequest.from_dictionary(
        ...
        metadata =\
            ...
            if dictionary.get("metadata") else None
        increments = None
        ...
        setup = CreateSetupRequest.from_dictionary(
            dictionary.get("setup"))\
            if "setup" in dictionary.keys() else APIHelper.SKIP
        plan_id =\
            dictionary.get("plan_id")\
            if dictionary.get("plan_id") else APIHelper.SKIP
        customer_id =\
        ...
        billing_day =\
            ...
            if dictionary.get("billing_day") else APIHelper.SKIP
        installments =\
            dictionary.get("installments")\
            if dictionary.get("installments") else APIHelper.SKIP
        ...
        minimum_price =\
            ...
            if dictionary.get("minimum_price") else APIHelper.SKIP
        cycles =\
            dictionary.get("cycles")\
            if dictionary.get("cycles") else APIHelper.SKIP
        card_token =\
        ...
        boleto_due_days =\
            ...
            if dictionary.get("boleto_due_days") else APIHelper.SKIP
        period = CreatePeriodRequest.from_dictionary(
            dictionary.get("period"))\
            if "period" in dictionary.keys() else APIHelper.SKIP
        submerchant = CreateSubMerchantRequest.from_dictionary(
            dictionary.get("submerchant"))\
            if "submerchant" in dictionary.keys() else APIHelper.SKIP
        split = CreateSubscriptionSplitRequest.from_dictionary(
            dictionary.get("split"))\
            if "split" in dictionary.keys() else APIHelper.SKIP
        boleto = CreateSubscriptionBoletoRequest.from_dictionary(
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"billing_day={(self.billing_day
                     if hasattr(self, 'billing_day') else None)!r}, "
                f"installments={(self.installments
                     if hasattr(self, 'installments') else None)!r}, "
                f"start_at={(self.start_at
                     if hasattr(self, 'start_at') else None)!r}, "
                f"minimum_price={(self.minimum_price
                     if hasattr(self, 'minimum_price') else None)!r}, "
                ...
                f"boleto_due_days={(self.boleto_due_days
                     if hasattr(self, 'boleto_due_days') else None)!r}, "
                f"increments={self.increments!r}, "
                f"period={(self.period if hasattr(self, 'period') else None)!r}, "
                f"submerchant={(self.submerchant
                     if hasattr(self, 'submerchant') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"billing_day={(self.billing_day
                     if hasattr(self, 'billing_day') else None)!s}, "
                f"installments={(self.installments
                     if hasattr(self, 'installments') else None)!s}, "
                f"start_at={(self.start_at
                     if hasattr(self, 'start_at') else None)!s}, "
                f"minimum_price={(self.minimum_price
                     if hasattr(self, 'minimum_price') else None)!s}, "
