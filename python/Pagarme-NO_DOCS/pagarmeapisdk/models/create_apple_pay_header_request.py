...
class CreateApplePayHeaderRequest(object):
    ...
    def from_dictionary(cls,
        ...
        ephemeral_public_key =\
            ...
            if dictionary.get("ephemeral_public_key") else None
        public_key_hash =\
            dictionary.get("public_key_hash")\
            if dictionary.get("public_key_hash") else APIHelper.SKIP
        transaction_id =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"public_key_hash={(self.public_key_hash
                     if hasattr(self, 'public_key_hash') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"public_key_hash={(self.public_key_hash
                     if hasattr(self, 'public_key_hash') else None)!s}, "
