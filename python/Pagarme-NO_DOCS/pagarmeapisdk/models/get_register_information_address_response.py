...
class GetRegisterInformationAddressResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a GetRegisterInformationAddressResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        complementary =\
            ...
            if "complementary" in dictionary.keys() else APIHelper.SKIP
        street_number =\
            dictionary.get("street_number")\
            if "street_number" in dictionary.keys() else APIHelper.SKIP
        neighborhood =\
            dictionary.get("neighborhood")\
            if "neighborhood" in dictionary.keys() else APIHelper.SKIP
        city =\
            dictionary.get("city")\
        ...
        zip_code =\
            ...
            if "zip_code" in dictionary.keys() else APIHelper.SKIP
        reference_point =\
            dictionary.get("reference_point")\
            if "reference_point" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"complementary={(self.complementary
                     if hasattr(self, 'complementary') else None)!r}, "
                f"street_number={(self.street_number
                     if hasattr(self, 'street_number') else None)!r}, "
                f"neighborhood={(self.neighborhood
                     if hasattr(self, 'neighborhood') else None)!r}, "
                ...
                f"reference_point={(self.reference_point
                     if hasattr(self, 'reference_point') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"complementary={(self.complementary
                     if hasattr(self, 'complementary') else None)!s}, "
                f"street_number={(self.street_number
                     if hasattr(self, 'street_number') else None)!s}, "
                f"neighborhood={(self.neighborhood
                     if hasattr(self, 'neighborhood') else None)!s}, "
                ...
                f"reference_point={(self.reference_point
                     if hasattr(self, 'reference_point') else None)!s})")
