...
class CreatePaymentRequest(object):
    ...
    def from_dictionary(cls,
        ...
        credit_card = CreateCreditCardPaymentRequest.from_dictionary(
            dictionary.get("credit_card"))\
            if "credit_card" in dictionary.keys() else APIHelper.SKIP
        debit_card = CreateDebitCardPaymentRequest.from_dictionary(
            dictionary.get("debit_card"))\
            if "debit_card" in dictionary.keys() else APIHelper.SKIP
        boleto = CreateBoletoPaymentRequest.from_dictionary(
        ...
        voucher = CreateVoucherPaymentRequest.from_dictionary(
            dictionary.get("voucher"))\
            if "voucher" in dictionary.keys() else APIHelper.SKIP
        split = None
        if dictionary.get("split") is not None:
            ...
            split = APIHelper.SKIP
        bank_transfer = CreateBankTransferPaymentRequest.from_dictionary(
        ...
        checkout = CreateCheckoutPaymentRequest.from_dictionary(
            dictionary.get("checkout"))\
            if "checkout" in dictionary.keys() else APIHelper.SKIP
        customer_id =\
        ...
        cash = CreateCashPaymentRequest.from_dictionary(
            dictionary.get("cash"))\
            if "cash" in dictionary.keys() else APIHelper.SKIP
        private_label = CreatePrivateLabelPaymentRequest.from_dictionary(
            dictionary.get("private_label"))\
            if "private_label" in dictionary.keys() else APIHelper.SKIP
        pix = CreatePixPaymentRequest.from_dictionary(
            dictionary.get("pix"))\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"voucher={(self.voucher
                     if hasattr(self, 'voucher') else None)!r}, "
                ...
                f"checkout={(self.checkout
                     if hasattr(self, 'checkout') else None)!r}, "
                ...
                f"private_label={(self.private_label
                     if hasattr(self, 'private_label') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"voucher={(self.voucher
                     if hasattr(self, 'voucher') else None)!s}, "
                ...
                f"checkout={(self.checkout
                     if hasattr(self, 'checkout') else None)!s}, "
                f"customer_id={(self.customer_id
                ...
                f"private_label={(self.private_label
                     if hasattr(self, 'private_label') else None)!s}, "
