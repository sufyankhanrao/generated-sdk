...
from pagarmeapisdk.models.create_checkout_bank_transfer_request import (
    CreateCheckoutBankTransferRequest,
)
from pagarmeapisdk.models.create_checkout_boleto_payment_request import (
    CreateCheckoutBoletoPaymentRequest,
)
from pagarmeapisdk.models.create_checkout_credit_card_payment_request import (
    CreateCheckoutCreditCardPaymentRequest,
)
from pagarmeapisdk.models.create_checkout_debit_card_payment_request import (
    CreateCheckoutDebitCardPaymentRequest,
)
from pagarmeapisdk.models.create_checkout_pix_payment_request import (
...
class CreateCheckoutPaymentRequest(object):
    ...
    def __init__(self,
                 ...
                 pix=APIHelper.SKIP):
        """Initialize a CreateCheckoutPaymentRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        accepted_payment_methods =\
            ...
            if dictionary.get("accepted_payment_methods") else None
        accepted_multi_payment_methods =\
            dictionary.get("accepted_multi_payment_methods")\
            if dictionary.get("accepted_multi_payment_methods") else None
        success_url =\
            dictionary.get("success_url")\
            if dictionary.get("success_url") else None
        skip_checkout_success_page =\
            dictionary.get("skip_checkout_success_page")\
            if "skip_checkout_success_page" in dictionary.keys() else None
        billing_address_editable =\
            dictionary.get("billing_address_editable")\
            if "billing_address_editable" in dictionary.keys() else None
        billing_address = CreateAddressRequest.from_dictionary(
            dictionary.get("billing_address"))\
            if dictionary.get("billing_address") else None
        accepted_brands =\
            dictionary.get("accepted_brands")\
            if dictionary.get("accepted_brands") else None
        default_payment_method =\
            dictionary.get("default_payment_method")\
            if dictionary.get("default_payment_method") else APIHelper.SKIP
        gateway_affiliation_id =\
            dictionary.get("gateway_affiliation_id")\
            if dictionary.get("gateway_affiliation_id") else APIHelper.SKIP
        credit_card = CreateCheckoutCreditCardPaymentRequest.from_dictionary(
            dictionary.get("credit_card"))\
            if "credit_card" in dictionary.keys() else APIHelper.SKIP
        debit_card = CreateCheckoutDebitCardPaymentRequest.from_dictionary(
            dictionary.get("debit_card"))\
            if "debit_card" in dictionary.keys() else APIHelper.SKIP
        boleto = CreateCheckoutBoletoPaymentRequest.from_dictionary(
            dictionary.get("boleto"))\
            if "boleto" in dictionary.keys() else APIHelper.SKIP
        customer_editable =\
        ...
        bank_transfer = CreateCheckoutBankTransferRequest.from_dictionary(
            dictionary.get("bank_transfer"))\
            if "bank_transfer" in dictionary.keys() else APIHelper.SKIP
        pix = CreateCheckoutPixPaymentRequest.from_dictionary(
            dictionary.get("pix"))\
            if "pix" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"accepted_multi_payment_methods={
                    self.accepted_multi_payment_methods!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"accepted_multi_payment_methods={
                    self.accepted_multi_payment_methods!s}, "
