...
class GetTransactionResponse(object):
    ...
    def __init__(self,
        ...
        if next_attempt is not APIHelper.SKIP:
            self.next_attempt =\
                 APIHelper.apply_datetime_converter(
                next_attempt, APIHelper.RFC3339DateTime) if next_attempt else None
    ...
    def from_dictionary(cls,
        ...
        gateway_id =\
            ...
            if "gateway_id" in dictionary.keys() else APIHelper.SKIP
        amount =\
        ...
        attempt_count =\
            ...
            if "attempt_count" in dictionary.keys() else APIHelper.SKIP
        max_attempts =\
            dictionary.get("max_attempts")\
            if "max_attempts" in dictionary.keys() else APIHelper.SKIP
        ...
        transaction_type =\
            ...
            if dictionary.get("transaction_type") else "transaction"
        ...
        max_days_to_pay_past_due =\
            ...
            if "max_days_to_pay_past_due" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"gateway_id={(self.gateway_id
                     if hasattr(self, 'gateway_id') else None)!r}, "
                ...
                f"attempt_count={(self.attempt_count
                     if hasattr(self, 'attempt_count') else None)!r}, "
                f"max_attempts={(self.max_attempts
                     if hasattr(self, 'max_attempts') else None)!r}, "
                f"splits={(self.splits if hasattr(self, 'splits') else None)!r}, "
                f"next_attempt={(self.next_attempt
                     if hasattr(self, 'next_attempt') else None)!r}, "
                f"transaction_type={(self.transaction_type
                     if hasattr(self, 'transaction_type') else None)!r}, "
                f"id={(self.id if hasattr(self, 'id') else None)!r}, "
                f"gateway_response={(self.gateway_response
                     if hasattr(self, 'gateway_response') else None)!r}, "
                f"antifraud_response={(self.antifraud_response
                     if hasattr(self, 'antifraud_response') else None)!r}, "
                f"metadata={(self.metadata
                     if hasattr(self, 'metadata') else None)!r}, "
                f"split={(self.split if hasattr(self, 'split') else None)!r}, "
                f"interest={(self.interest
                     if hasattr(self, 'interest') else None)!r}, "
                f"fine={(self.fine if hasattr(self, 'fine') else None)!r}, "
                f"max_days_to_pay_past_due={(self.max_days_to_pay_past_due
                     if hasattr(self, 'max_days_to_pay_past_due') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"gateway_id={(self.gateway_id
                     if hasattr(self, 'gateway_id') else None)!s}, "
                ...
                f"attempt_count={(self.attempt_count
                     if hasattr(self, 'attempt_count') else None)!s}, "
                f"max_attempts={(self.max_attempts
                     if hasattr(self, 'max_attempts') else None)!s}, "
                f"splits={(self.splits if hasattr(self, 'splits') else None)!s}, "
                f"next_attempt={(self.next_attempt
                     if hasattr(self, 'next_attempt') else None)!s}, "
                f"transaction_type={(self.transaction_type
                     if hasattr(self, 'transaction_type') else None)!s}, "
                f"id={(self.id if hasattr(self, 'id') else None)!s}, "
                f"gateway_response={(self.gateway_response
                     if hasattr(self, 'gateway_response') else None)!s}, "
                f"antifraud_response={(self.antifraud_response
                     if hasattr(self, 'antifraud_response') else None)!s}, "
                f"metadata={(self.metadata
                     if hasattr(self, 'metadata') else None)!s}, "
                f"split={(self.split if hasattr(self, 'split') else None)!s}, "
                f"interest={(self.interest
                     if hasattr(self, 'interest') else None)!s}, "
                f"fine={(self.fine if hasattr(self, 'fine') else None)!s}, "
                f"max_days_to_pay_past_due={(self.max_days_to_pay_past_due
                     if hasattr(self, 'max_days_to_pay_past_due') else None)!s})")
...
class GetSafetyPayTransactionResponse(GetTransactionResponse):
    ...
    def __init__(self,
        ...
        if paid_at is not APIHelper.SKIP:
            self.paid_at =\
                 APIHelper.apply_datetime_converter(
                paid_at, APIHelper.RFC3339DateTime) if paid_at else None
    ...
    def from_dictionary(cls,
        ...
        bank_tid =\
            ...
            if "bank_tid" in dictionary.keys() else APIHelper.SKIP
        ...
        paid_amount =\
            ...
            if "paid_amount" in dictionary.keys() else APIHelper.SKIP
        gateway_id =\
            dictionary.get("gateway_id")\
            if "gateway_id" in dictionary.keys() else APIHelper.SKIP
        amount =\
        ...
        transaction_type =\
            dictionary.get("transaction_type")\
            if dictionary.get("transaction_type") else "safetypay"
        id = dictionary.get("id") if "id" in dictionary.keys() else APIHelper.SKIP
        if "gateway_response" in dictionary.keys():
            gateway_response = GetGatewayResponseResponse.from_dictionary(dictionary.get("gateway_response")) if dictionary.get("gateway_response") else None
        else:
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"bank_tid={(self.bank_tid
                     if hasattr(self, 'bank_tid') else None)!r}, "
                f"paid_at={(self.paid_at
                     if hasattr(self, 'paid_at') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"bank_tid={(self.bank_tid
                     if hasattr(self, 'bank_tid') else None)!s}, "
                f"paid_at={(self.paid_at
                     if hasattr(self, 'paid_at') else None)!s}, "
                f"paid_amount={(self.paid_amount
...
class GetVoucherTransactionResponse(GetTransactionResponse):
    ...
    def from_dictionary(cls,
        ...
        statement_descriptor =\
            ...
            if "statement_descriptor" in dictionary.keys() else APIHelper.SKIP
        acquirer_name =\
            dictionary.get("acquirer_name")\
            if "acquirer_name" in dictionary.keys() else APIHelper.SKIP
        acquirer_affiliation_code =\
            dictionary.get("acquirer_affiliation_code")\
            if "acquirer_affiliation_code" in dictionary.keys() else APIHelper.SKIP
        acquirer_tid =\
            dictionary.get("acquirer_tid")\
            if "acquirer_tid" in dictionary.keys() else APIHelper.SKIP
        acquirer_nsu =\
            dictionary.get("acquirer_nsu")\
            if "acquirer_nsu" in dictionary.keys() else APIHelper.SKIP
        acquirer_auth_code =\
            dictionary.get("acquirer_auth_code")\
            if "acquirer_auth_code" in dictionary.keys() else APIHelper.SKIP
        acquirer_message =\
            dictionary.get("acquirer_message")\
            if "acquirer_message" in dictionary.keys() else APIHelper.SKIP
        acquirer_return_code =\
            dictionary.get("acquirer_return_code")\
            if "acquirer_return_code" in dictionary.keys() else APIHelper.SKIP
        operation_type =\
            dictionary.get("operation_type")\
            if "operation_type" in dictionary.keys() else APIHelper.SKIP
        ...
        transaction_type =\
            dictionary.get("transaction_type")\
            if dictionary.get("transaction_type") else "voucher"
        id = dictionary.get("id") if "id" in dictionary.keys() else APIHelper.SKIP
        if "gateway_response" in dictionary.keys():
            gateway_response = GetGatewayResponseResponse.from_dictionary(dictionary.get("gateway_response")) if dictionary.get("gateway_response") else None
        else:
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"{base_repr[base_repr.find('(') + 1:-1]}, "
                f"statement_descriptor={(self.statement_descriptor
                     if hasattr(self, 'statement_descriptor') else None)!r}, "
                f"acquirer_name={(self.acquirer_name
                     if hasattr(self, 'acquirer_name') else None)!r}, "
                f"acquirer_affiliation_code={(self.acquirer_affiliation_code
                     if hasattr(self, 'acquirer_affiliation_code') else None)!r}, "
                f"acquirer_tid={(self.acquirer_tid
                     if hasattr(self, 'acquirer_tid') else None)!r}, "
                f"acquirer_nsu={(self.acquirer_nsu
                     if hasattr(self, 'acquirer_nsu') else None)!r}, "
                f"acquirer_auth_code={(self.acquirer_auth_code
                     if hasattr(self, 'acquirer_auth_code') else None)!r}, "
                f"acquirer_message={(self.acquirer_message
                     if hasattr(self, 'acquirer_message') else None)!r}, "
                f"acquirer_return_code={(self.acquirer_return_code
                     if hasattr(self, 'acquirer_return_code') else None)!r}, "
                f"operation_type={(self.operation_type
                     if hasattr(self, 'operation_type') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"{base_str[base_str.find('(') + 1:-1]}, "
                f"statement_descriptor={(self.statement_descriptor
                     if hasattr(self, 'statement_descriptor') else None)!s}, "
                f"acquirer_name={(self.acquirer_name
                     if hasattr(self, 'acquirer_name') else None)!s}, "
                f"acquirer_affiliation_code={(self.acquirer_affiliation_code
                     if hasattr(self, 'acquirer_affiliation_code') else None)!s}, "
                f"acquirer_tid={(self.acquirer_tid
                     if hasattr(self, 'acquirer_tid') else None)!s}, "
                f"acquirer_nsu={(self.acquirer_nsu
                     if hasattr(self, 'acquirer_nsu') else None)!s}, "
                f"acquirer_auth_code={(self.acquirer_auth_code
                     if hasattr(self, 'acquirer_auth_code') else None)!s}, "
                f"acquirer_message={(self.acquirer_message
                     if hasattr(self, 'acquirer_message') else None)!s}, "
                f"acquirer_return_code={(self.acquirer_return_code
                     if hasattr(self, 'acquirer_return_code') else None)!s}, "
                f"operation_type={(self.operation_type
                     if hasattr(self, 'operation_type') else None)!s}, "
...
class GetBankTransferTransactionResponse(GetTransactionResponse):
    ...
    def from_dictionary(cls,
        ...
        bank_tid =\
            dictionary.get("bank_tid")\
            if dictionary.get("bank_tid") else APIHelper.SKIP
        bank =\
            dictionary.get("bank")\
            if dictionary.get("bank") else APIHelper.SKIP
        paid_at = APIHelper.RFC3339DateTime.from_value(
            dictionary.get("paid_at")).datetime\
        ...
        transaction_type =\
            dictionary.get("transaction_type")\
            if dictionary.get("transaction_type") else "bank_transfer"
        id = dictionary.get("id") if "id" in dictionary.keys() else APIHelper.SKIP
        if "gateway_response" in dictionary.keys():
            gateway_response = GetGatewayResponseResponse.from_dictionary(dictionary.get("gateway_response")) if dictionary.get("gateway_response") else None
        else:
...
class GetBoletoTransactionResponse(GetTransactionResponse):
    ...
    def __init__(self,
        ...
        if due_at is not APIHelper.SKIP:
            self.due_at =\
                 APIHelper.apply_datetime_converter(
                due_at, APIHelper.RFC3339DateTime) if due_at else None
        ...
        if credit_at is not APIHelper.SKIP:
            self.credit_at =\
                 APIHelper.apply_datetime_converter(
                credit_at, APIHelper.RFC3339DateTime) if credit_at else None
        if statement_descriptor is not APIHelper.SKIP:
            self.statement_descriptor = statement_descriptor
    ...
    def from_dictionary(cls,
        ...
        barcode =\
            ...
            if "barcode" in dictionary.keys() else APIHelper.SKIP
        nosso_numero =\
            dictionary.get("nosso_numero")\
            if "nosso_numero" in dictionary.keys() else APIHelper.SKIP
        bank =\
            dictionary.get("bank")\
            if "bank" in dictionary.keys() else APIHelper.SKIP
        document_number =\
            dictionary.get("document_number")\
            if "document_number" in dictionary.keys() else APIHelper.SKIP
        instructions =\
            dictionary.get("instructions")\
            if "instructions" in dictionary.keys() else APIHelper.SKIP
        ...
        qr_code =\
            ...
            if "qr_code" in dictionary.keys() else APIHelper.SKIP
        line =\
            dictionary.get("line")\
            if "line" in dictionary.keys() else APIHelper.SKIP
        pdf_password =\
            dictionary.get("pdf_password")\
            if "pdf_password" in dictionary.keys() else APIHelper.SKIP
        pdf =\
            dictionary.get("pdf")\
            if "pdf" in dictionary.keys() else APIHelper.SKIP
        if "paid_at" in dictionary.keys():
            paid_at = APIHelper.RFC3339DateTime.from_value(
                dictionary.get("paid_at")).datetime\
                if dictionary.get("paid_at") else None
        ...
        transaction_type =\
            dictionary.get("transaction_type")\
            if dictionary.get("transaction_type") else "boleto"
        id = dictionary.get("id") if "id" in dictionary.keys() else APIHelper.SKIP
        if "gateway_response" in dictionary.keys():
            gateway_response = GetGatewayResponseResponse.from_dictionary(dictionary.get("gateway_response")) if dictionary.get("gateway_response") else None
        else:
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"nosso_numero={(self.nosso_numero
                     if hasattr(self, 'nosso_numero') else None)!r}, "
                f"bank={(self.bank if hasattr(self, 'bank') else None)!r}, "
                f"document_number={(self.document_number
                     if hasattr(self, 'document_number') else None)!r}, "
                f"instructions={(self.instructions
                     if hasattr(self, 'instructions') else None)!r}, "
                ...
                f"qr_code={(self.qr_code
                     if hasattr(self, 'qr_code') else None)!r}, "
                f"line={(self.line if hasattr(self, 'line') else None)!r}, "
                f"pdf_password={(self.pdf_password
                     if hasattr(self, 'pdf_password') else None)!r}, "
                ...
                f"credit_at={(self.credit_at
                     if hasattr(self, 'credit_at') else None)!r}, "
                f"statement_descriptor={(self.statement_descriptor
                     if hasattr(self, 'statement_descriptor') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"nosso_numero={(self.nosso_numero
                     if hasattr(self, 'nosso_numero') else None)!s}, "
                f"bank={(self.bank if hasattr(self, 'bank') else None)!s}, "
                f"document_number={(self.document_number
                     if hasattr(self, 'document_number') else None)!s}, "
                f"instructions={(self.instructions
                     if hasattr(self, 'instructions') else None)!s}, "
                f"billing_address={(self.billing_address
                     if hasattr(self, 'billing_address') else None)!s}, "
                f"due_at={(self.due_at if hasattr(self, 'due_at') else None)!s}, "
                f"qr_code={(self.qr_code
                     if hasattr(self, 'qr_code') else None)!s}, "
                f"line={(self.line if hasattr(self, 'line') else None)!s}, "
                f"pdf_password={(self.pdf_password
                     if hasattr(self, 'pdf_password') else None)!s}, "
                ...
                f"credit_at={(self.credit_at
                     if hasattr(self, 'credit_at') else None)!s}, "
                f"statement_descriptor={(self.statement_descriptor
                     if hasattr(self, 'statement_descriptor') else None)!s})")
...
class GetDebitCardTransactionResponse(GetTransactionResponse):
    ...
    def from_dictionary(cls,
        ...
        mpi =\
            dictionary.get("mpi")\
            if "mpi" in dictionary.keys() else APIHelper.SKIP
        eci =\
            dictionary.get("eci")\
            if "eci" in dictionary.keys() else APIHelper.SKIP
        authentication_type =\
            dictionary.get("authentication_type")\
            if "authentication_type" in dictionary.keys() else APIHelper.SKIP
        threed_authentication_url =\
            dictionary.get("threed_authentication_url")\
            if "threed_authentication_url" in dictionary.keys() else APIHelper.SKIP
        funding_source =\
            dictionary.get("funding_source")\
            if "funding_source" in dictionary.keys() else APIHelper.SKIP
        ...
        transaction_type =\
            dictionary.get("transaction_type")\
            if dictionary.get("transaction_type") else "debit_card"
        id = dictionary.get("id") if "id" in dictionary.keys() else APIHelper.SKIP
        if "gateway_response" in dictionary.keys():
            gateway_response = GetGatewayResponseResponse.from_dictionary(dictionary.get("gateway_response")) if dictionary.get("gateway_response") else None
        else:
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"authentication_type={(self.authentication_type
                     if hasattr(self, 'authentication_type') else None)!r}, "
                f"threed_authentication_url={(self.threed_authentication_url
                     if hasattr(self, 'threed_authentication_url') else None)!r}, "
                f"funding_source={(self.funding_source
                     if hasattr(self, 'funding_source') else None)!r}, "
                f"retry_info={(self.retry_info
                     if hasattr(self, 'retry_info') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"authentication_type={(self.authentication_type
                     if hasattr(self, 'authentication_type') else None)!s}, "
                f"threed_authentication_url={(self.threed_authentication_url
                     if hasattr(self, 'threed_authentication_url') else None)!s}, "
                f"funding_source={(self.funding_source
                     if hasattr(self, 'funding_source') else None)!s}, "
                f"retry_info={(self.retry_info
                     if hasattr(self, 'retry_info') else None)!s})")
...
class GetCashTransactionResponse(GetTransactionResponse):
    ...
    def from_dictionary(cls,
        ...
        transaction_type =\
            dictionary.get("transaction_type")\
            if dictionary.get("transaction_type") else "cash"
        id = dictionary.get("id") if "id" in dictionary.keys() else APIHelper.SKIP
        if "gateway_response" in dictionary.keys():
            gateway_response = GetGatewayResponseResponse.from_dictionary(dictionary.get("gateway_response")) if dictionary.get("gateway_response") else None
        else:
...
class GetPrivateLabelTransactionResponse(GetTransactionResponse):
    ...
    def from_dictionary(cls,
        ...
        installments =\
            ...
            if "installments" in dictionary.keys() else APIHelper.SKIP
        gateway_id =\
            dictionary.get("gateway_id")\
            if "gateway_id" in dictionary.keys() else APIHelper.SKIP
        amount =\
        ...
        transaction_type =\
            dictionary.get("transaction_type")\
            if dictionary.get("transaction_type") else "private_label"
        id = dictionary.get("id") if "id" in dictionary.keys() else APIHelper.SKIP
        if "gateway_response" in dictionary.keys():
            gateway_response = GetGatewayResponseResponse.from_dictionary(dictionary.get("gateway_response")) if dictionary.get("gateway_response") else None
        else:
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"acquirer_return_code={(self.acquirer_return_code
                     if hasattr(self, 'acquirer_return_code') else None)!r}, "
                f"installments={(self.installments
                     if hasattr(self, 'installments') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"acquirer_return_code={(self.acquirer_return_code
                     if hasattr(self, 'acquirer_return_code') else None)!s}, "
                f"installments={(self.installments
                     if hasattr(self, 'installments') else None)!s})")
...
class GetCreditCardTransactionResponse(GetTransactionResponse):
    ...
    def from_dictionary(cls,
        ...
        acquirer_name =\
            dictionary.get("acquirer_name")\
            if dictionary.get("acquirer_name") else APIHelper.SKIP
        acquirer_affiliation_code =\
            dictionary.get("acquirer_affiliation_code")\
            if "acquirer_affiliation_code" in dictionary.keys() else APIHelper.SKIP
        acquirer_tid =\
            dictionary.get("acquirer_tid")\
            if dictionary.get("acquirer_tid") else APIHelper.SKIP
        acquirer_nsu =\
            dictionary.get("acquirer_nsu")\
            if dictionary.get("acquirer_nsu") else APIHelper.SKIP
        acquirer_auth_code =\
            dictionary.get("acquirer_auth_code")\
            if "acquirer_auth_code" in dictionary.keys() else APIHelper.SKIP
        operation_type =\
        ...
        transaction_type =\
            dictionary.get("transaction_type")\
            if dictionary.get("transaction_type") else "credit_card"
        id = dictionary.get("id") if "id" in dictionary.keys() else APIHelper.SKIP
        if "gateway_response" in dictionary.keys():
            gateway_response = GetGatewayResponseResponse.from_dictionary(dictionary.get("gateway_response")) if dictionary.get("gateway_response") else None
        else:
...
class GetPixTransactionResponse(GetTransactionResponse):
    ...
    def from_dictionary(cls,
        ...
        qr_code_url =\
            ...
            if "qr_code_url" in dictionary.keys() else APIHelper.SKIP
        ...
        end_to_end_id =\
            ...
            if "end_to_end_id" in dictionary.keys() else APIHelper.SKIP
        ...
        pix_provider_tid =\
            ...
            if "pix_provider_tid" in dictionary.keys() else APIHelper.SKIP
        gateway_id =\
            dictionary.get("gateway_id")\
            if "gateway_id" in dictionary.keys() else APIHelper.SKIP
        amount =\
        ...
        transaction_type =\
            dictionary.get("transaction_type")\
            if dictionary.get("transaction_type") else "pix"
        id = dictionary.get("id") if "id" in dictionary.keys() else APIHelper.SKIP
        if "gateway_response" in dictionary.keys():
            gateway_response = GetGatewayResponseResponse.from_dictionary(dictionary.get("gateway_response")) if dictionary.get("gateway_response") else None
        else:
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"qr_code={(self.qr_code
                     if hasattr(self, 'qr_code') else None)!r}, "
                f"qr_code_url={(self.qr_code_url
                     if hasattr(self, 'qr_code_url') else None)!r}, "
                ...
                f"end_to_end_id={(self.end_to_end_id
                     if hasattr(self, 'end_to_end_id') else None)!r}, "
                f"payer={(self.payer if hasattr(self, 'payer') else None)!r}, "
                f"pix_provider_tid={(self.pix_provider_tid
                     if hasattr(self, 'pix_provider_tid') else None)!r})")
