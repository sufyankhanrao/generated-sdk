...
class GetRecipientResponse(object):
    ...
    def from_dictionary(cls,
        ...
        payment_mode =\
            ...
            if dictionary.get("payment_mode") else "bank_transfer"
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"gateway_recipients={(self.gateway_recipients
                     if hasattr(self, 'gateway_recipients') else None)!r}, "
                f"metadata={(self.metadata
                     if hasattr(self, 'metadata') else None)!r}, "
                f"automatic_anticipation_settings={(self.automatic_anticipation_settings
                     if hasattr(self, 'automatic_anticipation_settings') else None)!r}, "
                f"transfer_settings={(self.transfer_settings
                     if hasattr(self, 'transfer_settings') else None)!r}, "
                f"code={(self.code if hasattr(self, 'code') else None)!r}, "
                f"payment_mode={(self.payment_mode
                     if hasattr(self, 'payment_mode') else None)!r}, "
                f"register_information={(self.register_information
                     if hasattr(self, 'register_information') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"gateway_recipients={(self.gateway_recipients
                     if hasattr(self, 'gateway_recipients') else None)!s}, "
                f"metadata={(self.metadata
                     if hasattr(self, 'metadata') else None)!s}, "
                f"automatic_anticipation_settings={(self.automatic_anticipation_settings
                     if hasattr(self, 'automatic_anticipation_settings') else None)!s}, "
                f"transfer_settings={(self.transfer_settings
                     if hasattr(self, 'transfer_settings') else None)!s}, "
                f"code={(self.code if hasattr(self, 'code') else None)!s}, "
                f"payment_mode={(self.payment_mode
                     if hasattr(self, 'payment_mode') else None)!s}, "
                f"register_information={(self.register_information
                     if hasattr(self, 'register_information') else None)!s})")
