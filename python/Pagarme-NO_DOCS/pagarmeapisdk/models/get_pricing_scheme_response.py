...
class GetPricingSchemeResponse(object):
    ...
    def from_dictionary(cls,
        ...
        scheme_type =\
            ...
            if "scheme_type" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"scheme_type={(self.scheme_type
                     if hasattr(self, 'scheme_type') else None)!r}, "
                f"price_brackets={(self.price_brackets
                     if hasattr(self, 'price_brackets') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"scheme_type={(self.scheme_type
                     if hasattr(self, 'scheme_type') else None)!s}, "
                f"price_brackets={(self.price_brackets
                     if hasattr(self, 'price_brackets') else None)!s}, "
                f"minimum_price={(self.minimum_price
