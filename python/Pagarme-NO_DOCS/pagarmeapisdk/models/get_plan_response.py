...
class GetPlanResponse(object):
    ...
    def from_dictionary(cls,
        ...
        payment_methods =\
            ...
            if "payment_methods" in dictionary.keys() else APIHelper.SKIP
        installments =\
        ...
        billing_days =\
            ...
            if "billing_days" in dictionary.keys() else APIHelper.SKIP
        shippable =\
        ...
        trial_period_days =\
            ...
            if "trial_period_days" in dictionary.keys() else APIHelper.SKIP
        minimum_price =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"billing_days={(self.billing_days
                     if hasattr(self, 'billing_days') else None)!r}, "
                f"shippable={(self.shippable
                     if hasattr(self, 'shippable') else None)!r}, "
                f"metadata={(self.metadata
                     if hasattr(self, 'metadata') else None)!r}, "
                f"trial_period_days={(self.trial_period_days
                     if hasattr(self, 'trial_period_days') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"billing_days={(self.billing_days
                     if hasattr(self, 'billing_days') else None)!s}, "
                f"shippable={(self.shippable
                     if hasattr(self, 'shippable') else None)!s}, "
                f"metadata={(self.metadata
                     if hasattr(self, 'metadata') else None)!s}, "
                f"trial_period_days={(self.trial_period_days
                     if hasattr(self, 'trial_period_days') else None)!s}, "
                f"minimum_price={(self.minimum_price
