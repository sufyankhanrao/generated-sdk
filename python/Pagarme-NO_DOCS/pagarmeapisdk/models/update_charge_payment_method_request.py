...
class UpdateChargePaymentMethodRequest(object):
    ...
    def __init__(self,
                 ...
                 bank_transfer=None,
                 private_label=None):
        """Initialize a UpdateChargePaymentMethodRequest instance."""
