...
class GetPixBankAccountResponse(object):
    ...
    def from_dictionary(cls,
        ...
        bank_name =\
            ...
            if "bank_name" in dictionary.keys() else APIHelper.SKIP
        ispb =\
            dictionary.get("ispb")\
            if "ispb" in dictionary.keys() else APIHelper.SKIP
        branch_code =\
            dictionary.get("branch_code")\
            if "branch_code" in dictionary.keys() else APIHelper.SKIP
        account_number =\
