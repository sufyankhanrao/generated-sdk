...
from pagarmeapisdk.models.get_movement_object_base_response import (
...
class GetBalanceOperationResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a GetBalanceOperationResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        balance_amount =\
            dictionary.get("balance_amount")\
            if "balance_amount" in dictionary.keys() else APIHelper.SKIP
        balance_old_amount =\
            dictionary.get("balance_old_amount")\
            if "balance_old_amount" in dictionary.keys() else APIHelper.SKIP
        mtype =\
            dictionary.get("type")\
        ...
        movement_object = GetMovementObjectBaseResponse.from_dictionary(
            dictionary.get("movement_object"))\
            if "movement_object" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"balance_amount={(self.balance_amount
                     if hasattr(self, 'balance_amount') else None)!r}, "
                f"balance_old_amount={(self.balance_old_amount
                     if hasattr(self, 'balance_old_amount') else None)!r}, "
                f"mtype={(self.mtype if hasattr(self, 'mtype') else None)!r}, "
                f"amount={(self.amount if hasattr(self, 'amount') else None)!r}, "
                f"fee={(self.fee if hasattr(self, 'fee') else None)!r}, "
                f"created_at={(self.created_at
                     if hasattr(self, 'created_at') else None)!r}, "
                f"movement_object={(self.movement_object
                     if hasattr(self, 'movement_object') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"balance_amount={(self.balance_amount
                     if hasattr(self, 'balance_amount') else None)!s}, "
                f"balance_old_amount={(self.balance_old_amount
                     if hasattr(self, 'balance_old_amount') else None)!s}, "
                ...
                f"movement_object={(self.movement_object
                     if hasattr(self, 'movement_object') else None)!s})")
