...
class GetBalanceResponse(object):
    ...
    def from_dictionary(cls,
        ...
        available_amount =\
            ...
            if "available_amount" in dictionary.keys() else APIHelper.SKIP
        ...
        transferred_amount =\
            ...
            if "transferred_amount" in dictionary.keys() else APIHelper.SKIP
        waiting_funds_amount =\
            dictionary.get("waiting_funds_amount")\
            if "waiting_funds_amount" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"available_amount={(self.available_amount
                     if hasattr(self, 'available_amount') else None)!r}, "
                f"recipient={(self.recipient
                     if hasattr(self, 'recipient') else None)!r}, "
                f"transferred_amount={(self.transferred_amount
                     if hasattr(self, 'transferred_amount') else None)!r}, "
                f"waiting_funds_amount={(self.waiting_funds_amount
                     if hasattr(self, 'waiting_funds_amount') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"available_amount={(self.available_amount
                     if hasattr(self, 'available_amount') else None)!s}, "
                f"recipient={(self.recipient
                     if hasattr(self, 'recipient') else None)!s}, "
                f"transferred_amount={(self.transferred_amount
                     if hasattr(self, 'transferred_amount') else None)!s}, "
                f"waiting_funds_amount={(self.waiting_funds_amount
                     if hasattr(self, 'waiting_funds_amount') else None)!s})")
