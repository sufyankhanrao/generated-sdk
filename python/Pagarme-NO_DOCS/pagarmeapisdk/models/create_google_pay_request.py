...
from pagarmeapisdk.models.create_google_pay_intermediate_signing_key_request import (
...
class CreateGooglePayRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a CreateGooglePayRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        version =\
            ...
            if "version" in dictionary.keys() else APIHelper.SKIP
        data =\
            dictionary.get("data")\
        ...
        signed_message =\
            dictionary.get("signed_message")\
            if "signed_message" in dictionary.keys() else APIHelper.SKIP
        merchant_identifier =\
            dictionary.get("merchant_identifier")\
            if "merchant_identifier" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"intermediate_signing_key={(self.intermediate_signing_key
                     if hasattr(self, 'intermediate_signing_key') else None)!r}, "
                f"signature={(self.signature
                     if hasattr(self, 'signature') else None)!r}, "
                f"signed_message={(self.signed_message
                     if hasattr(self, 'signed_message') else None)!r}, "
                f"merchant_identifier={(self.merchant_identifier
                     if hasattr(self, 'merchant_identifier') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"intermediate_signing_key={(self.intermediate_signing_key
                     if hasattr(self, 'intermediate_signing_key') else None)!s}, "
                f"signature={(self.signature
                     if hasattr(self, 'signature') else None)!s}, "
                f"signed_message={(self.signed_message
                     if hasattr(self, 'signed_message') else None)!s}, "
                f"merchant_identifier={(self.merchant_identifier
                     if hasattr(self, 'merchant_identifier') else None)!s})")
