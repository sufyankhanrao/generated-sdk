...
class CreateCardRequest(object):
    ...
    def from_dictionary(cls,
        ...
        holder_name =\
            ...
            if dictionary.get("holder_name") else APIHelper.SKIP
        exp_month =\
            dictionary.get("exp_month")\
            if dictionary.get("exp_month") else APIHelper.SKIP
        exp_year =\
            dictionary.get("exp_year")\
            if dictionary.get("exp_year") else APIHelper.SKIP
        ...
        billing_address_id =\
            ...
            if dictionary.get("billing_address_id") else APIHelper.SKIP
        metadata =\
        ...
        options = CreateCardOptionsRequest.from_dictionary(
            dictionary.get("options"))\
            if "options" in dictionary.keys() else APIHelper.SKIP
        holder_document =\
            dictionary.get("holder_document")\
            if dictionary.get("holder_document") else APIHelper.SKIP
        private_label =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"billing_address_id={(self.billing_address_id
                     if hasattr(self, 'billing_address_id') else None)!r}, "
                f"metadata={(self.metadata
                     if hasattr(self, 'metadata') else None)!r}, "
                f"mtype={(self.mtype if hasattr(self, 'mtype') else None)!r}, "
                f"options={(self.options
                     if hasattr(self, 'options') else None)!r}, "
                f"holder_document={(self.holder_document
                     if hasattr(self, 'holder_document') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"billing_address_id={(self.billing_address_id
                     if hasattr(self, 'billing_address_id') else None)!s}, "
                f"metadata={(self.metadata
                ...
                f"holder_document={(self.holder_document
                     if hasattr(self, 'holder_document') else None)!s}, "
                f"private_label={(self.private_label
