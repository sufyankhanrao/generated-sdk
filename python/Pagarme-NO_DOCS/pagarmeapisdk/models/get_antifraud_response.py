...
class GetAntifraudResponse(object):
    ...
    def from_dictionary(cls,
        ...
        return_code =\
            ...
            if "return_code" in dictionary.keys() else APIHelper.SKIP
        return_message =\
            dictionary.get("return_message")\
            if "return_message" in dictionary.keys() else APIHelper.SKIP
        provider_name =\
            dictionary.get("provider_name")\
            if "provider_name" in dictionary.keys() else APIHelper.SKIP
        score =\
            dictionary.get("score")\
            if "score" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"return_code={(self.return_code
                     if hasattr(self, 'return_code') else None)!r}, "
                f"return_message={(self.return_message
                     if hasattr(self, 'return_message') else None)!r}, "
                f"provider_name={(self.provider_name
                     if hasattr(self, 'provider_name') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"return_code={(self.return_code
                     if hasattr(self, 'return_code') else None)!s}, "
                f"return_message={(self.return_message
                     if hasattr(self, 'return_message') else None)!s}, "
                f"provider_name={(self.provider_name
                     if hasattr(self, 'provider_name') else None)!s}, "
