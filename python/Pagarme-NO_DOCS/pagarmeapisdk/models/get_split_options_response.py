...
class GetSplitOptionsResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a GetSplitOptionsResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        liable =\
            ...
            if "liable" in dictionary.keys() else APIHelper.SKIP
        charge_processing_fee =\
            dictionary.get("charge_processing_fee")\
            if "charge_processing_fee" in dictionary.keys() else APIHelper.SKIP
        charge_remainder_fee =\
            dictionary.get("charge_remainder_fee")\
            if "charge_remainder_fee" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"charge_processing_fee={(self.charge_processing_fee
                     if hasattr(self, 'charge_processing_fee') else None)!r}, "
                f"charge_remainder_fee={(self.charge_remainder_fee
                     if hasattr(self, 'charge_remainder_fee') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"charge_processing_fee={(self.charge_processing_fee
                     if hasattr(self, 'charge_processing_fee') else None)!s}, "
                f"charge_remainder_fee={(self.charge_remainder_fee
                     if hasattr(self, 'charge_remainder_fee') else None)!s})")
