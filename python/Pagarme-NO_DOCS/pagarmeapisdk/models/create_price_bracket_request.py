...
class CreatePriceBracketRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a CreatePriceBracketRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        start_quantity =\
            ...
            if dictionary.get("start_quantity") else None
        price = dictionary.get("price") if dictionary.get("price") else None
        end_quantity =\
            dictionary.get("end_quantity")\
            if dictionary.get("end_quantity") else APIHelper.SKIP
        overage_price =\
            dictionary.get("overage_price")\
            if dictionary.get("overage_price") else APIHelper.SKIP
