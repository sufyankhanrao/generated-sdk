...
class CreateCancelChargeRequest(object):
    ...
    def from_dictionary(cls,
        ...
        operation_reference =\
            ...
            if dictionary.get("operation_reference") else None
        amount =\
        ...
        if dictionary.get("split") is not None:
            ...
            split = APIHelper.SKIP
        bank_account = CreateBankAccountRefundingDTO.from_dictionary(
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"split_rules={(self.split_rules
                     if hasattr(self, 'split_rules') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"split_rules={(self.split_rules
                     if hasattr(self, 'split_rules') else None)!s}, "
