...
class GetRetryTransactionInformationResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a GetRetryTransactionInformationResponse instance."""
        # Initialize members of the class
        self.brand_failure_return_code = brand_failure_return_code
        self.transaction_limit = transaction_limit
        self.transaction_date_limit =\
             APIHelper.apply_datetime_converter(
            transaction_date_limit, APIHelper.RFC3339DateTime) if transaction_date_limit else None
    ...
    def from_dictionary(cls,
        ...
        brand_failure_return_code =\
            dictionary.get("brand_failure_return_code")\
            if dictionary.get("brand_failure_return_code") else None
        transaction_limit =\
            dictionary.get("transaction_limit")\
            if dictionary.get("transaction_limit") else None
        transaction_date_limit = APIHelper.RFC3339DateTime.from_value(
            dictionary.get("transaction_date_limit")).datetime\
            if dictionary.get("transaction_date_limit") else None
