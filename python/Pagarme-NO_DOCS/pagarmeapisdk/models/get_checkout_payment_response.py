...
from pagarmeapisdk.models.get_checkout_bank_transfer_payment_response import (
    GetCheckoutBankTransferPaymentResponse,
)
from pagarmeapisdk.models.get_checkout_boleto_payment_response import (
    GetCheckoutBoletoPaymentResponse,
)
from pagarmeapisdk.models.get_checkout_credit_card_payment_response import (
    GetCheckoutCreditCardPaymentResponse,
)
from pagarmeapisdk.models.get_checkout_debit_card_payment_response import (
    GetCheckoutDebitCardPaymentResponse,
)
from pagarmeapisdk.models.get_checkout_pix_payment_response import (
...
class GetCheckoutPaymentResponse(object):
    ...
    def __init__(self,
                 ...
                 pix=APIHelper.SKIP):
        """Initialize a GetCheckoutPaymentResponse instance."""
        ...
        if closed_at is not APIHelper.SKIP:
            self.closed_at =\
                 APIHelper.apply_datetime_converter(
                closed_at, APIHelper.RFC3339DateTime) if closed_at else None
    ...
    def from_dictionary(cls,
        ...
        default_payment_method =\
            dictionary.get("default_payment_method")\
            if "default_payment_method" in dictionary.keys() else APIHelper.SKIP
        success_url =\
            dictionary.get("success_url")\
            if "success_url" in dictionary.keys() else APIHelper.SKIP
        payment_url =\
            dictionary.get("payment_url")\
            if "payment_url" in dictionary.keys() else APIHelper.SKIP
        gateway_affiliation_id =\
            dictionary.get("gateway_affiliation_id")\
            if "gateway_affiliation_id" in dictionary.keys() else APIHelper.SKIP
        accepted_payment_methods =\
            dictionary.get("accepted_payment_methods")\
            if "accepted_payment_methods" in dictionary.keys() else APIHelper.SKIP
        status =\
            dictionary.get("status")\
            if "status" in dictionary.keys() else APIHelper.SKIP
        skip_checkout_success_page =\
            dictionary.get("skip_checkout_success_page")\
            if "skip_checkout_success_page" in dictionary.keys() else APIHelper.SKIP
        ...
        if "canceled_at" in dictionary.keys():
            ...
            canceled_at = APIHelper.SKIP
        customer_editable =\
            dictionary.get("customer_editable")\
            if "customer_editable" in dictionary.keys() else APIHelper.SKIP
        ...
        if "boleto" in dictionary.keys():
            ...
            boleto = APIHelper.SKIP
        billing_address_editable =\
            dictionary.get("billing_address_editable")\
            if "billing_address_editable" in dictionary.keys() else APIHelper.SKIP
        ...
        shippable =\
            ...
            if "shippable" in dictionary.keys() else APIHelper.SKIP
        ...
        if "bank_transfer" in dictionary.keys():
            ...
            bank_transfer = APIHelper.SKIP
        accepted_brands =\
            dictionary.get("accepted_brands")\
            if "accepted_brands" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"default_payment_method={(self.default_payment_method
                     if hasattr(self, 'default_payment_method') else None)!r}, "
                f"success_url={(self.success_url
                     if hasattr(self, 'success_url') else None)!r}, "
                f"payment_url={(self.payment_url
                     if hasattr(self, 'payment_url') else None)!r}, "
                f"gateway_affiliation_id={(self.gateway_affiliation_id
                     if hasattr(self, 'gateway_affiliation_id') else None)!r}, "
                f"accepted_payment_methods={(self.accepted_payment_methods
                     if hasattr(self, 'accepted_payment_methods') else None)!r}, "
                f"status={(self.status if hasattr(self, 'status') else None)!r}, "
                f"skip_checkout_success_page={(self.skip_checkout_success_page
                     if hasattr(self, 'skip_checkout_success_page') else None)!r}, "
                ...
                f"customer_editable={(self.customer_editable
                     if hasattr(self, 'customer_editable') else None)!r}, "
                f"customer={(self.customer
                     if hasattr(self, 'customer') else None)!r}, "
                f"billingaddress={(self.billingaddress
                     if hasattr(self, 'billingaddress') else None)!r}, "
                ...
                f"billing_address_editable={(self.billing_address_editable
                     if hasattr(self, 'billing_address_editable') else None)!r}, "
                f"shipping={(self.shipping
                     if hasattr(self, 'shipping') else None)!r}, "
                f"shippable={(self.shippable
                     if hasattr(self, 'shippable') else None)!r}, "
                f"closed_at={(self.closed_at
                     if hasattr(self, 'closed_at') else None)!r}, "
                f"expires_at={(self.expires_at
                     if hasattr(self, 'expires_at') else None)!r}, "
                f"currency={(self.currency
                     if hasattr(self, 'currency') else None)!r}, "
                f"debit_card={(self.debit_card
                     if hasattr(self, 'debit_card') else None)!r}, "
                f"bank_transfer={(self.bank_transfer
                     if hasattr(self, 'bank_transfer') else None)!r}, "
                f"accepted_brands={(self.accepted_brands
                     if hasattr(self, 'accepted_brands') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"default_payment_method={(self.default_payment_method
                     if hasattr(self, 'default_payment_method') else None)!s}, "
                f"success_url={(self.success_url
                     if hasattr(self, 'success_url') else None)!s}, "
                f"payment_url={(self.payment_url
                     if hasattr(self, 'payment_url') else None)!s}, "
                f"gateway_affiliation_id={(self.gateway_affiliation_id
                     if hasattr(self, 'gateway_affiliation_id') else None)!s}, "
                f"accepted_payment_methods={(self.accepted_payment_methods
                     if hasattr(self, 'accepted_payment_methods') else None)!s}, "
                f"status={(self.status if hasattr(self, 'status') else None)!s}, "
                f"skip_checkout_success_page={(self.skip_checkout_success_page
                     if hasattr(self, 'skip_checkout_success_page') else None)!s}, "
                f"created_at={(self.created_at
                ...
                f"customer_editable={(self.customer_editable
                     if hasattr(self, 'customer_editable') else None)!s}, "
                f"customer={(self.customer
                     if hasattr(self, 'customer') else None)!s}, "
                f"billingaddress={(self.billingaddress
                     if hasattr(self, 'billingaddress') else None)!s}, "
                f"credit_card={(self.credit_card
                     if hasattr(self, 'credit_card') else None)!s}, "
                f"boleto={(self.boleto if hasattr(self, 'boleto') else None)!s}, "
                f"billing_address_editable={(self.billing_address_editable
                     if hasattr(self, 'billing_address_editable') else None)!s}, "
                f"shipping={(self.shipping
                     if hasattr(self, 'shipping') else None)!s}, "
                f"shippable={(self.shippable
                     if hasattr(self, 'shippable') else None)!s}, "
                f"closed_at={(self.closed_at
                     if hasattr(self, 'closed_at') else None)!s}, "
                f"expires_at={(self.expires_at
                     if hasattr(self, 'expires_at') else None)!s}, "
                f"currency={(self.currency
                     if hasattr(self, 'currency') else None)!s}, "
                f"debit_card={(self.debit_card
                     if hasattr(self, 'debit_card') else None)!s}, "
                f"bank_transfer={(self.bank_transfer
                     if hasattr(self, 'bank_transfer') else None)!s}, "
                f"accepted_brands={(self.accepted_brands
                     if hasattr(self, 'accepted_brands') else None)!s}, "
