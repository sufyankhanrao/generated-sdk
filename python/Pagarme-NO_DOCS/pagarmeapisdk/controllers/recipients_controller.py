...
from pagarmeapisdk.models.create_kyc_link_response import (
    CreateKYCLinkResponse,
)
from pagarmeapisdk.models.get_anticipation_limit_response import (
    GetAnticipationLimitResponse,
)
from pagarmeapisdk.models.get_anticipation_response import (
    GetAnticipationResponse,
)
from pagarmeapisdk.models.get_balance_response import (
    GetBalanceResponse,
)
from pagarmeapisdk.models.get_recipient_response import (
    GetRecipientResponse,
)
from pagarmeapisdk.models.get_transfer_response import (
    GetTransferResponse,
)
from pagarmeapisdk.models.get_withdraw_response import (
    GetWithdrawResponse,
)
from pagarmeapisdk.models.list_anticipation_response import (
    ListAnticipationResponse,
)
from pagarmeapisdk.models.list_recipient_response import (
    ListRecipientResponse,
)
from pagarmeapisdk.models.list_transfer_response import (
    ListTransferResponse,
)
from pagarmeapisdk.models.list_withdrawals import (
    ListWithdrawals,
)
...
class RecipientsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize RecipientsController object."""
    ...
    def update_recipient(self,
        ...
        """Perform a PUT request to /recipients/{recipient_id}.
    ...
    def get_withdraw_by_id(self,
        ...
        Args:
            recipient_id (str): The request template parameter.
            withdrawal_id (str): The request template parameter.
    ...
    def get_recipient(self,
                      recipient_id):
        """Perform a GET request to /recipients/{recipient_id}.
    ...
    def get_balance(self,
                    recipient_id):
        """Perform a GET request to /recipients/{recipient_id}/balance.
    ...
    def get_recipients(self,
                       page=None,
                       size=None):
        """Perform a GET request to /recipients.
    ...
    def update_recipient_default_bank_account(self,
                                              ...
                                              request,
                                              idempotency_key=None):
        """Perform a PATCH request to /recipients/{recipient_id}/default-bank-account.
    ...
    def get_transfers(self,
                      ...
                      created_since=None,
                      created_until=None):
        """Perform a GET request to /recipients/{recipient_id}/transfers.
    ...
    def create_withdraw(self,
                        recipient_id,
                        request):
        """Perform a POST request to /recipients/{recipient_id}/withdrawals.

        Args:
            recipient_id (str): The request template parameter.
            request (CreateWithdrawRequest): The request body parameter.
    ...
    def update_recipient_transfer_settings(self,
                                           ...
                                           request,
                                           idempotency_key=None):
        """Perform a PATCH request to /recipients/{recipient_id}/transfer-settings.

        Args:
            recipient_id (str): Recipient Identificator
            request (UpdateTransferSettingsRequest): The request body
                parameter.
            idempotency_key (str, optional): The request header parameter.
    ...
    def get_recipient_by_code(self,
                              code):
        """Perform a GET request to /recipients/{code}.
    ...
    def create_transfer(self,
                        ...
                        request,
                        idempotency_key=None):
        """Perform a POST request to /recipients/{recipient_id}/transfers.
    ...
    def create_recipient(self,
                         request,
                         idempotency_key=None):
        """Perform a POST request to /recipients.
    ...
    def get_default_recipient(self):
        """Perform a GET request to /recipients/default.
    ...
    def create_anticipation(self,
                            ...
                            request,
                            idempotency_key=None):
        """Perform a POST request to /recipients/{recipient_id}/anticipations.
    ...
    def get_anticipation_limits(self,
                                ...
                                timeframe,
                                payment_date):
        """Perform a GET request to /recipients/{recipient_id}/anticipation_limits.
    ...
    def update_recipient_metadata(self,
                                  ...
                                  request,
                                  idempotency_key=None):
        """Perform a PATCH request to /recipients/{recipient_id}/metadata.
    ...
    def get_anticipations(self,
                          ...
                          created_since=None,
                          created_until=None):
        """Perform a GET request to /recipients/{recipient_id}/anticipations.
    ...
    def get_withdrawals(self,
                        ...
                        created_since=None,
                        created_until=None):
        """Perform a GET request to /recipients/{recipient_id}/withdrawals.
    ...
    def create_kyc_link(self,
                        recipient_id):
        """Perform a POST request to /recipients/{recipient_id}/kyc_link.
