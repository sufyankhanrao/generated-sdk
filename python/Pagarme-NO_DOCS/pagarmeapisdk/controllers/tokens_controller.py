...
from pagarmeapisdk.models.get_token_response import (
    GetTokenResponse,
)
...
class TokensController(BaseController):
    ...
    def get_token(self,
                  id,
                  public_key):
        """Perform a GET request to /tokens/{id}?appId={public_key}.
    ...
    def create_token(self,
        ...
        """Perform a POST request to /tokens?appId={public_key}.
