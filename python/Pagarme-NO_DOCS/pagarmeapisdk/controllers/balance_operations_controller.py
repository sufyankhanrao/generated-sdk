...
from pagarmeapisdk.models.get_balance_operation_response import (
    GetBalanceOperationResponse,
)
from pagarmeapisdk.models.list_balance_operation_response import (
...
class BalanceOperationsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize BalanceOperationsController object."""
        super(BalanceOperationsController, self).__init__(config)

    def get_balance_operation_by_id(self,
                                    id):
        """Perform a GET request to /balance/operations/{id}.
    ...
    def get_balance_operations(self,
                               ...
                               created_until=None,
                               recipient_id=None):
        """Perform a GET request to /balance/operations.
