...
client = MultiplesimilarauthtypesClient.from_environment(
...
BREEZE_HEADER_TOKEN=ExampleToken
BREEZE_HEADER_BREEZE_API_TOKEN=ExampleBreezeApiToken
BREEZE_HEADER_X_API_KEY=ExampleXApiKey
CUSTOM_HEADER_TOKEN=ExampleToken
CUSTOM_HEADER_API_KEY=ExampleApiKey
HTTP_QUERY_TOKEN=ExampleToken
HTTP_QUERY_API_KEY=ExampleApiKey
