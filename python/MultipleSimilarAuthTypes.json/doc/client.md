...
| breeze_header_credentials | [`BreezeHeaderCredentials`](auth/custom-header-signature.md) | The credential object for Custom Header Signature |
| custom_header_credentials | [`CustomHeaderCredentials`](auth/custom-header-signature-1.md) | The credential object for Custom Header Signature |
| http_query_credentials | [`HttpQueryCredentials`](auth/custom-query-parameter.md) | The credential object for Custom Query Parameter |
...
## MultipleSimilarAuthTypes Client
...
| Name | Description |
|  --- | --- |
| custom_header_authentication | Gets CustomHeaderAuthenticationController |
| custom_query_and_header_authentication | Gets CustomQueryAndHeaderAuthenticationController |
