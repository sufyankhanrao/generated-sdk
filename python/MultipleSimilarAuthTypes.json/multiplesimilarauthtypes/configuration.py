...
from multiplesimilarauthtypes.http.proxy_settings import (
    ProxySettings,
)
from multiplesimilarauthtypes.models.suite_code_enum import (
    SuiteCodeEnum,
)
...
class Configuration(HttpClientConfiguration):
    ...
    @property
    def breeze_header_credentials(self):
        """Return current breeze_header_credentials."""
        return self._breeze_header_credentials

    @property
    def custom_header_credentials(self):
        """Return current custom_header_credentials."""
        return self._custom_header_credentials

    @property
    def http_query_credentials(self):
        """Return current http_query_credentials."""
        return self._http_query_credentials
    ...
    def __init__(self, http_client_instance=None,
        ...
        self._breeze_header_credentials = breeze_header_credentials

        # The object holding Custom Header Signature credentials
        self._custom_header_credentials = custom_header_credentials

        # The object holding Custom Query Parameter credentials
        self._http_query_credentials = http_query_credentials
    ...
    def clone_with(self, http_client_instance=None,
        ...
        breeze_header_credentials =\
            (breeze_header_credentials
            or self.breeze_header_credentials)
        custom_header_credentials =\
            (custom_header_credentials
            or self.custom_header_credentials)
        http_query_credentials = http_query_credentials or self.http_query_credentials
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        default_config = cls(
            ...
            breeze_header_credentials=BreezeHeaderCredentials.from_environment(),
            custom_header_credentials=CustomHeaderCredentials.from_environment(),
            http_query_credentials=HttpQueryCredentials.from_environment(),
        )
