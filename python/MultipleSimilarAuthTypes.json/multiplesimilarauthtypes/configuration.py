...
class Configuration(HttpClientConfiguration):
    ...
    def clone_with(self, http_client_instance=None,
        ...
        breeze_header_credentials = breeze_header_credentials or self.breeze_header_credentials
        custom_header_credentials = custom_header_credentials or self.custom_header_credentials
