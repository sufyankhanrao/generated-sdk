...
from mdnotesccg.configuration import (
    Configuration,
    Environment,
)
...
from mdnotesccg.controllers.service_controller import (
    ServiceController,
)
from mdnotesccg.controllers.user_controller import (
    UserController,
)
...
class MdnotesccgClient(object):
    """Client that provide access to the MdnotesccgClient APIs."""
    ...
    def __init__(self, http_client_instance=None,
                 ...
                 config=None):
        """Initialize a new instance of MdnotesccgClient."""
