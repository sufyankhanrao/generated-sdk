...
from jwttester.controllers.api_controller import (
    APIController,
)
...
class JwttesterClient(object):
    """Client that provide access to the JwttesterClient APIs."""
    ...
    def __init__(self, http_client_instance=None,
        ...
        """Initialize a new instance of JwttesterClient."""
