...
from greenbyteapi.http.proxy_settings import (
    ProxySettings,
)
...
class Configuration(HttpClientConfiguration):
    ...
    @property
    def x_api_key(self):
        """Return XApiKey from CustomHeaderAuthenticationCredentials."""
        return self._custom_header_authentication_credentials.x_api_key
    ...
    def __init__(self, http_client_instance=None,
        ...
        self._custom_header_authentication_credentials =\
            self.create_auth_credentials_object(
                x_api_key, custom_header_authentication_credentials)
    ...
    def clone_with(self, http_client_instance=None,
                   ...
                   retry_statuses=None, retry_methods=None, proxy_settings=None,
                   environment=None, customer=None, x_api_key=None,
        ...
        return Configuration(
            ...
            environment=environment, customer=customer,
    ...
    def get_base_uri(self, server=Server.DEFAULT):
        ...
        """
        parameters = {
            "customer": {"value": self.customer, "encode": False},
        }
    ...
    @staticmethod
    def create_auth_credentials_object(x_api_key,
                                       custom_header_authentication_credentials,
                                       stack_level=4):
        ...
        warnings.warn(message=("The 'x_api_key' params are deprecated. Use 'cus"
                               "tom_header_authentication_credentials' param in"
                               "stead."),
        ...
        return CustomHeaderAuthenticationCredentials(x_api_key)
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        customer = os.getenv("CUSTOMER", "intro")
