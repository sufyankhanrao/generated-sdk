...
class PredictStatusResolved(object):
    ...
    def from_dictionary(cls,
        ...
        if 'timestampResolved' in dictionary.keys():
            ...
            timestamp_resolved = APIHelper.SKIP
        action_taken = dictionary.get("actionTaken") if dictionary.get("actionTaken") else APIHelper.SKIP
        component_resolved = Component.from_dictionary(dictionary.get('componentResolved')) if 'componentResolved' in dictionary.keys() else APIHelper.SKIP
        resolved_by = dictionary.get("resolvedBy") if dictionary.get("resolvedBy") else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'action_taken={(self.action_taken if hasattr(self, "action_taken") else None)!r}, '
                f'component_resolved={(self.component_resolved if hasattr(self, "component_resolved") else None)!r}, '
                f'resolved_by={(self.resolved_by if hasattr(self, "resolved_by") else None)!r})')

    def __str__(self):
        return (f'{self.__class__.__name__}('
                f'timestamp_resolved={(self.timestamp_resolved if hasattr(self, "timestamp_resolved") else None)!s}, '
                f'action_taken={(self.action_taken if hasattr(self, "action_taken") else None)!s}, '
                f'component_resolved={(self.component_resolved if hasattr(self, "component_resolved") else None)!s}, '
                f'resolved_by={(self.resolved_by if hasattr(self, "resolved_by") else None)!s})')
