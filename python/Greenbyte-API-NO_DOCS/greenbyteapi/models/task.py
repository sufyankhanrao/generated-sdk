...
class Task(object):
    ...
    def from_dictionary(cls,
        ...
        """
        from greenbyteapi.utilities.union_type_lookup import (
            UnionTypeLookUp,
        )
        ...
        resolved =\
            ...
            if "resolved" in dictionary.keys() else None
        number_of_comments =\
            dictionary.get("numberOfComments")\
            if dictionary.get("numberOfComments") else None
        description =\
            dictionary.get("description")\
            if "description" in dictionary.keys() else APIHelper.SKIP
        category = TaskCategory.from_dictionary(
        ...
        site_ids =\
            dictionary.get("siteIds")\
            if dictionary.get("siteIds") else APIHelper.SKIP
        site_access_ids =\
            dictionary.get("siteAccessIds")\
            if dictionary.get("siteAccessIds") else APIHelper.SKIP
        downtime_event_ids =\
            dictionary.get("downtimeEventIds")\
            if dictionary.get("downtimeEventIds") else APIHelper.SKIP
        status_ids =\
            dictionary.get("statusIds")\
            if dictionary.get("statusIds") else APIHelper.SKIP
        comments = None
        if dictionary.get("comments") is not None:
            comments = [
                TaskComment.from_dictionary(x)
        ...
        if "recurrence" in dictionary.keys():
            ...
            recurrence = APIHelper.SKIP
        main_task_id =\
            dictionary.get("mainTaskId")\
            if "mainTaskId" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"site_ids={(self.site_ids
                     if hasattr(self, 'site_ids') else None)!r}, "
                f"site_access_ids={(self.site_access_ids
                     if hasattr(self, 'site_access_ids') else None)!r}, "
                f"downtime_event_ids={(self.downtime_event_ids
                     if hasattr(self, 'downtime_event_ids') else None)!r}, "
                f"status_ids={(self.status_ids
                     if hasattr(self, 'status_ids') else None)!r}, "
                ...
                f"main_task_id={(self.main_task_id
                     if hasattr(self, 'main_task_id') else None)!r}, "
                f"assignee={(self.assignee
                     if hasattr(self, 'assignee') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"site_ids={(self.site_ids
                     if hasattr(self, 'site_ids') else None)!s}, "
                f"site_access_ids={(self.site_access_ids
                     if hasattr(self, 'site_access_ids') else None)!s}, "
                f"downtime_event_ids={(self.downtime_event_ids
                     if hasattr(self, 'downtime_event_ids') else None)!s}, "
                f"status_ids={(self.status_ids
                     if hasattr(self, 'status_ids') else None)!s}, "
                ...
                f"main_task_id={(self.main_task_id
                     if hasattr(self, 'main_task_id') else None)!s}, "
                f"assignee={(self.assignee
                     if hasattr(self, 'assignee') else None)!s}, "
                f"metadata={(self.metadata
