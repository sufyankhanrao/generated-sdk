...
class WorklogResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a WorklogResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        worklog_item_id =\
            dictionary.get("worklogItemId")\
            if dictionary.get("worklogItemId") else APIHelper.SKIP
        ...
        hours_worked =\
            ...
            if dictionary.get("hoursWorked") else APIHelper.SKIP
        comment =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"worklog_item_id={(self.worklog_item_id
                     if hasattr(self, 'worklog_item_id') else None)!r}, "
                f"timestamp={(self.timestamp
                     if hasattr(self, 'timestamp') else None)!r}, "
                f"site_id={(self.site_id
                     if hasattr(self, 'site_id') else None)!r}, "
                f"hours_worked={(self.hours_worked
                     if hasattr(self, 'hours_worked') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"worklog_item_id={(self.worklog_item_id
                     if hasattr(self, 'worklog_item_id') else None)!s}, "
                f"timestamp={(self.timestamp
                     if hasattr(self, 'timestamp') else None)!s}, "
                f"site_id={(self.site_id
                     if hasattr(self, 'site_id') else None)!s}, "
                f"hours_worked={(self.hours_worked
                     if hasattr(self, 'hours_worked') else None)!s}, "
                f"comment={(self.comment
