...
class AlertItem(object):
    ...
    def from_dictionary(cls,
        ...
        rule_id = dictionary.get("ruleId") if dictionary.get("ruleId") else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'rule_id={(self.rule_id if hasattr(self, "rule_id") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'rule_id={(self.rule_id if hasattr(self, "rule_id") else None)!s}, '
