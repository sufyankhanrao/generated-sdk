...
class TaskComment(object):
    ...
    def __init__(self,
        ...
        self.text = text 
        self.timestamp_created = APIHelper.apply_datetime_converter(timestamp_created, APIHelper.RFC3339DateTime) if timestamp_created else None 
    ...
    def from_dictionary(cls,
        ...
        comment_id = dictionary.get("commentId") if dictionary.get("commentId") else None
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.comment_id,
                                           type_callable=lambda value: isinstance(value, int)) \
                and APIHelper.is_valid_type(value=dictionary.task_id,
                                            type_callable=lambda value: isinstance(value, int)) \
                and APIHelper.is_valid_type(value=dictionary.text,
                                            type_callable=lambda value: isinstance(value, str)) \
                and APIHelper.is_valid_type(value=dictionary.timestamp_created,
                                            type_callable=lambda value: isinstance(value, APIHelper.RFC3339DateTime)) \
                and APIHelper.is_valid_type(value=dictionary.created_by,
        ...
        return APIHelper.is_valid_type(value=dictionary.get('commentId'),
                                       type_callable=lambda value: isinstance(value, int)) \
            and APIHelper.is_valid_type(value=dictionary.get('taskId'),
                                        type_callable=lambda value: isinstance(value, int)) \
            and APIHelper.is_valid_type(value=dictionary.get('text'),
                                        type_callable=lambda value: isinstance(value, str)) \
            and APIHelper.is_valid_type(value=dictionary.get('timestampCreated'),
                                        type_callable=lambda value: isinstance(value, str)) \
            and APIHelper.is_valid_type(value=dictionary.get('createdBy'),
                                        type_callable=lambda value: User.validate(value),
                                        is_model_dict=True)
