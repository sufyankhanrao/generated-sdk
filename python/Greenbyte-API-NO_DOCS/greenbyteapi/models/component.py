...
class Component(object):
    ...
    def from_dictionary(cls,
        ...
        component_id = dictionary.get("componentId") if dictionary.get("componentId") else APIHelper.SKIP
        component_name = dictionary.get("componentName") if dictionary.get("componentName") else APIHelper.SKIP
        component_tag = dictionary.get("componentTag") if dictionary.get("componentTag") else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'component_tag={(self.component_tag if hasattr(self, "component_tag") else None)!r})')
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'component_tag={(self.component_tag if hasattr(self, "component_tag") else None)!s})')
