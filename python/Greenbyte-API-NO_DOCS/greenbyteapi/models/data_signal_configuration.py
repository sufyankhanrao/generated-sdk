...
class DataSignalConfiguration(object):
    ...
    def from_dictionary(cls,
        ...
        availability_time_data_signal_id = dictionary.get("availabilityTimeDataSignalId") if dictionary.get("availabilityTimeDataSignalId") else None
        availability_production_data_signal_id = dictionary.get("availabilityProductionDataSignalId") if dictionary.get("availabilityProductionDataSignalId") else None
        lost_production_data_signal_id = dictionary.get("lostProductionDataSignalId") if dictionary.get("lostProductionDataSignalId") else None
        performance_data_signal_id = dictionary.get("performanceDataSignalId") if dictionary.get("performanceDataSignalId") else None
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                f'availability_time_data_signal_id={self.availability_time_data_signal_id!r}, '
                f'availability_production_data_signal_id={self.availability_production_data_signal_id!r}, '
                f'lost_production_data_signal_id={self.lost_production_data_signal_id!r}, '
                f'performance_data_signal_id={self.performance_data_signal_id!r})')

    def __str__(self):
        return (f'{self.__class__.__name__}('
                f'availability_time_data_signal_id={self.availability_time_data_signal_id!s}, '
                f'availability_production_data_signal_id={self.availability_production_data_signal_id!s}, '
                f'lost_production_data_signal_id={self.lost_production_data_signal_id!s}, '
