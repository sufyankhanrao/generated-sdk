...
from greenbyteapi.models.data_per_category_response import (
    DataPerCategoryResponse,
)
from greenbyteapi.models.data_real_time_item import (
    DataRealTimeItem,
)
from greenbyteapi.models.data_signal_item import (
    DataSignalItem,
)
from greenbyteapi.models.highresdata_response import (
    HighresdataResponse,
)
...
class DataController(BaseController):
    ...
    def get_data_signals(self,
                         device_ids=None):
        """Perform a GET request to /datasignals.
    ...
    def get_real_time_data(self,
                           ...
                           aggregate_level=0,
                           calculation=None):
        """Perform a GET request to /realtimedata.
    ...
    def get_data_per_category(self,
        ...
        """Perform a GET request to /datapercategory.

        Gets signal data aggregated per availability contract category.
        _🔐 This endpoint requires the **Data** and **Statuses** endpoint
        permissions._
        _This request can also be made using the POST method,
    ...
    def get_high_res_data(self,
                          ...
                          timestamp_end=None):
        """Perform a GET request to /highresdata.
