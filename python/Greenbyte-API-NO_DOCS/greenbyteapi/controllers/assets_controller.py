...
from greenbyteapi.models.devices_published_after_date_response import (
    DevicesPublishedAfterDateResponse,
)
from greenbyteapi.models.power_curve import (
    PowerCurve,
)
from greenbyteapi.models.site_with_data import (
    SiteWithData,
)
...
class AssetsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize AssetsController object."""
    ...
    def get_devices(self,
                    ...
                    page=1,
                    use_utc=False):
        """Perform a GET request to /devices.
        ...
        return super().new_api_call_builder.request(
            ...
            .local_error("429",
                ...
                "\n  '1m', '12h', or '1d').\n* `X-Rate-Limit-Remaining` – The r"
                "emaining number of requests\n  for this period.\n* `X-Rate-Lim"
                "it-Reset` – The UTC timestamp string (in ISO 8601\n  format) w"
    ...
    def get_devices_published_after_date(self,
                                         site_id,
                                         date):
        """Perform a GET request to /devices-published-after-date.
    ...
    def get_sites(self,
                  ...
                  page_size=50,
                  page=1):
        """Perform a GET request to /sites.
    ...
    def get_power_curves(self,
                         ...
                         timestamp=None,
                         learned=False):
        """Perform a GET request to /powercurves.
