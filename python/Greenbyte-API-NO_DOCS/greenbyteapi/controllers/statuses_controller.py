...
from greenbyteapi.models.status_item import (
    StatusItem,
)
...
class StatusesController(BaseController):
    ...
    def __init__(self, config):
        """Initialize StatusesController object."""
        super(StatusesController, self).__init__(config)
    ...
    def get_statuses(self,
        ...
        Args:
            device_ids (List[int]): Which devices to get statuses for.
        ...
        return super().new_api_call_builder.request(
            ...
            .query_param(Parameter()
                         ...
                         .value(category))
            .query_param(Parameter()
                         .key("lostProductionSignalId")
                         .value(lost_production_signal_id))
            .query_param(Parameter()
                         .key("fields")
                         .value(fields))
            .query_param(Parameter()
            ...
            .deserialize_into(StatusItem.from_dictionary)
    ...
    def get_active_statuses(self,
                            ...
                            use_utc=False,
                            contract_type="service"):
        """Perform a GET request to /activestatus.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. A list of
                active statuses with related data.
