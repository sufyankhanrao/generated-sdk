...
class PredictControllerTests(ControllerTestBase):
    ...
    def test_get_predict_alerts(self):
        ...
        expected_body = APIHelper.json_deserialize('[{"deviceId":260,"siteId":19,"componentAlert":{"componentId":46,"c'
            'omponentName":"Main gear oil system"},"highSeverity":true,"status"'
            ':"resolved","comments":[{"text":"Found high temperatures. Reported'
            ' to OM team.","userName":"Bill Bao","timestamp":"2019-04-16T12:48:'
            '16"}],"resolvedBy":"Jens Genberg","timestampResolved":"2019-10-25T'
            '09:29:55","actionTaken":"Replacement","componentResolved":{"compon'
            'entId":77,"componentName":"Main gear oil system"},"dismissedBy":nu'
            'll,"timestampDismissed":null,"recommendations":null}]')
