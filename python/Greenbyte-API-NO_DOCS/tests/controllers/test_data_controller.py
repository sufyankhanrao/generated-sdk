...
class DataControllerTests(ControllerTestBase):
    ...
    def test_get_data_signals(self):
        ...
        expected_body = APIHelper.json_deserialize('[{"dataSignalId":1,"title":"Wind speed","type":"Wind speed","unit"'
            ':"m/s","deviceType":{"deviceTypeId":1,"title":"Turbine"}},{"dataSi'
            'gnalId":5,"title":"Power","type":"Power","unit":"kW","deviceType":'
            '{"deviceTypeId":1,"title":"Turbine"}}]')
    ...
    def test_get_data(self):
        ...
        # Test whether the captured response is as we expected
        assert result is not None
        expected_body = APIHelper.json_deserialize('[{"aggregate":"device","aggregateId":1,"aggregatePathNames":[],"de'
            'viceIds":[1],"resolution":"hourly","calculation":"sum","dataSignal'
            '":{"dataSignalId":1,"title":"Wind speed","unit":"m/s"},"data":{"20'
            '20-01-01T00:00:00":6.89,"2020-01-01T01:00:00":8.33}},{"aggregate":'
            '"device","aggregateId":1,"aggregatePathNames":[],"deviceIds":[1],"'
            'resolution":"hourly","calculation":"sum","dataSignal":{"dataSignal'
            'Id":5,"title":"Power","unit":"kW"},"data":{"2020-01-01T00:00:00":5'
            '84.33,"2020-01-01T01:00:00":1014}}]')
        received_body = APIHelper.json_deserialize(self.response_catcher.response.text)
        assert ComparisonHelper.match_body(expected_body, received_body)
    ...
    def test_get_real_time_data(self):
        ...
        # Test whether the captured response is as we expected
        assert result is not None
        expected_body = APIHelper.json_deserialize('[{"aggregate":"device","aggregateId":24,"aggregatePathNames":[],"d'
            'eviceIds":[24],"calculation":"sum","dataSignal":{"dataSignalId":5,'
            '"title":"Power","unit":"kW"},"data":{"2020-03-17T12:50:02Z":2174}}'
            ',{"aggregate":"device","aggregateId":24,"aggregatePathNames":[],"d'
            'eviceIds":[24],"calculation":"sum","dataSignal":{"dataSignalId":1,'
            '"title":"Wind speed","unit":"m/s"},"data":{"2020-03-17T12:50:02Z":'
            '12.2}}]')
        received_body = APIHelper.json_deserialize(self.response_catcher.response.text)
        assert ComparisonHelper.match_body(expected_body, received_body)
    ...
    def test_get_data_per_category(self):
        ...
        # Test whether the captured response is as we expected
        assert result is not None
        expected_body = APIHelper.json_deserialize('{"dataSignal":{"dataSignalId":248,"title":"Lost Production (Contra'
            'ctual)","unit":"kWh"},"calculation":"sum","data":[{"aggregateId":6'
            ',"aggregatePathNames":[],"deviceIds":[1,2,3],"contractTitle":"Vest'
            'as 1","categoryTitle":"Icing","categoryTime":"available","value":1'
            '04.55,"duration":150},{"aggregateId":6,"aggregatePathNames":[],"de'
            'viceIds":[1,2,3],"contractTitle":"Vestas 1","categoryTitle":"Utili'
            'ty","categoryTime":"excluded","value":73,"duration":50.3}]}')
        received_body = APIHelper.json_deserialize(self.response_catcher.response.text)
        assert ComparisonHelper.match_body(expected_body, received_body)
    ...
    def test_get_high_res_data(self):
        ...
        # Test whether the captured response is as we expected
        assert result is not None
        expected_body = APIHelper.json_deserialize('[{"deviceId":24,"dataSignal":{"dataSignalId":1,"title":"Wind speed'
            '","unit":"m/s"},"data":{"2021-04-09T04:14:18Z":6.21827459335327,"2'
            '021-04-09T04:14:48Z":6.46509933471681,"2021-04-09T04:15:18Z":7.412'
            '47510910034,"2021-04-09T04:15:48Z":6.71687459945679,"2021-04-09T04'
            ':16:20Z":5.66159963607788}},{"deviceId":25,"dataSignal":{"dataSign'
            'alId":1,"title":"Wind speed","unit":"m/s"},"data":{"2021-04-09T04:'
            '14:18Z":5.81789970397949,"2021-04-09T04:14:48Z":5.43127489089966,"'
            '2021-04-09T04:15:18Z":7.41247510910034,"2021-04-09T04:15:48Z":5.58'
            '427476882935,"2021-04-09T04:16:20Z":6.80189990997314}}]')
        received_body = APIHelper.json_deserialize(self.response_catcher.response.text)
        assert ComparisonHelper.match_body(expected_body, received_body)
