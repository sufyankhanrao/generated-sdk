...
from allowadditionalenumitemsapi.controllers.api_controller import (
    APIController,
)
...
class AllowadditionalenumitemsapiClient(object):
    """Client that provide access to the AllowadditionalenumitemsapiClient APIs."""
    ...
    def __init__(self, http_client_instance=None,
        ...
        """Initialize a new instance of AllowadditionalenumitemsapiClient."""
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        Returns:
            AllowadditionalenumitemsapiClient instance.
