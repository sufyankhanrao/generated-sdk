...
from allowadditionalenumitemsapi.allowadditionalenumitemsapi_client import (
    AllowadditionalenumitemsapiClient,
)
...
class ControllerTestBase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.client = AllowadditionalenumitemsapiClient(config=cls.config)
