    ...
    def __init__(self, o_auth_ccg_credentials, config):
        ...
        if o_auth_ccg_credentials is not None \
            ...
            self._o_auth_token = o_auth_ccg_credentials.o_auth_token \
                if o_auth_ccg_credentials is not None else None
        self._o_auth_clock_skew = o_auth_ccg_credentials.o_auth_clock_skew \
            if o_auth_ccg_credentials is not None else None
        self._o_auth_token_provider = o_auth_ccg_credentials.o_auth_token_provider \
            if o_auth_ccg_credentials is not None else None
        self._o_auth_on_token_update = o_auth_ccg_credentials.o_auth_on_token_update \
            if o_auth_ccg_credentials is not None else None
...
class OAuthCCGCredentials:
    ...
    def from_environment(cls):
        o_auth_client_id = os.getenv('O_AUTH_CCG_O_AUTH_CLIENT_ID', None)
        o_auth_client_secret = os.getenv('O_AUTH_CCG_O_AUTH_CLIENT_SECRET', None)
        o_auth_clock_skew = os.getenv('O_AUTH_CCG_O_AUTH_CLOCK_SKEW', None)
