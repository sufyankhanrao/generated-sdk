...
class OAuthACGCredentials:
    ...
    def from_environment(cls):
        o_auth_client_id = os.getenv('O_AUTH_ACG_O_AUTH_CLIENT_ID', None)
        o_auth_client_secret = os.getenv('O_AUTH_ACG_O_AUTH_CLIENT_SECRET', None)
        o_auth_redirect_uri = os.getenv('O_AUTH_ACG_O_AUTH_REDIRECT_URI', None)
        o_auth_scopes = os.getenv('O_AUTH_ACG_O_AUTH_SCOPES', None)
