...
from multiauthsample.http.proxy_settings import (
    ProxySettings,
)
from multiauthsample.models.suite_code_enum import (
    SuiteCodeEnum,
)
...
class Configuration(HttpClientConfiguration):
    ...
    def clone_with(self, http_client_instance=None,
        ...
        o_auth_ropcg_credentials =\
            (o_auth_ropcg_credentials
            or self.o_auth_ropcg_credentials)
        o_auth_bearer_token_credentials =\
            (o_auth_bearer_token_credentials
            or self.o_auth_bearer_token_credentials)
        custom_auth_credentials =\
            (custom_auth_credentials
            or self.custom_auth_credentials)
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        default_config = cls(
            ...
            api_header_credentials=ApiHeaderCredentials.from_environment(),
            o_auth_ccg_credentials=OAuthCCGCredentials.from_environment(),
            o_auth_acg_credentials=OAuthACGCredentials.from_environment(),
            o_auth_ropcg_credentials=OAuthROPCGCredentials.from_environment(),
            o_auth_bearer_token_credentials=OAuthBearerTokenCredentials.from_environment(),
        )
