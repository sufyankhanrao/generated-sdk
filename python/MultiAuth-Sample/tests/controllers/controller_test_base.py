...
from multiauthsample.multiauthsample_client import (
    MultiauthsampleClient,
)
...
class ControllerTestBase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        o_auth_acg_credentials =\
            cls.config.o_auth_acg_credentials.clone_with(
                o_auth_token=o_auth_acg_token,
            )
        ...
        o_auth_ropcg_credentials =\
            cls.config.o_auth_ropcg_credentials.clone_with(
                o_auth_token=o_auth_ropcg_token,
            )
        cls.config = cls.config.clone_with(
