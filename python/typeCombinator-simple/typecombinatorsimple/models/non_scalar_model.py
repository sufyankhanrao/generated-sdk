...
class NonScalarModel(object):
    ...
    Attributes:
        any_of_required (Atom | Orbit): The model property of type Atom | Orbit.
        one_of_req_nullable (Orbit | Vehicle | None): The model property of type
            Orbit | Vehicle | None.
        one_of_optional (Car | Morning | Atom | None): The model property of type Car
            | Morning | Atom | None.
        any_of_opt_nullable (Morning | Evening | Noon | None): The model property of
            type Morning | Evening | Noon | None.
    ...
    def from_dictionary(cls,
        ...
        any_of_required = APIHelper.deserialize_union_type(
            UnionTypeLookUp.get("NonScalarModelAnyOfRequired"),
        ...
        one_of_req_nullable = APIHelper.deserialize_union_type(
            UnionTypeLookUp.get("NonScalarModelOneOfReqNullable"),
        ...
        one_of_optional = APIHelper.deserialize_union_type(
            UnionTypeLookUp.get("NonScalarModelOneOfOptional"),
        ...
        if "anyOfOptNullable" in dictionary.keys():
            ...
            UnionTypeLookUp.get("NonScalarModelAnyOfOptNullable"),
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return (UnionTypeLookUp.get("NonScalarModelAnyOfRequired")
                .validate(dictionary.any_of_required).is_valid) \
                and (UnionTypeLookUp.get("NonScalarModelOneOfReqNullable")
