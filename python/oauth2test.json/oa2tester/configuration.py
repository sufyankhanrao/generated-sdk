...
from oa2tester.models.suite_code_enum import (
    SuiteCodeEnum,
)
...
class Configuration(HttpClientConfiguration):
    ...
    def clone_with(self, http_client_instance=None,
                   ...
                   environment=None, port=None, suites=None, access_token=None,
    ...
    def create_auth_credentials_object(access_token, bearer_auth_credentials,
        ...
        from oa2tester.http.auth.o_auth_2 import (  # noqa: E501
