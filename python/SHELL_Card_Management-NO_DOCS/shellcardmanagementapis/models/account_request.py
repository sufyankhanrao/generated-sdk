...
from shellcardmanagementapis.models.accounts import (
    Accounts,
)
...
class AccountRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a AccountRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        include_card_summary =\
            dictionary.get("IncludeCardSummary")\
            if dictionary.get("IncludeCardSummary") else True
        payer_id =\
        ...
        invoice_points_only =\
            dictionary.get("InvoicePointsOnly")\
            if dictionary.get("InvoicePointsOnly") else False
        col_co_id =\
            dictionary.get("ColCoId")\
            if "ColCoId" in dictionary.keys() else APIHelper.SKIP
        return_tolls_customer_id =\
            dictionary.get("ReturnTollsCustomerId")\
            if "ReturnTollsCustomerId" in dictionary.keys() else APIHelper.SKIP
        accounts = None
        ...
        status_list =\
            dictionary.get("StatusList")\
            if dictionary.get("StatusList") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"include_card_summary={(self.include_card_summary
                     if hasattr(self, 'include_card_summary') else None)!r}, "
                ...
                f"invoice_points_only={(self.invoice_points_only
                     if hasattr(self, 'invoice_points_only') else None)!r}, "
                f"col_co_id={(self.col_co_id
                     if hasattr(self, 'col_co_id') else None)!r}, "
                f"return_tolls_customer_id={(self.return_tolls_customer_id
                     if hasattr(self, 'return_tolls_customer_id') else None)!r}, "
                ...
                f"status_list={(self.status_list
                     if hasattr(self, 'status_list') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"include_card_summary={(self.include_card_summary
                     if hasattr(self, 'include_card_summary') else None)!s}, "
                f"payer_id={(self.payer_id
                ...
                f"invoice_points_only={(self.invoice_points_only
                     if hasattr(self, 'invoice_points_only') else None)!s}, "
                f"col_co_id={(self.col_co_id
                     if hasattr(self, 'col_co_id') else None)!s}, "
                f"return_tolls_customer_id={(self.return_tolls_customer_id
                     if hasattr(self, 'return_tolls_customer_id') else None)!s}, "
                f"accounts={(self.accounts
                     if hasattr(self, 'accounts') else None)!s}, "
                f"account_name={(self.account_name
                     if hasattr(self, 'account_name') else None)!s}, "
                f"status_list={(self.status_list
                     if hasattr(self, 'status_list') else None)!s})")
