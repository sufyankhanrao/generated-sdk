...
from shellcardmanagementapis.models.card_move_response_error_cards_items import (
    CardMoveResponseErrorCardsItems,
)
from shellcardmanagementapis.models.card_move_response_successful_requests_items import (  # noqa: E501
...
class CardMoveResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a CardMoveResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        move_card_request_reference =\
            dictionary.get("MoveCardRequestReference")\
            if dictionary.get("MoveCardRequestReference") else APIHelper.SKIP
        successful_requests = None
        if dictionary.get("SuccessfulRequests") is not None:
            successful_requests = [
                CardMoveResponseSuccessfulRequestsItems.from_dictionary(x)
        ...
        if dictionary.get("ErrorCards") is not None:
            error_cards = [
                CardMoveResponseErrorCardsItems.from_dictionary(x)
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"move_card_request_reference={(self.move_card_request_reference
                     if hasattr(self, 'move_card_request_reference') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"move_card_request_reference={(self.move_card_request_reference
                     if hasattr(self, 'move_card_request_reference') else None)!s}, "
                f"successful_requests={(self.successful_requests
