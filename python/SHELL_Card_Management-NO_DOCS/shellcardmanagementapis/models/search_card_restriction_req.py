...
from shellcardmanagementapis.models.search_card_restriction import (
...
class SearchCardRestrictionReq(object):
    ...
    def __init__(self,
        ...
        """Initialize a SearchCardRestrictionReq instance."""
    ...
    def from_dictionary(cls,
        ...
        cards = SearchCardRestriction.from_dictionary(
            dictionary.get("Cards"))\
            if "Cards" in dictionary.keys() else APIHelper.SKIP
        include_location_restrictions =\
            dictionary.get("IncludeLocationRestrictions")\
            if "IncludeLocationRestrictions" in dictionary.keys() else APIHelper.SKIP
        include_bundle_details =\
            dictionary.get("IncludeBundleDetails")\
            if "IncludeBundleDetails" in dictionary.keys() else APIHelper.SKIP
        include_inherited_limits =\
            dictionary.get("IncludeInheritedLimits")\
            if "IncludeInheritedLimits" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"include_location_restrictions={(self.include_location_restrictions
                     if hasattr(self, 'include_location_restrictions') else None)!r}, "
                f"include_bundle_details={(self.include_bundle_details
                     if hasattr(self, 'include_bundle_details') else None)!r}, "
                f"include_inherited_limits={(self.include_inherited_limits
                     if hasattr(self, 'include_inherited_limits') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"include_location_restrictions={(self.include_location_restrictions
                     if hasattr(self, 'include_location_restrictions') else None)!s}, "
                f"include_bundle_details={(self.include_bundle_details
                     if hasattr(self, 'include_bundle_details') else None)!s}, "
                f"include_inherited_limits={(self.include_inherited_limits
                     if hasattr(self, 'include_inherited_limits') else None)!s})")
