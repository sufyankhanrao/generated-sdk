...
class AuditResponseAuditsItems(object):
    ...
    def __init__(self,
        ...
        """Initialize a AuditResponseAuditsItems instance."""
    ...
    def from_dictionary(cls,
        ...
        additional_information_1 =\
            dictionary.get("AdditionalInformation1")\
            if "AdditionalInformation1" in dictionary.keys() else APIHelper.SKIP
        additional_information_2 =\
            dictionary.get("AdditionalInformation2")\
            if "AdditionalInformation2" in dictionary.keys() else APIHelper.SKIP
        additional_information_3 =\
            dictionary.get("AdditionalInformation3")\
            if "AdditionalInformation3" in dictionary.keys() else APIHelper.SKIP
        additional_information_4 =\
            dictionary.get("AdditionalInformation4")\
            if "AdditionalInformation4" in dictionary.keys() else APIHelper.SKIP
        additional_information_5 =\
            dictionary.get("AdditionalInformation5")\
            if "AdditionalInformation5" in dictionary.keys() else APIHelper.SKIP
        additional_information_6 =\
            dictionary.get("AdditionalInformation6")\
            if "AdditionalInformation6" in dictionary.keys() else APIHelper.SKIP
        additional_information_7 =\
            dictionary.get("AdditionalInformation7")\
            if "AdditionalInformation7" in dictionary.keys() else APIHelper.SKIP
        additional_information_8 =\
            dictionary.get("AdditionalInformation8")\
            if "AdditionalInformation8" in dictionary.keys() else APIHelper.SKIP
        additional_information_9 =\
            dictionary.get("AdditionalInformation9")\
            if "AdditionalInformation9" in dictionary.keys() else APIHelper.SKIP
        card_group_id =\
        ...
        error_string =\
            dictionary.get("ErrorString")\
            if "ErrorString" in dictionary.keys() else APIHelper.SKIP
        global_request_id =\
            dictionary.get("GlobalRequestID")\
            if "GlobalRequestID" in dictionary.keys() else APIHelper.SKIP
        pan =\
            dictionary.get("PAN")\
        ...
        processed_on =\
            dictionary.get("ProcessedOn")\
            if "ProcessedOn" in dictionary.keys() else APIHelper.SKIP
        requested_by =\
            dictionary.get("RequestedBy")\
            if "RequestedBy" in dictionary.keys() else APIHelper.SKIP
        requested_operation =\
            dictionary.get("RequestedOperation")\
            if "RequestedOperation" in dictionary.keys() else APIHelper.SKIP
        request_reference =\
            dictionary.get("RequestReference")\
            if "RequestReference" in dictionary.keys() else APIHelper.SKIP
        request_type =\
            dictionary.get("RequestType")\
            if "RequestType" in dictionary.keys() else APIHelper.SKIP
        status =\
            dictionary.get("Status")\
            if "Status" in dictionary.keys() else APIHelper.SKIP
        submitted_on =\
            dictionary.get("SubmittedOn")\
            if "SubmittedOn" in dictionary.keys() else APIHelper.SKIP
        sub_request_reference =\
            dictionary.get("SubRequestReference")\
            if "SubRequestReference" in dictionary.keys() else APIHelper.SKIP
        user_display_name =\
            dictionary.get("UserDisplayName")\
            if "UserDisplayName" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"additional_information_1={(self.additional_information_1
                     if hasattr(self, 'additional_information_1') else None)!r}, "
                f"additional_information_2={(self.additional_information_2
                     if hasattr(self, 'additional_information_2') else None)!r}, "
                f"additional_information_3={(self.additional_information_3
                     if hasattr(self, 'additional_information_3') else None)!r}, "
                f"additional_information_4={(self.additional_information_4
                     if hasattr(self, 'additional_information_4') else None)!r}, "
                f"additional_information_5={(self.additional_information_5
                     if hasattr(self, 'additional_information_5') else None)!r}, "
                f"additional_information_6={(self.additional_information_6
                     if hasattr(self, 'additional_information_6') else None)!r}, "
                f"additional_information_7={(self.additional_information_7
                     if hasattr(self, 'additional_information_7') else None)!r}, "
                f"additional_information_8={(self.additional_information_8
                     if hasattr(self, 'additional_information_8') else None)!r}, "
                f"additional_information_9={(self.additional_information_9
                     if hasattr(self, 'additional_information_9') else None)!r}, "
                ...
                f"error_string={(self.error_string
                     if hasattr(self, 'error_string') else None)!r}, "
                f"global_request_id={(self.global_request_id
                     if hasattr(self, 'global_request_id') else None)!r}, "
                ...
                f"processed_on={(self.processed_on
                     if hasattr(self, 'processed_on') else None)!r}, "
                f"requested_by={(self.requested_by
                     if hasattr(self, 'requested_by') else None)!r}, "
                f"requested_operation={(self.requested_operation
                     if hasattr(self, 'requested_operation') else None)!r}, "
                f"request_reference={(self.request_reference
                     if hasattr(self, 'request_reference') else None)!r}, "
                f"request_type={(self.request_type
                     if hasattr(self, 'request_type') else None)!r}, "
                f"status={(self.status if hasattr(self, 'status') else None)!r}, "
                f"submitted_on={(self.submitted_on
                     if hasattr(self, 'submitted_on') else None)!r}, "
                f"sub_request_reference={(self.sub_request_reference
                     if hasattr(self, 'sub_request_reference') else None)!r}, "
                f"user_display_name={(self.user_display_name
                     if hasattr(self, 'user_display_name') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"additional_information_1={(self.additional_information_1
                     if hasattr(self, 'additional_information_1') else None)!s}, "
                f"additional_information_2={(self.additional_information_2
                     if hasattr(self, 'additional_information_2') else None)!s}, "
                f"additional_information_3={(self.additional_information_3
                     if hasattr(self, 'additional_information_3') else None)!s}, "
                f"additional_information_4={(self.additional_information_4
                     if hasattr(self, 'additional_information_4') else None)!s}, "
                f"additional_information_5={(self.additional_information_5
                     if hasattr(self, 'additional_information_5') else None)!s}, "
                f"additional_information_6={(self.additional_information_6
                     if hasattr(self, 'additional_information_6') else None)!s}, "
                f"additional_information_7={(self.additional_information_7
                     if hasattr(self, 'additional_information_7') else None)!s}, "
                f"additional_information_8={(self.additional_information_8
                     if hasattr(self, 'additional_information_8') else None)!s}, "
                f"additional_information_9={(self.additional_information_9
                     if hasattr(self, 'additional_information_9') else None)!s}, "
                f"card_group_id={(self.card_group_id
                ...
                f"error_string={(self.error_string
                     if hasattr(self, 'error_string') else None)!s}, "
                f"global_request_id={(self.global_request_id
                     if hasattr(self, 'global_request_id') else None)!s}, "
                ...
                f"processed_on={(self.processed_on
                     if hasattr(self, 'processed_on') else None)!s}, "
                f"requested_by={(self.requested_by
                     if hasattr(self, 'requested_by') else None)!s}, "
                f"requested_operation={(self.requested_operation
                     if hasattr(self, 'requested_operation') else None)!s}, "
                f"request_reference={(self.request_reference
                     if hasattr(self, 'request_reference') else None)!s}, "
                f"request_type={(self.request_type
                     if hasattr(self, 'request_type') else None)!s}, "
                f"status={(self.status if hasattr(self, 'status') else None)!s}, "
                f"submitted_on={(self.submitted_on
                     if hasattr(self, 'submitted_on') else None)!s}, "
                f"sub_request_reference={(self.sub_request_reference
                     if hasattr(self, 'sub_request_reference') else None)!s}, "
                f"user_display_name={(self.user_display_name
                     if hasattr(self, 'user_display_name') else None)!s})")
