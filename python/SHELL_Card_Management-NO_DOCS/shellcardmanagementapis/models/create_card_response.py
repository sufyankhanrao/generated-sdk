...
class CreateCardResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a CreateCardResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        driver_and_vrn =\
            dictionary.get("DriverAndVRN")\
            if "DriverAndVRN" in dictionary.keys() else APIHelper.SKIP
        order_card_reference =\
            dictionary.get("OrderCardReference")\
            if "OrderCardReference" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"driver_and_vrn={(self.driver_and_vrn
                     if hasattr(self, 'driver_and_vrn') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"driver_and_vrn={(self.driver_and_vrn
                     if hasattr(self, 'driver_and_vrn') else None)!s}, "
                f"order_card_reference={(self.order_card_reference
