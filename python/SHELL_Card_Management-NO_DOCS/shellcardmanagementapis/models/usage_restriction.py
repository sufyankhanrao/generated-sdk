...
class UsageRestriction(object):
    ...
    def __init__(self,
        ...
        """Initialize a UsageRestriction instance."""
        ...
        if life_time_transaction_accumulated is not APIHelper.SKIP:
            self.life_time_transaction_accumulated =\
                 life_time_transaction_accumulated
    ...
    def from_dictionary(cls,
        ...
        daily_spend =\
            dictionary.get("DailySpend")\
            if dictionary.get("DailySpend") else APIHelper.SKIP
        daily_spend_accumulated =\
            dictionary.get("DailySpendAccumulated")\
            if dictionary.get("DailySpendAccumulated") else APIHelper.SKIP
        daily_spend_balance =\
            dictionary.get("DailySpendBalance")\
            if dictionary.get("DailySpendBalance") else APIHelper.SKIP
        daily_spend_override =\
            dictionary.get("DailySpendOverride")\
            if "DailySpendOverride" in dictionary.keys() else APIHelper.SKIP
        daily_spend_threshold =\
            dictionary.get("DailySpendThreshold")\
            if dictionary.get("DailySpendThreshold") else APIHelper.SKIP
        weekly_spend =\
            dictionary.get("WeeklySpend")\
            if dictionary.get("WeeklySpend") else APIHelper.SKIP
        weekly_spend_accumulated =\
            dictionary.get("WeeklySpendAccumulated")\
            if dictionary.get("WeeklySpendAccumulated") else APIHelper.SKIP
        weekly_spend_balance =\
            dictionary.get("WeeklySpendBalance")\
            if dictionary.get("WeeklySpendBalance") else APIHelper.SKIP
        weekly_spend_override =\
            dictionary.get("WeeklySpendOverride")\
            if "WeeklySpendOverride" in dictionary.keys() else APIHelper.SKIP
        weekly_spend_threshold =\
            dictionary.get("WeeklySpendThreshold")\
            if dictionary.get("WeeklySpendThreshold") else APIHelper.SKIP
        monthly_spend =\
            dictionary.get("MonthlySpend")\
            if dictionary.get("MonthlySpend") else APIHelper.SKIP
        monthly_spend_accumulated =\
            dictionary.get("MonthlySpendAccumulated")\
            if dictionary.get("MonthlySpendAccumulated") else APIHelper.SKIP
        monthly_spend_balance =\
            dictionary.get("MonthlySpendBalance")\
            if dictionary.get("MonthlySpendBalance") else APIHelper.SKIP
        monthly_spend_override =\
            dictionary.get("MonthlySpendOverride")\
            if "MonthlySpendOverride" in dictionary.keys() else APIHelper.SKIP
        per_transaction_spend =\
            dictionary.get("PerTransactionSpend")\
            if dictionary.get("PerTransactionSpend") else APIHelper.SKIP
        per_transaction_spend_override =\
            dictionary.get("PerTransactionSpendOverride")\
            if "PerTransactionSpendOverride" in dictionary.keys() else APIHelper.SKIP
        annual_spend =\
            dictionary.get("AnnualSpend")\
            if dictionary.get("AnnualSpend") else APIHelper.SKIP
        annual_spend_accumulated =\
            dictionary.get("AnnualSpendAccumulated")\
            if dictionary.get("AnnualSpendAccumulated") else APIHelper.SKIP
        annual_spend_balance =\
            dictionary.get("AnnualSpendBalance")\
            if dictionary.get("AnnualSpendBalance") else APIHelper.SKIP
        annual_spend_override =\
            dictionary.get("AnnualSpendOverride")\
            if "AnnualSpendOverride" in dictionary.keys() else APIHelper.SKIP
        annual_spend_threshold =\
            dictionary.get("AnnualSpendThreshold")\
            if dictionary.get("AnnualSpendThreshold") else APIHelper.SKIP
        life_time_spend =\
            dictionary.get("LifeTimeSpend")\
            if dictionary.get("LifeTimeSpend") else APIHelper.SKIP
        life_time_spend_accumulated =\
            dictionary.get("LifeTimeSpendAccumulated")\
            if dictionary.get("LifeTimeSpendAccumulated") else APIHelper.SKIP
        life_time_spend_balance =\
            dictionary.get("LifeTimeSpendBalance")\
            if dictionary.get("LifeTimeSpendBalance") else APIHelper.SKIP
        life_time_spend_override =\
            dictionary.get("LifeTimeSpendOverride")\
            if "LifeTimeSpendOverride" in dictionary.keys() else APIHelper.SKIP
        life_time_spend_threshold =\
            dictionary.get("LifeTimeSpendThreshold")\
            if dictionary.get("LifeTimeSpendThreshold") else APIHelper.SKIP
        daily_volume =\
            dictionary.get("DailyVolume")\
            if dictionary.get("DailyVolume") else APIHelper.SKIP
        daily_volume_accumulated =\
            dictionary.get("DailyVolumeAccumulated")\
            if dictionary.get("DailyVolumeAccumulated") else APIHelper.SKIP
        daily_volume_balance =\
            dictionary.get("DailyVolumeBalance")\
            if dictionary.get("DailyVolumeBalance") else APIHelper.SKIP
        daily_volume_override =\
            dictionary.get("DailyVolumeOverride")\
            if dictionary.get("DailyVolumeOverride") else APIHelper.SKIP
        daily_volume_threshold =\
            dictionary.get("DailyVolumeThreshold")\
            if dictionary.get("DailyVolumeThreshold") else APIHelper.SKIP
        weekly_volume =\
            dictionary.get("WeeklyVolume")\
            if dictionary.get("WeeklyVolume") else APIHelper.SKIP
        weekly_volume_accumulated =\
            dictionary.get("WeeklyVolumeAccumulated")\
            if dictionary.get("WeeklyVolumeAccumulated") else APIHelper.SKIP
        weekly_volume_balance =\
            dictionary.get("WeeklyVolumeBalance")\
            if dictionary.get("WeeklyVolumeBalance") else APIHelper.SKIP
        weekly_volume_override =\
            dictionary.get("WeeklyVolumeOverride")\
            if "WeeklyVolumeOverride" in dictionary.keys() else APIHelper.SKIP
        weekly_volume_threshold =\
            dictionary.get("WeeklyVolumeThreshold")\
            if dictionary.get("WeeklyVolumeThreshold") else APIHelper.SKIP
        monthly_volume =\
            dictionary.get("MonthlyVolume")\
            if dictionary.get("MonthlyVolume") else APIHelper.SKIP
        monthly_volume_accumulated =\
            dictionary.get("MonthlyVolumeAccumulated")\
            if dictionary.get("MonthlyVolumeAccumulated") else APIHelper.SKIP
        monthly_volume_balance =\
            dictionary.get("MonthlyVolumeBalance")\
            if dictionary.get("MonthlyVolumeBalance") else APIHelper.SKIP
        monthly_volume_override =\
            dictionary.get("MonthlyVolumeOverride")\
            if "MonthlyVolumeOverride" in dictionary.keys() else APIHelper.SKIP
        monthly_volume_threshold =\
            dictionary.get("MonthlyVolumeThreshold")\
            if dictionary.get("MonthlyVolumeThreshold") else APIHelper.SKIP
        per_transaction_volume =\
            dictionary.get("PerTransactionVolume")\
            if dictionary.get("PerTransactionVolume") else APIHelper.SKIP
        per_transaction_volume_override =\
            dictionary.get("PerTransactionVolumeOverride")\
            if "PerTransactionVolumeOverride" in dictionary.keys() else APIHelper.SKIP
        annual_volume =\
            dictionary.get("AnnualVolume")\
            if dictionary.get("AnnualVolume") else APIHelper.SKIP
        annual_volume_accumulated =\
            dictionary.get("AnnualVolumeAccumulated")\
            if dictionary.get("AnnualVolumeAccumulated") else APIHelper.SKIP
        annual_volume_balance =\
            dictionary.get("AnnualVolumeBalance")\
            if dictionary.get("AnnualVolumeBalance") else APIHelper.SKIP
        annual_volume_override =\
            dictionary.get("AnnualVolumeOverride")\
            if "AnnualVolumeOverride" in dictionary.keys() else APIHelper.SKIP
        annual_volume_threshold =\
            dictionary.get("AnnualVolumeThreshold")\
            if dictionary.get("AnnualVolumeThreshold") else APIHelper.SKIP
        life_time_volume =\
            dictionary.get("LifeTimeVolume")\
            if dictionary.get("LifeTimeVolume") else APIHelper.SKIP
        life_time_volume_accumulated =\
            dictionary.get("LifeTimeVolumeAccumulated")\
            if dictionary.get("LifeTimeVolumeAccumulated") else APIHelper.SKIP
        life_time_volume_balance =\
            dictionary.get("LifeTimeVolumeBalance")\
            if dictionary.get("LifeTimeVolumeBalance") else APIHelper.SKIP
        life_time_volume_override =\
            dictionary.get("LifeTimeVolumeOverride")\
            if "LifeTimeVolumeOverride" in dictionary.keys() else APIHelper.SKIP
        life_time_volume_threshold =\
            dictionary.get("LifeTimeVolumeThreshold")\
            if dictionary.get("LifeTimeVolumeThreshold") else APIHelper.SKIP
        daily_transaction_count =\
            dictionary.get("DailyTransactionCount")\
            if dictionary.get("DailyTransactionCount") else APIHelper.SKIP
        daily_transaction_accumulated =\
            dictionary.get("DailyTransactionAccumulated")\
            if dictionary.get("DailyTransactionAccumulated") else APIHelper.SKIP
        daily_transaction_balance =\
            dictionary.get("DailyTransactionBalance")\
            if dictionary.get("DailyTransactionBalance") else APIHelper.SKIP
        daily_transaction_override =\
            dictionary.get("DailyTransactionOverride")\
            if "DailyTransactionOverride" in dictionary.keys() else APIHelper.SKIP
        daily_transaction_threshold =\
            dictionary.get("DailyTransactionThreshold")\
            if dictionary.get("DailyTransactionThreshold") else APIHelper.SKIP
        weekly_transaction_count =\
            dictionary.get("WeeklyTransactionCount")\
            if dictionary.get("WeeklyTransactionCount") else APIHelper.SKIP
        weekly_transaction_accumulated =\
            dictionary.get("WeeklyTransactionAccumulated")\
            if dictionary.get("WeeklyTransactionAccumulated") else APIHelper.SKIP
        weekly_transaction_balance =\
            dictionary.get("WeeklyTransactionBalance")\
            if dictionary.get("WeeklyTransactionBalance") else APIHelper.SKIP
        weekly_transaction_override =\
            dictionary.get("WeeklyTransactionOverride")\
            if "WeeklyTransactionOverride" in dictionary.keys() else APIHelper.SKIP
        weekly_transaction_threshold =\
            dictionary.get("WeeklyTransactionThreshold")\
            if dictionary.get("WeeklyTransactionThreshold") else APIHelper.SKIP
        monthly_transaction_count =\
            dictionary.get("MonthlyTransactionCount")\
            if dictionary.get("MonthlyTransactionCount") else APIHelper.SKIP
        monthly_transaction_accumulated =\
            dictionary.get("MonthlyTransactionAccumulated")\
            if dictionary.get("MonthlyTransactionAccumulated") else APIHelper.SKIP
        monthly_transaction_balance =\
            dictionary.get("MonthlyTransactionBalance")\
            if dictionary.get("MonthlyTransactionBalance") else APIHelper.SKIP
        monthly_transaction_override =\
            dictionary.get("MonthlyTransactionOverride")\
            if "MonthlyTransactionOverride" in dictionary.keys() else APIHelper.SKIP
        monthly_transaction_threshold =\
            dictionary.get("MonthlyTransactionThreshold")\
            if dictionary.get("MonthlyTransactionThreshold") else APIHelper.SKIP
        annual_transaction_count =\
            dictionary.get("AnnualTransactionCount")\
            if dictionary.get("AnnualTransactionCount") else APIHelper.SKIP
        annual_transaction_accumulated =\
            dictionary.get("AnnualTransactionAccumulated")\
            if dictionary.get("AnnualTransactionAccumulated") else APIHelper.SKIP
        annual_transaction_balance =\
            dictionary.get("AnnualTransactionBalance")\
            if dictionary.get("AnnualTransactionBalance") else APIHelper.SKIP
        annual_transaction_override =\
            dictionary.get("AnnualTransactionOverride")\
            if "AnnualTransactionOverride" in dictionary.keys() else APIHelper.SKIP
        annual_transaction_threshold =\
            dictionary.get("AnnualTransactionThreshold")\
            if dictionary.get("AnnualTransactionThreshold") else APIHelper.SKIP
        life_time_transaction_count =\
            dictionary.get("LifeTimeTransactionCount")\
            if dictionary.get("LifeTimeTransactionCount") else APIHelper.SKIP
        life_time_transaction_accumulated =\
            dictionary.get("LifeTimeTransactionAccumulated")\
            if dictionary.get("LifeTimeTransactionAccumulated") else APIHelper.SKIP
        life_time_transaction_balance =\
            dictionary.get("LifeTimeTransactionBalance")\
            if dictionary.get("LifeTimeTransactionBalance") else APIHelper.SKIP
        life_time_transaction_override =\
            dictionary.get("LifeTimeTransactionOverride")\
            if "LifeTimeTransactionOverride" in dictionary.keys() else APIHelper.SKIP
        life_time_transaction_threshold =\
            dictionary.get("LifeTimeTransactionThreshold")\
            if dictionary.get("LifeTimeTransactionThreshold") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"daily_spend={(self.daily_spend
                     if hasattr(self, 'daily_spend') else None)!r}, "
                f"daily_spend_accumulated={(self.daily_spend_accumulated
                     if hasattr(self, 'daily_spend_accumulated') else None)!r}, "
                f"daily_spend_balance={(self.daily_spend_balance
                     if hasattr(self, 'daily_spend_balance') else None)!r}, "
                f"daily_spend_override={(self.daily_spend_override
                     if hasattr(self, 'daily_spend_override') else None)!r}, "
                f"daily_spend_threshold={(self.daily_spend_threshold
                     if hasattr(self, 'daily_spend_threshold') else None)!r}, "
                f"weekly_spend={(self.weekly_spend
                     if hasattr(self, 'weekly_spend') else None)!r}, "
                f"weekly_spend_accumulated={(self.weekly_spend_accumulated
                     if hasattr(self, 'weekly_spend_accumulated') else None)!r}, "
                f"weekly_spend_balance={(self.weekly_spend_balance
                     if hasattr(self, 'weekly_spend_balance') else None)!r}, "
                f"weekly_spend_override={(self.weekly_spend_override
                     if hasattr(self, 'weekly_spend_override') else None)!r}, "
                f"weekly_spend_threshold={(self.weekly_spend_threshold
                     if hasattr(self, 'weekly_spend_threshold') else None)!r}, "
                f"monthly_spend={(self.monthly_spend
                     if hasattr(self, 'monthly_spend') else None)!r}, "
                f"monthly_spend_accumulated={(self.monthly_spend_accumulated
                     if hasattr(self, 'monthly_spend_accumulated') else None)!r}, "
                f"monthly_spend_balance={(self.monthly_spend_balance
                     if hasattr(self, 'monthly_spend_balance') else None)!r}, "
                f"monthly_spend_override={(self.monthly_spend_override
                     if hasattr(self, 'monthly_spend_override') else None)!r}, "
                f"per_transaction_spend={(self.per_transaction_spend
                     if hasattr(self, 'per_transaction_spend') else None)!r}, "
                f"per_transaction_spend_override={(self.per_transaction_spend_override
                     if hasattr(self, 'per_transaction_spend_override') else None)!r}, "
                f"annual_spend={(self.annual_spend
                     if hasattr(self, 'annual_spend') else None)!r}, "
                f"annual_spend_accumulated={(self.annual_spend_accumulated
                     if hasattr(self, 'annual_spend_accumulated') else None)!r}, "
                f"annual_spend_balance={(self.annual_spend_balance
                     if hasattr(self, 'annual_spend_balance') else None)!r}, "
                f"annual_spend_override={(self.annual_spend_override
                     if hasattr(self, 'annual_spend_override') else None)!r}, "
                f"annual_spend_threshold={(self.annual_spend_threshold
                     if hasattr(self, 'annual_spend_threshold') else None)!r}, "
                f"life_time_spend={(self.life_time_spend
                     if hasattr(self, 'life_time_spend') else None)!r}, "
                f"life_time_spend_accumulated={(self.life_time_spend_accumulated
                     if hasattr(self, 'life_time_spend_accumulated') else None)!r}, "
                f"life_time_spend_balance={(self.life_time_spend_balance
                     if hasattr(self, 'life_time_spend_balance') else None)!r}, "
                f"life_time_spend_override={(self.life_time_spend_override
                     if hasattr(self, 'life_time_spend_override') else None)!r}, "
                f"life_time_spend_threshold={(self.life_time_spend_threshold
                     if hasattr(self, 'life_time_spend_threshold') else None)!r}, "
                f"daily_volume={(self.daily_volume
                     if hasattr(self, 'daily_volume') else None)!r}, "
                f"daily_volume_accumulated={(self.daily_volume_accumulated
                     if hasattr(self, 'daily_volume_accumulated') else None)!r}, "
                f"daily_volume_balance={(self.daily_volume_balance
                     if hasattr(self, 'daily_volume_balance') else None)!r}, "
                f"daily_volume_override={(self.daily_volume_override
                     if hasattr(self, 'daily_volume_override') else None)!r}, "
                f"daily_volume_threshold={(self.daily_volume_threshold
                     if hasattr(self, 'daily_volume_threshold') else None)!r}, "
                f"weekly_volume={(self.weekly_volume
                     if hasattr(self, 'weekly_volume') else None)!r}, "
                f"weekly_volume_accumulated={(self.weekly_volume_accumulated
                     if hasattr(self, 'weekly_volume_accumulated') else None)!r}, "
                f"weekly_volume_balance={(self.weekly_volume_balance
                     if hasattr(self, 'weekly_volume_balance') else None)!r}, "
                f"weekly_volume_override={(self.weekly_volume_override
                     if hasattr(self, 'weekly_volume_override') else None)!r}, "
                f"weekly_volume_threshold={(self.weekly_volume_threshold
                     if hasattr(self, 'weekly_volume_threshold') else None)!r}, "
                f"monthly_volume={(self.monthly_volume
                     if hasattr(self, 'monthly_volume') else None)!r}, "
                f"monthly_volume_accumulated={(self.monthly_volume_accumulated
                     if hasattr(self, 'monthly_volume_accumulated') else None)!r}, "
                f"monthly_volume_balance={(self.monthly_volume_balance
                     if hasattr(self, 'monthly_volume_balance') else None)!r}, "
                f"monthly_volume_override={(self.monthly_volume_override
                     if hasattr(self, 'monthly_volume_override') else None)!r}, "
                f"monthly_volume_threshold={(self.monthly_volume_threshold
                     if hasattr(self, 'monthly_volume_threshold') else None)!r}, "
                f"per_transaction_volume={(self.per_transaction_volume
                     if hasattr(self, 'per_transaction_volume') else None)!r}, "
                f"per_transaction_volume_override={(self.per_transaction_volume_override
                     if hasattr(self, 'per_transaction_volume_override') else None)!r}, "
                f"annual_volume={(self.annual_volume
                     if hasattr(self, 'annual_volume') else None)!r}, "
                f"annual_volume_accumulated={(self.annual_volume_accumulated
                     if hasattr(self, 'annual_volume_accumulated') else None)!r}, "
                f"annual_volume_balance={(self.annual_volume_balance
                     if hasattr(self, 'annual_volume_balance') else None)!r}, "
                f"annual_volume_override={(self.annual_volume_override
                     if hasattr(self, 'annual_volume_override') else None)!r}, "
                f"annual_volume_threshold={(self.annual_volume_threshold
                     if hasattr(self, 'annual_volume_threshold') else None)!r}, "
                f"life_time_volume={(self.life_time_volume
                     if hasattr(self, 'life_time_volume') else None)!r}, "
                f"life_time_volume_accumulated={(self.life_time_volume_accumulated
                     if hasattr(self, 'life_time_volume_accumulated') else None)!r}, "
                f"life_time_volume_balance={(self.life_time_volume_balance
                     if hasattr(self, 'life_time_volume_balance') else None)!r}, "
                f"life_time_volume_override={(self.life_time_volume_override
                     if hasattr(self, 'life_time_volume_override') else None)!r}, "
                f"life_time_volume_threshold={(self.life_time_volume_threshold
                     if hasattr(self, 'life_time_volume_threshold') else None)!r}, "
                f"daily_transaction_count={(self.daily_transaction_count
                     if hasattr(self, 'daily_transaction_count') else None)!r}, "
                f"daily_transaction_accumulated={(self.daily_transaction_accumulated
                     if hasattr(self, 'daily_transaction_accumulated') else None)!r}, "
                f"daily_transaction_balance={(self.daily_transaction_balance
                     if hasattr(self, 'daily_transaction_balance') else None)!r}, "
                f"daily_transaction_override={(self.daily_transaction_override
                     if hasattr(self, 'daily_transaction_override') else None)!r}, "
                f"daily_transaction_threshold={(self.daily_transaction_threshold
                     if hasattr(self, 'daily_transaction_threshold') else None)!r}, "
                f"weekly_transaction_count={(self.weekly_transaction_count
                     if hasattr(self, 'weekly_transaction_count') else None)!r}, "
                f"weekly_transaction_accumulated={(self.weekly_transaction_accumulated
                     if hasattr(self, 'weekly_transaction_accumulated') else None)!r}, "
                f"weekly_transaction_balance={(self.weekly_transaction_balance
                     if hasattr(self, 'weekly_transaction_balance') else None)!r}, "
                f"weekly_transaction_override={(self.weekly_transaction_override
                     if hasattr(self, 'weekly_transaction_override') else None)!r}, "
                f"weekly_transaction_threshold={(self.weekly_transaction_threshold
                     if hasattr(self, 'weekly_transaction_threshold') else None)!r}, "
                f"monthly_transaction_count={(self.monthly_transaction_count
                     if hasattr(self, 'monthly_transaction_count') else None)!r}, "
                f"monthly_transaction_accumulated={(self.monthly_transaction_accumulated
                     if hasattr(self, 'monthly_transaction_accumulated') else None)!r}, "
                f"monthly_transaction_balance={(self.monthly_transaction_balance
                     if hasattr(self, 'monthly_transaction_balance') else None)!r}, "
                f"monthly_transaction_override={(self.monthly_transaction_override
                     if hasattr(self, 'monthly_transaction_override') else None)!r}, "
                f"monthly_transaction_threshold={(self.monthly_transaction_threshold
                     if hasattr(self, 'monthly_transaction_threshold') else None)!r}, "
                f"annual_transaction_count={(self.annual_transaction_count
                     if hasattr(self, 'annual_transaction_count') else None)!r}, "
                f"annual_transaction_accumulated={(self.annual_transaction_accumulated
                     if hasattr(self, 'annual_transaction_accumulated') else None)!r}, "
                f"annual_transaction_balance={(self.annual_transaction_balance
                     if hasattr(self, 'annual_transaction_balance') else None)!r}, "
                f"annual_transaction_override={(self.annual_transaction_override
                     if hasattr(self, 'annual_transaction_override') else None)!r}, "
                f"annual_transaction_threshold={(self.annual_transaction_threshold
                     if hasattr(self, 'annual_transaction_threshold') else None)!r}, "
                f"life_time_transaction_count={(self.life_time_transaction_count
                     if hasattr(self, 'life_time_transaction_count') else None)!r}, "
                f"life_time_transaction_accumulated={(self.life_time_transaction_accumulated
                     if hasattr(self, 'life_time_transaction_accumulated') else None)!r}, "
                f"life_time_transaction_balance={(self.life_time_transaction_balance
                     if hasattr(self, 'life_time_transaction_balance') else None)!r}, "
                f"life_time_transaction_override={(self.life_time_transaction_override
                     if hasattr(self, 'life_time_transaction_override') else None)!r}, "
                f"life_time_transaction_threshold={(self.life_time_transaction_threshold
                     if hasattr(self, 'life_time_transaction_threshold') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"daily_spend={(self.daily_spend
                     if hasattr(self, 'daily_spend') else None)!s}, "
                f"daily_spend_accumulated={(self.daily_spend_accumulated
                     if hasattr(self, 'daily_spend_accumulated') else None)!s}, "
                f"daily_spend_balance={(self.daily_spend_balance
                     if hasattr(self, 'daily_spend_balance') else None)!s}, "
                f"daily_spend_override={(self.daily_spend_override
                     if hasattr(self, 'daily_spend_override') else None)!s}, "
                f"daily_spend_threshold={(self.daily_spend_threshold
                     if hasattr(self, 'daily_spend_threshold') else None)!s}, "
                f"weekly_spend={(self.weekly_spend
                     if hasattr(self, 'weekly_spend') else None)!s}, "
                f"weekly_spend_accumulated={(self.weekly_spend_accumulated
                     if hasattr(self, 'weekly_spend_accumulated') else None)!s}, "
                f"weekly_spend_balance={(self.weekly_spend_balance
                     if hasattr(self, 'weekly_spend_balance') else None)!s}, "
                f"weekly_spend_override={(self.weekly_spend_override
                     if hasattr(self, 'weekly_spend_override') else None)!s}, "
                f"weekly_spend_threshold={(self.weekly_spend_threshold
                     if hasattr(self, 'weekly_spend_threshold') else None)!s}, "
                f"monthly_spend={(self.monthly_spend
                     if hasattr(self, 'monthly_spend') else None)!s}, "
                f"monthly_spend_accumulated={(self.monthly_spend_accumulated
                     if hasattr(self, 'monthly_spend_accumulated') else None)!s}, "
                f"monthly_spend_balance={(self.monthly_spend_balance
                     if hasattr(self, 'monthly_spend_balance') else None)!s}, "
                f"monthly_spend_override={(self.monthly_spend_override
                     if hasattr(self, 'monthly_spend_override') else None)!s}, "
                f"per_transaction_spend={(self.per_transaction_spend
                     if hasattr(self, 'per_transaction_spend') else None)!s}, "
                f"per_transaction_spend_override={(self.per_transaction_spend_override
                     if hasattr(self, 'per_transaction_spend_override') else None)!s}, "
                f"annual_spend={(self.annual_spend
                     if hasattr(self, 'annual_spend') else None)!s}, "
                f"annual_spend_accumulated={(self.annual_spend_accumulated
                     if hasattr(self, 'annual_spend_accumulated') else None)!s}, "
                f"annual_spend_balance={(self.annual_spend_balance
                     if hasattr(self, 'annual_spend_balance') else None)!s}, "
                f"annual_spend_override={(self.annual_spend_override
                     if hasattr(self, 'annual_spend_override') else None)!s}, "
                f"annual_spend_threshold={(self.annual_spend_threshold
                     if hasattr(self, 'annual_spend_threshold') else None)!s}, "
                f"life_time_spend={(self.life_time_spend
                     if hasattr(self, 'life_time_spend') else None)!s}, "
                f"life_time_spend_accumulated={(self.life_time_spend_accumulated
                     if hasattr(self, 'life_time_spend_accumulated') else None)!s}, "
                f"life_time_spend_balance={(self.life_time_spend_balance
                     if hasattr(self, 'life_time_spend_balance') else None)!s}, "
                f"life_time_spend_override={(self.life_time_spend_override
                     if hasattr(self, 'life_time_spend_override') else None)!s}, "
                f"life_time_spend_threshold={(self.life_time_spend_threshold
                     if hasattr(self, 'life_time_spend_threshold') else None)!s}, "
                f"daily_volume={(self.daily_volume
                     if hasattr(self, 'daily_volume') else None)!s}, "
                f"daily_volume_accumulated={(self.daily_volume_accumulated
                     if hasattr(self, 'daily_volume_accumulated') else None)!s}, "
                f"daily_volume_balance={(self.daily_volume_balance
                     if hasattr(self, 'daily_volume_balance') else None)!s}, "
                f"daily_volume_override={(self.daily_volume_override
                     if hasattr(self, 'daily_volume_override') else None)!s}, "
                f"daily_volume_threshold={(self.daily_volume_threshold
                     if hasattr(self, 'daily_volume_threshold') else None)!s}, "
                f"weekly_volume={(self.weekly_volume
                     if hasattr(self, 'weekly_volume') else None)!s}, "
                f"weekly_volume_accumulated={(self.weekly_volume_accumulated
                     if hasattr(self, 'weekly_volume_accumulated') else None)!s}, "
                f"weekly_volume_balance={(self.weekly_volume_balance
                     if hasattr(self, 'weekly_volume_balance') else None)!s}, "
                f"weekly_volume_override={(self.weekly_volume_override
                     if hasattr(self, 'weekly_volume_override') else None)!s}, "
                f"weekly_volume_threshold={(self.weekly_volume_threshold
                     if hasattr(self, 'weekly_volume_threshold') else None)!s}, "
                f"monthly_volume={(self.monthly_volume
                     if hasattr(self, 'monthly_volume') else None)!s}, "
                f"monthly_volume_accumulated={(self.monthly_volume_accumulated
                     if hasattr(self, 'monthly_volume_accumulated') else None)!s}, "
                f"monthly_volume_balance={(self.monthly_volume_balance
                     if hasattr(self, 'monthly_volume_balance') else None)!s}, "
                f"monthly_volume_override={(self.monthly_volume_override
                     if hasattr(self, 'monthly_volume_override') else None)!s}, "
                f"monthly_volume_threshold={(self.monthly_volume_threshold
                     if hasattr(self, 'monthly_volume_threshold') else None)!s}, "
                f"per_transaction_volume={(self.per_transaction_volume
                     if hasattr(self, 'per_transaction_volume') else None)!s}, "
                f"per_transaction_volume_override={(self.per_transaction_volume_override
                     if hasattr(self, 'per_transaction_volume_override') else None)!s}, "
                f"annual_volume={(self.annual_volume
                     if hasattr(self, 'annual_volume') else None)!s}, "
                f"annual_volume_accumulated={(self.annual_volume_accumulated
                     if hasattr(self, 'annual_volume_accumulated') else None)!s}, "
                f"annual_volume_balance={(self.annual_volume_balance
                     if hasattr(self, 'annual_volume_balance') else None)!s}, "
                f"annual_volume_override={(self.annual_volume_override
                     if hasattr(self, 'annual_volume_override') else None)!s}, "
                f"annual_volume_threshold={(self.annual_volume_threshold
                     if hasattr(self, 'annual_volume_threshold') else None)!s}, "
                f"life_time_volume={(self.life_time_volume
                     if hasattr(self, 'life_time_volume') else None)!s}, "
                f"life_time_volume_accumulated={(self.life_time_volume_accumulated
                     if hasattr(self, 'life_time_volume_accumulated') else None)!s}, "
                f"life_time_volume_balance={(self.life_time_volume_balance
                     if hasattr(self, 'life_time_volume_balance') else None)!s}, "
                f"life_time_volume_override={(self.life_time_volume_override
                     if hasattr(self, 'life_time_volume_override') else None)!s}, "
                f"life_time_volume_threshold={(self.life_time_volume_threshold
                     if hasattr(self, 'life_time_volume_threshold') else None)!s}, "
                f"daily_transaction_count={(self.daily_transaction_count
                     if hasattr(self, 'daily_transaction_count') else None)!s}, "
                f"daily_transaction_accumulated={(self.daily_transaction_accumulated
                     if hasattr(self, 'daily_transaction_accumulated') else None)!s}, "
                f"daily_transaction_balance={(self.daily_transaction_balance
                     if hasattr(self, 'daily_transaction_balance') else None)!s}, "
                f"daily_transaction_override={(self.daily_transaction_override
                     if hasattr(self, 'daily_transaction_override') else None)!s}, "
                f"daily_transaction_threshold={(self.daily_transaction_threshold
                     if hasattr(self, 'daily_transaction_threshold') else None)!s}, "
                f"weekly_transaction_count={(self.weekly_transaction_count
                     if hasattr(self, 'weekly_transaction_count') else None)!s}, "
                f"weekly_transaction_accumulated={(self.weekly_transaction_accumulated
                     if hasattr(self, 'weekly_transaction_accumulated') else None)!s}, "
                f"weekly_transaction_balance={(self.weekly_transaction_balance
                     if hasattr(self, 'weekly_transaction_balance') else None)!s}, "
                f"weekly_transaction_override={(self.weekly_transaction_override
                     if hasattr(self, 'weekly_transaction_override') else None)!s}, "
                f"weekly_transaction_threshold={(self.weekly_transaction_threshold
                     if hasattr(self, 'weekly_transaction_threshold') else None)!s}, "
                f"monthly_transaction_count={(self.monthly_transaction_count
                     if hasattr(self, 'monthly_transaction_count') else None)!s}, "
                f"monthly_transaction_accumulated={(self.monthly_transaction_accumulated
                     if hasattr(self, 'monthly_transaction_accumulated') else None)!s}, "
                f"monthly_transaction_balance={(self.monthly_transaction_balance
                     if hasattr(self, 'monthly_transaction_balance') else None)!s}, "
                f"monthly_transaction_override={(self.monthly_transaction_override
                     if hasattr(self, 'monthly_transaction_override') else None)!s}, "
                f"monthly_transaction_threshold={(self.monthly_transaction_threshold
                     if hasattr(self, 'monthly_transaction_threshold') else None)!s}, "
                f"annual_transaction_count={(self.annual_transaction_count
                     if hasattr(self, 'annual_transaction_count') else None)!s}, "
                f"annual_transaction_accumulated={(self.annual_transaction_accumulated
                     if hasattr(self, 'annual_transaction_accumulated') else None)!s}, "
                f"annual_transaction_balance={(self.annual_transaction_balance
                     if hasattr(self, 'annual_transaction_balance') else None)!s}, "
                f"annual_transaction_override={(self.annual_transaction_override
                     if hasattr(self, 'annual_transaction_override') else None)!s}, "
                f"annual_transaction_threshold={(self.annual_transaction_threshold
                     if hasattr(self, 'annual_transaction_threshold') else None)!s}, "
                f"life_time_transaction_count={(self.life_time_transaction_count
                     if hasattr(self, 'life_time_transaction_count') else None)!s}, "
                f"life_time_transaction_accumulated={(self.life_time_transaction_accumulated
                     if hasattr(self, 'life_time_transaction_accumulated') else None)!s}, "
                f"life_time_transaction_balance={(self.life_time_transaction_balance
                     if hasattr(self, 'life_time_transaction_balance') else None)!s}, "
                f"life_time_transaction_override={(self.life_time_transaction_override
                     if hasattr(self, 'life_time_transaction_override') else None)!s}, "
                f"life_time_transaction_threshold={(self.life_time_transaction_threshold
                     if hasattr(self, 'life_time_transaction_threshold') else None)!s})")
