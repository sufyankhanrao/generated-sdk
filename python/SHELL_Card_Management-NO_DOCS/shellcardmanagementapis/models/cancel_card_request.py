...
class CancelCardRequest(object):
    """Implementation of the 'CancelCardRequest' model.

    This entity models the data that is sent in the http request body of this
    operation.
    ...
    def __init__(self,
        ...
        """Initialize a CancelCardRequest instance."""
