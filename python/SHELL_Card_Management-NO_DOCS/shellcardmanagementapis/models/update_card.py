...
class UpdateCard(object):
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'target_status={(self.target_status if hasattr(self, "target_status") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'target_status={(self.target_status if hasattr(self, "target_status") else None)!s}, '
