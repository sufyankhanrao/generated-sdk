...
class CardDetailsResponseNonFuelSetsItems(object):
    """Implementation of the 'CardDetailsResponseNonFuelSetsItems' model.
    ...
    def __init__(self,
                 ...
                 description=None):
        """Initialize a CardDetailsResponseNonFuelSetsItems instance."""
    ...
    def from_dictionary(cls,
        ...
        product_restriction_id =\
            dictionary.get("ProductRestrictionId")\
            if dictionary.get("ProductRestrictionId") else None
        description =\
