...
class RestrictionProduct(object):
    ...
    def __init__(self,
        ...
        """Initialize a RestrictionProduct instance."""
    ...
    def from_dictionary(cls,
        ...
        global_product_code =\
            dictionary.get("GlobalProductCode")\
            if dictionary.get("GlobalProductCode") else APIHelper.SKIP
        description =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"global_product_code={(self.global_product_code
                     if hasattr(self, 'global_product_code') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"global_product_code={(self.global_product_code
                     if hasattr(self, 'global_product_code') else None)!s}, "
                f"description={(self.description
