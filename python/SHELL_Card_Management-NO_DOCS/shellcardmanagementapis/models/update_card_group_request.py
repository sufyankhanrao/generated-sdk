...
class UpdateCardGroupRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a UpdateCardGroupRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        card_group_name =\
            ...
            if dictionary.get("CardGroupName") else APIHelper.SKIP
        print_on_card =\
        ...
        terminate_card_group =\
            dictionary.get("TerminateCardGroup")\
            if "TerminateCardGroup" in dictionary.keys() else APIHelper.SKIP
        move_cards =\
            dictionary.get("MoveCards")\
            if "MoveCards" in dictionary.keys() else APIHelper.SKIP
        target_account_id =\
            dictionary.get("TargetAccountId")\
            if dictionary.get("TargetAccountId") else APIHelper.SKIP
        target_account_number =\
            dictionary.get("TargetAccountNumber")\
            if dictionary.get("TargetAccountNumber") else APIHelper.SKIP
        target_new_card_group_name =\
            dictionary.get("TargetNewCardGroupName")\
            if dictionary.get("TargetNewCardGroupName") else APIHelper.SKIP
        target_card_group_id =\
            dictionary.get("TargetCardGroupId")\
            if dictionary.get("TargetCardGroupId") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"terminate_card_group={(self.terminate_card_group
                     if hasattr(self, 'terminate_card_group') else None)!r}, "
                f"move_cards={(self.move_cards
                     if hasattr(self, 'move_cards') else None)!r}, "
                f"target_account_id={(self.target_account_id
                     if hasattr(self, 'target_account_id') else None)!r}, "
                f"target_account_number={(self.target_account_number
                     if hasattr(self, 'target_account_number') else None)!r}, "
                f"target_new_card_group_name={(self.target_new_card_group_name
                     if hasattr(self, 'target_new_card_group_name') else None)!r}, "
                f"target_card_group_id={(self.target_card_group_id
                     if hasattr(self, 'target_card_group_id') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"terminate_card_group={(self.terminate_card_group
                     if hasattr(self, 'terminate_card_group') else None)!s}, "
                f"move_cards={(self.move_cards
                     if hasattr(self, 'move_cards') else None)!s}, "
                f"target_account_id={(self.target_account_id
                     if hasattr(self, 'target_account_id') else None)!s}, "
                f"target_account_number={(self.target_account_number
                     if hasattr(self, 'target_account_number') else None)!s}, "
                f"target_new_card_group_name={(self.target_new_card_group_name
                     if hasattr(self, 'target_new_card_group_name') else None)!s}, "
                f"target_card_group_id={(self.target_card_group_id
                     if hasattr(self, 'target_card_group_id') else None)!s})")
