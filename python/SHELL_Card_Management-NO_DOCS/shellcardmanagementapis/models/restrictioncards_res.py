...
class RestrictioncardsRes(object):
    ...
    def __init__(self,
        ...
        """Initialize a RestrictioncardsRes instance."""
        ...
        if location_restriction_status_description is not APIHelper.SKIP:
            self.location_restriction_status_description =\
                 location_restriction_status_description
    ...
    def from_dictionary(cls,
        ...
        usage_restriction_status =\
            ...
            if dictionary.get("UsageRestrictionStatus") else APIHelper.SKIP
        usage_restriction_description =\
            dictionary.get("UsageRestrictionDescription")\
            if dictionary.get("UsageRestrictionDescription") else APIHelper.SKIP
        day_time_restriction_status =\
            dictionary.get("DayTimeRestrictionStatus")\
            if dictionary.get("DayTimeRestrictionStatus") else APIHelper.SKIP
        day_time_restriction_description =\
            dictionary.get("DayTimeRestrictionDescription")\
            if dictionary.get("DayTimeRestrictionDescription") else APIHelper.SKIP
        product_restriction_status =\
            dictionary.get("ProductRestrictionStatus")\
            if dictionary.get("ProductRestrictionStatus") else APIHelper.SKIP
        product_restriction_description =\
            dictionary.get("ProductRestrictionDescription")\
            if dictionary.get("ProductRestrictionDescription") else APIHelper.SKIP
        location_restriction_status =\
            dictionary.get("LocationRestrictionStatus")\
            if dictionary.get("LocationRestrictionStatus") else APIHelper.SKIP
        location_restriction_status_description =\
            dictionary.get("LocationRestrictionStatusDescription")\
            if dictionary.get("LocationRestrictionStatusDescription") else APIHelper.SKIP
        validation_error_code =\
            dictionary.get("ValidationErrorCode")\
            if dictionary.get("ValidationErrorCode") else APIHelper.SKIP
        validation_error_description =\
            dictionary.get("ValidationErrorDescription")\
            if dictionary.get("ValidationErrorDescription") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"usage_restriction_description={(self.usage_restriction_description
                     if hasattr(self, 'usage_restriction_description') else None)!r}, "
                f"day_time_restriction_status={(self.day_time_restriction_status
                     if hasattr(self, 'day_time_restriction_status') else None)!r}, "
                f"day_time_restriction_description={(self.day_time_restriction_description
                     if hasattr(self, 'day_time_restriction_description') else None)!r}, "
                f"product_restriction_status={(self.product_restriction_status
                     if hasattr(self, 'product_restriction_status') else None)!r}, "
                f"product_restriction_description={(self.product_restriction_description
                     if hasattr(self, 'product_restriction_description') else None)!r}, "
                f"location_restriction_status={(self.location_restriction_status
                     if hasattr(self, 'location_restriction_status') else None)!r}, "
                f"location_restriction_status_description={(self.location_restriction_status_description
                     if hasattr(self, 'location_restriction_status_description') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"usage_restriction_description={(self.usage_restriction_description
                     if hasattr(self, 'usage_restriction_description') else None)!s}, "
                f"day_time_restriction_status={(self.day_time_restriction_status
                     if hasattr(self, 'day_time_restriction_status') else None)!s}, "
                f"day_time_restriction_description={(self.day_time_restriction_description
                     if hasattr(self, 'day_time_restriction_description') else None)!s}, "
                f"product_restriction_status={(self.product_restriction_status
                     if hasattr(self, 'product_restriction_status') else None)!s}, "
                f"product_restriction_description={(self.product_restriction_description
                     if hasattr(self, 'product_restriction_description') else None)!s}, "
                f"location_restriction_status={(self.location_restriction_status
                     if hasattr(self, 'location_restriction_status') else None)!s}, "
                f"location_restriction_status_description={(self.location_restriction_status_description
                     if hasattr(self, 'location_restriction_status_description') else None)!s}, "
                f"validation_error_code={(self.validation_error_code
