...
from shellcardmanagementapis.models.purchase_category_1_all_of_0 import (
...
class PurchaseCategoryResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a PurchaseCategoryResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("PurchaseCategories") is not None:
            purchase_categories = [
                PurchaseCategory1AllOf0.from_dictionary(x)
                    for x in dictionary.get("PurchaseCategories")
            ]
        else:
            purchase_categories = APIHelper.SKIP
