...
from shellcardmanagementapis.models.restrictioncards_res import (
    RestrictioncardsRes,
)
...
class CardRestrictionResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a CardRestrictionResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        restriction_request_reference =\
            dictionary.get("RestrictionRequestReference")\
            if dictionary.get("RestrictionRequestReference") else APIHelper.SKIP
        cards = None
        if dictionary.get("Cards") is not None:
            cards = [
                RestrictioncardsRes.from_dictionary(x)
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"restriction_request_reference={(self.restriction_request_reference
                     if hasattr(self, 'restriction_request_reference') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"restriction_request_reference={(self.restriction_request_reference
                     if hasattr(self, 'restriction_request_reference') else None)!s}, "
