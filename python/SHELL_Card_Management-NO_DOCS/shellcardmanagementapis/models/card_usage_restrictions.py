...
class CardUsageRestrictions(object):
    ...
    def __init__(self,
        ...
        """Initialize a CardUsageRestrictions instance."""
    ...
    def from_dictionary(cls,
        ...
        level =\
            ...
            if "Level" in dictionary.keys() else APIHelper.SKIP
        daily_spend_limit =\
            dictionary.get("DailySpendLimit")\
            if "DailySpendLimit" in dictionary.keys() else APIHelper.SKIP
        weekly_spend_limit =\
            dictionary.get("WeeklySpendLimit")\
            if "WeeklySpendLimit" in dictionary.keys() else APIHelper.SKIP
        monthly_spend_limit =\
            dictionary.get("MonthlySpendLimit")\
            if "MonthlySpendLimit" in dictionary.keys() else APIHelper.SKIP
        annual_spend_limit =\
            dictionary.get("AnnualSpendLimit")\
            if "AnnualSpendLimit" in dictionary.keys() else APIHelper.SKIP
        life_time_spend_limit =\
            dictionary.get("LifeTimeSpendLimit")\
            if "LifeTimeSpendLimit" in dictionary.keys() else APIHelper.SKIP
        daily_volume_limit =\
            dictionary.get("DailyVolumeLimit")\
            if "DailyVolumeLimit" in dictionary.keys() else APIHelper.SKIP
        weekly_volume_limit =\
            dictionary.get("WeeklyVolumeLimit")\
            if "WeeklyVolumeLimit" in dictionary.keys() else APIHelper.SKIP
        monthly_volume_limit =\
            dictionary.get("MonthlyVolumeLimit")\
            if "MonthlyVolumeLimit" in dictionary.keys() else APIHelper.SKIP
        annual_volume_limit =\
            dictionary.get("AnnualVolumeLimit")\
            if dictionary.get("AnnualVolumeLimit") else 0
        life_time_volume_limit =\
            dictionary.get("LifeTimeVolumeLimit")\
            if "LifeTimeVolumeLimit" in dictionary.keys() else APIHelper.SKIP
        transaction_spend_limit =\
            dictionary.get("TransactionSpendLimit")\
            if "TransactionSpendLimit" in dictionary.keys() else APIHelper.SKIP
        transaction_volume_limit =\
            dictionary.get("TransactionVolumeLimit")\
            if "TransactionVolumeLimit" in dictionary.keys() else APIHelper.SKIP
        daily_transaction_count =\
            dictionary.get("DailyTransactionCount")\
            if "DailyTransactionCount" in dictionary.keys() else APIHelper.SKIP
        weekly_transaction_count =\
            dictionary.get("WeeklyTransactionCount")\
            if "WeeklyTransactionCount" in dictionary.keys() else APIHelper.SKIP
        monthly_transaction_count =\
            dictionary.get("MonthlyTransactionCount")\
            if "MonthlyTransactionCount" in dictionary.keys() else APIHelper.SKIP
        annual_transaction_count =\
            dictionary.get("AnnualTransactionCount")\
            if "AnnualTransactionCount" in dictionary.keys() else APIHelper.SKIP
        life_time_transaction_count =\
            dictionary.get("LifeTimeTransactionCount")\
            if "LifeTimeTransactionCount" in dictionary.keys() else APIHelper.SKIP
        is_velocity_ceiling =\
            dictionary.get("IsVelocityCeiling")\
            if "IsVelocityCeiling" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"daily_spend_limit={(self.daily_spend_limit
                     if hasattr(self, 'daily_spend_limit') else None)!r}, "
                f"weekly_spend_limit={(self.weekly_spend_limit
                     if hasattr(self, 'weekly_spend_limit') else None)!r}, "
                f"monthly_spend_limit={(self.monthly_spend_limit
                     if hasattr(self, 'monthly_spend_limit') else None)!r}, "
                f"annual_spend_limit={(self.annual_spend_limit
                     if hasattr(self, 'annual_spend_limit') else None)!r}, "
                f"life_time_spend_limit={(self.life_time_spend_limit
                     if hasattr(self, 'life_time_spend_limit') else None)!r}, "
                f"daily_volume_limit={(self.daily_volume_limit
                     if hasattr(self, 'daily_volume_limit') else None)!r}, "
                f"weekly_volume_limit={(self.weekly_volume_limit
                     if hasattr(self, 'weekly_volume_limit') else None)!r}, "
                f"monthly_volume_limit={(self.monthly_volume_limit
                     if hasattr(self, 'monthly_volume_limit') else None)!r}, "
                f"annual_volume_limit={(self.annual_volume_limit
                     if hasattr(self, 'annual_volume_limit') else None)!r}, "
                f"life_time_volume_limit={(self.life_time_volume_limit
                     if hasattr(self, 'life_time_volume_limit') else None)!r}, "
                f"transaction_spend_limit={(self.transaction_spend_limit
                     if hasattr(self, 'transaction_spend_limit') else None)!r}, "
                f"transaction_volume_limit={(self.transaction_volume_limit
                     if hasattr(self, 'transaction_volume_limit') else None)!r}, "
                ...
                f"is_velocity_ceiling={(self.is_velocity_ceiling
                     if hasattr(self, 'is_velocity_ceiling') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"daily_spend_limit={(self.daily_spend_limit
                     if hasattr(self, 'daily_spend_limit') else None)!s}, "
                f"weekly_spend_limit={(self.weekly_spend_limit
                     if hasattr(self, 'weekly_spend_limit') else None)!s}, "
                f"monthly_spend_limit={(self.monthly_spend_limit
                     if hasattr(self, 'monthly_spend_limit') else None)!s}, "
                f"annual_spend_limit={(self.annual_spend_limit
                     if hasattr(self, 'annual_spend_limit') else None)!s}, "
                f"life_time_spend_limit={(self.life_time_spend_limit
                     if hasattr(self, 'life_time_spend_limit') else None)!s}, "
                f"daily_volume_limit={(self.daily_volume_limit
                     if hasattr(self, 'daily_volume_limit') else None)!s}, "
                f"weekly_volume_limit={(self.weekly_volume_limit
                     if hasattr(self, 'weekly_volume_limit') else None)!s}, "
                f"monthly_volume_limit={(self.monthly_volume_limit
                     if hasattr(self, 'monthly_volume_limit') else None)!s}, "
                f"annual_volume_limit={(self.annual_volume_limit
                     if hasattr(self, 'annual_volume_limit') else None)!s}, "
                f"life_time_volume_limit={(self.life_time_volume_limit
                     if hasattr(self, 'life_time_volume_limit') else None)!s}, "
                f"transaction_spend_limit={(self.transaction_spend_limit
                     if hasattr(self, 'transaction_spend_limit') else None)!s}, "
                f"transaction_volume_limit={(self.transaction_volume_limit
                     if hasattr(self, 'transaction_volume_limit') else None)!s}, "
                f"daily_transaction_count={(self.daily_transaction_count
                ...
                f"is_velocity_ceiling={(self.is_velocity_ceiling
                     if hasattr(self, 'is_velocity_ceiling') else None)!s})")
