...
class DeliveryAddresses(object):
    ...
    def __init__(self,
        ...
        """Initialize a DeliveryAddresses instance."""
    ...
    def from_dictionary(cls,
        ...
        address_id =\
            dictionary.get("AddressId")\
            if "AddressId" in dictionary.keys() else APIHelper.SKIP
        address_line_1 =\
            dictionary.get("AddressLine1")\
            if "AddressLine1" in dictionary.keys() else APIHelper.SKIP
        address_line_2 =\
            dictionary.get("AddressLine2")\
            if "AddressLine2" in dictionary.keys() else APIHelper.SKIP
        address_line_3 =\
            dictionary.get("AddressLine3")\
            if "AddressLine3" in dictionary.keys() else APIHelper.SKIP
        city =\
            dictionary.get("City")\
            if "City" in dictionary.keys() else APIHelper.SKIP
        company_name =\
            dictionary.get("CompanyName")\
            if "CompanyName" in dictionary.keys() else APIHelper.SKIP
        contact_fore_name =\
            dictionary.get("ContactForeName")\
            if "ContactForeName" in dictionary.keys() else APIHelper.SKIP
        contact_last_name =\
            dictionary.get("ContactLastName")\
            if "ContactLastName" in dictionary.keys() else APIHelper.SKIP
        contact_middle_name =\
            dictionary.get("ContactMiddleName")\
            if "ContactMiddleName" in dictionary.keys() else APIHelper.SKIP
        contact_title =\
        ...
        country_iso_code =\
            dictionary.get("CountryISOCode")\
            if "CountryISOCode" in dictionary.keys() else APIHelper.SKIP
        fax =\
            dictionary.get("Fax")\
            if "Fax" in dictionary.keys() else APIHelper.SKIP
        region =\
            dictionary.get("Region")\
            if "Region" in dictionary.keys() else APIHelper.SKIP
        region_id =\
            dictionary.get("RegionId")\
            if "RegionId" in dictionary.keys() else APIHelper.SKIP
        telephone =\
            dictionary.get("Telephone")\
            if "Telephone" in dictionary.keys() else APIHelper.SKIP
        zip_code =\
            dictionary.get("ZipCode")\
            if "ZipCode" in dictionary.keys() else APIHelper.SKIP
        address_type =\
            dictionary.get("AddressType")\
            if "AddressType" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"address_id={(self.address_id
                     if hasattr(self, 'address_id') else None)!r}, "
                ...
                f"address_line_3={(self.address_line_3
                     if hasattr(self, 'address_line_3') else None)!r}, "
                f"city={(self.city if hasattr(self, 'city') else None)!r}, "
                f"company_name={(self.company_name
                     if hasattr(self, 'company_name') else None)!r}, "
                f"contact_fore_name={(self.contact_fore_name
                     if hasattr(self, 'contact_fore_name') else None)!r}, "
                f"contact_last_name={(self.contact_last_name
                     if hasattr(self, 'contact_last_name') else None)!r}, "
                f"contact_middle_name={(self.contact_middle_name
                     if hasattr(self, 'contact_middle_name') else None)!r}, "
                ...
                f"country_iso_code={(self.country_iso_code
                     if hasattr(self, 'country_iso_code') else None)!r}, "
                ...
                f"telephone={(self.telephone
                     if hasattr(self, 'telephone') else None)!r}, "
                f"zip_code={(self.zip_code
                     if hasattr(self, 'zip_code') else None)!r}, "
                f"address_type={(self.address_type
                     if hasattr(self, 'address_type') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"address_id={(self.address_id
                     if hasattr(self, 'address_id') else None)!s}, "
                f"address_line_1={(self.address_line_1
                     if hasattr(self, 'address_line_1') else None)!s}, "
                f"address_line_2={(self.address_line_2
                     if hasattr(self, 'address_line_2') else None)!s}, "
                f"address_line_3={(self.address_line_3
                     if hasattr(self, 'address_line_3') else None)!s}, "
                f"city={(self.city if hasattr(self, 'city') else None)!s}, "
                f"company_name={(self.company_name
                     if hasattr(self, 'company_name') else None)!s}, "
                f"contact_fore_name={(self.contact_fore_name
                     if hasattr(self, 'contact_fore_name') else None)!s}, "
                f"contact_last_name={(self.contact_last_name
                     if hasattr(self, 'contact_last_name') else None)!s}, "
                f"contact_middle_name={(self.contact_middle_name
                     if hasattr(self, 'contact_middle_name') else None)!s}, "
                f"contact_title={(self.contact_title
                ...
                f"country_iso_code={(self.country_iso_code
                     if hasattr(self, 'country_iso_code') else None)!s}, "
                ...
                f"telephone={(self.telephone
                     if hasattr(self, 'telephone') else None)!s}, "
                f"zip_code={(self.zip_code
                     if hasattr(self, 'zip_code') else None)!s}, "
                f"address_type={(self.address_type
                     if hasattr(self, 'address_type') else None)!s})")
