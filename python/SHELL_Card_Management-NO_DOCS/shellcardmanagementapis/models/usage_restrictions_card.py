...
class UsageRestrictionsCard(object):
    ...
    def __init__(self,
        ...
        """Initialize a UsageRestrictionsCard instance."""
    ...
    def from_dictionary(cls,
        ...
        daily_spend =\
            ...
            if "DailySpend" in dictionary.keys() else APIHelper.SKIP
        weekly_spend =\
            dictionary.get("WeeklySpend")\
            if "WeeklySpend" in dictionary.keys() else APIHelper.SKIP
        monthly_spend =\
            dictionary.get("MonthlySpend")\
            if "MonthlySpend" in dictionary.keys() else APIHelper.SKIP
        per_transaction_spend =\
            dictionary.get("PerTransactionSpend")\
            if "PerTransactionSpend" in dictionary.keys() else APIHelper.SKIP
        annual_spend =\
            dictionary.get("AnnualSpend")\
            if "AnnualSpend" in dictionary.keys() else APIHelper.SKIP
        life_time_spend =\
            dictionary.get("LifeTimeSpend")\
            if "LifeTimeSpend" in dictionary.keys() else APIHelper.SKIP
        daily_volume =\
            dictionary.get("DailyVolume")\
            if "DailyVolume" in dictionary.keys() else APIHelper.SKIP
        weekly_volume =\
            dictionary.get("WeeklyVolume")\
            if "WeeklyVolume" in dictionary.keys() else APIHelper.SKIP
        monthly_volume =\
            dictionary.get("MonthlyVolume")\
            if "MonthlyVolume" in dictionary.keys() else APIHelper.SKIP
        per_transaction_volume =\
            dictionary.get("PerTransactionVolume")\
            if dictionary.get("PerTransactionVolume") else APIHelper.SKIP
        annual_volume =\
            dictionary.get("AnnualVolume")\
            if "AnnualVolume" in dictionary.keys() else APIHelper.SKIP
        life_time_volume =\
