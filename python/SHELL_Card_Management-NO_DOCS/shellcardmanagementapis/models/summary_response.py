...
class SummaryResponse(object):
    ...
    def from_dictionary(cls,
        ...
        expiring_cards =\
            dictionary.get("ExpiringCards")\
            if "ExpiringCards" in dictionary.keys() else APIHelper.SKIP
        fraud_cards =\
            dictionary.get("FraudCards")\
            if "FraudCards" in dictionary.keys() else APIHelper.SKIP
        new_cards =\
            dictionary.get("NewCards")\
            if "NewCards" in dictionary.keys() else APIHelper.SKIP
        renewal_pending_cards =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"expiring_cards={(self.expiring_cards
                     if hasattr(self, 'expiring_cards') else None)!r}, "
                f"fraud_cards={(self.fraud_cards
                     if hasattr(self, 'fraud_cards') else None)!r}, "
                f"new_cards={(self.new_cards
                     if hasattr(self, 'new_cards') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"expiring_cards={(self.expiring_cards
                     if hasattr(self, 'expiring_cards') else None)!s}, "
                f"fraud_cards={(self.fraud_cards
                     if hasattr(self, 'fraud_cards') else None)!s}, "
                f"new_cards={(self.new_cards
                     if hasattr(self, 'new_cards') else None)!s}, "
                f"renewal_pending_cards={(self.renewal_pending_cards
