...
from shellcardmanagementapis.models.card_group_response_card_groups_items import (
...
class CardGroupResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a CardGroupResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("CardGroups") is not None:
            card_groups = [
                CardGroupResponseCardGroupsItems.from_dictionary(x)
                    for x in dictionary.get("CardGroups")
            ]
        else:
            card_groups = APIHelper.SKIP
        current_page =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"card_groups={(self.card_groups
                     if hasattr(self, 'card_groups') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"card_groups={(self.card_groups
                     if hasattr(self, 'card_groups') else None)!s}, "
                f"current_page={(self.current_page
