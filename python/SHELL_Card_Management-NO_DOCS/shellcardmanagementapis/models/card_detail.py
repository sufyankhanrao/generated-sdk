...
from shellcardmanagementapis.models.card_contact import (
    CardContact,
)
from shellcardmanagementapis.models.pin_contact import (
    PINContact,
)
...
class CardDetail(object):
    ...
    def __init__(self,
        ...
        """Initialize a CardDetail instance."""
    ...
    def from_dictionary(cls,
        ...
        odometer_input_required =\
            dictionary.get("OdometerInputRequired")\
            if "OdometerInputRequired" in dictionary.keys() else APIHelper.SKIP
        fleet_id_input_required =\
            dictionary.get("FleetIdInputRequired")\
            if "FleetIdInputRequired" in dictionary.keys() else APIHelper.SKIP
        purchase_category_id =\
        ...
        self_selected_encrypted_pin =\
            ...
            if dictionary.get("SelfSelectedEncryptedPIN") else APIHelper.SKIP
        self_selected_pin_key_id =\
        ...
        is_new_card_group =\
            dictionary.get("IsNewCardGroup")\
            if "IsNewCardGroup" in dictionary.keys() else APIHelper.SKIP
        emboss_card_group =\
            dictionary.get("EmbossCardGroup")\
            if "EmbossCardGroup" in dictionary.keys() else APIHelper.SKIP
        card_contact = CardContact.from_dictionary(
            dictionary.get("CardContact"))\
            if "CardContact" in dictionary.keys() else APIHelper.SKIP
        pin_delivery_address_type =\
            dictionary.get("PINDeliveryAddressType")\
            if "PINDeliveryAddressType" in dictionary.keys() else APIHelper.SKIP
        pin_contact = PINContact.from_dictionary(
            dictionary.get("PINContact"))\
            if "PINContact" in dictionary.keys() else APIHelper.SKIP
        notify_caller =\
        ...
        fleet_option =\
            dictionary.get("FleetOption")\
            if "FleetOption" in dictionary.keys() else APIHelper.SKIP
        bundle_id =\
            dictionary.get("BundleId")\
            if "BundleId" in dictionary.keys() else APIHelper.SKIP
        usage_restriction_action =\
            dictionary.get("UsageRestrictionAction")\
            if "UsageRestrictionAction" in dictionary.keys() else APIHelper.SKIP
        product_restriction_action =\
            dictionary.get("ProductRestrictionAction")\
            if "ProductRestrictionAction" in dictionary.keys() else APIHelper.SKIP
        products =\
        ...
        auto_renew =\
            dictionary.get("AutoRenew")\
            if dictionary.get("AutoRenew") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"odometer_input_required={(self.odometer_input_required
                     if hasattr(self, 'odometer_input_required') else None)!r}, "
                f"fleet_id_input_required={(self.fleet_id_input_required
                     if hasattr(self, 'fleet_id_input_required') else None)!r}, "
                ...
                f"is_new_card_group={(self.is_new_card_group
                     if hasattr(self, 'is_new_card_group') else None)!r}, "
                f"emboss_card_group={(self.emboss_card_group
                     if hasattr(self, 'emboss_card_group') else None)!r}, "
                f"card_delivery_type={self.card_delivery_type!r}, "
                f"card_contact={(self.card_contact
                     if hasattr(self, 'card_contact') else None)!r}, "
                ...
                f"pin_contact={(self.pin_contact
                     if hasattr(self, 'pin_contact') else None)!r}, "
                ...
                f"fleet_option={(self.fleet_option
                     if hasattr(self, 'fleet_option') else None)!r}, "
                f"bundle_id={(self.bundle_id
                     if hasattr(self, 'bundle_id') else None)!r}, "
                f"usage_restriction_action={(self.usage_restriction_action
                     if hasattr(self, 'usage_restriction_action') else None)!r}, "
                f"product_restriction_action={(self.product_restriction_action
                     if hasattr(self, 'product_restriction_action') else None)!r}, "
                ...
                f"auto_renew={(self.auto_renew
                     if hasattr(self, 'auto_renew') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"odometer_input_required={(self.odometer_input_required
                     if hasattr(self, 'odometer_input_required') else None)!s}, "
                f"fleet_id_input_required={(self.fleet_id_input_required
                     if hasattr(self, 'fleet_id_input_required') else None)!s}, "
                f"purchase_category_id={(self.purchase_category_id
                ...
                f"is_new_card_group={(self.is_new_card_group
                     if hasattr(self, 'is_new_card_group') else None)!s}, "
                f"emboss_card_group={(self.emboss_card_group
                     if hasattr(self, 'emboss_card_group') else None)!s}, "
                f"card_delivery_type={self.card_delivery_type!s}, "
                f"card_contact={(self.card_contact
                     if hasattr(self, 'card_contact') else None)!s}, "
                f"pin_delivery_address_type={(self.pin_delivery_address_type
                     if hasattr(self, 'pin_delivery_address_type') else None)!s}, "
                f"pin_advice_type={self.pin_advice_type!s}, "
                f"pin_contact={(self.pin_contact
                     if hasattr(self, 'pin_contact') else None)!s}, "
                f"notify_caller={(self.notify_caller
                ...
                f"fleet_option={(self.fleet_option
                     if hasattr(self, 'fleet_option') else None)!s}, "
                f"bundle_id={(self.bundle_id
                     if hasattr(self, 'bundle_id') else None)!s}, "
                f"usage_restriction_action={(self.usage_restriction_action
                     if hasattr(self, 'usage_restriction_action') else None)!s}, "
                f"product_restriction_action={(self.product_restriction_action
                     if hasattr(self, 'product_restriction_action') else None)!s}, "
                f"products={(self.products
                ...
                f"auto_renew={(self.auto_renew
                     if hasattr(self, 'auto_renew') else None)!s})")
