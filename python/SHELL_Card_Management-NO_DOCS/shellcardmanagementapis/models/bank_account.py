...
class BankAccount(object):
    ...
    def from_dictionary(cls,
        ...
        bank_name =\
            ...
            if "BankName" in dictionary.keys() else APIHelper.SKIP
        account_name =\
            dictionary.get("AccountName")\
            if "AccountName" in dictionary.keys() else APIHelper.SKIP
        date_effective =\
            dictionary.get("DateEffective")\
            if "DateEffective" in dictionary.keys() else APIHelper.SKIP
        date_terminated =\
            dictionary.get("DateTerminated")\
            if "DateTerminated" in dictionary.keys() else APIHelper.SKIP
        iban =\
            dictionary.get("IBAN")\
            if "IBAN" in dictionary.keys() else APIHelper.SKIP
        currency_code =\
        ...
        sort_code =\
            ...
            if "SortCode" in dictionary.keys() else APIHelper.SKIP
        swift_code =\
            dictionary.get("SwiftCode")\
            if "SwiftCode" in dictionary.keys() else APIHelper.SKIP
        bank_type =\
            dictionary.get("BankType")\
            if "BankType" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"date_effective={(self.date_effective
                     if hasattr(self, 'date_effective') else None)!r}, "
                f"date_terminated={(self.date_terminated
                     if hasattr(self, 'date_terminated') else None)!r}, "
                ...
                f"sort_code={(self.sort_code
                     if hasattr(self, 'sort_code') else None)!r}, "
                f"swift_code={(self.swift_code
                     if hasattr(self, 'swift_code') else None)!r}, "
                f"bank_type={(self.bank_type
                     if hasattr(self, 'bank_type') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"date_effective={(self.date_effective
                     if hasattr(self, 'date_effective') else None)!s}, "
                f"date_terminated={(self.date_terminated
                     if hasattr(self, 'date_terminated') else None)!s}, "
                ...
                f"sort_code={(self.sort_code
                     if hasattr(self, 'sort_code') else None)!s}, "
                f"swift_code={(self.swift_code
                     if hasattr(self, 'swift_code') else None)!s}, "
                f"bank_type={(self.bank_type
                     if hasattr(self, 'bank_type') else None)!s})")
