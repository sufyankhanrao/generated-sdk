...
from shellcardmanagementapis.models.payer_details import PayerDetails
...
class PayerResponse(object):
    ...
    def __init__(self,
        ...
        """Constructor for the PayerResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Payers') is not None:
            payers = [PayerDetails.from_dictionary(x) for x in dictionary.get('Payers')]
        else:
            payers = APIHelper.SKIP
