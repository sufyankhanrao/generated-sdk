...
class BundleRestrictionUpdate(object):
    ...
    def __init__(self,
        ...
        """Initialize a BundleRestrictionUpdate instance."""
    ...
    def from_dictionary(cls,
        ...
        reset_day_time_restriction =\
            dictionary.get("ResetDayTimeRestriction")\
            if "ResetDayTimeRestriction" in dictionary.keys() else APIHelper.SKIP
        reset_location_restriction =\
            dictionary.get("ResetLocationRestriction")\
            if "ResetLocationRestriction" in dictionary.keys() else APIHelper.SKIP
        reset_product_restriction =\
            dictionary.get("ResetProductRestriction")\
            if "ResetProductRestriction" in dictionary.keys() else APIHelper.SKIP
        ...
        day_time_restriction_profile_id =\
            ...
            if "DayTimeRestrictionProfileId" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"reset_day_time_restriction={(self.reset_day_time_restriction
                     if hasattr(self, 'reset_day_time_restriction') else None)!r}, "
                f"reset_location_restriction={(self.reset_location_restriction
                     if hasattr(self, 'reset_location_restriction') else None)!r}, "
                f"reset_product_restriction={(self.reset_product_restriction
                     if hasattr(self, 'reset_product_restriction') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"reset_day_time_restriction={(self.reset_day_time_restriction
                     if hasattr(self, 'reset_day_time_restriction') else None)!s}, "
                f"reset_location_restriction={(self.reset_location_restriction
                     if hasattr(self, 'reset_location_restriction') else None)!s}, "
                f"reset_product_restriction={(self.reset_product_restriction
                     if hasattr(self, 'reset_product_restriction') else None)!s}, "
                f"usage_restrictions={(self.usage_restrictions
