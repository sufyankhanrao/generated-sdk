...
from shellcardmanagementapis.models.account_access import (
    AccountAccess,
)
from shellcardmanagementapis.models.col_co_access import (
    ColCoAccess,
)
from shellcardmanagementapis.models.eid_access import (
    EIDAccess,
)
from shellcardmanagementapis.models.error_status import (
    ErrorStatus,
)
from shellcardmanagementapis.models.payer_access import (
    PayerAccess,
)
from shellcardmanagementapis.models.role import (
    Role,
)
...
class LoggedInUserResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a LoggedInUserResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        display_name =\
            ...
            if "DisplayName" in dictionary.keys() else APIHelper.SKIP
        id_mssoid =\
            dictionary.get("IdMSSOID")\
            if "IdMSSOID" in dictionary.keys() else APIHelper.SKIP
        preferred_language =\
            dictionary.get("PreferredLanguage")\
            if "PreferredLanguage" in dictionary.keys() else APIHelper.SKIP
        is_super_admin =\
            dictionary.get("IsSuperAdmin")\
            if dictionary.get("IsSuperAdmin") else False
        date_format =\
            dictionary.get("DateFormat")\
            if "DateFormat" in dictionary.keys() else APIHelper.SKIP
        time_format =\
            dictionary.get("TimeFormat")\
            if "TimeFormat" in dictionary.keys() else APIHelper.SKIP
        week_begins =\
            dictionary.get("WeekBegins")\
            if "WeekBegins" in dictionary.keys() else APIHelper.SKIP
        display_week =\
            dictionary.get("DisplayWeek")\
            if dictionary.get("DisplayWeek") else True
        csv_separator =\
            dictionary.get("CSVSeparator")\
            if "CSVSeparator" in dictionary.keys() else APIHelper.SKIP
        decimal_separator =\
            dictionary.get("DecimalSeparator")\
            if "DecimalSeparator" in dictionary.keys() else APIHelper.SKIP
        report_format =\
            dictionary.get("ReportFormat")\
            if "ReportFormat" in dictionary.keys() else APIHelper.SKIP
        has_api_access =\
            dictionary.get("HasAPIAccess")\
            if dictionary.get("HasAPIAccess") else True
        roles = None
        if dictionary.get("Roles") is not None:
            roles = [
                Role.from_dictionary(x)
        ...
        if dictionary.get("Accounts") is not None:
            accounts = [
                AccountAccess.from_dictionary(x)
        ...
        if dictionary.get("CollectingCompanies") is not None:
            collecting_companies = [
                ColCoAccess.from_dictionary(x)
                    for x in dictionary.get("CollectingCompanies")
            ]
        else:
            collecting_companies = APIHelper.SKIP
        ...
        if dictionary.get("EIDAccessDetails") is not None:
            eid_access_details = [
                EIDAccess.from_dictionary(x)
                    for x in dictionary.get("EIDAccessDetails")
            ]
        else:
            eid_access_details = APIHelper.SKIP
        user_classification_by_system =\
            dictionary.get("UserClassificationBySystem")\
            if "UserClassificationBySystem" in dictionary.keys() else APIHelper.SKIP
        user_classification_by_shell =\
            dictionary.get("UserClassificationByShell")\
            if "UserClassificationByShell" in dictionary.keys() else APIHelper.SKIP
        payer_count =\
            dictionary.get("PayerCount")\
            if "PayerCount" in dictionary.keys() else APIHelper.SKIP
        account_count =\
            dictionary.get("AccountCount")\
            if "AccountCount" in dictionary.keys() else APIHelper.SKIP
        card_count =\
            dictionary.get("CardCount")\
            if "CardCount" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"user_name={(self.user_name
                     if hasattr(self, 'user_name') else None)!r}, "
                f"display_name={(self.display_name
                     if hasattr(self, 'display_name') else None)!r}, "
                f"id_mssoid={(self.id_mssoid
                     if hasattr(self, 'id_mssoid') else None)!r}, "
                ...
                f"is_super_admin={(self.is_super_admin
                     if hasattr(self, 'is_super_admin') else None)!r}, "
                f"date_format={(self.date_format
                     if hasattr(self, 'date_format') else None)!r}, "
                f"time_format={(self.time_format
                     if hasattr(self, 'time_format') else None)!r}, "
                f"week_begins={(self.week_begins
                     if hasattr(self, 'week_begins') else None)!r}, "
                f"display_week={(self.display_week
                     if hasattr(self, 'display_week') else None)!r}, "
                f"csv_separator={(self.csv_separator
                     if hasattr(self, 'csv_separator') else None)!r}, "
                f"decimal_separator={(self.decimal_separator
                     if hasattr(self, 'decimal_separator') else None)!r}, "
                f"report_format={(self.report_format
                     if hasattr(self, 'report_format') else None)!r}, "
                f"has_api_access={(self.has_api_access
                     if hasattr(self, 'has_api_access') else None)!r}, "
                ...
                f"collecting_companies={(self.collecting_companies
                     if hasattr(self, 'collecting_companies') else None)!r}, "
                f"eid_access_details={(self.eid_access_details
                     if hasattr(self, 'eid_access_details') else None)!r}, "
                f"user_classification_by_system={(self.user_classification_by_system
                     if hasattr(self, 'user_classification_by_system') else None)!r}, "
                f"user_classification_by_shell={(self.user_classification_by_shell
                     if hasattr(self, 'user_classification_by_shell') else None)!r}, "
                f"payer_count={(self.payer_count
                     if hasattr(self, 'payer_count') else None)!r}, "
                f"account_count={(self.account_count
                     if hasattr(self, 'account_count') else None)!r}, "
                f"card_count={(self.card_count
                     if hasattr(self, 'card_count') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"user_name={(self.user_name
                     if hasattr(self, 'user_name') else None)!s}, "
                f"display_name={(self.display_name
                     if hasattr(self, 'display_name') else None)!s}, "
                f"id_mssoid={(self.id_mssoid
                     if hasattr(self, 'id_mssoid') else None)!s}, "
                f"preferred_language={(self.preferred_language
                     if hasattr(self, 'preferred_language') else None)!s}, "
                f"is_super_admin={(self.is_super_admin
                     if hasattr(self, 'is_super_admin') else None)!s}, "
                f"date_format={(self.date_format
                     if hasattr(self, 'date_format') else None)!s}, "
                f"time_format={(self.time_format
                     if hasattr(self, 'time_format') else None)!s}, "
                f"week_begins={(self.week_begins
                     if hasattr(self, 'week_begins') else None)!s}, "
                f"display_week={(self.display_week
                     if hasattr(self, 'display_week') else None)!s}, "
                f"csv_separator={(self.csv_separator
                     if hasattr(self, 'csv_separator') else None)!s}, "
                f"decimal_separator={(self.decimal_separator
                     if hasattr(self, 'decimal_separator') else None)!s}, "
                f"report_format={(self.report_format
                     if hasattr(self, 'report_format') else None)!s}, "
                f"has_api_access={(self.has_api_access
                     if hasattr(self, 'has_api_access') else None)!s}, "
                ...
                f"collecting_companies={(self.collecting_companies
                     if hasattr(self, 'collecting_companies') else None)!s}, "
                f"eid_access_details={(self.eid_access_details
                     if hasattr(self, 'eid_access_details') else None)!s}, "
                f"user_classification_by_system={(self.user_classification_by_system
                     if hasattr(self, 'user_classification_by_system') else None)!s}, "
                f"user_classification_by_shell={(self.user_classification_by_shell
                     if hasattr(self, 'user_classification_by_shell') else None)!s}, "
                f"payer_count={(self.payer_count
                     if hasattr(self, 'payer_count') else None)!s}, "
                f"account_count={(self.account_count
                     if hasattr(self, 'account_count') else None)!s}, "
                f"card_count={(self.card_count
                     if hasattr(self, 'card_count') else None)!s}, "
