...
from shellcardmanagementapis.models.card_detail import (
    CardDetail,
)
...
class CardManagementV1OrdercardRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a CardManagementV1OrdercardRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("CardDetails") is not None:
            card_details = [
                CardDetail.from_dictionary(x)
                    for x in dictionary.get("CardDetails")
            ]
        else:
            card_details = APIHelper.SKIP
