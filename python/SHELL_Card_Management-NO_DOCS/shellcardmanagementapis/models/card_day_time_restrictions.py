...
class CardDayTimeRestrictions(object):
    ...
    def __init__(self,
        ...
        """Initialize a CardDayTimeRestrictions instance."""
    ...
    def from_dictionary(cls,
        ...
        time_from =\
            dictionary.get("TimeFrom")\
            if "TimeFrom" in dictionary.keys() else APIHelper.SKIP
        time_to =\
            dictionary.get("TimeTo")\
            if "TimeTo" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"time_from={(self.time_from
                     if hasattr(self, 'time_from') else None)!r}, "
                f"time_to={(self.time_to
                     if hasattr(self, 'time_to') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"time_from={(self.time_from
                     if hasattr(self, 'time_from') else None)!s}, "
                f"time_to={(self.time_to
                     if hasattr(self, 'time_to') else None)!s})")
