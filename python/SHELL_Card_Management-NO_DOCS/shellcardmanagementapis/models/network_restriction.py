...
class NetworkRestriction(object):
    ...
    def __init__(self,
        ...
        """Initialize a NetworkRestriction instance."""
    ...
    def from_dictionary(cls,
        ...
        networks =\
            dictionary.get("Networks")\
            if dictionary.get("Networks") else APIHelper.SKIP
        exclusive =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"networks={(self.networks
                     if hasattr(self, 'networks') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"networks={(self.networks
                     if hasattr(self, 'networks') else None)!s}, "
                f"exclusive={(self.exclusive
