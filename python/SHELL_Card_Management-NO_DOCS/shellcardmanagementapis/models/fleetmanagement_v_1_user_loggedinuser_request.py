...
class FleetmanagementV1UserLoggedinuserRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a FleetmanagementV1UserLoggedinuserRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        include_payer_group =\
            dictionary.get("IncludePayerGroup")\
            if dictionary.get("IncludePayerGroup") else False
        include_eid_details =\
            dictionary.get("IncludeEIDDetails")\
            if dictionary.get("IncludeEIDDetails") else False
        requested_api_name =\
            dictionary.get("RequestedAPIName")\
            if "RequestedAPIName" in dictionary.keys() else APIHelper.SKIP
        payer_id =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"include_payer_group={(self.include_payer_group
                     if hasattr(self, 'include_payer_group') else None)!r}, "
                f"include_eid_details={(self.include_eid_details
                     if hasattr(self, 'include_eid_details') else None)!r}, "
                f"requested_api_name={(self.requested_api_name
                     if hasattr(self, 'requested_api_name') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"include_payer_group={(self.include_payer_group
                     if hasattr(self, 'include_payer_group') else None)!s}, "
                f"include_eid_details={(self.include_eid_details
                     if hasattr(self, 'include_eid_details') else None)!s}, "
                f"requested_api_name={(self.requested_api_name
                     if hasattr(self, 'requested_api_name') else None)!s}, "
                f"payer_id={(self.payer_id
