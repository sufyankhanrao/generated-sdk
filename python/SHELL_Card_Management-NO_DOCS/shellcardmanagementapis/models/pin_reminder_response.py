...
from shellcardmanagementapis.models.pin_reminder_reference import PINReminderReference
...
class PINReminderResponse(object):
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the PINReminderResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Data') is not None:
            data = [PINReminderReference.from_dictionary(x) for x in dictionary.get('Data')]
        else:
            data = APIHelper.SKIP
