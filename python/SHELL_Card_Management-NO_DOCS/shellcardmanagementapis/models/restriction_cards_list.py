...
class RestrictionCardsList(object):
    ...
    def __init__(self,
        ...
        """Initialize a RestrictionCardsList instance."""
    ...
    def from_dictionary(cls,
        ...
        reset_usage_restrictions =\
            dictionary.get("ResetUsageRestrictions")\
            if "ResetUsageRestrictions" in dictionary.keys() else APIHelper.SKIP
        reset_day_time_restrictions =\
            dictionary.get("ResetDayTimeRestrictions")\
            if "ResetDayTimeRestrictions" in dictionary.keys() else APIHelper.SKIP
        reset_product_restrictions =\
            dictionary.get("ResetProductRestrictions")\
            if "ResetProductRestrictions" in dictionary.keys() else APIHelper.SKIP
        reset_location_restrictions =\
            dictionary.get("ResetLocationRestrictions")\
            if "ResetLocationRestrictions" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"reset_usage_restrictions={(self.reset_usage_restrictions
                     if hasattr(self, 'reset_usage_restrictions') else None)!r}, "
                f"reset_day_time_restrictions={(self.reset_day_time_restrictions
                     if hasattr(self, 'reset_day_time_restrictions') else None)!r}, "
                f"reset_product_restrictions={(self.reset_product_restrictions
                     if hasattr(self, 'reset_product_restrictions') else None)!r}, "
                f"reset_location_restrictions={(self.reset_location_restrictions
                     if hasattr(self, 'reset_location_restrictions') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"reset_usage_restrictions={(self.reset_usage_restrictions
                     if hasattr(self, 'reset_usage_restrictions') else None)!s}, "
                f"reset_day_time_restrictions={(self.reset_day_time_restrictions
                     if hasattr(self, 'reset_day_time_restrictions') else None)!s}, "
                f"reset_product_restrictions={(self.reset_product_restrictions
                     if hasattr(self, 'reset_product_restrictions') else None)!s}, "
                f"reset_location_restrictions={(self.reset_location_restrictions
                     if hasattr(self, 'reset_location_restrictions') else None)!s}, "
                f"usage_restrictions={(self.usage_restrictions
