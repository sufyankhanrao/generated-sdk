...
from shellcardmanagementapis.models.update_card import (
    UpdateCard,
)


class UpdateCardStatusRequest(object):
    """Implementation of the 'UpdateCardStatusRequest' model.
    ...
    def __init__(self,
        ...
        """Initialize a UpdateCardStatusRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("Cards") is not None:
            cards = [
                UpdateCard.from_dictionary(x)
                    for x in dictionary.get("Cards")
            ]
        target_status =\
            dictionary.get("TargetStatus")\
            if dictionary.get("TargetStatus") else None
        reason_id =\
            dictionary.get("ReasonId")\
            if "ReasonId" in dictionary.keys() else APIHelper.SKIP
        reason_text =\
