...
from shellcardmanagementapis.models.delivery_addresses import (
    DeliveryAddresses,
)
from shellcardmanagementapis.models.error_status import (
    ErrorStatus,
)
from shellcardmanagementapis.models.pin_advice_types import (
    PINAdviceTypes,
)
...
class CustomerDetailResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a CustomerDetailResponse instance."""
        ...
        if pin_change_allowed_from_fleet_pin is not APIHelper.SKIP:
            self.pin_change_allowed_from_fleet_pin =\
                 pin_change_allowed_from_fleet_pin
    ...
    def from_dictionary(cls,
        ...
        account_trading_name =\
            dictionary.get("AccountTradingName")\
            if "AccountTradingName" in dictionary.keys() else APIHelper.SKIP
        allow_fleet_id_input =\
            dictionary.get("AllowFleetIdInput")\
            if "AllowFleetIdInput" in dictionary.keys() else APIHelper.SKIP
        band =\
            dictionary.get("Band")\
        ...
        card_group_position =\
            dictionary.get("CardGroupPosition")\
            if "CardGroupPosition" in dictionary.keys() else APIHelper.SKIP
        correspondence_address = Address.from_dictionary(
            dictionary.get("CorrespondenceAddress"))\
            if "CorrespondenceAddress" in dictionary.keys() else APIHelper.SKIP
        delivery_addresses = None
        if dictionary.get("DeliveryAddresses") is not None:
            delivery_addresses = [
                DeliveryAddresses.from_dictionary(x)
                    for x in dictionary.get("DeliveryAddresses")
            ]
        else:
            delivery_addresses = APIHelper.SKIP
        fleet_pin =\
            dictionary.get("FleetPin")\
            if "FleetPin" in dictionary.keys() else APIHelper.SKIP
        full_name =\
            dictionary.get("FullName")\
            if "FullName" in dictionary.keys() else APIHelper.SKIP
        invoice_customer_id =\
            dictionary.get("InvoiceCustomerId")\
            if "InvoiceCustomerId" in dictionary.keys() else APIHelper.SKIP
        invoice_customer_short_name =\
            dictionary.get("InvoiceCustomerShortName")\
            if "InvoiceCustomerShortName" in dictionary.keys() else APIHelper.SKIP
        is_invoice_point =\
        ...
        vat_number =\
            ...
            if "VATNumber" in dictionary.keys() else APIHelper.SKIP
        payer_id =\
        ...
        self_selected_pin =\
            dictionary.get("SelfSelectedPin")\
            if "SelfSelectedPin" in dictionary.keys() else APIHelper.SKIP
        status =\
            dictionary.get("Status")\
            if "Status" in dictionary.keys() else APIHelper.SKIP
        default_pin_advice_type =\
            dictionary.get("DefaultPINAdviceType")\
            if "DefaultPINAdviceType" in dictionary.keys() else APIHelper.SKIP
        pin_advice_types = None
        if dictionary.get("PINAdviceTypes") is not None:
            pin_advice_types = [
                PINAdviceTypes.from_dictionary(x)
                    for x in dictionary.get("PINAdviceTypes")
            ]
        else:
            pin_advice_types = APIHelper.SKIP
        ...
        pin_change_allowed_by_cardholder =\
            dictionary.get("PINChangeAllowedByCardholder")\
            if "PINChangeAllowedByCardholder" in dictionary.keys() else APIHelper.SKIP
        pin_change_allowed_from_fleet_pin =\
            dictionary.get("PINChangeAllowedFromFleetPIN")\
            if "PINChangeAllowedFromFleetPIN" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"account_trading_name={(self.account_trading_name
                     if hasattr(self, 'account_trading_name') else None)!r}, "
                f"allow_fleet_id_input={(self.allow_fleet_id_input
                     if hasattr(self, 'allow_fleet_id_input') else None)!r}, "
                ...
                f"card_group_position={(self.card_group_position
                     if hasattr(self, 'card_group_position') else None)!r}, "
                f"correspondence_address={(self.correspondence_address
                     if hasattr(self, 'correspondence_address') else None)!r}, "
                f"delivery_addresses={(self.delivery_addresses
                     if hasattr(self, 'delivery_addresses') else None)!r}, "
                f"fleet_pin={(self.fleet_pin
                     if hasattr(self, 'fleet_pin') else None)!r}, "
                f"full_name={(self.full_name
                     if hasattr(self, 'full_name') else None)!r}, "
                f"invoice_customer_id={(self.invoice_customer_id
                     if hasattr(self, 'invoice_customer_id') else None)!r}, "
                f"invoice_customer_short_name={(self.invoice_customer_short_name
                     if hasattr(self, 'invoice_customer_short_name') else None)!r}, "
                ...
                f"self_selected_pin={(self.self_selected_pin
                     if hasattr(self, 'self_selected_pin') else None)!r}, "
                f"status={(self.status if hasattr(self, 'status') else None)!r}, "
                f"default_pin_advice_type={(self.default_pin_advice_type
                     if hasattr(self, 'default_pin_advice_type') else None)!r}, "
                f"pin_advice_types={(self.pin_advice_types
                     if hasattr(self, 'pin_advice_types') else None)!r}, "
                f"error={(self.error if hasattr(self, 'error') else None)!r}, "
                f"request_id={(self.request_id
                     if hasattr(self, 'request_id') else None)!r}, "
                f"pin_change_allowed_by_cardholder={(self.pin_change_allowed_by_cardholder
                     if hasattr(self, 'pin_change_allowed_by_cardholder') else None)!r}, "
                f"pin_change_allowed_from_fleet_pin={(self.pin_change_allowed_from_fleet_pin
                     if hasattr(self, 'pin_change_allowed_from_fleet_pin') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"account_trading_name={(self.account_trading_name
                     if hasattr(self, 'account_trading_name') else None)!s}, "
                f"allow_fleet_id_input={(self.allow_fleet_id_input
                     if hasattr(self, 'allow_fleet_id_input') else None)!s}, "
                f"band={(self.band if hasattr(self, 'band') else None)!s}, "
                f"billing_address={(self.billing_address
                     if hasattr(self, 'billing_address') else None)!s}, "
                f"card_group_position={(self.card_group_position
                     if hasattr(self, 'card_group_position') else None)!s}, "
                f"correspondence_address={(self.correspondence_address
                     if hasattr(self, 'correspondence_address') else None)!s}, "
                f"delivery_addresses={(self.delivery_addresses
                     if hasattr(self, 'delivery_addresses') else None)!s}, "
                f"fleet_pin={(self.fleet_pin
                     if hasattr(self, 'fleet_pin') else None)!s}, "
                f"full_name={(self.full_name
                     if hasattr(self, 'full_name') else None)!s}, "
                f"invoice_customer_id={(self.invoice_customer_id
                     if hasattr(self, 'invoice_customer_id') else None)!s}, "
                f"invoice_customer_short_name={(self.invoice_customer_short_name
                     if hasattr(self, 'invoice_customer_short_name') else None)!s}, "
                f"is_invoice_point={(self.is_invoice_point
                ...
                f"self_selected_pin={(self.self_selected_pin
                     if hasattr(self, 'self_selected_pin') else None)!s}, "
                f"status={(self.status if hasattr(self, 'status') else None)!s}, "
                f"default_pin_advice_type={(self.default_pin_advice_type
                     if hasattr(self, 'default_pin_advice_type') else None)!s}, "
                f"pin_advice_types={(self.pin_advice_types
                     if hasattr(self, 'pin_advice_types') else None)!s}, "
                f"error={(self.error if hasattr(self, 'error') else None)!s}, "
                f"request_id={(self.request_id
                     if hasattr(self, 'request_id') else None)!s}, "
                f"pin_change_allowed_by_cardholder={(self.pin_change_allowed_by_cardholder
                     if hasattr(self, 'pin_change_allowed_by_cardholder') else None)!s}, "
                f"pin_change_allowed_from_fleet_pin={(self.pin_change_allowed_from_fleet_pin
                     if hasattr(self, 'pin_change_allowed_from_fleet_pin') else None)!s})")
