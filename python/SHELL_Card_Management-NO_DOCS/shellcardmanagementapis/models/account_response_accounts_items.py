...
class AccountResponseAccountsItems(object):
    ...
    def __init__(self,
        ...
        """Initialize a AccountResponseAccountsItems instance."""
    ...
    def from_dictionary(cls,
        ...
        best_of_indicator =\
            ...
            if "BestOfIndicator" in dictionary.keys() else APIHelper.SKIP
        billing_frequency_type =\
        ...
        billing_run_frequency =\
            dictionary.get("BillingRunFrequency")\
            if "BillingRunFrequency" in dictionary.keys() else APIHelper.SKIP
        billing_run_frequency_type_id =\
        ...
        gross_amount =\
            dictionary.get("GrossAmount")\
            if "GrossAmount" in dictionary.keys() else APIHelper.SKIP
        international_pos_language_code =\
            dictionary.get("InternationalPOSLanguageCode")\
            if "InternationalPOSLanguageCode" in dictionary.keys() else APIHelper.SKIP
        international_pos_language_id =\
            dictionary.get("InternationalPOSLanguageID")\
            if "InternationalPOSLanguageID" in dictionary.keys() else APIHelper.SKIP
        invoice_account_id =\
        ...
        is_invoice_point =\
            dictionary.get("IsInvoicePoint")\
            if "IsInvoicePoint" in dictionary.keys() else APIHelper.SKIP
        last_modified_date =\
        ...
        local_pos_language_code =\
            ...
            if "LocalPOSLanguageCode" in dictionary.keys() else APIHelper.SKIP
        local_pos_language_id =\
            dictionary.get("LocalPOSLanguageID")\
            if "LocalPOSLanguageID" in dictionary.keys() else APIHelper.SKIP
        net_amount =\
            dictionary.get("NetAmount")\
            if "NetAmount" in dictionary.keys() else APIHelper.SKIP
        outstanding_balance =\
            dictionary.get("OutstandingBalance")\
            if "OutstandingBalance" in dictionary.keys() else APIHelper.SKIP
        paid_amount =\
            dictionary.get("PaidAmount")\
            if "PaidAmount" in dictionary.keys() else APIHelper.SKIP
        status =\
            dictionary.get("Status")\
            if "Status" in dictionary.keys() else APIHelper.SKIP
        status_reason =\
            dictionary.get("StatusReason")\
            if "StatusReason" in dictionary.keys() else APIHelper.SKIP
        total_active_card_groups =\
            dictionary.get("TotalActiveCardGroups")\
            if "TotalActiveCardGroups" in dictionary.keys() else APIHelper.SKIP
        total_active_cards =\
        ...
        vat_amount =\
            dictionary.get("VATAmount")\
            if "VATAmount" in dictionary.keys() else APIHelper.SKIP
        is_partner_card =\
            dictionary.get("IsPartnerCard")\
            if "IsPartnerCard" in dictionary.keys() else APIHelper.SKIP
        tolls_customer_id =\
        ...
        if dictionary.get("Contracts") is not None:
            ...
            contracts = APIHelper.SKIP
        is_consortium_member =\
            dictionary.get("IsConsortiumMember")\
            if "IsConsortiumMember" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"billing_run_frequency={(self.billing_run_frequency
                     if hasattr(self, 'billing_run_frequency') else None)!r}, "
                ...
                f"gross_amount={(self.gross_amount
                     if hasattr(self, 'gross_amount') else None)!r}, "
                ...
                f"is_invoice_point={(self.is_invoice_point
                     if hasattr(self, 'is_invoice_point') else None)!r}, "
                ...
                f"total_active_card_groups={(self.total_active_card_groups
                     if hasattr(self, 'total_active_card_groups') else None)!r}, "
                ...
                f"vat_amount={(self.vat_amount
                     if hasattr(self, 'vat_amount') else None)!r}, "
                f"is_partner_card={(self.is_partner_card
                     if hasattr(self, 'is_partner_card') else None)!r}, "
                ...
                f"is_consortium_member={(self.is_consortium_member
                     if hasattr(self, 'is_consortium_member') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"billing_run_frequency={(self.billing_run_frequency
                     if hasattr(self, 'billing_run_frequency') else None)!s}, "
                f"billing_run_frequency_type_id={(self.billing_run_frequency_type_id
                ...
                f"gross_amount={(self.gross_amount
                     if hasattr(self, 'gross_amount') else None)!s}, "
                f"international_pos_language_code={(self.international_pos_language_code
                ...
                f"is_invoice_point={(self.is_invoice_point
                     if hasattr(self, 'is_invoice_point') else None)!s}, "
                f"last_modified_date={(self.last_modified_date
                ...
                f"total_active_card_groups={(self.total_active_card_groups
                     if hasattr(self, 'total_active_card_groups') else None)!s}, "
                f"total_active_cards={(self.total_active_cards
                ...
                f"vat_amount={(self.vat_amount
                     if hasattr(self, 'vat_amount') else None)!s}, "
                f"is_partner_card={(self.is_partner_card
                     if hasattr(self, 'is_partner_card') else None)!s}, "
                f"tolls_customer_id={(self.tolls_customer_id
                ...
                f"is_consortium_member={(self.is_consortium_member
                     if hasattr(self, 'is_consortium_member') else None)!s})")
