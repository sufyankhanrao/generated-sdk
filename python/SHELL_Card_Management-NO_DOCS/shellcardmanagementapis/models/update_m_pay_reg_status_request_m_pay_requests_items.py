...
class UpdateMPayRegStatusRequestMPayRequestsItems(object):
    ...
    def __init__(self,
        ...
        """Initialize a UpdateMPayRegStatusRequestMPayRequestsItems instance."""
    ...
    def from_dictionary(cls,
        ...
        global_request_id =\
            ...
            if dictionary.get("GlobalRequestID") else APIHelper.SKIP
        status =\
            dictionary.get("Status")\
            if dictionary.get("Status") else APIHelper.SKIP
        approver_user_id =\
            dictionary.get("ApproverUserID")\
            if dictionary.get("ApproverUserID") else APIHelper.SKIP
        approver_user_display_name =\
            dictionary.get("ApproverUserDisplayName")\
            if dictionary.get("ApproverUserDisplayName") else APIHelper.SKIP
        reason =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"approver_user_id={(self.approver_user_id
                     if hasattr(self, 'approver_user_id') else None)!r}, "
                f"approver_user_display_name={(self.approver_user_display_name
                     if hasattr(self, 'approver_user_display_name') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"approver_user_id={(self.approver_user_id
                     if hasattr(self, 'approver_user_id') else None)!s}, "
                f"approver_user_display_name={(self.approver_user_display_name
                     if hasattr(self, 'approver_user_display_name') else None)!s}, "
