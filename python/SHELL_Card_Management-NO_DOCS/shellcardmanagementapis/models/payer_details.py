...
from shellcardmanagementapis.models.address import (
    Address,
)
from shellcardmanagementapis.models.bank_account import (
    BankAccount,
)
from shellcardmanagementapis.models.customer_contract import (
    CustomerContract,
)
from shellcardmanagementapis.models.finance_currency_2 import (
    FinanceCurrency2,
)
from shellcardmanagementapis.models.invoice_distribution_method import (
...
class PayerDetails(object):
    ...
    def __init__(self,
        ...
        """Initialize a PayerDetails instance."""
        ...
        if local_currency_exchange_rate_so_a is not APIHelper.SKIP:
            self.local_currency_exchange_rate_so_a =\
                 local_currency_exchange_rate_so_a
        ...
        if total_temporary_block_cards_by_customer is not APIHelper.SKIP:
            self.total_temporary_block_cards_by_customer =\
                 total_temporary_block_cards_by_customer
        if total_temporary_block_cards_by_shell is not APIHelper.SKIP:
            self.total_temporary_block_cards_by_shell =\
                 total_temporary_block_cards_by_shell
        ...
        if temporary_credit_limit_increase_in_customer_currency is not APIHelper.SKIP:
            self.temporary_credit_limit_increase_in_customer_currency =\
                 temporary_credit_limit_increase_in_customer_currency
        if temporary_credit_limit_expiry_date is not APIHelper.SKIP:
            self.temporary_credit_limit_expiry_date =\
                 temporary_credit_limit_expiry_date
        ...
        if has_active_vol_based_association_bonus is not APIHelper.SKIP:
            self.has_active_vol_based_association_bonus =\
                 has_active_vol_based_association_bonus
    ...
    def from_dictionary(cls,
        ...
        soa_currency_code =\
            dictionary.get("SOACurrencyCode")\
            if "SOACurrencyCode" in dictionary.keys() else APIHelper.SKIP
        soa_currency_symbol =\
            dictionary.get("SOACurrencySymbol")\
            if "SOACurrencySymbol" in dictionary.keys() else APIHelper.SKIP
        soa_credit_limit_currency_code =\
            dictionary.get("SOACreditLimitCurrencyCode")\
            if "SOACreditLimitCurrencyCode" in dictionary.keys() else APIHelper.SKIP
        soa_credit_limit_currency_symbol =\
            dictionary.get("SOACreditLimitCurrencySymbol")\
            if "SOACreditLimitCurrencySymbol" in dictionary.keys() else APIHelper.SKIP
        last_payment_currency_code =\
        ...
        last_payment_amount =\
            dictionary.get("LastPaymentAmount")\
            if "LastPaymentAmount" in dictionary.keys() else APIHelper.SKIP
        last_payment_date =\
            dictionary.get("LastPaymentDate")\
            if "LastPaymentDate" in dictionary.keys() else APIHelper.SKIP
        soa_last_payment_amount =\
            dictionary.get("SOALastPaymentAmount")\
            if "SOALastPaymentAmount" in dictionary.keys() else APIHelper.SKIP
        soa_last_payment_date =\
            dictionary.get("SOALastPaymentDate")\
            if "SOALastPaymentDate" in dictionary.keys() else APIHelper.SKIP
        currency_code =\
        ...
        local_currency_exchange_rate_so_a =\
            dictionary.get("LocalCurrencyExchangeRate_SoA")\
            if "LocalCurrencyExchangeRate_SoA" in dictionary.keys() else APIHelper.SKIP
        billing_frequency_type_id =\
            dictionary.get("BillingFrequencyTypeId")\
            if "BillingFrequencyTypeId" in dictionary.keys() else APIHelper.SKIP
        billing_frequency_type =\
            dictionary.get("BillingFrequencyType")\
            if "BillingFrequencyType" in dictionary.keys() else APIHelper.SKIP
        billing_run_frequency_type_id =\
            dictionary.get("BillingRunFrequencyTypeId")\
            if "BillingRunFrequencyTypeId" in dictionary.keys() else APIHelper.SKIP
        billing_run_frequnecy =\
            dictionary.get("BillingRunFrequnecy")\
            if "BillingRunFrequnecy" in dictionary.keys() else APIHelper.SKIP
        day_1_run =\
            dictionary.get("Day1Run")\
            if "Day1Run" in dictionary.keys() else APIHelper.SKIP
        day_2_run =\
            dictionary.get("Day2Run")\
            if "Day2Run" in dictionary.keys() else APIHelper.SKIP
        day_3_run =\
            dictionary.get("Day3Run")\
            if "Day3Run" in dictionary.keys() else APIHelper.SKIP
        day_4_run =\
            dictionary.get("Day4Run")\
            if "Day4Run" in dictionary.keys() else APIHelper.SKIP
        invoice_distribution_methods = None
        if dictionary.get("InvoiceDistributionMethods") is not None:
            invoice_distribution_methods = [
                InvoiceDistributionMethod.from_dictionary(x)
                    for x in dictionary.get("InvoiceDistributionMethods")
            ]
        else:
            invoice_distribution_methods = APIHelper.SKIP
        output_type =\
        ...
        best_of_indicator =\
            dictionary.get("BestOfIndicator")\
            if dictionary.get("BestOfIndicator") else False
        is_international =\
            dictionary.get("IsInternational")\
            if dictionary.get("IsInternational") else False
        total_accounts =\
            dictionary.get("TotalAccounts")\
            if "TotalAccounts" in dictionary.keys() else APIHelper.SKIP
        total_active_accounts =\
            dictionary.get("TotalActiveAccounts")\
            if "TotalActiveAccounts" in dictionary.keys() else APIHelper.SKIP
        total_cards =\
            dictionary.get("TotalCards")\
            if "TotalCards" in dictionary.keys() else APIHelper.SKIP
        total_active_cards =\
            dictionary.get("TotalActiveCards")\
            if "TotalActiveCards" in dictionary.keys() else APIHelper.SKIP
        total_blocked_cards =\
            dictionary.get("TotalBlockedCards")\
            if "TotalBlockedCards" in dictionary.keys() else APIHelper.SKIP
        total_cancelled_cards =\
            dictionary.get("TotalCancelledCards")\
            if "TotalCancelledCards" in dictionary.keys() else APIHelper.SKIP
        total_expired_cards =\
            dictionary.get("TotalExpiredCards")\
            if "TotalExpiredCards" in dictionary.keys() else APIHelper.SKIP
        total_renewal_pending_cards =\
            dictionary.get("TotalRenewalPendingCards")\
            if "TotalRenewalPendingCards" in dictionary.keys() else APIHelper.SKIP
        total_replaced_cards =\
            dictionary.get("TotalReplacedCards")\
            if "TotalReplacedCards" in dictionary.keys() else APIHelper.SKIP
        total_temporary_block_cards_by_customer =\
            dictionary.get("TotalTemporaryBlockCardsByCustomer")\
            if "TotalTemporaryBlockCardsByCustomer" in dictionary.keys() else APIHelper.SKIP
        total_temporary_block_cards_by_shell =\
            dictionary.get("TotalTemporaryBlockCardsByShell")\
            if "TotalTemporaryBlockCardsByShell" in dictionary.keys() else APIHelper.SKIP
        total_new_cards =\
            dictionary.get("TotalNewCards")\
            if "TotalNewCards" in dictionary.keys() else APIHelper.SKIP
        total_fraud_cards =\
            dictionary.get("TotalFraudCards")\
            if "TotalFraudCards" in dictionary.keys() else APIHelper.SKIP
        total_blocked_accounts =\
            dictionary.get("TotalBlockedAccounts")\
            if "TotalBlockedAccounts" in dictionary.keys() else APIHelper.SKIP
        total_cancelled_accounts =\
            dictionary.get("TotalCancelledAccounts")\
            if "TotalCancelledAccounts" in dictionary.keys() else APIHelper.SKIP
        payer_trading_name =\
            dictionary.get("PayerTradingName")\
            if "PayerTradingName" in dictionary.keys() else APIHelper.SKIP
        status =\
            dictionary.get("Status")\
            if dictionary.get("Status") else APIHelper.SKIP
        billing_language =\
            dictionary.get("BillingLanguage")\
            if "BillingLanguage" in dictionary.keys() else APIHelper.SKIP
        legal_entity =\
            dictionary.get("LegalEntity")\
            if "LegalEntity" in dictionary.keys() else APIHelper.SKIP
        date_established =\
            dictionary.get("DateEstablished")\
            if "DateEstablished" in dictionary.keys() else APIHelper.SKIP
        customer_classification =\
            dictionary.get("CustomerClassification")\
            if "CustomerClassification" in dictionary.keys() else APIHelper.SKIP
        industry_class =\
            dictionary.get("IndustryClass")\
            if "IndustryClass" in dictionary.keys() else APIHelper.SKIP
        marketing_segmentation =\
            dictionary.get("MarketingSegmentation")\
            if "MarketingSegmentation" in dictionary.keys() else APIHelper.SKIP
        line_of_business =\
            dictionary.get("LineOfBusiness")\
            if "LineOfBusiness" in dictionary.keys() else APIHelper.SKIP
        print_credit_limit =\
            dictionary.get("PrintCreditLimit")\
            if dictionary.get("PrintCreditLimit") else False
        card_group_type =\
            dictionary.get("CardGroupType")\
            if "CardGroupType" in dictionary.keys() else APIHelper.SKIP
        renew_cards =\
            dictionary.get("RenewCards")\
            if dictionary.get("RenewCards") else False
        allow_select_pin =\
            dictionary.get("AllowSelectPIN")\
            if dictionary.get("AllowSelectPIN") else False
        use_fleet_pin =\
            dictionary.get("UseFleetPIN")\
            if "UseFleetPIN" in dictionary.keys() else APIHelper.SKIP
        vat_reg_number =\
            dictionary.get("VATRegNumber")\
            if "VATRegNumber" in dictionary.keys() else APIHelper.SKIP
        vat_reg_number_2 =\
            dictionary.get("VATRegNumber2")\
            if dictionary.get("VATRegNumber2") else APIHelper.SKIP
        registration_number =\
            dictionary.get("RegistrationNumber")\
            if "RegistrationNumber" in dictionary.keys() else APIHelper.SKIP
        registration_number_2 =\
            dictionary.get("RegistrationNumber2")\
            if "RegistrationNumber2" in dictionary.keys() else APIHelper.SKIP
        sales_ledger_balance =\
            dictionary.get("SalesLedgerBalance")\
            if "SalesLedgerBalance" in dictionary.keys() else APIHelper.SKIP
        exposure =\
            dictionary.get("Exposure")\
            if "Exposure" in dictionary.keys() else APIHelper.SKIP
        outstanding_debt =\
            dictionary.get("OutstandingDebt")\
            if "OutstandingDebt" in dictionary.keys() else APIHelper.SKIP
        available_credit =\
            dictionary.get("AvailableCredit")\
            if "AvailableCredit" in dictionary.keys() else APIHelper.SKIP
        band =\
            dictionary.get("Band")\
            if "Band" in dictionary.keys() else APIHelper.SKIP
        global_customer_reference_id =\
            dictionary.get("GlobalCustomerReferenceId")\
            if "GlobalCustomerReferenceId" in dictionary.keys() else APIHelper.SKIP
        credit_limit =\
        ...
        payment_method =\
            ...
            if "PaymentMethod" in dictionary.keys() else APIHelper.SKIP
        payment_terms =\
            dictionary.get("PaymentTerms")\
            if "PaymentTerms" in dictionary.keys() else APIHelper.SKIP
        temporary_credit_limit_increase =\
            dictionary.get("TemporaryCreditLimitIncrease")\
            if "TemporaryCreditLimitIncrease" in dictionary.keys() else APIHelper.SKIP
        temporary_credit_limit_increase_in_customer_currency =\
            dictionary.get("TemporaryCreditLimitIncreaseInCustomerCurrency")\
            if "TemporaryCreditLimitIncreaseInCustomerCurrency" in dictionary.keys() else APIHelper.SKIP
        temporary_credit_limit_expiry_date =\
            dictionary.get("TemporaryCreditLimitExpiryDate")\
            if "TemporaryCreditLimitExpiryDate" in dictionary.keys() else APIHelper.SKIP
        payer_bank_account = None
        if dictionary.get("PayerBankAccount") is not None:
            payer_bank_account = [
                BankAccount.from_dictionary(x)
                    for x in dictionary.get("PayerBankAccount")
            ]
        else:
            payer_bank_account = APIHelper.SKIP
        card_delivery_address = Address.from_dictionary(
            dictionary.get("CardDeliveryAddress"))\
            if "CardDeliveryAddress" in dictionary.keys() else APIHelper.SKIP
        correspondance_address = Address.from_dictionary(
            dictionary.get("CorrespondanceAddress"))\
            if "CorrespondanceAddress" in dictionary.keys() else APIHelper.SKIP
        billing_address = Address.from_dictionary(
            dictionary.get("BillingAddress"))\
            if "BillingAddress" in dictionary.keys() else APIHelper.SKIP
        has_active_vol_based_pricing =\
            dictionary.get("HasActiveVolBasedPricing")\
            if "HasActiveVolBasedPricing" in dictionary.keys() else APIHelper.SKIP
        has_active_vol_based_bonus =\
            dictionary.get("HasActiveVolBasedBonus")\
            if "HasActiveVolBasedBonus" in dictionary.keys() else APIHelper.SKIP
        has_active_vol_based_association_bonus =\
            dictionary.get("HasActiveVolBasedAssociationBonus")\
            if "HasActiveVolBasedAssociationBonus" in dictionary.keys() else APIHelper.SKIP
        finance_currency = FinanceCurrency2.from_dictionary(
            dictionary.get("FinanceCurrency"))\
            if "FinanceCurrency" in dictionary.keys() else APIHelper.SKIP
        tolls_customer_id =\
            dictionary.get("TollsCustomerId")\
            if "TollsCustomerId" in dictionary.keys() else APIHelper.SKIP
        tolls_colco_country_type_id =\
            dictionary.get("TollsColcoCountryTypeId")\
            if "TollsColcoCountryTypeId" in dictionary.keys() else APIHelper.SKIP
        contracts = None
        if dictionary.get("Contracts") is not None:
            contracts = [
                CustomerContract.from_dictionary(x)
                    for x in dictionary.get("Contracts")
            ]
        else:
            contracts = APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"soa_currency_code={(self.soa_currency_code
                     if hasattr(self, 'soa_currency_code') else None)!r}, "
                f"soa_currency_symbol={(self.soa_currency_symbol
                     if hasattr(self, 'soa_currency_symbol') else None)!r}, "
                f"soa_credit_limit_currency_code={(self.soa_credit_limit_currency_code
                     if hasattr(self, 'soa_credit_limit_currency_code') else None)!r}, "
                f"soa_credit_limit_currency_symbol={(self.soa_credit_limit_currency_symbol
                     if hasattr(self, 'soa_credit_limit_currency_symbol') else None)!r}, "
                ...
                f"last_payment_amount={(self.last_payment_amount
                     if hasattr(self, 'last_payment_amount') else None)!r}, "
                f"last_payment_date={(self.last_payment_date
                     if hasattr(self, 'last_payment_date') else None)!r}, "
                f"soa_last_payment_amount={(self.soa_last_payment_amount
                     if hasattr(self, 'soa_last_payment_amount') else None)!r}, "
                f"soa_last_payment_date={(self.soa_last_payment_date
                     if hasattr(self, 'soa_last_payment_date') else None)!r}, "
                ...
                f"local_currency_exchange_rate_so_a={(self.local_currency_exchange_rate_so_a
                     if hasattr(self, 'local_currency_exchange_rate_so_a') else None)!r}, "
                f"billing_frequency_type_id={(self.billing_frequency_type_id
                     if hasattr(self, 'billing_frequency_type_id') else None)!r}, "
                f"billing_frequency_type={(self.billing_frequency_type
                     if hasattr(self, 'billing_frequency_type') else None)!r}, "
                f"billing_run_frequency_type_id={(self.billing_run_frequency_type_id
                     if hasattr(self, 'billing_run_frequency_type_id') else None)!r}, "
                f"billing_run_frequnecy={(self.billing_run_frequnecy
                     if hasattr(self, 'billing_run_frequnecy') else None)!r}, "
                f"day_1_run={(self.day_1_run
                     if hasattr(self, 'day_1_run') else None)!r}, "
                f"day_2_run={(self.day_2_run
                     if hasattr(self, 'day_2_run') else None)!r}, "
                f"day_3_run={(self.day_3_run
                     if hasattr(self, 'day_3_run') else None)!r}, "
                f"day_4_run={(self.day_4_run
                     if hasattr(self, 'day_4_run') else None)!r}, "
                f"invoice_distribution_methods={(self.invoice_distribution_methods
                     if hasattr(self, 'invoice_distribution_methods') else None)!r}, "
                ...
                f"best_of_indicator={(self.best_of_indicator
                     if hasattr(self, 'best_of_indicator') else None)!r}, "
                f"is_international={(self.is_international
                     if hasattr(self, 'is_international') else None)!r}, "
                f"total_accounts={(self.total_accounts
                     if hasattr(self, 'total_accounts') else None)!r}, "
                f"total_active_accounts={(self.total_active_accounts
                     if hasattr(self, 'total_active_accounts') else None)!r}, "
                f"total_cards={(self.total_cards
                     if hasattr(self, 'total_cards') else None)!r}, "
                f"total_active_cards={(self.total_active_cards
                     if hasattr(self, 'total_active_cards') else None)!r}, "
                f"total_blocked_cards={(self.total_blocked_cards
                     if hasattr(self, 'total_blocked_cards') else None)!r}, "
                f"total_cancelled_cards={(self.total_cancelled_cards
                     if hasattr(self, 'total_cancelled_cards') else None)!r}, "
                f"total_expired_cards={(self.total_expired_cards
                     if hasattr(self, 'total_expired_cards') else None)!r}, "
                f"total_renewal_pending_cards={(self.total_renewal_pending_cards
                     if hasattr(self, 'total_renewal_pending_cards') else None)!r}, "
                f"total_replaced_cards={(self.total_replaced_cards
                     if hasattr(self, 'total_replaced_cards') else None)!r}, "
                f"total_temporary_block_cards_by_customer={(self.total_temporary_block_cards_by_customer
                     if hasattr(self, 'total_temporary_block_cards_by_customer') else None)!r}, "
                f"total_temporary_block_cards_by_shell={(self.total_temporary_block_cards_by_shell
                     if hasattr(self, 'total_temporary_block_cards_by_shell') else None)!r}, "
                f"total_new_cards={(self.total_new_cards
                     if hasattr(self, 'total_new_cards') else None)!r}, "
                f"total_fraud_cards={(self.total_fraud_cards
                     if hasattr(self, 'total_fraud_cards') else None)!r}, "
                f"total_blocked_accounts={(self.total_blocked_accounts
                     if hasattr(self, 'total_blocked_accounts') else None)!r}, "
                f"total_cancelled_accounts={(self.total_cancelled_accounts
                     if hasattr(self, 'total_cancelled_accounts') else None)!r}, "
                f"payer_trading_name={(self.payer_trading_name
                     if hasattr(self, 'payer_trading_name') else None)!r}, "
                f"status={(self.status if hasattr(self, 'status') else None)!r}, "
                f"billing_language={(self.billing_language
                     if hasattr(self, 'billing_language') else None)!r}, "
                f"legal_entity={(self.legal_entity
                     if hasattr(self, 'legal_entity') else None)!r}, "
                f"date_established={(self.date_established
                     if hasattr(self, 'date_established') else None)!r}, "
                f"customer_classification={(self.customer_classification
                     if hasattr(self, 'customer_classification') else None)!r}, "
                f"industry_class={(self.industry_class
                     if hasattr(self, 'industry_class') else None)!r}, "
                f"marketing_segmentation={(self.marketing_segmentation
                     if hasattr(self, 'marketing_segmentation') else None)!r}, "
                f"line_of_business={(self.line_of_business
                     if hasattr(self, 'line_of_business') else None)!r}, "
                f"print_credit_limit={(self.print_credit_limit
                     if hasattr(self, 'print_credit_limit') else None)!r}, "
                f"card_group_type={(self.card_group_type
                     if hasattr(self, 'card_group_type') else None)!r}, "
                f"renew_cards={(self.renew_cards
                     if hasattr(self, 'renew_cards') else None)!r}, "
                f"allow_select_pin={(self.allow_select_pin
                     if hasattr(self, 'allow_select_pin') else None)!r}, "
                f"use_fleet_pin={(self.use_fleet_pin
                     if hasattr(self, 'use_fleet_pin') else None)!r}, "
                f"vat_reg_number={(self.vat_reg_number
                     if hasattr(self, 'vat_reg_number') else None)!r}, "
                f"vat_reg_number_2={(self.vat_reg_number_2
                     if hasattr(self, 'vat_reg_number_2') else None)!r}, "
                f"registration_number={(self.registration_number
                     if hasattr(self, 'registration_number') else None)!r}, "
                f"registration_number_2={(self.registration_number_2
                     if hasattr(self, 'registration_number_2') else None)!r}, "
                f"sales_ledger_balance={(self.sales_ledger_balance
                     if hasattr(self, 'sales_ledger_balance') else None)!r}, "
                f"exposure={(self.exposure
                     if hasattr(self, 'exposure') else None)!r}, "
                f"outstanding_debt={(self.outstanding_debt
                     if hasattr(self, 'outstanding_debt') else None)!r}, "
                f"available_credit={(self.available_credit
                     if hasattr(self, 'available_credit') else None)!r}, "
                f"band={(self.band if hasattr(self, 'band') else None)!r}, "
                f"global_customer_reference_id={(self.global_customer_reference_id
                     if hasattr(self, 'global_customer_reference_id') else None)!r}, "
                ...
                f"temporary_credit_limit_increase={(self.temporary_credit_limit_increase
                     if hasattr(self, 'temporary_credit_limit_increase') else None)!r}, "
                f"temporary_credit_limit_increase_in_customer_currency={(self.temporary_credit_limit_increase_in_customer_currency
                     if hasattr(self, 'temporary_credit_limit_increase_in_customer_currency') else None)!r}, "
                f"temporary_credit_limit_expiry_date={(self.temporary_credit_limit_expiry_date
                     if hasattr(self, 'temporary_credit_limit_expiry_date') else None)!r}, "
                f"payer_bank_account={(self.payer_bank_account
                     if hasattr(self, 'payer_bank_account') else None)!r}, "
                f"card_delivery_address={(self.card_delivery_address
                     if hasattr(self, 'card_delivery_address') else None)!r}, "
                f"correspondance_address={(self.correspondance_address
                     if hasattr(self, 'correspondance_address') else None)!r}, "
                f"billing_address={(self.billing_address
                     if hasattr(self, 'billing_address') else None)!r}, "
                f"has_active_vol_based_pricing={(self.has_active_vol_based_pricing
                     if hasattr(self, 'has_active_vol_based_pricing') else None)!r}, "
                f"has_active_vol_based_bonus={(self.has_active_vol_based_bonus
                     if hasattr(self, 'has_active_vol_based_bonus') else None)!r}, "
                f"has_active_vol_based_association_bonus={(self.has_active_vol_based_association_bonus
                     if hasattr(self, 'has_active_vol_based_association_bonus') else None)!r}, "
                f"finance_currency={(self.finance_currency
                     if hasattr(self, 'finance_currency') else None)!r}, "
                f"tolls_customer_id={(self.tolls_customer_id
                     if hasattr(self, 'tolls_customer_id') else None)!r}, "
                f"tolls_colco_country_type_id={(self.tolls_colco_country_type_id
                     if hasattr(self, 'tolls_colco_country_type_id') else None)!r}, "
                f"contracts={(self.contracts
                     if hasattr(self, 'contracts') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"soa_currency_code={(self.soa_currency_code
                     if hasattr(self, 'soa_currency_code') else None)!s}, "
                f"soa_currency_symbol={(self.soa_currency_symbol
                     if hasattr(self, 'soa_currency_symbol') else None)!s}, "
                f"soa_credit_limit_currency_code={(self.soa_credit_limit_currency_code
                     if hasattr(self, 'soa_credit_limit_currency_code') else None)!s}, "
                f"soa_credit_limit_currency_symbol={(self.soa_credit_limit_currency_symbol
                     if hasattr(self, 'soa_credit_limit_currency_symbol') else None)!s}, "
                f"last_payment_currency_code={(self.last_payment_currency_code
                     if hasattr(self, 'last_payment_currency_code') else None)!s}, "
                f"last_payment_currency_symbol={(self.last_payment_currency_symbol
                     if hasattr(self, 'last_payment_currency_symbol') else None)!s}, "
                f"last_payment_amount={(self.last_payment_amount
                     if hasattr(self, 'last_payment_amount') else None)!s}, "
                f"last_payment_date={(self.last_payment_date
                     if hasattr(self, 'last_payment_date') else None)!s}, "
                f"soa_last_payment_amount={(self.soa_last_payment_amount
                     if hasattr(self, 'soa_last_payment_amount') else None)!s}, "
                f"soa_last_payment_date={(self.soa_last_payment_date
                     if hasattr(self, 'soa_last_payment_date') else None)!s}, "
                f"currency_code={(self.currency_code
                ...
                f"local_currency_exchange_rate_so_a={(self.local_currency_exchange_rate_so_a
                     if hasattr(self, 'local_currency_exchange_rate_so_a') else None)!s}, "
                f"billing_frequency_type_id={(self.billing_frequency_type_id
                     if hasattr(self, 'billing_frequency_type_id') else None)!s}, "
                f"billing_frequency_type={(self.billing_frequency_type
                     if hasattr(self, 'billing_frequency_type') else None)!s}, "
                f"billing_run_frequency_type_id={(self.billing_run_frequency_type_id
                     if hasattr(self, 'billing_run_frequency_type_id') else None)!s}, "
                f"billing_run_frequnecy={(self.billing_run_frequnecy
                     if hasattr(self, 'billing_run_frequnecy') else None)!s}, "
                f"day_1_run={(self.day_1_run
                     if hasattr(self, 'day_1_run') else None)!s}, "
                f"day_2_run={(self.day_2_run
                     if hasattr(self, 'day_2_run') else None)!s}, "
                f"day_3_run={(self.day_3_run
                     if hasattr(self, 'day_3_run') else None)!s}, "
                f"day_4_run={(self.day_4_run
                     if hasattr(self, 'day_4_run') else None)!s}, "
                f"invoice_distribution_methods={(self.invoice_distribution_methods
                     if hasattr(self, 'invoice_distribution_methods') else None)!s}, "
                f"output_type={(self.output_type
                ...
                f"best_of_indicator={(self.best_of_indicator
                     if hasattr(self, 'best_of_indicator') else None)!s}, "
                f"is_international={(self.is_international
                     if hasattr(self, 'is_international') else None)!s}, "
                f"total_accounts={(self.total_accounts
                     if hasattr(self, 'total_accounts') else None)!s}, "
                f"total_active_accounts={(self.total_active_accounts
                     if hasattr(self, 'total_active_accounts') else None)!s}, "
                f"total_cards={(self.total_cards
                     if hasattr(self, 'total_cards') else None)!s}, "
                f"total_active_cards={(self.total_active_cards
                     if hasattr(self, 'total_active_cards') else None)!s}, "
                f"total_blocked_cards={(self.total_blocked_cards
                     if hasattr(self, 'total_blocked_cards') else None)!s}, "
                f"total_cancelled_cards={(self.total_cancelled_cards
                     if hasattr(self, 'total_cancelled_cards') else None)!s}, "
                f"total_expired_cards={(self.total_expired_cards
                     if hasattr(self, 'total_expired_cards') else None)!s}, "
                f"total_renewal_pending_cards={(self.total_renewal_pending_cards
                     if hasattr(self, 'total_renewal_pending_cards') else None)!s}, "
                f"total_replaced_cards={(self.total_replaced_cards
                     if hasattr(self, 'total_replaced_cards') else None)!s}, "
                f"total_temporary_block_cards_by_customer={(self.total_temporary_block_cards_by_customer
                     if hasattr(self, 'total_temporary_block_cards_by_customer') else None)!s}, "
                f"total_temporary_block_cards_by_shell={(self.total_temporary_block_cards_by_shell
                     if hasattr(self, 'total_temporary_block_cards_by_shell') else None)!s}, "
                f"total_new_cards={(self.total_new_cards
                     if hasattr(self, 'total_new_cards') else None)!s}, "
                f"total_fraud_cards={(self.total_fraud_cards
                     if hasattr(self, 'total_fraud_cards') else None)!s}, "
                f"total_blocked_accounts={(self.total_blocked_accounts
                     if hasattr(self, 'total_blocked_accounts') else None)!s}, "
                f"total_cancelled_accounts={(self.total_cancelled_accounts
                     if hasattr(self, 'total_cancelled_accounts') else None)!s}, "
                f"payer_trading_name={(self.payer_trading_name
                     if hasattr(self, 'payer_trading_name') else None)!s}, "
                f"status={(self.status if hasattr(self, 'status') else None)!s}, "
                f"billing_language={(self.billing_language
                     if hasattr(self, 'billing_language') else None)!s}, "
                f"legal_entity={(self.legal_entity
                     if hasattr(self, 'legal_entity') else None)!s}, "
                f"date_established={(self.date_established
                     if hasattr(self, 'date_established') else None)!s}, "
                f"customer_classification={(self.customer_classification
                     if hasattr(self, 'customer_classification') else None)!s}, "
                f"industry_class={(self.industry_class
                     if hasattr(self, 'industry_class') else None)!s}, "
                f"marketing_segmentation={(self.marketing_segmentation
                     if hasattr(self, 'marketing_segmentation') else None)!s}, "
                f"line_of_business={(self.line_of_business
                     if hasattr(self, 'line_of_business') else None)!s}, "
                f"print_credit_limit={(self.print_credit_limit
                     if hasattr(self, 'print_credit_limit') else None)!s}, "
                f"card_group_type={(self.card_group_type
                     if hasattr(self, 'card_group_type') else None)!s}, "
                f"renew_cards={(self.renew_cards
                     if hasattr(self, 'renew_cards') else None)!s}, "
                f"allow_select_pin={(self.allow_select_pin
                     if hasattr(self, 'allow_select_pin') else None)!s}, "
                f"use_fleet_pin={(self.use_fleet_pin
                     if hasattr(self, 'use_fleet_pin') else None)!s}, "
                f"vat_reg_number={(self.vat_reg_number
                     if hasattr(self, 'vat_reg_number') else None)!s}, "
                f"vat_reg_number_2={(self.vat_reg_number_2
                     if hasattr(self, 'vat_reg_number_2') else None)!s}, "
                f"registration_number={(self.registration_number
                     if hasattr(self, 'registration_number') else None)!s}, "
                f"registration_number_2={(self.registration_number_2
                     if hasattr(self, 'registration_number_2') else None)!s}, "
                f"sales_ledger_balance={(self.sales_ledger_balance
                     if hasattr(self, 'sales_ledger_balance') else None)!s}, "
                f"exposure={(self.exposure
                     if hasattr(self, 'exposure') else None)!s}, "
                f"outstanding_debt={(self.outstanding_debt
                     if hasattr(self, 'outstanding_debt') else None)!s}, "
                f"available_credit={(self.available_credit
                     if hasattr(self, 'available_credit') else None)!s}, "
                f"band={(self.band if hasattr(self, 'band') else None)!s}, "
                f"global_customer_reference_id={(self.global_customer_reference_id
                     if hasattr(self, 'global_customer_reference_id') else None)!s}, "
                f"credit_limit={(self.credit_limit
                ...
                f"temporary_credit_limit_increase={(self.temporary_credit_limit_increase
                     if hasattr(self, 'temporary_credit_limit_increase') else None)!s}, "
                f"temporary_credit_limit_increase_in_customer_currency={(self.temporary_credit_limit_increase_in_customer_currency
                     if hasattr(self, 'temporary_credit_limit_increase_in_customer_currency') else None)!s}, "
                f"temporary_credit_limit_expiry_date={(self.temporary_credit_limit_expiry_date
                     if hasattr(self, 'temporary_credit_limit_expiry_date') else None)!s}, "
                f"payer_bank_account={(self.payer_bank_account
                     if hasattr(self, 'payer_bank_account') else None)!s}, "
                f"card_delivery_address={(self.card_delivery_address
                     if hasattr(self, 'card_delivery_address') else None)!s}, "
                f"correspondance_address={(self.correspondance_address
                     if hasattr(self, 'correspondance_address') else None)!s}, "
                f"billing_address={(self.billing_address
                     if hasattr(self, 'billing_address') else None)!s}, "
                f"has_active_vol_based_pricing={(self.has_active_vol_based_pricing
                     if hasattr(self, 'has_active_vol_based_pricing') else None)!s}, "
                f"has_active_vol_based_bonus={(self.has_active_vol_based_bonus
                     if hasattr(self, 'has_active_vol_based_bonus') else None)!s}, "
                f"has_active_vol_based_association_bonus={(self.has_active_vol_based_association_bonus
                     if hasattr(self, 'has_active_vol_based_association_bonus') else None)!s}, "
                f"finance_currency={(self.finance_currency
                     if hasattr(self, 'finance_currency') else None)!s}, "
                f"tolls_customer_id={(self.tolls_customer_id
                     if hasattr(self, 'tolls_customer_id') else None)!s}, "
                f"tolls_colco_country_type_id={(self.tolls_colco_country_type_id
                     if hasattr(self, 'tolls_colco_country_type_id') else None)!s}, "
                f"contracts={(self.contracts
                     if hasattr(self, 'contracts') else None)!s})")
