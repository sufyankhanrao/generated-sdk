...
from shellcardmanagementapis.models.pin_reminder_card_details import (
...
class CardManagementV1PinreminderRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a CardManagementV1PinreminderRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("PINReminderCardDetails") is not None:
            pin_reminder_card_details = [
                PINReminderCardDetails.from_dictionary(x)
                    for x in dictionary.get("PINReminderCardDetails")
            ]
        else:
            pin_reminder_card_details = APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"pin_reminder_card_details={(self.pin_reminder_card_details
                     if hasattr(self, 'pin_reminder_card_details') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"pin_reminder_card_details={(self.pin_reminder_card_details
                     if hasattr(self, 'pin_reminder_card_details') else None)!s})")
