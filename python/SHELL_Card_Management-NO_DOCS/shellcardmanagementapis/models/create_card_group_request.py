...
from shellcardmanagementapis.models.create_card_group_request_cards_items import (
...
class CreateCardGroupRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a CreateCardGroupRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("Cards") is not None:
            cards = [
                CreateCardGroupRequestCardsItems.from_dictionary(x)
