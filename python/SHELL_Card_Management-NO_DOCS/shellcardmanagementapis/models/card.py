...
class Card(object):
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'is_emv_contact={(self.is_emv_contact if hasattr(self, "is_emv_contact") else None)!r}, '
                f'is_emv_contactless={(self.is_emv_contactless if hasattr(self, "is_emv_contactless") else None)!r}, '
                f'is_rfid={(self.is_rfid if hasattr(self, "is_rfid") else None)!r}, '
                f'rfiduid={(self.rfiduid if hasattr(self, "rfiduid") else None)!r}, '
                ...
                f'card_media_code={(self.card_media_code if hasattr(self, "card_media_code") else None)!r})')
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'is_emv_contact={(self.is_emv_contact if hasattr(self, "is_emv_contact") else None)!s}, '
                f'is_emv_contactless={(self.is_emv_contactless if hasattr(self, "is_emv_contactless") else None)!s}, '
                f'is_rfid={(self.is_rfid if hasattr(self, "is_rfid") else None)!s}, '
                f'rfiduid={(self.rfiduid if hasattr(self, "rfiduid") else None)!s}, '
                ...
                f'card_media_code={(self.card_media_code if hasattr(self, "card_media_code") else None)!s})')
