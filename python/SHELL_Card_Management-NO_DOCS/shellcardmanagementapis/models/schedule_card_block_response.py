...
from shellcardmanagementapis.models.schedule_card_block_response_data_items import ScheduleCardBlockResponseDataItems
...
class ScheduleCardBlockResponse(object):
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the ScheduleCardBlockResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Data') is not None:
            data = [ScheduleCardBlockResponseDataItems.from_dictionary(x) for x in dictionary.get('Data')]
        else:
            data = APIHelper.SKIP
