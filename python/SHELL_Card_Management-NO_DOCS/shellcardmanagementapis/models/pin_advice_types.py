...
class PINAdviceTypes(object):
    ...
    def __init__(self,
        ...
        """Initialize a PINAdviceTypes instance."""
    ...
    def from_dictionary(cls,
        ...
        pin_advice_type_id =\
            dictionary.get("PINAdviceTypeID")\
            if "PINAdviceTypeID" in dictionary.keys() else APIHelper.SKIP
        is_card_order_option =\
            dictionary.get("IsCardOrderOption")\
            if "IsCardOrderOption" in dictionary.keys() else APIHelper.SKIP
        is_pin_reminder_option =\
            dictionary.get("IsPINReminderOption")\
            if "IsPINReminderOption" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"pin_advice_type_id={(self.pin_advice_type_id
                     if hasattr(self, 'pin_advice_type_id') else None)!r}, "
                f"is_card_order_option={(self.is_card_order_option
                     if hasattr(self, 'is_card_order_option') else None)!r}, "
                f"is_pin_reminder_option={(self.is_pin_reminder_option
                     if hasattr(self, 'is_pin_reminder_option') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"pin_advice_type_id={(self.pin_advice_type_id
                     if hasattr(self, 'pin_advice_type_id') else None)!s}, "
                f"is_card_order_option={(self.is_card_order_option
                     if hasattr(self, 'is_card_order_option') else None)!s}, "
                f"is_pin_reminder_option={(self.is_pin_reminder_option
                     if hasattr(self, 'is_pin_reminder_option') else None)!s})")
