...
from shellcardmanagementapis.models.auto_renew_card_response_data_items import AutoRenewCardResponseDataItems
...
class AutoRenewCardResponse(object):
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the AutoRenewCardResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Data') is not None:
            data = [AutoRenewCardResponseDataItems.from_dictionary(x) for x in dictionary.get('Data')]
        else:
            data = APIHelper.SKIP
