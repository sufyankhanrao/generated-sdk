...
from shellcardmanagementapis.http.proxy_settings import (
    ProxySettings,
)
...
class Configuration(HttpClientConfiguration):
    ...
    def bearer_token_credentials(self):
        """Return current bearer_token_credentials."""
    ...
    def clone_with(self, http_client_instance=None,
                   ...
                   retry_statuses=None, retry_methods=None, proxy_settings=None,
                   environment=None, basic_auth_credentials=None,
                   bearer_token_credentials=None):
        ...
        bearer_token_credentials =\
            (bearer_token_credentials
            or self.bearer_token_credentials)
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        default_config = cls(
            ...
            bearer_token_credentials=BearerTokenCredentials.from_environment(),
        )
