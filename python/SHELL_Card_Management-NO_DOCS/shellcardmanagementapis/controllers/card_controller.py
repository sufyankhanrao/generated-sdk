...
from shellcardmanagementapis.exceptions.error_object_exception import (
    ErrorObjectException,
)
from shellcardmanagementapis.http.http_method_enum import (
    HttpMethodEnum,
)
from shellcardmanagementapis.models.auto_renew_card_response import (
    AutoRenewCardResponse,
)
from shellcardmanagementapis.models.cancel_card_response import (
    CancelCardResponse,
)
from shellcardmanagementapis.models.card_details_response import (
    CardDetailsResponse,
)
from shellcardmanagementapis.models.card_move_response import (
    CardMoveResponse,
)
from shellcardmanagementapis.models.card_search_response import (
    CardSearchResponse,
)
from shellcardmanagementapis.models.card_summary_response import (
    CardSummaryResponse,
)
from shellcardmanagementapis.models.delivery_address_update_response import (
    DeliveryAddressUpdateResponse,
)
from shellcardmanagementapis.models.generate_pin_key_response import (
    GeneratePINKeyResponse,
)
from shellcardmanagementapis.models.order_card_enquiry_response import (
    OrderCardEnquiryResponse,
)
from shellcardmanagementapis.models.order_card_response import (
    OrderCardResponse,
)
from shellcardmanagementapis.models.pin_reminder_response import (
    PINReminderResponse,
)
from shellcardmanagementapis.models.purchase_category_response import (
    PurchaseCategoryResponse,
)
from shellcardmanagementapis.models.schedule_card_block_response import (
    ScheduleCardBlockResponse,
)
from shellcardmanagementapis.models.update_card_status_response import (
    UpdateCardStatusResponse,
)
from shellcardmanagementapis.models.update_m_pay_reg_status_response import (
...
class CardController(BaseController):
    ...
    def __init__(self, config):
        """Initialize CardController object."""
        super(CardController, self).__init__(config)

    def searchcard(self,
                   request_id,
                   body=None):
        """Perform a POST request to /card-management/v1/search.
    ...
    def cardsummary(self,
                    request_id,
                    body=None):
        """Perform a POST request to /card-management/v1/summary.
    ...
    def cardordercard(self,
                      request_id,
                      body=None):
        """Perform a POST request to /card-management/v1/ordercard.
    ...
    def cardordercardenquiry(self,
                             request_id,
                             body=None):
        """Perform a POST request to /card-management/v1/ordercardenquiry.
    ...
    def cardcancel(self,
                   request_id,
                   body=None):
        """Perform a POST request to /card-management/v1/cancel.
    ...
    def cardupdatestatus(self,
                         request_id,
                         body=None):
        """Perform a POST request to /card-management/v1/updatestatus.
    ...
    def purchase_category(self,
                          ...
                          request_id,
                          body=None):
        """Perform a POST request to /fleetmanagement/v1/master/purchasecategory.
    ...
    def carddetails(self,
                    ...
                    request_id,
                    body=None):
        """Perform a POST request to /fleetmanagement/v1/card/card.
    ...
    def card_move(self,
                  ...
                  request_id,
                  body=None):
        """Perform a POST request to /fleetmanagement/v1/card/move.
    ...
    def cardpinreminder(self,
                        request_id,
                        body=None):
        """Perform a POST request to /card-management/v1/pinreminder.
    ...
    def schedule_card_block(self,
                            request_id,
                            body=None):
        """Perform a POST request to /card-management/v1/schedulecardblock.
    ...
    def autorenew(self,
                  request_id,
                  body=None):
        """Perform a POST request to /card-management/v1/autorenew.
    ...
    def getkey(self,
               request_id,
               fleet=None):
        """Perform a GET request to /pin-management/v1/generatepinkeys.
    ...
    def deliveryaddressupdate(self,
                              apikey,
                              body=None):
        """Perform a POST request to /fleetmanagement/v1/card/deliveryaddressupdate.
