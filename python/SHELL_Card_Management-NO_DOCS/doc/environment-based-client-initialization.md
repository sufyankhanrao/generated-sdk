...
client = ShellCardManagementApIsClient.from_environment(
...
BEARER_TOKEN_O_AUTH_CLIENT_ID=ExampleOAuthClientId
BEARER_TOKEN_O_AUTH_CLIENT_SECRET=ExampleOAuthClientSecret
BEARER_TOKEN_O_AUTH_CLOCK_SKEW=5
