...
class UnixTimeStampException(APIException):
    def __init__(self, reason, response):
        """Initialize UnixTimeStampException object.
        ...
        """
        super(UnixTimeStampException, self).__init__(reason, response)
    ...
    def unbox(self, dictionary):
        ...
        """
        self.date_time = APIHelper.UnixDateTime.from_value(
            dictionary.get("dateTime")).datetime\
            if dictionary.get("dateTime") else None
        self.date_time_1 = APIHelper.UnixDateTime.from_value(
