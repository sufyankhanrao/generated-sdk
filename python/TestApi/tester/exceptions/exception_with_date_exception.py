...
class ExceptionWithDateException(APIException):
    def __init__(self, reason, response):
        """Initialize ExceptionWithDateException object.
    ...
    def unbox(self, dictionary):
        ...
        """
        self.value = dateutil.parser.parse(dictionary.get("value")).date()\
            if dictionary.get("value") else None
        self.value_1 = dateutil.parser.parse(dictionary.get("value1")).date()\
