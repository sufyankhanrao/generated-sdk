...
class ExceptionWithRfc3339DateTimeException(APIException):
    def __init__(self, reason, response):
        """Initialize ExceptionWithRfc3339DateTimeException object.
    ...
    def unbox(self, dictionary):
        ...
        """
        self.date_time = APIHelper.RFC3339DateTime.from_value(
            dictionary.get("dateTime")).datetime\
            if dictionary.get("dateTime") else None
        self.date_time_1 = APIHelper.RFC3339DateTime.from_value(
