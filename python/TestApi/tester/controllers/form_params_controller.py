...
class FormParamsController(BaseController):
    ...
    def send_delete_form(self,
                         body):
        """Perform a DELETE request to /form/deleteForm.
    ...
    def send_delete_multipart(self,
                              file):
        """Perform a DELETE request to /form/deleteMultipart.
    ...
    def send_date_array(self,
                        dates):
        """Perform a POST request to /form/date.
    ...
    def send_unix_date_time(self,
                            datetime):
        """Perform a POST request to /form/unixdatetime.
    ...
    def send_rfc_1123_date_time(self,
                                datetime):
        """Perform a POST request to /form/rfc1123datetime.
    ...
    def send_rfc_3339_date_time(self,
                                datetime):
        """Perform a POST request to /form/rfc3339datetime.
    ...
    def send_long(self,
                  value):
        """Perform a POST request to /form/number.
    ...
    def send_string_array(self,
                          strings):
        """Perform a POST request to /form/string.
    ...
    def allow_dynamic_form_fields(self,
        ...
        """Perform a POST request to /form/allowDynamicFormFields.
    ...
    def send_model(self,
                   model):
        """Perform a POST request to /form/model.
    ...
    def send_file(self,
                  file):
        """Perform a POST request to /form/file.
    ...
    def send_mixed_array(self,
                         options=dict()):
        """Perform a POST request to /form/mixed.
    ...
    def update_model_with_form(self,
                               model):
        """Perform a PUT request to /form/updateModel.
    ...
    def send_delete_form_1(self,
                           model):
        """Perform a DELETE request to /form/deleteForm1.
    ...
    def update_string_with_form(self,
                                value):
        """Perform a PUT request to /form/updateString.
    ...
    def send_integer_enum_array(self,
                                suites):
        """Perform a POST request to /form/integerenum.
    ...
    def send_string_enum_array(self,
                               days):
        """Perform a POST request to /form/stringenum.
    ...
    def send_string_in_form_with_new_line(self,
                                          body):
        """Perform a POST request to /form/stringEncoding.
    ...
    def all_optionals(self,
                      model,
                      option="empty"):
        """Perform a POST request to /form/alloptionals.
    ...
    def send_optional_unix_date_time_in_body(self,
                                             date_time=None):
        """Perform a POST request to /form/optionalUnixTimeStamp.
    ...
    def send_optional_rfc_1123_in_body(self,
                                       body):
        """Perform a POST request to /form/optionlRfc1123.
    ...
    def send_datetime_optional_in_endpoint(self,
                                           body=None):
        """Perform a POST request to /form/optionalDateTime.
    ...
    def send_optional_unix_time_stamp_in_model_body(self,
                                                    date_time):
        """Perform a POST request to /form/optionalUnixDateTimeInModel.
    ...
    def send_optional_unix_time_stamp_in_nested_model_body(self,
                                                           date_time):
        """Perform a POST request to /form/optionalUnixTimeStampInNestedModel.
    ...
    def send_rfc_1123_date_time_in_nested_model(self,
                                                body):
        """Perform a POST request to /form/rfc1123InNestedModel.
    ...
    def send_rfc_339_date_time_in_nested_models(self,
                                                body):
        """Perform a POST request to /form/dateTimeInNestedModel.
    ...
    def uuid_as_optional(self,
                         body):
        """Perform a POST request to /form/optionalUUIDInModel.
    ...
    def boolean_as_optional(self,
                            body):
        """Perform a POST request to /form/optionalBooleanInModel.
    ...
    def date_as_optional(self,
                         body):
        """Perform a POST request to /form/optionalDateInModel.
    ...
    def dynamic_as_optional(self,
                            body):
        """Perform a POST request to /form/optionalDynamicInModel.
    ...
    def string_as_optional(self,
                           body):
        """Perform a POST request to /form/optionalStringInModel.
    ...
    def precision_as_optional(self,
                              body):
        """Perform a POST request to /form/optionalPrecisionInModel.
    ...
    def long_as_optional(self,
                         body):
        """Perform a POST request to /form/optionalLongInModel.
    ...
    def send_number_as_optional(self,
                                body):
        """Perform a POST request to /form/optionalNumberInModel.
