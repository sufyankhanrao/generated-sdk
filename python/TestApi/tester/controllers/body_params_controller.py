...
class BodyParamsController(BaseController):
    ...
    def send_string(self,
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(ServerResponse.from_dictionary)
            .is_api_response(True)
            .local_error('400', 'The request was malformed.\nIf this update is a \'report lost\' but the user does not have a known address with a known state, the title of the error will be "User record missing address.""', RFC7807ErrorResponseErrorException)
        ).execute()
    ...
    def all_optionals(self,
                      body,
                      option='empty'):
        """Does a POST request to /body/alloptionals.
