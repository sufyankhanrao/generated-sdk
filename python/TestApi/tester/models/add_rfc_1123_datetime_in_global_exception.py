...
class AddRfc1123DatetimeInGlobalException(object):
    ...
    def __init__(self,
        ...
        """Initialize a AddRfc1123DatetimeInGlobalException instance."""
        # Initialize members of the class
        self.date_time =\
             APIHelper.apply_datetime_converter(
            date_time, APIHelper.HttpDateTime) if date_time else None
        if date_time_1 is not APIHelper.SKIP:
            self.date_time_1 =\
                 APIHelper.apply_datetime_converter(
                date_time_1, APIHelper.HttpDateTime) if date_time_1 else None
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"date_time_1={(self.date_time_1
                     if hasattr(self, 'date_time_1') else None)!r}, "
