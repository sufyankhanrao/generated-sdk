...
class GlossEntry(object):
    ...
    def from_dictionary(cls,
        ...
        gloss_def = GlossDef.from_dictionary(dictionary.get('GlossDef')) if dictionary.get('GlossDef') else None
        gloss_see = dictionary.get("GlossSee") if dictionary.get("GlossSee") else None
        gloss_term = dictionary.get("GlossTerm") if dictionary.get("GlossTerm") else None
