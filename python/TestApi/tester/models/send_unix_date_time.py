...
class SendUnixDateTime(object):
    ...
    Attributes:
        date_time (UnixDateTime): The model property of type UnixDateTime.
    ...
    def from_dictionary(cls,
        ...
        date_time = UnixDateTime.from_dictionary(dictionary.get('dateTime')) if 'dateTime' in dictionary.keys() else APIHelper.SKIP
