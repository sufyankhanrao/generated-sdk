...
class AddStringInGlobalException(object):

    """Implementation of the 'Add String in global exception' model.

    Attributes:
        value (str): The model property of type str.
        value_1 (str): The model property of type str.
    ...
    def __init__(self,
        ...
        """Constructor for the AddStringInGlobalException class"""
