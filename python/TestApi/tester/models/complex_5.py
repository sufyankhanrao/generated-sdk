...
class Complex5(object):
    ...
    def from_dictionary(cls,
        ...
        response_details = dictionary.get("responseDetails") if dictionary.get("responseDetails") else None
        response_status = dictionary.get("responseStatus") if dictionary.get("responseStatus") else None
