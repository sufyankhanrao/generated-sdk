...
class Payment(object):
    ...
    def from_dictionary(cls,
        ...
        payment_type = dictionary.get("paymentType") if dictionary.get("paymentType") else 'Payment'
...
class PaymentCard(Payment):
    ...
    def from_dictionary(cls,
        ...
        # Extract variables from the dictionary
        swiped = dictionary.get("swiped") if "swiped" in dictionary.keys() else None
        payment_type = dictionary.get("paymentType") if dictionary.get("paymentType") else 'CARD'
        # Clean out expected properties from dictionary
        additional_properties = {k: v for k, v in dictionary.items() if k not in cls._names.values()}
        # Return an object of this model
        return cls(swiped,
...
class PaymentCash(Payment):
    ...
    def __init__(self,
                 ...
                 payment_type='CASH',
                 additional_properties=None):
        """Constructor for the PaymentCash class"""
    ...
    def from_dictionary(cls,
        ...
        # Extract variables from the dictionary
        received = dictionary.get("received") if "received" in dictionary.keys() else None
        payment_type = dictionary.get("paymentType") if dictionary.get("paymentType") else 'CASH'
        # Clean out expected properties from dictionary
        additional_properties = {k: v for k, v in dictionary.items() if k not in cls._names.values()}
        # Return an object of this model
        return cls(received,
