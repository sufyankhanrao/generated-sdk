...
class AddRfc3339DatetimeInGlobalException(object):

    """Implementation of the 'Add rfc3339 datetime in global exception' model.
    ...
    def __init__(self,
        ...
        """Constructor for the AddRfc3339DatetimeInGlobalException class"""
        ...
        if date_time_1 is not APIHelper.SKIP:
            self.date_time_1 = APIHelper.apply_datetime_converter(date_time_1, APIHelper.RFC3339DateTime) if date_time_1 else None 
    ...
    def from_dictionary(cls,
        ...
        date_time_1 = APIHelper.RFC3339DateTime.from_value(dictionary.get("dateTime1")).datetime if dictionary.get("dateTime1") else APIHelper.SKIP
