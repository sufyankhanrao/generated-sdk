...
class StringAsOptional(object):
    ...
    def __init__(self,
        ...
        """Constructor for the StringAsOptional class"""
...
class AllOptionals(StringAsOptional):
    ...
    def __init__(self,
                 ...
                 string=APIHelper.SKIP,
                 additional_properties=None):
        """Constructor for the AllOptionals class"""
    ...
    def from_dictionary(cls,
        ...
        optional_long = LongAsOptional.from_dictionary(dictionary.get('optionalLong')) if 'optionalLong' in dictionary.keys() else APIHelper.SKIP
        optional_numbers = None
        if dictionary.get('optionalNumbers') is not None:
            optional_numbers = [NumberAsOptional.from_dictionary(x) for x in dictionary.get('optionalNumbers')]
        else:
            optional_numbers = APIHelper.SKIP
        optional_precision = PrecisionAsOptional.from_dictionary(dictionary.get('optionalPrecision')) if 'optionalPrecision' in dictionary.keys() else APIHelper.SKIP
        string = dictionary.get("string") if dictionary.get("string") else APIHelper.SKIP
        # Clean out expected properties from dictionary
        additional_properties = {k: v for k, v in dictionary.items() if k not in cls._names.values()}
        # Return an object of this model
    ...
    def __repr__(self):
        ...
        return (f'{self.__class__.__name__}('
                ...
                f'optional_numbers={(self.optional_numbers if hasattr(self, "optional_numbers") else None)!r}, '
                f'optional_long={(self.optional_long if hasattr(self, "optional_long") else None)!r}, '
                f'optional_precision={(self.optional_precision if hasattr(self, "optional_precision") else None)!r})')
    ...
    def __str__(self):
        ...
        return (f'{self.__class__.__name__}('
                ...
                f'optional_numbers={(self.optional_numbers if hasattr(self, "optional_numbers") else None)!s}, '
                f'optional_long={(self.optional_long if hasattr(self, "optional_long") else None)!s}, '
                f'optional_precision={(self.optional_precision if hasattr(self, "optional_precision") else None)!s})')
