...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `field` | `str` | Body, Required | - |
| `name` | `str` | Body, Required | - |
...
result = body_params_controller.wrap_body_in_object(
    field,
    name
)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `models` | [`Dict[str, Employee]`](../../doc/models/employee.md) | Body, Required | - |
...
|  --- | --- | --- |
| 400 | The request was malformed.<br>If this update is a 'report lost' but the user does not have a known address with a known state, the title of the error will be "User record missing address."" | [`RFC7807ErrorResponseErrorException`](../../doc/models/rfc7807-error-response-error-exception.md) |
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `days` | [`List[Days1Enum]`](../../doc/models/days-1-enum.md) | Body, Required | - |
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `suites` | [`List[SuiteCodeEnum]`](../../doc/models/suite-code-enum.md) | Body, Required | - |
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `strings` | `List[str]` | Body, Required | - |
...
result = body_params_controller.send_optional_unix_date_time_in_body(
    date_time=date_time
)
...
result = body_params_controller.all_optionals(
    body,
    option=option
)
