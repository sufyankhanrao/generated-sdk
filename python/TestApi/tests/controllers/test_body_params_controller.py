...
from tester.exceptions.rfc_7807_error_response_error_exception import RFC7807ErrorResponseErrorException
...
class BodyParamsControllerTests(ControllerTestBase):
    ...
    # Todo: Add description for test test_send_model_map
    @unittest.skip("temporarily disabled")
    def test_send_model_map(self):
        # Parameters for the API call
        models = APIHelper.json_deserialize('{"key0":{"name":"Shahid Khaliq","age":5147483645,"address":"H # 53'
            '1, S # 20","uid":"123321","birthday":"1994-02-13","birthtime":"199'
            '4-02-13T14:01:54.9571247Z","salary":20000,"department":"Software D'
            'evelopment","joiningDay":"Saturday","workingDays":["Monday","Tuesd'
            'ay","Friday"],"boss":{"personType":"Boss","name":"Zeeshan Ejaz","a'
            'ge":5147483645,"address":"H # 531, S # 20","uid":"123321","birthda'
            'y":"1994-02-13","birthtime":"1994-02-13T14:01:54.9571247Z","salary'
            '":20000,"department":"Software Development","joiningDay":"Saturday'
            '","workingDays":["Monday","Tuesday","Friday"],"dependents":[{"name'
            '":"Future Wife","age":5147483649,"address":"H # 531, S # 20","uid"'
            ':"123412","birthday":"1994-02-13","birthtime":"1994-02-13T14:01:54'
            '.9571247Z"},{"name":"Future Kid","age":5147483648,"address":"H # 5'
            '31, S # 20","uid":"312341","birthday":"1994-02-13","birthtime":"19'
            '94-02-13T14:01:54.9571247Z"}],"hiredAt":"Sun, 06 Nov 1994 08:49:37'
            ' GMT","promotedAt":1484719381},"dependents":[{"name":"Future Wife"'
            ',"age":5147483649,"address":"H # 531, S # 20","uid":"123412","birt'
            'hday":"1994-02-13","birthtime":"1994-02-13T14:01:54.9571247Z"},{"n'
            'ame":"Future Kid","age":5147483648,"address":"H # 531, S # 20","ui'
            'd":"312341","birthday":"1994-02-13","birthtime":"1994-02-13T14:01:'
            '54.9571247Z"}],"hiredAt":"Sun, 06 Nov 1994 08:49:37 GMT"},"key1":{'
            '"name":"Shahid Khaliq","age":5147483645,"address":"H # 531, S # 20'
            '","uid":"123321","birthday":"1994-02-13","birthtime":"1994-02-13T1'
            '4:01:54.9571247Z","salary":20000,"department":"Software Developmen'
            't","joiningDay":"Saturday","workingDays":["Monday","Tuesday","Frid'
            'ay"],"boss":{"personType":"Boss","name":"Zeeshan Ejaz","age":51474'
            '83645,"address":"H # 531, S # 20","uid":"123321","birthday":"1994-'
            '02-13","birthtime":"1994-02-13T14:01:54.9571247Z","salary":20000,"'
            'department":"Software Development","joiningDay":"Saturday","workin'
            'gDays":["Monday","Tuesday","Friday"],"dependents":[{"name":"Future'
            ' Wife","age":5147483649,"address":"H # 531, S # 20","uid":"123412"'
            ',"birthday":"1994-02-13","birthtime":"1994-02-13T14:01:54.9571247Z'
            '"},{"name":"Future Kid","age":5147483648,"address":"H # 531, S # 2'
            '0","uid":"312341","birthday":"1994-02-13","birthtime":"1994-02-13T'
            '14:01:54.9571247Z"}],"hiredAt":"Sun, 06 Nov 1994 08:49:37 GMT","pr'
            'omotedAt":1484719381},"dependents":[{"name":"Future Wife","age":51'
            '47483649,"address":"H # 531, S # 20","uid":"123412","birthday":"19'
            '94-02-13","birthtime":"1994-02-13T14:01:54.9571247Z"},{"name":"Fut'
            'ure Kid","age":5147483648,"address":"H # 531, S # 20","uid":"31234'
            '1","birthday":"1994-02-13","birthtime":"1994-02-13T14:01:54.957124'
            '7Z"}],"hiredAt":"Sun, 06 Nov 1994 08:49:37 GMT"}}', Employee.from_dictionary, as_dict=True)

        # Perform the API call through the SDK function
        result = self.controller.send_model_map(models)
    ...
    def test_empty_optionals(self):
        # Parameters for the API call
        body = APIHelper.json_deserialize('{}', AllOptionals.from_dictionary)
        option = None

        # Perform the API call through the SDK function
        result = self.controller.all_optionals(body, option)
    ...
    def test_set_optionals_with_empty_body(self):
        # Parameters for the API call
        body = APIHelper.json_deserialize('{"optionalNumbers":[{},{}],"optionalLong":{},"optionalPrecision":{'
    ...
    def test_set_optionals_with_set_body(self):
        # Parameters for the API call
        body = APIHelper.json_deserialize('{"id":14,"optionalNumbers":[{"number":23},{"number":45}],"optional'
