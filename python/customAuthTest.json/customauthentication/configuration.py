...
from customauthentication.http.proxy_settings import (
    ProxySettings,
)
from customauthentication.models.suite_code_enum import (
    SuiteCodeEnum,
)
...
class Configuration(HttpClientConfiguration):
    ...
    def __init__(self, http_client_instance=None,
                 ...
                 environment=Environment.TESTING, port="80", suites=1, access_token=""):
