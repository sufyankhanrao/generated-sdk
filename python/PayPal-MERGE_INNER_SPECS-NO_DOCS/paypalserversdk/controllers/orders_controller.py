...
from paypalserversdk.models.order_authorize_response import (
...
class OrdersController(BaseController):
    ...
    def create_order(self,
                     options=dict()):
        """Perform a POST request to /v2/checkout/orders.
    ...
    def get_order(self,
                  options=dict()):
        """Perform a GET request to /v2/checkout/orders/{id}.
    ...
    def patch_order(self,
                    options=dict()):
        """Perform a PATCH request to /v2/checkout/orders/{id}.
    ...
    def confirm_order(self,
                      options=dict()):
        """Perform a POST request to /v2/checkout/orders/{id}/confirm-payment-source.
    ...
    def authorize_order(self,
                        options=dict()):
        """Perform a POST request to /v2/checkout/orders/{id}/authorize.
    ...
    def capture_order(self,
                      options=dict()):
        """Perform a POST request to /v2/checkout/orders/{id}/capture.
    ...
    def create_order_tracking(self,
                              options=dict()):
        """Perform a POST request to /v2/checkout/orders/{id}/track.
    ...
    def update_order_tracking(self,
                              options=dict()):
        """Perform a PATCH request to /v2/checkout/orders/{id}/trackers/{tracker_id}.
