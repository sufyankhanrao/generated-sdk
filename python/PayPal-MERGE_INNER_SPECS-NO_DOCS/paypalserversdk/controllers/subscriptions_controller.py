...
from paypalserversdk.exceptions.subscription_error_exception import (
    SubscriptionErrorException,
)
from paypalserversdk.http.http_method_enum import (
    HttpMethodEnum,
)
from paypalserversdk.models.billing_plan import (
    BillingPlan,
)
from paypalserversdk.models.modify_subscription_response import (
    ModifySubscriptionResponse,
)
from paypalserversdk.models.plan_collection import (
    PlanCollection,
)
from paypalserversdk.models.subscription import (
    Subscription,
)
from paypalserversdk.models.subscription_collection import (
    SubscriptionCollection,
)
from paypalserversdk.models.subscription_transaction_details import (
    SubscriptionTransactionDetails,
)
from paypalserversdk.models.transactions_list import (
    TransactionsList,
)
...
class SubscriptionsController(BaseController):
    ...
    def create_billing_plan(self,
        ...
        return super().new_api_call_builder.request(
            ...
            .local_error("400",
                "Bad Request. Request is not well-formed, syntactically incorre"
                "ct, or violates schema.",
                SubscriptionErrorException)
            .local_error("401",
            ...
            .local_error("403",
                ...
                SubscriptionErrorException)
            .local_error("422",
                "The requested action could not be performed, semantically inco"
                "rrect, or failed business validation.",
                SubscriptionErrorException)
            .local_error("500",
    ...
    def list_billing_plans(self,
        ...
        return super().new_api_call_builder.request(
            ...
            .is_api_response(True)
            .local_error("400",
                "Request is not well-formed, syntactically incorrect, or violat"
                "es schema.",
                SubscriptionErrorException)
            .local_error("401",
                "Authentication failed due to missing authorization header, or "
    ...
    def update_billing_plan_pricing_schemes(self,
                                            options=dict()):
        """Perform a POST request to /v1/billing/plans/{id}/update-pricing-schemes.
    ...
    def patch_subscription(self,
        ...
        attributes that have already completed (Example - trial cycles can’t
    ...
    def list_subscription_transactions(self,
                                       options=dict()):
        """Perform a GET request to /v1/billing/subscriptions/{id}/transactions.
