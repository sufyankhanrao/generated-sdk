...
from paypalserversdk.exceptions.error_exception import (
    ErrorException,
)
from paypalserversdk.http.http_method_enum import (
    HttpMethodEnum,
)
from paypalserversdk.models.captured_payment import (
    CapturedPayment,
)
from paypalserversdk.models.payment_authorization import (
...
class PaymentsController(BaseController):
    ...
    def get_authorized_payment(self,
                               options=dict()):
        """Perform a GET request to /v2/payments/authorizations/{authorization_id}.
        ...
        return super().new_api_call_builder.request(
            ...
            .local_error("401",
                ...
                ErrorException)
            .local_error("403",
                "The request failed because the caller has insufficient permiss"
                "ions.",
                ErrorException)
            .local_error("404",
    ...
    def capture_authorized_payment(self,
        ...
        return super().new_api_call_builder.request(
            ...
            .is_api_response(True)
            .local_error("400",
                "The request failed because it is not well-formed or is syntact"
                "ically incorrect or violates schema.",
                ErrorException)
            .local_error("401",
                "Authentication failed due to missing authorization header, or "
                "invalid authentication credentials.",
            ...
            .local_error("404",
                ...
                ErrorException)
            .local_error("409",
                "The server has detected a conflict while processing this reque"
                "st.",
                ErrorException)
            .local_error("422",
                "The request failed because it is semantically incorrect or fai"
                "led business validation.",
                ErrorException)
            .local_error("500",
                "The request failed because an internal server error occurred.",
                ApiException)
    ...
    def void_payment(self,
        ...
        return super().new_api_call_builder.request(
            ...
            .local_error("404",
                ...
                ErrorException)
            .local_error("409",
                "The request failed because a previous call for the given resou"
                "rce is in progress.",
                ErrorException)
            .local_error("422",
                "The request failed because it either is semantically incorrect"
    ...
    def get_captured_payment(self,
                             options=dict()):
        """Perform a GET request to /v2/payments/captures/{capture_id}.
    ...
    def refund_captured_payment(self,
                                options=dict()):
        """Perform a POST request to /v2/payments/captures/{capture_id}/refund.
    ...
    def get_refund(self,
                   options=dict()):
        """Perform a GET request to /v2/payments/refunds/{refund_id}.
