...
from paypalserversdk.exceptions.default_error_exception import (
    DefaultErrorException,
)
from paypalserversdk.exceptions.search_error_exception import (
    SearchErrorException,
)
from paypalserversdk.http.http_method_enum import (
    HttpMethodEnum,
)
from paypalserversdk.models.balances_response import (
    BalancesResponse,
)
from paypalserversdk.models.search_response import (
    SearchResponse,
)
...
class TransactionSearchController(BaseController):
    ...
    def __init__(self, config):
        """Initialize TransactionSearchController object."""
