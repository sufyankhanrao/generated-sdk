...
from paypalserversdk.models.vault_experience_context import (
...
class VaultPaypalWalletRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a VaultPaypalWalletRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        billing_plan = Plan.from_dictionary(
            dictionary.get("billing_plan"))\
            if "billing_plan" in dictionary.keys() else APIHelper.SKIP
        experience_context = VaultExperienceContext.from_dictionary(
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"billing_plan={(self.billing_plan
                     if hasattr(self, 'billing_plan') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"billing_plan={(self.billing_plan
                     if hasattr(self, 'billing_plan') else None)!s}, "
                f"experience_context={(self.experience_context
