...
class NetworkToken(object):
    ...
    def from_dictionary(cls,
        ...
        eci_flag =\
            ...
            if dictionary.get("eci_flag") else APIHelper.SKIP
        token_requestor_id =\
            dictionary.get("token_requestor_id")\
            if dictionary.get("token_requestor_id") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"eci_flag={(self.eci_flag
                     if hasattr(self, 'eci_flag') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"eci_flag={(self.eci_flag
                     if hasattr(self, 'eci_flag') else None)!s}, "
                f"token_requestor_id={(self.token_requestor_id
