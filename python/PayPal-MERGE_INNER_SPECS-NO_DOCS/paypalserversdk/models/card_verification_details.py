...
from paypalserversdk.models.card_verification_processor_response import (
...
class CardVerificationDetails(object):
    ...
    Attributes:
        ...
        network (CardBrand): DEPRECATED. This field is DEPRECATED. Please find
            the network data in the 'network' field under the
            'network_transaction_reference' object instead of the
            'verification' object.
        time (str): DEPRECATED. This field is DEPRECATED. Please find the time
            data in the 'time' field under the 'network_transaction_reference'
            object instead of the 'verification' object.
    ...
    def __init__(self,
        ...
        """Initialize a CardVerificationDetails instance."""
    ...
    def from_dictionary(cls,
        ...
        network_transaction_id =\
            dictionary.get("network_transaction_id")\
            if dictionary.get("network_transaction_id") else APIHelper.SKIP
        date =\
            dictionary.get("date")\
        ...
        processor_response = CardVerificationProcessorResponse.from_dictionary(
        ...
        three_d_secure =\
            ...
            if dictionary.get("three_d_secure") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"three_d_secure={(self.three_d_secure
                     if hasattr(self, 'three_d_secure') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"three_d_secure={(self.three_d_secure
                     if hasattr(self, 'three_d_secure') else None)!s})")
