...
class PaymentCollection(object):
    ...
    Attributes:
        ...
        captures (List[OrdersCapture]): An array of captured payments for a
            purchase unit. A purchase unit can have zero or more captured
            payments.
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"captures={(self.captures
                     if hasattr(self, 'captures') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"captures={(self.captures
                     if hasattr(self, 'captures') else None)!s}, "
                f"refunds={(self.refunds
