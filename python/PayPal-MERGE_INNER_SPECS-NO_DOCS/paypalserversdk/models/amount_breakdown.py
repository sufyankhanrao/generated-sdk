...
class AmountBreakdown(object):
    ...
    def __init__(self,
        ...
        """Initialize a AmountBreakdown instance."""
    ...
    def from_dictionary(cls,
        ...
        item_total = Money.from_dictionary(
            dictionary.get("item_total"))\
            if "item_total" in dictionary.keys() else APIHelper.SKIP
        shipping = Money.from_dictionary(
            dictionary.get("shipping"))\
            if "shipping" in dictionary.keys() else APIHelper.SKIP
        handling = Money.from_dictionary(
            dictionary.get("handling"))\
            if "handling" in dictionary.keys() else APIHelper.SKIP
        tax_total = Money.from_dictionary(
            dictionary.get("tax_total"))\
            if "tax_total" in dictionary.keys() else APIHelper.SKIP
        insurance = Money.from_dictionary(
            dictionary.get("insurance"))\
            if "insurance" in dictionary.keys() else APIHelper.SKIP
        shipping_discount = Money.from_dictionary(
            dictionary.get("shipping_discount"))\
            if "shipping_discount" in dictionary.keys() else APIHelper.SKIP
        discount = Money.from_dictionary(
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"shipping_discount={(self.shipping_discount
                     if hasattr(self, 'shipping_discount') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"item_total={(self.item_total
                     if hasattr(self, 'item_total') else None)!s}, "
                f"shipping={(self.shipping
                     if hasattr(self, 'shipping') else None)!s}, "
                f"handling={(self.handling
                     if hasattr(self, 'handling') else None)!s}, "
                f"tax_total={(self.tax_total
                     if hasattr(self, 'tax_total') else None)!s}, "
                f"insurance={(self.insurance
                     if hasattr(self, 'insurance') else None)!s}, "
                f"shipping_discount={(self.shipping_discount
                     if hasattr(self, 'shipping_discount') else None)!s}, "
                f"discount={(self.discount
