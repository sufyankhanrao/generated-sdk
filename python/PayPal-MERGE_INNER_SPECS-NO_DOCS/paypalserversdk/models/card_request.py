...
from paypalserversdk.models.card_attributes import (
    CardAttributes,
)
from paypalserversdk.models.card_experience_context import (
    CardExperienceContext,
)
from paypalserversdk.models.card_stored_credential import (
    CardStoredCredential,
)
from paypalserversdk.models.network_token import (
    NetworkToken,
)
...
class CardRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a CardRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        security_code =\
            ...
            if dictionary.get("security_code") else APIHelper.SKIP
        ...
        attributes = CardAttributes.from_dictionary(
        ...
        single_use_token =\
            dictionary.get("single_use_token")\
            if dictionary.get("single_use_token") else APIHelper.SKIP
        ...
        network_token = NetworkToken.from_dictionary(
            dictionary.get("network_token"))\
            if "network_token" in dictionary.keys() else APIHelper.SKIP
        experience_context = CardExperienceContext.from_dictionary(
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"security_code={(self.security_code
                     if hasattr(self, 'security_code') else None)!r}, "
                ...
                f"single_use_token={(self.single_use_token
                     if hasattr(self, 'single_use_token') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"security_code={(self.security_code
                     if hasattr(self, 'security_code') else None)!s}, "
                f"billing_address={(self.billing_address
                ...
                f"single_use_token={(self.single_use_token
                     if hasattr(self, 'single_use_token') else None)!s}, "
                f"stored_credential={(self.stored_credential
