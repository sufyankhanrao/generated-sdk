...
from paypalserversdk.models.level_2_card_processing_data import (
    Level2CardProcessingData,
)
from paypalserversdk.models.level_3_card_processing_data import (
...
class CardSupplementaryData(object):
    ...
    def from_dictionary(cls,
        ...
        level_2 = Level2CardProcessingData.from_dictionary(
            dictionary.get("level_2"))\
            if "level_2" in dictionary.keys() else APIHelper.SKIP
        level_3 = Level3CardProcessingData.from_dictionary(
            dictionary.get("level_3"))\
            if "level_3" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"level_2={(self.level_2
                     if hasattr(self, 'level_2') else None)!r}, "
                f"level_3={(self.level_3
                     if hasattr(self, 'level_3') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"level_2={(self.level_2
                     if hasattr(self, 'level_2') else None)!s}, "
                f"level_3={(self.level_3
                     if hasattr(self, 'level_3') else None)!s})")
