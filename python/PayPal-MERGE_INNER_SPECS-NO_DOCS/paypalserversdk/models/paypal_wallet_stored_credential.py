...
class PaypalWalletStoredCredential(object):
    ...
    def __init__(self,
                 ...
                 usage="DERIVED"):
        """Initialize a PaypalWalletStoredCredential instance."""
    ...
    def from_dictionary(cls,
        ...
        charge_pattern =\
            dictionary.get("charge_pattern")\
            if dictionary.get("charge_pattern") else APIHelper.SKIP
        usage_pattern =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"charge_pattern={(self.charge_pattern
                     if hasattr(self, 'charge_pattern') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"charge_pattern={(self.charge_pattern
                     if hasattr(self, 'charge_pattern') else None)!s}, "
                f"usage_pattern={(self.usage_pattern
