...
from paypalserversdk.models.card_attributes_response import (
    CardAttributesResponse,
)
from paypalserversdk.models.card_from_request import (
    CardFromRequest,
)
...
class ApplePayCardResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a ApplePayCardResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        last_digits =\
            ...
            if dictionary.get("last_digits") else APIHelper.SKIP
        brand =\
            dictionary.get("brand")\
            if dictionary.get("brand") else APIHelper.SKIP
        available_networks =\
            dictionary.get("available_networks")\
            if dictionary.get("available_networks") else APIHelper.SKIP
        mtype =\
            dictionary.get("type")\
            if dictionary.get("type") else APIHelper.SKIP
        authentication_result = AuthenticationResponse.from_dictionary(
            dictionary.get("authentication_result"))\
            if "authentication_result" in dictionary.keys() else APIHelper.SKIP
        attributes = CardAttributesResponse.from_dictionary(
            dictionary.get("attributes"))\
            if "attributes" in dictionary.keys() else APIHelper.SKIP
        from_request = CardFromRequest.from_dictionary(
            dictionary.get("from_request"))\
            if "from_request" in dictionary.keys() else APIHelper.SKIP
        expiry =\
            dictionary.get("expiry")\
            if dictionary.get("expiry") else APIHelper.SKIP
        bin_details = BinDetails.from_dictionary(
            dictionary.get("bin_details"))\
            if "bin_details" in dictionary.keys() else APIHelper.SKIP
        stored_credential = CardStoredCredential.from_dictionary(
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"last_digits={(self.last_digits
                     if hasattr(self, 'last_digits') else None)!r}, "
                f"brand={(self.brand if hasattr(self, 'brand') else None)!r}, "
                f"available_networks={(self.available_networks
                     if hasattr(self, 'available_networks') else None)!r}, "
                f"mtype={(self.mtype if hasattr(self, 'mtype') else None)!r}, "
                f"authentication_result={(self.authentication_result
                     if hasattr(self, 'authentication_result') else None)!r}, "
                f"attributes={(self.attributes
                     if hasattr(self, 'attributes') else None)!r}, "
                f"from_request={(self.from_request
                     if hasattr(self, 'from_request') else None)!r}, "
                f"expiry={(self.expiry if hasattr(self, 'expiry') else None)!r}, "
                f"bin_details={(self.bin_details
                     if hasattr(self, 'bin_details') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"last_digits={(self.last_digits
                     if hasattr(self, 'last_digits') else None)!s}, "
                f"brand={(self.brand if hasattr(self, 'brand') else None)!s}, "
                f"available_networks={(self.available_networks
                     if hasattr(self, 'available_networks') else None)!s}, "
                f"mtype={(self.mtype if hasattr(self, 'mtype') else None)!s}, "
                f"authentication_result={(self.authentication_result
                     if hasattr(self, 'authentication_result') else None)!s}, "
                f"attributes={(self.attributes
                     if hasattr(self, 'attributes') else None)!s}, "
                f"from_request={(self.from_request
                     if hasattr(self, 'from_request') else None)!s}, "
                f"expiry={(self.expiry if hasattr(self, 'expiry') else None)!s}, "
                f"bin_details={(self.bin_details
                     if hasattr(self, 'bin_details') else None)!s}, "
                f"stored_credential={(self.stored_credential
