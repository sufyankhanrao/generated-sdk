...
class FailedPaymentDetails(object):
    ...
    def from_dictionary(cls,
        ...
        next_payment_retry_time =\
            ...
            if dictionary.get("next_payment_retry_time") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"next_payment_retry_time={(self.next_payment_retry_time
                     if hasattr(self, 'next_payment_retry_time') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"next_payment_retry_time={(self.next_payment_retry_time
                     if hasattr(self, 'next_payment_retry_time') else None)!s})")
