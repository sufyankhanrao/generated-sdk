...
from paypalserversdk.models.cycle_execution import (
    CycleExecution,
)
from paypalserversdk.models.failed_payment_details import (
    FailedPaymentDetails,
)
from paypalserversdk.models.last_payment_details import (
    LastPaymentDetails,
)
...
class SubscriptionBillingInformation(object):
    ...
    def __init__(self,
        ...
        """Initialize a SubscriptionBillingInformation instance."""
    ...
    def from_dictionary(cls,
        ...
        outstanding_balance = Money.from_dictionary(
            dictionary.get("outstanding_balance"))\
            if dictionary.get("outstanding_balance") else None
        failed_payments_count =\
            dictionary.get("failed_payments_count")\
            if dictionary.get("failed_payments_count") else None
        cycle_executions = None
        if dictionary.get("cycle_executions") is not None:
            cycle_executions = [
                CycleExecution.from_dictionary(x)
                    for x in dictionary.get("cycle_executions")
            ]
        else:
            cycle_executions = APIHelper.SKIP
        last_payment = LastPaymentDetails.from_dictionary(
            dictionary.get("last_payment"))\
            if "last_payment" in dictionary.keys() else APIHelper.SKIP
        next_billing_time =\
            dictionary.get("next_billing_time")\
            if dictionary.get("next_billing_time") else APIHelper.SKIP
        final_payment_time =\
            dictionary.get("final_payment_time")\
            if dictionary.get("final_payment_time") else APIHelper.SKIP
        last_failed_payment = FailedPaymentDetails.from_dictionary(
            dictionary.get("last_failed_payment"))\
            if "last_failed_payment" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"cycle_executions={(self.cycle_executions
                     if hasattr(self, 'cycle_executions') else None)!r}, "
                f"last_payment={(self.last_payment
                     if hasattr(self, 'last_payment') else None)!r}, "
                f"next_billing_time={(self.next_billing_time
                     if hasattr(self, 'next_billing_time') else None)!r}, "
                f"final_payment_time={(self.final_payment_time
                     if hasattr(self, 'final_payment_time') else None)!r}, "
                f"failed_payments_count={self.failed_payments_count!r}, "
                f"last_failed_payment={(self.last_failed_payment
                     if hasattr(self, 'last_failed_payment') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"cycle_executions={(self.cycle_executions
                     if hasattr(self, 'cycle_executions') else None)!s}, "
                f"last_payment={(self.last_payment
                     if hasattr(self, 'last_payment') else None)!s}, "
                f"next_billing_time={(self.next_billing_time
                     if hasattr(self, 'next_billing_time') else None)!s}, "
                f"final_payment_time={(self.final_payment_time
                     if hasattr(self, 'final_payment_time') else None)!s}, "
                f"failed_payments_count={self.failed_payments_count!s}, "
                f"last_failed_payment={(self.last_failed_payment
                     if hasattr(self, 'last_failed_payment') else None)!s})")
