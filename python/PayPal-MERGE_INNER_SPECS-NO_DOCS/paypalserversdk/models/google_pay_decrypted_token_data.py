...
class GooglePayDecryptedTokenData(object):
    ...
    def from_dictionary(cls,
        ...
        card = GooglePayCard.from_dictionary(
            dictionary.get("card"))\
            if dictionary.get("card") else None
        authentication_method =\
            dictionary.get("authentication_method")\
            if dictionary.get("authentication_method") else None
        message_id =\
            dictionary.get("message_id")\
            if dictionary.get("message_id") else APIHelper.SKIP
        message_expiration =\
            dictionary.get("message_expiration")\
            if dictionary.get("message_expiration") else APIHelper.SKIP
        cryptogram =\
            dictionary.get("cryptogram")\
            if dictionary.get("cryptogram") else APIHelper.SKIP
        eci_indicator =\
            dictionary.get("eci_indicator")\
            if dictionary.get("eci_indicator") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"message_id={(self.message_id
                     if hasattr(self, 'message_id') else None)!r}, "
                f"message_expiration={(self.message_expiration
                     if hasattr(self, 'message_expiration') else None)!r}, "
                f"payment_method={self.payment_method!r}, "
                f"card={self.card!r}, "
                f"authentication_method={self.authentication_method!r}, "
                f"cryptogram={(self.cryptogram
                     if hasattr(self, 'cryptogram') else None)!r}, "
                f"eci_indicator={(self.eci_indicator
                     if hasattr(self, 'eci_indicator') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"message_id={(self.message_id
                     if hasattr(self, 'message_id') else None)!s}, "
                f"message_expiration={(self.message_expiration
                     if hasattr(self, 'message_expiration') else None)!s}, "
                f"payment_method={self.payment_method!s}, "
                f"card={self.card!s}, "
                f"authentication_method={self.authentication_method!s}, "
                f"cryptogram={(self.cryptogram
                     if hasattr(self, 'cryptogram') else None)!s}, "
                f"eci_indicator={(self.eci_indicator
                     if hasattr(self, 'eci_indicator') else None)!s})")
