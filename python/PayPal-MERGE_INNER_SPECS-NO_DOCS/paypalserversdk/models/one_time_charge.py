...
class OneTimeCharge(object):
    ...
    def from_dictionary(cls,
        ...
        taxes = Money.from_dictionary(
            dictionary.get("taxes"))\
            if "taxes" in dictionary.keys() else APIHelper.SKIP
        product_price = Money.from_dictionary(
            dictionary.get("product_price"))\
            if "product_price" in dictionary.keys() else APIHelper.SKIP
        subtotal = Money.from_dictionary(
            dictionary.get("subtotal"))\
            if "subtotal" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"product_price={(self.product_price
                     if hasattr(self, 'product_price') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"product_price={(self.product_price
                     if hasattr(self, 'product_price') else None)!s}, "
                f"subtotal={(self.subtotal
