...
from paypalserversdk.models.refund_status_details import (
    RefundStatusDetails,
)
from paypalserversdk.models.seller_payable_breakdown import (
...
class Refund(object):
    ...
    def from_dictionary(cls,
        ...
        status_details = RefundStatusDetails.from_dictionary(
        ...
        acquirer_reference_number =\
            dictionary.get("acquirer_reference_number")\
            if dictionary.get("acquirer_reference_number") else APIHelper.SKIP
        note_to_payer =\
            dictionary.get("note_to_payer")\
            if dictionary.get("note_to_payer") else APIHelper.SKIP
        seller_payable_breakdown = SellerPayableBreakdown.from_dictionary(
            dictionary.get("seller_payable_breakdown"))\
            if "seller_payable_breakdown" in dictionary.keys() else APIHelper.SKIP
        payer = PayeeBase.from_dictionary(
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"acquirer_reference_number={(self.acquirer_reference_number
                     if hasattr(self, 'acquirer_reference_number') else None)!r}, "
                f"note_to_payer={(self.note_to_payer
                     if hasattr(self, 'note_to_payer') else None)!r}, "
                f"seller_payable_breakdown={(self.seller_payable_breakdown
                     if hasattr(self, 'seller_payable_breakdown') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"acquirer_reference_number={(self.acquirer_reference_number
                     if hasattr(self, 'acquirer_reference_number') else None)!s}, "
                f"note_to_payer={(self.note_to_payer
                     if hasattr(self, 'note_to_payer') else None)!s}, "
                f"seller_payable_breakdown={(self.seller_payable_breakdown
                     if hasattr(self, 'seller_payable_breakdown') else None)!s}, "
