...
class PaymentMethodPreference(object):
    ...
    def from_dictionary(cls,
        ...
        payee_preferred =\
            ...
            if dictionary.get("payee_preferred") else "UNRESTRICTED"
        standard_entry_class_code =\
            dictionary.get("standard_entry_class_code")\
            if dictionary.get("standard_entry_class_code") else "WEB"
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"payee_preferred={(self.payee_preferred
                     if hasattr(self, 'payee_preferred') else None)!r}, "
                f"standard_entry_class_code={(self.standard_entry_class_code
                     if hasattr(self, 'standard_entry_class_code') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"payee_preferred={(self.payee_preferred
                     if hasattr(self, 'payee_preferred') else None)!s}, "
                f"standard_entry_class_code={(self.standard_entry_class_code
                     if hasattr(self, 'standard_entry_class_code') else None)!s})")
