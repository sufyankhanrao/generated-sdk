...
class BancontactPaymentObject(object):
    ...
    def from_dictionary(cls,
        ...
        iban_last_chars =\
            ...
            if dictionary.get("iban_last_chars") else APIHelper.SKIP
        card_last_digits =\
            dictionary.get("card_last_digits")\
            if dictionary.get("card_last_digits") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"iban_last_chars={(self.iban_last_chars
                     if hasattr(self, 'iban_last_chars') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"iban_last_chars={(self.iban_last_chars
                     if hasattr(self, 'iban_last_chars') else None)!s}, "
                f"card_last_digits={(self.card_last_digits
