...
from paypalserversdk.models.paypal_wallet_attributes import (
...
class PaypalWallet(object):
    ...
    def __init__(self,
        ...
        """Initialize a PaypalWallet instance."""
    ...
    def from_dictionary(cls,
        ...
        vault_id =\
            ...
            if dictionary.get("vault_id") else APIHelper.SKIP
        email_address =\
        ...
        phone = PhoneWithType.from_dictionary(
        ...
        attributes = PaypalWalletAttributes.from_dictionary(
            dictionary.get("attributes"))\
            if "attributes" in dictionary.keys() else APIHelper.SKIP
        experience_context = PaypalWalletExperienceContext.from_dictionary(
            dictionary.get("experience_context"))\
            if "experience_context" in dictionary.keys() else APIHelper.SKIP
        billing_agreement_id =\
            dictionary.get("billing_agreement_id")\
            if dictionary.get("billing_agreement_id") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"vault_id={(self.vault_id
                     if hasattr(self, 'vault_id') else None)!r}, "
                ...
                f"experience_context={(self.experience_context
                     if hasattr(self, 'experience_context') else None)!r}, "
                f"billing_agreement_id={(self.billing_agreement_id
                     if hasattr(self, 'billing_agreement_id') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"vault_id={(self.vault_id
                     if hasattr(self, 'vault_id') else None)!s}, "
                f"email_address={(self.email_address
                ...
                f"experience_context={(self.experience_context
                     if hasattr(self, 'experience_context') else None)!s}, "
                f"billing_agreement_id={(self.billing_agreement_id
                     if hasattr(self, 'billing_agreement_id') else None)!s}, "
                f"stored_credential={(self.stored_credential
