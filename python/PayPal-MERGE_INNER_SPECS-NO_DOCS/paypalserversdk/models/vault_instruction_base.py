...
class VaultInstructionBase(object):
    ...
    def from_dictionary(cls,
        ...
        store_in_vault =\
            ...
            if dictionary.get("store_in_vault") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"store_in_vault={(self.store_in_vault
                     if hasattr(self, 'store_in_vault') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"store_in_vault={(self.store_in_vault
                     if hasattr(self, 'store_in_vault') else None)!s})")
