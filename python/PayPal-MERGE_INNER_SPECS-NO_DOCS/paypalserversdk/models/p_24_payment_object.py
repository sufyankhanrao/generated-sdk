...
class P24PaymentObject(object):
    ...
    def from_dictionary(cls,
        ...
        payment_descriptor =\
            ...
            if dictionary.get("payment_descriptor") else APIHelper.SKIP
        method_id =\
            dictionary.get("method_id")\
            if dictionary.get("method_id") else APIHelper.SKIP
        method_description =\
            dictionary.get("method_description")\
            if dictionary.get("method_description") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"payment_descriptor={(self.payment_descriptor
                     if hasattr(self, 'payment_descriptor') else None)!r}, "
                f"method_id={(self.method_id
                     if hasattr(self, 'method_id') else None)!r}, "
                f"method_description={(self.method_description
                     if hasattr(self, 'method_description') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"payment_descriptor={(self.payment_descriptor
                     if hasattr(self, 'payment_descriptor') else None)!s}, "
                f"method_id={(self.method_id
                     if hasattr(self, 'method_id') else None)!s}, "
                f"method_description={(self.method_description
                     if hasattr(self, 'method_description') else None)!s})")
