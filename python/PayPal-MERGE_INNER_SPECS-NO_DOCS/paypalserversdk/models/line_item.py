...
class LineItem(object):
    ...
    def from_dictionary(cls,
        ...
        image_url =\
            ...
            if dictionary.get("image_url") else APIHelper.SKIP
        upc = UniversalProductCode.from_dictionary(
            dictionary.get("upc"))\
            if "upc" in dictionary.keys() else APIHelper.SKIP
        billing_plan = OrderBillingPlan.from_dictionary(
            dictionary.get("billing_plan"))\
            if "billing_plan" in dictionary.keys() else APIHelper.SKIP
        unit_amount = Money.from_dictionary(
            dictionary.get("unit_amount"))\
            if "unit_amount" in dictionary.keys() else APIHelper.SKIP
        tax = Money.from_dictionary(
            dictionary.get("tax"))\
        ...
        total_amount = Money.from_dictionary(
            dictionary.get("total_amount"))\
            if "total_amount" in dictionary.keys() else APIHelper.SKIP
        unit_of_measure =\
            dictionary.get("unit_of_measure")\
            if dictionary.get("unit_of_measure") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"unit_amount={(self.unit_amount
                     if hasattr(self, 'unit_amount') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"unit_amount={(self.unit_amount
                     if hasattr(self, 'unit_amount') else None)!s}, "
