...
class CardStoredCredential(object):
    ...
    Attributes:
        ...
        previous_network_transaction_reference (NetworkTransaction): Reference
    ...
    def from_dictionary(cls,
        ...
        payment_initiator =\
            dictionary.get("payment_initiator")\
            if dictionary.get("payment_initiator") else None
        payment_type =\
        ...
        previous_network_transaction_reference = NetworkTransaction.from_dictionary(
            dictionary.get("previous_network_transaction_reference"))\
            if "previous_network_transaction_reference" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"previous_network_transaction_reference={(self.previous_network_transaction_reference
                     if hasattr(self, 'previous_network_transaction_reference') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"previous_network_transaction_reference={(self.previous_network_transaction_reference
                     if hasattr(self, 'previous_network_transaction_reference') else None)!s})")
