...
from paypalserversdk.models.amount_breakdown import (
    AmountBreakdown,
)
...
class AmountWithBreakdown(object):
    ...
    def __init__(self,
        ...
        """Initialize a AmountWithBreakdown instance."""
    ...
    def from_dictionary(cls,
        ...
        breakdown = AmountBreakdown.from_dictionary(
            dictionary.get("breakdown"))\
            if "breakdown" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"breakdown={(self.breakdown
                     if hasattr(self, 'breakdown') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"breakdown={(self.breakdown
                     if hasattr(self, 'breakdown') else None)!s})")
