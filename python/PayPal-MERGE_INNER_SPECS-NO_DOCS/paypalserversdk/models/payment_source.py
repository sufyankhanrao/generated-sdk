...
from paypalserversdk.models.bancontact_payment_request import (
    BancontactPaymentRequest,
)
from paypalserversdk.models.blik_payment_request import (
    BlikPaymentRequest,
)
from paypalserversdk.models.card_request import (
    CardRequest,
)
from paypalserversdk.models.eps_payment_request import (
    EpsPaymentRequest,
)
from paypalserversdk.models.giropay_payment_request import (
    GiropayPaymentRequest,
)
from paypalserversdk.models.google_pay_request import (
    GooglePayRequest,
)
from paypalserversdk.models.ideal_payment_request import (
    IdealPaymentRequest,
)
from paypalserversdk.models.mybank_payment_request import (
    MybankPaymentRequest,
)
from paypalserversdk.models.p_24_payment_request import (
    P24PaymentRequest,
)
from paypalserversdk.models.paypal_wallet import (
    PaypalWallet,
)
from paypalserversdk.models.sofort_payment_request import (
    SofortPaymentRequest,
)
from paypalserversdk.models.token import Token
from paypalserversdk.models.trustly_payment_request import (
...
class PaymentSource(object):
    ...
    def __init__(self,
        ...
        """Initialize a PaymentSource instance."""
    ...
    def from_dictionary(cls,
        ...
        card = CardRequest.from_dictionary(
            dictionary.get("card"))\
            if "card" in dictionary.keys() else APIHelper.SKIP
        token = Token.from_dictionary(
            dictionary.get("token"))\
            if "token" in dictionary.keys() else APIHelper.SKIP
        paypal = PaypalWallet.from_dictionary(
            dictionary.get("paypal"))\
            if "paypal" in dictionary.keys() else APIHelper.SKIP
        bancontact = BancontactPaymentRequest.from_dictionary(
            dictionary.get("bancontact"))\
            if "bancontact" in dictionary.keys() else APIHelper.SKIP
        blik = BlikPaymentRequest.from_dictionary(
            dictionary.get("blik"))\
            if "blik" in dictionary.keys() else APIHelper.SKIP
        eps = EpsPaymentRequest.from_dictionary(
            dictionary.get("eps"))\
            if "eps" in dictionary.keys() else APIHelper.SKIP
        giropay = GiropayPaymentRequest.from_dictionary(
            dictionary.get("giropay"))\
            if "giropay" in dictionary.keys() else APIHelper.SKIP
        ideal = IdealPaymentRequest.from_dictionary(
            dictionary.get("ideal"))\
            if "ideal" in dictionary.keys() else APIHelper.SKIP
        mybank = MybankPaymentRequest.from_dictionary(
            dictionary.get("mybank"))\
            if "mybank" in dictionary.keys() else APIHelper.SKIP
        p_24 = P24PaymentRequest.from_dictionary(
            dictionary.get("p24"))\
            if "p24" in dictionary.keys() else APIHelper.SKIP
        sofort = SofortPaymentRequest.from_dictionary(
            dictionary.get("sofort"))\
            if "sofort" in dictionary.keys() else APIHelper.SKIP
        trustly = TrustlyPaymentRequest.from_dictionary(
            dictionary.get("trustly"))\
            if "trustly" in dictionary.keys() else APIHelper.SKIP
        apple_pay = ApplePayRequest.from_dictionary(
            dictionary.get("apple_pay"))\
            if "apple_pay" in dictionary.keys() else APIHelper.SKIP
        google_pay = GooglePayRequest.from_dictionary(
            dictionary.get("google_pay"))\
            if "google_pay" in dictionary.keys() else APIHelper.SKIP
        venmo = VenmoWalletRequest.from_dictionary(
            dictionary.get("venmo"))\
            if "venmo" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"bancontact={(self.bancontact
                     if hasattr(self, 'bancontact') else None)!r}, "
                f"blik={(self.blik if hasattr(self, 'blik') else None)!r}, "
                f"eps={(self.eps if hasattr(self, 'eps') else None)!r}, "
                f"giropay={(self.giropay
                     if hasattr(self, 'giropay') else None)!r}, "
                ...
                f"trustly={(self.trustly
                     if hasattr(self, 'trustly') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"trustly={(self.trustly
                     if hasattr(self, 'trustly') else None)!s}, "
                f"apple_pay={(self.apple_pay
