...
from paypalserversdk.models.app_switch_context import (
    AppSwitchContext,
)
from paypalserversdk.models.callback_configuration import (
...
class PaypalWalletExperienceContext(object):
    ...
    def __init__(self,
        ...
        """Initialize a PaypalWalletExperienceContext instance."""
    ...
    def from_dictionary(cls,
        ...
        brand_name =\
            ...
            if dictionary.get("brand_name") else APIHelper.SKIP
        locale =\
            dictionary.get("locale")\
            if dictionary.get("locale") else APIHelper.SKIP
        shipping_preference =\
            dictionary.get("shipping_preference")\
            if dictionary.get("shipping_preference") else "GET_FROM_FILE"
        contact_preference =\
            dictionary.get("contact_preference")\
            if dictionary.get("contact_preference") else "NO_CONTACT_INFO"
        return_url =\
            dictionary.get("return_url")\
            if dictionary.get("return_url") else APIHelper.SKIP
        cancel_url =\
            dictionary.get("cancel_url")\
            if dictionary.get("cancel_url") else APIHelper.SKIP
        app_switch_context = AppSwitchContext.from_dictionary(
            dictionary.get("app_switch_context"))\
            if "app_switch_context" in dictionary.keys() else APIHelper.SKIP
        landing_page =\
            dictionary.get("landing_page")\
            if dictionary.get("landing_page") else "NO_PREFERENCE"
        user_action =\
            dictionary.get("user_action")\
            if dictionary.get("user_action") else "CONTINUE"
        payment_method_preference =\
            dictionary.get("payment_method_preference")\
            if dictionary.get("payment_method_preference") else "UNRESTRICTED"
        order_update_callback_config = CallbackConfiguration.from_dictionary(
            dictionary.get("order_update_callback_config"))\
            if "order_update_callback_config" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"brand_name={(self.brand_name
                     if hasattr(self, 'brand_name') else None)!r}, "
                f"locale={(self.locale if hasattr(self, 'locale') else None)!r}, "
                f"shipping_preference={(self.shipping_preference
                     if hasattr(self, 'shipping_preference') else None)!r}, "
                f"contact_preference={(self.contact_preference
                     if hasattr(self, 'contact_preference') else None)!r}, "
                f"return_url={(self.return_url
                     if hasattr(self, 'return_url') else None)!r}, "
                f"cancel_url={(self.cancel_url
                     if hasattr(self, 'cancel_url') else None)!r}, "
                f"app_switch_context={(self.app_switch_context
                     if hasattr(self, 'app_switch_context') else None)!r}, "
                f"landing_page={(self.landing_page
                     if hasattr(self, 'landing_page') else None)!r}, "
                f"user_action={(self.user_action
                     if hasattr(self, 'user_action') else None)!r}, "
                f"payment_method_preference={(self.payment_method_preference
                     if hasattr(self, 'payment_method_preference') else None)!r}, "
                f"order_update_callback_config={(self.order_update_callback_config
                     if hasattr(self, 'order_update_callback_config') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"brand_name={(self.brand_name
                     if hasattr(self, 'brand_name') else None)!s}, "
                f"locale={(self.locale if hasattr(self, 'locale') else None)!s}, "
                f"shipping_preference={(self.shipping_preference
                     if hasattr(self, 'shipping_preference') else None)!s}, "
                f"contact_preference={(self.contact_preference
                     if hasattr(self, 'contact_preference') else None)!s}, "
                f"return_url={(self.return_url
                     if hasattr(self, 'return_url') else None)!s}, "
                f"cancel_url={(self.cancel_url
                     if hasattr(self, 'cancel_url') else None)!s}, "
                f"app_switch_context={(self.app_switch_context
                     if hasattr(self, 'app_switch_context') else None)!s}, "
                f"landing_page={(self.landing_page
                     if hasattr(self, 'landing_page') else None)!s}, "
                f"user_action={(self.user_action
                     if hasattr(self, 'user_action') else None)!s}, "
                f"payment_method_preference={(self.payment_method_preference
                     if hasattr(self, 'payment_method_preference') else None)!s}, "
                f"order_update_callback_config={(self.order_update_callback_config
                     if hasattr(self, 'order_update_callback_config') else None)!s})")
