...
class RelatedIdentifiers(object):
    ...
    def __init__(self,
        ...
        """Initialize a RelatedIdentifiers instance."""
    ...
    def from_dictionary(cls,
        ...
        order_id =\
            ...
            if dictionary.get("order_id") else APIHelper.SKIP
        authorization_id =\
            dictionary.get("authorization_id")\
            if dictionary.get("authorization_id") else APIHelper.SKIP
        capture_id =\
            dictionary.get("capture_id")\
            if dictionary.get("capture_id") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"authorization_id={(self.authorization_id
                     if hasattr(self, 'authorization_id') else None)!r}, "
                f"capture_id={(self.capture_id
                     if hasattr(self, 'capture_id') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"authorization_id={(self.authorization_id
                     if hasattr(self, 'authorization_id') else None)!s}, "
                f"capture_id={(self.capture_id
                     if hasattr(self, 'capture_id') else None)!s})")
