...
class Level3CardProcessingData(object):
    ...
    def from_dictionary(cls,
        ...
        duty_amount = Money.from_dictionary(
        ...
        shipping_address = Address.from_dictionary(
        ...
        ships_from_postal_code =\
            ...
            if dictionary.get("ships_from_postal_code") else APIHelper.SKIP
        line_items = None
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"ships_from_postal_code={(self.ships_from_postal_code
                     if hasattr(self, 'ships_from_postal_code') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"ships_from_postal_code={(self.ships_from_postal_code
                     if hasattr(self, 'ships_from_postal_code') else None)!s}, "
                f"line_items={(self.line_items
