...
class PaypalPaymentToken(object):
    ...
    def __init__(self,
        ...
        """Initialize a PaypalPaymentToken instance."""
    ...
    def from_dictionary(cls,
        ...
        usage_pattern =\
            ...
            if dictionary.get("usage_pattern") else APIHelper.SKIP
        shipping = VaultedDigitalWalletShippingDetails.from_dictionary(
            dictionary.get("shipping"))\
            if "shipping" in dictionary.keys() else APIHelper.SKIP
        permit_multiple_payment_tokens =\
            dictionary.get("permit_multiple_payment_tokens")\
            if dictionary.get("permit_multiple_payment_tokens") else False
        usage_type =\
            dictionary.get("usage_type")\
            if dictionary.get("usage_type") else APIHelper.SKIP
        customer_type =\
            dictionary.get("customer_type")\
            if dictionary.get("customer_type") else APIHelper.SKIP
        email_address =\
        ...
        phone_number = Phone.from_dictionary(
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"usage_pattern={(self.usage_pattern
                     if hasattr(self, 'usage_pattern') else None)!r}, "
                f"shipping={(self.shipping
                     if hasattr(self, 'shipping') else None)!r}, "
                f"permit_multiple_payment_tokens={(self.permit_multiple_payment_tokens
                     if hasattr(self, 'permit_multiple_payment_tokens') else None)!r}, "
                f"usage_type={(self.usage_type
                     if hasattr(self, 'usage_type') else None)!r}, "
                f"customer_type={(self.customer_type
                     if hasattr(self, 'customer_type') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"usage_pattern={(self.usage_pattern
                     if hasattr(self, 'usage_pattern') else None)!s}, "
                f"shipping={(self.shipping
                     if hasattr(self, 'shipping') else None)!s}, "
                f"permit_multiple_payment_tokens={(self.permit_multiple_payment_tokens
                     if hasattr(self, 'permit_multiple_payment_tokens') else None)!s}, "
                f"usage_type={(self.usage_type
                     if hasattr(self, 'usage_type') else None)!s}, "
                f"customer_type={(self.customer_type
                     if hasattr(self, 'customer_type') else None)!s}, "
                f"email_address={(self.email_address
