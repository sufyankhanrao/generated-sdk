...
class ProcessorResponse(object):
    ...
    def from_dictionary(cls,
        ...
        avs_code =\
            ...
            if dictionary.get("avs_code") else APIHelper.SKIP
        cvv_code =\
            dictionary.get("cvv_code")\
            if dictionary.get("cvv_code") else APIHelper.SKIP
        response_code =\
            dictionary.get("response_code")\
            if dictionary.get("response_code") else APIHelper.SKIP
        payment_advice_code =\
            dictionary.get("payment_advice_code")\
            if dictionary.get("payment_advice_code") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"avs_code={(self.avs_code
                     if hasattr(self, 'avs_code') else None)!r}, "
                f"cvv_code={(self.cvv_code
                     if hasattr(self, 'cvv_code') else None)!r}, "
                f"response_code={(self.response_code
                     if hasattr(self, 'response_code') else None)!r}, "
                f"payment_advice_code={(self.payment_advice_code
                     if hasattr(self, 'payment_advice_code') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"avs_code={(self.avs_code
                     if hasattr(self, 'avs_code') else None)!s}, "
                f"cvv_code={(self.cvv_code
                     if hasattr(self, 'cvv_code') else None)!s}, "
                f"response_code={(self.response_code
                     if hasattr(self, 'response_code') else None)!s}, "
                f"payment_advice_code={(self.payment_advice_code
                     if hasattr(self, 'payment_advice_code') else None)!s})")
