...
from paypalserversdk.models.apple_pay_attributes_response import (
    ApplePayAttributesResponse,
)
from paypalserversdk.models.apple_pay_card_response import (
...
class ApplePayPaymentObject(object):
    ...
    def __init__(self,
        ...
        """Initialize a ApplePayPaymentObject instance."""
    ...
    def from_dictionary(cls,
        ...
        card = ApplePayCardResponse.from_dictionary(
            dictionary.get("card"))\
            if "card" in dictionary.keys() else APIHelper.SKIP
        attributes = ApplePayAttributesResponse.from_dictionary(
