...
class BlikExperienceContext(object):
    ...
    def __init__(self,
        ...
        """Initialize a BlikExperienceContext instance."""
    ...
    def from_dictionary(cls,
        ...
        consumer_ip =\
            dictionary.get("consumer_ip")\
            if dictionary.get("consumer_ip") else APIHelper.SKIP
        consumer_user_agent =\
            dictionary.get("consumer_user_agent")\
            if dictionary.get("consumer_user_agent") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"consumer_ip={(self.consumer_ip
                     if hasattr(self, 'consumer_ip') else None)!r}, "
                f"consumer_user_agent={(self.consumer_user_agent
                     if hasattr(self, 'consumer_user_agent') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"consumer_ip={(self.consumer_ip
                     if hasattr(self, 'consumer_ip') else None)!s}, "
                f"consumer_user_agent={(self.consumer_user_agent
                     if hasattr(self, 'consumer_user_agent') else None)!s})")
