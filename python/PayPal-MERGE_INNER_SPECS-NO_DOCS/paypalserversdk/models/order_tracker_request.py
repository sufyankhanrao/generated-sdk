...
class OrderTrackerRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a OrderTrackerRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        capture_id =\
            ...
            if dictionary.get("capture_id") else None
        tracking_number =\
            dictionary.get("tracking_number")\
            if dictionary.get("tracking_number") else APIHelper.SKIP
        carrier =\
            dictionary.get("carrier")\
            if dictionary.get("carrier") else APIHelper.SKIP
        carrier_name_other =\
            dictionary.get("carrier_name_other")\
            if dictionary.get("carrier_name_other") else APIHelper.SKIP
        notify_payer =\
            dictionary.get("notify_payer")\
            if dictionary.get("notify_payer") else False
        items = None
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"carrier_name_other={(self.carrier_name_other
                     if hasattr(self, 'carrier_name_other') else None)!r}, "
                f"capture_id={self.capture_id!r}, "
                f"notify_payer={(self.notify_payer
                     if hasattr(self, 'notify_payer') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"carrier_name_other={(self.carrier_name_other
                     if hasattr(self, 'carrier_name_other') else None)!s}, "
                f"capture_id={self.capture_id!s}, "
                f"notify_payer={(self.notify_payer
                     if hasattr(self, 'notify_payer') else None)!s}, "
