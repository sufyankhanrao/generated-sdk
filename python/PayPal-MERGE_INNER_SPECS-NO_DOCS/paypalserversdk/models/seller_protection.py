...
class SellerProtection(object):
    ...
    def __init__(self,
        ...
        """Initialize a SellerProtection instance."""
    ...
    def from_dictionary(cls,
        ...
        dispute_categories =\
            dictionary.get("dispute_categories")\
            if dictionary.get("dispute_categories") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"dispute_categories={(self.dispute_categories
                     if hasattr(self, 'dispute_categories') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"dispute_categories={(self.dispute_categories
                     if hasattr(self, 'dispute_categories') else None)!s})")
