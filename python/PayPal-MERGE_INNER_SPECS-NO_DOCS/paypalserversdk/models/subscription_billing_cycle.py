...
from paypalserversdk.models.frequency import (
    Frequency,
)
...
class SubscriptionBillingCycle(object):
    ...
    def from_dictionary(cls,
        ...
        frequency = Frequency.from_dictionary(
