...
from paypalserversdk.models.capture_status_details import (
...
from paypalserversdk.models.payment_supplementary_data import (
    PaymentSupplementaryData,
)
from paypalserversdk.models.processor_response import (
    ProcessorResponse,
)
from paypalserversdk.models.seller_protection import (
    SellerProtection,
)
from paypalserversdk.models.seller_receivable_breakdown import (
...
class CapturedPayment(object):
    ...
    def __init__(self,
        ...
        """Initialize a CapturedPayment instance."""
    ...
    def from_dictionary(cls,
        ...
        status_details = CaptureStatusDetails.from_dictionary(
            dictionary.get("status_details"))\
            if "status_details" in dictionary.keys() else APIHelper.SKIP
        id = dictionary.get("id") if dictionary.get("id") else APIHelper.SKIP
        amount = Money.from_dictionary(
        ...
        custom_id =\
            ...
            if dictionary.get("custom_id") else APIHelper.SKIP
        network_transaction_reference = NetworkTransaction.from_dictionary(
            dictionary.get("network_transaction_reference"))\
            if "network_transaction_reference" in dictionary.keys() else APIHelper.SKIP
        seller_protection = SellerProtection.from_dictionary(
            dictionary.get("seller_protection"))\
            if "seller_protection" in dictionary.keys() else APIHelper.SKIP
        final_capture =\
            dictionary.get("final_capture")\
            if dictionary.get("final_capture") else False
        seller_receivable_breakdown = SellerReceivableBreakdown.from_dictionary(
            dictionary.get("seller_receivable_breakdown"))\
            if "seller_receivable_breakdown" in dictionary.keys() else APIHelper.SKIP
        disbursement_mode =\
            dictionary.get("disbursement_mode")\
            if dictionary.get("disbursement_mode") else "INSTANT"
        links = None
        if dictionary.get("links") is not None:
            ...
            links = APIHelper.SKIP
        processor_response = ProcessorResponse.from_dictionary(
            dictionary.get("processor_response"))\
            if "processor_response" in dictionary.keys() else APIHelper.SKIP
        create_time =\
            dictionary.get("create_time")\
            if dictionary.get("create_time") else APIHelper.SKIP
        update_time =\
            dictionary.get("update_time")\
            if dictionary.get("update_time") else APIHelper.SKIP
        supplementary_data = PaymentSupplementaryData.from_dictionary(
            dictionary.get("supplementary_data"))\
            if "supplementary_data" in dictionary.keys() else APIHelper.SKIP
        payee = PayeeBase.from_dictionary(
            dictionary.get("payee"))\
            if "payee" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"status_details={(self.status_details
                     if hasattr(self, 'status_details') else None)!r}, "
                f"id={(self.id if hasattr(self, 'id') else None)!r}, "
                f"amount={(self.amount if hasattr(self, 'amount') else None)!r}, "
                f"invoice_id={(self.invoice_id
                     if hasattr(self, 'invoice_id') else None)!r}, "
                f"custom_id={(self.custom_id
                     if hasattr(self, 'custom_id') else None)!r}, "
                f"network_transaction_reference={(self.network_transaction_reference
                     if hasattr(self, 'network_transaction_reference') else None)!r}, "
                f"seller_protection={(self.seller_protection
                     if hasattr(self, 'seller_protection') else None)!r}, "
                f"final_capture={(self.final_capture
                     if hasattr(self, 'final_capture') else None)!r}, "
                f"seller_receivable_breakdown={(self.seller_receivable_breakdown
                     if hasattr(self, 'seller_receivable_breakdown') else None)!r}, "
                f"disbursement_mode={(self.disbursement_mode
                     if hasattr(self, 'disbursement_mode') else None)!r}, "
                f"links={(self.links if hasattr(self, 'links') else None)!r}, "
                f"processor_response={(self.processor_response
                     if hasattr(self, 'processor_response') else None)!r}, "
                f"create_time={(self.create_time
                     if hasattr(self, 'create_time') else None)!r}, "
                f"update_time={(self.update_time
                     if hasattr(self, 'update_time') else None)!r}, "
                f"supplementary_data={(self.supplementary_data
                     if hasattr(self, 'supplementary_data') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"status_details={(self.status_details
                     if hasattr(self, 'status_details') else None)!s}, "
                f"id={(self.id if hasattr(self, 'id') else None)!s}, "
                f"amount={(self.amount if hasattr(self, 'amount') else None)!s}, "
                f"invoice_id={(self.invoice_id
                     if hasattr(self, 'invoice_id') else None)!s}, "
                f"custom_id={(self.custom_id
                     if hasattr(self, 'custom_id') else None)!s}, "
                f"network_transaction_reference={(self.network_transaction_reference
                     if hasattr(self, 'network_transaction_reference') else None)!s}, "
                f"seller_protection={(self.seller_protection
                     if hasattr(self, 'seller_protection') else None)!s}, "
                f"final_capture={(self.final_capture
                     if hasattr(self, 'final_capture') else None)!s}, "
                f"seller_receivable_breakdown={(self.seller_receivable_breakdown
                     if hasattr(self, 'seller_receivable_breakdown') else None)!s}, "
                f"disbursement_mode={(self.disbursement_mode
                     if hasattr(self, 'disbursement_mode') else None)!s}, "
                f"links={(self.links if hasattr(self, 'links') else None)!s}, "
                f"processor_response={(self.processor_response
                     if hasattr(self, 'processor_response') else None)!s}, "
                f"create_time={(self.create_time
                     if hasattr(self, 'create_time') else None)!s}, "
                f"update_time={(self.update_time
                     if hasattr(self, 'update_time') else None)!s}, "
                f"supplementary_data={(self.supplementary_data
                     if hasattr(self, 'supplementary_data') else None)!s}, "
