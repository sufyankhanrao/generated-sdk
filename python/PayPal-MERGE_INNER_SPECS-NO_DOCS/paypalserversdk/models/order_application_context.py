...
from paypalserversdk.models.payment_method_preference import (
    PaymentMethodPreference,
)
from paypalserversdk.models.stored_payment_source import (
    StoredPaymentSource,
)
...
class OrderApplicationContext(object):
    ...
    def __init__(self,
        ...
        """Initialize a OrderApplicationContext instance."""
    ...
    def from_dictionary(cls,
        ...
        payment_method = PaymentMethodPreference.from_dictionary(
        ...
        stored_payment_source = StoredPaymentSource.from_dictionary(
            dictionary.get("stored_payment_source"))\
            if "stored_payment_source" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"stored_payment_source={(self.stored_payment_source
                     if hasattr(self, 'stored_payment_source') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"stored_payment_source={(self.stored_payment_source
                     if hasattr(self, 'stored_payment_source') else None)!s})")
