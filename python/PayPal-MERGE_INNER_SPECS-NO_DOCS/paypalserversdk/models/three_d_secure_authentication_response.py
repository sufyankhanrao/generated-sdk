...
class ThreeDSecureAuthenticationResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a ThreeDSecureAuthenticationResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        authentication_status =\
            ...
            if dictionary.get("authentication_status") else APIHelper.SKIP
        enrollment_status =\
            dictionary.get("enrollment_status")\
            if dictionary.get("enrollment_status") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"authentication_status={(self.authentication_status
                     if hasattr(self, 'authentication_status') else None)!r}, "
                f"enrollment_status={(self.enrollment_status
                     if hasattr(self, 'enrollment_status') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"authentication_status={(self.authentication_status
                     if hasattr(self, 'authentication_status') else None)!s}, "
                f"enrollment_status={(self.enrollment_status
                     if hasattr(self, 'enrollment_status') else None)!s})")
