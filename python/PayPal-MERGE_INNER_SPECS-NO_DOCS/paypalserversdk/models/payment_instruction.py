...
class PaymentInstruction(object):
    ...
    def __init__(self,
        ...
        """Initialize a PaymentInstruction instance."""
    ...
    def from_dictionary(cls,
        ...
        payee_pricing_tier_id =\
            dictionary.get("payee_pricing_tier_id")\
            if dictionary.get("payee_pricing_tier_id") else APIHelper.SKIP
        payee_receivable_fx_rate_id =\
            dictionary.get("payee_receivable_fx_rate_id")\
            if dictionary.get("payee_receivable_fx_rate_id") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"payee_pricing_tier_id={(self.payee_pricing_tier_id
                     if hasattr(self, 'payee_pricing_tier_id') else None)!r}, "
                f"payee_receivable_fx_rate_id={(self.payee_receivable_fx_rate_id
                     if hasattr(self, 'payee_receivable_fx_rate_id') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"payee_pricing_tier_id={(self.payee_pricing_tier_id
                     if hasattr(self, 'payee_pricing_tier_id') else None)!s}, "
                f"payee_receivable_fx_rate_id={(self.payee_receivable_fx_rate_id
                     if hasattr(self, 'payee_receivable_fx_rate_id') else None)!s})")
