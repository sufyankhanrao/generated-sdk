...
class SetupTokenResponseCard(object):
    ...
    def __init__(self,
        ...
        """Initialize a SetupTokenResponseCard instance."""
    ...
    def from_dictionary(cls,
        ...
        billing_address = CardResponseAddress.from_dictionary(
        ...
        verification_status =\
            ...
            if dictionary.get("verification_status") else APIHelper.SKIP
        verification = CardVerificationDetails.from_dictionary(
            dictionary.get("verification"))\
            if "verification" in dictionary.keys() else APIHelper.SKIP
        network_transaction_reference = NetworkTransactionReferenceEntity.from_dictionary(
            dictionary.get("network_transaction_reference"))\
            if "network_transaction_reference" in dictionary.keys() else APIHelper.SKIP
        authentication_result = CardAuthenticationResponse.from_dictionary(
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"verification_status={(self.verification_status
                     if hasattr(self, 'verification_status') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"verification_status={(self.verification_status
                     if hasattr(self, 'verification_status') else None)!s}, "
                f"verification={(self.verification
