...
class ExchangeRate(object):
    ...
    def from_dictionary(cls,
        ...
        source_currency =\
            ...
            if dictionary.get("source_currency") else APIHelper.SKIP
        target_currency =\
            dictionary.get("target_currency")\
            if dictionary.get("target_currency") else APIHelper.SKIP
        value =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"source_currency={(self.source_currency
                     if hasattr(self, 'source_currency') else None)!r}, "
                f"target_currency={(self.target_currency
                     if hasattr(self, 'target_currency') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"source_currency={(self.source_currency
                     if hasattr(self, 'source_currency') else None)!s}, "
                f"target_currency={(self.target_currency
                     if hasattr(self, 'target_currency') else None)!s}, "
