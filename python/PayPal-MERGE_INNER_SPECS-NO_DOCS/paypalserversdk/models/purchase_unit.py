...
class PurchaseUnit(object):
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("items") is not None:
            ...
            items = APIHelper.SKIP
        shipping = ShippingWithTrackingDetails.from_dictionary(
        ...
        payments = PaymentCollection.from_dictionary(
            dictionary.get("payments"))\
            if "payments" in dictionary.keys() else APIHelper.SKIP
        most_recent_errors =\
            dictionary.get("most_recent_errors")\
            if dictionary.get("most_recent_errors") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"most_recent_errors={(self.most_recent_errors
                     if hasattr(self, 'most_recent_errors') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"most_recent_errors={(self.most_recent_errors
                     if hasattr(self, 'most_recent_errors') else None)!s})")
