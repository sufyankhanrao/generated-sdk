...
class NetAmountBreakdownItem(object):
    ...
    def __init__(self,
        ...
        """Initialize a NetAmountBreakdownItem instance."""
    ...
    def from_dictionary(cls,
        ...
        payable_amount = Money.from_dictionary(
            dictionary.get("payable_amount"))\
            if "payable_amount" in dictionary.keys() else APIHelper.SKIP
        converted_amount = Money.from_dictionary(
            dictionary.get("converted_amount"))\
            if "converted_amount" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"payable_amount={(self.payable_amount
                     if hasattr(self, 'payable_amount') else None)!r}, "
                f"converted_amount={(self.converted_amount
                     if hasattr(self, 'converted_amount') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"payable_amount={(self.payable_amount
                     if hasattr(self, 'payable_amount') else None)!s}, "
                f"converted_amount={(self.converted_amount
                     if hasattr(self, 'converted_amount') else None)!s}, "
                f"exchange_rate={(self.exchange_rate
