...
class BlikOneClickPaymentObject(object):
    ...
    def __init__(self,
        ...
        """Initialize a BlikOneClickPaymentObject instance."""
    ...
    def from_dictionary(cls,
        ...
        consumer_reference =\
            ...
            if dictionary.get("consumer_reference") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"consumer_reference={(self.consumer_reference
                     if hasattr(self, 'consumer_reference') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"consumer_reference={(self.consumer_reference
                     if hasattr(self, 'consumer_reference') else None)!s})")
