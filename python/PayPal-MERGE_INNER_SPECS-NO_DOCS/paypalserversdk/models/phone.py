...
class Phone(object):
    ...
    def from_dictionary(cls,
        ...
        national_number =\
            ...
            if dictionary.get("national_number") else None
        extension_number =\
            dictionary.get("extension_number")\
            if dictionary.get("extension_number") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"extension_number={(self.extension_number
                     if hasattr(self, 'extension_number') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"extension_number={(self.extension_number
                     if hasattr(self, 'extension_number') else None)!s})")
