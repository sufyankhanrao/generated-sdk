...
from paypalserversdk.models.order_authorize_response_payment_source import (
    OrderAuthorizeResponsePaymentSource,
)
from paypalserversdk.models.payer import Payer
from paypalserversdk.models.purchase_unit import (
    PurchaseUnit,
)
...
class OrderAuthorizeResponse(object):
    ...
    Attributes:
        ...
        intent (CheckoutPaymentIntent): The intent to either capture payment
            ...
            creation.
        payer (Payer): The customer who approves and pays for the order. The
            customer is also known as the payer.
    ...
    def __init__(self,
        ...
        """Initialize a OrderAuthorizeResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        payment_source = OrderAuthorizeResponsePaymentSource.from_dictionary(
            dictionary.get("payment_source"))\
            if "payment_source" in dictionary.keys() else APIHelper.SKIP
        intent =\
            dictionary.get("intent")\
            if dictionary.get("intent") else APIHelper.SKIP
        payer = Payer.from_dictionary(
            dictionary.get("payer"))\
            if "payer" in dictionary.keys() else APIHelper.SKIP
        purchase_units = None
        if dictionary.get("purchase_units") is not None:
            purchase_units = [
                PurchaseUnit.from_dictionary(x)
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"payment_source={(self.payment_source
                     if hasattr(self, 'payment_source') else None)!r}, "
                f"intent={(self.intent if hasattr(self, 'intent') else None)!r}, "
                f"payer={(self.payer if hasattr(self, 'payer') else None)!r}, "
                f"purchase_units={(self.purchase_units
                     if hasattr(self, 'purchase_units') else None)!r}, "
