...
class PricingScheme(object):
    ...
    def from_dictionary(cls,
        ...
        pricing_model =\
            ...
            if dictionary.get("pricing_model") else None
        price = Money.from_dictionary(
            dictionary.get("price"))\
            if "price" in dictionary.keys() else APIHelper.SKIP
        reload_threshold_amount = Money.from_dictionary(
            dictionary.get("reload_threshold_amount"))\
            if "reload_threshold_amount" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"reload_threshold_amount={(self.reload_threshold_amount
                     if hasattr(self, 'reload_threshold_amount') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"reload_threshold_amount={(self.reload_threshold_amount
                     if hasattr(self, 'reload_threshold_amount') else None)!s})")
