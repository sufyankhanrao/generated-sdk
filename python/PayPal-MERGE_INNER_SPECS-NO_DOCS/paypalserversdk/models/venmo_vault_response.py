...
class VenmoVaultResponse(object):
    """Implementation of the 'Venmo Vault Response' model.

    The details about a saved venmo payment source.

    Attributes:
        id (str): The PayPal-generated ID for the saved payment source.
        status (VenmoVaultResponseStatus): The vault status.
    ...
    def __init__(self,
        ...
        """Initialize a VenmoVaultResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("links") is not None:
            ...
            links = APIHelper.SKIP
        customer = CustomerInformation.from_dictionary(
