...
class ApplePayRequest(object):
    ...
    def from_dictionary(cls,
        ...
        decrypted_token = ApplePayDecryptedTokenData.from_dictionary(
        ...
        attributes = ApplePayAttributes.from_dictionary(
            dictionary.get("attributes"))\
            if "attributes" in dictionary.keys() else APIHelper.SKIP
        experience_context = ApplePayExperienceContext.from_dictionary(
