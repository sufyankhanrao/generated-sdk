...
class BlikOneClickPaymentRequest(object):
    ...
    def from_dictionary(cls,
        ...
        consumer_reference =\
            ...
            if dictionary.get("consumer_reference") else None
        auth_code =\
            dictionary.get("auth_code")\
            if dictionary.get("auth_code") else APIHelper.SKIP
        alias_label =\
            dictionary.get("alias_label")\
            if dictionary.get("alias_label") else APIHelper.SKIP
        alias_key =\
            dictionary.get("alias_key")\
            if dictionary.get("alias_key") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"alias_label={(self.alias_label
                     if hasattr(self, 'alias_label') else None)!r}, "
                f"alias_key={(self.alias_key
                     if hasattr(self, 'alias_key') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"alias_label={(self.alias_label
                     if hasattr(self, 'alias_label') else None)!s}, "
                f"alias_key={(self.alias_key
                     if hasattr(self, 'alias_key') else None)!s})")
