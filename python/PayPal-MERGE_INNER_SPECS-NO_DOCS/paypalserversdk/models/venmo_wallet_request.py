...
from paypalserversdk.models.venmo_wallet_additional_attributes import (
    VenmoWalletAdditionalAttributes,
)
from paypalserversdk.models.venmo_wallet_experience_context import (
...
class VenmoWalletRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a VenmoWalletRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        experience_context = VenmoWalletExperienceContext.from_dictionary(
            dictionary.get("experience_context"))\
            if "experience_context" in dictionary.keys() else APIHelper.SKIP
        attributes = VenmoWalletAdditionalAttributes.from_dictionary(
