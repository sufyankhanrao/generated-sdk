...
from paypalserversdk.models.paypal_wallet_customer_request import (
    PaypalWalletCustomerRequest,
)
from paypalserversdk.models.paypal_wallet_vault_instruction import (
...
class PaypalWalletAttributes(object):
    ...
    def from_dictionary(cls,
        ...
        customer = PaypalWalletCustomerRequest.from_dictionary(
            dictionary.get("customer"))\
            if "customer" in dictionary.keys() else APIHelper.SKIP
        vault = PaypalWalletVaultInstruction.from_dictionary(
