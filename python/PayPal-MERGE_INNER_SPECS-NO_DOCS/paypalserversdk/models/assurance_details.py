...
class AssuranceDetails(object):
    ...
    def __init__(self,
        ...
        """Initialize a AssuranceDetails instance."""
    ...
    def from_dictionary(cls,
        ...
        account_verified =\
            dictionary.get("account_verified")\
            if dictionary.get("account_verified") else False
        card_holder_authenticated =\
            dictionary.get("card_holder_authenticated")\
            if dictionary.get("card_holder_authenticated") else False
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"account_verified={(self.account_verified
                     if hasattr(self, 'account_verified') else None)!r}, "
                f"card_holder_authenticated={(self.card_holder_authenticated
                     if hasattr(self, 'card_holder_authenticated') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"account_verified={(self.account_verified
                     if hasattr(self, 'account_verified') else None)!s}, "
                f"card_holder_authenticated={(self.card_holder_authenticated
                     if hasattr(self, 'card_holder_authenticated') else None)!s})")
