...
from paypalserversdk.models.cobranded_card import (
    CobrandedCard,
)
from paypalserversdk.models.paypal_wallet_vault_response import (
...
class PaypalWalletAttributesResponse(object):
    ...
    def from_dictionary(cls,
        ...
        vault = PaypalWalletVaultResponse.from_dictionary(
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"cobranded_cards={(self.cobranded_cards
                     if hasattr(self, 'cobranded_cards') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"cobranded_cards={(self.cobranded_cards
                     if hasattr(self, 'cobranded_cards') else None)!s})")
