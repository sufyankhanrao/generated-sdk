...
class ApplePayDecryptedTokenData(object):
    ...
    def from_dictionary(cls,
        ...
        tokenized_card = ApplePayTokenizedCard.from_dictionary(
        ...
        device_manufacturer_id =\
            ...
            if dictionary.get("device_manufacturer_id") else APIHelper.SKIP
        payment_data_type =\
            dictionary.get("payment_data_type")\
            if dictionary.get("payment_data_type") else APIHelper.SKIP
        payment_data = ApplePayPaymentData.from_dictionary(
            dictionary.get("payment_data"))\
            if "payment_data" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"device_manufacturer_id={(self.device_manufacturer_id
                     if hasattr(self, 'device_manufacturer_id') else None)!r}, "
                f"payment_data_type={(self.payment_data_type
                     if hasattr(self, 'payment_data_type') else None)!r}, "
                f"payment_data={(self.payment_data
                     if hasattr(self, 'payment_data') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"device_manufacturer_id={(self.device_manufacturer_id
                     if hasattr(self, 'device_manufacturer_id') else None)!s}, "
                f"payment_data_type={(self.payment_data_type
                     if hasattr(self, 'payment_data_type') else None)!s}, "
                f"payment_data={(self.payment_data
                     if hasattr(self, 'payment_data') else None)!s})")
