...
class BinDetails(object):
    ...
    def __init__(self,
        ...
        """Initialize a BinDetails instance."""
    ...
    def from_dictionary(cls,
        ...
        issuing_bank =\
            dictionary.get("issuing_bank")\
            if dictionary.get("issuing_bank") else APIHelper.SKIP
        bin_country_code =\
            dictionary.get("bin_country_code")\
            if dictionary.get("bin_country_code") else APIHelper.SKIP
        products =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"issuing_bank={(self.issuing_bank
                     if hasattr(self, 'issuing_bank') else None)!r}, "
                f"bin_country_code={(self.bin_country_code
                     if hasattr(self, 'bin_country_code') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"issuing_bank={(self.issuing_bank
                     if hasattr(self, 'issuing_bank') else None)!s}, "
                f"bin_country_code={(self.bin_country_code
                     if hasattr(self, 'bin_country_code') else None)!s}, "
                f"products={(self.products
