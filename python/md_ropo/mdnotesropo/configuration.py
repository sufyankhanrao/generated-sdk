...
from mdnotesropo.http.proxy_settings import (
    ProxySettings,
)
...
class Configuration(HttpClientConfiguration):
    ...
    def o_auth_username(self):
        """Return OAuthUsername from ResourcePasswordAuthCredentials."""
        return self._resource_password_auth_credentials.o_auth_username

    @property
    def o_auth_password(self):
        """Return OAuthPassword from ResourcePasswordAuthCredentials."""
        return self._resource_password_auth_credentials.o_auth_password

    @property
    def o_auth_scopes(self):
        """Return OAuthScopes from ResourcePasswordAuthCredentials."""
        return self._resource_password_auth_credentials.o_auth_scopes

    @property
    def o_auth_token(self):
        """Return OAuthToken from ResourcePasswordAuthCredentials."""
        return self._resource_password_auth_credentials.o_auth_token

    @property
    def resource_password_auth_credentials(self):
        """Return ResourcePasswordAuthCredentials."""
        return self._resource_password_auth_credentials
    ...
    def clone_with(self, http_client_instance=None,
                   ...
                   environment=None, o_auth_username=None, o_auth_password=None,
        ...
        resource_password_auth_credentials = self.create_auth_credentials_object(
            o_auth_username, o_auth_password, o_auth_token, o_auth_scopes,
            resource_password_auth_credentials
            or self.resource_password_auth_credentials,
            stack_level=3)
    ...
    @staticmethod
    def create_auth_credentials_object(o_auth_username, o_auth_password,
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        default_config = cls(
            ...
            resource_password_auth_credentials=ResourcePasswordAuthCredentials.from_environment(),
        )
