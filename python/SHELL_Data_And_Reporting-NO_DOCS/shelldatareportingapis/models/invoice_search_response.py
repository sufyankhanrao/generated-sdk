...
from shelldatareportingapis.models.invoice_search_details import (
...
class InvoiceSearchResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a InvoiceSearchResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("Data") is not None:
            data = [
                InvoiceSearchDetails.from_dictionary(x)
        ...
        total_records =\
            ...
            if "TotalRecords" in dictionary.keys() else APIHelper.SKIP
        total_pages =\
            dictionary.get("TotalPages")\
            if "TotalPages" in dictionary.keys() else APIHelper.SKIP
