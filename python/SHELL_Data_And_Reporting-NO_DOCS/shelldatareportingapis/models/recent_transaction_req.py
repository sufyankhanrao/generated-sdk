...
class RecentTransactionReq(object):
    ...
    def __init__(self,
        ...
        """Initialize a RecentTransactionReq instance."""
    ...
    def from_dictionary(cls,
        ...
        from_date_time =\
            dictionary.get("FromDateTime")\
            if "FromDateTime" in dictionary.keys() else APIHelper.SKIP
        to_date_time =\
            dictionary.get("ToDateTime")\
            if "ToDateTime" in dictionary.keys() else APIHelper.SKIP
        transaction_status =\
        ...
        include_declines =\
            dictionary.get("IncludeDeclines")\
            if "IncludeDeclines" in dictionary.keys() else APIHelper.SKIP
        card_issuer_name =\
            dictionary.get("CardIssuerName")\
            if "CardIssuerName" in dictionary.keys() else APIHelper.SKIP
        column_list =\
            dictionary.get("ColumnList")\
            if dictionary.get("ColumnList") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"from_date_time={(self.from_date_time
                     if hasattr(self, 'from_date_time') else None)!r}, "
                f"to_date_time={(self.to_date_time
                     if hasattr(self, 'to_date_time') else None)!r}, "
                ...
                f"include_declines={(self.include_declines
                     if hasattr(self, 'include_declines') else None)!r}, "
                f"card_issuer_name={(self.card_issuer_name
                     if hasattr(self, 'card_issuer_name') else None)!r}, "
                f"column_list={(self.column_list
                     if hasattr(self, 'column_list') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"from_date_time={(self.from_date_time
                     if hasattr(self, 'from_date_time') else None)!s}, "
                f"to_date_time={(self.to_date_time
                     if hasattr(self, 'to_date_time') else None)!s}, "
                f"transaction_status={(self.transaction_status
                ...
                f"include_declines={(self.include_declines
                     if hasattr(self, 'include_declines') else None)!s}, "
                f"card_issuer_name={(self.card_issuer_name
                     if hasattr(self, 'card_issuer_name') else None)!s}, "
                f"column_list={(self.column_list
                     if hasattr(self, 'column_list') else None)!s})")
