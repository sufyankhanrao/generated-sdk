...
class Tier(object):
    ...
    def from_dictionary(cls,
        ...
        tier_price_list_id =\
            dictionary.get("TierPriceListId")\
            if "TierPriceListId" in dictionary.keys() else APIHelper.SKIP
        price_list_description =\
            dictionary.get("PriceListDescription")\
            if "PriceListDescription" in dictionary.keys() else APIHelper.SKIP
        tier_min =\
            dictionary.get("TierMin")\
            if "TierMin" in dictionary.keys() else APIHelper.SKIP
        tier_max =\
            dictionary.get("TierMax")\
            if "TierMax" in dictionary.keys() else APIHelper.SKIP
        tiered_pricing_group_name =\
            dictionary.get("TieredPricingGroupName")\
            if "TieredPricingGroupName" in dictionary.keys() else APIHelper.SKIP
        tiered_pricing_group_period =\
            dictionary.get("TieredPricingGroupPeriod")\
            if "TieredPricingGroupPeriod" in dictionary.keys() else APIHelper.SKIP
        discount_value =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"tier_price_list_id={(self.tier_price_list_id
                     if hasattr(self, 'tier_price_list_id') else None)!r}, "
                f"price_list_description={(self.price_list_description
                     if hasattr(self, 'price_list_description') else None)!r}, "
                f"tier_min={(self.tier_min
                     if hasattr(self, 'tier_min') else None)!r}, "
                f"tier_max={(self.tier_max
                     if hasattr(self, 'tier_max') else None)!r}, "
                f"tiered_pricing_group_name={(self.tiered_pricing_group_name
                     if hasattr(self, 'tiered_pricing_group_name') else None)!r}, "
                f"tiered_pricing_group_period={(self.tiered_pricing_group_period
                     if hasattr(self, 'tiered_pricing_group_period') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"tier_price_list_id={(self.tier_price_list_id
                     if hasattr(self, 'tier_price_list_id') else None)!s}, "
                f"price_list_description={(self.price_list_description
                     if hasattr(self, 'price_list_description') else None)!s}, "
                f"tier_min={(self.tier_min
                     if hasattr(self, 'tier_min') else None)!s}, "
                f"tier_max={(self.tier_max
                     if hasattr(self, 'tier_max') else None)!s}, "
                f"tiered_pricing_group_name={(self.tiered_pricing_group_name
                     if hasattr(self, 'tiered_pricing_group_name') else None)!s}, "
                f"tiered_pricing_group_period={(self.tiered_pricing_group_period
                     if hasattr(self, 'tiered_pricing_group_period') else None)!s}, "
                f"discount_value={(self.discount_value
