...
from shelldatareportingapis.models.search_statement_of_account import SearchStatementOfAccount
...
class SearchStatementOfAccountResponse(object):
    ...
    def __init__(self,
        ...
        """Constructor for the SearchStatementOfAccountResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Data') is not None:
            data = [SearchStatementOfAccount.from_dictionary(x) for x in dictionary.get('Data')]
        else:
            data = APIHelper.SKIP
