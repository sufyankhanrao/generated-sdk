...
from shelldatareportingapis.models.fee_item_summary_all_of_0 import (
...
class FeeSummaryResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a FeeSummaryResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("FeeItemsSummary") is not None:
            fee_items_summary = [
                FeeItemSummaryAllOf0.from_dictionary(x)
                    for x in dictionary.get("FeeItemsSummary")
            ]
        else:
            fee_items_summary = APIHelper.SKIP
        request_id =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"fee_items_summary={(self.fee_items_summary
                     if hasattr(self, 'fee_items_summary') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"fee_items_summary={(self.fee_items_summary
                     if hasattr(self, 'fee_items_summary') else None)!s}, "
                f"request_id={(self.request_id
