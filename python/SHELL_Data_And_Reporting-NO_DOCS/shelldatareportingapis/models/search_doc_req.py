...
class SearchDocReq(object):
    ...
    def __init__(self,
        ...
        """Initialize a SearchDocReq instance."""
    ...
    def from_dictionary(cls,
        ...
        account_number_list =\
            dictionary.get("AccountNumberList")\
            if dictionary.get("AccountNumberList") else APIHelper.SKIP
        invoice_number =\
            dictionary.get("InvoiceNumber")\
            if "InvoiceNumber" in dictionary.keys() else APIHelper.SKIP
        invoice_number_list =\
            dictionary.get("InvoiceNumberList")\
            if dictionary.get("InvoiceNumberList") else APIHelper.SKIP
        invoice_status =\
            dictionary.get("InvoiceStatus")\
            if "InvoiceStatus" in dictionary.keys() else APIHelper.SKIP
        issuing_date_from =\
            dictionary.get("IssuingDateFrom")\
            if "IssuingDateFrom" in dictionary.keys() else APIHelper.SKIP
        issuing_date_to =\
            dictionary.get("IssuingDateTo")\
            if "IssuingDateTo" in dictionary.keys() else APIHelper.SKIP
        due_date_from =\
            dictionary.get("DueDateFrom")\
            if "DueDateFrom" in dictionary.keys() else APIHelper.SKIP
        due_date_to =\
            dictionary.get("DueDateTo")\
            if "DueDateTo" in dictionary.keys() else APIHelper.SKIP
        gross_amount =\
            dictionary.get("GrossAmount")\
            if "GrossAmount" in dictionary.keys() else APIHelper.SKIP
        gross_amount_operator =\
            dictionary.get("GrossAmountOperator")\
            if "GrossAmountOperator" in dictionary.keys() else APIHelper.SKIP
        document_type =\
            dictionary.get("DocumentType")\
            if "DocumentType" in dictionary.keys() else APIHelper.SKIP
        vat_issuer_country =\
            dictionary.get("VATIssuerCountry")\
            if "VATIssuerCountry" in dictionary.keys() else APIHelper.SKIP
        sorty_by =\
            dictionary.get("SortyBy")\
            if dictionary.get("SortyBy") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"account_number_list={(self.account_number_list
                     if hasattr(self, 'account_number_list') else None)!r}, "
                f"invoice_number={(self.invoice_number
                     if hasattr(self, 'invoice_number') else None)!r}, "
                f"invoice_number_list={(self.invoice_number_list
                     if hasattr(self, 'invoice_number_list') else None)!r}, "
                f"invoice_status={(self.invoice_status
                     if hasattr(self, 'invoice_status') else None)!r}, "
                f"issuing_date_from={(self.issuing_date_from
                     if hasattr(self, 'issuing_date_from') else None)!r}, "
                f"issuing_date_to={(self.issuing_date_to
                     if hasattr(self, 'issuing_date_to') else None)!r}, "
                f"due_date_from={(self.due_date_from
                     if hasattr(self, 'due_date_from') else None)!r}, "
                f"due_date_to={(self.due_date_to
                     if hasattr(self, 'due_date_to') else None)!r}, "
                f"gross_amount={(self.gross_amount
                     if hasattr(self, 'gross_amount') else None)!r}, "
                f"gross_amount_operator={(self.gross_amount_operator
                     if hasattr(self, 'gross_amount_operator') else None)!r}, "
                f"document_type={(self.document_type
                     if hasattr(self, 'document_type') else None)!r}, "
                f"vat_issuer_country={(self.vat_issuer_country
                     if hasattr(self, 'vat_issuer_country') else None)!r}, "
                f"sorty_by={(self.sorty_by
                     if hasattr(self, 'sorty_by') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"account_number_list={(self.account_number_list
                     if hasattr(self, 'account_number_list') else None)!s}, "
                f"invoice_number={(self.invoice_number
                     if hasattr(self, 'invoice_number') else None)!s}, "
                f"invoice_number_list={(self.invoice_number_list
                     if hasattr(self, 'invoice_number_list') else None)!s}, "
                f"invoice_status={(self.invoice_status
                     if hasattr(self, 'invoice_status') else None)!s}, "
                f"issuing_date_from={(self.issuing_date_from
                     if hasattr(self, 'issuing_date_from') else None)!s}, "
                f"issuing_date_to={(self.issuing_date_to
                     if hasattr(self, 'issuing_date_to') else None)!s}, "
                f"due_date_from={(self.due_date_from
                     if hasattr(self, 'due_date_from') else None)!s}, "
                f"due_date_to={(self.due_date_to
                     if hasattr(self, 'due_date_to') else None)!s}, "
                f"gross_amount={(self.gross_amount
                     if hasattr(self, 'gross_amount') else None)!s}, "
                f"gross_amount_operator={(self.gross_amount_operator
                     if hasattr(self, 'gross_amount_operator') else None)!s}, "
                f"document_type={(self.document_type
                     if hasattr(self, 'document_type') else None)!s}, "
                f"vat_issuer_country={(self.vat_issuer_country
                     if hasattr(self, 'vat_issuer_country') else None)!s}, "
                f"sorty_by={(self.sorty_by
                     if hasattr(self, 'sorty_by') else None)!s}, "
