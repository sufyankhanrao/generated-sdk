...
from shelldatareportingapis.models.invoices_summaries import (
    InvoicesSummaries,
)
from shelldatareportingapis.models.last_statement_of_account import (
    LastStatementOfAccount,
)
from shelldatareportingapis.models.monthly_invoice_trend import (
    MonthlyInvoiceTrend,
)
from shelldatareportingapis.models.past_statement_of_accounts import (
    PastStatementOfAccounts,
)
from shelldatareportingapis.models.payments_since_last_soa import (
...
class StatementOfAccountResp(object):
    ...
    def __init__(self,
        ...
        """Initialize a StatementOfAccountResp instance."""
    ...
    def from_dictionary(cls,
        ...
        last_statement_of_account = LastStatementOfAccount.from_dictionary(
            dictionary.get("LastStatementOfAccount"))\
            if "LastStatementOfAccount" in dictionary.keys() else APIHelper.SKIP
        ...
        if dictionary.get("PastStatementOfAccounts") is not None:
            past_statement_of_accounts = [
                PastStatementOfAccounts.from_dictionary(x)
                    for x in dictionary.get("PastStatementOfAccounts")
            ]
        else:
            past_statement_of_accounts = APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"last_statement_of_account={(self.last_statement_of_account
                     if hasattr(self, 'last_statement_of_account') else None)!r}, "
                f"monthly_invoice_trend={(self.monthly_invoice_trend
                     if hasattr(self, 'monthly_invoice_trend') else None)!r}, "
                f"past_statement_of_accounts={(self.past_statement_of_accounts
                     if hasattr(self, 'past_statement_of_accounts') else None)!r}, "
                f"payments_since_last_soa={(self.payments_since_last_soa
                     if hasattr(self, 'payments_since_last_soa') else None)!r}, "
                f"invoices_summaries={(self.invoices_summaries
                     if hasattr(self, 'invoices_summaries') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"last_statement_of_account={(self.last_statement_of_account
                     if hasattr(self, 'last_statement_of_account') else None)!s}, "
                f"monthly_invoice_trend={(self.monthly_invoice_trend
                     if hasattr(self, 'monthly_invoice_trend') else None)!s}, "
                f"past_statement_of_accounts={(self.past_statement_of_accounts
                     if hasattr(self, 'past_statement_of_accounts') else None)!s}, "
                f"payments_since_last_soa={(self.payments_since_last_soa
                     if hasattr(self, 'payments_since_last_soa') else None)!s}, "
                f"invoices_summaries={(self.invoices_summaries
                     if hasattr(self, 'invoices_summaries') else None)!s})")
