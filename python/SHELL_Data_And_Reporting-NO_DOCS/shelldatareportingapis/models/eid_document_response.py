...
from shelldatareportingapis.models.eid_document import EIDDocument
...
class EIDDocumentResponse(object):
    ...
    def __init__(self,
        ...
        """Constructor for the EIDDocumentResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Data') is not None:
            data = [EIDDocument.from_dictionary(x) for x in dictionary.get('Data')]
        else:
            data = APIHelper.SKIP
