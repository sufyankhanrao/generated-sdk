...
from shelldatareportingapis.models.search_documents_invoice import SearchDocumentsInvoice
...
class SearchDocumentsResponse(object):
    ...
    def __init__(self,
        ...
        """Constructor for the SearchDocumentsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Data') is not None:
            data = [SearchDocumentsInvoice.from_dictionary(x) for x in dictionary.get('Data')]
        else:
            data = APIHelper.SKIP
        total_records = dictionary.get("TotalRecords") if dictionary.get("TotalRecords") else APIHelper.SKIP
        total_records_on_page = dictionary.get("TotalRecordsOnPage") if dictionary.get("TotalRecordsOnPage") else APIHelper.SKIP
        is_first_page = dictionary.get("IsFirstPage") if "IsFirstPage" in dictionary.keys() else APIHelper.SKIP
        is_last_page = dictionary.get("IsLastPage") if "IsLastPage" in dictionary.keys() else APIHelper.SKIP
