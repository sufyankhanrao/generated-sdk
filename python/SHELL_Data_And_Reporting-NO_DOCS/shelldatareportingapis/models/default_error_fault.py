...
from shelldatareportingapis.models.default_error_fault_detail import DefaultErrorFaultDetail
...
class DefaultErrorFault(object):
    ...
    def __init__(self,
        ...
        """Constructor for the DefaultErrorFault class"""
    ...
    def from_dictionary(cls,
        ...
        detail = DefaultErrorFaultDetail.from_dictionary(dictionary.get('detail')) if 'detail' in dictionary.keys() else APIHelper.SKIP
