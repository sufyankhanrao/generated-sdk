...
class TransactionFeesResponse(object):
    ...
    def __init__(self,
        ...
        """Constructor for the TransactionFeesResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('FeeItems') is not None:
            fee_items = [FeeItem.from_dictionary(x) for x in dictionary.get('FeeItems')]
        else:
            fee_items = APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                f'fee_items={(self.fee_items if hasattr(self, "fee_items") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                f'fee_items={(self.fee_items if hasattr(self, "fee_items") else None)!s}, '
