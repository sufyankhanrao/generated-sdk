...
class VolumeBasedBonusRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a VolumeBasedBonusRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        include_history =\
            dictionary.get("IncludeHistory")\
            if "IncludeHistory" in dictionary.keys() else APIHelper.SKIP
        include_current_period_volume =\
            dictionary.get("IncludeCurrentPeriodVolume")\
            if "IncludeCurrentPeriodVolume" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"include_history={(self.include_history
                     if hasattr(self, 'include_history') else None)!r}, "
                f"include_current_period_volume={(self.include_current_period_volume
                     if hasattr(self, 'include_current_period_volume') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"include_history={(self.include_history
                     if hasattr(self, 'include_history') else None)!s}, "
                f"include_current_period_volume={(self.include_current_period_volume
                     if hasattr(self, 'include_current_period_volume') else None)!s})")
