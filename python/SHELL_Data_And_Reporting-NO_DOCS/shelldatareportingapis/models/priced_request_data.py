...
class PricedRequestData(object):
    ...
    def __init__(self,
        ...
        """Initialize a PricedRequestData instance."""
    ...
    def from_dictionary(cls,
        ...
        invoice_status =\
            ...
            if dictionary.get("InvoiceStatus") else None
        payer_number =\
            dictionary.get("PayerNumber")\
            if dictionary.get("PayerNumber") else None
        account_id =\
        ...
        fuel_only =\
            ...
            if dictionary.get("FuelOnly") else False
        include_fees =\
            dictionary.get("IncludeFees")\
            if "IncludeFees" in dictionary.keys() else APIHelper.SKIP
        is_multipayer =\
            dictionary.get("IsMultipayer")\
            if "IsMultipayer" in dictionary.keys() else APIHelper.SKIP
        valid_invoice_date_only =\
            dictionary.get("ValidInvoiceDateOnly")\
            if dictionary.get("ValidInvoiceDateOnly") else False
        invoice_from_date =\
        ...
        search =\
            ...
            if "Search" in dictionary.keys() else APIHelper.SKIP
        transaction_id =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"is_multipayer={(self.is_multipayer
                     if hasattr(self, 'is_multipayer') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"is_multipayer={(self.is_multipayer
                     if hasattr(self, 'is_multipayer') else None)!s}, "
                f"valid_invoice_date_only={(self.valid_invoice_date_only
