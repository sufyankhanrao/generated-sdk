...
class AssociatedAccount(object):
    ...
    def __init__(self,
        ...
        """Initialize a AssociatedAccount instance."""
    ...
    def from_dictionary(cls,
        ...
        associated_account_id =\
            dictionary.get("AssociatedAccountId")\
            if "AssociatedAccountId" in dictionary.keys() else APIHelper.SKIP
        associated_account_number =\
            dictionary.get("AssociatedAccountNumber")\
            if "AssociatedAccountNumber" in dictionary.keys() else APIHelper.SKIP
        associated_account_short_name =\
            dictionary.get("AssociatedAccountShortName")\
            if "AssociatedAccountShortName" in dictionary.keys() else APIHelper.SKIP
        associated_account_full_name =\
            dictionary.get("AssociatedAccountFullName")\
            if "AssociatedAccountFullName" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"associated_account_id={(self.associated_account_id
                     if hasattr(self, 'associated_account_id') else None)!r}, "
                f"associated_account_number={(self.associated_account_number
                     if hasattr(self, 'associated_account_number') else None)!r}, "
                f"associated_account_short_name={(self.associated_account_short_name
                     if hasattr(self, 'associated_account_short_name') else None)!r}, "
                f"associated_account_full_name={(self.associated_account_full_name
                     if hasattr(self, 'associated_account_full_name') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"associated_account_id={(self.associated_account_id
                     if hasattr(self, 'associated_account_id') else None)!s}, "
                f"associated_account_number={(self.associated_account_number
                     if hasattr(self, 'associated_account_number') else None)!s}, "
                f"associated_account_short_name={(self.associated_account_short_name
                     if hasattr(self, 'associated_account_short_name') else None)!s}, "
                f"associated_account_full_name={(self.associated_account_full_name
                     if hasattr(self, 'associated_account_full_name') else None)!s})")
