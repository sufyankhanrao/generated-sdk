...
from shelldatareportingapis.models.site_location import (
    SiteLocation,
)
...
class MultiPricedTransactionResponseTransactionsItems(object):
    ...
    Attributes:
        ...
        product_group_name (str): Product Group Name  Example:   1 Parent
            Product Group  2 All Fuels  3 Motor gasoline  4 2 stroke  5 Autogas
    ...
    def __init__(self,
        ...
        """Initialize a MultiPricedTransactionResponseTransactionsItems instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("Location") is not None:
            location = [
                SiteLocation.from_dictionary(x)
