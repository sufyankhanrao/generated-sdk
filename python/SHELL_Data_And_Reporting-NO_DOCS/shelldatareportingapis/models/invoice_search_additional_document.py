...
class InvoiceSearchAdditionalDocument(object):
    ...
    def __init__(self,
        ...
        """Initialize a InvoiceSearchAdditionalDocument instance."""
    ...
    def from_dictionary(cls,
        ...
        is_applicable =\
            dictionary.get("IsApplicable")\
            if "IsApplicable" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"is_applicable={(self.is_applicable
                     if hasattr(self, 'is_applicable') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"is_applicable={(self.is_applicable
                     if hasattr(self, 'is_applicable') else None)!s})")
