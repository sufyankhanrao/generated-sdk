...
from shelldatareportingapis.models.update_odometer import (
    UpdateOdometer,
)
...
class UpdateOdometerRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a UpdateOdometerRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("UpdateOdometers") is not None:
            update_odometers = [
                UpdateOdometer.from_dictionary(x)
                    for x in dictionary.get("UpdateOdometers")
            ]
        else:
            update_odometers = APIHelper.SKIP
        notify_caller =\
        ...
        caller =\
            ...
            if dictionary.get("Caller") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"update_odometers={(self.update_odometers
                     if hasattr(self, 'update_odometers') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"update_odometers={(self.update_odometers
                     if hasattr(self, 'update_odometers') else None)!s}, "
                f"notify_caller={(self.notify_caller
