...
from shelldatareportingapis.models.statement_of_account_resp import StatementOfAccountResp
...
class StatementOfAccountResponse(object):
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the StatementOfAccountResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Data') is not None:
            data = [StatementOfAccountResp.from_dictionary(x) for x in dictionary.get('Data')]
        else:
            data = APIHelper.SKIP
