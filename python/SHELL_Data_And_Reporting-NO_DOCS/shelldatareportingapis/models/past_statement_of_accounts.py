...
class PastStatementOfAccounts(object):
    ...
    def __init__(self,
        ...
        """Constructor for the PastStatementOfAccounts class"""
    ...
    def from_dictionary(cls,
        ...
        amount_overdue_from_unallocated = dictionary.get("AmountOverdueFromUnallocated") if "AmountOverdueFromUnallocated" in dictionary.keys() else APIHelper.SKIP
        amount_paid = dictionary.get("AmountPaid") if "AmountPaid" in dictionary.keys() else APIHelper.SKIP
        balance_on_this_statement = dictionary.get("BalanceOnThisStatement") if "BalanceOnThisStatement" in dictionary.keys() else APIHelper.SKIP
        ...
        fully_paid = dictionary.get("FullyPaid") if "FullyPaid" in dictionary.keys() else APIHelper.SKIP
