...
from shelldatareportingapis.models.tier import (
    Tier,
)
...
class PriceList(object):
    ...
    def __init__(self,
        ...
        """Initialize a PriceList instance."""
    ...
    def from_dictionary(cls,
        ...
        date =\
            dictionary.get("Date")\
            if "Date" in dictionary.keys() else APIHelper.SKIP
        day =\
            dictionary.get("Day")\
            if "Day" in dictionary.keys() else APIHelper.SKIP
        mtype =\
            dictionary.get("Type")\
            if "Type" in dictionary.keys() else APIHelper.SKIP
        price_list_id =\
            dictionary.get("PriceListId")\
            if "PriceListId" in dictionary.keys() else APIHelper.SKIP
        price_list_description =\
            dictionary.get("PriceListDescription")\
            if "PriceListDescription" in dictionary.keys() else APIHelper.SKIP
        price_rule_id =\
            dictionary.get("PriceRuleId")\
            if "PriceRuleId" in dictionary.keys() else APIHelper.SKIP
        price_rule_name =\
            dictionary.get("PriceRuleName")\
            if "PriceRuleName" in dictionary.keys() else APIHelper.SKIP
        del_co_id =\
        ...
        price_per_unit =\
            dictionary.get("PricePerUnit")\
            if "PricePerUnit" in dictionary.keys() else APIHelper.SKIP
        currency_code =\
        ...
        price_type =\
            dictionary.get("PriceType")\
            if "PriceType" in dictionary.keys() else APIHelper.SKIP
        site_group_id =\
        ...
        price_rule_delco_id =\
            dictionary.get("PriceRuleDelcoId")\
            if "PriceRuleDelcoId" in dictionary.keys() else APIHelper.SKIP
        price_rule_delco_name =\
            dictionary.get("PriceRuleDelcoName")\
            if "PriceRuleDelcoName" in dictionary.keys() else APIHelper.SKIP
        price_rule_country =\
            dictionary.get("PriceRuleCountry")\
            if "PriceRuleCountry" in dictionary.keys() else APIHelper.SKIP
        price_rule_country_code =\
            dictionary.get("PriceRuleCountryCode")\
            if "PriceRuleCountryCode" in dictionary.keys() else APIHelper.SKIP
        price_rule_basis_id =\
            dictionary.get("PriceRuleBasisId")\
            if "PriceRuleBasisId" in dictionary.keys() else APIHelper.SKIP
        discount_value =\
            dictionary.get("DiscountValue")\
            if "DiscountValue" in dictionary.keys() else APIHelper.SKIP
        price_per_unit_after_discount =\
            dictionary.get("PricePerUnitAfterDiscount")\
            if "PricePerUnitAfterDiscount" in dictionary.keys() else APIHelper.SKIP
        vat_percentage =\
            dictionary.get("VATPercentage")\
            if "VATPercentage" in dictionary.keys() else APIHelper.SKIP
        price_rule_category_id =\
            dictionary.get("PriceRuleCategoryId")\
            if "PriceRuleCategoryId" in dictionary.keys() else APIHelper.SKIP
        tiers = None
        if dictionary.get("Tiers") is not None:
            tiers = [
                Tier.from_dictionary(x)
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"price_list_id={(self.price_list_id
                     if hasattr(self, 'price_list_id') else None)!r}, "
                f"price_list_description={(self.price_list_description
                     if hasattr(self, 'price_list_description') else None)!r}, "
                f"price_rule_id={(self.price_rule_id
                     if hasattr(self, 'price_rule_id') else None)!r}, "
                f"price_rule_name={(self.price_rule_name
                     if hasattr(self, 'price_rule_name') else None)!r}, "
                ...
                f"price_per_unit={(self.price_per_unit
                     if hasattr(self, 'price_per_unit') else None)!r}, "
                ...
                f"price_type={(self.price_type
                     if hasattr(self, 'price_type') else None)!r}, "
                ...
                f"price_rule_delco_id={(self.price_rule_delco_id
                     if hasattr(self, 'price_rule_delco_id') else None)!r}, "
                f"price_rule_delco_name={(self.price_rule_delco_name
                     if hasattr(self, 'price_rule_delco_name') else None)!r}, "
                f"price_rule_country={(self.price_rule_country
                     if hasattr(self, 'price_rule_country') else None)!r}, "
                f"price_rule_country_code={(self.price_rule_country_code
                     if hasattr(self, 'price_rule_country_code') else None)!r}, "
                f"price_rule_basis_id={(self.price_rule_basis_id
                     if hasattr(self, 'price_rule_basis_id') else None)!r}, "
                f"discount_value={(self.discount_value
                     if hasattr(self, 'discount_value') else None)!r}, "
                f"price_per_unit_after_discount={(self.price_per_unit_after_discount
                     if hasattr(self, 'price_per_unit_after_discount') else None)!r}, "
                f"vat_percentage={(self.vat_percentage
                     if hasattr(self, 'vat_percentage') else None)!r}, "
                f"price_rule_category_id={(self.price_rule_category_id
                     if hasattr(self, 'price_rule_category_id') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"price_list_id={(self.price_list_id
                     if hasattr(self, 'price_list_id') else None)!s}, "
                f"price_list_description={(self.price_list_description
                     if hasattr(self, 'price_list_description') else None)!s}, "
                f"price_rule_id={(self.price_rule_id
                     if hasattr(self, 'price_rule_id') else None)!s}, "
                f"price_rule_name={(self.price_rule_name
                     if hasattr(self, 'price_rule_name') else None)!s}, "
                f"del_co_id={(self.del_co_id
                ...
                f"price_rule_delco_id={(self.price_rule_delco_id
                     if hasattr(self, 'price_rule_delco_id') else None)!s}, "
                f"price_rule_delco_name={(self.price_rule_delco_name
                     if hasattr(self, 'price_rule_delco_name') else None)!s}, "
                f"price_rule_country={(self.price_rule_country
                     if hasattr(self, 'price_rule_country') else None)!s}, "
                f"price_rule_country_code={(self.price_rule_country_code
                     if hasattr(self, 'price_rule_country_code') else None)!s}, "
                f"price_rule_basis_id={(self.price_rule_basis_id
                     if hasattr(self, 'price_rule_basis_id') else None)!s}, "
                f"discount_value={(self.discount_value
                     if hasattr(self, 'discount_value') else None)!s}, "
                f"price_per_unit_after_discount={(self.price_per_unit_after_discount
                     if hasattr(self, 'price_per_unit_after_discount') else None)!s}, "
                f"vat_percentage={(self.vat_percentage
                     if hasattr(self, 'vat_percentage') else None)!s}, "
                f"price_rule_category_id={(self.price_rule_category_id
                     if hasattr(self, 'price_rule_category_id') else None)!s}, "
