...
class StatementOfAccountRequestFilters(object):
    ...
    def __init__(self,
        ...
        """Initialize a StatementOfAccountRequestFilters instance."""
        ...
        if include_past_statement_of_accounts is not APIHelper.SKIP:
            self.include_past_statement_of_accounts =\
                 include_past_statement_of_accounts
        if due_or_over_due_soa_documents_only is not APIHelper.SKIP:
            self.due_or_over_due_soa_documents_only =\
                 due_or_over_due_soa_documents_only
    ...
    def from_dictionary(cls,
        ...
        include_monthly_invoice_trend =\
            dictionary.get("IncludeMonthlyInvoiceTrend")\
            if "IncludeMonthlyInvoiceTrend" in dictionary.keys() else APIHelper.SKIP
        include_past_statement_of_accounts =\
            dictionary.get("IncludePastStatementOfAccounts")\
            if "IncludePastStatementOfAccounts" in dictionary.keys() else APIHelper.SKIP
        due_or_over_due_soa_documents_only =\
            dictionary.get("DueOrOverDueSOADocumentsOnly")\
            if "DueOrOverDueSOADocumentsOnly" in dictionary.keys() else APIHelper.SKIP
        number_of_soa_documents =\
            dictionary.get("NumberOfSOADocuments")\
            if "NumberOfSOADocuments" in dictionary.keys() else APIHelper.SKIP
        include_account_invoices_summary =\
            dictionary.get("IncludeAccountInvoicesSummary")\
            if "IncludeAccountInvoicesSummary" in dictionary.keys() else APIHelper.SKIP
        col_co_id =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"include_monthly_invoice_trend={(self.include_monthly_invoice_trend
                     if hasattr(self, 'include_monthly_invoice_trend') else None)!r}, "
                f"include_past_statement_of_accounts={(self.include_past_statement_of_accounts
                     if hasattr(self, 'include_past_statement_of_accounts') else None)!r}, "
                f"due_or_over_due_soa_documents_only={(self.due_or_over_due_soa_documents_only
                     if hasattr(self, 'due_or_over_due_soa_documents_only') else None)!r}, "
                f"number_of_soa_documents={(self.number_of_soa_documents
                     if hasattr(self, 'number_of_soa_documents') else None)!r}, "
                f"include_account_invoices_summary={(self.include_account_invoices_summary
                     if hasattr(self, 'include_account_invoices_summary') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"include_monthly_invoice_trend={(self.include_monthly_invoice_trend
                     if hasattr(self, 'include_monthly_invoice_trend') else None)!s}, "
                f"include_past_statement_of_accounts={(self.include_past_statement_of_accounts
                     if hasattr(self, 'include_past_statement_of_accounts') else None)!s}, "
                f"due_or_over_due_soa_documents_only={(self.due_or_over_due_soa_documents_only
                     if hasattr(self, 'due_or_over_due_soa_documents_only') else None)!s}, "
                f"number_of_soa_documents={(self.number_of_soa_documents
                     if hasattr(self, 'number_of_soa_documents') else None)!s}, "
                f"include_account_invoices_summary={(self.include_account_invoices_summary
                     if hasattr(self, 'include_account_invoices_summary') else None)!s}, "
                f"col_co_id={(self.col_co_id
