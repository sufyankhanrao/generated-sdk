...
class CardExceptions(object):
    ...
    def __init__(self,
                 ...
                 week=APIHelper.SKIP,
                 year=APIHelper.SKIP):
        """Initialize a CardExceptions instance."""
    ...
    def from_dictionary(cls,
        ...
        total_amount =\
            ...
            if "TotalAmount" in dictionary.keys() else APIHelper.SKIP
        total_quantity =\
            dictionary.get("TotalQuantity")\
            if "TotalQuantity" in dictionary.keys() else APIHelper.SKIP
        total_sales_items =\
            dictionary.get("TotalSalesItems")\
            if "TotalSalesItems" in dictionary.keys() else APIHelper.SKIP
        total_transactions =\
            dictionary.get("TotalTransactions")\
            if "TotalTransactions" in dictionary.keys() else APIHelper.SKIP
        vrn =\
            dictionary.get("VRN")\
            if "VRN" in dictionary.keys() else APIHelper.SKIP
        week =\
            dictionary.get("Week")\
            if "Week" in dictionary.keys() else APIHelper.SKIP
        year =\
            dictionary.get("Year")\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"total_sales_items={(self.total_sales_items
                     if hasattr(self, 'total_sales_items') else None)!r}, "
                f"total_transactions={(self.total_transactions
                     if hasattr(self, 'total_transactions') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"total_sales_items={(self.total_sales_items
                     if hasattr(self, 'total_sales_items') else None)!s}, "
                f"total_transactions={(self.total_transactions
                     if hasattr(self, 'total_transactions') else None)!s}, "
