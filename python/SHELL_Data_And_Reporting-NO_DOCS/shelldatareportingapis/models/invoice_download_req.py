...
class InvoiceDownloadReq(object):
    ...
    def __init__(self,
        ...
        """Initialize a InvoiceDownloadReq instance."""
    ...
    def from_dictionary(cls,
        ...
        invoice_or_soa_number =\
            dictionary.get("InvoiceOrSOANumber")\
            if "InvoiceOrSOANumber" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"invoice_or_soa_number={(self.invoice_or_soa_number
                     if hasattr(self, 'invoice_or_soa_number') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"invoice_or_soa_number={(self.invoice_or_soa_number
                     if hasattr(self, 'invoice_or_soa_number') else None)!s})")
