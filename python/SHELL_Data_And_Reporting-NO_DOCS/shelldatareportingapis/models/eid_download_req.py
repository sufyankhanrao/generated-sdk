...
class EIDDownloadReq(object):
    ...
    def __init__(self,
        ...
        """Initialize a EIDDownloadReq instance."""
    ...
    def from_dictionary(cls,
        ...
        eid_list =\
            dictionary.get("EIDList")\
            if dictionary.get("EIDList") else None
        account_group_country =\
            dictionary.get("AccountGroupCountry")\
            if dictionary.get("AccountGroupCountry") else None
        account_group_id_list =\
            dictionary.get("AccountGroupIdList")\
            if dictionary.get("AccountGroupIdList") else None
