...
from shelldatareportingapis.models.card_exceptions import (
    CardExceptions,
)
from shelldatareportingapis.models.error_status import (
    ErrorStatus,
)
from shelldatareportingapis.models.transaction_exceptions import (
...
class TransactionExceptionsResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a TransactionExceptionsResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("CardExceptions") is not None:
            card_exceptions = [
                CardExceptions.from_dictionary(x)
                    for x in dictionary.get("CardExceptions")
            ]
        else:
            card_exceptions = APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"card_exceptions={(self.card_exceptions
                     if hasattr(self, 'card_exceptions') else None)!r}, "
                f"transaction_exceptions={(self.transaction_exceptions
                     if hasattr(self, 'transaction_exceptions') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"card_exceptions={(self.card_exceptions
                     if hasattr(self, 'card_exceptions') else None)!s}, "
                f"transaction_exceptions={(self.transaction_exceptions
                     if hasattr(self, 'transaction_exceptions') else None)!s}, "
