...
class ServiceUsage(object):
    ...
    def __init__(self,
        ...
        """Initialize a ServiceUsage instance."""
    ...
    def from_dictionary(cls,
        ...
        transactions_count =\
            dictionary.get("transactionsCount")\
            if dictionary.get("transactionsCount") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"transactions_count={(self.transactions_count
                     if hasattr(self, 'transactions_count') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"transactions_count={(self.transactions_count
                     if hasattr(self, 'transactions_count') else None)!s})")
