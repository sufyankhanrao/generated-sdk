...
class QosDeviceInfo(object):
    ...
    def __init__(self,
        ...
        """Initialize a QosDeviceInfo instance."""
    ...
    def from_dictionary(cls,
        ...
        device_id = QosDeviceId.from_dictionary(
            dictionary.get("deviceId"))\
            if dictionary.get("deviceId") else None
        flow_info = None
        if dictionary.get("flowInfo") is not None:
            flow_info = [
                FlowInfo.from_dictionary(x)
                    for x in dictionary.get("flowInfo")
            ]
        device_i_pv_6_addr =\
            dictionary.get("deviceIPv6Addr")\
            if dictionary.get("deviceIPv6Addr") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"device_i_pv_6_addr={(self.device_i_pv_6_addr
                     if hasattr(self, 'device_i_pv_6_addr') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"device_i_pv_6_addr={(self.device_i_pv_6_addr
                     if hasattr(self, 'device_i_pv_6_addr') else None)!s}, "
