...
from verizon.models.trigger_attributes_options import (
...
class TriggersListOptions(object):
    ...
    def __init__(self,
        ...
        """Initialize a TriggersListOptions instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("triggerAttributes") is not None:
            trigger_attributes = [
                TriggerAttributesOptions.from_dictionary(x)
                    for x in dictionary.get("triggerAttributes")
            ]
        else:
            trigger_attributes = APIHelper.SKIP
        created_at =\
        ...
        anomalyattributes = UsageAnomalyAttributes.from_dictionary(
            dictionary.get("anomalyattributes"))\
            if "anomalyattributes" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"trigger_attributes={(self.trigger_attributes
                     if hasattr(self, 'trigger_attributes') else None)!r}, "
                f"created_at={(self.created_at
                     if hasattr(self, 'created_at') else None)!r}, "
                f"modified_at={(self.modified_at
                     if hasattr(self, 'modified_at') else None)!r}, "
                f"anomalyattributes={(self.anomalyattributes
                     if hasattr(self, 'anomalyattributes') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"trigger_attributes={(self.trigger_attributes
                     if hasattr(self, 'trigger_attributes') else None)!s}, "
                f"created_at={(self.created_at
                     if hasattr(self, 'created_at') else None)!s}, "
                f"modified_at={(self.modified_at
                     if hasattr(self, 'modified_at') else None)!s}, "
                f"anomalyattributes={(self.anomalyattributes
                     if hasattr(self, 'anomalyattributes') else None)!s}, "
                f"notification={(self.notification
