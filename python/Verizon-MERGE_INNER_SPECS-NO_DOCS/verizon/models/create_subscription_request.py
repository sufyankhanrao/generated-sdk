...
class CreateSubscriptionRequest(object):
    ...
    def from_dictionary(cls,
        ...
        allowaggregation =\
            dictionary.get("allowaggregation")\
            if "allowaggregation" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"allowaggregation={(self.allowaggregation
                     if hasattr(self, 'allowaggregation') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"allowaggregation={(self.allowaggregation
                     if hasattr(self, 'allowaggregation') else None)!s})")
