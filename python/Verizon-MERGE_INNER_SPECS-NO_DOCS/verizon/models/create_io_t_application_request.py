...
class CreateIoTApplicationRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a CreateIoTApplicationRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        app_name =\
            ...
            if dictionary.get("appName") else APIHelper.SKIP
        billing_account_id =\
        ...
        client_secret =\
            dictionary.get("clientSecret")\
            if dictionary.get("clientSecret") else APIHelper.SKIP
        email_i_ds =\
            dictionary.get("emailIDs")\
            if dictionary.get("emailIDs") else APIHelper.SKIP
        resourcegroup =\
            dictionary.get("resourcegroup")\
            if dictionary.get("resourcegroup") else APIHelper.SKIP
        sample_io_tc_app =\
            dictionary.get("sampleIOTcApp")\
            if dictionary.get("sampleIOTcApp") else APIHelper.SKIP
        subscription_id =\
            dictionary.get("subscriptionID")\
            if dictionary.get("subscriptionID") else APIHelper.SKIP
        tenant_id =\
            dictionary.get("tenantID")\
            if dictionary.get("tenantID") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"app_name={(self.app_name
                     if hasattr(self, 'app_name') else None)!r}, "
                f"billing_account_id={(self.billing_account_id
                     if hasattr(self, 'billing_account_id') else None)!r}, "
                f"client_id={(self.client_id
                     if hasattr(self, 'client_id') else None)!r}, "
                f"client_secret={(self.client_secret
                     if hasattr(self, 'client_secret') else None)!r}, "
                f"email_i_ds={(self.email_i_ds
                     if hasattr(self, 'email_i_ds') else None)!r}, "
                f"resourcegroup={(self.resourcegroup
                     if hasattr(self, 'resourcegroup') else None)!r}, "
                f"sample_io_tc_app={(self.sample_io_tc_app
                     if hasattr(self, 'sample_io_tc_app') else None)!r}, "
                f"subscription_id={(self.subscription_id
                     if hasattr(self, 'subscription_id') else None)!r}, "
                f"tenant_id={(self.tenant_id
                     if hasattr(self, 'tenant_id') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"app_name={(self.app_name
                     if hasattr(self, 'app_name') else None)!s}, "
                f"billing_account_id={(self.billing_account_id
                     if hasattr(self, 'billing_account_id') else None)!s}, "
                f"client_id={(self.client_id
                     if hasattr(self, 'client_id') else None)!s}, "
                f"client_secret={(self.client_secret
                     if hasattr(self, 'client_secret') else None)!s}, "
                f"email_i_ds={(self.email_i_ds
                     if hasattr(self, 'email_i_ds') else None)!s}, "
                f"resourcegroup={(self.resourcegroup
                     if hasattr(self, 'resourcegroup') else None)!s}, "
                f"sample_io_tc_app={(self.sample_io_tc_app
                     if hasattr(self, 'sample_io_tc_app') else None)!s}, "
                f"subscription_id={(self.subscription_id
                     if hasattr(self, 'subscription_id') else None)!s}, "
                f"tenant_id={(self.tenant_id
                     if hasattr(self, 'tenant_id') else None)!s})")
