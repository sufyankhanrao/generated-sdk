...
class AggregateUsageItem(object):
    ...
    def from_dictionary(cls,
        ...
        number_of_sessions =\
            ...
            if dictionary.get("numberOfSessions") else APIHelper.SKIP
        bytes_transferred =\
            dictionary.get("bytesTransferred")\
            if dictionary.get("bytesTransferred") else APIHelper.SKIP
        example =\
            dictionary.get("example")\
            if dictionary.get("example") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"number_of_sessions={(self.number_of_sessions
                     if hasattr(self, 'number_of_sessions') else None)!r}, "
                f"bytes_transferred={(self.bytes_transferred
                     if hasattr(self, 'bytes_transferred') else None)!r}, "
                f"example={(self.example
                     if hasattr(self, 'example') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"number_of_sessions={(self.number_of_sessions
                     if hasattr(self, 'number_of_sessions') else None)!s}, "
                f"bytes_transferred={(self.bytes_transferred
                     if hasattr(self, 'bytes_transferred') else None)!s}, "
                f"example={(self.example
