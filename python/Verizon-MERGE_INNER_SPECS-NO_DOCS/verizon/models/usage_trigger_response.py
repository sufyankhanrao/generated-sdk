...
class UsageTriggerResponse(object):
    ...
    def __init__(self,
                 ...
                 create_date=None,
                 update_date=None):
        """Initialize a UsageTriggerResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        trigger_id =\
            ...
            if dictionary.get("triggerId") else None
        trigger_name =\
            dictionary.get("triggerName")\
            if dictionary.get("triggerName") else None
        account_name =\
        ...
        allow_excess =\
            ...
            if "allowExcess" in dictionary.keys() else None
        send_sms_notification =\
            dictionary.get("sendSmsNotification")\
            if "sendSmsNotification" in dictionary.keys() else None
        sms_phone_numbers =\
            dictionary.get("smsPhoneNumbers")\
            if dictionary.get("smsPhoneNumbers") else None
        send_email_notification =\
            dictionary.get("sendEmailNotification")\
            if "sendEmailNotification" in dictionary.keys() else None
        email_addresses =\
            dictionary.get("emailAddresses")\
            if dictionary.get("emailAddresses") else None
        create_date =\
            dictionary.get("createDate")\
            if dictionary.get("createDate") else None
        update_date =\
            dictionary.get("updateDate")\
            if dictionary.get("updateDate") else None
