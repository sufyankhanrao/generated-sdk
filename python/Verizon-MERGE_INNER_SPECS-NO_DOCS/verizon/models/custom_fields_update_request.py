...
class CustomFieldsUpdateRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a CustomFieldsUpdateRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("customFieldsToUpdate") is not None:
            custom_fields_to_update = [
                CustomFields.from_dictionary(x)
                    for x in dictionary.get("customFieldsToUpdate")
            ]
        else:
            custom_fields_to_update = APIHelper.SKIP
        devices = None
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"custom_fields_to_update={(self.custom_fields_to_update
                     if hasattr(self, 'custom_fields_to_update') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"custom_fields_to_update={(self.custom_fields_to_update
                     if hasattr(self, 'custom_fields_to_update') else None)!s}, "
                f"devices={(self.devices
