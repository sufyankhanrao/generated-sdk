...
class SessionReportRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a SessionReportRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        duration_low =\
            dictionary.get("durationLow")\
            if "durationLow" in dictionary.keys() else APIHelper.SKIP
        duration_high =\
            dictionary.get("durationHigh")\
            if "durationHigh" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"duration_low={(self.duration_low
                     if hasattr(self, 'duration_low') else None)!r}, "
                f"duration_high={(self.duration_high
                     if hasattr(self, 'duration_high') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"duration_low={(self.duration_low
                     if hasattr(self, 'duration_low') else None)!s}, "
                f"duration_high={(self.duration_high
                     if hasattr(self, 'duration_high') else None)!s})")
