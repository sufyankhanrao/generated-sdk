...
class GetMECPerformanceConsentResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a GetMECPerformanceConsentResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        consent =\
            ...
            if dictionary.get("consent") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"consent={(self.consent
                     if hasattr(self, 'consent') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"consent={(self.consent
                     if hasattr(self, 'consent') else None)!s})")
