...
class BilledusageListRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a BilledusageListRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        labels = LabelsList.from_dictionary(
            dictionary.get("labels"))\
            if "labels" in dictionary.keys() else APIHelper.SKIP
        device_ids = None
        if dictionary.get("deviceIds") is not None:
            ...
            device_ids = APIHelper.SKIP
        billing_cycle = BillingCycle.from_dictionary(
            dictionary.get("billingCycle"))\
            if "billingCycle" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"billing_cycle={(self.billing_cycle
                     if hasattr(self, 'billing_cycle') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"billing_cycle={(self.billing_cycle
                     if hasattr(self, 'billing_cycle') else None)!s})")
