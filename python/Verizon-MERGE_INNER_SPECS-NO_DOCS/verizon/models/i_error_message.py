...
class IErrorMessage(object):
    ...
    def __init__(self,
        ...
        """Initialize a IErrorMessage instance."""
    ...
    def from_dictionary(cls,
        ...
        detail_error_message =\
            dictionary.get("detailErrorMessage")\
            if dictionary.get("detailErrorMessage") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"detail_error_message={(self.detail_error_message
                     if hasattr(self, 'detail_error_message') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"detail_error_message={(self.detail_error_message
                     if hasattr(self, 'detail_error_message') else None)!s})")
