...
class ChangePlan(object):
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                f'trigger_date={(self.trigger_date if hasattr(self, "trigger_date") else None)!r}, '
                f'share_plan={(self.share_plan if hasattr(self, "share_plan") else None)!r})')

    def __str__(self):
        return (f'{self.__class__.__name__}('
                f'trigger_date={(self.trigger_date if hasattr(self, "trigger_date") else None)!s}, '
                f'share_plan={(self.share_plan if hasattr(self, "share_plan") else None)!s})')
