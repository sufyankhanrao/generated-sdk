...
class LocationRequest(object):
    ...
    def from_dictionary(cls,
        ...
        accuracy_mode =\
            ...
            if dictionary.get("accuracyMode") else APIHelper.SKIP
        cache_mode =\
            dictionary.get("cacheMode")\
            if dictionary.get("cacheMode") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"accuracy_mode={(self.accuracy_mode
                     if hasattr(self, 'accuracy_mode') else None)!r}, "
                f"cache_mode={(self.cache_mode
                     if hasattr(self, 'cache_mode') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"accuracy_mode={(self.accuracy_mode
                     if hasattr(self, 'accuracy_mode') else None)!s}, "
                f"cache_mode={(self.cache_mode
                     if hasattr(self, 'cache_mode') else None)!s})")
