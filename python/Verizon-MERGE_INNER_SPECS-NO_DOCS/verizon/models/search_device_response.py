...
class SearchDeviceResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a SearchDeviceResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        fields = Fields2.from_dictionary(
        ...
        tagids =\
            dictionary.get("tagids")\
            if dictionary.get("tagids") else APIHelper.SKIP
        transactionid =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"deviceid={(self.deviceid
                     if hasattr(self, 'deviceid') else None)!r}, "
                ...
                f"transactionid={(self.transactionid
                     if hasattr(self, 'transactionid') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"deviceid={(self.deviceid
                     if hasattr(self, 'deviceid') else None)!s}, "
                ...
                f"transactionid={(self.transactionid
                     if hasattr(self, 'transactionid') else None)!s}, "
                f"version={(self.version
