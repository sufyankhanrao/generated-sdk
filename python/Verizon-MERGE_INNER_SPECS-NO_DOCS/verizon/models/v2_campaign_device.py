...
class V2CampaignDevice(object):
    ...
    def __init__(self,
        ...
        """Initialize a V2CampaignDevice instance."""
    ...
    def from_dictionary(cls,
        ...
        total_device =\
            dictionary.get("totalDevice")\
            if dictionary.get("totalDevice") else APIHelper.SKIP
        last_seen_device_id =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"total_device={(self.total_device
                     if hasattr(self, 'total_device') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"total_device={(self.total_device
                     if hasattr(self, 'total_device') else None)!s}, "
