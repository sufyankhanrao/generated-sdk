...
class DeviceGroupUpdateRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a DeviceGroupUpdateRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("devicesToRemove") is not None:
            devices_to_remove = [
                DeviceId.from_dictionary(x)
                    for x in dictionary.get("devicesToRemove")
            ]
        else:
            devices_to_remove = APIHelper.SKIP
        new_group_description =\
            dictionary.get("newGroupDescription")\
            if dictionary.get("newGroupDescription") else APIHelper.SKIP
        new_group_name =\
            dictionary.get("newGroupName")\
            if dictionary.get("newGroupName") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"devices_to_add={(self.devices_to_add
                     if hasattr(self, 'devices_to_add') else None)!r}, "
                f"devices_to_remove={(self.devices_to_remove
                     if hasattr(self, 'devices_to_remove') else None)!r}, "
                f"new_group_description={(self.new_group_description
                     if hasattr(self, 'new_group_description') else None)!r}, "
                f"new_group_name={(self.new_group_name
                     if hasattr(self, 'new_group_name') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"devices_to_add={(self.devices_to_add
                     if hasattr(self, 'devices_to_add') else None)!s}, "
                f"devices_to_remove={(self.devices_to_remove
                     if hasattr(self, 'devices_to_remove') else None)!s}, "
                f"new_group_description={(self.new_group_description
                     if hasattr(self, 'new_group_description') else None)!s}, "
                f"new_group_name={(self.new_group_name
                     if hasattr(self, 'new_group_name') else None)!s})")
