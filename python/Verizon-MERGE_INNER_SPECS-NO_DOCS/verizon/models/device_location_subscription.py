...
class DeviceLocationSubscription(object):
    ...
    def from_dictionary(cls,
        ...
        loc_type =\
            ...
            if dictionary.get("locType") else APIHelper.SKIP
        max_allowance =\
            dictionary.get("maxAllowance")\
            if dictionary.get("maxAllowance") else APIHelper.SKIP
        purchase_time =\
            dictionary.get("purchaseTime")\
            if dictionary.get("purchaseTime") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"loc_type={(self.loc_type
                     if hasattr(self, 'loc_type') else None)!r}, "
                f"max_allowance={(self.max_allowance
                     if hasattr(self, 'max_allowance') else None)!r}, "
                f"purchase_time={(self.purchase_time
                     if hasattr(self, 'purchase_time') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"loc_type={(self.loc_type
                     if hasattr(self, 'loc_type') else None)!s}, "
                f"max_allowance={(self.max_allowance
                     if hasattr(self, 'max_allowance') else None)!s}, "
                f"purchase_time={(self.purchase_time
                     if hasattr(self, 'purchase_time') else None)!s})")
