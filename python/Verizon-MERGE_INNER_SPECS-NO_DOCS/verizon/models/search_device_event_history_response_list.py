...
class SearchDeviceEventHistoryResponseList(object):
    ...
    def __init__(self,
        ...
        """Initialize a SearchDeviceEventHistoryResponseList instance."""
        ...
        if dictionary.get("SearchDeviceEventHistory") is not None:
            search_device_event_history = [
                SearchDeviceResponse.from_dictionary(x)
                    for x in dictionary.get("SearchDeviceEventHistory")
            ]
        else:
            search_device_event_history = APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"search_device_event_history={(self.search_device_event_history
                     if hasattr(self, 'search_device_event_history') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"search_device_event_history={(self.search_device_event_history
                     if hasattr(self, 'search_device_event_history') else None)!s})")
