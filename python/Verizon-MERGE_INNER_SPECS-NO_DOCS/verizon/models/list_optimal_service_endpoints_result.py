...
from verizon.models.resources_edge_hosted_service import (
...
class ListOptimalServiceEndpointsResult(object):
    ...
    def __init__(self,
        ...
        """Initialize a ListOptimalServiceEndpointsResult instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("serviceEndpoints") is not None:
            service_endpoints = [
                ResourcesEdgeHostedService.from_dictionary(x)
                    for x in dictionary.get("serviceEndpoints")
            ]
        else:
            service_endpoints = APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"service_endpoints={(self.service_endpoints
                     if hasattr(self, 'service_endpoints') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"service_endpoints={(self.service_endpoints
                     if hasattr(self, 'service_endpoints') else None)!s})")
