...
class ServicePlan(object):
    ...
    def __init__(self,
        ...
        """Initialize a ServicePlan instance."""
    ...
    def from_dictionary(cls,
        ...
        carrier_service_plan_code =\
            ...
            if dictionary.get("carrierServicePlanCode") else APIHelper.SKIP
        code =\
            dictionary.get("code")\
        ...
        size_kb =\
            ...
            if dictionary.get("sizeKb") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"carrier_service_plan_code={(self.carrier_service_plan_code
                     if hasattr(self, 'carrier_service_plan_code') else None)!r}, "
                f"code={(self.code if hasattr(self, 'code') else None)!r}, "
                f"extended_attributes={(self.extended_attributes
                     if hasattr(self, 'extended_attributes') else None)!r}, "
                f"name={(self.name if hasattr(self, 'name') else None)!r}, "
                f"size_kb={(self.size_kb
                     if hasattr(self, 'size_kb') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"carrier_service_plan_code={(self.carrier_service_plan_code
                     if hasattr(self, 'carrier_service_plan_code') else None)!s}, "
                f"code={(self.code if hasattr(self, 'code') else None)!s}, "
                f"extended_attributes={(self.extended_attributes
                     if hasattr(self, 'extended_attributes') else None)!s}, "
                f"name={(self.name if hasattr(self, 'name') else None)!s}, "
                f"size_kb={(self.size_kb
                     if hasattr(self, 'size_kb') else None)!s})")
