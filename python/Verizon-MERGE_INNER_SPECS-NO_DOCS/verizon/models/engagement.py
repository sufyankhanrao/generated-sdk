...
class Engagement(object):
    ...
    def __init__(self,
        ...
        """Initialize a Engagement instance."""
    ...
    def from_dictionary(cls,
        ...
        engagement_id =\
            dictionary.get("engagementId")\
            if dictionary.get("engagementId") else APIHelper.SKIP
        charging_group =\
            dictionary.get("chargingGroup")\
            if dictionary.get("chargingGroup") else APIHelper.SKIP
        services = None
        if dictionary.get("services") is not None:
            services = [
                AccountService.from_dictionary(x)
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"engagement_id={(self.engagement_id
                     if hasattr(self, 'engagement_id') else None)!r}, "
                f"charging_group={(self.charging_group
                     if hasattr(self, 'charging_group') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"engagement_id={(self.engagement_id
                     if hasattr(self, 'engagement_id') else None)!s}, "
                f"charging_group={(self.charging_group
                     if hasattr(self, 'charging_group') else None)!s}, "
                f"services={(self.services
