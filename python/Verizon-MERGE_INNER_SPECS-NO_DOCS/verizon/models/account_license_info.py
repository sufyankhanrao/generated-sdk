...
from verizon.models.account_license_device_list_item import (
...
class AccountLicenseInfo(object):
    ...
    def __init__(self,
        ...
        """Initialize a AccountLicenseInfo instance."""
    ...
    def from_dictionary(cls,
        ...
        assigned_licenses =\
            ...
            if dictionary.get("assignedLicenses") else APIHelper.SKIP
        has_more_data =\
        ...
        if dictionary.get("deviceList") is not None:
            device_list = [
                AccountLicenseDeviceListItem.from_dictionary(x)
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"assigned_licenses={(self.assigned_licenses
                     if hasattr(self, 'assigned_licenses') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"assigned_licenses={(self.assigned_licenses
                     if hasattr(self, 'assigned_licenses') else None)!s}, "
                f"has_more_data={(self.has_more_data
