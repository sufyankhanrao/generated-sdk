...
from verizon.models.history_search_filter import (
    HistorySearchFilter,
)
from verizon.models.history_search_limit_time import (
...
class HistorySearchRequest(object):
    ...
    def __init__(self,
                 ...
                 page=APIHelper.SKIP):
        """Initialize a HistorySearchRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        filter = HistorySearchFilter.from_dictionary(
        ...
        limit_time = HistorySearchLimitTime.from_dictionary(
            dictionary.get("$limitTime"))\
            if "$limitTime" in dictionary.keys() else APIHelper.SKIP
        page =\
            dictionary.get("$page")\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"limit_number={(self.limit_number
                     if hasattr(self, 'limit_number') else None)!r}, "
                f"limit_time={(self.limit_time
                     if hasattr(self, 'limit_time') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"limit_number={(self.limit_number
                     if hasattr(self, 'limit_number') else None)!s}, "
                f"limit_time={(self.limit_time
                     if hasattr(self, 'limit_time') else None)!s}, "
