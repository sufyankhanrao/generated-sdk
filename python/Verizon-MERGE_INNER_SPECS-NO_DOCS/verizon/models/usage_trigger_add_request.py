...
class UsageTriggerAddRequest(object):
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"allow_excess={(self.allow_excess
                     if hasattr(self, 'allow_excess') else None)!r}, "
                f"send_sms_notification={(self.send_sms_notification
                     if hasattr(self, 'send_sms_notification') else None)!r}, "
                f"sms_phone_numbers={(self.sms_phone_numbers
                     if hasattr(self, 'sms_phone_numbers') else None)!r}, "
                f"send_email_notification={(self.send_email_notification
                     if hasattr(self, 'send_email_notification') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"allow_excess={(self.allow_excess
                     if hasattr(self, 'allow_excess') else None)!s}, "
                f"send_sms_notification={(self.send_sms_notification
                     if hasattr(self, 'send_sms_notification') else None)!s}, "
                f"sms_phone_numbers={(self.sms_phone_numbers
                     if hasattr(self, 'sms_phone_numbers') else None)!s}, "
                f"send_email_notification={(self.send_email_notification
                     if hasattr(self, 'send_email_notification') else None)!s}, "
                f"email_addresses={(self.email_addresses
