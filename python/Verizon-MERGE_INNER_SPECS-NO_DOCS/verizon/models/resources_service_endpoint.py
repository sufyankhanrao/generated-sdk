...
class ResourcesServiceEndpoint(object):
    ...
    def __init__(self,
                 ...
                 port=APIHelper.SKIP):
        """Initialize a ResourcesServiceEndpoint instance."""
    ...
    def from_dictionary(cls,
        ...
        fqdn =\
            dictionary.get("FQDN")\
            if dictionary.get("FQDN") else APIHelper.SKIP
        i_pv_4_address =\
            dictionary.get("IPv4Address")\
            if dictionary.get("IPv4Address") else APIHelper.SKIP
        i_pv_6_address =\
            dictionary.get("IPv6Address")\
            if dictionary.get("IPv6Address") else APIHelper.SKIP
        port =\
            dictionary.get("port")\
            if dictionary.get("port") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"i_pv_4_address={(self.i_pv_4_address
                     if hasattr(self, 'i_pv_4_address') else None)!r}, "
                f"i_pv_6_address={(self.i_pv_6_address
                     if hasattr(self, 'i_pv_6_address') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"i_pv_4_address={(self.i_pv_4_address
                     if hasattr(self, 'i_pv_4_address') else None)!s}, "
                f"i_pv_6_address={(self.i_pv_6_address
                     if hasattr(self, 'i_pv_6_address') else None)!s}, "
