...
class CreateIoTApplicationResponse(object):
    ...
    def __init__(self,
                 ...
                 url=APIHelper.SKIP):
        """Initialize a CreateIoTApplicationResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        shared_secret =\
            dictionary.get("sharedSecret")\
            if dictionary.get("sharedSecret") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"shared_secret={(self.shared_secret
                     if hasattr(self, 'shared_secret') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"shared_secret={(self.shared_secret
                     if hasattr(self, 'shared_secret') else None)!s}, "
