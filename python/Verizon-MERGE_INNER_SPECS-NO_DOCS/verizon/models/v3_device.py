...
class V3Device(object):
    ...
    def __init__(self,
        ...
        """Initialize a V3Device instance."""
        ...
        if last_connection_time is not APIHelper.SKIP:
            self.last_connection_time =\
                ...
                last_connection_time, APIHelper.RFC3339DateTime) if last_connection_time else None
    ...
    def from_dictionary(cls,
        ...
        request_status =\
            dictionary.get("requestStatus")\
            if dictionary.get("requestStatus") else APIHelper.SKIP
        result_reason =\
            dictionary.get("resultReason")\
            if dictionary.get("resultReason") else APIHelper.SKIP
        ...
        protocol =\
            ...
            if dictionary.get("protocol") else APIHelper.SKIP
        software_list = None
        ...
        status_time =\
            dictionary.get("statusTime")\
            if dictionary.get("statusTime") else APIHelper.SKIP
        update_time =\
        ...
        last_connection_time = APIHelper.RFC3339DateTime.from_value(
            dictionary.get("lastConnectionTime")).datetime\
            if dictionary.get("lastConnectionTime") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"request_status={(self.request_status
                     if hasattr(self, 'request_status') else None)!r}, "
                f"result_reason={(self.result_reason
                     if hasattr(self, 'result_reason') else None)!r}, "
                ...
                f"software_list={(self.software_list
                     if hasattr(self, 'software_list') else None)!r}, "
                f"file_list={(self.file_list
                     if hasattr(self, 'file_list') else None)!r}, "
                f"create_time={(self.create_time
                     if hasattr(self, 'create_time') else None)!r}, "
                f"status_time={(self.status_time
                     if hasattr(self, 'status_time') else None)!r}, "
                f"update_time={(self.update_time
                     if hasattr(self, 'update_time') else None)!r}, "
                f"refresh_time={(self.refresh_time
                     if hasattr(self, 'refresh_time') else None)!r}, "
                f"last_connection_time={(self.last_connection_time
                     if hasattr(self, 'last_connection_time') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"request_status={(self.request_status
                     if hasattr(self, 'request_status') else None)!s}, "
                f"result_reason={(self.result_reason
                     if hasattr(self, 'result_reason') else None)!s}, "
