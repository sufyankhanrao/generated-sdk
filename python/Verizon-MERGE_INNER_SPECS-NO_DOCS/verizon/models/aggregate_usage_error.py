...
class AggregateUsageError(object):
    ...
    def __init__(self,
        ...
        """Initialize a AggregateUsageError instance."""
    ...
    def from_dictionary(cls,
        ...
        error_response = IErrorMessage.from_dictionary(
            dictionary.get("errorResponse"))\
            if "errorResponse" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"error_response={(self.error_response
                     if hasattr(self, 'error_response') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"error_response={(self.error_response
                     if hasattr(self, 'error_response') else None)!s})")
