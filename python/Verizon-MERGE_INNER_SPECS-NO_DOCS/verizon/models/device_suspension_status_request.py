...
from verizon.models.device_filter_without_account import (
...
class DeviceSuspensionStatusRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a DeviceSuspensionStatusRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("deviceIds") is not None:
            ...
            device_ids = APIHelper.SKIP
        filter = DeviceFilterWithoutAccount.from_dictionary(
