...
class UsageAnomalyAttributes(object):
    ...
    def __init__(self,
        ...
        """Initialize a UsageAnomalyAttributes instance."""
    ...
    def from_dictionary(cls,
        ...
        account_names =\
            ...
            if dictionary.get("accountNames") else APIHelper.SKIP
        device_group =\
            dictionary.get("deviceGroup")\
            if dictionary.get("deviceGroup") else APIHelper.SKIP
        include_abnormal =\
            dictionary.get("includeAbnormal")\
            if "includeAbnormal" in dictionary.keys() else APIHelper.SKIP
        include_very_abnormal =\
            dictionary.get("includeVeryAbnormal")\
            if "includeVeryAbnormal" in dictionary.keys() else APIHelper.SKIP
        include_under_expected_usage =\
            dictionary.get("includeUnderExpectedUsage")\
            if "includeUnderExpectedUsage" in dictionary.keys() else APIHelper.SKIP
        include_over_expected_usage =\
            dictionary.get("includeOverExpectedUsage")\
            if "includeOverExpectedUsage" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"account_names={(self.account_names
                     if hasattr(self, 'account_names') else None)!r}, "
                f"device_group={(self.device_group
                     if hasattr(self, 'device_group') else None)!r}, "
                f"include_abnormal={(self.include_abnormal
                     if hasattr(self, 'include_abnormal') else None)!r}, "
                f"include_very_abnormal={(self.include_very_abnormal
                     if hasattr(self, 'include_very_abnormal') else None)!r}, "
                f"include_under_expected_usage={(self.include_under_expected_usage
                     if hasattr(self, 'include_under_expected_usage') else None)!r}, "
                f"include_over_expected_usage={(self.include_over_expected_usage
                     if hasattr(self, 'include_over_expected_usage') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"account_names={(self.account_names
                     if hasattr(self, 'account_names') else None)!s}, "
                f"device_group={(self.device_group
                     if hasattr(self, 'device_group') else None)!s}, "
                f"include_abnormal={(self.include_abnormal
                     if hasattr(self, 'include_abnormal') else None)!s}, "
                f"include_very_abnormal={(self.include_very_abnormal
                     if hasattr(self, 'include_very_abnormal') else None)!s}, "
                f"include_under_expected_usage={(self.include_under_expected_usage
                     if hasattr(self, 'include_under_expected_usage') else None)!s}, "
                f"include_over_expected_usage={(self.include_over_expected_usage
                     if hasattr(self, 'include_over_expected_usage') else None)!s})")
