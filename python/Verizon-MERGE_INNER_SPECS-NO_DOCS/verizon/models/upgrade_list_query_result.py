...
from verizon.models.firmware_upgrade import (
    FirmwareUpgrade,
)
...
class UpgradeListQueryResult(object):
    ...
    def __init__(self,
        ...
        """Initialize a UpgradeListQueryResult instance."""
    ...
    def from_dictionary(cls,
        ...
        has_more_flag =\
            dictionary.get("hasMoreFlag")\
            if "hasMoreFlag" in dictionary.keys() else APIHelper.SKIP
        last_seen_upgrade_id =\
            dictionary.get("lastSeenUpgradeId")\
            if dictionary.get("lastSeenUpgradeId") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"has_more_flag={(self.has_more_flag
                     if hasattr(self, 'has_more_flag') else None)!r}, "
                f"last_seen_upgrade_id={(self.last_seen_upgrade_id
                     if hasattr(self, 'last_seen_upgrade_id') else None)!r}, "
                f"report_list={(self.report_list
                     if hasattr(self, 'report_list') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"has_more_flag={(self.has_more_flag
                     if hasattr(self, 'has_more_flag') else None)!s}, "
                f"last_seen_upgrade_id={(self.last_seen_upgrade_id
                     if hasattr(self, 'last_seen_upgrade_id') else None)!s}, "
                f"report_list={(self.report_list
                     if hasattr(self, 'report_list') else None)!s})")
