...
class Account(object):
    ...
    def from_dictionary(cls,
        ...
        is_provisioning_allowed =\
            ...
            if "isProvisioningAllowed" in dictionary.keys() else APIHelper.SKIP
        carriers =\
            dictionary.get("carriers")\
            if dictionary.get("carriers") else APIHelper.SKIP
        features =\
            dictionary.get("features")\
            if dictionary.get("features") else APIHelper.SKIP
        i_p_pools = None
        if dictionary.get("iPPools") is not None:
            i_p_pools = [
                IPPool.from_dictionary(x)
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"is_provisioning_allowed={(self.is_provisioning_allowed
                     if hasattr(self, 'is_provisioning_allowed') else None)!r}, "
                f"carriers={(self.carriers
                     if hasattr(self, 'carriers') else None)!r}, "
                f"features={(self.features
                     if hasattr(self, 'features') else None)!r}, "
                f"i_p_pools={(self.i_p_pools
                     if hasattr(self, 'i_p_pools') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"is_provisioning_allowed={(self.is_provisioning_allowed
                     if hasattr(self, 'is_provisioning_allowed') else None)!s}, "
                f"carriers={(self.carriers
                     if hasattr(self, 'carriers') else None)!s}, "
                f"features={(self.features
                     if hasattr(self, 'features') else None)!s}, "
                f"i_p_pools={(self.i_p_pools
                     if hasattr(self, 'i_p_pools') else None)!s}, "
                f"service_plans={(self.service_plans
