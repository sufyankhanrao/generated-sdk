...
class ChangeConfigurationResponse(object):
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"foreignid={(self.foreignid
                     if hasattr(self, 'foreignid') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"foreignid={(self.foreignid
                     if hasattr(self, 'foreignid') else None)!s}, "
