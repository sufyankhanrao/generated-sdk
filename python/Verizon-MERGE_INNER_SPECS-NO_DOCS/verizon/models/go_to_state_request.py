...
class GoToStateRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a GoToStateRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        state_name =\
            dictionary.get("stateName")\
            if dictionary.get("stateName") else None
        service_plan =\
        ...
        public_ip_restriction =\
            ...
            if dictionary.get("publicIpRestriction") else APIHelper.SKIP
        sku_number =\
        ...
        if dictionary.get("customFields") is not None:
            ...
            custom_fields = APIHelper.SKIP
        devices_with_service_address =\
            dictionary.get("devicesWithServiceAddress")\
            if dictionary.get("devicesWithServiceAddress") else APIHelper.SKIP
        ip_address =\
        ...
        primary_place_of_use = PlaceOfUse.from_dictionary(
            dictionary.get("primaryPlaceOfUse"))\
            if "primaryPlaceOfUse" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"public_ip_restriction={(self.public_ip_restriction
                     if hasattr(self, 'public_ip_restriction') else None)!r}, "
                ...
                f"devices_with_service_address={(self.devices_with_service_address
                     if hasattr(self, 'devices_with_service_address') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"public_ip_restriction={(self.public_ip_restriction
                     if hasattr(self, 'public_ip_restriction') else None)!s}, "
                f"sku_number={(self.sku_number
                     if hasattr(self, 'sku_number') else None)!s}, "
                f"custom_fields={(self.custom_fields
                     if hasattr(self, 'custom_fields') else None)!s}, "
                f"devices_with_service_address={(self.devices_with_service_address
                     if hasattr(self, 'devices_with_service_address') else None)!s}, "
                f"ip_address={(self.ip_address
