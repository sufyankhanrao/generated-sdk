...
from verizon.models.create_target_request_fields import (
    CreateTargetRequestFields,
)
from verizon.models.target_authentication import (
...
class CreateTargetRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a CreateTargetRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        addressscheme =\
            ...
            if dictionary.get("addressscheme") else APIHelper.SKIP
        fields = CreateTargetRequestFields.from_dictionary(
        ...
        key_1 =\
            dictionary.get("key1")\
            if dictionary.get("key1") else APIHelper.SKIP
        oauth = TargetAuthentication.from_dictionary(
            dictionary.get("oauth"))\
            if "oauth" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"addressscheme={(self.addressscheme
                     if hasattr(self, 'addressscheme') else None)!r}, "
                ...
                f"externalid={(self.externalid
                     if hasattr(self, 'externalid') else None)!r}, "
