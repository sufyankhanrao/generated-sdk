...
class DeviceFirmwareVersion(object):
    ...
    def __init__(self,
        ...
        """Initialize a DeviceFirmwareVersion instance."""
        ...
        if firmware_version_update_time is not APIHelper.SKIP:
            self.firmware_version_update_time =\
                 APIHelper.apply_datetime_converter(
                firmware_version_update_time, APIHelper.RFC3339DateTime) if firmware_version_update_time else None
    ...
    def from_dictionary(cls,
        ...
        firmware_version =\
            ...
            if dictionary.get("firmwareVersion") else None
        status =\
        ...
        firmware_version_update_time = APIHelper.RFC3339DateTime.from_value(
            dictionary.get("firmwareVersionUpdateTime")).datetime\
            if dictionary.get("firmwareVersionUpdateTime") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"firmware_version_update_time={(self.firmware_version_update_time
                     if hasattr(self, 'firmware_version_update_time') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"firmware_version_update_time={(self.firmware_version_update_time
                     if hasattr(self, 'firmware_version_update_time') else None)!s})")
