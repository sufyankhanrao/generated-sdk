...
from verizon.models.device_firmware_version import (
...
class DeviceFirmwareList(object):
    ...
    def __init__(self,
        ...
        """Initialize a DeviceFirmwareList instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("deviceFirmwarVersionList") is not None:
            device_firmwar_version_list = [
                DeviceFirmwareVersion.from_dictionary(x)
                    for x in dictionary.get("deviceFirmwarVersionList")
            ]
        else:
            device_firmwar_version_list = APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"device_firmwar_version_list={(self.device_firmwar_version_list
                     if hasattr(self, 'device_firmwar_version_list') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"device_firmwar_version_list={(self.device_firmwar_version_list
                     if hasattr(self, 'device_firmwar_version_list') else None)!s})")
