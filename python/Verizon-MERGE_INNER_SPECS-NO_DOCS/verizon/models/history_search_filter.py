...
from verizon.models.history_search_filter_attributes import (
...
class HistorySearchFilter(object):
    ...
    def __init__(self,
        ...
        """Initialize a HistorySearchFilter instance."""
    ...
    def from_dictionary(cls,
        ...
        device = Device.from_dictionary(
            dictionary.get("device"))\
            if dictionary.get("device") else None
        attributes = HistorySearchFilterAttributes.from_dictionary(
