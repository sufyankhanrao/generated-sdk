...
class GPU(object):
    ...
    def from_dictionary(cls,
        ...
        min_core_clock_m_hz =\
            dictionary.get("minCoreClockMHz")\
            if dictionary.get("minCoreClockMHz") else APIHelper.SKIP
        min_memory_clock_m_hz =\
            dictionary.get("minMemoryClockMHz")\
            if dictionary.get("minMemoryClockMHz") else APIHelper.SKIP
        min_bandwidth_g_bs =\
            dictionary.get("minBandwidthGBs")\
            if dictionary.get("minBandwidthGBs") else APIHelper.SKIP
        min_tflops =\
            dictionary.get("minTFLOPS")\
            if dictionary.get("minTFLOPS") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"min_core_clock_m_hz={(self.min_core_clock_m_hz
                     if hasattr(self, 'min_core_clock_m_hz') else None)!r}, "
                f"min_memory_clock_m_hz={(self.min_memory_clock_m_hz
                     if hasattr(self, 'min_memory_clock_m_hz') else None)!r}, "
                f"min_bandwidth_g_bs={(self.min_bandwidth_g_bs
                     if hasattr(self, 'min_bandwidth_g_bs') else None)!r}, "
                f"min_tflops={(self.min_tflops
                     if hasattr(self, 'min_tflops') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"min_core_clock_m_hz={(self.min_core_clock_m_hz
                     if hasattr(self, 'min_core_clock_m_hz') else None)!s}, "
                f"min_memory_clock_m_hz={(self.min_memory_clock_m_hz
                     if hasattr(self, 'min_memory_clock_m_hz') else None)!s}, "
                f"min_bandwidth_g_bs={(self.min_bandwidth_g_bs
                     if hasattr(self, 'min_bandwidth_g_bs') else None)!s}, "
                f"min_tflops={(self.min_tflops
                     if hasattr(self, 'min_tflops') else None)!s})")
