...
class Location(object):
    ...
    def from_dictionary(cls,
        ...
        msid =\
            dictionary.get("msid")\
            if dictionary.get("msid") else APIHelper.SKIP
        pd = PositionData.from_dictionary(
            dictionary.get("pd"))\
            if "pd" in dictionary.keys() else APIHelper.SKIP
        error = PositionError.from_dictionary(
