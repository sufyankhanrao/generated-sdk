...
class Triggervalues2(object):
    ...
    def __init__(self,
        ...
        """Initialize a Triggervalues2 instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("promoAlerts") is not None:
            promo_alerts = [
                PromoAlert.from_dictionary(x)
                    for x in dictionary.get("promoAlerts")
            ]
        else:
            promo_alerts = APIHelper.SKIP
        active =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"promo_alerts={(self.promo_alerts
                     if hasattr(self, 'promo_alerts') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"promo_alerts={(self.promo_alerts
                     if hasattr(self, 'promo_alerts') else None)!s}, "
