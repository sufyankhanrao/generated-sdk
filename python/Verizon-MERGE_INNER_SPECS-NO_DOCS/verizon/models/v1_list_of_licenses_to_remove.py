...
class V1ListOfLicensesToRemove(object):
    ...
    def __init__(self,
        ...
        """Initialize a V1ListOfLicensesToRemove instance."""
        ...
        if update_time is not APIHelper.SKIP:
            self.update_time =\
                ...
                update_time, APIHelper.RFC3339DateTime) if update_time else None
    ...
    def from_dictionary(cls,
        ...
        update_time = APIHelper.RFC3339DateTime.from_value(
            dictionary.get("updateTime")).datetime\
