...
class MismatchedDevice(object):
    ...
    def __init__(self,
        ...
        """Initialize a MismatchedDevice instance."""
    ...
    def from_dictionary(cls,
        ...
        activation_date =\
            dictionary.get("activationDate")\
            if dictionary.get("activationDate") else APIHelper.SKIP
        iccid =\
            dictionary.get("iccid")\
            if dictionary.get("iccid") else APIHelper.SKIP
        pre_imei =\
            dictionary.get("preImei")\
            if dictionary.get("preImei") else APIHelper.SKIP
        post_imei =\
            dictionary.get("postImei")\
            if dictionary.get("postImei") else APIHelper.SKIP
        sim_ota_date =\
            dictionary.get("simOtaDate")\
            if dictionary.get("simOtaDate") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"pre_imei={(self.pre_imei
                     if hasattr(self, 'pre_imei') else None)!r}, "
                f"post_imei={(self.post_imei
                     if hasattr(self, 'post_imei') else None)!r}, "
                f"sim_ota_date={(self.sim_ota_date
                     if hasattr(self, 'sim_ota_date') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"pre_imei={(self.pre_imei
                     if hasattr(self, 'pre_imei') else None)!s}, "
                f"post_imei={(self.post_imei
                     if hasattr(self, 'post_imei') else None)!s}, "
                f"sim_ota_date={(self.sim_ota_date
                     if hasattr(self, 'sim_ota_date') else None)!s})")
