...
class MECPlatformResource(object):
    ...
    def __init__(self,
        ...
        """Initialize a MECPlatformResource instance."""
    ...
    def from_dictionary(cls,
        ...
        zone =\
            dictionary.get("zone")\
            if "zone" in dictionary.keys() else APIHelper.SKIP
        region =\
            dictionary.get("region")\
            if dictionary.get("region") else APIHelper.SKIP
        status =\
            dictionary.get("status")\
            if dictionary.get("status") else "unknown"
        properties =\
            dictionary.get("properties")\
            if dictionary.get("properties") else APIHelper.SKIP
