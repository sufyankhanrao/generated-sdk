...
class GetTriggerResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a GetTriggerResponse instance."""
        ...
        if modified_at is not APIHelper.SKIP:
            self.modified_at =\
                 APIHelper.apply_datetime_converter(
                modified_at, APIHelper.RFC3339DateTime) if modified_at else None
    ...
    def from_dictionary(cls,
        ...
        organization_name =\
            ...
            if dictionary.get("organizationName") else APIHelper.SKIP
        sms_type =\
            dictionary.get("smsType")\
            if dictionary.get("smsType") else APIHelper.SKIP
        threshold =\
        ...
        trigger_cycle =\
            dictionary.get("triggerCycle")\
            if dictionary.get("triggerCycle") else APIHelper.SKIP
        trigger_id =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"modified_at={(self.modified_at
                     if hasattr(self, 'modified_at') else None)!r}, "
                ...
                f"organization_name={(self.organization_name
                     if hasattr(self, 'organization_name') else None)!r}, "
                f"sms_type={(self.sms_type
                     if hasattr(self, 'sms_type') else None)!r}, "
                ...
                f"trigger_cycle={(self.trigger_cycle
                     if hasattr(self, 'trigger_cycle') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"modified_at={(self.modified_at
                     if hasattr(self, 'modified_at') else None)!s}, "
                f"notification_group_name={(self.notification_group_name
                     if hasattr(self, 'notification_group_name') else None)!s}, "
                f"organization_name={(self.organization_name
                     if hasattr(self, 'organization_name') else None)!s}, "
                f"sms_type={(self.sms_type
                     if hasattr(self, 'sms_type') else None)!s}, "
                f"threshold={(self.threshold
                ...
                f"trigger_cycle={(self.trigger_cycle
                     if hasattr(self, 'trigger_cycle') else None)!s}, "
                f"trigger_id={(self.trigger_id
