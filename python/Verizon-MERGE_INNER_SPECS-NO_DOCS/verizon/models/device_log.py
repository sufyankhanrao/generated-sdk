...
class DeviceLog(object):
    ...
    def __init__(self,
        ...
        """Initialize a DeviceLog instance."""
        # Initialize members of the class
        self.device_id = device_id
        self.log_time =\
             APIHelper.apply_datetime_converter(
            log_time, APIHelper.RFC3339DateTime) if log_time else None
    ...
    def from_dictionary(cls,
        ...
        log_time = APIHelper.RFC3339DateTime.from_value(
            dictionary.get("logTime")).datetime\
            if dictionary.get("logTime") else None
        log_type =\
            dictionary.get("logType")\
            if dictionary.get("logType") else None
        event_log =\
            dictionary.get("eventLog")\
            if dictionary.get("eventLog") else None
        binary_log_file_base_64 =\
            dictionary.get("binaryLogFileBase64")\
            if dictionary.get("binaryLogFileBase64") else None
        binary_log_filename =\
            dictionary.get("binaryLogFilename")\
            if dictionary.get("binaryLogFilename") else None
