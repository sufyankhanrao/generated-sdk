...
class SearchDeviceByPropertyFields(object):
    ...
    def from_dictionary(cls,
        ...
        acceleration = Acceleration.from_dictionary(
            dictionary.get("acceleration"))\
            if "acceleration" in dictionary.keys() else APIHelper.SKIP
        battery =\
            dictionary.get("battery")\
            if dictionary.get("battery") else APIHelper.SKIP
        humidity =\
            dictionary.get("humidity")\
            if dictionary.get("humidity") else APIHelper.SKIP
        light =\
            dictionary.get("light")\
            if dictionary.get("light") else APIHelper.SKIP
        pressure =\
            dictionary.get("pressure")\
            if dictionary.get("pressure") else APIHelper.SKIP
        signal_strength =\
            dictionary.get("signalStrength")\
            if dictionary.get("signalStrength") else APIHelper.SKIP
        temperature =\
            dictionary.get("temperature")\
            if dictionary.get("temperature") else APIHelper.SKIP
        device_propertylocation = DevicePropertylocation.from_dictionary(
            dictionary.get("DevicePropertylocation"))\
            if "DevicePropertylocation" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"acceleration={(self.acceleration
                     if hasattr(self, 'acceleration') else None)!r}, "
                f"battery={(self.battery
                     if hasattr(self, 'battery') else None)!r}, "
                f"humidity={(self.humidity
                     if hasattr(self, 'humidity') else None)!r}, "
                f"light={(self.light if hasattr(self, 'light') else None)!r}, "
                f"pressure={(self.pressure
                     if hasattr(self, 'pressure') else None)!r}, "
                f"signal_strength={(self.signal_strength
                     if hasattr(self, 'signal_strength') else None)!r}, "
                f"temperature={(self.temperature
                     if hasattr(self, 'temperature') else None)!r}, "
                f"device_propertylocation={(self.device_propertylocation
                     if hasattr(self, 'device_propertylocation') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"acceleration={(self.acceleration
                     if hasattr(self, 'acceleration') else None)!s}, "
                f"battery={(self.battery
                     if hasattr(self, 'battery') else None)!s}, "
                f"humidity={(self.humidity
                     if hasattr(self, 'humidity') else None)!s}, "
                f"light={(self.light if hasattr(self, 'light') else None)!s}, "
                f"pressure={(self.pressure
                     if hasattr(self, 'pressure') else None)!s}, "
                f"signal_strength={(self.signal_strength
                     if hasattr(self, 'signal_strength') else None)!s}, "
                f"temperature={(self.temperature
                     if hasattr(self, 'temperature') else None)!s}, "
                f"device_propertylocation={(self.device_propertylocation
                     if hasattr(self, 'device_propertylocation') else None)!s})")
