...
class LogInResult(object):
    ...
    def __init__(self,
        ...
        """Initialize a LogInResult instance."""
    ...
    def from_dictionary(cls,
        ...
        session_token =\
            dictionary.get("sessionToken")\
            if dictionary.get("sessionToken") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"session_token={(self.session_token
                     if hasattr(self, 'session_token') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"session_token={(self.session_token
                     if hasattr(self, 'session_token') else None)!s})")
