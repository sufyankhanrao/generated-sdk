...
class ComputeResourcesType(object):
    ...
    def __init__(self,
        ...
        """Initialize a ComputeResourcesType instance."""
    ...
    def from_dictionary(cls,
        ...
        gpu = GPU.from_dictionary(
            dictionary.get("GPU"))\
            if "GPU" in dictionary.keys() else APIHelper.SKIP
        min_ramgb =\
            dictionary.get("minRAMGB")\
            if dictionary.get("minRAMGB") else APIHelper.SKIP
        min_storage_gb =\
            dictionary.get("minStorageGB")\
            if dictionary.get("minStorageGB") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"min_ramgb={(self.min_ramgb
                     if hasattr(self, 'min_ramgb') else None)!r}, "
                f"min_storage_gb={(self.min_storage_gb
                     if hasattr(self, 'min_storage_gb') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"min_ramgb={(self.min_ramgb
                     if hasattr(self, 'min_ramgb') else None)!s}, "
                f"min_storage_gb={(self.min_storage_gb
                     if hasattr(self, 'min_storage_gb') else None)!s})")
