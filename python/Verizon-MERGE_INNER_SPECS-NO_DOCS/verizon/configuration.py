...
class Configuration(HttpClientConfiguration):
    ...
    def thingspace_oauth_credentials(self):
        """Return current thingspace_oauth_credentials."""
        return self._thingspace_oauth_credentials

    @property
    def vz_m2m_token_credentials(self):
        """Return current vz_m2m_token_credentials."""
    ...
    def clone_with(self, http_client_instance=None,
                   ...
                   retry_statuses=None, retry_methods=None, proxy_settings=None,
                   environment=None, thingspace_oauth_credentials=None,
                   vz_m2m_token_credentials=None):
        ...
        thingspace_oauth_credentials =\
            (thingspace_oauth_credentials
            or self.thingspace_oauth_credentials)
        vz_m2m_token_credentials =\
            (vz_m2m_token_credentials
            or self.vz_m2m_token_credentials)
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        from verizon.http.auth.vz_m2m_token import (
        ...
        default_config = cls(
            ...
            thingspace_oauth_credentials=ThingspaceOauthCredentials.from_environment(),
            vz_m2m_token_credentials=VZM2mTokenCredentials.from_environment(),
        )
