...
class DeviceMonitoringController(BaseController):
    ...
    def __init__(self, config):
        """Initialize DeviceMonitoringController object."""
        super(DeviceMonitoringController, self).__init__(config)

    def device_reachability(self,
                            body):
        """Perform a POST request to /m2m/v1/diagnostics/basic/devicereachability.
    ...
    def stop_device_reachability(self,
                                 body=None):
        """Perform a DELETE request to /m2m/v1/diagnostics/basic/devicereachability.
