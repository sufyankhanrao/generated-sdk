...
from verizon.models.callback_action_result import (
    CallbackActionResult,
)
from verizon.models.connectivity_management_callback import (
...
class ConnectivityCallbacksController(BaseController):
    ...
    def __init__(self, config):
        """Initialize ConnectivityCallbacksController object."""
        super(ConnectivityCallbacksController, self).__init__(config)

    def list_registered_callbacks(self,
                                  aname):
        """Perform a GET request to /m2m/v1/callbacks/{aname}.
    ...
    def register_callback(self,
                          aname,
                          body):
        """Perform a POST request to /m2m/v1/callbacks/{aname}.
    ...
    def deregister_callback(self,
                            aname,
                            sname):
        """Perform a DELETE request to /m2m/v1/callbacks/{aname}/name/{sname}.
