...
from verizon.models.callback_registration_result import (
    CallbackRegistrationResult,
)
from verizon.models.device_location_callback import (
...
class DeviceLocationCallbacksController(BaseController):
    ...
    def register_callback(self,
                          account,
                          body):
        """Perform a POST request to /callbacks/{account}.
    ...
    def deregister_callback(self,
                            account,
                            service):
        """Perform a DELETE request to /callbacks/{account}/name/{service}.
