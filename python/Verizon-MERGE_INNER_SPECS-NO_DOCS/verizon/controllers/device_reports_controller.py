...
from verizon.models.aggregate_session_report import (
    AggregateSessionReport,
)
from verizon.models.aggregated_report_callback_result import (
...
class DeviceReportsController(BaseController):
    ...
    def calculate_aggregated_report_asynchronous(self,
                                                 body):
        """Perform a POST request to /report/async/aggregate.
    ...
    def get_sessions_report(self,
                            body):
        """Perform a POST request to /report/sessions.
