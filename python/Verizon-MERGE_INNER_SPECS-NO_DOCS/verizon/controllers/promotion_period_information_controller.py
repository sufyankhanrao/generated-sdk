...
from verizon.models.response_to_usage_query import (
    ResponseToUsageQuery,
)
from verizon.models.usage_request_response import (
...
class PromotionPeriodInformationController(BaseController):
    ...
    def __init__(self, config):
        """Initialize PromotionPeriodInformationController object."""
        super(PromotionPeriodInformationController, self).__init__(config)

    def get_promo_device_usage_history(self,
                                       body):
        """Perform a POST request to /m2m/v1/devices/usage/actions/promodeviceusage.
