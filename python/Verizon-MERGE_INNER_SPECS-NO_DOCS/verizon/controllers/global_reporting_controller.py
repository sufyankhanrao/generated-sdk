...
from verizon.exceptions.esim_rest_error_response_exception import (
    ESIMRestErrorResponseException,
)
from verizon.http.http_method_enum import HttpMethodEnum
from verizon.models.esim_request_response import (
    ESIMRequestResponse,
)
from verizon.models.esim_status_response import (
    ESIMStatusResponse,
)
...
class GlobalReportingController(BaseController):
    ...
    def __init__(self, config):
        """Initialize GlobalReportingController object."""
        super(GlobalReportingController, self).__init__(config)

    def deviceprovhistory_using_post(self,
                                     body):
        """Perform a POST request to /m2m/v2/devices/history/actions/list.
