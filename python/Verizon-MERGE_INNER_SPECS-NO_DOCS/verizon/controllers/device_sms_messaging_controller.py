...
from verizon.models.sms_messages_response import (
    SmsMessagesResponse,
)
from verizon.models.success_response import (
    SuccessResponse,
)
...
class DeviceSMSMessagingController(BaseController):
    ...
    def __init__(self, config):
        """Initialize DeviceSMSMessagingController object."""
    ...
    def get_sms_messages(self,
                         account_name,
                         next=None):
        """Perform a GET request to /m2m/v1/sms/{accountName}/history.
    ...
    def start_sms_message_delivery(self,
                                   account_name):
        """Perform a PUT request to /m2m/v1/sms/{accountName}/startCallbacks.
    ...
    def list_sms_message_history(self,
                                 body):
        """Perform a POST request to /m2m/v1/devices/sms/history/actions/list.
