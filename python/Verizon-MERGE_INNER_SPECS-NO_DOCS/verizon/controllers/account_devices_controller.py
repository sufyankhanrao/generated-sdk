...
from verizon.models.device_list_result import (
    DeviceListResult,
)
from verizon.models.v3_account_device_list import (
    V3AccountDeviceList,
)
...
class AccountDevicesController(BaseController):
    ...
    def __init__(self, config):
        """Initialize AccountDevicesController object."""
    ...
    def get_account_device_information(self,
                                       ...
                                       protocol="LWM2M"):
        """Perform a GET request to /devices/{acc}.
    ...
    def list_account_devices_information(self,
                                         acc,
                                         body):
        """Perform a POST request to /devices/{acc}.
