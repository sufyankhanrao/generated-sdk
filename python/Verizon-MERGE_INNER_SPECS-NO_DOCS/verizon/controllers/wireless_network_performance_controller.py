...
class WirelessNetworkPerformanceController(BaseController):
    ...
    def __init__(self, config):
        """Initialize WirelessNetworkPerformanceController object."""
        super(WirelessNetworkPerformanceController, self).__init__(config)

    def near_real_time_network_conditions(self,
                                          body):
        """Perform a POST request to /m2m/v1/intelligence/network-conditions.
    ...
    def domestic_4_g_and_5g_nationwide_network_coverage(self,
                                                        body):
        """Perform a POST request to /m2m/v1/intelligence/wireless-coverage.
    ...
    def site_proximity(self,
                       body):
        """Perform a POST request to /m2m/v1/intelligence/site-proximity/action/list.
