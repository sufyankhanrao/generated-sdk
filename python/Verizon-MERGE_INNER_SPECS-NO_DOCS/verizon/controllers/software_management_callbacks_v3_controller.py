...
from verizon.models.fota_v3_callback_registration_result import (
    FotaV3CallbackRegistrationResult,
)
from verizon.models.fota_v3_callback_summary import (
...
class SoftwareManagementCallbacksV3Controller(BaseController):
    ...
    def update_callback(self,
                        acc,
                        body):
        """Perform a PUT request to /callbacks/{acc}.
    ...
    def register_callback(self,
                          acc,
                          body):
        """Perform a POST request to /callbacks/{acc}.
    ...
    def deregister_callback(self,
                            acc):
        """Perform a DELETE request to /callbacks/{acc}.
