...
from verizon.models.firmware_campaign import (
    FirmwareCampaign,
)
from verizon.models.fota_v3_success_result import (
    FotaV3SuccessResult,
)
from verizon.models.v3_add_or_remove_device_result import (
...
class CampaignsV3Controller(BaseController):
    ...
    def update_campaign_firmware_devices(self,
                                         ...
                                         campaign_id,
                                         body):
        """Perform a PUT request to /campaigns/firmware/{acc}/{campaignId}.
    ...
    def update_campaign_dates(self,
                              ...
                              campaign_id,
                              body):
        """Perform a PUT request to /campaigns/firmware/{acc}/{campaignId}/dates.
    ...
    def get_campaign_information(self,
                                 acc,
                                 campaign_id):
        """Perform a GET request to /campaigns/{acc}/{campaignId}.
    ...
    def cancel_campaign(self,
                        acc,
                        campaign_id):
        """Perform a DELETE request to /campaigns/{acc}/{campaignId}.
