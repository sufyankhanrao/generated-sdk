...
from verizon.models.firmware_upgrade_change_result import (
...
class FirmwareV1Controller(BaseController):
    ...
    def __init__(self, config):
        """Initialize FirmwareV1Controller object."""
        super(FirmwareV1Controller, self).__init__(config)

    def list_available_firmware(self,
                                account):
        """Perform a GET request to /firmware/{account}.
    ...
    def schedule_firmware_upgrade(self,
                                  body):
        """Perform a POST request to /upgrades.
    ...
    def list_firmware_upgrade_details(self,
                                      account,
                                      upgrade_id):
        """Perform a GET request to /upgrades/{account}/upgrade/{upgradeId}.
    ...
    def update_firmware_upgrade_devices(self,
                                        ...
                                        upgrade_id,
                                        body):
        """Perform a PUT request to /upgrades/{account}/upgrade/{upgradeId}.
    ...
    def cancel_scheduled_firmware_upgrade(self,
                                          account,
                                          upgrade_id):
        """Perform a DELETE request to /upgrades/{account}/upgrade/{upgradeId}.
