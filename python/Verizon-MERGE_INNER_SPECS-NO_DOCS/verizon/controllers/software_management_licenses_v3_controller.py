...
from verizon.models.v3_license_assigned_removed_result import (
    V3LicenseAssignedRemovedResult,
)
from verizon.models.v3_license_summary import (
    V3LicenseSummary,
)
...
class SoftwareManagementLicensesV3Controller(BaseController):
    ...
    def __init__(self, config):
        """Initialize SoftwareManagementLicensesV3Controller object."""
    ...
    def get_account_licenses_status(self,
        ...
        """Perform a GET request to /licenses/{acc}.
    ...
    def assign_licenses_to_devices(self,
                                   acc,
                                   body):
        """Perform a POST request to /licenses/{acc}/assign.
    ...
    def remove_licenses_from_devices(self,
                                     acc,
                                     body):
        """Perform a POST request to /licenses/{acc}/remove.
