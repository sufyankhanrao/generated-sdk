...
from verizon.models.fota_v2_success_result import (
    FotaV2SuccessResult,
)
from verizon.models.v2_license_summary import (
    V2LicenseSummary,
)
from verizon.models.v2_licenses_assigned_removed_result import (
    V2LicensesAssignedRemovedResult,
)
from verizon.models.v2_list_of_licenses_to_remove import (
    V2ListOfLicensesToRemove,
)
from verizon.models.v2_list_of_licenses_to_remove_result import (
...
class SoftwareManagementLicensesV2Controller(BaseController):
    ...
    def __init__(self, config):
        """Initialize SoftwareManagementLicensesV2Controller object."""
    ...
    def get_account_license_status(self,
        ...
        """Perform a GET request to /licenses/{account}.
    ...
    def assign_licenses_to_devices(self,
                                   account,
                                   body):
        """Perform a POST request to /licenses/{account}/assign.
    ...
    def remove_licenses_from_devices(self,
                                     account,
                                     body):
        """Perform a POST request to /licenses/{account}/remove.
    ...
    def list_licenses_to_remove(self,
                                account,
                                start_index=None):
        """Perform a GET request to /licenses/{account}/cancel.
    ...
    def create_list_of_licenses_to_remove(self,
                                          account,
                                          body):
        """Perform a POST request to /licenses/{account}/cancel.
    ...
    def delete_list_of_licenses_to_remove(self,
                                          account):
        """Perform a DELETE request to /licenses/{account}/cancel.
