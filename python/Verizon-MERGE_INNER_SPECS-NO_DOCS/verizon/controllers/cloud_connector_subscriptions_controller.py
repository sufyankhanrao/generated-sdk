...
class CloudConnectorSubscriptionsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize CloudConnectorSubscriptionsController object."""
    ...
    def query_subscription(self,
                           body):
        """Perform a POST request to /subscriptions/actions/query.
    ...
    def delete_subscription(self,
                            body):
        """Perform a POST request to /subscriptions/actions/delete.
