...
from verizon.models.account_license_info import (
    AccountLicenseInfo,
)
from verizon.models.v1_account_subscription import (
...
class SoftwareManagementSubscriptionsV1Controller(BaseController):
    ...
    def __init__(self, config):
        """Initialize SoftwareManagementSubscriptionsV1Controller object."""
    ...
    def get_account_license_status(self,
                                   account,
                                   start_index):
        """Perform a GET request to /licenses/{account}/index/{startIndex}.
