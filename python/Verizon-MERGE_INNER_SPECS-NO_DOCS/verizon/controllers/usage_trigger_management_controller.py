...
from verizon.models.usage_trigger_response import (
...
class UsageTriggerManagementController(BaseController):
    ...
    def __init__(self, config):
        """Initialize UsageTriggerManagementController object."""
        super(UsageTriggerManagementController, self).__init__(config)

    def create_new_trigger(self,
                           body=None):
        """Perform a POST request to /usage/triggers.
    ...
    def update_trigger(self,
                       trigger_id,
                       body=None):
        """Perform a POST request to /usage/triggers/{triggerId}.
