...
from verizon.models.callback_summary import (
    CallbackSummary,
)
from verizon.models.fota_v2_callback_registration_result import (
...
class SoftwareManagementCallbacksV2Controller(BaseController):
    ...
    def __init__(self, config):
        """Initialize SoftwareManagementCallbacksV2Controller object."""
    ...
    def update_callback(self,
                        account,
                        body):
        """Perform a PUT request to /callbacks/{account}.
    ...
    def deregister_callback(self,
                            account):
        """Perform a DELETE request to /callbacks/{account}.
