...
from verizon.models.device_software_upgrade import (
    DeviceSoftwareUpgrade,
)
from verizon.models.software_package import (
    SoftwarePackage,
)
from verizon.models.v2_account_device_list import (
    V2AccountDeviceList,
)
from verizon.models.v2_campaign_device import (
    V2CampaignDevice,
)
from verizon.models.v2_campaign_history import (
    V2CampaignHistory,
)
...
class SoftwareManagementReportsV2Controller(BaseController):
    ...
    def list_account_devices(self,
                             ...
                             distribution_type=None):
        """Perform a GET request to /devices/{account}.
    ...
    def get_campaign_history_by_status(self,
        ...
        """Perform a GET request to /reports/{account}/campaigns.
    ...
    def get_campaign_device_status(self,
                                   ...
                                   campaign_id,
                                   last_seen_device_id=None):
        """Perform a GET request to /reports/{account}/campaigns/{campaignId}/devices.
