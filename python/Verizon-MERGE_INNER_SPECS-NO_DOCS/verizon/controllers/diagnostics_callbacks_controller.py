...
from verizon.models.device_diagnostics_callback import (
...
class DiagnosticsCallbacksController(BaseController):
    ...
    def register_diagnostics_callback_url(self,
                                          body):
        """Perform a POST request to /callbacks.
    ...
    def unregister_diagnostics_callback(self,
                                        account_name,
                                        service_name):
        """Perform a DELETE request to /callbacks.
