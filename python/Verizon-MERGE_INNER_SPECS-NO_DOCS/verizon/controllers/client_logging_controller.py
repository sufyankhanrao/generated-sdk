...
from verizon.models.device_logging_status import (
    DeviceLoggingStatus,
)
...
class ClientLoggingController(BaseController):
    ...
    def enable_logging_for_devices(self,
                                   account,
                                   body):
        """Perform a PUT request to /logging/{account}/devices.
    ...
    def disable_logging_for_devices(self,
                                    account,
                                    device_ids):
        """Perform a DELETE request to /logging/{account}/devices.
    ...
    def enable_device_logging(self,
                              account,
                              device_id):
        """Perform a PUT request to /logging/{account}/devices/{deviceId}.
    ...
    def disable_device_logging(self,
                               account,
                               device_id):
        """Perform a DELETE request to /logging/{account}/devices/{deviceId}.
    ...
    def list_device_logs(self,
                         account,
                         device_id):
        """Perform a GET request to /logging/{account}/devices/{deviceId}/logs.
