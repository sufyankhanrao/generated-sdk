...
from verizon.models.security_subscription_result import (
...
class AccountSubscriptionsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize AccountSubscriptionsController object."""
        super(AccountSubscriptionsController, self).__init__(config)

    def list_account_subscriptions(self,
                                   body,
                                   x_request_id=None):
        """Perform a POST request to /v1/accounts/subscriptions/actions/list.
