...
from verizon.models.anomaly_trigger_result import (
    AnomalyTriggerResult,
)
from verizon.models.intelligence_success_result import (
...
class AnomalyTriggersV2Controller(BaseController):
    ...
    def update_anomaly_detection_trigger_v2(self,
                                            body):
        """Perform a PUT request to /m2m/v2/triggers.
