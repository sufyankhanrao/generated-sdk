...
from verizon.models.anomaly_detection_settings import (
...
class AnomalySettingsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize AnomalySettingsController object."""
        super(AnomalySettingsController, self).__init__(config)

    def activate_anomaly_detection(self,
                                   body):
        """Perform a POST request to /m2m/v1/intelligence/anomaly/settings.
