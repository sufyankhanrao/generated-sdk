...
from verizon.models.create_io_t_application_response import (
    CreateIoTApplicationResponse,
)
from verizon.models.generate_external_id_result import (
...
class TargetsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize TargetsController object."""
        super(TargetsController, self).__init__(config)

    def query_target(self,
                     body):
        """Perform a POST request to /targets/actions/query.
    ...
    def delete_target(self,
                      body):
        """Perform a POST request to /targets/actions/delete.
    ...
    def create_target(self,
                      body):
        """Perform a POST request to /targets.
    ...
    def generate_target_external_id(self,
                                    body):
        """Perform a POST request to /targets/actions/newextid.
    ...
    def create_azure_central_io_t_application(self,
                                              billingaccount_id,
                                              body):
        """Perform a POST request to /targets/actions/newaic.
