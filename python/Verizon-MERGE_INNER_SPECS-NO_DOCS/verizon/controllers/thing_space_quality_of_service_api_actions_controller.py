...
from verizon.exceptions.default_response_exception import (
...
class ThingSpaceQualityOfServiceAPIActionsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize ThingSpaceQualityOfServiceAPIActionsController object."""
    ...
    def create_a_thing_space_quality_of_service_api_subscription(self,
                                                                 body):
        """Perform a POST request to /m2m/v1/devices/actions/enhanceQoS.
    ...
    def stop_a_thing_space_quality_of_service_api_subscription(self,
                                                               account_name,
                                                               qos_subscription_id):
        """Perform a DELETE request to /m2m/v1/devices/actions/enhanceQoS.
