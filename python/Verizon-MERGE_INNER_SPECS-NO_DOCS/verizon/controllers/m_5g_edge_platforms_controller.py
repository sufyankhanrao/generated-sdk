...
from verizon.models.list_mec_platforms_result import (
    ListMECPlatformsResult,
)
from verizon.models.list_regions_result import (
    ListRegionsResult,
)
...
class M5gEdgePlatformsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize M5gEdgePlatformsController object."""
    ...
    def list_mec_platforms(self,
                           ...
                           ue_identity=None):
        """Perform a GET request to /mecplatforms.
    ...
    def list_regions(self):
        """Perform a GET request to /regions.
