...
from verizon.models.campaign_software import (
    CampaignSoftware,
)
from verizon.models.fota_v2_success_result import (
    FotaV2SuccessResult,
)
from verizon.models.upload_and_schedule_file_response import (
    UploadAndScheduleFileResponse,
)
from verizon.models.v2_add_or_remove_device_result import (
...
class CampaignsV2Controller(BaseController):
    ...
    def get_campaign_information(self,
                                 account,
                                 campaign_id):
        """Perform a GET request to /campaigns/{account}/{campaignId}.
    ...
    def update_campaign_firmware_devices(self,
                                         ...
                                         campaign_id,
                                         body):
        """Perform a PUT request to /campaigns/{account}/{campaignId}.
    ...
    def cancel_campaign(self,
                        account,
                        campaign_id):
        """Perform a DELETE request to /campaigns/{account}/{campaignId}.
    ...
    def update_campaign_dates(self,
                              ...
                              campaign_id,
                              body):
        """Perform a PUT request to /campaigns/{account}/{campaignId}/dates.
    ...
    def schedule_file_upgrade(self,
                              acc,
                              body):
        """Perform a POST request to /campaigns/files/{acc}.
    ...
    def schedule_sw_upgrade_http_devices(self,
                                         acc,
                                         body):
        """Perform a POST request to /campaigns/software/{acc}.
