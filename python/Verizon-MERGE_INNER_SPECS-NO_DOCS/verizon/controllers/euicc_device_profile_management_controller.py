...
class EUICCDeviceProfileManagementController(BaseController):
    ...
    def __init__(self, config):
        """Initialize EUICCDeviceProfileManagementController object."""
    ...
    def download_local_profile_to_disable(self,
                                          body):
        """Perform a POST request to /m2m/v1/devices/profile/actions/download_disable.
    ...
    def disable_local_profile(self,
                              body):
        """Perform a POST request to /m2m/v1/devices/profile/actions/disable.
