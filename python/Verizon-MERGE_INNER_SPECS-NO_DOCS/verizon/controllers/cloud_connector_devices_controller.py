...
from verizon.models.change_configuration_response import (
    ChangeConfigurationResponse,
)
from verizon.models.find_device_by_property_response_list import (
    FindDeviceByPropertyResponseList,
)
from verizon.models.search_device_by_property_response_list import (
    SearchDeviceByPropertyResponseList,
)
from verizon.models.search_device_event_history_response_list import (
    SearchDeviceEventHistoryResponseList,
)
from verizon.models.search_sensor_history_response_list import (
...
class CloudConnectorDevicesController(BaseController):
    ...
    def __init__(self, config):
        """Initialize CloudConnectorDevicesController object."""
        super(CloudConnectorDevicesController, self).__init__(config)

    def update_devices_configuration_value(self,
                                           body):
        """Perform a POST request to /devices/configuration/actions/set.
    ...
    def find_device_by_property_values(self,
                                       body):
        """Perform a POST request to /devices/actions/query.
    ...
    def search_devices_resources_by_property_values(self,
                                                    body):
        """Perform a POST request to /devices/actions/search.
    ...
    def search_device_event_history(self,
                                    body):
        """Perform a POST request to /devices/fields/actions/history/search.
    ...
    def search_sensor_readings(self,
                               fieldname,
                               body):
        """Perform a POST request to /devices/fields/{fieldname}/actions/history.
    ...
    def delete_device_from_account(self,
                                   body):
        """Perform a POST request to /devices/actions/delete.
