...
from verizon.models.session_reset_password_result import (
...
class SessionManagementController(BaseController):
    ...
    def end_connectivity_management_session(self):
        """Perform a POST request to /m2m/v1/session/logout.
    ...
    def reset_connectivity_management_password(self,
                                               body):
        """Perform a PUT request to /m2m/v1/session/password/actions/reset.
