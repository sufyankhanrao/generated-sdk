...
from verizon.models.bullseye_service_result import (
...
class DeviceServiceManagementController(BaseController):
    ...
    def update_device_hyper_precise_status(self,
                                           body):
        """Perform a PUT request to /devices/services.
