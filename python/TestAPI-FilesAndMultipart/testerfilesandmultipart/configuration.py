...
from testerfilesandmultipart.http.proxy_settings import (
    ProxySettings,
)
...
class Configuration(HttpClientConfiguration):
    ...
    def __init__(self, http_client_instance=None,
                 ...
                 environment=Environment.PRODUCTION, port="80"):
    ...
    environments = {
        Environment.PRODUCTION: {
            Server.DEFAULT: "http://apimatic.hopto.org:{port}",
