...
from pipeseperatedarrayserialization.models.complex_type import (
    ComplexType,
)
...
class PipeSeperatedControllerTests(ControllerTestBase):
    ...
    def test_pipe_seperated_array_serialization_in_query(self):
        ...
        result = self.controller.get_pipe_seperated_in_query(
            dependent,
        )
        # Test response code
    ...
    def test_pipe_seperated_array_serialization_in_query_1(self):
        """
        Api call test for `test_pipe_seperated_array_serialization_in_query_1`.
        """
        # Parameters for the API call
        dependent = APIHelper.json_deserialize(
            "[\"ab\",\"bc\",\"cd\",\"ef\"]",
        ...
        # Perform the API call through the SDK function
        result = self.controller.get_pipe_seperated_in_query_1(
            dependent,
        )
        # Test response code
        assert self.response_catcher.response.status_code == 200
    ...
    def test_pipe_seperated_array_serialization_in_query_2(self):
        """
        Api call test for `test_pipe_seperated_array_serialization_in_query_2`.
        """
        # Parameters for the API call
        dependent = APIHelper.json_deserialize(
            "[\"ab\",\"bc\\tbc\",\"cd\",\"ef\"]",
    ...
    def test_send_pipe_separated_complex_type_in_query(self):
        """
        Api call test for `test_send_pipe_separated_complex_type_in_query`.
        """
        # Parameters for the API call
        ...
        # Perform the API call through the SDK function
        result = self.controller.create_send_pipe_separated_complex_type_in_query(
            complex_type,
        )
        # Test response code
        assert self.response_catcher.response.status_code == 200
    ...
    def test_send_pipe_separated_list_of_complex_type_in_query(self):
        """
        Api call test for `test_send_pipe_separated_list_of_complex_type_in_query`.
        """
        # Parameters for the API call
        complex_type = APIHelper.json_deserialize(
            "[{\"numberListType\":[555,666,777],\"numberMapType\":{\"num1\":1,"
        ...
        # Perform the API call through the SDK function
        result = self.controller.create_send_pipe_separated_list_of_complex_type_in_query( # noqa: E501
            complex_type,
        )
        # Test response code
        assert self.response_catcher.response.status_code == 200
    ...
    def test_send_pipe_separated_map_of_complex_type_in_query(self):
        """
        Api call test for `test_send_pipe_separated_map_of_complex_type_in_query`.
        """
        # Parameters for the API call
        complex_type = APIHelper.json_deserialize(
        ...
        # Perform the API call through the SDK function
        result = self.controller.create_send_pipe_separated_map_of_complex_type_in_query( # noqa: E501
            complex_type,
        )
        # Test response code
        assert self.response_catcher.response.status_code == 200
