...
from advancedbilling.models.create_or_update_flat_amount_coupon import (
    CreateOrUpdateFlatAmountCoupon,
)
from advancedbilling.models.create_or_update_percentage_coupon import (
...
from advancedbilling.models.subscription_group_signup_failure import (
    SubscriptionGroupSignupFailure,
)
from advancedbilling.models.subscription_group_signup_success import (
...
class UnionTypeLookUp:
    ...
    _templates: ClassVar[dict[str, Callable]] = {
        ...
        "AddSubscriptionToAGroupGroup": lambda: OneOf(
            [
        ...
        "CreateOrUpdateCouponCoupon": lambda: OneOf(
            [
        ...
        "CreateOrUpdatePercentageCouponPercentage": lambda: OneOf(
            [
                LeafType(str),
                LeafType(float),
            ],
        ...
        "PaymentProfileResponsePaymentProfile": lambda: OneOf(
            [
