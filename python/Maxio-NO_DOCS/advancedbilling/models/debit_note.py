...
class DebitNote(object):
    ...
    def from_dictionary(cls,
        ...
        origin_credit_note_uid =\
            ...
            if dictionary.get("origin_credit_note_uid") else APIHelper.SKIP
        origin_credit_note_number =\
            dictionary.get("origin_credit_note_number")\
            if dictionary.get("origin_credit_note_number") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"origin_credit_note_uid={(self.origin_credit_note_uid
                     if hasattr(self, 'origin_credit_note_uid') else None)!r}, "
                f"origin_credit_note_number={(self.origin_credit_note_number
                     if hasattr(self, 'origin_credit_note_number') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"origin_credit_note_uid={(self.origin_credit_note_uid
                     if hasattr(self, 'origin_credit_note_uid') else None)!s}, "
                f"origin_credit_note_number={(self.origin_credit_note_number
                     if hasattr(self, 'origin_credit_note_number') else None)!s}, "
                f"issue_date={(self.issue_date
