...
class CouponUsage(object):
    ...
    def from_dictionary(cls,
        ...
        signups =\
            ...
            if dictionary.get("signups") else APIHelper.SKIP
        savings =\
            dictionary.get("savings")\
            if "savings" in dictionary.keys() else APIHelper.SKIP
        savings_in_cents =\
            dictionary.get("savings_in_cents")\
            if "savings_in_cents" in dictionary.keys() else APIHelper.SKIP
        revenue =\
            dictionary.get("revenue")\
            if "revenue" in dictionary.keys() else APIHelper.SKIP
        revenue_in_cents =\
            dictionary.get("revenue_in_cents")\
            if dictionary.get("revenue_in_cents") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"signups={(self.signups
                     if hasattr(self, 'signups') else None)!r}, "
                f"savings={(self.savings
                     if hasattr(self, 'savings') else None)!r}, "
                f"savings_in_cents={(self.savings_in_cents
                     if hasattr(self, 'savings_in_cents') else None)!r}, "
                f"revenue={(self.revenue
                     if hasattr(self, 'revenue') else None)!r}, "
                f"revenue_in_cents={(self.revenue_in_cents
                     if hasattr(self, 'revenue_in_cents') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"signups={(self.signups
                     if hasattr(self, 'signups') else None)!s}, "
                f"savings={(self.savings
                     if hasattr(self, 'savings') else None)!s}, "
                f"savings_in_cents={(self.savings_in_cents
                     if hasattr(self, 'savings_in_cents') else None)!s}, "
                f"revenue={(self.revenue
                     if hasattr(self, 'revenue') else None)!s}, "
                f"revenue_in_cents={(self.revenue_in_cents
                     if hasattr(self, 'revenue_in_cents') else None)!s}, "
