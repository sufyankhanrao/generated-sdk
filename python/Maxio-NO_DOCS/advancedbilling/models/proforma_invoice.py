...
class ProformaInvoice(object):
    ...
    def from_dictionary(cls,
        ...
        number =\
            ...
            if "number" in dictionary.keys() else APIHelper.SKIP
        sequence_number =\
            dictionary.get("sequence_number")\
            if "sequence_number" in dictionary.keys() else APIHelper.SKIP
        ...
        delivery_date = dateutil.parser.parse(dictionary.get("delivery_date")).date()\
        ...
        public_url =\
            ...
            if "public_url" in dictionary.keys() else APIHelper.SKIP
