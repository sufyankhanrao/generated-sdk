...
class CreditAccountBalanceChanged(object):
    ...
    def from_dictionary(cls,
        ...
        service_credit_account_balance_in_cents =\
            ...
            if dictionary.get("service_credit_account_balance_in_cents") else None
        service_credit_balance_change_in_cents =\
            dictionary.get("service_credit_balance_change_in_cents")\
            if dictionary.get("service_credit_balance_change_in_cents") else None
        currency_code =\
            dictionary.get("currency_code")\
            if dictionary.get("currency_code") else None
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"service_credit_account_balance_in_cents={
                    self.service_credit_account_balance_in_cents!r}, "
                f"service_credit_balance_change_in_cents={
                    self.service_credit_balance_change_in_cents!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"service_credit_account_balance_in_cents={
                    self.service_credit_account_balance_in_cents!s}, "
                f"service_credit_balance_change_in_cents={
                    self.service_credit_balance_change_in_cents!s}, "
