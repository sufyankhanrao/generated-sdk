...
class CustomFieldValueChange(object):
    ...
    def from_dictionary(cls,
        ...
        event_type =\
            ...
            if dictionary.get("event_type") else None
        metafield_name =\
            dictionary.get("metafield_name")\
            if dictionary.get("metafield_name") else None
        metafield_id =\
            dictionary.get("metafield_id")\
            if dictionary.get("metafield_id") else None
        old_value =\
            dictionary.get("old_value")\
            if dictionary.get("old_value") else None
        new_value =\
            dictionary.get("new_value")\
            if dictionary.get("new_value") else None
        resource_type =\
            dictionary.get("resource_type")\
            if dictionary.get("resource_type") else None
        resource_id =\
            dictionary.get("resource_id")\
            if dictionary.get("resource_id") else None
