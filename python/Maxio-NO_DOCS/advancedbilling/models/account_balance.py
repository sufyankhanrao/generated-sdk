...
class AccountBalance(object):
    ...
    def from_dictionary(cls,
        ...
        automatic_balance_in_cents =\
            ...
            if "automatic_balance_in_cents" in dictionary.keys() else APIHelper.SKIP
        remittance_balance_in_cents =\
            dictionary.get("remittance_balance_in_cents")\
            if "remittance_balance_in_cents" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"automatic_balance_in_cents={(self.automatic_balance_in_cents
                     if hasattr(self, 'automatic_balance_in_cents') else None)!r}, "
                f"remittance_balance_in_cents={(self.remittance_balance_in_cents
                     if hasattr(self, 'remittance_balance_in_cents') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"automatic_balance_in_cents={(self.automatic_balance_in_cents
                     if hasattr(self, 'automatic_balance_in_cents') else None)!s}, "
                f"remittance_balance_in_cents={(self.remittance_balance_in_cents
                     if hasattr(self, 'remittance_balance_in_cents') else None)!s}, "
