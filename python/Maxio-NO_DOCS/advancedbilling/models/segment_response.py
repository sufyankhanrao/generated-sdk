...
class SegmentResponse(object):
    ...
    def from_dictionary(cls,
        ...
        segment = Segment.from_dictionary(
            dictionary.get("segment"))\
            if "segment" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"segment={(self.segment
                     if hasattr(self, 'segment') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"segment={(self.segment
                     if hasattr(self, 'segment') else None)!s}, "
