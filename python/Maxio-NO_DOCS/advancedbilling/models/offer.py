...
class Offer(object):
    ...
    def from_dictionary(cls,
        ...
        product_revisable_number =\
            ...
            if dictionary.get("product_revisable_number") else APIHelper.SKIP
        name =\
            dictionary.get("name")\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"product_revisable_number={(self.product_revisable_number
                     if hasattr(self, 'product_revisable_number') else None)!r}, "
                ...
                f"offer_items={(self.offer_items
                     if hasattr(self, 'offer_items') else None)!r}, "
                f"offer_discounts={(self.offer_discounts
                     if hasattr(self, 'offer_discounts') else None)!r}, "
                ...
                f"offer_signup_pages={(self.offer_signup_pages
                     if hasattr(self, 'offer_signup_pages') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"product_revisable_number={(self.product_revisable_number
                     if hasattr(self, 'product_revisable_number') else None)!s}, "
                ...
                f"offer_items={(self.offer_items
                     if hasattr(self, 'offer_items') else None)!s}, "
                f"offer_discounts={(self.offer_discounts
                     if hasattr(self, 'offer_discounts') else None)!s}, "
                f"product_family_name={(self.product_family_name
                ...
                f"offer_signup_pages={(self.offer_signup_pages
                     if hasattr(self, 'offer_signup_pages') else None)!s}, "
