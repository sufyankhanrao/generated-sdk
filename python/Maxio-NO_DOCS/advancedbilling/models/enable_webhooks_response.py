...
class EnableWebhooksResponse(object):
    ...
    def from_dictionary(cls,
        ...
        webhooks_enabled =\
            ...
            if "webhooks_enabled" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"webhooks_enabled={(self.webhooks_enabled
                     if hasattr(self, 'webhooks_enabled') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"webhooks_enabled={(self.webhooks_enabled
                     if hasattr(self, 'webhooks_enabled') else None)!s}, "
