...
class SubscriptionGroupSubscriptionError(object):
    ...
    def from_dictionary(cls,
        ...
        payment_profile =\
            ...
            if dictionary.get("payment_profile") else APIHelper.SKIP
        payment_profile_chargify_token =\
            dictionary.get("payment_profile.chargify_token")\
            if dictionary.get("payment_profile.chargify_token") else APIHelper.SKIP
        base =\
            dictionary.get("base")\
            if dictionary.get("base") else APIHelper.SKIP
        payment_profile_expiration_month =\
            dictionary.get("payment_profile.expiration_month")\
            if dictionary.get("payment_profile.expiration_month") else APIHelper.SKIP
        payment_profile_expiration_year =\
            dictionary.get("payment_profile.expiration_year")\
            if dictionary.get("payment_profile.expiration_year") else APIHelper.SKIP
        payment_profile_full_number =\
            dictionary.get("payment_profile.full_number")\
            if dictionary.get("payment_profile.full_number") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"payment_profile={(self.payment_profile
                     if hasattr(self, 'payment_profile') else None)!r}, "
                f"payment_profile_chargify_token={(self.payment_profile_chargify_token
                     if hasattr(self, 'payment_profile_chargify_token') else None)!r}, "
                f"base={(self.base if hasattr(self, 'base') else None)!r}, "
                f"payment_profile_expiration_month={(self.payment_profile_expiration_month
                     if hasattr(self, 'payment_profile_expiration_month') else None)!r}, "
                f"payment_profile_expiration_year={(self.payment_profile_expiration_year
                     if hasattr(self, 'payment_profile_expiration_year') else None)!r}, "
                f"payment_profile_full_number={(self.payment_profile_full_number
                     if hasattr(self, 'payment_profile_full_number') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"payment_profile={(self.payment_profile
                     if hasattr(self, 'payment_profile') else None)!s}, "
                f"payment_profile_chargify_token={(self.payment_profile_chargify_token
                     if hasattr(self, 'payment_profile_chargify_token') else None)!s}, "
                f"base={(self.base if hasattr(self, 'base') else None)!s}, "
                f"payment_profile_expiration_month={(self.payment_profile_expiration_month
                     if hasattr(self, 'payment_profile_expiration_month') else None)!s}, "
                f"payment_profile_expiration_year={(self.payment_profile_expiration_year
                     if hasattr(self, 'payment_profile_expiration_year') else None)!s}, "
                f"payment_profile_full_number={(self.payment_profile_full_number
                     if hasattr(self, 'payment_profile_full_number') else None)!s}, "
