...
class RenewalPreview(object):
    ...
    def from_dictionary(cls,
        ...
        total_amount_due_in_cents =\
            ...
            if dictionary.get("total_amount_due_in_cents") else APIHelper.SKIP
        uncalculated_taxes =\
            dictionary.get("uncalculated_taxes")\
            if "uncalculated_taxes" in dictionary.keys() else APIHelper.SKIP
        line_items = None
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"total_amount_due_in_cents={(self.total_amount_due_in_cents
                     if hasattr(self, 'total_amount_due_in_cents') else None)!r}, "
                f"uncalculated_taxes={(self.uncalculated_taxes
                     if hasattr(self, 'uncalculated_taxes') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"total_amount_due_in_cents={(self.total_amount_due_in_cents
                     if hasattr(self, 'total_amount_due_in_cents') else None)!s}, "
                f"uncalculated_taxes={(self.uncalculated_taxes
                     if hasattr(self, 'uncalculated_taxes') else None)!s}, "
                f"line_items={(self.line_items
