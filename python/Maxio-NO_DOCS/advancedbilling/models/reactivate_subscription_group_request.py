...
class ReactivateSubscriptionGroupRequest(object):
    ...
    def from_dictionary(cls,
        ...
        resume =\
            ...
            if "resume" in dictionary.keys() else APIHelper.SKIP
        resume_members =\
            dictionary.get("resume_members")\
            if "resume_members" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"resume_members={(self.resume_members
                     if hasattr(self, 'resume_members') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"resume_members={(self.resume_members
                     if hasattr(self, 'resume_members') else None)!s}, "
