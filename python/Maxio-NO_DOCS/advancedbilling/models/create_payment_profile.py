...
class CreatePaymentProfile(object):
    ...
    def from_dictionary(cls,
        ...
        chargify_token =\
            ...
            if dictionary.get("chargify_token") else APIHelper.SKIP
        ...
        masked_card_number =\
            ...
            if dictionary.get("masked_card_number") else APIHelper.SKIP
        full_number =\
        ...
        customer_vault_token =\
            ...
            if dictionary.get("customer_vault_token") else APIHelper.SKIP
        customer_id =\
            dictionary.get("customer_id")\
            if dictionary.get("customer_id") else APIHelper.SKIP
        paypal_email =\
            dictionary.get("paypal_email")\
            if dictionary.get("paypal_email") else APIHelper.SKIP
        payment_method_nonce =\
            dictionary.get("payment_method_nonce")\
            if dictionary.get("payment_method_nonce") else APIHelper.SKIP
        gateway_handle =\
            dictionary.get("gateway_handle")\
            if dictionary.get("gateway_handle") else APIHelper.SKIP
        ...
        bank_iban =\
            ...
            if dictionary.get("bank_iban") else APIHelper.SKIP
        bank_routing_number =\
            dictionary.get("bank_routing_number")\
            if dictionary.get("bank_routing_number") else APIHelper.SKIP
        bank_account_number =\
            dictionary.get("bank_account_number")\
            if dictionary.get("bank_account_number") else APIHelper.SKIP
        bank_branch_code =\
            dictionary.get("bank_branch_code")\
            if dictionary.get("bank_branch_code") else APIHelper.SKIP
        bank_account_type =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"chargify_token={(self.chargify_token
                     if hasattr(self, 'chargify_token') else None)!r}, "
                ...
                f"masked_card_number={(self.masked_card_number
                     if hasattr(self, 'masked_card_number') else None)!r}, "
                ...
                f"paypal_email={(self.paypal_email
                     if hasattr(self, 'paypal_email') else None)!r}, "
                f"payment_method_nonce={(self.payment_method_nonce
                     if hasattr(self, 'payment_method_nonce') else None)!r}, "
                ...
                f"bank_iban={(self.bank_iban
                     if hasattr(self, 'bank_iban') else None)!r}, "
                f"bank_routing_number={(self.bank_routing_number
                     if hasattr(self, 'bank_routing_number') else None)!r}, "
                f"bank_account_number={(self.bank_account_number
                     if hasattr(self, 'bank_account_number') else None)!r}, "
                f"bank_branch_code={(self.bank_branch_code
                     if hasattr(self, 'bank_branch_code') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"chargify_token={(self.chargify_token
                     if hasattr(self, 'chargify_token') else None)!s}, "
                ...
                f"masked_card_number={(self.masked_card_number
                     if hasattr(self, 'masked_card_number') else None)!s}, "
                f"full_number={(self.full_number
                ...
                f"paypal_email={(self.paypal_email
                     if hasattr(self, 'paypal_email') else None)!s}, "
                f"payment_method_nonce={(self.payment_method_nonce
                     if hasattr(self, 'payment_method_nonce') else None)!s}, "
                f"gateway_handle={(self.gateway_handle
                ...
                f"bank_iban={(self.bank_iban
                     if hasattr(self, 'bank_iban') else None)!s}, "
                f"bank_routing_number={(self.bank_routing_number
                     if hasattr(self, 'bank_routing_number') else None)!s}, "
                f"bank_account_number={(self.bank_account_number
                     if hasattr(self, 'bank_account_number') else None)!s}, "
                f"bank_branch_code={(self.bank_branch_code
                     if hasattr(self, 'bank_branch_code') else None)!s}, "
                f"bank_account_type={(self.bank_account_type
