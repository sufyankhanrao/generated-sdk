...
class SubscriptionGroupSignupSuccessData(object):
    ...
    def __init__(self,
        ...
        """Initialize a SubscriptionGroupSignupSuccessData instance."""
    ...
    def from_dictionary(cls,
        ...
        customer_id =\
            ...
            if dictionary.get("customer_id") else None
        payment_profile_id =\
            dictionary.get("payment_profile_id")\
            if dictionary.get("payment_profile_id") else None
        subscription_ids =\
            dictionary.get("subscription_ids")\
            if dictionary.get("subscription_ids") else None
        primary_subscription_id =\
            dictionary.get("primary_subscription_id")\
            if dictionary.get("primary_subscription_id") else None
        ...
        cancel_at_end_of_period =\
            ...
            if "cancel_at_end_of_period" in dictionary.keys() else None
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(
                ...
                value=dictionary.scheme,
                type_callable=lambda value: isinstance(value, int)) \
                and APIHelper.is_valid_type(
                value=dictionary.customer_id,
                type_callable=lambda value: isinstance(value, int)) \
                and APIHelper.is_valid_type(
                value=dictionary.payment_profile_id,
                type_callable=lambda value: isinstance(value, int)) \
                and APIHelper.is_valid_type(
                value=dictionary.subscription_ids,
                type_callable=lambda value: isinstance(value, int)) \
                and APIHelper.is_valid_type(
                value=dictionary.primary_subscription_id,
                type_callable=lambda value: isinstance(value, int)) \
                and APIHelper.is_valid_type(
                value=dictionary.next_assessment_at,
                type_callable=lambda value: isinstance(value, APIHelper.RFC3339DateTime)) \
                and APIHelper.is_valid_type(
                value=dictionary.state,
                type_callable=lambda value: isinstance(value, str)) \
                and APIHelper.is_valid_type(
                value=dictionary.cancel_at_end_of_period,
        ...
        return APIHelper.is_valid_type(
            ...
            type_callable=lambda value: isinstance(value, str)) \
            and APIHelper.is_valid_type(
            value=dictionary.get("scheme"),
            type_callable=lambda value: isinstance(value, int)) \
            and APIHelper.is_valid_type(
            value=dictionary.get("customer_id"),
            type_callable=lambda value: isinstance(value, int)) \
            and APIHelper.is_valid_type(
            value=dictionary.get("payment_profile_id"),
            type_callable=lambda value: isinstance(value, int)) \
            and APIHelper.is_valid_type(
            value=dictionary.get("subscription_ids"),
            type_callable=lambda value: isinstance(value, int)) \
            and APIHelper.is_valid_type(
            value=dictionary.get("primary_subscription_id"),
            type_callable=lambda value: isinstance(value, int)) \
            and APIHelper.is_valid_type(
            value=dictionary.get("next_assessment_at"),
            type_callable=lambda value: isinstance(value, str)) \
            and APIHelper.is_valid_type(
            value=dictionary.get("state"),
            type_callable=lambda value: isinstance(value, str)) \
            and APIHelper.is_valid_type(
            value=dictionary.get("cancel_at_end_of_period"),
            type_callable=lambda value: isinstance(value, bool))
