...
class EBBComponent(object):
    ...
    def from_dictionary(cls,
        ...
        event_based_billing_metric_id =\
            ...
            if dictionary.get("event_based_billing_metric_id") else None
        description =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"event_based_billing_metric_id={
                    self.event_based_billing_metric_id!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"event_based_billing_metric_id={
                    self.event_based_billing_metric_id!s}, "
                f"interval={(self.interval
