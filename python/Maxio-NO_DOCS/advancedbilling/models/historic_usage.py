...
class HistoricUsage(object):
    ...
    def __init__(self,
        ...
        if billing_period_starts_at is not APIHelper.SKIP:
            self.billing_period_starts_at =\
                ...
                billing_period_starts_at, APIHelper.RFC3339DateTime) if billing_period_starts_at else None
        if billing_period_ends_at is not APIHelper.SKIP:
            self.billing_period_ends_at =\
                 APIHelper.apply_datetime_converter(
                billing_period_ends_at, APIHelper.RFC3339DateTime) if billing_period_ends_at else None
    ...
    def from_dictionary(cls,
        ...
        total_usage_quantity =\
            ...
            if dictionary.get("total_usage_quantity") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"total_usage_quantity={(self.total_usage_quantity
                     if hasattr(self, 'total_usage_quantity') else None)!r}, "
                f"billing_period_starts_at={(self.billing_period_starts_at
                     if hasattr(self, 'billing_period_starts_at') else None)!r}, "
                f"billing_period_ends_at={(self.billing_period_ends_at
                     if hasattr(self, 'billing_period_ends_at') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"total_usage_quantity={(self.total_usage_quantity
                     if hasattr(self, 'total_usage_quantity') else None)!s}, "
                f"billing_period_starts_at={(self.billing_period_starts_at
                     if hasattr(self, 'billing_period_starts_at') else None)!s}, "
                f"billing_period_ends_at={(self.billing_period_ends_at
                     if hasattr(self, 'billing_period_ends_at') else None)!s}, "
