...
class InvoiceCredit(object):
    ...
    def from_dictionary(cls,
        ...
        credit_note_number =\
            ...
            if dictionary.get("credit_note_number") else APIHelper.SKIP
        credit_note_uid =\
            dictionary.get("credit_note_uid")\
            if dictionary.get("credit_note_uid") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"credit_note_number={(self.credit_note_number
                     if hasattr(self, 'credit_note_number') else None)!r}, "
                f"credit_note_uid={(self.credit_note_uid
                     if hasattr(self, 'credit_note_uid') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"credit_note_number={(self.credit_note_number
                     if hasattr(self, 'credit_note_number') else None)!s}, "
                f"credit_note_uid={(self.credit_note_uid
                     if hasattr(self, 'credit_note_uid') else None)!s}, "
                f"transaction_time={(self.transaction_time
