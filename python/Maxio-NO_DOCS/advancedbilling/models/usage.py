...
class Usage(object):
    ...
    def from_dictionary(cls,
        ...
        overage_quantity =\
            ...
            if dictionary.get("overage_quantity") else APIHelper.SKIP
        component_id =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"overage_quantity={(self.overage_quantity
                     if hasattr(self, 'overage_quantity') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"overage_quantity={(self.overage_quantity
                     if hasattr(self, 'overage_quantity') else None)!s}, "
                f"component_id={(self.component_id
