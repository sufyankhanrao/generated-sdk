...
class CreateInvoice(object):
    ...
    def from_dictionary(cls,
        ...
        seller_address = CreateInvoiceAddress.from_dictionary(
            dictionary.get("seller_address"))\
            if "seller_address" in dictionary.keys() else APIHelper.SKIP
        billing_address = CreateInvoiceAddress.from_dictionary(
            dictionary.get("billing_address"))\
            if "billing_address" in dictionary.keys() else APIHelper.SKIP
        shipping_address = CreateInvoiceAddress.from_dictionary(
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"seller_address={(self.seller_address
                     if hasattr(self, 'seller_address') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"seller_address={(self.seller_address
                     if hasattr(self, 'seller_address') else None)!s}, "
                f"billing_address={(self.billing_address
