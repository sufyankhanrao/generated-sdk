...
class Endpoint(object):
    ...
    def from_dictionary(cls,
        ...
        webhook_subscriptions =\
            ...
            if dictionary.get("webhook_subscriptions") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"webhook_subscriptions={(self.webhook_subscriptions
                     if hasattr(self, 'webhook_subscriptions') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"webhook_subscriptions={(self.webhook_subscriptions
                     if hasattr(self, 'webhook_subscriptions') else None)!s}, "
