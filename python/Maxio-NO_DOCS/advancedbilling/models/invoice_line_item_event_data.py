...
class InvoiceLineItemEventData(object):
    ...
    def from_dictionary(cls,
        ...
        quantity_delta =\
            ...
            if "quantity_delta" in dictionary.keys() else APIHelper.SKIP
        unit_price =\
        ...
        line_references =\
            ...
            if dictionary.get("line_references") else APIHelper.SKIP
        pricing_details_index =\
            dictionary.get("pricing_details_index")\
            if "pricing_details_index" in dictionary.keys() else APIHelper.SKIP
        ...
        billing_schedule_item_id =\
            ...
            if "billing_schedule_item_id" in dictionary.keys() else APIHelper.SKIP
        custom_item =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"quantity_delta={(self.quantity_delta
                     if hasattr(self, 'quantity_delta') else None)!r}, "
                ...
                f"line_references={(self.line_references
                     if hasattr(self, 'line_references') else None)!r}, "
                f"pricing_details_index={(self.pricing_details_index
                     if hasattr(self, 'pricing_details_index') else None)!r}, "
                f"pricing_details={(self.pricing_details
                     if hasattr(self, 'pricing_details') else None)!r}, "
                ...
                f"billing_schedule_item_id={(self.billing_schedule_item_id
                     if hasattr(self, 'billing_schedule_item_id') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"quantity_delta={(self.quantity_delta
                     if hasattr(self, 'quantity_delta') else None)!s}, "
                f"unit_price={(self.unit_price
                ...
                f"line_references={(self.line_references
                     if hasattr(self, 'line_references') else None)!s}, "
                f"pricing_details_index={(self.pricing_details_index
                     if hasattr(self, 'pricing_details_index') else None)!s}, "
                f"pricing_details={(self.pricing_details
                     if hasattr(self, 'pricing_details') else None)!s}, "
                f"tax_code={(self.tax_code
                ...
                f"billing_schedule_item_id={(self.billing_schedule_item_id
                     if hasattr(self, 'billing_schedule_item_id') else None)!s}, "
                f"custom_item={(self.custom_item
