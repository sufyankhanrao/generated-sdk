...
class InvoiceTax(object):
    ...
    def from_dictionary(cls,
        ...
        taxable_amount =\
            ...
            if dictionary.get("taxable_amount") else APIHelper.SKIP
        tax_amount =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"taxable_amount={(self.taxable_amount
                     if hasattr(self, 'taxable_amount') else None)!r}, "
                ...
                f"tax_component_breakouts={(self.tax_component_breakouts
                     if hasattr(self, 'tax_component_breakouts') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"taxable_amount={(self.taxable_amount
                     if hasattr(self, 'taxable_amount') else None)!s}, "
                f"tax_amount={(self.tax_amount
                ...
                f"tax_component_breakouts={(self.tax_component_breakouts
                     if hasattr(self, 'tax_component_breakouts') else None)!s}, "
