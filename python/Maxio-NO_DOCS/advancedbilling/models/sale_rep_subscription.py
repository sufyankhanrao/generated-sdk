...
class SaleRepSubscription(object):
    ...
    def from_dictionary(cls,
        ...
        subscription_url =\
            ...
            if dictionary.get("subscription_url") else APIHelper.SKIP
        customer_name =\
        ...
        last_payment =\
            ...
            if dictionary.get("last_payment") else APIHelper.SKIP
        churn_date =\
            dictionary.get("churn_date")\
            if "churn_date" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"subscription_url={(self.subscription_url
                     if hasattr(self, 'subscription_url') else None)!r}, "
                ...
                f"last_payment={(self.last_payment
                     if hasattr(self, 'last_payment') else None)!r}, "
                f"churn_date={(self.churn_date
                     if hasattr(self, 'churn_date') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"subscription_url={(self.subscription_url
                     if hasattr(self, 'subscription_url') else None)!s}, "
                f"customer_name={(self.customer_name
                ...
                f"last_payment={(self.last_payment
                     if hasattr(self, 'last_payment') else None)!s}, "
                f"churn_date={(self.churn_date
                     if hasattr(self, 'churn_date') else None)!s}, "
