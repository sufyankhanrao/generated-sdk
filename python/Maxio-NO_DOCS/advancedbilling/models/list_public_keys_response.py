...
class ListPublicKeysResponse(object):
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("chargify_js_keys") is not None:
            ...
            chargify_js_keys = APIHelper.SKIP
        meta = ListPublicKeysMeta.from_dictionary(
            dictionary.get("meta"))\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"chargify_js_keys={(self.chargify_js_keys
                     if hasattr(self, 'chargify_js_keys') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"chargify_js_keys={(self.chargify_js_keys
                     if hasattr(self, 'chargify_js_keys') else None)!s}, "
