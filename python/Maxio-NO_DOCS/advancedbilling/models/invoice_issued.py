...
class InvoiceIssued(object):
    ...
    def from_dictionary(cls,
        ...
        issue_date =\
            ...
            if dictionary.get("issue_date") else None
        paid_date =\
        ...
        paid_amount =\
            ...
            if dictionary.get("paid_amount") else None
        tax_amount =\
            dictionary.get("tax_amount")\
            if dictionary.get("tax_amount") else None
        refund_amount =\
        ...
        status_amount =\
            ...
            if dictionary.get("status_amount") else None
        product_name =\
            dictionary.get("product_name")\
            if dictionary.get("product_name") else None
        consolidation_level =\
