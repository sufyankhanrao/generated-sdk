...
class SubscriptionGroupSignup(object):
    ...
    def from_dictionary(cls,
        ...
        payer_attributes = PayerAttributes.from_dictionary(
            dictionary.get("payer_attributes"))\
            if "payer_attributes" in dictionary.keys() else APIHelper.SKIP
        credit_card_attributes = SubscriptionGroupCreditCard.from_dictionary(
            dictionary.get("credit_card_attributes"))\
            if "credit_card_attributes" in dictionary.keys() else APIHelper.SKIP
        bank_account_attributes = SubscriptionGroupBankAccount.from_dictionary(
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"payer_attributes={(self.payer_attributes
                     if hasattr(self, 'payer_attributes') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"payer_attributes={(self.payer_attributes
                     if hasattr(self, 'payer_attributes') else None)!s}, "
                f"credit_card_attributes={(self.credit_card_attributes
