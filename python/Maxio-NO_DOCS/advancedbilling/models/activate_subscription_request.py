...
class ActivateSubscriptionRequest(object):
    ...
    def from_dictionary(cls,
        ...
        revert_on_failure =\
            ...
            if "revert_on_failure" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"revert_on_failure={(self.revert_on_failure
                     if hasattr(self, 'revert_on_failure') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"revert_on_failure={(self.revert_on_failure
                     if hasattr(self, 'revert_on_failure') else None)!s}, "
