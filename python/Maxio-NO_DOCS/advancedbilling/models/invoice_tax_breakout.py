...
class InvoiceTaxBreakout(object):
    ...
    def from_dictionary(cls,
        ...
        tax_exempt_amount =\
            ...
            if dictionary.get("tax_exempt_amount") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"tax_exempt_amount={(self.tax_exempt_amount
                     if hasattr(self, 'tax_exempt_amount') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"tax_exempt_amount={(self.tax_exempt_amount
                     if hasattr(self, 'tax_exempt_amount') else None)!s}, "
