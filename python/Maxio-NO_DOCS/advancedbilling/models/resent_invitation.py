...
class ResentInvitation(object):
    ...
    def from_dictionary(cls,
        ...
        send_invite_link_text =\
            ...
            if dictionary.get("send_invite_link_text") else APIHelper.SKIP
        uninvited_count =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"send_invite_link_text={(self.send_invite_link_text
                     if hasattr(self, 'send_invite_link_text') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"send_invite_link_text={(self.send_invite_link_text
                     if hasattr(self, 'send_invite_link_text') else None)!s}, "
                f"uninvited_count={(self.uninvited_count
