...
class GetOneTimeTokenPaymentProfile(object):
    ...
    def from_dictionary(cls,
        ...
        masked_card_number =\
            ...
            if dictionary.get("masked_card_number") else None
        card_type =\
            dictionary.get("card_type")\
            if dictionary.get("card_type") else None
        expiration_month =\
            dictionary.get("expiration_month")\
            if dictionary.get("expiration_month") else None
        expiration_year =\
            dictionary.get("expiration_year")\
            if dictionary.get("expiration_year") else None
        current_vault =\
            dictionary.get("current_vault")\
            if dictionary.get("current_vault") else None
        vault_token =\
            dictionary.get("vault_token")\
            if dictionary.get("vault_token") else None
        billing_address =\
            dictionary.get("billing_address")\
            if dictionary.get("billing_address") else None
        billing_city =\
            dictionary.get("billing_city")\
            if dictionary.get("billing_city") else None
        billing_country =\
            dictionary.get("billing_country")\
            if dictionary.get("billing_country") else None
        billing_state =\
            dictionary.get("billing_state")\
            if dictionary.get("billing_state") else None
        billing_zip =\
            dictionary.get("billing_zip")\
            if dictionary.get("billing_zip") else None
        payment_type =\
            dictionary.get("payment_type")\
            if dictionary.get("payment_type") else None
        disabled =\
            dictionary.get("disabled")\
            if "disabled" in dictionary.keys() else None
        site_gateway_setting_id =\
            dictionary.get("site_gateway_setting_id")\
            if dictionary.get("site_gateway_setting_id") else None
        ...
        billing_address_2 =\
            ...
            if dictionary.get("billing_address_2") else APIHelper.SKIP
        customer_vault_token =\
