...
class Product(object):
    ...
    Attributes:
        ...
        expiration_interval_unit (ExtendedIntervalUnit): A string representing
            the expiration interval unit for this product, either month or day
    ...
    def from_dictionary(cls,
        ...
        request_credit_card =\
            ...
            if "request_credit_card" in dictionary.keys() else APIHelper.SKIP
        expiration_interval =\
        ...
        return_params =\
            ...
            if "return_params" in dictionary.keys() else APIHelper.SKIP
        taxable =\
            dictionary.get("taxable")\
            if "taxable" in dictionary.keys() else APIHelper.SKIP
        update_return_url =\
            dictionary.get("update_return_url")\
            if "update_return_url" in dictionary.keys() else APIHelper.SKIP
        initial_charge_after_trial =\
        ...
        version_number =\
            ...
            if dictionary.get("version_number") else APIHelper.SKIP
        update_return_params =\
            dictionary.get("update_return_params")\
            if "update_return_params" in dictionary.keys() else APIHelper.SKIP
        product_family = ProductFamily.from_dictionary(
            dictionary.get("product_family"))\
            if "product_family" in dictionary.keys() else APIHelper.SKIP
        ...
        product_price_point_name =\
            ...
            if dictionary.get("product_price_point_name") else APIHelper.SKIP
        request_billing_address =\
            dictionary.get("request_billing_address")\
            if "request_billing_address" in dictionary.keys() else APIHelper.SKIP
        require_billing_address =\
            dictionary.get("require_billing_address")\
            if "require_billing_address" in dictionary.keys() else APIHelper.SKIP
        require_shipping_address =\
            dictionary.get("require_shipping_address")\
            if "require_shipping_address" in dictionary.keys() else APIHelper.SKIP
        tax_code =\
            dictionary.get("tax_code")\
            if "tax_code" in dictionary.keys() else APIHelper.SKIP
        default_product_price_point_id =\
            dictionary.get("default_product_price_point_id")\
            if dictionary.get("default_product_price_point_id") else APIHelper.SKIP
        use_site_exchange_rate =\
        ...
        product_price_point_handle =\
            ...
            if "product_price_point_handle" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"request_credit_card={(self.request_credit_card
                     if hasattr(self, 'request_credit_card') else None)!r}, "
                ...
                f"return_params={(self.return_params
                     if hasattr(self, 'return_params') else None)!r}, "
                f"taxable={(self.taxable
                     if hasattr(self, 'taxable') else None)!r}, "
                f"update_return_url={(self.update_return_url
                     if hasattr(self, 'update_return_url') else None)!r}, "
                ...
                f"version_number={(self.version_number
                     if hasattr(self, 'version_number') else None)!r}, "
                f"update_return_params={(self.update_return_params
                     if hasattr(self, 'update_return_params') else None)!r}, "
                f"product_family={(self.product_family
                     if hasattr(self, 'product_family') else None)!r}, "
                f"public_signup_pages={(self.public_signup_pages
                     if hasattr(self, 'public_signup_pages') else None)!r}, "
                f"product_price_point_name={(self.product_price_point_name
                     if hasattr(self, 'product_price_point_name') else None)!r}, "
                f"request_billing_address={(self.request_billing_address
                     if hasattr(self, 'request_billing_address') else None)!r}, "
                f"require_billing_address={(self.require_billing_address
                     if hasattr(self, 'require_billing_address') else None)!r}, "
                f"require_shipping_address={(self.require_shipping_address
                     if hasattr(self, 'require_shipping_address') else None)!r}, "
                f"tax_code={(self.tax_code
                     if hasattr(self, 'tax_code') else None)!r}, "
                f"default_product_price_point_id={(self.default_product_price_point_id
                     if hasattr(self, 'default_product_price_point_id') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"request_credit_card={(self.request_credit_card
                     if hasattr(self, 'request_credit_card') else None)!s}, "
                f"expiration_interval={(self.expiration_interval
                ...
                f"return_params={(self.return_params
                     if hasattr(self, 'return_params') else None)!s}, "
                f"taxable={(self.taxable
                     if hasattr(self, 'taxable') else None)!s}, "
                f"update_return_url={(self.update_return_url
                     if hasattr(self, 'update_return_url') else None)!s}, "
                f"initial_charge_after_trial={(self.initial_charge_after_trial
                     if hasattr(self, 'initial_charge_after_trial') else None)!s}, "
                f"version_number={(self.version_number
                     if hasattr(self, 'version_number') else None)!s}, "
                f"update_return_params={(self.update_return_params
                     if hasattr(self, 'update_return_params') else None)!s}, "
                f"product_family={(self.product_family
                     if hasattr(self, 'product_family') else None)!s}, "
                f"public_signup_pages={(self.public_signup_pages
                     if hasattr(self, 'public_signup_pages') else None)!s}, "
                f"product_price_point_name={(self.product_price_point_name
                     if hasattr(self, 'product_price_point_name') else None)!s}, "
                f"request_billing_address={(self.request_billing_address
                     if hasattr(self, 'request_billing_address') else None)!s}, "
                f"require_billing_address={(self.require_billing_address
                     if hasattr(self, 'require_billing_address') else None)!s}, "
                f"require_shipping_address={(self.require_shipping_address
                     if hasattr(self, 'require_shipping_address') else None)!s}, "
                f"tax_code={(self.tax_code
                     if hasattr(self, 'tax_code') else None)!s}, "
                f"default_product_price_point_id={(self.default_product_price_point_id
                     if hasattr(self, 'default_product_price_point_id') else None)!s}, "
                f"use_site_exchange_rate={(self.use_site_exchange_rate
