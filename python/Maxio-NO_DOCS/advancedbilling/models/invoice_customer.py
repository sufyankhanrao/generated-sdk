...
class InvoiceCustomer(object):
    ...
    def from_dictionary(cls,
        ...
        chargify_id =\
            ...
            if "chargify_id" in dictionary.keys() else APIHelper.SKIP
        first_name =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"chargify_id={(self.chargify_id
                     if hasattr(self, 'chargify_id') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"chargify_id={(self.chargify_id
                     if hasattr(self, 'chargify_id') else None)!s}, "
                f"first_name={(self.first_name
