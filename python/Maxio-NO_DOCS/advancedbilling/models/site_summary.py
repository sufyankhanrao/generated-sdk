...
class SiteSummary(object):
    ...
    def from_dictionary(cls,
        ...
        seller_name =\
            ...
            if dictionary.get("seller_name") else APIHelper.SKIP
        site_name =\
        ...
        site_currency =\
            ...
            if dictionary.get("site_currency") else APIHelper.SKIP
        stats = SiteStatistics.from_dictionary(
            dictionary.get("stats"))\
            if "stats" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"seller_name={(self.seller_name
                     if hasattr(self, 'seller_name') else None)!r}, "
                f"site_name={(self.site_name
                     if hasattr(self, 'site_name') else None)!r}, "
                f"site_id={(self.site_id
                     if hasattr(self, 'site_id') else None)!r}, "
                f"site_currency={(self.site_currency
                     if hasattr(self, 'site_currency') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"seller_name={(self.seller_name
                     if hasattr(self, 'seller_name') else None)!s}, "
                f"site_name={(self.site_name
                     if hasattr(self, 'site_name') else None)!s}, "
                f"site_id={(self.site_id
                     if hasattr(self, 'site_id') else None)!s}, "
                f"site_currency={(self.site_currency
                     if hasattr(self, 'site_currency') else None)!s}, "
