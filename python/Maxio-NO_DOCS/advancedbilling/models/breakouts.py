...
class Breakouts(object):
    ...
    def from_dictionary(cls,
        ...
        plan_amount_in_cents =\
            ...
            if dictionary.get("plan_amount_in_cents") else APIHelper.SKIP
        plan_amount_formatted =\
            dictionary.get("plan_amount_formatted")\
            if dictionary.get("plan_amount_formatted") else APIHelper.SKIP
        usage_amount_in_cents =\
            dictionary.get("usage_amount_in_cents")\
            if dictionary.get("usage_amount_in_cents") else APIHelper.SKIP
        usage_amount_formatted =\
            dictionary.get("usage_amount_formatted")\
            if dictionary.get("usage_amount_formatted") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"plan_amount_in_cents={(self.plan_amount_in_cents
                     if hasattr(self, 'plan_amount_in_cents') else None)!r}, "
                f"plan_amount_formatted={(self.plan_amount_formatted
                     if hasattr(self, 'plan_amount_formatted') else None)!r}, "
                f"usage_amount_in_cents={(self.usage_amount_in_cents
                     if hasattr(self, 'usage_amount_in_cents') else None)!r}, "
                f"usage_amount_formatted={(self.usage_amount_formatted
                     if hasattr(self, 'usage_amount_formatted') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"plan_amount_in_cents={(self.plan_amount_in_cents
                     if hasattr(self, 'plan_amount_in_cents') else None)!s}, "
                f"plan_amount_formatted={(self.plan_amount_formatted
                     if hasattr(self, 'plan_amount_formatted') else None)!s}, "
                f"usage_amount_in_cents={(self.usage_amount_in_cents
                     if hasattr(self, 'usage_amount_in_cents') else None)!s}, "
                f"usage_amount_formatted={(self.usage_amount_formatted
                     if hasattr(self, 'usage_amount_formatted') else None)!s}, "
