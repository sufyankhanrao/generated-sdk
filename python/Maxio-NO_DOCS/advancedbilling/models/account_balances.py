...
class AccountBalances(object):
    ...
    def from_dictionary(cls,
        ...
        open_invoices = AccountBalance.from_dictionary(
            dictionary.get("open_invoices"))\
            if "open_invoices" in dictionary.keys() else APIHelper.SKIP
        pending_invoices = AccountBalance.from_dictionary(
            dictionary.get("pending_invoices"))\
            if "pending_invoices" in dictionary.keys() else APIHelper.SKIP
        pending_discounts = AccountBalance.from_dictionary(
            dictionary.get("pending_discounts"))\
            if "pending_discounts" in dictionary.keys() else APIHelper.SKIP
        service_credits = AccountBalance.from_dictionary(
            dictionary.get("service_credits"))\
            if "service_credits" in dictionary.keys() else APIHelper.SKIP
        prepayments = AccountBalance.from_dictionary(
            dictionary.get("prepayments"))\
            if "prepayments" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"open_invoices={(self.open_invoices
                     if hasattr(self, 'open_invoices') else None)!r}, "
                f"pending_invoices={(self.pending_invoices
                     if hasattr(self, 'pending_invoices') else None)!r}, "
                f"pending_discounts={(self.pending_discounts
                     if hasattr(self, 'pending_discounts') else None)!r}, "
                f"service_credits={(self.service_credits
                     if hasattr(self, 'service_credits') else None)!r}, "
                f"prepayments={(self.prepayments
                     if hasattr(self, 'prepayments') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"open_invoices={(self.open_invoices
                     if hasattr(self, 'open_invoices') else None)!s}, "
                f"pending_invoices={(self.pending_invoices
                     if hasattr(self, 'pending_invoices') else None)!s}, "
                f"pending_discounts={(self.pending_discounts
                     if hasattr(self, 'pending_discounts') else None)!s}, "
                f"service_credits={(self.service_credits
                     if hasattr(self, 'service_credits') else None)!s}, "
                f"prepayments={(self.prepayments
                     if hasattr(self, 'prepayments') else None)!s}, "
