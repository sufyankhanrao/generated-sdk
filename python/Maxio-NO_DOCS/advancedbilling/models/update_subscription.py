...
class UpdateSubscription(object):
    ...
    def from_dictionary(cls,
        ...
        credit_card_attributes = CreditCardAttributes.from_dictionary(
        ...
        next_product_id =\
            ...
            if dictionary.get("next_product_id") else APIHelper.SKIP
        next_product_price_point_id =\
            dictionary.get("next_product_price_point_id")\
            if dictionary.get("next_product_price_point_id") else APIHelper.SKIP
