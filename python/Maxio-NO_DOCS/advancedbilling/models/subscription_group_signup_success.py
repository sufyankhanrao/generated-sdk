...
from advancedbilling.models.subscription_group_signup_success_data import (
...
class SubscriptionGroupSignupSuccess(object):
    ...
    def __init__(self,
        ...
        """Initialize a SubscriptionGroupSignupSuccess instance."""
    ...
    def from_dictionary(cls,
        ...
        subscription_group = SubscriptionGroupSignupSuccessData.from_dictionary(
