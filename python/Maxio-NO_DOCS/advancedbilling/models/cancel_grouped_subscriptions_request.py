...
class CancelGroupedSubscriptionsRequest(object):
    ...
    def from_dictionary(cls,
        ...
        charge_unbilled_usage =\
            ...
            if "charge_unbilled_usage" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"charge_unbilled_usage={(self.charge_unbilled_usage
                     if hasattr(self, 'charge_unbilled_usage') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"charge_unbilled_usage={(self.charge_unbilled_usage
                     if hasattr(self, 'charge_unbilled_usage') else None)!s}, "
