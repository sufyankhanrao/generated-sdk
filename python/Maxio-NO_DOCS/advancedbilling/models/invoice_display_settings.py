...
class InvoiceDisplaySettings(object):
    ...
    def from_dictionary(cls,
        ...
        hide_zero_subtotal_lines =\
            ...
            if "hide_zero_subtotal_lines" in dictionary.keys() else APIHelper.SKIP
        include_discounts_on_lines =\
            dictionary.get("include_discounts_on_lines")\
            if "include_discounts_on_lines" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"hide_zero_subtotal_lines={(self.hide_zero_subtotal_lines
                     if hasattr(self, 'hide_zero_subtotal_lines') else None)!r}, "
                f"include_discounts_on_lines={(self.include_discounts_on_lines
                     if hasattr(self, 'include_discounts_on_lines') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"hide_zero_subtotal_lines={(self.hide_zero_subtotal_lines
                     if hasattr(self, 'hide_zero_subtotal_lines') else None)!s}, "
                f"include_discounts_on_lines={(self.include_discounts_on_lines
                     if hasattr(self, 'include_discounts_on_lines') else None)!s}, "
