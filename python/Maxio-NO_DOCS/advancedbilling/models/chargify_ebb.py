...
class ChargifyEBB(object):
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"uniqueness_token={(self.uniqueness_token
                     if hasattr(self, 'uniqueness_token') else None)!r}, "
                f"subscription_id={(self.subscription_id
                     if hasattr(self, 'subscription_id') else None)!r}, "
                f"subscription_reference={(self.subscription_reference
                     if hasattr(self, 'subscription_reference') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"uniqueness_token={(self.uniqueness_token
                     if hasattr(self, 'uniqueness_token') else None)!s}, "
                f"subscription_id={(self.subscription_id
                     if hasattr(self, 'subscription_id') else None)!s}, "
                f"subscription_reference={(self.subscription_reference
                     if hasattr(self, 'subscription_reference') else None)!s}, "
