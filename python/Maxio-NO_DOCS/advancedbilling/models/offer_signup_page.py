...
class OfferSignupPage(object):
    ...
    def from_dictionary(cls,
        ...
        nickname =\
            ...
            if dictionary.get("nickname") else APIHelper.SKIP
        enabled =\
            dictionary.get("enabled")\
            if "enabled" in dictionary.keys() else APIHelper.SKIP
        return_url =\
            dictionary.get("return_url")\
            if dictionary.get("return_url") else APIHelper.SKIP
        return_params =\
            dictionary.get("return_params")\
            if dictionary.get("return_params") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"nickname={(self.nickname
                     if hasattr(self, 'nickname') else None)!r}, "
                f"enabled={(self.enabled
                     if hasattr(self, 'enabled') else None)!r}, "
                f"return_url={(self.return_url
                     if hasattr(self, 'return_url') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"nickname={(self.nickname
                     if hasattr(self, 'nickname') else None)!s}, "
                f"enabled={(self.enabled
                     if hasattr(self, 'enabled') else None)!s}, "
                f"return_url={(self.return_url
                     if hasattr(self, 'return_url') else None)!s}, "
                f"return_params={(self.return_params
