...
class ListSubscriptionGroupsResponse(object):
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("subscription_groups") is not None:
            ...
            subscription_groups = APIHelper.SKIP
        meta = ListSubscriptionGroupsMeta.from_dictionary(
            dictionary.get("meta"))\
            if "meta" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"subscription_groups={(self.subscription_groups
                     if hasattr(self, 'subscription_groups') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"subscription_groups={(self.subscription_groups
                     if hasattr(self, 'subscription_groups') else None)!s}, "
