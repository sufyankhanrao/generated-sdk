...
class RefundInvoiceEventData(object):
    ...
    def from_dictionary(cls,
        ...
        apply_credit =\
            ...
            if "apply_credit" in dictionary.keys() else None
        credit_note_attributes = CreditNote.from_dictionary(
        ...
        refund_amount =\
            ...
            if dictionary.get("refund_amount") else None
        refund_id =\
            dictionary.get("refund_id")\
            if dictionary.get("refund_id") else None
