...
class SignupProformaPreview(object):
    ...
    def from_dictionary(cls,
        ...
        current_proforma_invoice = ProformaInvoice.from_dictionary(
            dictionary.get("current_proforma_invoice"))\
            if "current_proforma_invoice" in dictionary.keys() else APIHelper.SKIP
        next_proforma_invoice = ProformaInvoice.from_dictionary(
            dictionary.get("next_proforma_invoice"))\
            if "next_proforma_invoice" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"current_proforma_invoice={(self.current_proforma_invoice
                     if hasattr(self, 'current_proforma_invoice') else None)!r}, "
                f"next_proforma_invoice={(self.next_proforma_invoice
                     if hasattr(self, 'next_proforma_invoice') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"current_proforma_invoice={(self.current_proforma_invoice
                     if hasattr(self, 'current_proforma_invoice') else None)!s}, "
                f"next_proforma_invoice={(self.next_proforma_invoice
                     if hasattr(self, 'next_proforma_invoice') else None)!s}, "
