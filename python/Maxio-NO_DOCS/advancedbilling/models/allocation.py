...
class Allocation(object):
    ...
    def from_dictionary(cls,
        ...
        allocation_id =\
            ...
            if dictionary.get("allocation_id") else APIHelper.SKIP
        component_id =\
            dictionary.get("component_id")\
            if dictionary.get("component_id") else APIHelper.SKIP
        component_handle =\
            dictionary.get("component_handle")\
            if "component_handle" in dictionary.keys() else APIHelper.SKIP
        subscription_id =\
        ...
        price_point_name =\
            ...
            if dictionary.get("price_point_name") else APIHelper.SKIP
        price_point_handle =\
            dictionary.get("price_point_handle")\
            if dictionary.get("price_point_handle") else APIHelper.SKIP
        interval =\
        ...
        previous_price_point_id =\
            ...
            if dictionary.get("previous_price_point_id") else APIHelper.SKIP
        accrue_charge =\
        ...
        used_quantity =\
            ...
            if dictionary.get("used_quantity") else APIHelper.SKIP
        charge_id =\
            dictionary.get("charge_id")\
            if dictionary.get("charge_id") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"allocation_id={(self.allocation_id
                     if hasattr(self, 'allocation_id') else None)!r}, "
                f"component_id={(self.component_id
                     if hasattr(self, 'component_id') else None)!r}, "
                f"component_handle={(self.component_handle
                     if hasattr(self, 'component_handle') else None)!r}, "
                f"subscription_id={(self.subscription_id
                     if hasattr(self, 'subscription_id') else None)!r}, "
                f"quantity={(self.quantity
                     if hasattr(self, 'quantity') else None)!r}, "
                f"previous_quantity={(self.previous_quantity
                     if hasattr(self, 'previous_quantity') else None)!r}, "
                ...
                f"price_point_name={(self.price_point_name
                     if hasattr(self, 'price_point_name') else None)!r}, "
                f"price_point_handle={(self.price_point_handle
                     if hasattr(self, 'price_point_handle') else None)!r}, "
                f"interval={(self.interval
                     if hasattr(self, 'interval') else None)!r}, "
                f"interval_unit={(self.interval_unit
                     if hasattr(self, 'interval_unit') else None)!r}, "
                f"previous_price_point_id={(self.previous_price_point_id
                     if hasattr(self, 'previous_price_point_id') else None)!r}, "
                ...
                f"used_quantity={(self.used_quantity
                     if hasattr(self, 'used_quantity') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"allocation_id={(self.allocation_id
                     if hasattr(self, 'allocation_id') else None)!s}, "
                f"component_id={(self.component_id
                     if hasattr(self, 'component_id') else None)!s}, "
                f"component_handle={(self.component_handle
                     if hasattr(self, 'component_handle') else None)!s}, "
                f"subscription_id={(self.subscription_id
                     if hasattr(self, 'subscription_id') else None)!s}, "
                f"quantity={(self.quantity
                     if hasattr(self, 'quantity') else None)!s}, "
                f"previous_quantity={(self.previous_quantity
                     if hasattr(self, 'previous_quantity') else None)!s}, "
                ...
                f"price_point_name={(self.price_point_name
                     if hasattr(self, 'price_point_name') else None)!s}, "
                f"price_point_handle={(self.price_point_handle
                     if hasattr(self, 'price_point_handle') else None)!s}, "
                f"interval={(self.interval
                     if hasattr(self, 'interval') else None)!s}, "
                f"interval_unit={(self.interval_unit
                     if hasattr(self, 'interval_unit') else None)!s}, "
                f"previous_price_point_id={(self.previous_price_point_id
                     if hasattr(self, 'previous_price_point_id') else None)!s}, "
                f"accrue_charge={(self.accrue_charge
                ...
                f"used_quantity={(self.used_quantity
                     if hasattr(self, 'used_quantity') else None)!s}, "
                f"charge_id={(self.charge_id
