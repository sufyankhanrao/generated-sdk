...
class MRRMovement(object):
    ...
    def from_dictionary(cls,
        ...
        subscriber_delta =\
            ...
            if dictionary.get("subscriber_delta") else APIHelper.SKIP
        lead_delta =\
            dictionary.get("lead_delta")\
            if dictionary.get("lead_delta") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"subscriber_delta={(self.subscriber_delta
                     if hasattr(self, 'subscriber_delta') else None)!r}, "
                f"lead_delta={(self.lead_delta
                     if hasattr(self, 'lead_delta') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"subscriber_delta={(self.subscriber_delta
                     if hasattr(self, 'subscriber_delta') else None)!s}, "
                f"lead_delta={(self.lead_delta
                     if hasattr(self, 'lead_delta') else None)!s}, "
