...
class PortalManagementLink(object):
    ...
    def __init__(self,
        ...
        if last_invite_sent_at is not APIHelper.SKIP:
            self.last_invite_sent_at =\
                 APIHelper.apply_datetime_converter(
                last_invite_sent_at, APIHelper.RFC3339DateTime) if last_invite_sent_at else None
    ...
    def from_dictionary(cls,
        ...
        fetch_count =\
            ...
            if dictionary.get("fetch_count") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"fetch_count={(self.fetch_count
                     if hasattr(self, 'fetch_count') else None)!r}, "
                f"created_at={(self.created_at
                     if hasattr(self, 'created_at') else None)!r}, "
                f"new_link_available_at={(self.new_link_available_at
                     if hasattr(self, 'new_link_available_at') else None)!r}, "
                f"expires_at={(self.expires_at
                     if hasattr(self, 'expires_at') else None)!r}, "
                f"last_invite_sent_at={(self.last_invite_sent_at
                     if hasattr(self, 'last_invite_sent_at') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"fetch_count={(self.fetch_count
                     if hasattr(self, 'fetch_count') else None)!s}, "
                f"created_at={(self.created_at
                     if hasattr(self, 'created_at') else None)!s}, "
                f"new_link_available_at={(self.new_link_available_at
                     if hasattr(self, 'new_link_available_at') else None)!s}, "
                f"expires_at={(self.expires_at
                     if hasattr(self, 'expires_at') else None)!s}, "
                f"last_invite_sent_at={(self.last_invite_sent_at
                     if hasattr(self, 'last_invite_sent_at') else None)!s}, "
