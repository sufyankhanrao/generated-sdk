...
class ListSubscriptionGroupsItem(object):
    ...
    def from_dictionary(cls,
        ...
        account_balances = SubscriptionGroupBalances.from_dictionary(
            dictionary.get("account_balances"))\
            if "account_balances" in dictionary.keys() else APIHelper.SKIP
        group_type =\
            dictionary.get("group_type")\
            if dictionary.get("group_type") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"account_balances={(self.account_balances
                     if hasattr(self, 'account_balances') else None)!r}, "
                f"group_type={(self.group_type
                     if hasattr(self, 'group_type') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"account_balances={(self.account_balances
                     if hasattr(self, 'account_balances') else None)!s}, "
                f"group_type={(self.group_type
                     if hasattr(self, 'group_type') else None)!s}, "
