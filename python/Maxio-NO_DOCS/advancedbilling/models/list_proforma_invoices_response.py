...
class ListProformaInvoicesResponse(object):
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("proforma_invoices") is not None:
            ...
            proforma_invoices = APIHelper.SKIP
        meta = ListProformaInvoicesMeta.from_dictionary(
            dictionary.get("meta"))\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"proforma_invoices={(self.proforma_invoices
                     if hasattr(self, 'proforma_invoices') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"proforma_invoices={(self.proforma_invoices
                     if hasattr(self, 'proforma_invoices') else None)!s}, "
