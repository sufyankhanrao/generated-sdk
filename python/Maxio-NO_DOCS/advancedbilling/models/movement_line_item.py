...
class MovementLineItem(object):
    ...
    def from_dictionary(cls,
        ...
        prev_quantity =\
            ...
            if dictionary.get("prev_quantity") else APIHelper.SKIP
        recurring =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"mrr_movements={(self.mrr_movements
                     if hasattr(self, 'mrr_movements') else None)!r}, "
                f"quantity={(self.quantity
                     if hasattr(self, 'quantity') else None)!r}, "
                f"prev_quantity={(self.prev_quantity
                     if hasattr(self, 'prev_quantity') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"mrr_movements={(self.mrr_movements
                     if hasattr(self, 'mrr_movements') else None)!s}, "
                f"quantity={(self.quantity
                     if hasattr(self, 'quantity') else None)!s}, "
                f"prev_quantity={(self.prev_quantity
                     if hasattr(self, 'prev_quantity') else None)!s}, "
                f"recurring={(self.recurring
