...
class ApplyPaymentEventData(object):
    ...
    def from_dictionary(cls,
        ...
        remaining_prepayment_amount =\
            ...
            if "remaining_prepayment_amount" in dictionary.keys() else APIHelper.SKIP
        prepayment =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"remaining_prepayment_amount={(self.remaining_prepayment_amount
                     if hasattr(self, 'remaining_prepayment_amount') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"remaining_prepayment_amount={(self.remaining_prepayment_amount
                     if hasattr(self, 'remaining_prepayment_amount') else None)!s}, "
                f"prepayment={(self.prepayment
