...
class InvoicePaymentMethod(object):
    ...
    def from_dictionary(cls,
        ...
        card_brand =\
            ...
            if dictionary.get("card_brand") else APIHelper.SKIP
        card_expiration =\
            dictionary.get("card_expiration")\
            if dictionary.get("card_expiration") else APIHelper.SKIP
        last_four =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"card_brand={(self.card_brand
                     if hasattr(self, 'card_brand') else None)!r}, "
                f"card_expiration={(self.card_expiration
                     if hasattr(self, 'card_expiration') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"card_brand={(self.card_brand
                     if hasattr(self, 'card_brand') else None)!s}, "
                f"card_expiration={(self.card_expiration
                     if hasattr(self, 'card_expiration') else None)!s}, "
                f"last_four={(self.last_four
