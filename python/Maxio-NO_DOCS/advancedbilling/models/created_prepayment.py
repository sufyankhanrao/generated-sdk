...
class CreatedPrepayment(object):
    ...
    def from_dictionary(cls,
        ...
        starting_balance_in_cents =\
            ...
            if dictionary.get("starting_balance_in_cents") else APIHelper.SKIP
        ending_balance_in_cents =\
            dictionary.get("ending_balance_in_cents")\
            if dictionary.get("ending_balance_in_cents") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"starting_balance_in_cents={(self.starting_balance_in_cents
                     if hasattr(self, 'starting_balance_in_cents') else None)!r}, "
                f"ending_balance_in_cents={(self.ending_balance_in_cents
                     if hasattr(self, 'ending_balance_in_cents') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"starting_balance_in_cents={(self.starting_balance_in_cents
                     if hasattr(self, 'starting_balance_in_cents') else None)!s}, "
                f"ending_balance_in_cents={(self.ending_balance_in_cents
                     if hasattr(self, 'ending_balance_in_cents') else None)!s}, "
