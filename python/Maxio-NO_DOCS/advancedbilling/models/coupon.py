...
class Coupon(object):
    ...
    def from_dictionary(cls,
        ...
        amount_in_cents =\
            ...
            if "amount_in_cents" in dictionary.keys() else APIHelper.SKIP
        product_family_id =\
        ...
        product_family_name =\
            ...
            if "product_family_name" in dictionary.keys() else APIHelper.SKIP
        ...
        percentage =\
            ...
            if "percentage" in dictionary.keys() else APIHelper.SKIP
        recurring =\
            dictionary.get("recurring")\
            if "recurring" in dictionary.keys() else APIHelper.SKIP
        recurring_scheme =\
            dictionary.get("recurring_scheme")\
            if dictionary.get("recurring_scheme") else APIHelper.SKIP
        duration_period_count =\
            dictionary.get("duration_period_count")\
            if "duration_period_count" in dictionary.keys() else APIHelper.SKIP
        duration_interval =\
            dictionary.get("duration_interval")\
            if "duration_interval" in dictionary.keys() else APIHelper.SKIP
        duration_interval_unit =\
            dictionary.get("duration_interval_unit")\
            if "duration_interval_unit" in dictionary.keys() else APIHelper.SKIP
        duration_interval_span =\
            dictionary.get("duration_interval_span")\
            if "duration_interval_span" in dictionary.keys() else APIHelper.SKIP
        allow_negative_balance =\
        ...
        conversion_limit =\
            ...
            if "conversion_limit" in dictionary.keys() else APIHelper.SKIP
        stackable =\
            dictionary.get("stackable")\
            if "stackable" in dictionary.keys() else APIHelper.SKIP
        compounding_strategy =\
            dictionary.get("compounding_strategy")\
            if "compounding_strategy" in dictionary.keys() else APIHelper.SKIP
        use_site_exchange_rate =\
        ...
        discount_type =\
            ...
            if dictionary.get("discount_type") else APIHelper.SKIP
        exclude_mid_period_allocations =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"amount_in_cents={(self.amount_in_cents
                     if hasattr(self, 'amount_in_cents') else None)!r}, "
                ...
                f"recurring_scheme={(self.recurring_scheme
                     if hasattr(self, 'recurring_scheme') else None)!r}, "
                f"duration_period_count={(self.duration_period_count
                     if hasattr(self, 'duration_period_count') else None)!r}, "
                f"duration_interval={(self.duration_interval
                     if hasattr(self, 'duration_interval') else None)!r}, "
                f"duration_interval_unit={(self.duration_interval_unit
                     if hasattr(self, 'duration_interval_unit') else None)!r}, "
                f"duration_interval_span={(self.duration_interval_span
                     if hasattr(self, 'duration_interval_span') else None)!r}, "
                ...
                f"conversion_limit={(self.conversion_limit
                     if hasattr(self, 'conversion_limit') else None)!r}, "
                ...
                f"discount_type={(self.discount_type
                     if hasattr(self, 'discount_type') else None)!r}, "
                ...
                f"coupon_restrictions={(self.coupon_restrictions
                     if hasattr(self, 'coupon_restrictions') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"amount_in_cents={(self.amount_in_cents
                     if hasattr(self, 'amount_in_cents') else None)!s}, "
                f"product_family_id={(self.product_family_id
                ...
                f"recurring_scheme={(self.recurring_scheme
                     if hasattr(self, 'recurring_scheme') else None)!s}, "
                f"duration_period_count={(self.duration_period_count
                     if hasattr(self, 'duration_period_count') else None)!s}, "
                f"duration_interval={(self.duration_interval
                     if hasattr(self, 'duration_interval') else None)!s}, "
                f"duration_interval_unit={(self.duration_interval_unit
                     if hasattr(self, 'duration_interval_unit') else None)!s}, "
                f"duration_interval_span={(self.duration_interval_span
                     if hasattr(self, 'duration_interval_span') else None)!s}, "
                f"allow_negative_balance={(self.allow_negative_balance
                     if hasattr(self, 'allow_negative_balance') else None)!s}, "
                f"archived_at={(self.archived_at
                     if hasattr(self, 'archived_at') else None)!s}, "
                f"conversion_limit={(self.conversion_limit
                     if hasattr(self, 'conversion_limit') else None)!s}, "
                f"stackable={(self.stackable
                ...
                f"discount_type={(self.discount_type
                     if hasattr(self, 'discount_type') else None)!s}, "
                f"exclude_mid_period_allocations={(self.exclude_mid_period_allocations
                ...
                f"coupon_restrictions={(self.coupon_restrictions
                     if hasattr(self, 'coupon_restrictions') else None)!s}, "
