...
class CouponSubcodesResponse(object):
    ...
    def from_dictionary(cls,
        ...
        created_codes =\
            ...
            if dictionary.get("created_codes") else APIHelper.SKIP
        duplicate_codes =\
            dictionary.get("duplicate_codes")\
            if dictionary.get("duplicate_codes") else APIHelper.SKIP
        invalid_codes =\
            dictionary.get("invalid_codes")\
            if dictionary.get("invalid_codes") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"created_codes={(self.created_codes
                     if hasattr(self, 'created_codes') else None)!r}, "
                f"duplicate_codes={(self.duplicate_codes
                     if hasattr(self, 'duplicate_codes') else None)!r}, "
                f"invalid_codes={(self.invalid_codes
                     if hasattr(self, 'invalid_codes') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"created_codes={(self.created_codes
                     if hasattr(self, 'created_codes') else None)!s}, "
                f"duplicate_codes={(self.duplicate_codes
                     if hasattr(self, 'duplicate_codes') else None)!s}, "
                f"invalid_codes={(self.invalid_codes
                     if hasattr(self, 'invalid_codes') else None)!s}, "
