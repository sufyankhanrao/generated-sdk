...
class InvoicePaymentApplication(object):
    ...
    def from_dictionary(cls,
        ...
        invoice_uid =\
            ...
            if dictionary.get("invoice_uid") else APIHelper.SKIP
        application_uid =\
            dictionary.get("application_uid")\
            if dictionary.get("application_uid") else APIHelper.SKIP
        applied_amount =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"invoice_uid={(self.invoice_uid
                     if hasattr(self, 'invoice_uid') else None)!r}, "
                f"application_uid={(self.application_uid
                     if hasattr(self, 'application_uid') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"invoice_uid={(self.invoice_uid
                     if hasattr(self, 'invoice_uid') else None)!s}, "
                f"application_uid={(self.application_uid
                     if hasattr(self, 'application_uid') else None)!s}, "
                f"applied_amount={(self.applied_amount
