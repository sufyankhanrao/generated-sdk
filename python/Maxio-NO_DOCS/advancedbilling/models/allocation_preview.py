...
class AllocationPreview(object):
    ...
    def from_dictionary(cls,
        ...
        subtotal_in_cents =\
            ...
            if dictionary.get("subtotal_in_cents") else APIHelper.SKIP
        total_tax_in_cents =\
            dictionary.get("total_tax_in_cents")\
            if dictionary.get("total_tax_in_cents") else APIHelper.SKIP
        total_discount_in_cents =\
            dictionary.get("total_discount_in_cents")\
            if dictionary.get("total_discount_in_cents") else APIHelper.SKIP
        total_in_cents =\
            dictionary.get("total_in_cents")\
            if dictionary.get("total_in_cents") else APIHelper.SKIP
        direction =\
            dictionary.get("direction")\
            if dictionary.get("direction") else APIHelper.SKIP
        proration_scheme =\
            dictionary.get("proration_scheme")\
            if dictionary.get("proration_scheme") else APIHelper.SKIP
        line_items = None
        ...
        period_type =\
            ...
            if dictionary.get("period_type") else APIHelper.SKIP
        existing_balance_in_cents =\
            dictionary.get("existing_balance_in_cents")\
            if dictionary.get("existing_balance_in_cents") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"subtotal_in_cents={(self.subtotal_in_cents
                     if hasattr(self, 'subtotal_in_cents') else None)!r}, "
                f"total_tax_in_cents={(self.total_tax_in_cents
                     if hasattr(self, 'total_tax_in_cents') else None)!r}, "
                f"total_discount_in_cents={(self.total_discount_in_cents
                     if hasattr(self, 'total_discount_in_cents') else None)!r}, "
                f"total_in_cents={(self.total_in_cents
                     if hasattr(self, 'total_in_cents') else None)!r}, "
                f"direction={(self.direction
                     if hasattr(self, 'direction') else None)!r}, "
                f"proration_scheme={(self.proration_scheme
                     if hasattr(self, 'proration_scheme') else None)!r}, "
                ...
                f"allocations={(self.allocations
                     if hasattr(self, 'allocations') else None)!r}, "
                f"period_type={(self.period_type
                     if hasattr(self, 'period_type') else None)!r}, "
                f"existing_balance_in_cents={(self.existing_balance_in_cents
                     if hasattr(self, 'existing_balance_in_cents') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"subtotal_in_cents={(self.subtotal_in_cents
                     if hasattr(self, 'subtotal_in_cents') else None)!s}, "
                f"total_tax_in_cents={(self.total_tax_in_cents
                     if hasattr(self, 'total_tax_in_cents') else None)!s}, "
                f"total_discount_in_cents={(self.total_discount_in_cents
                     if hasattr(self, 'total_discount_in_cents') else None)!s}, "
                f"total_in_cents={(self.total_in_cents
                     if hasattr(self, 'total_in_cents') else None)!s}, "
                f"direction={(self.direction
                     if hasattr(self, 'direction') else None)!s}, "
                f"proration_scheme={(self.proration_scheme
                     if hasattr(self, 'proration_scheme') else None)!s}, "
                f"line_items={(self.line_items
                     if hasattr(self, 'line_items') else None)!s}, "
                f"accrue_charge={(self.accrue_charge
                     if hasattr(self, 'accrue_charge') else None)!s}, "
                f"allocations={(self.allocations
                     if hasattr(self, 'allocations') else None)!s}, "
                f"period_type={(self.period_type
                     if hasattr(self, 'period_type') else None)!s}, "
                f"existing_balance_in_cents={(self.existing_balance_in_cents
                     if hasattr(self, 'existing_balance_in_cents') else None)!s}, "
