...
class ComponentPrice(object):
    ...
    def from_dictionary(cls,
        ...
        ending_quantity =\
            ...
            if "ending_quantity" in dictionary.keys() else APIHelper.SKIP
        unit_price =\
        ...
        formatted_unit_price =\
            ...
            if dictionary.get("formatted_unit_price") else APIHelper.SKIP
        segment_id =\
            dictionary.get("segment_id")\
            if "segment_id" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"ending_quantity={(self.ending_quantity
                     if hasattr(self, 'ending_quantity') else None)!r}, "
                ...
                f"formatted_unit_price={(self.formatted_unit_price
                     if hasattr(self, 'formatted_unit_price') else None)!r}, "
                f"segment_id={(self.segment_id
                     if hasattr(self, 'segment_id') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"ending_quantity={(self.ending_quantity
                     if hasattr(self, 'ending_quantity') else None)!s}, "
                f"unit_price={(self.unit_price
                     if hasattr(self, 'unit_price') else None)!s}, "
                f"price_point_id={(self.price_point_id
                     if hasattr(self, 'price_point_id') else None)!s}, "
                f"formatted_unit_price={(self.formatted_unit_price
                     if hasattr(self, 'formatted_unit_price') else None)!s}, "
                f"segment_id={(self.segment_id
                     if hasattr(self, 'segment_id') else None)!s}, "
