...
class RenewalPreviewLineItem(object):
    ...
    def from_dictionary(cls,
        ...
        transaction_type =\
            ...
            if dictionary.get("transaction_type") else APIHelper.SKIP
        kind =\
            dictionary.get("kind")\
            if dictionary.get("kind") else APIHelper.SKIP
        amount_in_cents =\
            dictionary.get("amount_in_cents")\
            if dictionary.get("amount_in_cents") else APIHelper.SKIP
        memo =\
            dictionary.get("memo")\
            if dictionary.get("memo") else APIHelper.SKIP
        discount_amount_in_cents =\
            dictionary.get("discount_amount_in_cents")\
            if dictionary.get("discount_amount_in_cents") else APIHelper.SKIP
        taxable_amount_in_cents =\
            dictionary.get("taxable_amount_in_cents")\
            if dictionary.get("taxable_amount_in_cents") else APIHelper.SKIP
        product_id =\
        ...
        component_handle =\
            ...
            if dictionary.get("component_handle") else APIHelper.SKIP
        component_name =\
            dictionary.get("component_name")\
            if dictionary.get("component_name") else APIHelper.SKIP
        product_handle =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"discount_amount_in_cents={(self.discount_amount_in_cents
                     if hasattr(self, 'discount_amount_in_cents') else None)!r}, "
                f"taxable_amount_in_cents={(self.taxable_amount_in_cents
                     if hasattr(self, 'taxable_amount_in_cents') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"discount_amount_in_cents={(self.discount_amount_in_cents
                     if hasattr(self, 'discount_amount_in_cents') else None)!s}, "
                f"taxable_amount_in_cents={(self.taxable_amount_in_cents
                     if hasattr(self, 'taxable_amount_in_cents') else None)!s}, "
                f"product_id={(self.product_id
