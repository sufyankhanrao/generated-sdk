...
class WebhookResponse(object):
    ...
    def from_dictionary(cls,
        ...
        webhook = Webhook.from_dictionary(
            dictionary.get("webhook"))\
            if "webhook" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"webhook={(self.webhook
                     if hasattr(self, 'webhook') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"webhook={(self.webhook
                     if hasattr(self, 'webhook') else None)!s}, "
