...
class PrepaymentAccountBalanceChanged(object):
    ...
    def from_dictionary(cls,
        ...
        prepayment_balance_change_in_cents =\
            ...
            if dictionary.get("prepayment_balance_change_in_cents") else None
        currency_code =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"prepayment_balance_change_in_cents={
                    self.prepayment_balance_change_in_cents!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"prepayment_balance_change_in_cents={
                    self.prepayment_balance_change_in_cents!s}, "
