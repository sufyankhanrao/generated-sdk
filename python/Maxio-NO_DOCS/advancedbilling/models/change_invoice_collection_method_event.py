...
class ChangeInvoiceCollectionMethodEvent(object):
    ...
    def from_dictionary(cls,
        ...
        invoice = Invoice.from_dictionary(
            dictionary.get("invoice"))\
            if dictionary.get("invoice") else None
        event_type =\
            dictionary.get("event_type")\
            if dictionary.get("event_type") else "change_invoice_collection_method"
        event_data = ChangeInvoiceCollectionMethodEventData.from_dictionary(
