...
class NetTerms(object):
    ...
    def from_dictionary(cls,
        ...
        default_net_terms =\
            ...
            if dictionary.get("default_net_terms") else 0
        automatic_net_terms =\
            dictionary.get("automatic_net_terms")\
            if dictionary.get("automatic_net_terms") else 0
        remittance_net_terms =\
            dictionary.get("remittance_net_terms")\
            if dictionary.get("remittance_net_terms") else 0
        net_terms_on_remittance_signups_enabled =\
            dictionary.get("net_terms_on_remittance_signups_enabled")\
            if dictionary.get("net_terms_on_remittance_signups_enabled") else False
        custom_net_terms_enabled =\
            dictionary.get("custom_net_terms_enabled")\
            if dictionary.get("custom_net_terms_enabled") else False
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"default_net_terms={(self.default_net_terms
                     if hasattr(self, 'default_net_terms') else None)!r}, "
                f"automatic_net_terms={(self.automatic_net_terms
                     if hasattr(self, 'automatic_net_terms') else None)!r}, "
                f"remittance_net_terms={(self.remittance_net_terms
                     if hasattr(self, 'remittance_net_terms') else None)!r}, "
                f"net_terms_on_remittance_signups_enabled={(self.net_terms_on_remittance_signups_enabled
                     if hasattr(self, 'net_terms_on_remittance_signups_enabled') else None)!r}, "
                f"custom_net_terms_enabled={(self.custom_net_terms_enabled
                     if hasattr(self, 'custom_net_terms_enabled') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"default_net_terms={(self.default_net_terms
                     if hasattr(self, 'default_net_terms') else None)!s}, "
                f"automatic_net_terms={(self.automatic_net_terms
                     if hasattr(self, 'automatic_net_terms') else None)!s}, "
                f"remittance_net_terms={(self.remittance_net_terms
                     if hasattr(self, 'remittance_net_terms') else None)!s}, "
                f"net_terms_on_remittance_signups_enabled={(self.net_terms_on_remittance_signups_enabled
                     if hasattr(self, 'net_terms_on_remittance_signups_enabled') else None)!s}, "
                f"custom_net_terms_enabled={(self.custom_net_terms_enabled
                     if hasattr(self, 'custom_net_terms_enabled') else None)!s}, "
