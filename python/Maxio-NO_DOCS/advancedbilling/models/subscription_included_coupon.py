...
class SubscriptionIncludedCoupon(object):
    ...
    def from_dictionary(cls,
        ...
        use_count =\
            ...
            if dictionary.get("use_count") else APIHelper.SKIP
        uses_allowed =\
            dictionary.get("uses_allowed")\
            if dictionary.get("uses_allowed") else APIHelper.SKIP
        expires_at =\
            dictionary.get("expires_at")\
            if "expires_at" in dictionary.keys() else APIHelper.SKIP
        recurring =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"use_count={(self.use_count
                     if hasattr(self, 'use_count') else None)!r}, "
                f"uses_allowed={(self.uses_allowed
                     if hasattr(self, 'uses_allowed') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"use_count={(self.use_count
                     if hasattr(self, 'use_count') else None)!s}, "
                f"uses_allowed={(self.uses_allowed
                     if hasattr(self, 'uses_allowed') else None)!s}, "
                f"expires_at={(self.expires_at
