...
class CreateCustomer(object):
    ...
    def from_dictionary(cls,
        ...
        cc_emails =\
            ...
            if dictionary.get("cc_emails") else APIHelper.SKIP
        organization =\
            dictionary.get("organization")\
            if dictionary.get("organization") else APIHelper.SKIP
        reference =\
        ...
        address_2 =\
            ...
            if dictionary.get("address_2") else APIHelper.SKIP
        city =\
            dictionary.get("city")\
        ...
        locale =\
            ...
            if dictionary.get("locale") else APIHelper.SKIP
        vat_number =\
            dictionary.get("vat_number")\
            if dictionary.get("vat_number") else APIHelper.SKIP
        tax_exempt =\
            dictionary.get("tax_exempt")\
            if "tax_exempt" in dictionary.keys() else APIHelper.SKIP
        tax_exempt_reason =\
            dictionary.get("tax_exempt_reason")\
            if dictionary.get("tax_exempt_reason") else APIHelper.SKIP
        parent_id =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"tax_exempt_reason={(self.tax_exempt_reason
                     if hasattr(self, 'tax_exempt_reason') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"tax_exempt_reason={(self.tax_exempt_reason
                     if hasattr(self, 'tax_exempt_reason') else None)!s}, "
                f"parent_id={(self.parent_id
