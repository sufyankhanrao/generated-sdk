...
class InvoiceDiscount(object):
    ...
    def from_dictionary(cls,
        ...
        source_type =\
            ...
            if dictionary.get("source_type") else APIHelper.SKIP
        source_id =\
            dictionary.get("source_id")\
            if dictionary.get("source_id") else APIHelper.SKIP
        discount_type =\
        ...
        eligible_amount =\
            ...
            if dictionary.get("eligible_amount") else APIHelper.SKIP
        discount_amount =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"source_type={(self.source_type
                     if hasattr(self, 'source_type') else None)!r}, "
                ...
                f"eligible_amount={(self.eligible_amount
                     if hasattr(self, 'eligible_amount') else None)!r}, "
                ...
                f"line_item_breakouts={(self.line_item_breakouts
                     if hasattr(self, 'line_item_breakouts') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"source_type={(self.source_type
                     if hasattr(self, 'source_type') else None)!s}, "
                f"source_id={(self.source_id
                ...
                f"eligible_amount={(self.eligible_amount
                     if hasattr(self, 'eligible_amount') else None)!s}, "
                f"discount_amount={(self.discount_amount
                     if hasattr(self, 'discount_amount') else None)!s}, "
                f"transaction_id={(self.transaction_id
                     if hasattr(self, 'transaction_id') else None)!s}, "
                f"line_item_breakouts={(self.line_item_breakouts
                     if hasattr(self, 'line_item_breakouts') else None)!s}, "
