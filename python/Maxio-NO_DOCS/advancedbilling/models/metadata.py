...
class Metadata(object):
    ...
    def from_dictionary(cls,
        ...
        resource_id =\
            ...
            if "resource_id" in dictionary.keys() else APIHelper.SKIP
        name =\
            dictionary.get("name")\
        ...
        metafield_id =\
            ...
            if "metafield_id" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"deleted_at={(self.deleted_at
                     if hasattr(self, 'deleted_at') else None)!r}, "
                f"metafield_id={(self.metafield_id
                     if hasattr(self, 'metafield_id') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"deleted_at={(self.deleted_at
                     if hasattr(self, 'deleted_at') else None)!s}, "
                f"metafield_id={(self.metafield_id
                     if hasattr(self, 'metafield_id') else None)!s}, "
