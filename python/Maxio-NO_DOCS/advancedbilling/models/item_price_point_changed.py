...
class ItemPricePointChanged(object):
    ...
    def from_dictionary(cls,
        ...
        item_type =\
            ...
            if dictionary.get("item_type") else None
        item_handle =\
            dictionary.get("item_handle")\
            if dictionary.get("item_handle") else None
        item_name =\
            dictionary.get("item_name")\
            if dictionary.get("item_name") else None
        previous_price_point = ItemPricePointData.from_dictionary(
            dictionary.get("previous_price_point"))\
            if dictionary.get("previous_price_point") else None
        current_price_point = ItemPricePointData.from_dictionary(
