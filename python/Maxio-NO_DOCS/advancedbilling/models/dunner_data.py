...
class DunnerData(object):
    ...
    def __init__(self,
        ...
        self.last_attempted_at =\
             APIHelper.apply_datetime_converter(
            last_attempted_at, APIHelper.RFC3339DateTime) if last_attempted_at else None
    ...
    def from_dictionary(cls,
        ...
        revenue_at_risk_in_cents =\
            ...
            if dictionary.get("revenue_at_risk_in_cents") else None
        ...
        attempts =\
            ...
            if dictionary.get("attempts") else None
