...
class SubscriptionPreview(object):
    ...
    def from_dictionary(cls,
        ...
        current_billing_manifest = BillingManifest.from_dictionary(
            dictionary.get("current_billing_manifest"))\
            if "current_billing_manifest" in dictionary.keys() else APIHelper.SKIP
        next_billing_manifest = BillingManifest.from_dictionary(
            dictionary.get("next_billing_manifest"))\
            if "next_billing_manifest" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"current_billing_manifest={(self.current_billing_manifest
                     if hasattr(self, 'current_billing_manifest') else None)!r}, "
                f"next_billing_manifest={(self.next_billing_manifest
                     if hasattr(self, 'next_billing_manifest') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"current_billing_manifest={(self.current_billing_manifest
                     if hasattr(self, 'current_billing_manifest') else None)!s}, "
                f"next_billing_manifest={(self.next_billing_manifest
                     if hasattr(self, 'next_billing_manifest') else None)!s}, "
