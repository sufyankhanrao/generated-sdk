...
class ListSubcriptionGroupPrepaymentItem(object):
    ...
    def from_dictionary(cls,
        ...
        subscription_group_uid =\
            ...
            if dictionary.get("subscription_group_uid") else APIHelper.SKIP
        amount_in_cents =\
        ...
        remaining_amount_in_cents =\
            ...
            if dictionary.get("remaining_amount_in_cents") else APIHelper.SKIP
        details =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"subscription_group_uid={(self.subscription_group_uid
                     if hasattr(self, 'subscription_group_uid') else None)!r}, "
                f"amount_in_cents={(self.amount_in_cents
                     if hasattr(self, 'amount_in_cents') else None)!r}, "
                f"remaining_amount_in_cents={(self.remaining_amount_in_cents
                     if hasattr(self, 'remaining_amount_in_cents') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"subscription_group_uid={(self.subscription_group_uid
                     if hasattr(self, 'subscription_group_uid') else None)!s}, "
                f"amount_in_cents={(self.amount_in_cents
                     if hasattr(self, 'amount_in_cents') else None)!s}, "
                f"remaining_amount_in_cents={(self.remaining_amount_in_cents
                     if hasattr(self, 'remaining_amount_in_cents') else None)!s}, "
                f"details={(self.details
