...
class SiteStatistics(object):
    ...
    def from_dictionary(cls,
        ...
        total_subscriptions =\
            ...
            if dictionary.get("total_subscriptions") else APIHelper.SKIP
        subscriptions_today =\
            dictionary.get("subscriptions_today")\
            if dictionary.get("subscriptions_today") else APIHelper.SKIP
        total_revenue =\
            dictionary.get("total_revenue")\
            if dictionary.get("total_revenue") else APIHelper.SKIP
        revenue_today =\
            dictionary.get("revenue_today")\
            if dictionary.get("revenue_today") else APIHelper.SKIP
        revenue_this_month =\
            dictionary.get("revenue_this_month")\
            if dictionary.get("revenue_this_month") else APIHelper.SKIP
        revenue_this_year =\
            dictionary.get("revenue_this_year")\
            if dictionary.get("revenue_this_year") else APIHelper.SKIP
        total_canceled_subscriptions =\
            dictionary.get("total_canceled_subscriptions")\
            if dictionary.get("total_canceled_subscriptions") else APIHelper.SKIP
        total_active_subscriptions =\
            dictionary.get("total_active_subscriptions")\
            if dictionary.get("total_active_subscriptions") else APIHelper.SKIP
        total_past_due_subscriptions =\
            dictionary.get("total_past_due_subscriptions")\
            if dictionary.get("total_past_due_subscriptions") else APIHelper.SKIP
        total_unpaid_subscriptions =\
            dictionary.get("total_unpaid_subscriptions")\
            if dictionary.get("total_unpaid_subscriptions") else APIHelper.SKIP
        total_dunning_subscriptions =\
            dictionary.get("total_dunning_subscriptions")\
            if dictionary.get("total_dunning_subscriptions") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"total_subscriptions={(self.total_subscriptions
                     if hasattr(self, 'total_subscriptions') else None)!r}, "
                f"subscriptions_today={(self.subscriptions_today
                     if hasattr(self, 'subscriptions_today') else None)!r}, "
                f"total_revenue={(self.total_revenue
                     if hasattr(self, 'total_revenue') else None)!r}, "
                f"revenue_today={(self.revenue_today
                     if hasattr(self, 'revenue_today') else None)!r}, "
                f"revenue_this_month={(self.revenue_this_month
                     if hasattr(self, 'revenue_this_month') else None)!r}, "
                f"revenue_this_year={(self.revenue_this_year
                     if hasattr(self, 'revenue_this_year') else None)!r}, "
                f"total_canceled_subscriptions={(self.total_canceled_subscriptions
                     if hasattr(self, 'total_canceled_subscriptions') else None)!r}, "
                f"total_active_subscriptions={(self.total_active_subscriptions
                     if hasattr(self, 'total_active_subscriptions') else None)!r}, "
                f"total_past_due_subscriptions={(self.total_past_due_subscriptions
                     if hasattr(self, 'total_past_due_subscriptions') else None)!r}, "
                f"total_unpaid_subscriptions={(self.total_unpaid_subscriptions
                     if hasattr(self, 'total_unpaid_subscriptions') else None)!r}, "
                f"total_dunning_subscriptions={(self.total_dunning_subscriptions
                     if hasattr(self, 'total_dunning_subscriptions') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"total_subscriptions={(self.total_subscriptions
                     if hasattr(self, 'total_subscriptions') else None)!s}, "
                f"subscriptions_today={(self.subscriptions_today
                     if hasattr(self, 'subscriptions_today') else None)!s}, "
                f"total_revenue={(self.total_revenue
                     if hasattr(self, 'total_revenue') else None)!s}, "
                f"revenue_today={(self.revenue_today
                     if hasattr(self, 'revenue_today') else None)!s}, "
                f"revenue_this_month={(self.revenue_this_month
                     if hasattr(self, 'revenue_this_month') else None)!s}, "
                f"revenue_this_year={(self.revenue_this_year
                     if hasattr(self, 'revenue_this_year') else None)!s}, "
                f"total_canceled_subscriptions={(self.total_canceled_subscriptions
                     if hasattr(self, 'total_canceled_subscriptions') else None)!s}, "
                f"total_active_subscriptions={(self.total_active_subscriptions
                     if hasattr(self, 'total_active_subscriptions') else None)!s}, "
                f"total_past_due_subscriptions={(self.total_past_due_subscriptions
                     if hasattr(self, 'total_past_due_subscriptions') else None)!s}, "
                f"total_unpaid_subscriptions={(self.total_unpaid_subscriptions
                     if hasattr(self, 'total_unpaid_subscriptions') else None)!s}, "
                f"total_dunning_subscriptions={(self.total_dunning_subscriptions
                     if hasattr(self, 'total_dunning_subscriptions') else None)!s}, "
