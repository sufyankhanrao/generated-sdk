...
class Event(object):
    ...
    Attributes:
        ...
        event_specific_data (SubscriptionProductChange |
            ...
            CustomFieldValueChange | None): The model property of type
            SubscriptionProductChange | SubscriptionStateChange |
            ...
            ProformaInvoiceIssued | SubscriptionGroupSignupSuccess |
            SubscriptionGroupSignupFailure | CreditAccountBalanceChanged |
            PrepaymentAccountBalanceChanged | PaymentCollectionMethodChanged |
            ItemPricePointChanged | CustomFieldValueChange | None.
