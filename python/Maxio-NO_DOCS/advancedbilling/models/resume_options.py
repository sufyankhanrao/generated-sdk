...
class ResumeOptions(object):
    ...
    def from_dictionary(cls,
        ...
        require_resume =\
            ...
            if "require_resume" in dictionary.keys() else APIHelper.SKIP
        forgive_balance =\
            dictionary.get("forgive_balance")\
            if "forgive_balance" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"require_resume={(self.require_resume
                     if hasattr(self, 'require_resume') else None)!r}, "
                f"forgive_balance={(self.forgive_balance
                     if hasattr(self, 'forgive_balance') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"require_resume={(self.require_resume
                     if hasattr(self, 'require_resume') else None)!s}, "
                f"forgive_balance={(self.forgive_balance
                     if hasattr(self, 'forgive_balance') else None)!s}, "
