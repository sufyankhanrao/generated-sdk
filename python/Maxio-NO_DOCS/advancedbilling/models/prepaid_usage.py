...
class PrepaidUsage(object):
    ...
    def from_dictionary(cls,
        ...
        previous_unit_balance =\
            ...
            if dictionary.get("previous_unit_balance") else None
        previous_overage_unit_balance =\
            dictionary.get("previous_overage_unit_balance")\
            if dictionary.get("previous_overage_unit_balance") else None
        new_unit_balance =\
            dictionary.get("new_unit_balance")\
            if dictionary.get("new_unit_balance") else None
        new_overage_unit_balance =\
            dictionary.get("new_overage_unit_balance")\
            if dictionary.get("new_overage_unit_balance") else None
        usage_quantity =\
            dictionary.get("usage_quantity")\
            if dictionary.get("usage_quantity") else None
        overage_usage_quantity =\
            dictionary.get("overage_usage_quantity")\
            if dictionary.get("overage_usage_quantity") else None
        component_id =\
            dictionary.get("component_id")\
            if dictionary.get("component_id") else None
        component_handle =\
            dictionary.get("component_handle")\
            if dictionary.get("component_handle") else None
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"previous_overage_unit_balance={
                    self.previous_overage_unit_balance!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"previous_overage_unit_balance={
                    self.previous_overage_unit_balance!s}, "
