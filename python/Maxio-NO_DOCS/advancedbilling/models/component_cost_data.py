...
class ComponentCostData(object):
    ...
    def from_dictionary(cls,
        ...
        component_code_id =\
            ...
            if "component_code_id" in dictionary.keys() else APIHelper.SKIP
        price_point_id =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"component_code_id={(self.component_code_id
                     if hasattr(self, 'component_code_id') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"component_code_id={(self.component_code_id
                     if hasattr(self, 'component_code_id') else None)!s}, "
                f"price_point_id={(self.price_point_id
