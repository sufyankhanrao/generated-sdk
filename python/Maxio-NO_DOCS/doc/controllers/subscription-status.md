...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`DelayedCancellationResponse`](../../doc/models/delayed-cancellation-response.md).
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`RenewalPreviewResponse`](../../doc/models/renewal-preview-response.md).
