...
from mdnotesropcg.http.proxy_settings import (
    ProxySettings,
)
...
class Configuration(HttpClientConfiguration):
    ...
    def o_auth_scopes(self):
        """Return OAuthScopes from ResourceOwnerAuthCredentials."""
        return self._resource_owner_auth_credentials.o_auth_scopes
