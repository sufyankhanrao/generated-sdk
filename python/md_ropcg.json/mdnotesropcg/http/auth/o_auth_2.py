    ...
    def __init__(self, resource_owner_auth_credentials, config):
        ...
        if resource_owner_auth_credentials is not None \
            ...
            self._o_auth_token = resource_owner_auth_credentials.o_auth_token \
                if resource_owner_auth_credentials is not None else None
        if resource_owner_auth_credentials is not None \
                and isinstance(resource_owner_auth_credentials.o_auth_scopes, list):
            self._o_auth_scopes = resource_owner_auth_credentials.o_auth_scopes
        else:
...
class ResourceOwnerAuthCredentials:
    ...
    def __init__(self, o_auth_client_id, o_auth_client_secret, o_auth_username,
                 o_auth_password, o_auth_token=None, o_auth_scopes=None):
