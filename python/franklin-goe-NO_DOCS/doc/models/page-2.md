...
Contains details about the number of scenarios returned, the current page, and the total number of scenarios and pages that pertain to these investors preferences. Refer to the Swagger documentation for Page objects for more details.
