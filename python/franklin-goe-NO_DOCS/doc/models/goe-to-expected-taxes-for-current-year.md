...
# Goe to Expected Taxes for Current Year

*This model accepts additional fields of type Any.*

## Structure

`GoeToExpectedTaxesForCurrentYear`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `federal_ordinary_income_tax_liability` | `float` | Required | Income tax for current financial year due to following:  <br>                    •	Withdrawals from TDA (if any)  <br>                    •	Social Security (if any)  <br>                    •	RMD  <br>                    •	Unqualified dividend (if any)  <br>                    •	Interest Income (if any) |
