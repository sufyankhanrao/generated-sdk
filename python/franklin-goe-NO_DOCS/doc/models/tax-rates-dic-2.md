...
| `ltcg_post_retirement` | `float` | Required | Post-retirement Long Term Capital Gains tax on profits & qualified dividends due to capital appreciation. <br>                        LTCG is applicable only on taxable accounts.<br><br>**Constraints**: `>= 0`, `<= 1` |
