...
from goeapi.exceptions.internal_server_message_1_exception import (
    InternalServerMessage1Exception,
)
from goeapi.exceptions.refresh_token_status_exception import (
    RefreshTokenStatusException,
)
from goeapi.exceptions.validation_message_two_exception import (
    ValidationMessageTwoException,
)
from goeapi.http.http_method_enum import HttpMethodEnum
from goeapi.models.change_password_output_model import (
    ChangePasswordOutputModel,
)
from goeapi.models.forgot_password_output_model import (
    ForgotPasswordOutputModel,
)
from goeapi.models.refresh_token_output_model import (
    RefreshTokenOutputModel,
)
from goeapi.models.sign_in_output_model import (
    SignInOutputModel,
)
...
class AuthApi(BaseApi):
    ...
    def __init__(self, config):
        """Initialize AuthApi object."""
        super(AuthApi, self).__init__(config)

    def sign_in(self,
                body):
        """Perform a POST request to /signIn.
    ...
    def forgot_password(self,
                        body):
        """Perform a POST request to /forgotPassword.
    ...
    def change_password(self,
                        body):
        """Perform a POST request to /changePassword.
    ...
    def refresh_token(self,
                      body):
        """Perform a POST request to /refreshToken.
