...
from goeapi.logging.configuration.api_logging_configuration import (
...
class Configuration(HttpClientConfiguration):
    ...
    environments = {
        Environment.PRODUCTION: {
            Server.DEFAULT: "https://api.uip.frk.com",
        },
        Environment.UAT: {
            Server.DEFAULT: "https://api.uipuat.frk.com",
        },
    }
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        environment = Environment.from_value(
            os.getenv("ENVIRONMENT"), Environment.UAT)

        from goeapi.http.auth.oauth_2 import (
