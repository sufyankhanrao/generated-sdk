...
class RunPipeInputModel(object):
    ...
    def __init__(self,
        ...
        """Constructor for the RunPipeInputModel class"""
    ...
    def from_dictionary(cls,
        ...
        current_age = dictionary.get("currentAge") if "currentAge" in dictionary.keys() else APIHelper.SKIP
        retirement_age = dictionary.get("retirementAge") if "retirementAge" in dictionary.keys() else APIHelper.SKIP
        risk_override = dictionary.get("riskOverride") if "riskOverride" in dictionary.keys() else APIHelper.SKIP
        engaged_participant = dictionary.get("engagedParticipant") if "engagedParticipant" in dictionary.keys() else APIHelper.SKIP
        required_data_available = dictionary.get("requiredDataAvailable") if dictionary.get("requiredDataAvailable") else True
        wealth_path_probabilities = dictionary.get("wealthPathProbabilities") if "wealthPathProbabilities" in dictionary.keys() else APIHelper.SKIP
        last_reallocation_probability = dictionary.get("lastReallocationProbability") if "lastReallocationProbability" in dictionary.keys() else APIHelper.SKIP
        last_reallocation_date = dictionary.get("lastReallocationDate") if "lastReallocationDate" in dictionary.keys() else APIHelper.SKIP
        plan_id = dictionary.get("planID") if "planID" in dictionary.keys() else APIHelper.SKIP
        participant_id = dictionary.get("participantID") if "participantID" in dictionary.keys() else APIHelper.SKIP
        source_id = dictionary.get("sourceID") if "sourceID" in dictionary.keys() else APIHelper.SKIP
        ...
        retirement_date = dictionary.get("retirementDate") if "retirementDate" in dictionary.keys() else APIHelper.SKIP
        target_portfolio = dictionary.get("targetPortfolio") if "targetPortfolio" in dictionary.keys() else APIHelper.SKIP
        mode = dictionary.get("mode") if "mode" in dictionary.keys() else APIHelper.SKIP
        min_equity_allocation = dictionary.get("minEquityAllocation") if "minEquityAllocation" in dictionary.keys() else APIHelper.SKIP
        max_equity_allocation = dictionary.get("maxEquityAllocation") if "maxEquityAllocation" in dictionary.keys() else APIHelper.SKIP
        allocation_to_annuities = dictionary.get("allocationToAnnuities") if dictionary.get("allocationToAnnuities") else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'risk_override={(self.risk_override if hasattr(self, "risk_override") else None)!r}, '
                f'engaged_participant={(self.engaged_participant if hasattr(self, "engaged_participant") else None)!r}, '
                f'required_data_available={(self.required_data_available if hasattr(self, "required_data_available") else None)!r}, '
                f'wealth_path_probabilities={(self.wealth_path_probabilities if hasattr(self, "wealth_path_probabilities") else None)!r}, '
                f'last_reallocation_probability={(self.last_reallocation_probability if hasattr(self, "last_reallocation_probability") else None)!r}, '
                f'last_reallocation_date={(self.last_reallocation_date if hasattr(self, "last_reallocation_date") else None)!r}, '
                f'plan_id={(self.plan_id if hasattr(self, "plan_id") else None)!r}, '
                f'participant_id={(self.participant_id if hasattr(self, "participant_id") else None)!r}, '
                ...
                f'retirement_date={(self.retirement_date if hasattr(self, "retirement_date") else None)!r}, '
                f'target_portfolio={(self.target_portfolio if hasattr(self, "target_portfolio") else None)!r}, '
                f'mode={(self.mode if hasattr(self, "mode") else None)!r}, '
                f'min_equity_allocation={(self.min_equity_allocation if hasattr(self, "min_equity_allocation") else None)!r}, '
                f'max_equity_allocation={(self.max_equity_allocation if hasattr(self, "max_equity_allocation") else None)!r}, '
                f'allocation_to_annuities={(self.allocation_to_annuities if hasattr(self, "allocation_to_annuities") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'risk_override={(self.risk_override if hasattr(self, "risk_override") else None)!s}, '
                f'engaged_participant={(self.engaged_participant if hasattr(self, "engaged_participant") else None)!s}, '
                f'required_data_available={(self.required_data_available if hasattr(self, "required_data_available") else None)!s}, '
                f'wealth_path_probabilities={(self.wealth_path_probabilities if hasattr(self, "wealth_path_probabilities") else None)!s}, '
                f'last_reallocation_probability={(self.last_reallocation_probability if hasattr(self, "last_reallocation_probability") else None)!s}, '
                f'last_reallocation_date={(self.last_reallocation_date if hasattr(self, "last_reallocation_date") else None)!s}, '
                f'plan_id={(self.plan_id if hasattr(self, "plan_id") else None)!s}, '
                f'participant_id={(self.participant_id if hasattr(self, "participant_id") else None)!s}, '
                ...
                f'retirement_date={(self.retirement_date if hasattr(self, "retirement_date") else None)!s}, '
                f'target_portfolio={(self.target_portfolio if hasattr(self, "target_portfolio") else None)!s}, '
                f'mode={(self.mode if hasattr(self, "mode") else None)!s}, '
                f'min_equity_allocation={(self.min_equity_allocation if hasattr(self, "min_equity_allocation") else None)!s}, '
                f'max_equity_allocation={(self.max_equity_allocation if hasattr(self, "max_equity_allocation") else None)!s}, '
                f'allocation_to_annuities={(self.allocation_to_annuities if hasattr(self, "allocation_to_annuities") else None)!s}, '
