...
class AnalysisReport1(object):
    ...
    def __init__(self,
        ...
        """Constructor for the AnalysisReport1 class"""
    ...
    def from_dictionary(cls,
        ...
        expected_taxes_for_current_year = ExpectedTaxesForCurrentYear2.from_dictionary(dictionary.get('expectedTaxesForCurrentYear')) if dictionary.get('expectedTaxesForCurrentYear') else None
        ...
        proposed_trades_current_year = ProposedTradesCurrentYear2.from_dictionary(dictionary.get('proposedTradesCurrentYear')) if dictionary.get('proposedTradesCurrentYear') else None
