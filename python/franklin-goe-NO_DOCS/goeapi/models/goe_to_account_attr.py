...
from goeapi.models.goe_to_cashflow_details_2 import (
...
class GoeToAccountAttr(object):
    ...
    def __init__(self,
        ...
        """Initialize a GoeToAccountAttr instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("currentHoldings") is not None:
            current_holdings = [
                GoeToCategory.from_dictionary(x)
                    for x in dictionary.get("currentHoldings")
            ]
        cashflow_details = GoeToCashflowDetails2.from_dictionary(
