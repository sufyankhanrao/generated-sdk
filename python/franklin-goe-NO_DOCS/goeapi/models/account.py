...
class Account(object):
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('currentHoldings') is not None:
            current_holdings = [Category.from_dictionary(x) for x in dictionary.get('currentHoldings')]
        cashflow_details = CashflowDetails2.from_dictionary(dictionary.get('cashflowDetails')) if dictionary.get('cashflowDetails') else None
