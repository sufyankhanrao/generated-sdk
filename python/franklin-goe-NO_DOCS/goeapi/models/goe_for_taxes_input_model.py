...
class GoeForTaxesInputModel(object):
    ...
    def __init__(self,
        ...
        """Constructor for the GoeForTaxesInputModel class"""
    ...
    def from_dictionary(cls,
        ...
        tax_rates = TaxRatesDic2.from_dictionary(dictionary.get('taxRates')) if dictionary.get('taxRates') else None
        household = HouseholdGoeForTaxesObj2.from_dictionary(dictionary.get('household')) if dictionary.get('household') else None
        accounts = None
        if dictionary.get('accounts') is not None:
            accounts = [GoeToAccountAttr.from_dictionary(x) for x in dictionary.get('accounts')]
        goal_profile_list = None
        if dictionary.get('goalProfileList') is not None:
            goal_profile_list = [GoalProfileGoeForTaxesAttr.from_dictionary(x) for x in dictionary.get('goalProfileList')]
