...
class GoeSimulationEngineInputModel(object):
    ...
    def from_dictionary(cls,
        ...
        tax_rates = TaxRates2.from_dictionary(
            dictionary.get("taxRates"))\
            if dictionary.get("taxRates") else None
        household = Household2.from_dictionary(
        ...
        is_new_goal_priority =\
            ...
            if "isNewGoalPriority" in dictionary.keys() else APIHelper.SKIP
        curr_date =\
        ...
        is_new_investment_tenure =\
            ...
            if "isNewInvestmentTenure" in dictionary.keys() else APIHelper.SKIP
        is_new_goal =\
            dictionary.get("isNewGoal")\
            if "isNewGoal" in dictionary.keys() else APIHelper.SKIP
        loss_threshold =\
            dictionary.get("lossThreshold")\
            if dictionary.get("lossThreshold") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"is_new_goal_priority={(self.is_new_goal_priority
                     if hasattr(self, 'is_new_goal_priority') else None)!r}, "
                ...
                f"is_new_investment_tenure={(self.is_new_investment_tenure
                     if hasattr(self, 'is_new_investment_tenure') else None)!r}, "
                f"is_new_goal={(self.is_new_goal
                     if hasattr(self, 'is_new_goal') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"is_new_goal_priority={(self.is_new_goal_priority
                     if hasattr(self, 'is_new_goal_priority') else None)!s}, "
                ...
                f"is_new_investment_tenure={(self.is_new_investment_tenure
                     if hasattr(self, 'is_new_investment_tenure') else None)!s}, "
                f"is_new_goal={(self.is_new_goal
                     if hasattr(self, 'is_new_goal') else None)!s}, "
                f"loss_threshold={(self.loss_threshold
