...
from goeapi.models.tenure_recommendation_1 import TenureRecommendation1
...
class UpaAnalysisReport1(object):
    ...
    def __init__(self,
        ...
        """Constructor for the UpaAnalysisReport1 class"""
    ...
    def from_dictionary(cls,
        ...
        cashflow_recommendation = CashflowRecommendation1.from_dictionary(dictionary.get('cashflowRecommendation')) if dictionary.get('cashflowRecommendation') else None
        ...
        tenure_recommendation = TenureRecommendation1.from_dictionary(dictionary.get('tenureRecommendation')) if dictionary.get('tenureRecommendation') else None
