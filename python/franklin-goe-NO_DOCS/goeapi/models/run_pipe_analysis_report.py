...
class RunPipeAnalysisReport(object):
    ...
    def __init__(self,
        ...
        """Initialize a RunPipeAnalysisReport instance."""
    ...
    def from_dictionary(cls,
        ...
        yearly_top_up_accumulation =\
            ...
            if dictionary.get("yearlyTopUpAccumulation") else None
        monthly_top_up_accumulation =\
            dictionary.get("monthlyTopUpAccumulation")\
            if dictionary.get("monthlyTopUpAccumulation") else None
        yearly_top_up_decumulation =\
            dictionary.get("yearlyTopUpDecumulation")\
            if dictionary.get("yearlyTopUpDecumulation") else None
        monthly_top_up_decumulation =\
            dictionary.get("monthlyTopUpDecumulation")\
            if dictionary.get("monthlyTopUpDecumulation") else None
        recommended_tenure =\
            dictionary.get("recommendedTenure")\
            if dictionary.get("recommendedTenure") else None
        bankruptcy_msg =\
        ...
        recommended_final_wealth_at_75 =\
            dictionary.get("recommendedFinalWealthAt75")\
            if dictionary.get("recommendedFinalWealthAt75") else APIHelper.SKIP
        recommended_prob_at_75 =\
            dictionary.get("recommendedProbAt75")\
            if dictionary.get("recommendedProbAt75") else APIHelper.SKIP
        recommended_final_wealth_at_50 =\
            dictionary.get("recommendedFinalWealthAt50")\
            if dictionary.get("recommendedFinalWealthAt50") else APIHelper.SKIP
        recommended_prob_at_50 =\
            dictionary.get("recommendedProbAt50")\
            if dictionary.get("recommendedProbAt50") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"monthly_top_up_accumulation={
                    self.monthly_top_up_accumulation!r}, "
                f"yearly_top_up_decumulation={self.yearly_top_up_decumulation!r}, "
                f"monthly_top_up_decumulation={
                    self.monthly_top_up_decumulation!r}, "
                f"recommended_tenure={self.recommended_tenure!r}, "
                f"bankruptcy_msg={self.bankruptcy_msg!r}, "
                f"recommended_final_wealth_at_75={(self.recommended_final_wealth_at_75
                     if hasattr(self, 'recommended_final_wealth_at_75') else None)!r}, "
                f"recommended_prob_at_75={(self.recommended_prob_at_75
                     if hasattr(self, 'recommended_prob_at_75') else None)!r}, "
                f"recommended_final_wealth_at_50={(self.recommended_final_wealth_at_50
                     if hasattr(self, 'recommended_final_wealth_at_50') else None)!r}, "
                f"recommended_prob_at_50={(self.recommended_prob_at_50
                     if hasattr(self, 'recommended_prob_at_50') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"monthly_top_up_accumulation={
                    self.monthly_top_up_accumulation!s}, "
                f"yearly_top_up_decumulation={self.yearly_top_up_decumulation!s}, "
                f"monthly_top_up_decumulation={
                    self.monthly_top_up_decumulation!s}, "
                f"recommended_tenure={self.recommended_tenure!s}, "
                f"bankruptcy_msg={self.bankruptcy_msg!s}, "
                f"recommended_final_wealth_at_75={(self.recommended_final_wealth_at_75
                     if hasattr(self, 'recommended_final_wealth_at_75') else None)!s}, "
                f"recommended_prob_at_75={(self.recommended_prob_at_75
                     if hasattr(self, 'recommended_prob_at_75') else None)!s}, "
                f"recommended_final_wealth_at_50={(self.recommended_final_wealth_at_50
                     if hasattr(self, 'recommended_final_wealth_at_50') else None)!s}, "
                f"recommended_prob_at_50={(self.recommended_prob_at_50
                     if hasattr(self, 'recommended_prob_at_50') else None)!s}, "
