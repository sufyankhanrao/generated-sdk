...
class GoeForDecumulationInputModel(object):
    ...
    def __init__(self,
        ...
        """Initialize a GoeForDecumulationInputModel instance."""
    ...
    def from_dictionary(cls,
        ...
        future_annuity_proj =\
            dictionary.get("futureAnnuityProj")\
            if "futureAnnuityProj" in dictionary.keys() else None
        risk_profile =\
        ...
        db_income =\
            dictionary.get("dbIncome")\
            if dictionary.get("dbIncome") else None
        other_guaranteed_income =\
            dictionary.get("otherGuaranteedIncome")\
            if dictionary.get("otherGuaranteedIncome") else None
        existing_annuities_income =\
            dictionary.get("existingAnnuitiesIncome")\
            if dictionary.get("existingAnnuitiesIncome") else None
        state_income =\
            dictionary.get("stateIncome")\
            if dictionary.get("stateIncome") else None
        target_expenditures =\
            dictionary.get("targetExpenditures")\
            if dictionary.get("targetExpenditures") else None
        fixed_expense_fact =\
            dictionary.get("fixedExpenseFact")\
            if dictionary.get("fixedExpenseFact") else None
        current_wealth =\
        ...
        annuity_rate =\
            dictionary.get("annuityRate")\
            if dictionary.get("annuityRate") else None
        reallocation_freq =\
        ...
        health_status =\
            dictionary.get("healthStatus")\
            if dictionary.get("healthStatus") else APIHelper.SKIP
        cashflow_date =\
        ...
        retirement_age =\
            ...
            if dictionary.get("retirementAge") else 65
        reallocate =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"health_status={(self.health_status
                     if hasattr(self, 'health_status') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"health_status={(self.health_status
                     if hasattr(self, 'health_status') else None)!s}, "
