...
from batesterwithcustomparameters.http.proxy_settings import (
    ProxySettings,
)
from batesterwithcustomparameters.models.suite_code_enum import (
    SuiteCodeEnum,
)
...
class Configuration(HttpClientConfiguration):
    ...
    def __init__(self, http_client_instance=None,
                 ...
                 username="farhan", password="apimatic", basic_auth_credentials=None):
        ...
        self._basic_auth_credentials =\
            self.create_auth_credentials_object(username, password,
    ...
    def clone_with(self, http_client_instance=None,
                   ...
                   environment=None, port=None, suites=None, username=None,
                   password=None, basic_auth_credentials=None):
    ...
    def create_auth_credentials_object(username, password,
        ...
        from batesterwithcustomparameters.http.auth.basic_auth import (  # noqa: E501
