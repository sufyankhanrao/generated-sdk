...
from batesterwithcustomparameters.controllers.api_controller import (
    APIController,
)
from batesterwithcustomparameters.controllers.base_controller import (
    BaseController,
)
from batesterwithcustomparameters.http.auth.basic_auth import (
    BasicAuth,
)


class BatesterwithcustomparametersClient(object):
    """Client that provide access to the BatesterwithcustomparametersClient APIs."""
    ...
    def __init__(self, http_client_instance=None,
        ...
        """Initialize a new instance of BatesterwithcustomparametersClient."""
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        Returns:
            BatesterwithcustomparametersClient instance.
