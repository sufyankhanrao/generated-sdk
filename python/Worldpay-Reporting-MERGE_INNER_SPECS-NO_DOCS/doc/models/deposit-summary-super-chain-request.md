...
# Deposit Summary Super Chain Request

## Structure

`DepositSummarySuperChainRequest`
...
| `hierarchy` | [`EntityListTypeSuperChain`](../../doc/models/entity-list-type-super-chain.md) | Required | Refers to merchant hierarchy levels |
