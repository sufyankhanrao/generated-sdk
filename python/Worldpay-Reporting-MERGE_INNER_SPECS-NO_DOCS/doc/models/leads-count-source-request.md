...
# Leads Count Source Request

Request message to get leads count by source.

## Structure

`LeadsCountSourceRequest`
...
| `sort_results_by` | [`SortPartner`](../../doc/models/sort-partner.md) | Optional | Sorting order for the search results of leads source. |
