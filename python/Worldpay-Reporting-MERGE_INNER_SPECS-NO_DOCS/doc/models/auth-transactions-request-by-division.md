...
# Auth Transactions Request by Division

## Structure

`AuthTransactionsRequestByDivision`
...
| `hierarchy` | [`EntityParentTypeDivision`](../../doc/models/entity-parent-type-division.md) | Required | Refers to merchant hierarchy levels |
| `card_type` | `str` | Optional | Types of card used for the payment. <br> Default - Credit.<br><br>**Constraints**: *Minimum Length*: `0`, *Maximum Length*: `255` |
