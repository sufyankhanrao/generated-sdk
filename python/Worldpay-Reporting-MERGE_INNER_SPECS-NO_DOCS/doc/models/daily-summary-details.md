...
| `credit_sales_amount` | `float` | Optional | Credit card sales amount.<br><br>**Constraints**: `>= 0`, `<= 9999999999999.99` |
| `credit_sales_count` | `int` | Optional | Credit card sales count.<br><br>**Constraints**: `>= 0`, `<= 9999999999` |
| `credit_returns_amount` | `float` | Optional | Credit card returns amount.<br><br>**Constraints**: `>= 0`, `<= 9999999999999.99` |
| `credit_returns_count` | `int` | Optional | Credit card returns count.<br><br>**Constraints**: `>= 0`, `<= 9999999999` |
...
| `gift_sales_amount` | `float` | Optional | Gift card sales amount<br><br>**Constraints**: `>= 0`, `<= 9999999999999.99` |
| `gift_sales_count` | `int` | Optional | Gift card sales count<br><br>**Constraints**: `>= 0`, `<= 9999999999` |
| `chargeback_sales_amount` | `float` | Optional | Amount of sales which resulted in chargebacks.<br><br>**Constraints**: `>= 0`, `<= 9999999999999.99` |
| `chargeback_sales_count` | `int` | Optional | Count of sales which resulted in chargebacks.<br><br>**Constraints**: `>= 0`, `<= 9999999999` |
| `process_date` | `str` | Optional | Date when transaction was processed.<br><br>**Constraints**: *Minimum Length*: `10`, *Maximum Length*: `10`, *Pattern*: `^[0-9]{4}-[0-9]{2}-[0-9]{2}$` |
