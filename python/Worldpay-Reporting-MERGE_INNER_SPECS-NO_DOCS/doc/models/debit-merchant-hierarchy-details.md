...
# Debit Merchant Hierarchy Details

Resource is used to retrieve debit details at merchant level.

## Structure

`DebitMerchantHierarchyDetails`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `acro` | `str` | Optional | Refers to merchant acro<br><br>**Constraints**: *Maximum Length*: `4` |
...
| `merchant_name` | `str` | Optional | Merchant Name refers to the name registered for business.<br><br>**Constraints**: *Maximum Length*: `256` |
| `process_location` | `str` | Optional | Refers to the process location.<br><br>**Constraints**: *Maximum Length*: `2` |
