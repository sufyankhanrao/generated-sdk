...
# Auth Transactions Request by Chain

## Structure

`AuthTransactionsRequestByChain`
...
| `hierarchy` | [`EntityChain`](../../doc/models/entity-chain.md) | Required | Refers to merchant hierarchy levels |
