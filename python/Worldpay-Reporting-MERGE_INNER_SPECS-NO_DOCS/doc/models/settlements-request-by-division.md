...
# Settlements Request by DIVISION

## Structure

`SettlementsRequestByDIVISION`
...
| `hierarchy` | [`EntityParentTypeDivision2`](../../doc/models/entity-parent-type-division-2.md) | Required | Merchant hierarchy details |
