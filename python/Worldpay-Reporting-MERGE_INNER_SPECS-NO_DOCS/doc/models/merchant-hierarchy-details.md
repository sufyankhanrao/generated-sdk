...
| `alternate_merchant_id` | `str` | Optional | This fields indicates to alternate merchant id.<br><br>**Constraints**: *Maximum Length*: `20` |
...
```json
{
  ...
  "alternateMerchantId": "5200006658643423645"
}
```
