...
# Credit Card Activity Summary Request

This object is used to retrieve card activity summary.

## Structure

`CreditCardActivitySummaryRequest`
...
| `card_network` | [`CardNetwork2Enum`](../../doc/models/card-network-2-enum.md) | Required | Indicates the network of the cards which is associated with facilitating the payment.Card Type mandatory when adding card network.<br><br>**Constraints**: *Maximum Length*: `13` |
