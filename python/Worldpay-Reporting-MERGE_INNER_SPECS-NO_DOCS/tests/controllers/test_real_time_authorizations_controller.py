...
class RealTimeAuthorizationsControllerTests(ControllerTestBase):
    ...
    def test_retrieve_real_time_transaction_detals_by_credit_transaction_id(self):
        ...
        self.controller.retrieve_real_time_transaction_detals_by_credit_transaction_id(
            transaction_id,
            v_correlation_id,
        )
        # Test response code
    ...
    def test_retrieve_real_time_transaction_detals_by_debit_transaction_id(self):
        ...
        # Perform the API call through the SDK function
        self.controller.retrieve_real_time_transaction_detals_by_debit_transaction_id(
            transaction_id,
            v_correlation_id,
        )
        # Test response code
    ...
    def test_retrieve_real_time_transaction_detals_by_gift_transaction_id(self):
        ...
        # Perform the API call through the SDK function
        self.controller.retrieve_real_time_transaction_detals_by_gift_transaction_id(
            transaction_id,
            v_correlation_id,
        )
        # Test response code
