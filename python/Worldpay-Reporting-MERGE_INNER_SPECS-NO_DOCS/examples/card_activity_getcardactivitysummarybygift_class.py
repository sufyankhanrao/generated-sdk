...
from reportingapi.models.gift_card_activity_summary_request import GiftCardActivitySummaryRequest
from reportingapi.models.gift_card_network_enum import GiftCardNetworkEnum
