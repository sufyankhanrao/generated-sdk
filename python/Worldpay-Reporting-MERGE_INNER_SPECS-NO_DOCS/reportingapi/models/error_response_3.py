...
class ErrorResponse3(object):

    """Implementation of the 'ErrorResponse3' model.

    Returned if any error.

    Attributes:
        errors (List[Error2]): The model property of type List[Error2].
    ...
    def __init__(self,
        ...
        """Constructor for the ErrorResponse3 class"""
