...
class EntityParentTypeDivision1(object):
    """Implementation of the 'EntityParentTypeDivision1' model.

    Attributes:
        level (Level5Enum): Refers to hierarchy level
    ...
    def __init__(self,
        ...
        """Initialize a EntityParentTypeDivision1 instance."""
