...
class EntityParentTypeStore1(object):
    """Implementation of the 'EntityParentTypeStore1' model.

    Attributes:
        level (Level3Enum): Refers to hierarchy level
    ...
    def __init__(self,
        ...
        """Initialize a EntityParentTypeStore1 instance."""
