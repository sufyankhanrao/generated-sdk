...
from reportingapi.http.proxy_settings import (
    ProxySettings,
)
...
class Configuration(HttpClientConfiguration):
    ...
    def authorization(self):
        """Return Authorization from CustomHeaderAuthenticationCredentials."""
        return self._custom_header_authentication_credentials.authorization
    ...
    def clone_with(self, http_client_instance=None,
                   ...
                   retry_statuses=None, retry_methods=None, proxy_settings=None,
                   environment=None, authorization=None,
                   custom_header_authentication_credentials=None):
    ...
    environments = {
        Environment.PRODUCTION: {
            Server.DEFAULT: "https://apis.stage.worldpay.com/merchant-reporting/authorizationbatches/v1",
            Server.DEFAULT1: "https://apis.stage.worldpay.com/merchant-reporting/authorizationresearch/v1",
            Server.DEFAULT2: "https://apis.stage.worldpay.com/merchant-reporting/authorizationsummary/v2",
            Server.DEFAULT3: "https://apis.cert.worldpay.com/merchant-reporting/bankpartnerreporting/v1",
            Server.DEFAULT4: "https://apis.cert.worldpay.com/merchant-reporting/depositresearch/v1",
            Server.DEFAULT5: "https://apis.stage.worldpay.com/merchant-reporting/depositsummary/v2",
            Server.DEFAULT6: "https://apis.stage.worldpay.com/merchant-reporting/sales-pipeline/v1",
            Server.DEFAULT7: "https://apis.stage.worldpay.com/merchant-reporting/settlementresearch/v1",
            Server.DEFAULT8: "https://apis.stage.worldpay.com/merchant-reporting/settlementsummary/v2",
            Server.DEFAULT9: "https://apis.stage.worldpay.com/merchant-reporting/taxforms/v2",
        },
    }
    ...
    def create_auth_credentials_object(authorization,
        ...
        warnings.warn(message=("The 'authorization' params are deprecated. Use "
                               "'custom_header_authentication_credentials' para"
                               "m instead."),
        ...
        return CustomHeaderAuthenticationCredentials(authorization)
