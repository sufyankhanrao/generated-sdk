...
from typecombinatorcomplex.http.proxy_settings import (
    ProxySettings,
)
...
class Configuration(HttpClientConfiguration):
    ...
    @property
    def sub_url(self):
        """Return current sub_url."""
        return self._sub_url

    def __init__(self, http_client_instance=None,
                 override_http_client_configuration=False, http_call_back=None,
                 timeout=60, max_retries=0, backoff_factor=0, retry_statuses=None,
    ...
    def clone_with(self, http_client_instance=None,
        ...
        sub_url = sub_url or self.sub_url
        return Configuration(
            ...
            environment=environment, sub_url=sub_url,
        )
    ...
    environments = {
        Environment.PRODUCTION: {
            Server.DEFAULT: "https://enehkteyzt55p.x.pipedream.net/{subUrl}",
        },
        Environment.TESTING: {
            Server.DEFAULT: "http://localhost:3000/{subUrl}",
        },
    }
    ...
    def get_base_uri(self, server=Server.DEFAULT):
        ...
        """
        parameters = {
            "subUrl": {"value": self.sub_url, "encode": False},
        }
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        backoff_factor = float(os.getenv("BACKOFF_FACTOR", "0"))
        ...
        sub_url = os.getenv("SUB_URL", "multitype/complex")
