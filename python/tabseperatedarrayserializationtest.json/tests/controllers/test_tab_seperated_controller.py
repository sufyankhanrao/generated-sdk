...
from tabseperatedarrayserialization.models.complex_type import (
    ComplexType,
)
...
class TabSeperatedControllerTests(ControllerTestBase):
    ...
    def test_tab_seperated_array_serialization_in_query(self):
        """
        Api call test for `test_tab_seperated_array_serialization_in_query`.
        """
        ...
        result = self.controller.get_tab_seperated_in_query(
            dependent,
        )
        # Test response code
    ...
    def test_tab_seperated_array_serialization_in_query_1(self):
        """
        Api call test for `test_tab_seperated_array_serialization_in_query_1`.
        """
        # Parameters for the API call
        dependent = APIHelper.json_deserialize(
            "[\"&&\",\"**\",\"||\",\"$$\"]",
    ...
    def test_send_tab_separated_complex_type_in_query(self):
        """
        Api call test for `test_send_tab_separated_complex_type_in_query`.
        """
        # Parameters for the API call
        ...
        # Perform the API call through the SDK function
        result = self.controller.create_send_tab_separated_complex_type_in_query(
            complex_type,
        )
        # Test response code
        assert self.response_catcher.response.status_code == 200
    ...
    def test_send_tab_separated_list_of_complex_type_in_query(self):
        """
        Api call test for `test_send_tab_separated_list_of_complex_type_in_query`.
        """
        # Parameters for the API call
        complex_type = APIHelper.json_deserialize(
            "[{\"numberListType\":[555,666,777],\"numberMapType\":{\"num1\":1,\"num3"
        ...
        # Perform the API call through the SDK function
        result = self.controller.create_send_tab_separated_list_of_complex_type_in_query( # noqa: E501
            complex_type,
        )
        # Test response code
        assert self.response_catcher.response.status_code == 200
    ...
    def test_send_tab_separated_map_of_complex_type_in_query(self):
        """
        Api call test for `test_send_tab_separated_map_of_complex_type_in_query`.
        """
        # Parameters for the API call
        complex_type = APIHelper.json_deserialize(
        ...
        # Perform the API call through the SDK function
        result = self.controller.create_send_tab_separated_map_of_complex_type_in_query( # noqa: E501
            complex_type,
        )
        # Test response code
        assert self.response_catcher.response.status_code == 200
