...
class TabSeperatedControllerTests(ControllerTestBase):

    controller = None

    @classmethod
    def setUpClass(cls):
        super(TabSeperatedControllerTests, cls).setUpClass()
        cls.controller = cls.client.tab_seperated
        cls.response_catcher = cls.controller.http_call_back

    # Todo: Add description for test test_tab_seperated_array_serialization_in_query
    def test_tab_seperated_array_serialization_in_query(self):
        # Parameters for the API call
        dependent = APIHelper.json_deserialize('["ab","bc","cd","ef"]')

        # Perform the API call through the SDK function
        result = self.controller.get_tab_seperated_in_query(dependent)
    ...
    # Todo: Add description for test test_tab_seperated_array_serialization_in_query_1
    def test_tab_seperated_array_serialization_in_query_1(self):
        # Parameters for the API call
    ...
    # Todo: Add description for test test_send_tab_separated_complex_type_in_query
    def test_send_tab_separated_complex_type_in_query(self):
        # Parameters for the API call
        ...
        # Perform the API call through the SDK function
        result = self.controller.create_send_tab_separated_complex_type_in_query(complex_type)
    ...
    # Todo: Add description for test test_send_tab_separated_list_of_complex_type_in_query
    def test_send_tab_separated_list_of_complex_type_in_query(self):
        # Parameters for the API call
        ...
        # Perform the API call through the SDK function
        result = self.controller.create_send_tab_separated_list_of_complex_type_in_query(complex_type)
    ...
    # Todo: Add description for test test_send_tab_separated_map_of_complex_type_in_query
    def test_send_tab_separated_map_of_complex_type_in_query(self):
        # Parameters for the API call
        ...
        # Perform the API call through the SDK function
        result = self.controller.create_send_tab_separated_map_of_complex_type_in_query(complex_type)
