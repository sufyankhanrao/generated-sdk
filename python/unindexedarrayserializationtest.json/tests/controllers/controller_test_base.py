...
from unindexedarrayserialization.unindexedarrayserialization_client import (
    UnindexedarrayserializationClient,
)
...
class ControllerTestBase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.client = UnindexedarrayserializationClient(config=cls.config)
