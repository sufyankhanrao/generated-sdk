...
class Configuration(HttpClientConfiguration):
    ...
    def o_auth_client_id(self):
        """Return OAuthClientId from ImplicitAuthCredentials."""
        return self._implicit_auth_credentials.o_auth_client_id

    @property
    def o_auth_redirect_uri(self):
        """Return OAuthRedirectUri from ImplicitAuthCredentials."""
        return self._implicit_auth_credentials.o_auth_redirect_uri

    @property
    def o_auth_scopes(self):
        """Return OAuthScopes from ImplicitAuthCredentials."""
        return self._implicit_auth_credentials.o_auth_scopes

    @property
    def o_auth_token(self):
        """Return OAuthToken from ImplicitAuthCredentials."""
        return self._implicit_auth_credentials.o_auth_token

    @property
    def implicit_auth_credentials(self):
        """Return ImplicitAuthCredentials."""
        return self._implicit_auth_credentials
    ...
    def clone_with(self, http_client_instance=None,
        ...
        basepath = basepath or self.basepath
        implicit_auth_credentials = self.create_auth_credentials_object(
            o_auth_client_id, o_auth_redirect_uri, o_auth_token, o_auth_scopes,
            implicit_auth_credentials
            or self.implicit_auth_credentials,
            stack_level=3)
    ...
    def get_base_uri(self, server=Server.DEFAULT):
        ...
        """
        parameters = {
            "basepath": {"value": self.basepath, "encode": False},
        }
    ...
    @staticmethod
    def create_auth_credentials_object(o_auth_client_id, o_auth_redirect_uri,
                                       o_auth_token, o_auth_scopes,
                                       implicit_auth_credentials,
                                       stack_level=4):
        ...
        if implicit_auth_credentials is not None:
            return implicit_auth_credentials.clone_with(o_auth_client_id,
                                                        o_auth_redirect_uri,
                                                        o_auth_token,
                                                        o_auth_scopes)
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        default_config = cls(
            ...
            implicit_auth_credentials=ImplicitAuthCredentials.from_environment(),
        )
