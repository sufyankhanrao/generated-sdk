...
from dropbox.configuration import (
    Configuration,
    Environment,
)
...
from dropbox.controllers.files_controller import (
    FilesController,
)
from dropbox.http.auth.o_auth_2 import OAuth2


class DropboxClient(object):
    """Client that provide access to the DropboxClient APIs."""
    ...
    @property
    def http_ig(self):
        """Provide access to the HttpIG auth manager."""
        return self.auth_managers["httpIG"]
    ...
    def __init__(self, http_client_instance=None,
                 ...
                 config=None):
        """Initialize a new instance of DropboxClient."""
        self.config = config or Configuration(
            ...
            basepath=basepath, o_auth_client_id=o_auth_client_id,
        ...
        self.auth_managers = {
            "httpIG": OAuth2(self.config.implicit_auth_credentials,
