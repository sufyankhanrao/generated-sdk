...
from plainarrayserialization.models.complex_type import (
    ComplexType,
)
from plainarrayserialization.models.employee import (
    Employee,
)
from plainarrayserialization.models.model import (
    Model,
)
...
class PlainControllerTests(ControllerTestBase):
    ...
    def test_plain_form_array_serialization(self):
        """
        Api call test for `test_plain_form_array_serialization`.
        """
        ...
        result = self.controller.create_plain_form(
            model,
        )
        # Test response code
    ...
    def test_plain_serialization_in_query(self):
        """
        Api call test for `test_plain_serialization_in_query`.
        """
        # Parameters for the API call
        ...
        # Perform the API call through the SDK function
        result = self.controller.get_plain_query(
            query_param,
        )
        # Test response code
        assert self.response_catcher.response.status_code == 200
    ...
    def test_plain_body_array_serialization(self):
        ...
        # Perform the API call through the SDK function
        result = self.controller.create_plain_body(
            model,
        )
        # Test response code
        assert self.response_catcher.response.status_code == 200
    ...
    def test_send_plain_complex_type_in_query(self):
        """
        Api call test for `test_send_plain_complex_type_in_query`.
        """
        # Parameters for the API call
        ...
        # Perform the API call through the SDK function
        result = self.controller.create_send_plain_complex_type_in_query(
            complex_type,
        )
        # Test response code
        assert self.response_catcher.response.status_code == 200
    ...
    def test_send_plain_list_of_complex_type_in_query(self):
        """
        Api call test for `test_send_plain_list_of_complex_type_in_query`.
        """
        # Parameters for the API call
        complex_type = APIHelper.json_deserialize(
            "[{\"numberListType\":[555,666,777],\"numberMapType\":{\"num1\":1,"
        ...
        # Perform the API call through the SDK function
        result = self.controller.create_send_plain_list_of_complex_type_in_query(
            complex_type,
        )
        # Test response code
        assert self.response_catcher.response.status_code == 200
    ...
    def test_send_plain_map_of_complex_type_in_query(self):
        """
        Api call test for `test_send_plain_map_of_complex_type_in_query`.
        """
        # Parameters for the API call
        complex_type = APIHelper.json_deserialize(
        ...
        # Perform the API call through the SDK function
        result = self.controller.create_send_plain_map_of_complex_type_in_query(
            complex_type,
        )
        # Test response code
        assert self.response_catcher.response.status_code == 200
