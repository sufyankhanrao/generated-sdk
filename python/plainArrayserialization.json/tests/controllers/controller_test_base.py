...
from plainarrayserialization.plainarrayserialization_client import (
    PlainarrayserializationClient,
)
...
class ControllerTestBase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.client = PlainarrayserializationClient(config=cls.config)
