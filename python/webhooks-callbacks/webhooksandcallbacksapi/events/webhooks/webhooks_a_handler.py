...
class WebhooksAHandler:
    ...
    def verify_and_parse_event(self, request: Request) -> WebhooksAEventType:
        """
         Verify the request signature and parse the event.

        :return: PaymentStatusUpdatedEvent, PaymentStatusCreatedEvent for
                 successful parsing; SignatureVerificationFailure when signature
                 fails; UnknownEvent for unknown events.
        :rtype: Union[PaymentStatusUpdatedEvent, PaymentStatusCreatedEvent,
