...
class WebhooksCHandler:
    ...
    def verify_and_parse_event(self, request: Request) -> WebhooksCEventType:
        """
         Verify the request signature and parse the event.

        :return: str, int, List[float], Dict[str, str] for successful parsing;
                 SignatureVerificationFailure when signature fails; UnknownEvent for
                 unknown events.
        :rtype: Union[str, int, List[float], Dict[str, str],
