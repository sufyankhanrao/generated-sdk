...
CallbacksAEventType = Union[FulfillmentCallback, SignatureVerificationFailure, UnknownEvent]
...
class CallbacksAHandler:
    ...
    def verify_and_parse_event(self, request: Request) -> CallbacksAEventType:
        ...
        :return: FulfillmentCallback for successful parsing;
                 SignatureVerificationFailure when signature fails; UnknownEvent
                 for unknown events.
        :rtype: Union[FulfillmentCallback, SignatureVerificationFailure,
                UnknownEvent]
        """
