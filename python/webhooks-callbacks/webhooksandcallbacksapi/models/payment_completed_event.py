...
class PaymentCompletedEvent(object):
    ...
    def __init__(self,
        ...
        """Constructor for the PaymentCompletedEvent class"""
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.payment_id,
                                           type_callable=lambda value: isinstance(value, int))

        if not isinstance(dictionary, dict):
            return False

        return APIHelper.is_valid_type(value=dictionary.get('paymentId'),
                                       type_callable=lambda value: isinstance(value, int))
