...
from mdnotesropcgwithoutauthscopes.configuration import Configuration, Environment
...
class ControllerTestBase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        resource_owner_auth_credentials = cls.config.resource_owner_auth_credentials\
            .clone_with(o_auth_token=http_ropcg_token)
        cls.config = cls.config.clone_with(resource_owner_auth_credentials=resource_owner_auth_credentials)
