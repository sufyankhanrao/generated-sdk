...
from mdnotesropcgwithoutauthscopes.api_helper import (
    APIHelper,
)
from mdnotesropcgwithoutauthscopes.controllers.o_auth_authorization_controller import (
    OAuthAuthorizationController,
)
from mdnotesropcgwithoutauthscopes.models.o_auth_token import (
    OAuthToken,
)
...
class OAuth2(HeaderAuth):
    """
    An authentication handler that applies `ResourceOwnerAuth` to
    ...
    def __init__(self, auth_credentials_model, config):
        ...
        self._o_auth_client_secret = auth_credentials_model.o_auth_client_secret \
            if auth_credentials_model is not None else None
        self._o_auth_username = auth_credentials_model.o_auth_username \
            if auth_credentials_model is not None else None
        self._o_auth_password = auth_credentials_model.o_auth_password \
            if auth_credentials_model is not None else None
...
class ResourceOwnerAuthCredentials:
    ...
    def __init__(self, o_auth_client_id, o_auth_client_secret, o_auth_username,
        ...
        Args:
            ...
            o_auth_username: The o_auth_username property value to set.
            o_auth_password: The o_auth_password property value to set.
    ...
    def from_environment(cls):
        ...
        o_auth_username = os.getenv(
            "O_AUTH_USERNAME",
            None,
        )
        o_auth_password = os.getenv(
            "O_AUTH_PASSWORD",
            None,
        )
        ...
        if (o_auth_client_id is None
                ...
                or o_auth_username is None
                or o_auth_password is None):
            return None
