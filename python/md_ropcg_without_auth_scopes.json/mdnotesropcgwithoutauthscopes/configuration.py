...
from mdnotesropcgwithoutauthscopes.http.proxy_settings import (
    ProxySettings,
)
...
class Configuration(HttpClientConfiguration):
    ...
    def o_auth_client_id(self):
        """Return OAuthClientId from ResourceOwnerAuthCredentials."""
        return self._resource_owner_auth_credentials.o_auth_client_id

    @property
    def o_auth_client_secret(self):
        """Return OAuthClientSecret from ResourceOwnerAuthCredentials."""
        return self._resource_owner_auth_credentials.o_auth_client_secret

    @property
    def o_auth_username(self):
        """Return OAuthUsername from ResourceOwnerAuthCredentials."""
        return self._resource_owner_auth_credentials.o_auth_username

    @property
    def o_auth_password(self):
        """Return OAuthPassword from ResourceOwnerAuthCredentials."""
        return self._resource_owner_auth_credentials.o_auth_password

    @property
    def o_auth_token(self):
        """Return OAuthToken from ResourceOwnerAuthCredentials."""
        return self._resource_owner_auth_credentials.o_auth_token

    @property
    def resource_owner_auth_credentials(self):
        """Return ResourceOwnerAuthCredentials."""
        return self._resource_owner_auth_credentials
    ...
    def __init__(self, http_client_instance=None,
                 ...
                 o_auth_token=None, resource_owner_auth_credentials=None):
        ...
        self._resource_owner_auth_credentials =\
            self.create_auth_credentials_object(o_auth_client_id,
    ...
    def clone_with(self, http_client_instance=None,
        ...
        resource_owner_auth_credentials = self.create_auth_credentials_object(
            o_auth_client_id, o_auth_client_secret, o_auth_username,
            o_auth_password, o_auth_token,
            resource_owner_auth_credentials
            or self.resource_owner_auth_credentials,
            stack_level=3)
    ...
    def create_auth_credentials_object(o_auth_client_id, o_auth_client_secret,
        ...
        if o_auth_client_id is None \
                ...
                and o_auth_username is None \
                and o_auth_password is None \
        ...
        warnings.warn(message=("The 'o_auth_client_id', 'o_auth_client_secret', 'o_au"
                               "th_username', 'o_auth_password', 'o_auth_token' param"
                               "s are deprecated. Use 'resource_owner_auth_credential"
                               "s' param instead."),
                      category=DeprecationWarning,
                      stacklevel=stack_level)

        if resource_owner_auth_credentials is not None:
            return resource_owner_auth_credentials.clone_with(
                o_auth_client_id, o_auth_client_secret, o_auth_username,
                o_auth_password, o_auth_token)

        from mdnotesropcgwithoutauthscopes.http.auth.o_auth_2 import (  # noqa: E501
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        default_config = cls(
            ...
            resource_owner_auth_credentials=ResourceOwnerAuthCredentials.from_environment(),
        )
