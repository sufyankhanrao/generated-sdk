...
```python
user_verifications_controller = client.user_verifications
```
...
|  --- | --- | --- | --- |
| `user_verification_id` | `str` | Template, Required | **Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` |
