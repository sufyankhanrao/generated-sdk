...
| `product_recurring_active` | `Any` | Query, Optional | Product Recurring Active |
| `product_accountvault_active` | `Any` | Query, Optional | Product Accountvault Active |
...
result = locations_controller.locations_detail(
    page=page,
    order=order,
    filter_by=filter_by
)
