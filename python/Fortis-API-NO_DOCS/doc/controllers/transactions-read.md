...
```python
transactions_read_controller = client.transactions_read
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`ResponseTransactionBinInfo`](../../doc/models/response-transaction-bin-info.md).
...
result = transactions_read_controller.get_bin_info(transaction_id)
...
result = transactions_read_controller.get_transaction(transaction_id)
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`ResponseTransactionsCollection`](../../doc/models/response-transactions-collection.md).
...
result = transactions_read_controller.list_transactions(
    page=page,
    order=order,
    filter_by=filter_by
)
