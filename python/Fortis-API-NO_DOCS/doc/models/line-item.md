...
|  --- | --- | --- | --- |
| `description` | `str` | Optional | Description of the item.<br><br>**Constraints**: *Maximum Length*: `26` |
| `commodity_code` | `str` | Optional | An international description code of the individual good or service being supplied.<br><br>**Constraints**: *Maximum Length*: `12` |
...
| `product_code` | `str` | Optional | Merchant-defined description code of the item.<br><br>**Constraints**: *Maximum Length*: `12` |
...
| `unit_code` | `str` | Optional | Units of measurement as used in international trade. (See Codes for Units of Measurement below for unit code abbreviations)<br><br>**Constraints**: *Minimum Length*: `3`, *Maximum Length*: `3` |
| `unit_cost` | `int` | Optional | Unit cost of the item ,Can accept Four (4) decimal places.<br><br>**Constraints**: `<= 99999999999999` |
| `alternate_tax_id` | `str` | Optional | Tax identification number of the merchant that reported the alternate tax amount.<br><br>**Constraints**: *Maximum Length*: `15` |
