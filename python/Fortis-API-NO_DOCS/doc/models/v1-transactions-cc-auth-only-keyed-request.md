...
| `account_number` | `str` | Required | For CC transactions, a credit card number. For ACH transactions, a bank account number.<br><br>**Constraints**: *Minimum Length*: `13`, *Maximum Length*: `19` |
...
| `exp_date` | `str` | Required | Required for CC. The Expiration Date for the credit card. (MMYY format).<br><br>**Constraints**: *Maximum Length*: `4` |
