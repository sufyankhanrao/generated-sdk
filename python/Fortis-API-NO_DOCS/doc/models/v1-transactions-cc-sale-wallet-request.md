...
| `wallet_data` | `str` | Required | Wallet Data |
| `wallet_provider` | [`WalletProviderEnum`](../../doc/models/wallet-provider-enum.md) | Required | Wallet Provider |
| `wallet_key_id` | `str` | Optional | Wallet Key ID |
