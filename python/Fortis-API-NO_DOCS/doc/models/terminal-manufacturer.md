...
|  --- | --- | --- | --- |
| `title` | `str` | Optional | Terminal Manufacturer Title<br><br>**Constraints**: *Maximum Length*: `32` |
| `idtype` | [`IdtypeEnum`](../../doc/models/idtype-enum.md) | Optional | Terminal Manufacturer ID Type |
| `code` | `str` | Optional | Terminal Manufacture Code |
