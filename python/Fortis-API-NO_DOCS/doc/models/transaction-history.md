...
| `id` | `str` | Optional | Transaction Histories ID<br><br>**Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` |
| `status_id` | `int` | Optional | Status ID |
| `event_date_ts` | `int` | Optional | Event Date TS |
