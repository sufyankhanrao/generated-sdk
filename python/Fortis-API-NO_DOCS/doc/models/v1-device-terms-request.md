...
| `require_signature` | `bool` | Required | Set to true or 1 to require a signature from the customer |
...
| `terms_conditions` | `str` | Required | This is the message that is displayed on the screen when prompting for a signature.<br><br>**Constraints**: *Maximum Length*: `4096` |
