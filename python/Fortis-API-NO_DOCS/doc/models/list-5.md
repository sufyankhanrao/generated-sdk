...
| `parent_id` | `str` | Optional | Location GUID of the parent location |
...
| `branding_domain` | `Any` | Optional | Branding domain array |
| `product_transactions` | `List[Any]` | Optional | Product Transactions array |
| `product_file` | `Any` | Optional | Product file array |
| `product_accountvault` | `Any` | Optional | Product Token array |
| `product_recurring` | `Any` | Optional | Product recurring array |
| `tags` | `List[Any]` | Optional | Tags array |
| `terminals` | `List[Any]` | Optional | Terminals array |
