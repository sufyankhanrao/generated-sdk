...
| `title` | `str` | Required | Title<br><br>**Constraints**: *Maximum Length*: `64` |
...
| `due_date` | `str` | Required | Due Date, Format: Y-m-d<br><br>**Constraints**: *Maximum Length*: `10`, *Pattern*: `^[\d]{4}-[\d]{2}-[\d]{2}$` |
| `item_list` | [`List[ItemList4]`](../../doc/models/item-list-4.md) | Required | Item List<br><br>**Constraints**: *Minimum Items*: `1`, *Maximum Items*: `99`, *Unique Items Required* |
