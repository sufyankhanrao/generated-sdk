...
| `basic_auth_username` | `str` | Optional | Basic Auth Username Information on `expand` |
| `basic_auth_password` | `str` | Optional | Basic Auth Password Information on `expand` |
...
| `id` | `str` | Optional | Postback Config ID<br><br>**Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` |
