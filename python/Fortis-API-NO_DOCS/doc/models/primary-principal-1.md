...
|  --- | --- | --- | --- |
| `first_name` | `str` | Required | Signer's first name<br><br>**Constraints**: *Maximum Length*: `20` |
| `last_name` | `str` | Required | Signer's last name<br><br>**Constraints**: *Maximum Length*: `20` |
