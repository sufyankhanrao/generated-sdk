...
| `terminal_api_id` | `str` | Optional | Advance Deposit<br><br>**Constraints**: *Maximum Length*: `36` |
| `e_format` | [`EFormatEnum`](../../doc/models/e-format-enum.md) | Optional | Encrypted Track Data Format. |
| `e_track_data` | `str` | Optional | Encrypted Track Data |
| `e_serial_number` | `str` | Optional | Encrypted Track Data KSN<br><br>**Constraints**: *Maximum Length*: `20` |
