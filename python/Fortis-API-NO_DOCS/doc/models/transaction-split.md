...
| `amount` | `int` | Optional | Amount<br><br>**Constraints**: `>= 1`, `<= 999999999` |
| `id` | `str` | Optional | Transaction Splits ID<br><br>**Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` |
