...
| `interval` | `int` | Required | Interval<br><br>**Constraints**: `>= 0`, `<= 365` |
| `interval_type` | [`IntervalTypeEnum`](../../doc/models/interval-type-enum.md) | Required | Interval Type |
...
| `start_date` | `str` | Required | Start date<br><br>**Constraints**: *Maximum Length*: `10`, *Pattern*: `^[\d]{4}-[\d]{2}-[\d]{2}$` |
| `status` | [`StatusEnum`](../../doc/models/status-enum.md) | Optional | Status |
| `transaction_amount` | `int` | Required | Transaction amount |
