...
| `payment_schedule` | `List[str]` | Optional | Payment Schedule Information on `expand`<br><br>**Constraints**: *Maximum Length*: `10`, *Pattern*: `^[\d]{4}-[\d]{2}-[\d]{2}$` |
...
| `next_run_date_min` | `str` | Optional | Next Run Date Min Information on `expand`<br><br>**Constraints**: *Maximum Length*: `10`, *Pattern*: `^[\d]{4}-[\d]{2}-[\d]{2}$` |
| `next_run_date_max` | `str` | Optional | Next Run Date Max Information on `expand`<br><br>**Constraints**: *Maximum Length*: `10`, *Pattern*: `^[\d]{4}-[\d]{2}-[\d]{2}$` |
...
| `recurring_splits` | [`List[RecurringSplit]`](../../doc/models/recurring-split.md) | Optional | Recurring Split Information on `expand` |
