...
| `terminal_application_id` | `str` | Required | Terminal Application ID<br><br>**Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` |
...
| `terminal_manufacturer_code` | [`TerminalManufacturerCodeEnum`](../../doc/models/terminal-manufacturer-code-enum.md) | Required | Terminal Manufacturer Code |
| `title` | `str` | Required | Terminal Name<br><br>**Constraints**: *Maximum Length*: `24` |
...
| `serial_number` | `str` | Required | Terminal Serial Number<br><br>**Constraints**: *Maximum Length*: `24`, *Pattern*: `^[a-zA-Z0-9]*$` |
...
| `cashback_enable` | `bool` | Required | Cashback Enable |
| `print_enable` | `bool` | Required | Print Enable |
| `sig_capture_enable` | `bool` | Required | Sig Capture Enable |
