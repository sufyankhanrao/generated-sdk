...
class Pagination(object):
    ...
    def from_dictionary(cls,
        ...
        page_count =\
            ...
            if dictionary.get("page_count") else APIHelper.SKIP
        page_number =\
            dictionary.get("page_number")\
            if dictionary.get("page_number") else APIHelper.SKIP
        page_size =\
            dictionary.get("page_size")\
            if dictionary.get("page_size") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"page_count={(self.page_count
                     if hasattr(self, 'page_count') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"page_count={(self.page_count
                     if hasattr(self, 'page_count') else None)!s}, "
                f"page_number={(self.page_number
