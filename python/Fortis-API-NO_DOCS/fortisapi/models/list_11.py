...
class List11(object):
    ...
    def __init__(self,
        ...
        """Constructor for the List11 class"""
    ...
    def from_dictionary(cls,
        ...
        raw_signature = dictionary.get("raw_signature") if "raw_signature" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'raw_signature={(self.raw_signature if hasattr(self, "raw_signature") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'raw_signature={(self.raw_signature if hasattr(self, "raw_signature") else None)!s}, '
