...
class TransactionHistory(object):
    ...
    def from_dictionary(cls,
        ...
        event_date_ts =\
            dictionary.get("event_date_ts")\
            if "event_date_ts" in dictionary.keys() else APIHelper.SKIP
        location_id =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"event_date_ts={(self.event_date_ts
                     if hasattr(self, 'event_date_ts') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"event_date_ts={(self.event_date_ts
                     if hasattr(self, 'event_date_ts') else None)!s}, "
                f"location_id={(self.location_id
