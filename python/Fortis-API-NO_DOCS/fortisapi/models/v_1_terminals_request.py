...
class V1TerminalsRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a V1TerminalsRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        cashback_enable =\
            ...
            if "cashback_enable" in dictionary.keys() else None
        print_enable =\
            dictionary.get("print_enable")\
            if "print_enable" in dictionary.keys() else None
        sig_capture_enable =\
            dictionary.get("sig_capture_enable")\
            if "sig_capture_enable" in dictionary.keys() else None
        default_product_transaction_id =\
