...
class FieldConfiguration(object):
    ...
    def from_dictionary(cls,
        ...
        css_mini =\
            ...
            if "css_mini" in dictionary.keys() else APIHelper.SKIP
        stack =\
            dictionary.get("stack")\
            if dictionary.get("stack") else APIHelper.SKIP
        header = Header.from_dictionary(
            dictionary.get("header"))\
            if "header" in dictionary.keys() else APIHelper.SKIP
        body = Body.from_dictionary(
            dictionary.get("body"))\
            if "body" in dictionary.keys() else APIHelper.SKIP
        footer = Footer.from_dictionary(
            dictionary.get("footer"))\
            if "footer" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"css_mini={(self.css_mini
                     if hasattr(self, 'css_mini') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"css_mini={(self.css_mini
                     if hasattr(self, 'css_mini') else None)!s}, "
