...
class Conditions24(object):
    """Implementation of the 'Conditions24' model.

    Attributes:
        method (MethodEnum): The model property of type MethodEnum.
        values (Values84Enum): The model property of type Values84Enum.
    ...
    def __init__(self,
        ...
        """Initialize a Conditions24 instance."""
