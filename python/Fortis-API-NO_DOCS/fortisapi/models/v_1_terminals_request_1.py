...
class V1TerminalsRequest1(object):
    ...
    def __init__(self,
        ...
        """Initialize a V1TerminalsRequest1 instance."""
    ...
    def from_dictionary(cls,
        ...
        terminal_application_id =\
            ...
            if "terminal_application_id" in dictionary.keys() else APIHelper.SKIP
        terminal_cvm_id =\
        ...
        terminal_manufacturer_code =\
            ...
            if "terminal_manufacturer_code" in dictionary.keys() else APIHelper.SKIP
        title =\
        ...
        local_ip_address =\
            ...
            if "local_ip_address" in dictionary.keys() else APIHelper.SKIP
        port = dictionary.get("port") if dictionary.get("port") else 10009
        serial_number =\
            dictionary.get("serial_number")\
            if "serial_number" in dictionary.keys() else APIHelper.SKIP
        terminal_number =\
            dictionary.get("terminal_number")\
            if "terminal_number" in dictionary.keys() else APIHelper.SKIP
