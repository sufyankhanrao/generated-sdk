...
class List13(object):
    ...
    def from_dictionary(cls,
        ...
        default_product_transaction_id =\
            ...
            if "default_product_transaction_id" in dictionary.keys() else APIHelper.SKIP
        terminal_application_id =\
            dictionary.get("terminal_application_id")\
            if dictionary.get("terminal_application_id") else APIHelper.SKIP
        terminal_cvm_id =\
            dictionary.get("terminal_cvm_id")\
            if "terminal_cvm_id" in dictionary.keys() else APIHelper.SKIP
        terminal_manufacturer_code =\
            dictionary.get("terminal_manufacturer_code")\
            if dictionary.get("terminal_manufacturer_code") else APIHelper.SKIP
        title =\
            dictionary.get("title")\
            if dictionary.get("title") else APIHelper.SKIP
        mac_address =\
            dictionary.get("mac_address")\
            if "mac_address" in dictionary.keys() else APIHelper.SKIP
        local_ip_address =\
            dictionary.get("local_ip_address")\
            if dictionary.get("local_ip_address") else APIHelper.SKIP
        port = dictionary.get("port") if dictionary.get("port") else 10009
        serial_number =\
            dictionary.get("serial_number")\
            if dictionary.get("serial_number") else APIHelper.SKIP
        terminal_number =\
            dictionary.get("terminal_number")\
            if dictionary.get("terminal_number") else APIHelper.SKIP
        terminal_timeouts = TerminalTimeouts.from_dictionary(
            dictionary.get("terminal_timeouts"))\
            if "terminal_timeouts" in dictionary.keys() else APIHelper.SKIP
        tip_percents = TipPercents.from_dictionary(
            dictionary.get("tip_percents"))\
            if "tip_percents" in dictionary.keys() else APIHelper.SKIP
        location_api_id =\
        ...
        header_line_1 =\
            ...
            if "header_line_1" in dictionary.keys() else APIHelper.SKIP
        header_line_2 =\
            dictionary.get("header_line_2")\
            if "header_line_2" in dictionary.keys() else APIHelper.SKIP
        header_line_3 =\
            dictionary.get("header_line_3")\
            if "header_line_3" in dictionary.keys() else APIHelper.SKIP
        header_line_4 =\
            dictionary.get("header_line_4")\
            if "header_line_4" in dictionary.keys() else APIHelper.SKIP
        header_line_5 =\
            dictionary.get("header_line_5")\
            if "header_line_5" in dictionary.keys() else APIHelper.SKIP
        trailer_line_1 =\
            dictionary.get("trailer_line_1")\
            if "trailer_line_1" in dictionary.keys() else APIHelper.SKIP
        trailer_line_2 =\
            dictionary.get("trailer_line_2")\
            if "trailer_line_2" in dictionary.keys() else APIHelper.SKIP
        trailer_line_3 =\
            dictionary.get("trailer_line_3")\
            if "trailer_line_3" in dictionary.keys() else APIHelper.SKIP
        trailer_line_4 =\
            dictionary.get("trailer_line_4")\
            if "trailer_line_4" in dictionary.keys() else APIHelper.SKIP
        trailer_line_5 =\
            dictionary.get("trailer_line_5")\
            if "trailer_line_5" in dictionary.keys() else APIHelper.SKIP
        default_checkin =\
            dictionary.get("default_checkin")\
            if "default_checkin" in dictionary.keys() else APIHelper.SKIP
        default_checkout =\
            dictionary.get("default_checkout")\
            if "default_checkout" in dictionary.keys() else APIHelper.SKIP
        default_room_rate =\
            dictionary.get("default_room_rate")\
            if "default_room_rate" in dictionary.keys() else APIHelper.SKIP
        default_room_number =\
            dictionary.get("default_room_number")\
            if "default_room_number" in dictionary.keys() else APIHelper.SKIP
        debit =\
            dictionary.get("debit")\
            if "debit" in dictionary.keys() else APIHelper.SKIP
        emv =\
            dictionary.get("emv")\
            if "emv" in dictionary.keys() else APIHelper.SKIP
        cashback_enable =\
            dictionary.get("cashback_enable")\
            if "cashback_enable" in dictionary.keys() else APIHelper.SKIP
        print_enable =\
            dictionary.get("print_enable")\
            if "print_enable" in dictionary.keys() else APIHelper.SKIP
        sig_capture_enable =\
            dictionary.get("sig_capture_enable")\
            if "sig_capture_enable" in dictionary.keys() else APIHelper.SKIP
        is_provisioned =\
            dictionary.get("is_provisioned")\
            if "is_provisioned" in dictionary.keys() else APIHelper.SKIP
        tip_enable =\
            dictionary.get("tip_enable")\
            if "tip_enable" in dictionary.keys() else APIHelper.SKIP
        validated_decryption =\
            dictionary.get("validated_decryption")\
            if "validated_decryption" in dictionary.keys() else APIHelper.SKIP
        communication_type =\
            dictionary.get("communication_type")\
            if "communication_type" in dictionary.keys() else APIHelper.SKIP
        active =\
        ...
        last_registration_ts =\
            ...
            if dictionary.get("last_registration_ts") else APIHelper.SKIP
        created_user_id =\
        ...
        terminal_application = TerminalApplication.from_dictionary(
            dictionary.get("terminal_application"))\
            if "terminal_application" in dictionary.keys() else APIHelper.SKIP
        changelogs = None
        ...
        has_terminal_routers =\
            ...
            if "has_terminal_routers" in dictionary.keys() else APIHelper.SKIP
        terminal_cvm = TerminalCvm.from_dictionary(
            dictionary.get("terminal_cvm"))\
            if "terminal_cvm" in dictionary.keys() else APIHelper.SKIP
        terminal_manufacturer = TerminalManufacturer.from_dictionary(
            dictionary.get("terminal_manufacturer"))\
            if "terminal_manufacturer" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"default_product_transaction_id={(self.default_product_transaction_id
                     if hasattr(self, 'default_product_transaction_id') else None)!r}, "
                f"terminal_application_id={(self.terminal_application_id
                     if hasattr(self, 'terminal_application_id') else None)!r}, "
                f"terminal_cvm_id={(self.terminal_cvm_id
                     if hasattr(self, 'terminal_cvm_id') else None)!r}, "
                f"terminal_manufacturer_code={(self.terminal_manufacturer_code
                     if hasattr(self, 'terminal_manufacturer_code') else None)!r}, "
                ...
                f"local_ip_address={(self.local_ip_address
                     if hasattr(self, 'local_ip_address') else None)!r}, "
                f"port={(self.port if hasattr(self, 'port') else None)!r}, "
                f"serial_number={(self.serial_number
                     if hasattr(self, 'serial_number') else None)!r}, "
                f"terminal_number={(self.terminal_number
                     if hasattr(self, 'terminal_number') else None)!r}, "
                f"terminal_timeouts={(self.terminal_timeouts
                     if hasattr(self, 'terminal_timeouts') else None)!r}, "
                f"tip_percents={(self.tip_percents
                     if hasattr(self, 'tip_percents') else None)!r}, "
                ...
                f"header_line_1={(self.header_line_1
                     if hasattr(self, 'header_line_1') else None)!r}, "
                f"header_line_2={(self.header_line_2
                     if hasattr(self, 'header_line_2') else None)!r}, "
                f"header_line_3={(self.header_line_3
                     if hasattr(self, 'header_line_3') else None)!r}, "
                f"header_line_4={(self.header_line_4
                     if hasattr(self, 'header_line_4') else None)!r}, "
                f"header_line_5={(self.header_line_5
                     if hasattr(self, 'header_line_5') else None)!r}, "
                f"trailer_line_1={(self.trailer_line_1
                     if hasattr(self, 'trailer_line_1') else None)!r}, "
                f"trailer_line_2={(self.trailer_line_2
                     if hasattr(self, 'trailer_line_2') else None)!r}, "
                f"trailer_line_3={(self.trailer_line_3
                     if hasattr(self, 'trailer_line_3') else None)!r}, "
                f"trailer_line_4={(self.trailer_line_4
                     if hasattr(self, 'trailer_line_4') else None)!r}, "
                f"trailer_line_5={(self.trailer_line_5
                     if hasattr(self, 'trailer_line_5') else None)!r}, "
                f"default_checkin={(self.default_checkin
                     if hasattr(self, 'default_checkin') else None)!r}, "
                f"default_checkout={(self.default_checkout
                     if hasattr(self, 'default_checkout') else None)!r}, "
                f"default_room_rate={(self.default_room_rate
                     if hasattr(self, 'default_room_rate') else None)!r}, "
                f"default_room_number={(self.default_room_number
                     if hasattr(self, 'default_room_number') else None)!r}, "
                f"debit={(self.debit if hasattr(self, 'debit') else None)!r}, "
                f"emv={(self.emv if hasattr(self, 'emv') else None)!r}, "
                f"cashback_enable={(self.cashback_enable
                     if hasattr(self, 'cashback_enable') else None)!r}, "
                f"print_enable={(self.print_enable
                     if hasattr(self, 'print_enable') else None)!r}, "
                f"sig_capture_enable={(self.sig_capture_enable
                     if hasattr(self, 'sig_capture_enable') else None)!r}, "
                f"is_provisioned={(self.is_provisioned
                     if hasattr(self, 'is_provisioned') else None)!r}, "
                f"tip_enable={(self.tip_enable
                     if hasattr(self, 'tip_enable') else None)!r}, "
                f"validated_decryption={(self.validated_decryption
                     if hasattr(self, 'validated_decryption') else None)!r}, "
                f"communication_type={(self.communication_type
                     if hasattr(self, 'communication_type') else None)!r}, "
                ...
                f"last_registration_ts={(self.last_registration_ts
                     if hasattr(self, 'last_registration_ts') else None)!r}, "
                ...
                f"terminal_application={(self.terminal_application
                     if hasattr(self, 'terminal_application') else None)!r}, "
                ...
                f"has_terminal_routers={(self.has_terminal_routers
                     if hasattr(self, 'has_terminal_routers') else None)!r}, "
                f"terminal_cvm={(self.terminal_cvm
                     if hasattr(self, 'terminal_cvm') else None)!r}, "
                f"terminal_manufacturer={(self.terminal_manufacturer
                     if hasattr(self, 'terminal_manufacturer') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"default_product_transaction_id={(self.default_product_transaction_id
                     if hasattr(self, 'default_product_transaction_id') else None)!s}, "
                f"terminal_application_id={(self.terminal_application_id
                     if hasattr(self, 'terminal_application_id') else None)!s}, "
                f"terminal_cvm_id={(self.terminal_cvm_id
                     if hasattr(self, 'terminal_cvm_id') else None)!s}, "
                f"terminal_manufacturer_code={(self.terminal_manufacturer_code
                     if hasattr(self, 'terminal_manufacturer_code') else None)!s}, "
                f"title={(self.title if hasattr(self, 'title') else None)!s}, "
                f"mac_address={(self.mac_address
                     if hasattr(self, 'mac_address') else None)!s}, "
                f"local_ip_address={(self.local_ip_address
                     if hasattr(self, 'local_ip_address') else None)!s}, "
                f"port={(self.port if hasattr(self, 'port') else None)!s}, "
                f"serial_number={(self.serial_number
                     if hasattr(self, 'serial_number') else None)!s}, "
                f"terminal_number={(self.terminal_number
                     if hasattr(self, 'terminal_number') else None)!s}, "
                f"terminal_timeouts={(self.terminal_timeouts
                     if hasattr(self, 'terminal_timeouts') else None)!s}, "
                f"tip_percents={(self.tip_percents
                     if hasattr(self, 'tip_percents') else None)!s}, "
                f"location_api_id={(self.location_api_id
                     if hasattr(self, 'location_api_id') else None)!s}, "
                f"terminal_api_id={(self.terminal_api_id
                     if hasattr(self, 'terminal_api_id') else None)!s}, "
                f"header_line_1={(self.header_line_1
                     if hasattr(self, 'header_line_1') else None)!s}, "
                f"header_line_2={(self.header_line_2
                     if hasattr(self, 'header_line_2') else None)!s}, "
                f"header_line_3={(self.header_line_3
                     if hasattr(self, 'header_line_3') else None)!s}, "
                f"header_line_4={(self.header_line_4
                     if hasattr(self, 'header_line_4') else None)!s}, "
                f"header_line_5={(self.header_line_5
                     if hasattr(self, 'header_line_5') else None)!s}, "
                f"trailer_line_1={(self.trailer_line_1
                     if hasattr(self, 'trailer_line_1') else None)!s}, "
                f"trailer_line_2={(self.trailer_line_2
                     if hasattr(self, 'trailer_line_2') else None)!s}, "
                f"trailer_line_3={(self.trailer_line_3
                     if hasattr(self, 'trailer_line_3') else None)!s}, "
                f"trailer_line_4={(self.trailer_line_4
                     if hasattr(self, 'trailer_line_4') else None)!s}, "
                f"trailer_line_5={(self.trailer_line_5
                     if hasattr(self, 'trailer_line_5') else None)!s}, "
                f"default_checkin={(self.default_checkin
                     if hasattr(self, 'default_checkin') else None)!s}, "
                f"default_checkout={(self.default_checkout
                     if hasattr(self, 'default_checkout') else None)!s}, "
                f"default_room_rate={(self.default_room_rate
                     if hasattr(self, 'default_room_rate') else None)!s}, "
                f"default_room_number={(self.default_room_number
                     if hasattr(self, 'default_room_number') else None)!s}, "
                f"debit={(self.debit if hasattr(self, 'debit') else None)!s}, "
                f"emv={(self.emv if hasattr(self, 'emv') else None)!s}, "
                f"cashback_enable={(self.cashback_enable
                     if hasattr(self, 'cashback_enable') else None)!s}, "
                f"print_enable={(self.print_enable
                     if hasattr(self, 'print_enable') else None)!s}, "
                f"sig_capture_enable={(self.sig_capture_enable
                     if hasattr(self, 'sig_capture_enable') else None)!s}, "
                f"is_provisioned={(self.is_provisioned
                     if hasattr(self, 'is_provisioned') else None)!s}, "
                f"tip_enable={(self.tip_enable
                     if hasattr(self, 'tip_enable') else None)!s}, "
                f"validated_decryption={(self.validated_decryption
                     if hasattr(self, 'validated_decryption') else None)!s}, "
                f"communication_type={(self.communication_type
                     if hasattr(self, 'communication_type') else None)!s}, "
                ...
                f"last_registration_ts={(self.last_registration_ts
                     if hasattr(self, 'last_registration_ts') else None)!s}, "
                f"created_user_id={(self.created_user_id
                ...
                f"terminal_application={(self.terminal_application
                     if hasattr(self, 'terminal_application') else None)!s}, "
                f"changelogs={(self.changelogs
                     if hasattr(self, 'changelogs') else None)!s}, "
                f"terminal_routers={(self.terminal_routers
                     if hasattr(self, 'terminal_routers') else None)!s}, "
                f"has_terminal_routers={(self.has_terminal_routers
                     if hasattr(self, 'has_terminal_routers') else None)!s}, "
                f"terminal_cvm={(self.terminal_cvm
                     if hasattr(self, 'terminal_cvm') else None)!s}, "
                f"terminal_manufacturer={(self.terminal_manufacturer
                     if hasattr(self, 'terminal_manufacturer') else None)!s}, "
