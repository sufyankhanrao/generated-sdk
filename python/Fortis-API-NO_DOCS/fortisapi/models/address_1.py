...
class Address1(object):
    ...
    def from_dictionary(cls,
        ...
        street_2 = dictionary.get("street2") if "street2" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'street_2={(self.street_2 if hasattr(self, "street_2") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'street_2={(self.street_2 if hasattr(self, "street_2") else None)!s}, '
