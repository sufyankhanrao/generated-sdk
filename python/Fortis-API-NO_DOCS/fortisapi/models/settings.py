...
class Settings(object):
    ...
    def from_dictionary(cls,
        ...
        rows = dictionary.get("rows") if dictionary.get("rows") else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'columns={(self.columns if hasattr(self, "columns") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'columns={(self.columns if hasattr(self, "columns") else None)!s}, '
