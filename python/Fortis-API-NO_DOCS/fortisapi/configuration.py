...
class Configuration(HttpClientConfiguration):
    ...
    @property
    def user_id_credentials(self):
        """Return current user_id_credentials."""
        return self._user_id_credentials

    @property
    def user_api_key_credentials(self):
        """Return current user_api_key_credentials."""
        return self._user_api_key_credentials

    @property
    def developer_id_credentials(self):
        """Return current developer_id_credentials."""
        return self._developer_id_credentials
    ...
    def __init__(self, http_client_instance=None,
        ...
        self._user_id_credentials = user_id_credentials

        # The object holding Custom Header Signature credentials
        self._user_api_key_credentials = user_api_key_credentials

        # The object holding Custom Header Signature credentials
        self._developer_id_credentials = developer_id_credentials
    ...
    def clone_with(self, http_client_instance=None,
        ...
        user_api_key_credentials =\
            (user_api_key_credentials
            or self.user_api_key_credentials)
        developer_id_credentials =\
            (developer_id_credentials
            or self.developer_id_credentials)
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        from fortisapi.http.auth.user_id import (
            UserIdCredentials,
        )
