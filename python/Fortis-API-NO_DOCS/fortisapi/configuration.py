...
class Configuration(HttpClientConfiguration):
    ...
    def clone_with(self, http_client_instance=None,
        ...
        user_api_key_credentials = user_api_key_credentials or self.user_api_key_credentials
        developer_id_credentials = developer_id_credentials or self.developer_id_credentials
        access_token_credentials = access_token_credentials or self.access_token_credentials
