...
from fortisapi.models.response_transaction_level_3 import (
    ResponseTransactionLevel3,
)
from fortisapi.models.response_transaction_level_3_master import (
    ResponseTransactionLevel3Master,
)
from fortisapi.models.response_transaction_level_3_visa import (
...
class Level3DataController(BaseController):
    ...
    def create_a_new_level_3_entry_for_a_visa(self,
                                              transaction_id,
                                              body):
        """Perform a POST request to /v1/transactions/{transaction_id}/level3/visa.
