...
from fortisapi.models.response_apple_pay_validate_merchant import (
...
class ApplePayValidateMerchantController(BaseController):
    ...
    def __init__(self, config):
        """Initialize ApplePayValidateMerchantController object."""
        super(ApplePayValidateMerchantController, self).__init__(config)

    def apple_pay_validate_merchant(self,
                                    body):
        """Perform a POST request to /v1/wallet-provider/apple-pay-validate-merchant.
