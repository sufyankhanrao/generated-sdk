...
from fortisapi.models.response_user_verification import (
    ResponseUserVerification,
)
from fortisapi.models.response_user_verifications_collection import (
...
class UserVerificationsController(BaseController):
    ...
    def get_user_verification(self,
        ...
        """Perform a GET request to /v1/user-verifications/{user_verification_id}.
