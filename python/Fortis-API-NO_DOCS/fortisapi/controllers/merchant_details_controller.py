...
from fortisapi.models.response_merchant_details import (
...
class MerchantDetailsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize MerchantDetailsController object."""
        super(MerchantDetailsController, self).__init__(config)

    def merchant_details(self,
                         body):
        """Perform a POST request to /v1/wallet-provider/merchant-details.
