...
from fortisapi.models.v_1_transactions_cash_refund_request import V1TransactionsCashRefundRequest
...
transactions_cash_controller = client.transactions_cash
