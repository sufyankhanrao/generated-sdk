...
from fortisapi.models.v_1_transactions_cc_balance_inquiry_wallet_request import V1TransactionsCcBalanceInquiryWalletRequest
from fortisapi.models.wallet_provider_enum import WalletProviderEnum
