...
from fortisapi.models.account_type_10_enum import AccountType10Enum
from fortisapi.models.ach_sec_code_1_enum import AchSecCode1Enum
from fortisapi.models.iias_ind_enum import IiasIndEnum
from fortisapi.models.v_1_transactions_ach_credit_keyed_request import V1TransactionsAchCreditKeyedRequest
...
transactions_ach_controller = client.transactions_ach
body = V1TransactionsAchCreditKeyedRequest(
    transaction_amount=1,
    account_holder_name='smith',
    account_number='24345',
    account_type=AccountType10Enum.CHECKING,
    ...
    ach_identifier='P',
    ach_sec_code=AchSecCode1Enum.C21,
