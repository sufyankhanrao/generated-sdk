...
class OAuth2(HeaderAuth):
    ...
    def __init__(self, client_credentials_auth_credentials, config):
        ...
        if client_credentials_auth_credentials is not None \
                and isinstance(client_credentials_auth_credentials.o_auth_token, OAuthTokenModel):
            self._o_auth_token = OAuthTokenModel.from_dictionary(
            ...
            self._o_auth_token = client_credentials_auth_credentials.o_auth_token \
                if client_credentials_auth_credentials is not None else None
        if client_credentials_auth_credentials is not None \
                and isinstance(client_credentials_auth_credentials.o_auth_scopes, list):
            self._o_auth_scopes = client_credentials_auth_credentials.o_auth_scopes
        else:
    ...
    def is_valid(self):
        ...
        return (self._o_auth_token and isinstance(self._o_auth_token, OAuthTokenModel)
    ...
    def fetch_token(self, additional_params=None):
        ...
        Returns:
            OAuthTokenModel: The OAuth token.
    ...
    def is_token_expired(self, o_auth_token=None):
        ...
        Args:
            o_auth_token (OAuthTokenModel): The OAuth token whose expiry is to be checked.
...
class ClientCredentialsAuthCredentials:
    ...
    def from_environment(cls):
        ...
        o_auth_clock_skew = os.getenv('O_AUTH_CLOCK_SKEW', None)
