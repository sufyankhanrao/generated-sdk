...
from mdnotesccgmodelpostfix.exceptions.api_exception import (
    APIException,
)
...
class OAuth2(HeaderAuth):
    ...
    def __init__(self, auth_credentials_model, config):
        ...
        if auth_credentials_model is not None \
                and isinstance(auth_credentials_model.o_auth_token, OAuthTokenModel):
    ...
    def _get_token_from_provider(self):
        ...
        Returns:
            OAuthTokenModel: The fetched OAuth token.
    ...
    def _apply_on_token_update_callback(self, o_auth_token):
        ...
        Args:
            o_auth_token (OAuthTokenModel): The updated OAuth token.
