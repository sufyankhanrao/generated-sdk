...
client = MultiauthjwtandcustomheaderClient.from_environment(
...
HTTP_BEARER_ACCESS_TOKEN=ExampleAccessToken
HTTP_HEADER_TOKEN=ExampleToken
HTTP_HEADER_API_KEY=ExampleApiKey
