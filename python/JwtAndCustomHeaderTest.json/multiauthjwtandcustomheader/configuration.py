...
from multiauthjwtandcustomheader.http.proxy_settings import (
    ProxySettings,
)
from multiauthjwtandcustomheader.models.suite_code_enum import (
    SuiteCodeEnum,
)
...
class Configuration(HttpClientConfiguration):
    ...
    @property
    def http_bearer_credentials(self):
        """Return current http_bearer_credentials."""
        return self._http_bearer_credentials

    @property
    def http_header_credentials(self):
        """Return current http_header_credentials."""
        return self._http_header_credentials
    ...
    def __init__(self, http_client_instance=None,
        ...
        self._http_bearer_credentials = http_bearer_credentials

        # The object holding Custom Header Signature credentials
        self._http_header_credentials = http_header_credentials
    ...
    def clone_with(self, http_client_instance=None,
        ...
        http_bearer_credentials =\
            (http_bearer_credentials
            or self.http_bearer_credentials)
        http_header_credentials =\
            (http_header_credentials
            or self.http_header_credentials)
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        default_config = cls(
            ...
            http_bearer_credentials=HttpBearerCredentials.from_environment(),
            http_header_credentials=HttpHeaderCredentials.from_environment(),
        )
