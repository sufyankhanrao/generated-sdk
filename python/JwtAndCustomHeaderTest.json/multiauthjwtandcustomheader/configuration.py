...
class Configuration(HttpClientConfiguration):
    ...
    def clone_with(self, http_client_instance=None,
        ...
        http_bearer_credentials = http_bearer_credentials or self.http_bearer_credentials
        http_header_credentials = http_header_credentials or self.http_header_credentials
