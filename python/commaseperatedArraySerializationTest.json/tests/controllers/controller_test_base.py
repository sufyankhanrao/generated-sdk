...
from commaseperatedarrayserialization.commaseperatedarrayserialization_client import (
    CommaseperatedarrayserializationClient,
)
...
class ControllerTestBase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.client = CommaseperatedarrayserializationClient(config=cls.config)
