...
from mdnotesacg.configuration import Configuration, Environment
...
class ControllerTestBase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.client = MdnotesacgClient(config=cls.config)
    ...
    def create_configuration():
        return Configuration.from_environment(
            authorization_code_auth_credentials=AuthorizationCodeAuthCredentials(
                ...
                o_auth_redirect_uri='http://localhost:25565/myredirect'),
