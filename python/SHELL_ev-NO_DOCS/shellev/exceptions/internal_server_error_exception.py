...
from shellev.models.internal_error_object import InternalErrorObject
...
class InternalServerErrorException(APIException):
    ...
    def unbox(self, dictionary):
        ...
        if dictionary.get('errors') is not None:
            self.errors = [InternalErrorObject.from_dictionary(x) for x in dictionary.get('errors')]
        else:
            self.errors = None
        self.details = dictionary.get("details") if dictionary.get("details") else None
