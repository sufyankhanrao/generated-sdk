...
from shellev.models.internal_error_object import (
    InternalErrorObject,
)
...
class InternalServerErrorException(APIException):
    def __init__(self, reason, response):
        """Initialize InternalServerErrorException object.
        ...
        """
        super(InternalServerErrorException, self).__init__(reason, response)
    ...
    def unbox(self, dictionary):
        ...
        if dictionary.get("errors") is not None:
            self.errors = [
                InternalErrorObject.from_dictionary(x)
