...
class ElectricalProperties(object):
    ...
    def __init__(self,
        ...
        """Initialize a ElectricalProperties instance."""
    ...
    def from_dictionary(cls,
        ...
        power_type =\
            ...
            if dictionary.get("powerType") else APIHelper.SKIP
        voltage =\
            dictionary.get("voltage")\
            if dictionary.get("voltage") else APIHelper.SKIP
        amperage =\
            dictionary.get("amperage")\
            if dictionary.get("amperage") else APIHelper.SKIP
        max_electric_power =\
            dictionary.get("maxElectricPower")\
            if dictionary.get("maxElectricPower") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"power_type={(self.power_type
                     if hasattr(self, 'power_type') else None)!r}, "
                f"voltage={(self.voltage
                     if hasattr(self, 'voltage') else None)!r}, "
                f"amperage={(self.amperage
                     if hasattr(self, 'amperage') else None)!r}, "
                f"max_electric_power={(self.max_electric_power
                     if hasattr(self, 'max_electric_power') else None)!r})")

    def __str__(self):
        """Return a human-readable string representation."""
        return (f"{self.__class__.__name__}("
                f"power_type={(self.power_type
                     if hasattr(self, 'power_type') else None)!s}, "
                f"voltage={(self.voltage
                     if hasattr(self, 'voltage') else None)!s}, "
                f"amperage={(self.amperage
                     if hasattr(self, 'amperage') else None)!s}, "
                f"max_electric_power={(self.max_electric_power
                     if hasattr(self, 'max_electric_power') else None)!s})")
