...
class MultiLocationMarker(object):
    ...
    def __init__(self,
        ...
        """Initialize a MultiLocationMarker instance."""
    ...
    def from_dictionary(cls,
        ...
        location_count =\
            ...
            if dictionary.get("locationCount") else APIHelper.SKIP
        evse_count =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"location_count={(self.location_count
                     if hasattr(self, 'location_count') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"location_count={(self.location_count
                     if hasattr(self, 'location_count') else None)!s}, "
                f"evse_count={(self.evse_count
