...
from shellev.models.electrical_properties import (
...
class ConnectorVO(object):
    ...
    def __init__(self,
        ...
        """Initialize a ConnectorVO instance."""
    ...
    def from_dictionary(cls,
        ...
        connector_type =\
            ...
            if dictionary.get("connectorType") else APIHelper.SKIP
        electrical_properties = ElectricalProperties.from_dictionary(
            dictionary.get("electricalProperties"))\
            if "electricalProperties" in dictionary.keys() else APIHelper.SKIP
        fixed_cable =\
            dictionary.get("fixedCable")\
            if "fixedCable" in dictionary.keys() else APIHelper.SKIP
        tariff = TariffVO.from_dictionary(
            dictionary.get("tariff"))\
            if "tariff" in dictionary.keys() else APIHelper.SKIP
        updated =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"connector_type={(self.connector_type
                     if hasattr(self, 'connector_type') else None)!r}, "
                f"electrical_properties={(self.electrical_properties
                     if hasattr(self, 'electrical_properties') else None)!r}, "
                f"fixed_cable={(self.fixed_cable
                     if hasattr(self, 'fixed_cable') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"connector_type={(self.connector_type
                     if hasattr(self, 'connector_type') else None)!s}, "
                f"electrical_properties={(self.electrical_properties
                     if hasattr(self, 'electrical_properties') else None)!s}, "
                f"fixed_cable={(self.fixed_cable
                     if hasattr(self, 'fixed_cable') else None)!s}, "
