...
class Address(object):
    ...
    def from_dictionary(cls,
        ...
        street_and_number =\
            dictionary.get("streetAndNumber")\
            if dictionary.get("streetAndNumber") else APIHelper.SKIP
        postal_code =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"street_and_number={(self.street_and_number
                     if hasattr(self, 'street_and_number') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"street_and_number={(self.street_and_number
                     if hasattr(self, 'street_and_number') else None)!s}, "
                f"postal_code={(self.postal_code
