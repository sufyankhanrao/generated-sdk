...
class SingleLocationMarker(object):
    ...
    def __init__(self,
        ...
        """Initialize a SingleLocationMarker instance."""
    ...
    def from_dictionary(cls,
        ...
        marker_type =\
            dictionary.get("markerType")\
            if dictionary.get("markerType") else None
        unique_key =\
            dictionary.get("uniqueKey")\
            if dictionary.get("uniqueKey") else APIHelper.SKIP
        status =\
            dictionary.get("status")\
            if dictionary.get("status") else APIHelper.SKIP
        coordinates = Coordinates.from_dictionary(
            dictionary.get("coordinates"))\
            if "coordinates" in dictionary.keys() else APIHelper.SKIP
        evse_count =\
            dictionary.get("evseCount")\
            if dictionary.get("evseCount") else APIHelper.SKIP
        max_power =\
            dictionary.get("maxPower")\
            if dictionary.get("maxPower") else APIHelper.SKIP
        geo_hash =\
            dictionary.get("geoHash")\
            if dictionary.get("geoHash") else APIHelper.SKIP
        location_uid =\
            dictionary.get("locationUid")\
            if dictionary.get("locationUid") else APIHelper.SKIP
        authorization_methods =\
            dictionary.get("authorizationMethods")\
            if dictionary.get("authorizationMethods") else APIHelper.SKIP
        operator_id =\
            dictionary.get("operatorId")\
            if dictionary.get("operatorId") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"unique_key={(self.unique_key
                     if hasattr(self, 'unique_key') else None)!r}, "
                f"status={(self.status if hasattr(self, 'status') else None)!r}, "
                f"coordinates={(self.coordinates
                     if hasattr(self, 'coordinates') else None)!r}, "
                f"evse_count={(self.evse_count
                     if hasattr(self, 'evse_count') else None)!r}, "
                f"max_power={(self.max_power
                     if hasattr(self, 'max_power') else None)!r}, "
                f"geo_hash={(self.geo_hash
                     if hasattr(self, 'geo_hash') else None)!r}, "
                f"location_uid={(self.location_uid
                     if hasattr(self, 'location_uid') else None)!r}, "
                ...
                f"operator_id={(self.operator_id
                     if hasattr(self, 'operator_id') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"unique_key={(self.unique_key
                     if hasattr(self, 'unique_key') else None)!s}, "
                f"status={(self.status if hasattr(self, 'status') else None)!s}, "
                f"coordinates={(self.coordinates
                     if hasattr(self, 'coordinates') else None)!s}, "
                f"evse_count={(self.evse_count
                     if hasattr(self, 'evse_count') else None)!s}, "
                f"max_power={(self.max_power
                     if hasattr(self, 'max_power') else None)!s}, "
                f"geo_hash={(self.geo_hash
                     if hasattr(self, 'geo_hash') else None)!s}, "
                f"location_uid={(self.location_uid
                     if hasattr(self, 'location_uid') else None)!s}, "
                f"authorization_methods={(self.authorization_methods
                     if hasattr(self, 'authorization_methods') else None)!s}, "
                f"operator_id={(self.operator_id
                     if hasattr(self, 'operator_id') else None)!s})")
