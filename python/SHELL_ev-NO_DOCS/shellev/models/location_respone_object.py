...
class LocationResponeObject(object):
    ...
    def __init__(self,
        ...
        """Initialize a LocationResponeObject instance."""
    ...
    def from_dictionary(cls,
        ...
        operator_name =\
            ...
            if dictionary.get("operatorName") else APIHelper.SKIP
        address = Address.from_dictionary(
            dictionary.get("address"))\
            if "address" in dictionary.keys() else APIHelper.SKIP
        accessibility = Accessibility.from_dictionary(
            dictionary.get("accessibility"))\
            if "accessibility" in dictionary.keys() else APIHelper.SKIP
        evses = None
        if dictionary.get("evses") is not None:
            evses = [
                EvseVO.from_dictionary(x)
        ...
        operator_comment =\
            dictionary.get("operatorComment")\
            if dictionary.get("operatorComment") else APIHelper.SKIP
        location_type =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"operator_name={(self.operator_name
                     if hasattr(self, 'operator_name') else None)!r}, "
                f"address={(self.address
                     if hasattr(self, 'address') else None)!r}, "
                f"accessibility={(self.accessibility
                     if hasattr(self, 'accessibility') else None)!r}, "
                ...
                f"operator_comment={(self.operator_comment
                     if hasattr(self, 'operator_comment') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"operator_name={(self.operator_name
                     if hasattr(self, 'operator_name') else None)!s}, "
                f"address={(self.address
                     if hasattr(self, 'address') else None)!s}, "
                f"accessibility={(self.accessibility
                     if hasattr(self, 'accessibility') else None)!s}, "
                ...
                f"operator_comment={(self.operator_comment
                     if hasattr(self, 'operator_comment') else None)!s}, "
                f"location_type={(self.location_type
