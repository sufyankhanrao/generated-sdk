...
class Label1(object):
    ...
    def from_dictionary(cls,
        ...
        labeltype =\
            dictionary.get("Labeltype")\
            if dictionary.get("Labeltype") else APIHelper.SKIP
        output_type =\
            dictionary.get("OutputType")\
            if dictionary.get("OutputType") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"labeltype={(self.labeltype
                     if hasattr(self, 'labeltype') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"labeltype={(self.labeltype
                     if hasattr(self, 'labeltype') else None)!s}, "
                f"output_type={(self.output_type
