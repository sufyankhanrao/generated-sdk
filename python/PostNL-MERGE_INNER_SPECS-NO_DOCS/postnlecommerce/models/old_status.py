...
class OldStatus(object):
    ...
    def __init__(self,
        ...
        """Initialize a OldStatus instance."""
    ...
    def from_dictionary(cls,
        ...
        phase_code =\
            dictionary.get("PhaseCode")\
            if dictionary.get("PhaseCode") else APIHelper.SKIP
        phase_description =\
            dictionary.get("PhaseDescription")\
            if dictionary.get("PhaseDescription") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"phase_code={(self.phase_code
                     if hasattr(self, 'phase_code') else None)!r}, "
                f"phase_description={(self.phase_description
                     if hasattr(self, 'phase_description') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"phase_code={(self.phase_code
                     if hasattr(self, 'phase_code') else None)!s}, "
                f"phase_description={(self.phase_description
                     if hasattr(self, 'phase_description') else None)!s})")
