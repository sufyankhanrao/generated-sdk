...
class Address4(object):
    ...
    def from_dictionary(cls,
        ...
        department_name =\
            dictionary.get("DepartmentName")\
            if dictionary.get("DepartmentName") else APIHelper.SKIP
        country_code =\
        ...
        district =\
            dictionary.get("District")\
            if dictionary.get("District") else APIHelper.SKIP
        city =\
            dictionary.get("City")\
        ...
        house_number_suffix =\
            dictionary.get("HouseNumberSuffix")\
            if dictionary.get("HouseNumberSuffix") else APIHelper.SKIP
        building =\
            dictionary.get("Building")\
            if dictionary.get("Building") else APIHelper.SKIP
        floor =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"department_name={(self.department_name
                     if hasattr(self, 'department_name') else None)!r}, "
                ...
                f"district={(self.district
                     if hasattr(self, 'district') else None)!r}, "
                ...
                f"house_number_suffix={(self.house_number_suffix
                     if hasattr(self, 'house_number_suffix') else None)!r}, "
                f"building={(self.building
                     if hasattr(self, 'building') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"department_name={(self.department_name
                     if hasattr(self, 'department_name') else None)!s}, "
                f"country_code={(self.country_code
                ...
                f"district={(self.district
                     if hasattr(self, 'district') else None)!s}, "
                ...
                f"house_number_suffix={(self.house_number_suffix
                     if hasattr(self, 'house_number_suffix') else None)!s}, "
                f"building={(self.building
                     if hasattr(self, 'building') else None)!s}, "
