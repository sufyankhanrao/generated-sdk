...
from postnlecommerce.models.saturday import (
    Saturday,
)
from postnlecommerce.models.sunday import Sunday
from postnlecommerce.models.thursday import (
    Thursday,
)
from postnlecommerce.models.tuesday import Tuesday
from postnlecommerce.models.wednesday import (
    Wednesday,
)
...
class OpeningHours(object):
    ...
    def __init__(self,
        ...
        """Initialize a OpeningHours instance."""
    ...
    def from_dictionary(cls,
        ...
        monday = Monday.from_dictionary(
            dictionary.get("Monday"))\
            if "Monday" in dictionary.keys() else APIHelper.SKIP
        tuesday = Tuesday.from_dictionary(
            dictionary.get("Tuesday"))\
            if "Tuesday" in dictionary.keys() else APIHelper.SKIP
        wednesday = Wednesday.from_dictionary(
            dictionary.get("Wednesday"))\
            if "Wednesday" in dictionary.keys() else APIHelper.SKIP
        thursday = Thursday.from_dictionary(
            dictionary.get("Thursday"))\
            if "Thursday" in dictionary.keys() else APIHelper.SKIP
        friday = Friday.from_dictionary(
            dictionary.get("Friday"))\
            if "Friday" in dictionary.keys() else APIHelper.SKIP
        saturday = Saturday.from_dictionary(
            dictionary.get("Saturday"))\
            if "Saturday" in dictionary.keys() else APIHelper.SKIP
        sunday = Sunday.from_dictionary(
            dictionary.get("Sunday"))\
            if "Sunday" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"tuesday={(self.tuesday
                     if hasattr(self, 'tuesday') else None)!r}, "
                f"wednesday={(self.wednesday
                     if hasattr(self, 'wednesday') else None)!r}, "
                f"thursday={(self.thursday
                     if hasattr(self, 'thursday') else None)!r}, "
                f"friday={(self.friday if hasattr(self, 'friday') else None)!r}, "
                f"saturday={(self.saturday
                     if hasattr(self, 'saturday') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"tuesday={(self.tuesday
                     if hasattr(self, 'tuesday') else None)!s}, "
                f"wednesday={(self.wednesday
                     if hasattr(self, 'wednesday') else None)!s}, "
                f"thursday={(self.thursday
                     if hasattr(self, 'thursday') else None)!s}, "
                f"friday={(self.friday if hasattr(self, 'friday') else None)!s}, "
                f"saturday={(self.saturday
                     if hasattr(self, 'saturday') else None)!s}, "
