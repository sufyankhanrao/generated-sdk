...
class ResponseShipment2(object):
    """Implementation of the 'ResponseShipment2' model.
    ...
    def __init__(self,
        ...
        """Initialize a ResponseShipment2 instance."""
    ...
    def from_dictionary(cls,
        ...
        product_code_delivery =\
            ...
            if dictionary.get("ProductCodeDelivery") else APIHelper.SKIP
        labels = None
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"product_code_delivery={(self.product_code_delivery
                     if hasattr(self, 'product_code_delivery') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"product_code_delivery={(self.product_code_delivery
                     if hasattr(self, 'product_code_delivery') else None)!s}, "
