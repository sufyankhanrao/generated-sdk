...
from postnlecommerce.models.reason_no_timeframes import (
    ReasonNoTimeframes,
)
from postnlecommerce.models.timeframes import (
    Timeframes,
)
...
class TimeframeResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a TimeframeResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        timeframes = Timeframes.from_dictionary(
            dictionary.get("Timeframes"))\
            if "Timeframes" in dictionary.keys() else APIHelper.SKIP
        reason_no_timeframes = ReasonNoTimeframes.from_dictionary(
            dictionary.get("ReasonNoTimeframes"))\
            if "ReasonNoTimeframes" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"reason_no_timeframes={(self.reason_no_timeframes
                     if hasattr(self, 'reason_no_timeframes') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"reason_no_timeframes={(self.reason_no_timeframes
                     if hasattr(self, 'reason_no_timeframes') else None)!s})")
