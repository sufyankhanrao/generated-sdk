...
class Custom(object):
    ...
    def from_dictionary(cls,
        ...
        shipment_type =\
            dictionary.get("ShipmentType")\
            if dictionary.get("ShipmentType") else None
        content = None
        if dictionary.get("Content") is not None:
            content = [
                Content.from_dictionary(x)
                    for x in dictionary.get("Content")
            ]
        certificate =\
            dictionary.get("Certificate")\
            if "Certificate" in dictionary.keys() else APIHelper.SKIP
        certificate_nr =\
            dictionary.get("CertificateNr")\
            if dictionary.get("CertificateNr") else APIHelper.SKIP
        license =\
            dictionary.get("License")\
            if "License" in dictionary.keys() else APIHelper.SKIP
        license_nr =\
            dictionary.get("LicenseNr")\
            if dictionary.get("LicenseNr") else APIHelper.SKIP
        invoice =\
            dictionary.get("Invoice")\
            if "Invoice" in dictionary.keys() else APIHelper.SKIP
        invoice_nr =\
            dictionary.get("InvoiceNr")\
            if dictionary.get("InvoiceNr") else APIHelper.SKIP
        handle_as_non_deliverable =\
            dictionary.get("HandleAsNonDeliverable")\
            if "HandleAsNonDeliverable" in dictionary.keys() else APIHelper.SKIP
        trusted_shipper_id =\
            dictionary.get("TrustedShipperID")\
            if dictionary.get("TrustedShipperID") else APIHelper.SKIP
        importer_reference_code =\
            dictionary.get("ImporterReferenceCode")\
            if dictionary.get("ImporterReferenceCode") else APIHelper.SKIP
        transaction_code =\
            dictionary.get("TransactionCode")\
            if dictionary.get("TransactionCode") else APIHelper.SKIP
        transaction_description =\
            dictionary.get("TransactionDescription")\
            if dictionary.get("TransactionDescription") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"certificate={(self.certificate
                     if hasattr(self, 'certificate') else None)!r}, "
                f"certificate_nr={(self.certificate_nr
                     if hasattr(self, 'certificate_nr') else None)!r}, "
                f"license={(self.license
                     if hasattr(self, 'license') else None)!r}, "
                f"license_nr={(self.license_nr
                     if hasattr(self, 'license_nr') else None)!r}, "
                f"invoice={(self.invoice
                     if hasattr(self, 'invoice') else None)!r}, "
                f"invoice_nr={(self.invoice_nr
                     if hasattr(self, 'invoice_nr') else None)!r}, "
                f"handle_as_non_deliverable={(self.handle_as_non_deliverable
                     if hasattr(self, 'handle_as_non_deliverable') else None)!r}, "
                f"currency={self.currency!r}, "
                f"shipment_type={self.shipment_type!r}, "
                f"trusted_shipper_id={(self.trusted_shipper_id
                     if hasattr(self, 'trusted_shipper_id') else None)!r}, "
                f"importer_reference_code={(self.importer_reference_code
                     if hasattr(self, 'importer_reference_code') else None)!r}, "
                ...
                f"transaction_description={(self.transaction_description
                     if hasattr(self, 'transaction_description') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"certificate={(self.certificate
                     if hasattr(self, 'certificate') else None)!s}, "
                f"certificate_nr={(self.certificate_nr
                     if hasattr(self, 'certificate_nr') else None)!s}, "
                f"license={(self.license
                     if hasattr(self, 'license') else None)!s}, "
                f"license_nr={(self.license_nr
                     if hasattr(self, 'license_nr') else None)!s}, "
                f"invoice={(self.invoice
                     if hasattr(self, 'invoice') else None)!s}, "
                f"invoice_nr={(self.invoice_nr
                     if hasattr(self, 'invoice_nr') else None)!s}, "
                f"handle_as_non_deliverable={(self.handle_as_non_deliverable
                     if hasattr(self, 'handle_as_non_deliverable') else None)!s}, "
                f"currency={self.currency!s}, "
                f"shipment_type={self.shipment_type!s}, "
                f"trusted_shipper_id={(self.trusted_shipper_id
                     if hasattr(self, 'trusted_shipper_id') else None)!s}, "
                f"importer_reference_code={(self.importer_reference_code
                     if hasattr(self, 'importer_reference_code') else None)!s}, "
                f"transaction_code={(self.transaction_code
                     if hasattr(self, 'transaction_code') else None)!s}, "
                f"transaction_description={(self.transaction_description
                     if hasattr(self, 'transaction_description') else None)!s}, "
