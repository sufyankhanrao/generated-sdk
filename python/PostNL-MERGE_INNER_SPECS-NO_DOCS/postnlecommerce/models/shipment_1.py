...
from postnlecommerce.models.address_11 import (
    Address11,
)
...
from postnlecommerce.models.dimension import (
    Dimension,
)
from postnlecommerce.models.extra_field import (
    ExtraField,
)
from postnlecommerce.models.group import Group
from postnlecommerce.models.hazardous_material import (
    HazardousMaterial,
)
from postnlecommerce.models.product_option import (
    ProductOption,
)
...
class Shipment1(object):
    ...
    def __init__(self,
        ...
        """Initialize a Shipment1 instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("Addresses") is not None:
            addresses = [
                Address11.from_dictionary(x)
                    for x in dictionary.get("Addresses")
            ]
        barcode = dictionary.get("Barcode") if dictionary.get("Barcode") else None
        dimension = Dimension.from_dictionary(
            dictionary.get("Dimension"))\
            if dictionary.get("Dimension") else None
        product_code_delivery =\
            dictionary.get("ProductCodeDelivery")\
            if dictionary.get("ProductCodeDelivery") else "3085"
        amounts = None
        if dictionary.get("Amounts") is not None:
            ...
            amounts = APIHelper.SKIP
        coding_text =\
            dictionary.get("CodingText")\
            if dictionary.get("CodingText") else APIHelper.SKIP
        collection_time_stamp_start =\
            dictionary.get("CollectionTimeStampStart")\
            if dictionary.get("CollectionTimeStampStart") else APIHelper.SKIP
        collection_time_stamp_end =\
            dictionary.get("CollectionTimeStampEnd")\
            if dictionary.get("CollectionTimeStampEnd") else APIHelper.SKIP
        contacts = None
        if dictionary.get("Contacts") is not None:
            contacts = [
                Contact.from_dictionary(x)
                    for x in dictionary.get("Contacts")
            ]
        else:
            contacts = APIHelper.SKIP
        content =\
        ...
        customer_order_number =\
            dictionary.get("CustomerOrderNumber")\
            if dictionary.get("CustomerOrderNumber") else APIHelper.SKIP
        customs = Custom.from_dictionary(
            dictionary.get("Customs"))\
            if "Customs" in dictionary.keys() else APIHelper.SKIP
        delivery_address =\
            dictionary.get("DeliveryAddress")\
            if dictionary.get("DeliveryAddress") else APIHelper.SKIP
        delivery_date =\
            dictionary.get("DeliveryDate")\
            if dictionary.get("DeliveryDate") else APIHelper.SKIP
        down_partner_barcode =\
            dictionary.get("DownPartnerBarcode")\
            if dictionary.get("DownPartnerBarcode") else APIHelper.SKIP
        down_partner_id =\
            dictionary.get("DownPartnerID")\
            if dictionary.get("DownPartnerID") else APIHelper.SKIP
        down_partner_location =\
            dictionary.get("DownPartnerLocation")\
            if dictionary.get("DownPartnerLocation") else APIHelper.SKIP
        groups = None
        if dictionary.get("Groups") is not None:
            groups = [
                Group.from_dictionary(x)
        ...
        if dictionary.get("HazardousMaterial") is not None:
            hazardous_material = [
                HazardousMaterial.from_dictionary(x)
                    for x in dictionary.get("HazardousMaterial")
            ]
        else:
            hazardous_material = APIHelper.SKIP
        product_code_collect =\
            dictionary.get("ProductCodeCollect")\
            if dictionary.get("ProductCodeCollect") else APIHelper.SKIP
        product_options = None
        if dictionary.get("ProductOptions") is not None:
            product_options = [
                ProductOption.from_dictionary(x)
                    for x in dictionary.get("ProductOptions")
            ]
        else:
            product_options = APIHelper.SKIP
        receiver_date_of_birth =\
            dictionary.get("ReceiverDateOfBirth")\
            if dictionary.get("ReceiverDateOfBirth") else APIHelper.SKIP
        reference =\
            dictionary.get("Reference")\
            if dictionary.get("Reference") else APIHelper.SKIP
        reference_collect =\
            dictionary.get("ReferenceCollect")\
            if dictionary.get("ReferenceCollect") else APIHelper.SKIP
        remark =\
            dictionary.get("Remark")\
            if dictionary.get("Remark") else APIHelper.SKIP
        return_barcode =\
            dictionary.get("ReturnBarcode")\
            if dictionary.get("ReturnBarcode") else APIHelper.SKIP
        return_reference =\
            dictionary.get("ReturnReference")\
            if dictionary.get("ReturnReference") else APIHelper.SKIP
        timeslot_id =\
            dictionary.get("TimeslotID")\
            if dictionary.get("TimeslotID") else APIHelper.SKIP
        extra_fields = None
        if dictionary.get("ExtraFields") is not None:
            extra_fields = [
                ExtraField.from_dictionary(x)
                    for x in dictionary.get("ExtraFields")
            ]
        else:
            extra_fields = APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"amounts={(self.amounts
                     if hasattr(self, 'amounts') else None)!r}, "
                f"barcode={self.barcode!r}, "
                f"coding_text={(self.coding_text
                     if hasattr(self, 'coding_text') else None)!r}, "
                f"collection_time_stamp_start={(self.collection_time_stamp_start
                     if hasattr(self, 'collection_time_stamp_start') else None)!r}, "
                f"collection_time_stamp_end={(self.collection_time_stamp_end
                     if hasattr(self, 'collection_time_stamp_end') else None)!r}, "
                f"contacts={(self.contacts
                     if hasattr(self, 'contacts') else None)!r}, "
                f"content={(self.content
                     if hasattr(self, 'content') else None)!r}, "
                f"cost_center={(self.cost_center
                     if hasattr(self, 'cost_center') else None)!r}, "
                f"customer_order_number={(self.customer_order_number
                     if hasattr(self, 'customer_order_number') else None)!r}, "
                f"customs={(self.customs
                     if hasattr(self, 'customs') else None)!r}, "
                f"delivery_address={(self.delivery_address
                     if hasattr(self, 'delivery_address') else None)!r}, "
                f"delivery_date={(self.delivery_date
                     if hasattr(self, 'delivery_date') else None)!r}, "
                f"dimension={self.dimension!r}, "
                f"down_partner_barcode={(self.down_partner_barcode
                     if hasattr(self, 'down_partner_barcode') else None)!r}, "
                f"down_partner_id={(self.down_partner_id
                     if hasattr(self, 'down_partner_id') else None)!r}, "
                f"down_partner_location={(self.down_partner_location
                     if hasattr(self, 'down_partner_location') else None)!r}, "
                f"groups={(self.groups if hasattr(self, 'groups') else None)!r}, "
                f"hazardous_material={(self.hazardous_material
                     if hasattr(self, 'hazardous_material') else None)!r}, "
                f"product_code_collect={(self.product_code_collect
                     if hasattr(self, 'product_code_collect') else None)!r}, "
                f"product_code_delivery={self.product_code_delivery!r}, "
                f"product_options={(self.product_options
                     if hasattr(self, 'product_options') else None)!r}, "
                f"receiver_date_of_birth={(self.receiver_date_of_birth
                     if hasattr(self, 'receiver_date_of_birth') else None)!r}, "
                f"reference={(self.reference
                     if hasattr(self, 'reference') else None)!r}, "
                f"reference_collect={(self.reference_collect
                     if hasattr(self, 'reference_collect') else None)!r}, "
                f"remark={(self.remark if hasattr(self, 'remark') else None)!r}, "
                f"return_barcode={(self.return_barcode
                     if hasattr(self, 'return_barcode') else None)!r}, "
                f"return_reference={(self.return_reference
                     if hasattr(self, 'return_reference') else None)!r}, "
                f"timeslot_id={(self.timeslot_id
                     if hasattr(self, 'timeslot_id') else None)!r}, "
                f"extra_fields={(self.extra_fields
                     if hasattr(self, 'extra_fields') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"amounts={(self.amounts
                     if hasattr(self, 'amounts') else None)!s}, "
                f"barcode={self.barcode!s}, "
                f"coding_text={(self.coding_text
                     if hasattr(self, 'coding_text') else None)!s}, "
                f"collection_time_stamp_start={(self.collection_time_stamp_start
                     if hasattr(self, 'collection_time_stamp_start') else None)!s}, "
                f"collection_time_stamp_end={(self.collection_time_stamp_end
                     if hasattr(self, 'collection_time_stamp_end') else None)!s}, "
                f"contacts={(self.contacts
                     if hasattr(self, 'contacts') else None)!s}, "
                f"content={(self.content
                     if hasattr(self, 'content') else None)!s}, "
                f"cost_center={(self.cost_center
                     if hasattr(self, 'cost_center') else None)!s}, "
                f"customer_order_number={(self.customer_order_number
                     if hasattr(self, 'customer_order_number') else None)!s}, "
                f"customs={(self.customs
                     if hasattr(self, 'customs') else None)!s}, "
                f"delivery_address={(self.delivery_address
                     if hasattr(self, 'delivery_address') else None)!s}, "
                f"delivery_date={(self.delivery_date
                     if hasattr(self, 'delivery_date') else None)!s}, "
                f"dimension={self.dimension!s}, "
                f"down_partner_barcode={(self.down_partner_barcode
                     if hasattr(self, 'down_partner_barcode') else None)!s}, "
                f"down_partner_id={(self.down_partner_id
                     if hasattr(self, 'down_partner_id') else None)!s}, "
                f"down_partner_location={(self.down_partner_location
                     if hasattr(self, 'down_partner_location') else None)!s}, "
                f"groups={(self.groups if hasattr(self, 'groups') else None)!s}, "
                f"hazardous_material={(self.hazardous_material
                     if hasattr(self, 'hazardous_material') else None)!s}, "
                f"product_code_collect={(self.product_code_collect
                     if hasattr(self, 'product_code_collect') else None)!s}, "
                f"product_code_delivery={self.product_code_delivery!s}, "
                f"product_options={(self.product_options
                     if hasattr(self, 'product_options') else None)!s}, "
                f"receiver_date_of_birth={(self.receiver_date_of_birth
                     if hasattr(self, 'receiver_date_of_birth') else None)!s}, "
                f"reference={(self.reference
                     if hasattr(self, 'reference') else None)!s}, "
                f"reference_collect={(self.reference_collect
                     if hasattr(self, 'reference_collect') else None)!s}, "
                f"remark={(self.remark if hasattr(self, 'remark') else None)!s}, "
                f"return_barcode={(self.return_barcode
                     if hasattr(self, 'return_barcode') else None)!s}, "
                f"return_reference={(self.return_reference
                     if hasattr(self, 'return_reference') else None)!s}, "
                f"timeslot_id={(self.timeslot_id
                     if hasattr(self, 'timeslot_id') else None)!s}, "
                f"extra_fields={(self.extra_fields
                     if hasattr(self, 'extra_fields') else None)!s})")
