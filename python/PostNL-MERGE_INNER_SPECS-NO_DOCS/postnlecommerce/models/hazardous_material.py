...
class HazardousMaterial(object):
    ...
    def __init__(self,
        ...
        """Initialize a HazardousMaterial instance."""
    ...
    def from_dictionary(cls,
        ...
        toxic_substance_code =\
            dictionary.get("ToxicSubstanceCode")\
            if dictionary.get("ToxicSubstanceCode") else None
        additional_toxic_substance_code =\
            dictionary.get("AdditionalToxicSubstanceCode")\
            if dictionary.get("AdditionalToxicSubstanceCode") else APIHelper.SKIP
        adr_points =\
            dictionary.get("ADRPoints")\
            if dictionary.get("ADRPoints") else APIHelper.SKIP
        tunnel_code =\
            dictionary.get("TunnelCode")\
            if dictionary.get("TunnelCode") else APIHelper.SKIP
        packaging_group_code =\
            dictionary.get("PackagingGroupCode")\
            if dictionary.get("PackagingGroupCode") else APIHelper.SKIP
        packaging_group_description =\
            dictionary.get("PackagingGroupDescription")\
            if dictionary.get("PackagingGroupDescription") else APIHelper.SKIP
        gross_weight =\
            dictionary.get("GrossWeight")\
            if dictionary.get("GrossWeight") else APIHelper.SKIP
        undg_number =\
            dictionary.get("UNDGNumber")\
            if dictionary.get("UNDGNumber") else APIHelper.SKIP
        transport_category_code =\
            dictionary.get("TransportCategoryCode")\
            if dictionary.get("TransportCategoryCode") else APIHelper.SKIP
        chemical_technical_description =\
            dictionary.get("ChemicalTechnicalDescription")\
            if dictionary.get("ChemicalTechnicalDescription") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"additional_toxic_substance_code={(self.additional_toxic_substance_code
                     if hasattr(self, 'additional_toxic_substance_code') else None)!r}, "
                f"adr_points={(self.adr_points
                     if hasattr(self, 'adr_points') else None)!r}, "
                f"tunnel_code={(self.tunnel_code
                     if hasattr(self, 'tunnel_code') else None)!r}, "
                f"packaging_group_code={(self.packaging_group_code
                     if hasattr(self, 'packaging_group_code') else None)!r}, "
                f"packaging_group_description={(self.packaging_group_description
                     if hasattr(self, 'packaging_group_description') else None)!r}, "
                f"gross_weight={(self.gross_weight
                     if hasattr(self, 'gross_weight') else None)!r}, "
                f"undg_number={(self.undg_number
                     if hasattr(self, 'undg_number') else None)!r}, "
                f"transport_category_code={(self.transport_category_code
                     if hasattr(self, 'transport_category_code') else None)!r}, "
                f"chemical_technical_description={(self.chemical_technical_description
                     if hasattr(self, 'chemical_technical_description') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"additional_toxic_substance_code={(self.additional_toxic_substance_code
                     if hasattr(self, 'additional_toxic_substance_code') else None)!s}, "
                f"adr_points={(self.adr_points
                     if hasattr(self, 'adr_points') else None)!s}, "
                f"tunnel_code={(self.tunnel_code
                     if hasattr(self, 'tunnel_code') else None)!s}, "
                f"packaging_group_code={(self.packaging_group_code
                     if hasattr(self, 'packaging_group_code') else None)!s}, "
                f"packaging_group_description={(self.packaging_group_description
                     if hasattr(self, 'packaging_group_description') else None)!s}, "
                f"gross_weight={(self.gross_weight
                     if hasattr(self, 'gross_weight') else None)!s}, "
                f"undg_number={(self.undg_number
                     if hasattr(self, 'undg_number') else None)!s}, "
                f"transport_category_code={(self.transport_category_code
                     if hasattr(self, 'transport_category_code') else None)!s}, "
                f"chemical_technical_description={(self.chemical_technical_description
                     if hasattr(self, 'chemical_technical_description') else None)!s})")
