...
from postnlecommerce.models.address_4 import (
    Address4,
)
from postnlecommerce.models.amount_1 import (
    Amount1,
)
from postnlecommerce.models.customer_2 import (
    Customer2,
)
from postnlecommerce.models.dimension_1 import (
    Dimension1,
)
from postnlecommerce.models.event import Event
from postnlecommerce.models.expectation import (
    Expectation,
)
from postnlecommerce.models.old_status import (
    OldStatus,
)
from postnlecommerce.models.product_options import (
    ProductOptions,
)
...
class Shipment2(object):
    ...
    Attributes:
        ...
        shipment_counter (str): The sequence of this parcel in the multi-collo
            shipment
        customer (Customer2): The model property of type Customer2.
        ...
        dimension (Dimension1): The model property of type Dimension1.
        amount (Amount1): The amounts belonging to the shipment
        address (List[Address4]): A list of addresses belonging to the shipment
    ...
    def __init__(self,
        ...
        """Initialize a Shipment2 instance."""
    ...
    def from_dictionary(cls,
        ...
        main_barcode =\
            ...
            if dictionary.get("MainBarcode") else APIHelper.SKIP
        barcode =\
            dictionary.get("Barcode")\
            if dictionary.get("Barcode") else APIHelper.SKIP
        shipment_amount =\
            dictionary.get("ShipmentAmount")\
            if dictionary.get("ShipmentAmount") else APIHelper.SKIP
        shipment_counter =\
            dictionary.get("ShipmentCounter")\
            if dictionary.get("ShipmentCounter") else APIHelper.SKIP
        customer = Customer2.from_dictionary(
        ...
        product_description =\
            dictionary.get("ProductDescription")\
            if dictionary.get("ProductDescription") else APIHelper.SKIP
        reference =\
        ...
        dimension = Dimension1.from_dictionary(
            dictionary.get("Dimension"))\
            if "Dimension" in dictionary.keys() else APIHelper.SKIP
        amount = Amount1.from_dictionary(
            dictionary.get("Amount"))\
            if "Amount" in dictionary.keys() else APIHelper.SKIP
        address = None
        if dictionary.get("Address") is not None:
            address = [
                Address4.from_dictionary(x)
        ...
        if dictionary.get("Event") is not None:
            event = [
                Event.from_dictionary(x)
                    for x in dictionary.get("Event")
            ]
        else:
            event = APIHelper.SKIP
        expectation = Expectation.from_dictionary(
            dictionary.get("Expectation"))\
            if "Expectation" in dictionary.keys() else APIHelper.SKIP
        product_options = ProductOptions.from_dictionary(
            dictionary.get("ProductOptions"))\
            if "ProductOptions" in dictionary.keys() else APIHelper.SKIP
        ...
        if dictionary.get("OldStatus") is not None:
            old_status = [
                OldStatus.from_dictionary(x)
                    for x in dictionary.get("OldStatus")
            ]
        else:
            old_status = APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"main_barcode={(self.main_barcode
                     if hasattr(self, 'main_barcode') else None)!r}, "
                f"barcode={(self.barcode
                     if hasattr(self, 'barcode') else None)!r}, "
                f"shipment_amount={(self.shipment_amount
                     if hasattr(self, 'shipment_amount') else None)!r}, "
                f"shipment_counter={(self.shipment_counter
                     if hasattr(self, 'shipment_counter') else None)!r}, "
                ...
                f"product_description={(self.product_description
                     if hasattr(self, 'product_description') else None)!r}, "
                ...
                f"dimension={(self.dimension
                     if hasattr(self, 'dimension') else None)!r}, "
