...
from postnlecommerce.exceptions.checkout_response_invalid_exception import (
...
from postnlecommerce.models.checkout_response import (
    CheckoutResponse,
)
...
class CheckoutController(BaseController):
    ...
    def __init__(self, config):
        """Initialize CheckoutController object."""
        super(CheckoutController, self).__init__(config)

    def checkout(self,
                 body):
        """Perform a POST request to /shipment/v1/checkout.
