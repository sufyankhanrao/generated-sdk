...
from postnlecommerce.exceptions.labelling_response_invalid_exception import (
...
from postnlecommerce.models.labelling_response_1 import (
    LabellingResponse1,
)
...
class ShipmentController(BaseController):
    ...
    def __init__(self, config):
        """Initialize ShipmentController object."""
        super(ShipmentController, self).__init__(config)

    def generate_shipment_label(self,
                                body,
                                confirm=True):
        """Perform a POST request to /shipment/v2_2/label.
