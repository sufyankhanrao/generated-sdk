...
|  --- | --- | --- | --- |
| `order_date` | [`str`](../../doc/models/string-enum.md) | Required | The order date of the shipment. Format dd-MM-YYYY HH:mm:ss<br><br>**Constraints**: *Pattern*: `^[0-3]\d-[0-1]\d-20\d{2}\s[0-2]\d:[0-5]\d:[0-5]\d$` |
...
| `locations` | `int` | Required | Specifies the number of locations you want returned. This can be a value of 1-3<br><br>**Constraints**: `>= 1`, `<= 3` |
| `days` | `int` | Required | Specifies the number of days for which the timeframes are returned. This can be a value of 1-9<br><br>**Constraints**: `>= 1`, `<= 9` |
