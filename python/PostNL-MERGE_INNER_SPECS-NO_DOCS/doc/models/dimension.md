...
|  --- | --- | --- | --- |
| `height` | `int` | Optional | The shortest side of the shipment in millimeters (mm).<br><br>**Constraints**: `>= 1` |
| `length` | `int` | Optional | The longest side of the shipment in millimeters (mm).<br><br>**Constraints**: `>= 1` |
| `volume` | `int` | Optional | Volume of the shipment in centimeters (cm3). Mandatory for E@H-products.<br><br>**Constraints**: `>= 1` |
| `weight` | `int` | Required | Weight of the shipment in grams. Approximate weight suffices<br><br>**Constraints**: `>= 1` |
| `width` | `int` | Optional | The second longest side of the shipment in millimeters (mm).<br><br>**Constraints**: `>= 1` |
