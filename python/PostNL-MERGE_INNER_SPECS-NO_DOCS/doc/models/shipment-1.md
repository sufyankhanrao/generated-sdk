...
|  --- | --- | --- | --- |
| `addresses` | [`List[Address11]`](../../doc/models/address-11.md) | Required | List of 1 or more Address type elements. At least 1 address type is mandatory. See [Address types](https://developer.postnl.nl/docs/#/http/reference-data/reference-codes/address-types) for the available types. |
...
| `barcode` | [`str`](../../doc/models/string-enum.md) | Required | Barcode of the shipment. This is a unique value. Note: If you leave this attribute out of your request an unique barcode will be generated automatically.<br><br>**Constraints**: *Minimum Length*: `11`, *Maximum Length*: `15` |
| `coding_text` | [`str`](../../doc/models/string-enum.md) | Optional | Code used for logistic purposes (usually generated by the service itself and returned in the response). Please note that this must be provided when  using the Confirm API to confirm shipments where coding texts are required (e.g. letterbox parcels).<br><br>**Constraints**: *Minimum Length*: `0`, *Maximum Length*: `35` |
| `collection_time_stamp_start` | [`str`](../../doc/models/string-enum.md) | Optional | Starting date/time of the collection of the shipment. Format: dd-MM-yyyy hh:mm:ss<br><br>**Constraints**: *Pattern*: `^([0-3]\d-[01]\d-[12]\d{3}\s+)[0-2]\d:[0-5]\d(:[0-5]\d)$` |
| `collection_time_stamp_end` | [`str`](../../doc/models/string-enum.md) | Optional | Ending date/time of the collection of the shipment. Format: dd-MM-yyyy hh:mm:ss<br><br>**Constraints**: *Pattern*: `^([0-3]\d-[01]\d-[12]\d{3}\s+)[0-2]\d:[0-5]\d(:[0-5]\d)$` |
...
| `content` | [`str`](../../doc/models/string-enum.md) | Optional | Content of the shipment. Mandatory for Extra@Home shipments<br><br>**Constraints**: *Minimum Length*: `0`, *Maximum Length*: `35` |
| `cost_center` | [`str`](../../doc/models/string-enum.md) | Optional | Cost center of the shipment. This value will appear on your invoice<br><br>**Constraints**: *Minimum Length*: `0`, *Maximum Length*: `35` |
| `customer_order_number` | [`str`](../../doc/models/string-enum.md) | Optional | Order number of the customer<br><br>**Constraints**: *Minimum Length*: `0`, *Maximum Length*: `35` |
| `customs` | [`Custom`](../../doc/models/custom.md) | Optional | The Customs type is mandatory for non-EU shipments and not allowed for any other shipment types. |
| `delivery_address` | [`str`](../../doc/models/string-enum.md) | Optional | Delivery address specification. This field is mandatory when AddressType on the Address is 09.<br><br>**Constraints**: *Pattern*: `^\d{2}$` |
| `delivery_date` | [`str`](../../doc/models/string-enum.md) | Optional | Mandatory when using Mailbox Parcels (for generation of the coding rule) and delivery options like Evening/Morning/Sameday delivery etc.<br><br>**Constraints**: *Pattern*: `^[0-3]\d-[01]\d-[12]\d{3}\s[0-2]\d:[0-5]\d:[0-5]\d$` |
...
| `down_partner_barcode` | [`str`](../../doc/models/string-enum.md) | Optional | Barcode of the downstream network partner of PostNL Parcels. Madatory for requesting Parcels Non-EU combilabel product codes.<br><br>**Constraints**: *Minimum Length*: `0`, *Maximum Length*: `35` |
| `down_partner_id` | [`str`](../../doc/models/string-enum.md) | Optional | Identification of the downstream network partner of PostNL Pakketten.<br><br>**Constraints**: *Minimum Length*: `0`, *Maximum Length*: `50` |
| `down_partner_location` | [`str`](../../doc/models/string-enum.md) | Optional | Identification of the location of the downstream network partner of PostNL Pakketten.<br><br>**Constraints**: *Minimum Length*: `0`, *Maximum Length*: `10` |
...
| `product_code_delivery` | [`str`](../../doc/models/string-enum.md) | Required | Product code of the shipment. See the [Products page](https://developer.postnl.nl/docs/#/http/reference-data/product-codes) for possible products.<br><br>**Default**: `'3085'`<br><br>**Constraints**: *Pattern*: `^\d{4,5}$` |
...
| `receiver_date_of_birth` | [`str`](../../doc/models/string-enum.md) | Optional | Date of birth. Mandatory for Age check products<br><br>**Constraints**: *Pattern*: `^([0-3]\d-[01]\d-[12]\d{3})$` |
