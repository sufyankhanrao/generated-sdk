...
class OrgFlowRulesResponse(object):
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Constructor for the OrgFlowRulesResponse class"""
    ...
    def from_dictionary(cls,
        ...
        org_flow = dictionary.get("orgFlow") if dictionary.get("orgFlow") else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'org_flow={(self.org_flow if hasattr(self, "org_flow") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'org_flow={(self.org_flow if hasattr(self, "org_flow") else None)!s}, '
