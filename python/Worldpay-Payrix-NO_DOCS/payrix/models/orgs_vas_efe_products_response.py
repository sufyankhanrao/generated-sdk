...
class OrgsVASEfeProductsResponse(object):
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Initialize a OrgsVASEfeProductsResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        contract_type =\
            ...
            if dictionary.get("contractType") else APIHelper.SKIP
        platform =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"contract_type={(self.contract_type
                     if hasattr(self, 'contract_type') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"contract_type={(self.contract_type
                     if hasattr(self, 'contract_type') else None)!s}, "
                f"platform={(self.platform
