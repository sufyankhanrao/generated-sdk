...
class ChangeRequest(object):
    ...
    def __init__(self,
        ...
        """Constructor for the ChangeRequest class"""
    ...
    def from_dictionary(cls,
        ...
        operation = dictionary.get("operation") if dictionary.get("operation") else APIHelper.SKIP
        status = dictionary.get("status") if dictionary.get("status") else APIHelper.SKIP
        reason_type = dictionary.get("reasonType") if dictionary.get("reasonType") else APIHelper.SKIP
        reason = dictionary.get("reason") if dictionary.get("reason") else APIHelper.SKIP
        changes = dictionary.get("changes") if dictionary.get("changes") else APIHelper.SKIP
        model = dictionary.get("model") if dictionary.get("model") else APIHelper.SKIP
        record_id = dictionary.get("recordId") if dictionary.get("recordId") else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'auth_type={(self.auth_type if hasattr(self, "auth_type") else None)!r}, '
                f'operation={(self.operation if hasattr(self, "operation") else None)!r}, '
                f'status={(self.status if hasattr(self, "status") else None)!r}, '
                f'reason_type={(self.reason_type if hasattr(self, "reason_type") else None)!r}, '
                f'reason={(self.reason if hasattr(self, "reason") else None)!r}, '
                f'changes={(self.changes if hasattr(self, "changes") else None)!r}, '
                f'model={(self.model if hasattr(self, "model") else None)!r}, '
                f'record_id={(self.record_id if hasattr(self, "record_id") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'auth_type={(self.auth_type if hasattr(self, "auth_type") else None)!s}, '
                f'operation={(self.operation if hasattr(self, "operation") else None)!s}, '
                f'status={(self.status if hasattr(self, "status") else None)!s}, '
                f'reason_type={(self.reason_type if hasattr(self, "reason_type") else None)!s}, '
                f'reason={(self.reason if hasattr(self, "reason") else None)!s}, '
                f'changes={(self.changes if hasattr(self, "changes") else None)!s}, '
                f'model={(self.model if hasattr(self, "model") else None)!s}, '
                f'record_id={(self.record_id if hasattr(self, "record_id") else None)!s}, '
