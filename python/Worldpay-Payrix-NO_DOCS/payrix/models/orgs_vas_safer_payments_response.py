...
class OrgsVASSaferPaymentsResponse(object):

    """Implementation of the 'orgsVASSaferPaymentsResponse' model.
    ...
    Attributes:
        ...
        org (str): The identifier of the Org (group) that OrgsVASOmniTokens is
            associated to.
        default_program (OrgsVASSaferPaymentsDefaultProgramEnum): This field
            contains the default program type of the orgsVASSaferPayments. 
            <details> <summary>Valid Values</summary>  - `basic` - **Basic** -
            `managed` - **Managed**  </details>
    ...
    def __init__(self,
                 ...
                 org=APIHelper.SKIP,
                 default_program=APIHelper.SKIP,
                 inactive=0,
                 frozen=0):
        """Constructor for the OrgsVASSaferPaymentsResponse class"""
        ...
        if org is not APIHelper.SKIP:
            self.org = org 
        if default_program is not APIHelper.SKIP:
    ...
    def from_dictionary(cls,
        ...
        creator = APIHelper.deserialize_union_type(UnionTypeLookUp.get('OrgsVASSaferPaymentsResponseCreator'), dictionary.get('creator'), False) if dictionary.get('creator') is not None else APIHelper.SKIP
        ...
        default_program = dictionary.get("defaultProgram") if dictionary.get("defaultProgram") else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'default_program={(self.default_program if hasattr(self, "default_program") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'default_program={(self.default_program if hasattr(self, "default_program") else None)!s}, '
