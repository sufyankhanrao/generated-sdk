...
class OrgsVASSaferPaymentsResponse(object):
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Initialize a OrgsVASSaferPaymentsResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        default_program =\
            dictionary.get("defaultProgram")\
            if dictionary.get("defaultProgram") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"default_program={(self.default_program
                     if hasattr(self, 'default_program') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"default_program={(self.default_program
                     if hasattr(self, 'default_program') else None)!s}, "
                f"inactive={(self.inactive
