...
class OrgsVASRevenueBoostsResponse(object):

    """Implementation of the 'orgsVASRevenueBoostsResponse' model.
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Constructor for the OrgsVASRevenueBoostsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        creator = APIHelper.deserialize_union_type(UnionTypeLookUp.get('OrgsVASRevenueBoostsResponseCreator'), dictionary.get('creator'), False) if dictionary.get('creator') is not None else APIHelper.SKIP
