...
class DecisionsResponse(object):
    """Implementation of the 'decisionsResponse' model.
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Initialize a DecisionsResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        creator = APIHelper.deserialize_union_type(UnionTypeLookUp.get("DecisionsResponseCreator"), dictionary.get("creator"), False) if dictionary.get("creator") is not None else APIHelper.SKIP
        modifier =\
        ...
        additional_options =\
            dictionary.get("additionalOptions")\
            if dictionary.get("additionalOptions") else APIHelper.SKIP
        level =\
        ...
        sequence =\
            ...
            if dictionary.get("sequence") else APIHelper.SKIP
        amount =\
        ...
        period_factor =\
            dictionary.get("periodFactor")\
            if dictionary.get("periodFactor") else APIHelper.SKIP
        schedule =\
        ...
        high =\
            dictionary.get("high")\
            if dictionary.get("high") else APIHelper.SKIP
        use_cache =\
            dictionary.get("useCache")\
            if dictionary.get("useCache") else APIHelper.SKIP
        cache_time =\
            dictionary.get("cacheTime")\
            if dictionary.get("cacheTime") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"additional_options={(self.additional_options
                     if hasattr(self, 'additional_options') else None)!r}, "
                ...
                f"use_cache={(self.use_cache
                     if hasattr(self, 'use_cache') else None)!r}, "
                f"cache_time={(self.cache_time
                     if hasattr(self, 'cache_time') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"additional_options={(self.additional_options
                     if hasattr(self, 'additional_options') else None)!s}, "
                ...
                f"use_cache={(self.use_cache
                     if hasattr(self, 'use_cache') else None)!s}, "
                f"cache_time={(self.cache_time
                     if hasattr(self, 'cache_time') else None)!s}, "
                f"inactive={(self.inactive
