...
class ChargebackDocumentsResponse(object):
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Initialize a ChargebackDocumentsResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        document_source =\
            dictionary.get("documentSource")\
            if dictionary.get("documentSource") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"document_source={(self.document_source
                     if hasattr(self, 'document_source') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"document_source={(self.document_source
                     if hasattr(self, 'document_source') else None)!s}, "
                f"inactive={(self.inactive
