...
from payrix.models.billing_schedule_enum import (
    BillingScheduleEnum,
)
from payrix.models.collection_factor_enum import (
    CollectionFactorEnum,
)
from payrix.models.collection_include_current_enum import (
    CollectionIncludeCurrentEnum,
)
...
class BillingsPostRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a BillingsPostRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        collection_offset =\
            ...
            if dictionary.get("collectionOffset") else 1
        collection_include_current =\
            dictionary.get("collectionIncludeCurrent")\
            if dictionary.get("collectionIncludeCurrent") else 0
        currency =\
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(
                ...
                type_callable=lambda value: isinstance(value, int)) \
                and APIHelper.is_valid_type(
                value=dictionary.collection_include_current,
        ...
        return APIHelper.is_valid_type(
            ...
            type_callable=lambda value: isinstance(value, int)) \
            and APIHelper.is_valid_type(
            value=dictionary.get("collection"),
            type_callable=lambda value: isinstance(value, str)) \
            and APIHelper.is_valid_type(
            ...
            type_callable=lambda value: isinstance(value, int)) \
            and APIHelper.is_valid_type(
            value=dictionary.get("collectionIncludeCurrent"),
            type_callable=lambda value: CollectionIncludeCurrentEnum.validate(value)) \
            and APIHelper.is_valid_type(
