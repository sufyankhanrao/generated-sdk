...
class OrgsVASSaferPaymentsPutRequest(object):

    """Implementation of the 'orgsVASSaferPaymentsPutRequest' model.
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Constructor for the OrgsVASSaferPaymentsPutRequest class"""
