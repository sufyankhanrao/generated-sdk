...
class BatchesResponse(object):
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Initialize a BatchesResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        processing_date = dateutil.parser.parse(dictionary.get("processingDate")).date()\
        ...
        close_time =\
            dictionary.get("closeTime")\
            if dictionary.get("closeTime") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"close_time={(self.close_time
                     if hasattr(self, 'close_time') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"close_time={(self.close_time
                     if hasattr(self, 'close_time') else None)!s}, "
                f"inactive={(self.inactive
