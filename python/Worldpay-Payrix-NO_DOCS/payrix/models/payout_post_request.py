...
class PayoutPostRequest(object):
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Constructor for the PayoutPostRequest class"""
    ...
    def from_dictionary(cls,
        ...
        skip_off_days = dictionary.get("skipOffDays") if dictionary.get("skipOffDays") else None
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.account,
                ...
                and APIHelper.is_valid_type(value=dictionary.amount,
                                            type_callable=lambda value: isinstance(value, int)) \
                and APIHelper.is_valid_type(value=dictionary.float,
                                            type_callable=lambda value: isinstance(value, int)) \
                and APIHelper.is_valid_type(value=dictionary.skip_off_days,
                                            type_callable=lambda value: SkipOffDaysEnum.validate(value)) \
                and APIHelper.is_valid_type(value=dictionary.same_day,
                                            type_callable=lambda value: SameDayEnum.validate(value))

        if not isinstance(dictionary, dict):
            return False

        return APIHelper.is_valid_type(value=dictionary.get('account'),
                                       type_callable=lambda value: isinstance(value, str)) \
            ...
            and APIHelper.is_valid_type(value=dictionary.get('amount'),
                                        type_callable=lambda value: isinstance(value, int)) \
            and APIHelper.is_valid_type(value=dictionary.get('float'),
                                        type_callable=lambda value: isinstance(value, int)) \
            and APIHelper.is_valid_type(value=dictionary.get('skipOffDays'),
                                        type_callable=lambda value: SkipOffDaysEnum.validate(value)) \
            and APIHelper.is_valid_type(value=dictionary.get('sameDay'),
                                        type_callable=lambda value: SameDayEnum.validate(value))
