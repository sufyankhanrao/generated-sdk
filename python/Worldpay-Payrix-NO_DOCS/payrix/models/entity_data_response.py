...
class EntityDataResponse(object):
    ...
    def __init__(self,
        ...
        """Constructor for the EntityDataResponse class"""
    ...
    def from_dictionary(cls,
        ...
        tc_accept_signature = dictionary.get("tcAcceptSignature") if dictionary.get("tcAcceptSignature") else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'tc_accept_signature={(self.tc_accept_signature if hasattr(self, "tc_accept_signature") else None)!r})')
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'tc_accept_signature={(self.tc_accept_signature if hasattr(self, "tc_accept_signature") else None)!s})')
