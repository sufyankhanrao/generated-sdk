...
class OrgsVASPinlessDebitConversionsPostRequest(object):

    """Implementation of the 'orgsVASPinlessDebitConversionsPostRequest' model.
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Constructor for the OrgsVASPinlessDebitConversionsPostRequest class"""
