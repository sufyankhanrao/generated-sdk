...
class AggregationResultsResponse(object):
    ...
    def __init__(self,
                 ...
                 min=APIHelper.SKIP,
                 max=APIHelper.SKIP):
        """Initialize a AggregationResultsResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        aggregation_result_group =\
            dictionary.get("aggregationResultGroup")\
            if dictionary.get("aggregationResultGroup") else APIHelper.SKIP
        grouping =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"aggregation_result_group={(self.aggregation_result_group
                     if hasattr(self, 'aggregation_result_group') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"aggregation_result_group={(self.aggregation_result_group
                     if hasattr(self, 'aggregation_result_group') else None)!s}, "
                f"grouping={(self.grouping
