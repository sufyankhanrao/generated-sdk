...
class PayoutsResponse(object):
    """Implementation of the 'payoutsResponse' model.
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Initialize a PayoutsResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        creator = APIHelper.deserialize_union_type(UnionTypeLookUp.get("PayoutsResponseCreator"), dictionary.get("creator"), False) if dictionary.get("creator") is not None else APIHelper.SKIP
        modifier =\
        ...
        float =\
            dictionary.get("float")\
            if dictionary.get("float") else APIHelper.SKIP
        secondary_descriptor =\
