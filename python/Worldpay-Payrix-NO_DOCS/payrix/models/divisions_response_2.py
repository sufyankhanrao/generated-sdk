...
class DivisionsResponse2(object):
    """Implementation of the 'divisionsResponse2' model.
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Initialize a DivisionsResponse2 instance."""
    ...
    def from_dictionary(cls,
        ...
        creator = APIHelper.deserialize_union_type(UnionTypeLookUp.get("DivisionsResponse2Creator"), dictionary.get("creator"), False) if dictionary.get("creator") is not None else APIHelper.SKIP
        modifier =\
