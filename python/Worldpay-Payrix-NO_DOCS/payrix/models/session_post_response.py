...
class SessionPostResponse(object):
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Constructor for the SessionPostResponse class"""
    ...
    def from_dictionary(cls,
        ...
        public = dictionary.get("public") if dictionary.get("public") else APIHelper.SKIP
        ...
        mfa_authenticated = dictionary.get("mfaAuthenticated") if dictionary.get("mfaAuthenticated") else APIHelper.SKIP
        effective_roles = dictionary.get("effectiveRoles") if dictionary.get("effectiveRoles") else APIHelper.SKIP
        effective_resources = dictionary.get("effectiveResources") if dictionary.get("effectiveResources") else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'mfa_authenticated={(self.mfa_authenticated if hasattr(self, "mfa_authenticated") else None)!r}, '
                f'effective_roles={(self.effective_roles if hasattr(self, "effective_roles") else None)!r}, '
                f'effective_resources={(self.effective_resources if hasattr(self, "effective_resources") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'mfa_authenticated={(self.mfa_authenticated if hasattr(self, "mfa_authenticated") else None)!s}, '
                f'effective_roles={(self.effective_roles if hasattr(self, "effective_roles") else None)!s}, '
                f'effective_resources={(self.effective_resources if hasattr(self, "effective_resources") else None)!s}, '
