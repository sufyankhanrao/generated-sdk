...
class OrgsVASSaferPaymentsPostRequest(object):

    """Implementation of the 'orgsVASSaferPaymentsPostRequest' model.
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Constructor for the OrgsVASSaferPaymentsPostRequest class"""
