...
class ItemsResponse(object):
    """Implementation of the 'itemsResponse' model.
    ...
    Attributes:
        ...
        txn (str): The txn in which these items have been sold, A single txn
            may have many items.
        item (str): The SKU, short name or title of the item sold.
        description (str): A description of this Item. This field is stored as
        ...
        custom (str): A custom identifier for this line Item. This field is
            ...
            long.
        um (str): The unit of measure for this Item. This field is stored as a
        ...
        price (int): The amount charged for this Item. This field is specified
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Initialize a ItemsResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        creator = APIHelper.deserialize_union_type(UnionTypeLookUp.get("ItemsResponseCreator"), dictionary.get("creator"), False) if dictionary.get("creator") is not None else APIHelper.SKIP
        modifier =\
