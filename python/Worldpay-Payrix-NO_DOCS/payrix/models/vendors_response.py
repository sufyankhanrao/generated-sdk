...
class VendorsResponse(object):
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Initialize a VendorsResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        deal_id =\
            dictionary.get("dealId")\
            if dictionary.get("dealId") else APIHelper.SKIP
        onboarding_contact_emails =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"deal_id={(self.deal_id
                     if hasattr(self, 'deal_id') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"deal_id={(self.deal_id
                     if hasattr(self, 'deal_id') else None)!s}, "
                f"onboarding_contact_emails={(self.onboarding_contact_emails
