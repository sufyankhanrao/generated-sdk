    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.login,
                ...
                and APIHelper.is_valid_type(value=dictionary.release,
                                            type_callable=lambda value: ReleaseEnum.validate(value)) \
                and APIHelper.is_valid_type(value=dictionary.release_factor,
                                            type_callable=lambda value: isinstance(value, int)) \
        ...
        return APIHelper.is_valid_type(value=dictionary.get('login'),
            ...
            and APIHelper.is_valid_type(value=dictionary.get('percent'),
                                        type_callable=lambda value: isinstance(value, int)) \
            and APIHelper.is_valid_type(value=dictionary.get('release'),
                                        type_callable=lambda value: ReleaseEnum.validate(value)) \
            and APIHelper.is_valid_type(value=dictionary.get('releaseFactor'),
                                        type_callable=lambda value: isinstance(value, int)) \
