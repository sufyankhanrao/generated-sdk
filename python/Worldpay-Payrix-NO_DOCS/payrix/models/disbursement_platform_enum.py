...
class DisbursementPlatformEnum(object):

    """Implementation of the 'disbursementPlatform' enum.
    ...
    """
    _all_values = ['ELAVON', 'VANTIV', 'VCORE', 'TDBANK', 'TDBANKCA', 'WELLSACH', 'WELLSFARGO', 'WFSINGLE', 'WORLDPAY']
    ELAVON = 'ELAVON'
