...
class PinlessDebitConversionsResponse(object):
    """Implementation of the 'pinlessDebitConversionsResponse' model.
    ...
    Attributes:
        ...
        enablement_date (str): The Date and time when an entity was enabled
            for pinlessDebitConversion. The date is specified as an eight
            digit string in YYYY-MM-DD hh:mm:ss format, for example,
            '2023-06-01 01:00:00' for June 01, 2023. 1:00 am.
        org (str): The identifier of the Org (group) that
            pinlessDebitConversion is associated to.
        division (str): The identifier of the Division that
            pinlessDebitConversion is associated to.
        partition (str): The identifier of the Partition that
            pinlessDebitConversion is associated to.
        platform (Platform2Enum): The platform used to process this
            transaction.
        ...
        deleter (str): The id of user who deleted the pinlessDebitConversion.
    ...
    def __init__(self,
        ...
        """Initialize a PinlessDebitConversionsResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        creator = APIHelper.deserialize_union_type(UnionTypeLookUp.get("PinlessDebitConversionsResponseCreator"), dictionary.get("creator"), False) if dictionary.get("creator") is not None else APIHelper.SKIP
        modifier =\
