...
class EntityCustomFieldsPutRequest(object):

    """Implementation of the 'entityCustomFieldsPutRequest' model.
    ...
    def __init__(self,
        ...
        """Constructor for the EntityCustomFieldsPutRequest class"""
