...
class OrgsVASPinlessDebitConversionsPutRequest(object):

    """Implementation of the 'orgsVASPinlessDebitConversionsPutRequest' model.
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Constructor for the OrgsVASPinlessDebitConversionsPutRequest class"""
