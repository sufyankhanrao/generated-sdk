...
class MessageThreadsPostRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a MessageThreadsPostRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        folder =\
            ...
            if dictionary.get("folder") else "default"
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(
                ...
                type_callable=lambda value: isinstance(value, str)) \
                and APIHelper.is_valid_type(
                value=dictionary.sender,
                type_callable=lambda value: isinstance(value, str)) \
                and APIHelper.is_valid_type(
                value=dictionary.recipient,
                type_callable=lambda value: isinstance(value, str)) \
                and APIHelper.is_valid_type(
        ...
        return APIHelper.is_valid_type(
            ...
            type_callable=lambda value: isinstance(value, str)) \
            and APIHelper.is_valid_type(
            value=dictionary.get("folder"),
            type_callable=lambda value: isinstance(value, str)) \
            and APIHelper.is_valid_type(
            value=dictionary.get("sender"),
            type_callable=lambda value: isinstance(value, str)) \
            and APIHelper.is_valid_type(
            value=dictionary.get("recipient"),
            type_callable=lambda value: isinstance(value, str)) \
            and APIHelper.is_valid_type(
