...
class TeamsResponse(object):
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Initialize a TeamsResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        auto_cascade_disabled =\
            ...
            if dictionary.get("autoCascadeDisabled") else APIHelper.SKIP
        auto_cascade_owner =\
            dictionary.get("autoCascadeOwner")\
            if dictionary.get("autoCascadeOwner") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"auto_cascade_disabled={(self.auto_cascade_disabled
                     if hasattr(self, 'auto_cascade_disabled') else None)!r}, "
                f"auto_cascade_owner={(self.auto_cascade_owner
                     if hasattr(self, 'auto_cascade_owner') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"auto_cascade_disabled={(self.auto_cascade_disabled
                     if hasattr(self, 'auto_cascade_disabled') else None)!s}, "
                f"auto_cascade_owner={(self.auto_cascade_owner
                     if hasattr(self, 'auto_cascade_owner') else None)!s}, "
                f"inactive={(self.inactive
