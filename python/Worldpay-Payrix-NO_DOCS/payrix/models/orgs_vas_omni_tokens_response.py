...
class OrgsVASOmniTokensResponse(object):

    """Implementation of the 'orgsVASOmniTokensResponse' model.
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Constructor for the OrgsVASOmniTokensResponse class"""
    ...
    def from_dictionary(cls,
        ...
        creator = APIHelper.deserialize_union_type(UnionTypeLookUp.get('OrgsVASOmniTokensResponseCreator'), dictionary.get('creator'), False) if dictionary.get('creator') is not None else APIHelper.SKIP
