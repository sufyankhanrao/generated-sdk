...
class SubscriptionsPutRequest(object):

    """Implementation of the 'subscriptionsPutRequest' model.
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Constructor for the SubscriptionsPutRequest class"""
    ...
    def from_dictionary(cls,
        ...
        plan = dictionary.get("plan") if dictionary.get("plan") else APIHelper.SKIP
        ...
        failures = dictionary.get("failures") if dictionary.get("failures") else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'failures={(self.failures if hasattr(self, "failures") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'failures={(self.failures if hasattr(self, "failures") else None)!s}, '
