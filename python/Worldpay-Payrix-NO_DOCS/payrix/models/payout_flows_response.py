...
class PayoutFlowsResponse(object):
    ...
    def __init__(self,
                 ...
                 frozen=0,
                 inactive=0):
        """Initialize a PayoutFlowsResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        payout_login =\
            dictionary.get("payoutLogin")\
            if dictionary.get("payoutLogin") else APIHelper.SKIP
        ...
        schedule =\
            ...
            if dictionary.get("schedule") else "days"
        schedule_factor =\
        ...
        payout_inactive =\
            dictionary.get("payoutInactive")\
            if dictionary.get("payoutInactive") else APIHelper.SKIP
        skip_off_days =\
            dictionary.get("skipOffDays")\
            if dictionary.get("skipOffDays") else APIHelper.SKIP
        same_day =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"payout_login={(self.payout_login
                     if hasattr(self, 'payout_login') else None)!r}, "
                ...
                f"payout_inactive={(self.payout_inactive
                     if hasattr(self, 'payout_inactive') else None)!r}, "
                f"skip_off_days={(self.skip_off_days
                     if hasattr(self, 'skip_off_days') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"payout_login={(self.payout_login
                     if hasattr(self, 'payout_login') else None)!s}, "
                ...
                f"payout_inactive={(self.payout_inactive
                     if hasattr(self, 'payout_inactive') else None)!s}, "
                f"skip_off_days={(self.skip_off_days
                     if hasattr(self, 'skip_off_days') else None)!s}, "
                f"same_day={(self.same_day
