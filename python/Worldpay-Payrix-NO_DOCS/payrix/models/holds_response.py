...
class HoldsResponse(object):
    ...
    def __init__(self,
        ...
        """Initialize a HoldsResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        verification =\
            ...
            if dictionary.get("verification") else APIHelper.SKIP
        verification_ref =\
            dictionary.get("verificationRef")\
            if dictionary.get("verificationRef") else APIHelper.SKIP
        decision_action =\
            dictionary.get("decisionAction")\
            if dictionary.get("decisionAction") else APIHelper.SKIP
        action =\
        ...
        claimed =\
            ...
            if dictionary.get("claimed") else APIHelper.SKIP
        hold_source =\
        ...
        hold_source_details =\
            dictionary.get("holdSourceDetails")\
            if dictionary.get("holdSourceDetails") else APIHelper.SKIP
        division =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"verification={(self.verification
                     if hasattr(self, 'verification') else None)!r}, "
                f"verification_ref={(self.verification_ref
                     if hasattr(self, 'verification_ref') else None)!r}, "
                f"decision_action={(self.decision_action
                     if hasattr(self, 'decision_action') else None)!r}, "
                ...
                f"hold_source_details={(self.hold_source_details
                     if hasattr(self, 'hold_source_details') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"verification={(self.verification
                     if hasattr(self, 'verification') else None)!s}, "
                f"verification_ref={(self.verification_ref
                     if hasattr(self, 'verification_ref') else None)!s}, "
                f"decision_action={(self.decision_action
                     if hasattr(self, 'decision_action') else None)!s}, "
                ...
                f"hold_source_details={(self.hold_source_details
                     if hasattr(self, 'hold_source_details') else None)!s}, "
                f"division={(self.division
