...
class EntityTermsResponse(object):
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Initialize a EntityTermsResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        date_accepted =\
            dictionary.get("dateAccepted")\
            if dictionary.get("dateAccepted") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"version_id={(self.version_id
                     if hasattr(self, 'version_id') else None)!r}, "
                f"ip={(self.ip if hasattr(self, 'ip') else None)!r}, "
                f"date_accepted={(self.date_accepted
                     if hasattr(self, 'date_accepted') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"version_id={(self.version_id
                     if hasattr(self, 'version_id') else None)!s}, "
                f"ip={(self.ip if hasattr(self, 'ip') else None)!s}, "
                f"date_accepted={(self.date_accepted
                     if hasattr(self, 'date_accepted') else None)!s}, "
                f"inactive={(self.inactive
