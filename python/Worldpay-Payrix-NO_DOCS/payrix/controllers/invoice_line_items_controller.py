...
from payrix.models.invoice_line_items_response_result import (
    InvoiceLineItemsResponseResult,
)


class InvoiceLineItemsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize InvoiceLineItemsController object."""
        super(InvoiceLineItemsController, self).__init__(config)

    def get_invoice_line_items_id(self,
                                  id,
                                  request_token=None):
        """Perform a GET request to /invoiceLineItems/{id}.

        Query an InvoiceLineItem or Invoice Line Item.

        Args:
            id (str): The ID of this invoice line item.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                the Response for query on invoiceLineItems resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(InvoiceLineItemsResponseResult.from_dictionary)
    ...
    def put_invoice_line_items_id(self,
                                  ...
                                  body,
                                  request_token=None):
        """Perform a PUT request to /invoiceLineItems/{id}.

        Update an InvoiceLineItem or Invoice Line Item.

        Args:
            id (str): The ID of this invoice line item.
            body (InvoiceLineItemsPutRequest): Update Invoice Line Item Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for updating an Invoice Line Item.
    ...
    def delete_invoice_line_items_id(self,
                                     id,
                                     request_token=None):
        """Perform a DELETE request to /invoiceLineItems/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                response for deleting an invoice line item is the Delete
    ...
    def get_invoice_line_items(self,
                               ...
                               page_number=None,
                               page_limit=None):
        """Perform a GET request to /invoiceLineItems.

        Query an InvoiceLineItem. InvoiceLineItem is a resource that relates
        an invoice item with an invoice. It holds information such as
        quantity, and price each item.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on invoiceLineItems resource
    ...
    def post_invoice_line_items(self,
                                body,
                                request_token=None):
        """Perform a POST request to /invoiceLineItems.

        Create an InvoiceLineItem or Invoice Line Item.InvoiceLineItem is a
        resource that relates an invoice item with an invoice. It holds
        information such as quantity, and price each item.

        Args:
            body (InvoiceLineItemsPostRequest): Create Invoice Line Item
                Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. The
                response for creating an invoice line item on the
                invoiceLineItems resource
