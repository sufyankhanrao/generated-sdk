...
from payrix.models.refunds_response_result import RefundsResponseResult
...
class FeeRefundsController(BaseController):
    ...
    def get_refunds_id(self,
                       id,
                       request_token=None):
        """Does a GET request to /refunds/{id}.
    ...
    def post_refunds(self,
                     body,
                     request_token=None):
        """Does a POST request to /refunds.
