...
from payrix.models.refunds_response_result import (
    RefundsResponseResult,
)


class FeeRefundsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize FeeRefundsController object."""
        super(FeeRefundsController, self).__init__(config)

    def get_refunds_id(self,
                       id,
                       request_token=None):
        """Perform a GET request to /refunds/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                a Fee Refund Response for query on refunds resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(RefundsResponseResult.from_dictionary)
    ...
    def get_refunds(self,
                    ...
                    page_number=None,
                    page_limit=None):
        """Perform a GET request to /refunds.
    ...
    def post_refunds(self,
                     body,
                     request_token=None):
        """Perform a POST request to /refunds.

        Create a Refund.

        Args:
            body (RefundsRequest): Create a Fee Refund Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on refunds resource
