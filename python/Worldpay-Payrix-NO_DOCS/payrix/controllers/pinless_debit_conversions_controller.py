...
from payrix.models.pinless_debit_conversions_response_result import (
    PinlessDebitConversionsResponseResult,
)


class PinlessDebitConversionsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize PinlessDebitConversionsController object."""
        super(PinlessDebitConversionsController, self).__init__(config)

    def get_pinless_debit_conversions_id(self,
                                         id,
                                         request_token=None):
        """Perform a GET request to /pinlessDebitConversions/{id}.

        Query a pinlessDebitConversion.

        Args:
            id (str): The ID of this pinlessDebitConversion.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for retrieving pinlessDebitConversion response.
        ...
        return super().new_api_call_builder.request(
            ...
            .path("/pinlessDebitConversions/{id}")
            ...
            .deserialize_into(PinlessDebitConversionsResponseResult.from_dictionary)
    ...
    def put_pinless_debit_conversions_id(self,
                                         ...
                                         body,
                                         request_token=None):
        """Perform a PUT request to /pinlessDebitConversions/{id}.

        Update a pinlessDebitConversion.

        Args:
            id (str): The ID of this Pinless Debit Conversions.
            body (PinlessDebitConversionsPutRequest): Update Pinless Debit
                Conversions
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for update on Pinless Debit Conversions response.
    ...
    def get_pinless_debit_conversions(self,
                                      ...
                                      page_number=None,
                                      page_limit=None):
        """Perform a GET request to /pinlessDebitConversions.
    ...
    def post_pinless_debit_conversions(self,
                                       body,
                                       request_token=None):
        """Perform a POST request to /pinlessDebitConversions.

        Create a pinlessDebitConversions.

        Args:
            body (PinlessDebitConversionsPostRequest): Create Pinless Debit
                Conversions Request.
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on Pinless Debit Conversions resource.
