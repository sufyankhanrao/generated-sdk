...
from payrix.models.statements_response_result import (
...
class StatementsController(BaseController):
    ...
    def get_statements_id(self,
                          id,
                          request_token=None):
        """Perform a GET request to /statements/{id}.

        Query a Statement. A Statement resource represents the total
        collection of funds owed for a Billing period.

        Args:
            id (str): The ID of this resource and The Statement ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for retrieving statement response.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(StatementsResponseResult.from_dictionary)
    ...
    def get_statements(self,
                       ...
                       page_number=None,
                       page_limit=None):
        """Perform a GET request to /statements.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on statements resource
