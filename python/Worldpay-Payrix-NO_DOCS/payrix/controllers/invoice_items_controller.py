...
from payrix.models.invoice_items_response_result import (
...
class InvoiceItemsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize InvoiceItemsController object."""
        super(InvoiceItemsController, self).__init__(config)

    def get_invoice_items_id(self,
                             id,
                             request_token=None):
        """Perform a GET request to /invoiceItems/{id}.

        Query an Invoice Item or query Invoice Items.

        Args:
            id (str): The ID of this invoice item.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for retrieve invoice item response.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(InvoiceItemsResponseResult.from_dictionary)
    ...
    def put_invoice_items_id(self,
                             ...
                             body,
                             request_token=None):
        """Perform a PUT request to /invoiceItems/{id}.

        Update an Invoice Item, A InvoiceItem is a resource that stores line
        item details for an invoice.

        Args:
            id (str): The ID of this invoice item.
            body (InvoiceItemsPutRequest): Update Invoice Item Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for update on invoiceItems resource: Update Invoice Item
                Response
    ...
    def delete_invoice_items_id(self,
                                id,
                                request_token=None):
        """Perform a DELETE request to /invoiceItems/{id}.

        Delete an Invoice Item or a resource that stores line item details for
        an invoice.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                response for deleting an invoice item from the invoiceItems
                resource is the Delete Invoice Item Response.
    ...
    def get_invoice_items(self,
                          ...
                          page_number=None,
                          page_limit=None):
        """Perform a GET request to /invoiceItems.

        Query an Invoice Item. A Invoice Item is a resource that stores line
        item details for an invoice.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on invoiceItems resource
    ...
    def post_invoice_items(self,
                           body,
                           request_token=None):
        """Perform a POST request to /invoiceItems.

        Create an Invoice Item, a resource that stores line item details for
        an invoice.

        Args:
            body (InvoiceItemsPostRequest): Create Invoice Item Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on invoiceItems resource
