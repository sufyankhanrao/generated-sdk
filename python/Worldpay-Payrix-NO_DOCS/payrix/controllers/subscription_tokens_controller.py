...
from payrix.models.subscription_tokens_response_result import (
    SubscriptionTokensResponseResult,
)


class SubscriptionTokensController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize SubscriptionTokensController object."""
        super(SubscriptionTokensController, self).__init__(config)

    def get_subscription_tokens_id(self,
                                   id,
                                   request_token=None):
        """Perform a GET request to /subscriptionTokens/{id}.

        Query a Subscription Token, which represents an association between a
        Subscription and a means of payment (Token) for that Subscription.

        Args:
            id (str): The ID of this subscription token.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for retrieve subscription token response.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(SubscriptionTokensResponseResult.from_dictionary)
    ...
    def put_subscription_tokens_id(self,
                                   ...
                                   body,
                                   request_token=None):
        """Perform a PUT request to /subscriptionTokens/{id}.

        Update a Subscription Token, which represents an association between a
        Subscription and a means of payment (Token) for that Subscription.

        Args:
            id (str): The ID of this resource or The Subscription Token ID.
            body (SubscriptionTokensPutRequest): Update Subscription Token
                Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for update on subscriptionTokens resource: Update Subscription
                Token Response
    ...
    def delete_subscription_tokens_id(self,
                                      id,
                                      request_token=None):
        """Perform a DELETE request to /subscriptionTokens/{id}.

        Delete a Subscription Token, which represents an association between a
        Subscription and a means of payment (Token) for that Subscription.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for delete on subscriptionTokens response.
    ...
    def get_subscription_tokens(self,
                                ...
                                page_number=None,
                                page_limit=None):
        """Perform a GET request to /subscriptionTokens.

        Query a Subscription Tokens resource.
        A Subscription Tokens resource represents an association between a
        Subscription and a means of payment (Token) for that Subscription.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on subscriptionTokens resource
    ...
    def post_subscription_tokens(self,
                                 body,
                                 request_token=None):
        """Perform a POST request to /subscriptionTokens.
        ...
        Args:
            body (SubscriptionTokensPostRequest): Create Subscription Token
                Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on subscriptionTokens resource
