...
from payrix.models.alert_triggers_response_result import (
...
class AlertTriggersController(BaseController):
    ...
    def __init__(self, config):
        """Initialize AlertTriggersController object."""
        super(AlertTriggersController, self).__init__(config)

    def get_alert_triggers_id(self,
                              id,
                              request_token=None):
        """Perform a GET request to /alertTriggers/{id}.
    ...
    def put_alert_triggers_id(self,
                              ...
                              body,
                              request_token=None):
        """Perform a PUT request to /alertTriggers/{id}.
    ...
    def delete_alert_triggers_id(self,
                                 id,
                                 request_token=None):
        """Perform a DELETE request to /alertTriggers/{id}.
    ...
    def get_alert_triggers(self,
                           ...
                           page_number=None,
                           page_limit=None):
        """Perform a GET request to /alertTriggers.
    ...
    def post_alert_triggers(self,
                            body,
                            request_token=None):
        """Perform a POST request to /alertTriggers.
