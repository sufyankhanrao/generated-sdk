...
from payrix.models.pending_entries_response_result import (
    PendingEntriesResponseResult,
)


class PendingEntryController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize PendingEntryController object."""
        super(PendingEntryController, self).__init__(config)

    def get_pending_entries_id(self,
                               id,
                               request_token=None):
        """Perform a GET request to /pendingEntries/{id}.

        Query a Pending Entry resource.

        Args:
            id (str): The ID of this resource or The Pending Entry ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                the Response for the Query on the Pending Entries Resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(PendingEntriesResponseResult.from_dictionary)
    ...
    def get_pending_entries(self,
                            ...
                            page_number=None,
                            page_limit=None):
        """Perform a GET request to /pendingEntries.

        Query a PendingEntry resource.
        A PendingEntry resource represents a record of amounts moving in or
        out of the funds held by an Entity.
        For example, this could be a time-based activity such as a weekly or
        monthly summary, or an event-based activity such as a Capture, a
        Payout, or a Fee. In the case of an event-based activity, the
        PendingEntry contains references the activity in the appropriate
        field. Eventually the PendingEntry will trigger the creation of an
        Entry resource and its amount will reflect any unsourced amounts for
        the Entry.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Retrieve
                Pending Entries Response for query on pendingEntries resource.
