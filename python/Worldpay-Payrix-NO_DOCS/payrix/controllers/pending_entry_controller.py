...
from payrix.models.pending_entries_response_result import PendingEntriesResponseResult
...
class PendingEntryController(BaseController):
    ...
    def get_pending_entries_id(self,
                               id,
                               request_token=None):
        """Does a GET request to /pendingEntries/{id}.
    ...
    def get_pending_entries(self,
                            ...
                            page_number=None,
                            page_limit=None):
        """Does a GET request to /pendingEntries.
