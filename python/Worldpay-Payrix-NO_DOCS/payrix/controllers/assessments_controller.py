...
from payrix.models.assessments_response_result import (
...
class AssessmentsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize AssessmentsController object."""
        super(AssessmentsController, self).__init__(config)

    def get_assessments_id(self,
                           id,
                           request_token=None):
        """Perform a GET request to /assessments/{id}.

        Query an Assessment resource that represents a record of fees charged
        by processors or other third parties to Entities or Orgs. Fees can
        represent charges that are levied on a one-off, regularly scheduled,
        or event-driven basis.

        Args:
            id (str): The ID of this assessment.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                assessment response for query on assessments resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(AssessmentsResponseResult.from_dictionary)
    ...
    def get_assessments(self,
                        ...
                        page_number=None,
                        page_limit=None):
        """Perform a GET request to /assessments.

        Query an Assessment resource that represents a record of fees charged
        by processors or other third parties to Entities or Orgs. These fees
        are levied on a one-off, regularly scheduled, or event-driven basis.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Retrieve
                assessments response for query on assessments resource.
