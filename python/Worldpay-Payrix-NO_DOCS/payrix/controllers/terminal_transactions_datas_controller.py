...
from payrix.models.terminal_txn_datas_response_result import (
    TerminalTxnDatasResponseResult,
)


class TerminalTransactionsDatasController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize TerminalTransactionsDatasController object."""
        super(TerminalTransactionsDatasController, self).__init__(config)

    def get_terminal_txns_datas_id(self,
                                   id,
                                   request_token=None):
        """Perform a GET request to /terminalTxnDatas/{id}.

        Query a TerminalTxnData resource.

        Args:
            id (str): The Terminal Transaction Data ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Terminal Transaction Data Response
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(TerminalTxnDatasResponseResult.from_dictionary)
    ...
    def get_terminal_txns_datas(self,
                                ...
                                page_number=None,
                                page_limit=None):
        """Perform a GET request to /terminalTxnDatas.
    ...
    def post_terminal_txns_datas(self,
                                 body,
                                 request_token=None):
        """Perform a POST request to /terminalTxnDatas.

        Create a TerminalTxnData resource.

        Args:
            body (TerminalTxnsDatasPostRequest): Create Terminal Transaction
                Data Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
