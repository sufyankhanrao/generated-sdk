...
from payrix.models.terminal_txn_datas_response_result import TerminalTxnDatasResponseResult
...
class TerminalTransactionsDatasController(BaseController):
    ...
    def get_terminal_txns_datas_id(self,
                                   id,
                                   request_token=None):
        """Does a GET request to /terminalTxnDatas/{id}.
    ...
    def get_terminal_txns_datas(self,
                                ...
                                page_number=None,
                                page_limit=None):
        """Does a GET request to /terminalTxnDatas.
    ...
    def post_terminal_txns_datas(self,
                                 body,
                                 request_token=None):
        """Does a POST request to /terminalTxnDatas.
