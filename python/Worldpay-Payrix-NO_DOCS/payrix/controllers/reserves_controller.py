...
from payrix.models.reserves_response_result import (
...
class ReservesController(BaseController):
    ...
    def __init__(self, config):
        """Initialize ReservesController object."""
        super(ReservesController, self).__init__(config)

    def get_reserves_id(self,
                        id,
                        request_token=None):
        """Perform a GET request to /reserves/{id}.

        Query a Reserve resource that represents a way to reserve funds from
        an Entity or Org automatically and to release them automatically
        according to a pre-determined schedule.

        Args:
            id (str): The ID of this reserve.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                a Reserve Response for query on reserves resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(ReservesResponseResult.from_dictionary)
    ...
    def put_reserves_id(self,
                        ...
                        body,
                        request_token=None):
        """Perform a PUT request to /reserves/{id}.

        Update a Reserves or Reserve resource, which represents a way to
        reserve funds from an Entity or Org automatically and to release them
        automatically according to a pre-determined schedule.

        Args:
            id (str): The ID of this reserve.
            body (ReservesPutRequest): Update a Reserve Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for update on reserves resource Update a Reserve Response
    ...
    def delete_reserves_id(self,
                           id,
                           request_token=None):
        """Perform a DELETE request to /reserves/{id}.

        Delete a Reserves or Reserve resource that represents a way to reserve
        funds from an Entity or Org automatically and to release them
        automatically according to a pre-determined schedule.
    ...
    def get_reserves(self,
                     ...
                     page_number=None,
                     page_limit=None):
        """Perform a GET request to /reserves.

        Query a Reserves resource.
        A Reserves resource represents a way to reserve funds from an Entity
        or Org automatically and to release them automatically according to a
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on reserves resource
    ...
    def post_reserves(self,
                      body,
                      request_token=None):
        """Perform a POST request to /reserves.
        ...
        Args:
            body (ReservesPostRequest): Create Reserve Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on reserves resource
