...
from payrix.models.secrets_response_result import (
...
class SecretsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize SecretsController object."""
        super(SecretsController, self).__init__(config)

    def get_secrets_id(self,
                       id,
                       request_token=None):
        """Perform a GET request to /secrets/{id}.

        Query a Secret, A Secret represents either a key used to decrypt data
        or an indicator of which key to be used to decrypt data.

        Args:
            id (str): The ID of this secret resource.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                the Response for query on secrets resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(SecretsResponseResult.from_dictionary)
    ...
    def put_secrets_id(self,
                       ...
                       body,
                       request_token=None):
        """Perform a PUT request to /secrets/{id}.

        Update a Secret, A Secret represents either a key used to decrypt data
        or an indicator of which key to be used to decrypt data.

        Args:
            id (str): The ID of this secret resource.
            body (SecretsPutRequest): Update Secret Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for update on secrets resource Update Secret Response
    ...
    def delete_secrets_id(self,
                          id,
                          request_token=None):
        """Perform a DELETE request to /secrets/{id}.

        Delete a Secret. A Secret represents either a key used to decrypt data
        or an indicator of which key to be used to decrypt data.
...
Details:
    ...
    def get_secrets(self,
                    ...
                    page_number=None,
                    page_limit=None):
        """Perform a GET request to /secrets.

        Query a Secret.
        A Secret represents either a key used to decrypt data or an indicator
        of which key to be used to decrypt data.
    ...
    def post_secrets(self,
                     body,
                     request_token=None):
        """Perform a POST request to /secrets.
        ...
        Args:
            body (SecretsPostRequest): Create Secret Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on secrets resource
