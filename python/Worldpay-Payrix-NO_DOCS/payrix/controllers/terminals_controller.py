...
from payrix.models.terminals_response_result import (
...
class TerminalsController(BaseController):
    ...
    def get_terminals_id(self,
                         id,
                         request_token=None):
        """Perform a GET request to /terminals/{id}.

        Query a Terminal resource.

        Args:
            id (str): The ID of this resource and The Terminal ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                terminal response for query on terminals resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(TerminalsResponseResult.from_dictionary)
    ...
    def put_terminals_id(self,
                         ...
                         body,
                         request_token=None):
        """Perform a PUT request to /terminals/{id}.

        Update a Terminal resource.

        Args:
            id (str): The ID of this resource and The Terminal ID.
            body (TerminalsPutRequest): Update Terminal Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for update on terminals resource Update Terminal Response
    ...
    def delete_terminals_id(self,
                            id,
                            request_token=None):
        """Perform a DELETE request to /terminals/{id}.

        Delete a terminal resource that represents a device/software that will
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                terminal response for terminals resource.
    ...
    def get_terminals(self,
        ...
        Query a terminal resource.
        A terminal resource represents a device/software that will be used to
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on terminals resource
    ...
    def post_terminals(self,
                       body,
                       request_token=None):
        """Perform a POST request to /terminals.
        ...
        Args:
            body (TerminalsPostRequest): Create Terminal Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on terminals resource
