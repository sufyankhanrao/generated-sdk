...
from payrix.models.orgs_vas_omni_tokens_response_result import (
    OrgsVASOmniTokensResponseResult,
)


class OrgsVASOmniTokensController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize OrgsVASOmniTokensController object."""
        super(OrgsVASOmniTokensController, self).__init__(config)

    def get_orgs_vas_omni_tokens_id(self,
                                    id):
        """Perform a GET request to /orgsVASSOmniTokens/{id}.

        Query Orgs VAS OmniTokens.

        Args:
            id (str): The ID of this resource, or the (unknown) ID associated
                with the Orgs VAS OmniTokens.

        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for retrieve Orgs VAS OmniTokens.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(OrgsVASOmniTokensResponseResult.from_dictionary)
    ...
    def put_orgs_vas_omni_tokens_id(self,
                                    id,
                                    body):
        """Perform a PUT request to /orgsVASSOmniTokens/{id}.

        Update Orgs VAS OmniTokens.

        Args:
            id (str): The ID of this Orgs VAS OmniToken.
            body (OrgsVASOmniTokensPutRequest): Update Orgs VAS OmniToken

        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. The
                response for update Orgs VAS OmniToken.
    ...
    def delete_orgs_vas_omni_tokens_id(self,
                                       id):
        """Perform a DELETE request to /orgsVASSOmniTokens/{id}.
    ...
    def get_orgs_vas_omni_tokens(self,
                                 ...
                                 page_number=None,
                                 page_limit=None):
        """Perform a GET request to /orgsVASSOmniTokens.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on Orgs VAS OmniTokens
    ...
    def post_orgs_vas_omni_tokens(self,
                                  body,
                                  request_token=None):
        """Perform a POST request to /orgsVASSOmniTokens.

        Create a Orgs VAS OmniTokens.

        Args:
            body (OrgsVASOmniTokensPostRequest): The request body parameter.
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create Orgs VAS OmniTokens
