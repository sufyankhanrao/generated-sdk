...
from payrix.models.invoices_response_result import (
...
class InvoicesController(BaseController):
    ...
    def get_invoices_id(self,
                        id,
                        request_token=None):
        """Perform a GET request to /invoices/{id}.

        Query an Invoice or use it for invoicing customers, email the invoice
        to them, allow them to pay the invoice and track payments with
        invoices.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(InvoicesResponseResult.from_dictionary)
    ...
    def put_invoices_id(self,
                        ...
                        body,
                        request_token=None):
        """Perform a PUT request to /invoices/{id}.

        Update an Invoice. An Invoice resource is used for invoicing
        customers, email the invoice to them, allow them to pay the invoice
        and track payments with invoices.

        Args:
            id (str): The ID of this invoice.
            body (InvoicesPutRequest): Update Invoice Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for update on invoices resource Update Invoice Response
    ...
    def delete_invoices_id(self,
                           id,
                           request_token=None):
        """Perform a DELETE request to /invoices/{id}.

        Delete an Invoice or use it for invoicing customers, email the invoice
        to them, allow them to pay the invoice and track payments with
        invoices.
    ...
    def get_invoices(self,
                     ...
                     page_number=None,
                     page_limit=None):
        """Perform a GET request to /invoices.

        Query an Invoice or query an Invoice. An Invoice resource is used for
        invoicing customers, email the invoice to them, allow them to pay the
        invoice and track payments with invoices.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Invoices Response for query on invoices resource.
    ...
    def post_invoices(self,
                      body,
                      request_token=None):
        """Perform a POST request to /invoices.

        Create an Invoice, which is used for invoicing customers, emailing the
        invoice to them, allowing them to pay the invoice and tracking
        payments with invoices.

        Args:
            body (InvoicesPostRequest): Create Invoice Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
