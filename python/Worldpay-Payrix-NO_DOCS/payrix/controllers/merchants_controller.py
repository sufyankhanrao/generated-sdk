...
from payrix.models.merchants_response_result import (
...
class MerchantsController(BaseController):
    ...
    def get_merchants(self,
        ...
        Query a Merchant, an organization that processes credit card payments,
        each associated with an Entity.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on merchants resource
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(MerchantsResponseResult.from_dictionary)
    ...
    def post_merchants(self,
        ...
        Args:
            body (MerchantsPostRequest): The request body parameter.
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for update on merchant's response.
    ...
    def get_merchants_id(self,
                         id,
                         request_token=None):
        """Perform a GET request to /merchants/{id}.

        Query a Merchant, which is an organization that processes credit card
        payments and each is associated with an Entity.

        Args:
            id (str): The ID of this resource, also known as the Merchant ID
                (MID).
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for retrieving merchant response.
    ...
    def put_merchants_id(self,
                         ...
                         body,
                         request_token=None):
        """Perform a PUT request to /merchants/{id}.

        Update a Merchant, A Merchant is an organization that processes credit
        card payments. Each Merchant is associated with an Entity.

        Args:
            id (str): The ID of this resource, also known as the Merchant ID
                (MID).
            body (MerchantsPutRequest): Update Merchant Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
    ...
    def delete_merchants_id(self,
                            id,
                            request_token=None):
        """Perform a DELETE request to /merchants/{id}.

        Delete a Merchant. A Merchant is an organization that processes credit
        card payments. Each Merchant is associated with an Entity.
