...
from payrix.models.disbursement_entries_response_result import (
...
class DisbursementEntriesController(BaseController):
    ...
    def __init__(self, config):
        """Initialize DisbursementEntriesController object."""
        super(DisbursementEntriesController, self).__init__(config)

    def get_disbursement_entries_id(self,
                                    id,
                                    request_token=None):
        """Perform a GET request to /disbursementEntries/{id}.
    ...
    def get_disbursement_entries(self,
                                 ...
                                 page_number=None,
                                 page_limit=None):
        """Perform a GET request to /disbursementEntries.
