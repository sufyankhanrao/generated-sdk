...
from payrix.models.txns_post_response_result import (
    TxnsPostResponseResult,
)
from payrix.models.txns_response_result import (
    TxnsResponseResult,
)


class TransactionsTxnsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize TransactionsTxnsController object."""
        super(TransactionsTxnsController, self).__init__(config)

    def get_txns_id(self,
                    id,
                    request_token=None):
        """Perform a GET request to /txns/{id}.

        Query a Transaction.
        Transactions hold all of the information relating to a particular
        credit card transaction, including the merchant, token, subscription,
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(TxnsResponseResult.from_dictionary)
    ...
    def put_txns_id(self,
                    ...
                    body,
                    request_token=None):
        """Perform a PUT request to /txns/{id}.
        ...
        Args:
            id (str): The ID of this transaction.
            body (TxnsPutRequest): Update txns Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
    ...
    def get_txns(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                transactions resource returns multiple transaction (txns)
                objects in response to a query.
    ...
    def post_txns(self,
                  body,
                  request_token=None):
        """Perform a POST request to /txns.
        ...
        Args:
            body (TxnsPostRequest): Create a new transaction.
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        return super().new_api_call_builder.request(
            ...
            ResponseHandler()
            .deserializer(APIHelper.json_deserialize)
            .deserialize_into(TxnsPostResponseResult.from_dictionary)
            .is_api_response(True)
            .local_error("400", "Error", ErrorFourHundredException),
        ).execute()
