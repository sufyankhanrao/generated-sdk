...
from payrix.models.orgs_vas_revenue_boosts_response_result import (
    OrgsVASRevenueBoostsResponseResult,
)


class OrgsVASRevenueBoostsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize OrgsVASRevenueBoostsController object."""
        super(OrgsVASRevenueBoostsController, self).__init__(config)

    def get_orgs_vas_revenue_boosts_id(self,
                                       id,
                                       request_token=None):
        """Perform a GET request to /orgsVASRevenueBoosts/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on orgsVASRevenueBoosts resource
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(OrgsVASRevenueBoostsResponseResult.from_dictionary)
    ...
    def get_orgs_vas_revenue_boosts(self,
                                    ...
                                    page_number=None,
                                    page_limit=None):
        """Perform a GET request to /orgsVASRevenueBoosts.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for querying and retrieving all bank orgsVASRevenueBoosts.
    ...
    def post_orgs_vas_revenue_boosts(self,
                                     body,
                                     request_token=None):
        """Perform a POST request to /orgsVASRevenueBoosts.

        Create a OrgsVasNetworkPaymentManager.

        Args:
            body (OrgsVASRevenueBoostsPostRequest): Add
                OrgsVasNetworkPaymentManager Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                response for creating an OrgsVasNetworkPaymentManagers
                resource.
