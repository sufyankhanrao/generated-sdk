...
from payrix.models.holds_response_result import HoldsResponseResult
...
class TransactionHoldsController(BaseController):
    ...
    def get_holds_id(self,
                     id,
                     request_token=None):
        """Does a GET request to /holds/{id}.
    ...
    def put_holds_id(self,
                     ...
                     body,
                     request_token=None):
        """Does a PUT request to /holds/{id}.
