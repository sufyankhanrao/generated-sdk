...
from payrix.models.holds_response_result import (
    HoldsResponseResult,
)


class TransactionHoldsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize TransactionHoldsController object."""
        super(TransactionHoldsController, self).__init__(config)

    def get_holds_id(self,
                     id,
                     request_token=None):
        """Perform a GET request to /holds/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                a Transaction Hold Response for query on holds resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(HoldsResponseResult.from_dictionary)
    ...
    def put_holds_id(self,
                     ...
                     body,
                     request_token=None):
        """Perform a PUT request to /holds/{id}.

        Details for update on holds

        Args:
            id (str): The ID of this resource.
            body (HoldsPutRequest): Update Transaction Hold Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for update on holds transaction response.
    ...
    def get_holds(self,
                  ...
                  page_number=None,
                  page_limit=None):
        """Perform a GET request to /holds.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Retrieve
                all Transaction Holds and response for query on holds resource.
    ...
    def post_holds(self,
                   body,
                   request_token=None):
        """Perform a POST request to /holds.

        Create a holds resource.
        A holds resource represents a reviewable action taken on a Transaction.

        Args:
            body (HoldsPostRequest): Create a Transaction Hold Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Transaction Hold Response for the holds resource.
