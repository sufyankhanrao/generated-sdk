...
from payrix.models.txn_sessions_response_result import (
    TxnSessionsResponseResult,
)


class TxnSessionsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize TxnSessionsController object."""
        super(TxnSessionsController, self).__init__(config)

    def get_txn_sessions_id(self,
                            id,
                            request_token=None):
        """Perform a GET request to /txnSessions/{id}.

        Query a TxnSession.
        A TxnSession represents a temporary method of authentication to the
        API. Each TxnSession expires automatically after 10 minutes of
        inactivity or by the customizable configurations field.
        They are similar to API Keys (/apikeys) in their capabilities and
        field structure - but unlike API Keys, TxnSessions are not permanent.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on txnSessions resource
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(TxnSessionsResponseResult.from_dictionary)
    ...
    def delete_txn_sessions_id(self,
                               id,
                               request_token=None):
        """Perform a DELETE request to /txnSessions/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for delete on txnSessions resource
    ...
    def get_txn_sessions(self,
                         ...
                         page_number=None,
                         page_limit=None):
        """Perform a GET request to /txnSessions.
    ...
    def post_txn_sessions(self,
                          body,
                          request_token=None):
        """Perform a POST request to /txnSessions.

        Create a TxnSession.
        A TxnSessions represents a temporary method of authentication to the
        API. Each TxnSession expires automatically after 10 minutes of
        inactivity or by the customizable configurations field.
        They are similar to API Keys (/apikeys) in their capabilities and
        field structure - but unlike API Keys, TxnSessions are not permanent.
        ...
        Args:
            body (TxnSessionsPostRequest): The request body parameter.
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on txnSessions resource
