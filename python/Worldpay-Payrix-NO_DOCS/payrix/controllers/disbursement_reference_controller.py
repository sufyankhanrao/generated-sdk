...
from payrix.models.disbursement_refs_response_result import DisbursementRefsResponseResult
...
class DisbursementReferenceController(BaseController):
    ...
    def get_disbursement_refs_id(self,
                                 id,
                                 request_token=None):
        """Does a GET request to /disbursementRefs/{id}.
    ...
    def get_disbursement_refs(self,
                              ...
                              page_number=None,
                              page_limit=None):
        """Does a GET request to /disbursementRefs.
