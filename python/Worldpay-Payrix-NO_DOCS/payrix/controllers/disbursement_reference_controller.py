...
from payrix.models.disbursement_refs_response_result import (
    DisbursementRefsResponseResult,
)


class DisbursementReferenceController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize DisbursementReferenceController object."""
        super(DisbursementReferenceController, self).__init__(config)

    def get_disbursement_refs_id(self,
                                 id,
                                 request_token=None):
        """Perform a GET request to /disbursementRefs/{id}.

        Query a Disbursement Reference that represents a reference code issued
        by the Payout facilitator when a Disbursement is paid.

        Args:
            id (str): The ID of this resource, also known as The Disbursement
                Reference ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                the Response for query on Disbursement References resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(DisbursementRefsResponseResult.from_dictionary)
    ...
    def get_disbursement_refs(self,
                              ...
                              page_number=None,
                              page_limit=None):
        """Perform a GET request to /disbursementRefs.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on disbursementRefs resource.
