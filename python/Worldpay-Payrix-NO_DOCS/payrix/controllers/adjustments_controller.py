...
from payrix.models.adjustments_response_result import (
...
class AdjustmentsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize AdjustmentsController object."""
        super(AdjustmentsController, self).__init__(config)

    def get_adjustments_id(self,
                           id,
                           request_token=None):
        """Perform a GET request to /adjustments/{id}.

        Query an Adjustment, which is a way to make monetary adjustments to an
        entity's funds.

        Args:
            id (str): The ID of this resource and The Adjustment ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                the adjustment response for query on adjustments resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(AdjustmentsResponseResult.from_dictionary)
    ...
    def get_adjustments(self,
                        ...
                        page_number=None,
                        page_limit=None):
        """Perform a GET request to /adjustments.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Retrieve
                the Response for query on adjustments resource.
