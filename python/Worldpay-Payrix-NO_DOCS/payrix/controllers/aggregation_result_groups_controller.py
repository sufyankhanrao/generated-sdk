...
from payrix.models.aggregation_results_groups_response_result import (
    AggregationResultsGroupsResponseResult,
)


class AggregationResultGroupsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize AggregationResultGroupsController object."""
        super(AggregationResultGroupsController, self).__init__(config)

    def get_aggregation_result_groups_id(self,
                                         id,
                                         request_token=None):
        """Perform a GET request to /aggregationResultGroups/{id}.

        Query an AggregationResultGroup resource, which holds data regarding a
        processed aggregation.

        Args:
            id (str): The ID of this resource or The Aggregation Result Group
                ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                the response for the query on the Aggregation Result Groups
                resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .path("/aggregationResultGroups/{id}")
            ...
            .deserialize_into(AggregationResultsGroupsResponseResult.from_dictionary)
    ...
    def delete_aggregation_result_groups_id(self,
                                            ...
                                            request_token=None,
                                            search_filter=None):
        """Perform a DELETE request to /aggregationResultGroups/{id}.

        Delete an Aggregation Result Group, which holds data regarding a
        processed aggregation.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Aggregation Result Group Response for the
                aggregationResultGroups resource.
    ...
    def get_aggregation_result_groups(self,
                                      ...
                                      page_number=None,
                                      page_limit=None):
        """Perform a GET request to /aggregationResultGroups.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Retrieve
                Aggregation Result Groups Response for querying the
                aggregationResultGroups resource.
