...
from payrix.models.profit_share_results_response_result import ProfitShareResultsResponseResult
...
class ProfitShareResultsController(BaseController):
    ...
    def get_profit_share_results_id(self,
                                    id,
                                    request_token=None):
        """Does a GET request to /profitShareResults/{id}.
    ...
    def get_profit_share_results(self,
                                 ...
                                 page_number=None,
                                 page_limit=None):
        """Does a GET request to /profitShareResults.
