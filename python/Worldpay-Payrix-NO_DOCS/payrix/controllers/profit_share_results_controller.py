...
from payrix.models.profit_share_results_response_result import (
    ProfitShareResultsResponseResult,
)


class ProfitShareResultsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize ProfitShareResultsController object."""
        super(ProfitShareResultsController, self).__init__(config)

    def get_profit_share_results_id(self,
                                    id,
                                    request_token=None):
        """Perform a GET request to /profitShareResults/{id}.

        Query a ProfitShareResult or Profit Share Result.

        Args:
            id (str): The ID of this resource, The Profit Share Result ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                the Response for query on Profit Share Results resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(ProfitShareResultsResponseResult.from_dictionary)
    ...
    def get_profit_share_results(self,
                                 ...
                                 page_number=None,
                                 page_limit=None):
        """Perform a GET request to /profitShareResults.

        Query a ProfitShareResult or Profit Share Result resource, which holds
        a message regarding a failed ProfitShare process.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on profitShareResults resource
