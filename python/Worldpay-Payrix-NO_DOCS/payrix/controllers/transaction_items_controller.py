...
from payrix.models.items_response_result import (
    ItemsResponseResult,
)


class TransactionItemsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize TransactionItemsController object."""
        super(TransactionItemsController, self).__init__(config)
    ...
    def get_items_id(self,
        ...
        Query an Item.
        An Item is a line item that is associated with a particular
        Transaction. It allows you to describe the cost, quantity and other
        details of each line in the Transaction.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for retrieving an item response.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(ItemsResponseResult.from_dictionary)
    ...
    def put_items_id(self,
                     ...
                     body,
                     request_token=None):
        """Perform a PUT request to /items/{id}.
        ...
        Args:
            id (str): The ID of this resource.
            body (ItemsPutRequest): Update Item Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Successful update of the items
    ...
    def delete_items_id(self,
                        id,
                        request_token=None):
        """Perform a DELETE request to /items/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                response for deleting an item from the items resource.
    ...
    def post_items(self,
                   body,
                   request_token=None):
        """Perform a POST request to /items.
        ...
        Args:
            body (ItemsPostRequest): Create an Item Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
