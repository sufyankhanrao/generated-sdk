...
from payrix.models.txn_results_response_result import (
    TxnResultsResponseResult,
)


class TransactionsResultsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize TransactionsResultsController object."""
        super(TransactionsResultsController, self).__init__(config)

    def get_txn_results_id(self,
                           id,
                           request_token=None):
        """Perform a GET request to /txnResults/{id}.

        Query a txnResults resource.
        A txnResults resource represents the result of a Transaction from a
        processor.
        For example, the Transaction may be approved, declined, or raise an
        error.

        Args:
            id (str): The ID of this resource and The TXN result ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on txnResults resource
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(TxnResultsResponseResult.from_dictionary)
    ...
    def get_txn_results(self,
                        ...
                        page_number=None,
                        page_limit=None):
        """Perform a GET request to /txnResults.
