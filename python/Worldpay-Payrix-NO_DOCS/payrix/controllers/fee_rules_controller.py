...
from payrix.models.fee_rules_response_result import (
...
class FeeRulesController(BaseController):
    ...
    def __init__(self, config):
        """Initialize FeeRulesController object."""
        super(FeeRulesController, self).__init__(config)

    def get_fee_rules_id(self,
                         id,
                         request_token=None):
        """Perform a GET request to /feeRules/{id}.

        Query a Fee Rule that makes a Fee apply only in certain circumstances,
        such as applying an administration charge if a payment is under $50.

        Args:
            id (str): The ID of this fee rule.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Fee Rule Response for query on feeRules resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(FeeRulesResponseResult.from_dictionary)
    ...
    def put_fee_rules_id(self,
                         ...
                         body,
                         request_token=None):
        """Perform a PUT request to /feeRules/{id}.

        Update a Fee Rule that makes a Fee apply only in certain
        circumstances, for example, applying an administration charge if a
        payment is under $50.

        Args:
            id (str): The ID of this fee rule.
            body (FeeRulesPutRequest): Update Fee Rule Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for update on feeRules resource: Update a Fee Rule Response
    ...
    def delete_fee_rules_id(self,
                            id,
                            request_token=None):
        """Perform a DELETE request to /feeRules/{id}.

        Delete a Fee Rule that makes a Fee apply only in certain
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Fee Rule Response for the feeRules resource.
    ...
    def get_fee_rules(self,
                      ...
                      page_number=None,
                      page_limit=None):
        """Perform a GET request to /feeRules.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on feeRules resource
    ...
    def post_fee_rules(self,
                       body,
                       request_token=None):
        """Perform a POST request to /feeRules.

        Create a conditional Fee Rule that makes fees apply only in certain
        circumstances, such as applying an administration charge if a payment
        is under $50.

        Args:
            body (FeeRulesPostRequest): Create Fee Rule Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on feeRules resource
