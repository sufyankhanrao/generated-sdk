...
from payrix.models.entry_origins_response_result import (
    EntryOriginsResponseResult,
)


class EntryOriginController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize EntryOriginController object."""
        super(EntryOriginController, self).__init__(config)

    def get_entry_origins_id(self,
                             id,
                             request_token=None):
        """Perform a GET request to /entryOrigins/{id}.

        Query an Entry Origin.

        Args:
            id (str): The Entry Origin ID of this resource.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Entry Origin Response for query on entryOrigins resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(EntryOriginsResponseResult.from_dictionary)
    ...
    def get_entry_origins(self,
                          ...
                          page_number=None,
                          page_limit=None):
        """Perform a GET request to /entryOrigins.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on entryOrigins resource
