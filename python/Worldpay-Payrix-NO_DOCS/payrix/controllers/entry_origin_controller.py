...
from payrix.models.entry_origins_response_result import EntryOriginsResponseResult
...
class EntryOriginController(BaseController):
    ...
    def get_entry_origins_id(self,
                             id,
                             request_token=None):
        """Does a GET request to /entryOrigins/{id}.
    ...
    def get_entry_origins(self,
                          ...
                          page_number=None,
                          page_limit=None):
        """Does a GET request to /entryOrigins.
