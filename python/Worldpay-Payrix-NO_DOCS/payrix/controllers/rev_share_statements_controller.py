...
from payrix.models.rev_share_statements_response_result import (
    RevShareStatementsResponseResult,
)


class RevShareStatementsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize RevShareStatementsController object."""
        super(RevShareStatementsController, self).__init__(config)

    def get_rev_share_statements_id(self,
                                    id,
                                    request_token=None):
        """Perform a GET request to /revShareStatements/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on revShareStatements resource
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(RevShareStatementsResponseResult.from_dictionary)
    ...
    def get_rev_share_statements(self,
                                 ...
                                 page_number=None,
                                 page_limit=None):
        """Perform a GET request to /revShareStatements.
