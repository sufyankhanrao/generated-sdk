...
from payrix.models.rev_share_statements_response_result import RevShareStatementsResponseResult
...
class RevShareStatementsController(BaseController):
    ...
    def get_rev_share_statements_id(self,
                                    id,
                                    request_token=None):
        """Does a GET request to /revShareStatements/{id}.
    ...
    def get_rev_share_statements(self,
                                 ...
                                 page_number=None,
                                 page_limit=None):
        """Does a GET request to /revShareStatements.
