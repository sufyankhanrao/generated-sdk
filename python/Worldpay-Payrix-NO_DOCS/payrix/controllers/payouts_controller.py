...
from payrix.models.payouts_response_result import (
...
class PayoutsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize PayoutsController object."""
        super(PayoutsController, self).__init__(config)

    def get_payouts_id(self,
                       id,
                       request_token=None):
        """Perform a GET request to /payouts/{id}.

        Query a Payout. A Payout is a resource that represents all the details
        that allow a Disbursement to be paid or debited; these details include
        the schedule or trigger, the beneficiary account and the amount.

        Args:
            id (str): The ID of this payout.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for retrieving payout response.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(PayoutsResponseResult.from_dictionary)
    ...
    def put_payouts_id(self,
                       ...
                       body,
                       request_token=None):
        """Perform a PUT request to /payouts/{id}.

        Update a Payout. A Payout is a resource that represents all the
        details that allow a Disbursement to be paid or debited. These details
        include the schedule or trigger, the beneficiary account and the
        amount.

        Args:
            id (str): The ID of this payout.
            body (PayoutPutRequest): Update Payout Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Payout Response for payouts resource.
    ...
    def delete_payouts_id(self,
                          id,
                          request_token=None):
        """Perform a DELETE request to /payouts/{id}.

        Delete a Payout. A Payout is a resource that represents all the
        details that allow a Disbursement to be paid or debited. These details
        include the schedule or trigger, the beneficiary account and the
        amount.
    ...
    def post_payouts(self,
                     body,
                     request_token=None):
        """Perform a POST request to /payouts.

        Create a Payout. A Payout is a resource that represents all the
        details that allow a Disbursement to be paid or debited; these details
        include the schedule or trigger, the beneficiary account and the
        amount.

        Args:
            body (PayoutPostRequest): Create Payout Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on payouts resource.
