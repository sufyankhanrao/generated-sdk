...
from payrix.models.chargeback_message_results_response_result import ChargebackMessageResultsResponseResult
...
class ChargebackMessageResultsController(BaseController):
    ...
    def get_chargeback_message_results_id(self,
                                          id,
                                          request_token=None):
        """Does a GET request to /chargebackMessageResults/{id}.
    ...
    def get_chargeback_message_results(self,
                                       ...
                                       page_number=None,
                                       page_limit=None):
        """Does a GET request to /chargebackMessageResults.
