...
from payrix.models.chargeback_message_results_response_result import (
    ChargebackMessageResultsResponseResult,
)


class ChargebackMessageResultsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize ChargebackMessageResultsController object."""
        super(ChargebackMessageResultsController, self).__init__(config)

    def get_chargeback_message_results_id(self,
                                          id,
                                          request_token=None):
        """Perform a GET request to /chargebackMessageResults/{id}.

        Query a chargebackMessageResults resource, which represents a message
        that is received from the processor in relation to a Chargeback
        message.

        Args:
            id (str): The Chargeback Message Result ID of this resource.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                response for query on chargebackMessageResults resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .path("/chargebackMessageResults/{id}")
            ...
            .deserialize_into(ChargebackMessageResultsResponseResult.from_dictionary)
    ...
    def get_chargeback_message_results(self,
                                       ...
                                       page_number=None,
                                       page_limit=None):
        """Perform a GET request to /chargebackMessageResults.
