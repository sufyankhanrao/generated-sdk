...
from payrix.models.auth_tokens_response_result import (
    AuthTokensResponseResult,
)


class AuthenticationTokensController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize AuthenticationTokensController object."""
        super(AuthenticationTokensController, self).__init__(config)

    def get_auth_tokens_id(self,
                           id,
                           request_token=None):
        """Perform a GET request to /authTokens/{id}.

        Query an AuthToken, an AuthToken resource is an additional layer of
        authentication security and tracking for Apikeys and Sessions.

        Args:
            id (str): The ID of this resource and The Authentication Token ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                response for retrieve authentication token response.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(AuthTokensResponseResult.from_dictionary)
    ...
    def put_auth_tokens_id(self,
                           ...
                           body,
                           request_token=None):
        """Perform a PUT request to /authTokens/{id}.

        Update an AuthToken to add an additional layer of authentication
        security and tracking for Apikeys and Sessions.

        Args:
            id (str): The ID of this resource and The Authentication Token ID.
            body (AuthTokensPutRequest): Update Authentication Token Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for update on authTokens resource Update Authentication Token
                Response
    ...
    def delete_auth_tokens_id(self,
                              id,
                              request_token=None):
        """Perform a DELETE request to /authTokens/{id}.

        Delete an AuthToken, which is an additional layer of authentication
        security and tracking for Apikeys and Sessions.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for deleting an Authentication Token.
    ...
    def get_auth_tokens(self,
                        ...
                        page_number=None,
                        page_limit=None):
        """Perform a GET request to /authTokens.

        Query an AuthToken, which is an additional layer of authentication
        security and tracking for Apikeys and Sessions.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. The
                response for retrieving authentication tokens.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(AuthTokensResponseResult.from_dictionary)
            .is_api_response(True)
            .local_error("400", "ErrorError", ErrorFourHundredException),
        ).execute()

    def post_auth_tokens(self,
                         body,
                         request_token=None):
        """Perform a POST request to /authTokens.

        Create an AuthToken to add an additional layer of authentication,
        security, and tracking for Apikeys and Sessions.

        Args:
            body (AuthTokensPostRequest): Create Authentication Token Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. The
                Response for creating an authentication token on the
                authTokens resource is a Create Authentication Token Response.
