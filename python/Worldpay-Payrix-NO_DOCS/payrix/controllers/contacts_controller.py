...
from payrix.models.contacts_response_result import (
...
class ContactsController(BaseController):
    ...
    def get_contacts_id(self,
                        id,
                        request_token=None):
        """Perform a GET request to /contacts/{id}.

        Query a Contact, which represents an individual who is associated with
        an Entity.

        Args:
            id (str): The ID of this contact.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(ContactsResponseResult.from_dictionary)
    ...
    def put_contacts_id(self,
                        ...
                        body,
                        request_token=None):
        """Perform a PUT request to /contacts/{id}.

        Update a Contact, A Contact resource represents an individual who is
        associated with an Entity.

        Args:
            id (str): The ID of this contact.
            body (ContactsPutRequest): Update Contact Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for update on contacts resource Update Contact Response
    ...
    def delete_contacts_id(self,
                           id,
                           request_token=None):
        """Perform a DELETE request to /contacts/{id}.

        Delete a Contact. A Contact resource represents an individual who is
        associated with an Entity.
    ...
    def get_contacts(self,
                     ...
                     page_number=None,
                     page_limit=None):
        """Perform a GET request to /contacts.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Response for query to retrieve from contacts resources.
    ...
    def post_contacts(self,
                      body,
                      request_token=None):
        """Perform a POST request to /contacts.

        Create a Contact.
        A Contact resource represents an individual who is associated with an
        Entity.

        Args:
            body (ContactsPostRequest): Create Contact Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on Contacts resource: Create Contact Response
