...
from payrix.models.org_entities_response_result import (
    OrgEntitiesResponseResult,
)


class OrgEntitiesController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize OrgEntitiesController object."""
        super(OrgEntitiesController, self).__init__(config)

    def get_org_entities_id(self,
                            id,
                            request_token=None):
        """Perform a GET request to /orgEntities/{id}.

        Query an orgEntity.

        Args:
            id (str): The ID of this resource and the Org Entity ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                an Org Entity Response for query on orgEntities resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(OrgEntitiesResponseResult.from_dictionary)
    ...
    def put_org_entities_id(self,
                            ...
                            body,
                            request_token=None):
        """Perform a PUT request to /orgEntities/{id}.

        Update an orgEntity.

        Args:
            id (str): The ID of this resource and The Org Entity ID.
            body (OrgEntitiesPutRequest): Update an Org Entity Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for update on orgEntities resource: Update an Org Entity
                Response
    ...
    def delete_org_entities_id(self,
                               id,
                               request_token=None):
        """Perform a DELETE request to /orgEntities/{id}.

        Delete an Org Entity. An orgEntity is a record of an association
        between a particular Org and a particular Entity. One Org can contain
        and be associated with many Entities.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                response for deleting an OrgEntity.
    ...
    def get_org_entities(self,
                         ...
                         page_number=None,
                         page_limit=None):
        """Perform a GET request to /orgEntities.

        Query an orgEntity.
        An orgEntity is a record of an association between a particular Org
        and a particular Entity.
        You can associate Entities with an Org by creating orgEntity
        resources. One Org can contain and be associated with many Entities.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Retrieve
                an Org Entities Response for the query on orgEntities resource.
    ...
    def post_org_entities(self,
                          body,
                          request_token=None):
        """Perform a POST request to /orgEntities.
        ...
        Args:
            body (OrgEntitiesPostRequest): Create Org Entity Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on orgEntities resource
