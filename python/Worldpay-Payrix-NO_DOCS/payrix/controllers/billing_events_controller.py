...
from payrix.models.billing_events_response_result import (
...
class BillingEventsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize BillingEventsController object."""
        super(BillingEventsController, self).__init__(config)

    def get_billing_events_id(self,
                              id,
                              request_token=None):
        """Perform a GET request to /billingEvents/{id}.

        Query a Billing Event.

        Args:
            id (str): The ID of this billing event.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Response for query on billingEvents resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(BillingEventsResponseResult.from_dictionary)
    ...
    def put_billing_events_id(self,
                              ...
                              body,
                              request_token=None):
        """Perform a PUT request to /billingEvents/{id}.

        Update a Billing Event.

        Args:
            id (str): The ID of this billing event.
            body (BillingEventsPutRequest): Update Billing Event Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for update on billingEvents resource Update Billing Event
                Response
    ...
    def delete_billing_events_id(self,
                                 id,
                                 request_token=None):
        """Perform a DELETE request to /billingEvents/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for delete on Billing Events resource.
    ...
    def get_billing_events(self,
                           ...
                           page_number=None,
                           page_limit=None):
        """Perform a GET request to /billingEvents.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on billingEvents resource.
    ...
    def post_billing_events(self,
                            body,
                            request_token=None):
        """Perform a POST request to /billingEvents.

        Create a billingEvents.

        Args:
            body (BillingEventsPostRequest): Create Billing Event Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Create a
                Billing Event Response on the billingEvents resource.
