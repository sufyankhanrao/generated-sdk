...
from payrix.models.billings_response_result import (
...
class BillingController(BaseController):
    ...
    def get_billings_id(self,
                        id,
                        request_token=None):
        """Perform a GET request to /billings/{id}.

        Query a Billing that is a means to collect and invoice for any funds
        owed for a particular period of time, such as setting up a billing to
        collect fees and create a statement on a monthly basis.

        Args:
            id (str): The ID of this resource and The Billing ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                billing response for query on billings resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(BillingsResponseResult.from_dictionary)
    ...
    def put_billings_id(self,
                        ...
                        body,
                        request_token=None):
        """Perform a PUT request to /billings/{id}.

        Update a Billing, which is a means to collect and invoice for any
        funds owed for a particular period of time, such as setting up a
        billing to collect fees and create a statement on a monthly basis.

        Args:
            id (str): The ID of this resource and The Billing ID.
            body (BillingsPutRequest): Update Billing Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
    ...
    def delete_billings_id(self,
                           id,
                           request_token=None):
        """Perform a DELETE request to /billings/{id}.

        Delete a Billing that is a means to collect and invoice for any funds
        owed for a particular period of time, such as setting up a billing to
        collect fees and create a statement on a monthly basis.
    ...
    def get_billings(self,
                     ...
                     page_number=None,
                     page_limit=None):
        """Perform a GET request to /billings.

        Query a Billing is a means to collect and invoice for any funds owed
        for a particular period of time, such as setting up a billing to
        collect fees and create a statement on a monthly basis.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Retrieve
                Response for query on billings resource.
    ...
    def post_billings(self,
                      body,
                      request_token=None):
        """Perform a POST request to /billings.

        Create a Billing that is a means to collect and invoice for any funds
        owed for a particular period of time, such as statement of fees
        collected on a monthly basis.

        Args:
            body (BillingsPostRequest): Create Billing Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Billing Response for creating on billing resource.
