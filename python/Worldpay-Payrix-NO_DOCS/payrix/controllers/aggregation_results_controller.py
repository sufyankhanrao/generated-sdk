...
from payrix.models.aggregation_results_response_result import (
    AggregationResultsResponseResult,
)


class AggregationResultsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize AggregationResultsController object."""
        super(AggregationResultsController, self).__init__(config)

    def get_aggregation_results_id(self,
                                   id,
                                   request_token=None):
        """Perform a GET request to /aggregationResults/{id}.

        Query an AggregationResult.

        Args:
            id (str): The ID of this resource or The Aggregation Result ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                the Response for the query on the Aggregation Results resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(AggregationResultsResponseResult.from_dictionary)
    ...
    def delete_aggregation_results_id(self,
                                      id,
                                      request_token=None):
        """Perform a DELETE request to /aggregationResults/{id}.

        Delete an Aggregation Result that holds a field totals calculated when
        processing an aggregation.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for delete on Aggregation Results resource Delete Aggregation
                Result Response
    ...
    def get_aggregation_results(self,
                                ...
                                page_number=None,
                                page_limit=None):
        """Perform a GET request to /aggregationResults.

        Query an AggregationResult resource holding field totals calculated
        when processing an aggregation.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for querying the aggregationResults resource to retrieve
                aggregation results.
