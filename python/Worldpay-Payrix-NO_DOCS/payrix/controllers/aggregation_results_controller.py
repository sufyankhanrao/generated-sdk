...
from payrix.models.aggregation_results_response_result import AggregationResultsResponseResult
...
class AggregationResultsController(BaseController):
    ...
    def get_aggregation_results_id(self,
                                   id,
                                   request_token=None):
        """Does a GET request to /aggregationResults/{id}.
    ...
    def delete_aggregation_results_id(self,
                                      id,
                                      request_token=None):
        """Does a DELETE request to /aggregationResults/{id}.
    ...
    def get_aggregation_results(self,
                                ...
                                page_number=None,
                                page_limit=None):
        """Does a GET request to /aggregationResults.
