...
from payrix.models.entity_reserves_response_result import EntityReservesResponseResult
...
class EntityReservesController(BaseController):
    ...
    def get_entity_reserves_id(self,
                               id,
                               request_token=None):
        """Does a GET request to /entityReserves/{id}.
    ...
    def put_entity_reserves_id(self,
                               ...
                               body,
                               request_token=None):
        """Does a PUT request to /entityReserves/{id}.
    ...
    def get_entity_reserves(self,
                            ...
                            page_number=None,
                            page_limit=None):
        """Does a GET request to /entityReserves.
    ...
    def post_entity_reserves(self,
                             body,
                             request_token=None):
        """Does a POST request to /entityReserves.
