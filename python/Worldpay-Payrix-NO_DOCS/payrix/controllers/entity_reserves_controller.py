...
from payrix.models.entity_reserves_response_result import (
    EntityReservesResponseResult,
)


class EntityReservesController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize EntityReservesController object."""
        super(EntityReservesController, self).__init__(config)

    def get_entity_reserves_id(self,
                               id,
                               request_token=None):
        """Perform a GET request to /entityReserves/{id}.

        Query an EntityReserves resource that represents funds held by an
        Entity in reserve, separately from amounts in any entityFunds.

        Args:
            id (str): The ID of this entity reserve.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                an Entity Reserve Response for query on entityReserves
                resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(EntityReservesResponseResult.from_dictionary)
    ...
    def put_entity_reserves_id(self,
                               ...
                               body,
                               request_token=None):
        """Perform a PUT request to /entityReserves/{id}.

        Update an EntityReserves resource, which represents funds held by an
        Entity in reserve, separately from amounts in any entityFunds.

        Args:
            id (str): The ID of this entity reserve.
            body (EntityReservesPutRequest): Update an Entity Reserve Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for updating an Entity Reserve.
    ...
    def get_entity_reserves(self,
                            ...
                            page_number=None,
                            page_limit=None):
        """Perform a GET request to /entityReserves.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Retrieve
                an Entity Reserves Response for the query on entityReserves
                resource.
    ...
    def post_entity_reserves(self,
                             body,
                             request_token=None):
        """Perform a POST request to /entityReserves.

        Create an EntityReserves resource that represents funds held by an
        Entity in reserve, separately from amounts in any entityFunds.

        Args:
            body (EntityReservesPostRequest): Create Entity Reserve Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on entityReserves resource
