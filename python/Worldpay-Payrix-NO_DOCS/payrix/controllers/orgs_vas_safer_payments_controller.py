...
from payrix.models.orgs_vas_safer_payments_response_result import (
    OrgsVASSaferPaymentsResponseResult,
)


class OrgsVASSaferPaymentsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize OrgsVASSaferPaymentsController object."""
        super(OrgsVASSaferPaymentsController, self).__init__(config)

    def get_orgs_vas_safer_payments_id(self,
                                       id):
        """Perform a GET request to /orgsVASSaferPayments/{id}.

        Query Orgs VAS Safer Payments.

        Args:
            id (str): The ID of this resource, or the (unknown) ID associated
                with the Orgs VAS Safer Payments.

        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for retrieve Orgs VAS Safer Payments.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(OrgsVASSaferPaymentsResponseResult.from_dictionary)
    ...
    def put_orgs_vas_safer_payments_id(self,
                                       id,
                                       body):
        """Perform a PUT request to /orgsVASSaferPayments/{id}.

        Update Orgs VAS Safer Payments.

        Args:
            id (str): The ID of this Orgs VAS Safer Payments.
            body (OrgsVASSaferPaymentsPutRequest): Update Orgs VAS Safer
                Payments

        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. The
                response for update Orgs VAS Safer Payments.
    ...
    def delete_orgs_vas_safer_payments_id(self,
                                          id):
        """Perform a DELETE request to /orgsVASSaferPayments/{id}.
    ...
    def get_orgs_vas_safer_payments(self,
                                    ...
                                    page_number=None,
                                    page_limit=None):
        """Perform a GET request to /orgsVASSaferPayments.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on Orgs VAS Safer Payments
    ...
    def post_orgs_vas_safer_payments(self,
                                     body,
                                     request_token=None):
        """Perform a POST request to /orgsVASSaferPayments.

        Create a Orgs VAS Safer Payments.

        Args:
            body (OrgsVASSaferPaymentsPostRequest): The request body parameter.
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create Orgs VAS Safer Payments
