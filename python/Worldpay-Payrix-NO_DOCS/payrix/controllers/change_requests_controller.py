...
from payrix.models.change_requests_response_result import (
...
class ChangeRequestsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize ChangeRequestsController object."""
        super(ChangeRequestsController, self).__init__(config)

    def get_change_requests_id(self,
                               id,
                               request_token=None):
        """Perform a GET request to /changeRequests/{id}.

        Query a Change Request.
        ChangeRequests is a resource that manages changes to a certain
        resource.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on changeRequests resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(ChangeRequestsResponseResult.from_dictionary)
    ...
    def delete_change_requests_id(self,
                                  id,
                                  request_token=None):
        """Perform a DELETE request to /changeRequests/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for delete on changeRequests resource
    ...
    def get_change_requests(self,
                            ...
                            page_number=None,
                            page_limit=None):
        """Perform a GET request to /changeRequests.
