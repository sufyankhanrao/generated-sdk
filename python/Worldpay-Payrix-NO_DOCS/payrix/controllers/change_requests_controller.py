...
from payrix.models.change_requests_response_result import ChangeRequestsResponseResult
...
class ChangeRequestsController(BaseController):
    ...
    def get_change_requests_id(self,
                               id,
                               request_token=None):
        """Does a GET request to /changeRequests/{id}.
    ...
    def delete_change_requests_id(self,
                                  id,
                                  request_token=None):
        """Does a DELETE request to /changeRequests/{id}.
    ...
    def get_change_requests(self,
                            ...
                            page_number=None,
                            page_limit=None):
        """Does a GET request to /changeRequests.
