...
from payrix.models.reserve_entries_response_result import ReserveEntriesResponseResult
...
class ReserveEntryController(BaseController):
    ...
    def get_reserve_entries_id(self,
                               id,
                               request_token=None):
        """Does a GET request to /reserveEntries/{id}.
    ...
    def get_reserve_entries(self,
                            ...
                            page_number=None,
                            page_limit=None):
        """Does a GET request to /reserveEntries.
    ...
    def post_reserve_entries(self,
                             body,
                             request_token=None):
        """Does a POST request to /reserveEntries.
