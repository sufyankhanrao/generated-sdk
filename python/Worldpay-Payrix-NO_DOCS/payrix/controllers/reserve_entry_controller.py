...
from payrix.models.reserve_entries_response_result import (
    ReserveEntriesResponseResult,
)


class ReserveEntryController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize ReserveEntryController object."""
        super(ReserveEntryController, self).__init__(config)

    def get_reserve_entries_id(self,
                               id,
                               request_token=None):
        """Perform a GET request to /reserveEntries/{id}.

        Query a Reserve Entry resource that describes a record of funds moving
        in or out of reserve and can be associated with either a Transaction,
        a Reserve, an entityReserve, or another reserveEntry resource.

        Args:
            id (str): The ID of this reserve entry.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                a Reserve Entry Response for query on reserveEntries resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(ReserveEntriesResponseResult.from_dictionary)
    ...
    def get_reserve_entries(self,
                            ...
                            page_number=None,
                            page_limit=None):
        """Perform a GET request to /reserveEntries.

        Query a reserveEntry resource.
        A reserveEntry resource describes a record of funds moving in or out
        of reserve. It can be associated with either a Transaction, a Reserve,
        an entityReserve, or another reserveEntry resource.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on reserveEntries resource
    ...
    def post_reserve_entries(self,
                             body,
                             request_token=None):
        """Perform a POST request to /reserveEntries.

        Create a Reserve Entry resource that describes a record of funds
        moving in or out of reserve and can be associated with either a
        Transaction, a Reserve, an entityReserve, or another reserveEntry
        resource.

        Args:
            body (ReserveEntriesPostRequest): Create Reserve Entry Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on reserveEntries resource
