...
from payrix.models.entity_custom_fields_response_result import (
    EntityCustomFieldsResponseResult,
)


class EntitiesCustomFieldsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize EntitiesCustomFieldsController object."""
        super(EntitiesCustomFieldsController, self).__init__(config)

    def get_entity_custom_fields_id(self,
                                    id,
                                    request_token=None):
        """Perform a GET request to /entityCustomFields/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on entityCustomFields resource
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(EntityCustomFieldsResponseResult.from_dictionary)
    ...
    def put_entity_custom_fields_id(self,
                                    ...
                                    body,
                                    request_token=None):
        """Perform a PUT request to /entityCustomFields/{id}.
        ...
        Args:
            id (str): The ID of this resource.
            body (EntityCustomFieldsPutRequest): The request body parameter.
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for update on entityCustomFields resource
    ...
    def delete_entity_custom_fields_id(self,
                                       id,
                                       request_token=None):
        """Perform a DELETE request to /entityCustomFields/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for delete on entityCustomFields resource.
    ...
    def get_entity_custom_fields(self,
                                 ...
                                 page_number=None,
                                 page_limit=None):
        """Perform a GET request to /entityCustomFields.
    ...
    def post_entity_custom_fields(self,
                                  body,
                                  request_token=None):
        """Perform a POST request to /entityCustomFields.

        Create an Entity Custom Field. Custom Fields can be added to entities
        associated by the Entity Id. An Entity Id can have various fields
        associated to it.

        Args:
            body (EntityCustomFieldsPostRequest): Add Entity Cutom Field
                Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on entityCustomFields resource
