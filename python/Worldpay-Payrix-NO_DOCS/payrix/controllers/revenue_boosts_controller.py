...
from payrix.models.revenue_boosts_response_result import (
    RevenueBoostsResponseResult,
)


class RevenueBoostsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize RevenueBoostsController object."""
        super(RevenueBoostsController, self).__init__(config)

    def get_revenue_boosts_id(self,
                              id):
        """Perform a GET request to /revenueBoosts/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on revenueBoost resource
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(RevenueBoostsResponseResult.from_dictionary)
    ...
    def get_revenue_boosts(self,
                           ...
                           page_number=None,
                           page_limit=None):
        """Perform a GET request to /revenueBoosts.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for querying and retrieving all revenueBoosts.
    ...
    def post_revenue_boosts(self,
                            body):
        """Perform a POST request to /revenueBoosts.

        Create a Value Added Service networkPaymentManager

        Args:
            body (RevenueBoostsPostRequest): Add RevenueBoosts Request

        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. The
                response for creating revenueBoost on the revenueBoosts
                resource.
