...
from payrix.models.revenue_boosts_response_result import RevenueBoostsResponseResult
...
class RevenueBoostsController(BaseController):
    ...
    def get_revenue_boosts_id(self,
                              id):
        """Does a GET request to /revenueBoosts/{id}.
    ...
    def get_revenue_boosts(self,
                           ...
                           page_number=None,
                           page_limit=None):
        """Does a GET request to /revenueBoosts.
    ...
    def post_revenue_boosts(self,
                            body):
        """Does a POST request to /revenueBoosts.
