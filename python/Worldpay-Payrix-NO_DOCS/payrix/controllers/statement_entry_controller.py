...
from payrix.models.statement_entries_response_result import (
    StatementEntriesResponseResult,
)


class StatementEntryController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize StatementEntryController object."""
        super(StatementEntryController, self).__init__(config)

    def get_statement_entries_id(self,
                                 id,
                                 request_token=None):
        """Perform a GET request to /statementEntries/{id}.

        Query a StatementEntry resource. A StatementEntry resource represents
        a record of funds owed for a billing schedule.

        Args:
            id (str): The ID of this statement entry.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                the Response for the query on the Statement Entries resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(StatementEntriesResponseResult.from_dictionary)
    ...
    def get_statement_entries(self,
                              ...
                              page_number=None,
                              page_limit=None):
        """Perform a GET request to /statementEntries.

        Query a StatementEntry resource.
        A StatementEntry resource represents a record of funds owed for a
        billing schedule.
        For example, this could be a scheduled weekly or monthly fee, or an
        event-based activity such as a capture or payout fee.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on statementEntries resource
