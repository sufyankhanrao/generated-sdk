...
from payrix.models.statement_entries_response_result import StatementEntriesResponseResult
...
class StatementEntryController(BaseController):
    ...
    def get_statement_entries_id(self,
                                 id,
                                 request_token=None):
        """Does a GET request to /statementEntries/{id}.
    ...
    def get_statement_entries(self,
                              ...
                              page_number=None,
                              page_limit=None):
        """Does a GET request to /statementEntries.
