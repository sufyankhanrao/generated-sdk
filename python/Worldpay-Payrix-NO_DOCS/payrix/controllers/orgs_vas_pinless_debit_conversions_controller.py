...
from payrix.models.orgs_vas_pinless_debit_conversions_response_result import (
    OrgsVASPinlessDebitConversionsResponseResult,
)


class OrgsVASPinlessDebitConversionsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize OrgsVASPinlessDebitConversionsController object."""
        super(OrgsVASPinlessDebitConversionsController, self).__init__(config)

    def get_orgs_vas_pinless_debit_conversions_id(self,
                                                  id):
        """Perform a GET request to /orgsVASPinlessDebitConversions/{id}.

        Query orgsVASPinlessDebitConversions.

        Args:
            id (str): The ID of this resource, or the (unknown) ID associated
                with the Orgs VAS Pinless Debit Conversions.

        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for retrieve orgsVASPinlessDebitConversions.
        ...
        return super().new_api_call_builder.request(
            ...
            .path("/orgsVASPinlessDebitConversions/{id}")
            ...
            .deserialize_into(OrgsVASPinlessDebitConversionsResponseResult.from_dictionary)
    ...
    def put_orgs_vas_pinless_debit_conversions_id(self,
                                                  id,
                                                  body):
        """Perform a PUT request to /orgsVASPinlessDebitConversions/{id}.

        Update orgsVASPinlessDebitConversions.

        Args:
            id (str): The ID of this Orgs VAS Pinless Debit Conversions.
            body (OrgsVASPinlessDebitConversionsPutRequest): Update Orgs VAS
                Pinless Debit Conversions

        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. The
                response for update orgsVASPinlessDebitConversions.
    ...
    def get_orgs_vas_pinless_debit_conversions(self,
                                               ...
                                               page_number=None,
                                               page_limit=None):
        """Perform a GET request to /orgsVASPinlessDebitConversions.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on orgsVASPinlessDebitConversions
        ...
        return super().new_api_call_builder.request(
            RequestBuilder().server(Server.PAYRIX)
            .path("/orgsVASPinlessDebitConversions")
            .http_method(HttpMethodEnum.GET)
            .header_param(Parameter()
                          .key("request-token")
                          .value(request_token))
    ...
    def post_orgs_vas_pinless_debit_conversions(self,
                                                body,
                                                request_token=None):
        """Perform a POST request to /orgsVASPinlessDebitConversions.

        Create a orgsVASPinlessDebitConversions.

        Args:
            body (OrgsVASPinlessDebitConversionsPostRequest): The request body
                parameter.
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create orgsVASPinlessDebitConversions
