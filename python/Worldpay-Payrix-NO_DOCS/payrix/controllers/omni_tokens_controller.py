...
from payrix.models.omni_tokens_response_result import (
    OmniTokensResponseResult,
)


class OmniTokensController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize OmniTokensController object."""
        super(OmniTokensController, self).__init__(config)

    def get_omni_tokens_id(self,
                           id):
        """Perform a GET request to /omniTokens/{id}.

        Query a omniToken.

        Args:
            id (str): The ID of this OmniToken.

        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for retrieving OmniToken response.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(OmniTokensResponseResult.from_dictionary)
    ...
    def put_omni_tokens_id(self,
                           id,
                           body):
        """Perform a PUT request to /omniTokens/{id}.

        Update a Token.

        Args:
            id (str): The ID of this OmniToken.
            body (OmniTokensPutRequest): Update OmniToken Request

        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for update OmniToken response.
    ...
    def get_omni_tokens(self,
                        ...
                        page_number=None,
                        page_limit=None):
        """Perform a GET request to /omniTokens.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on OmniToken resource
    ...
    def post_omni_tokens(self,
                         body):
        """Perform a POST request to /omniTokens.

        Create a omniTokens.

        Args:
            body (OmniTokensPostRequest): Create omniTokens

        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create omniTokens resource
