...
from payrix.models.omni_tokens_response_result import OmniTokensResponseResult
...
class OmniTokensController(BaseController):
    ...
    def get_omni_tokens_id(self,
                           id):
        """Does a GET request to /omniTokens/{id}.
    ...
    def put_omni_tokens_id(self,
                           id,
                           body):
        """Does a PUT request to /omniTokens/{id}.
    ...
    def get_omni_tokens(self,
                        ...
                        page_number=None,
                        page_limit=None):
        """Does a GET request to /omniTokens.
    ...
    def post_omni_tokens(self,
                         body):
        """Does a POST request to /omniTokens.
