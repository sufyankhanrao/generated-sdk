...
from payrix.models.chargeback_messages_response_result import (
    ChargebackMessagesResponseResult,
)


class ChargebackMessagesController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize ChargebackMessagesController object."""
        super(ChargebackMessagesController, self).__init__(config)

    def get_chargeback_messages_id(self,
                                   id,
                                   request_token=None,
                                   search=None):
        """Perform a GET request to /chargebackMessages/{id}.

        Query a chargebackMessage. A chargebackMessage resource represents a
        message that is sent by a Merchant, processor, or bank in relation to
        a Chargeback.

        Args:
            id (str): The ID of this chargeback message.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Chargeback Messages Response for query on chargebackMessages
                resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(ChargebackMessagesResponseResult.from_dictionary)
    ...
    def get_chargeback_messages(self,
                                ...
                                page_number=None,
                                page_limit=None):
        """Perform a GET request to /chargebackMessages.

        Query a chargebackMessage resource, which represents a message that is
        sent by a Merchant, processor, or bank in relation to a Chargeback.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Retrieve
                Response for query on chargebackMessages resource.
    ...
    def post_chargeback_messages(self,
                                 body,
                                 request_token=None):
        """Perform a POST request to /chargebackMessages.

        Create a chargebackMessage. A chargebackMessage resource represents a
        message that is sent by a Merchant, processor, or bank in relation to
        a Chargeback.

        Args:
            body (ChargebackMessagePostRequest): Create Chargeback Message
                Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Chargeback Message Response for creating on chargebackMessages
                resource.
