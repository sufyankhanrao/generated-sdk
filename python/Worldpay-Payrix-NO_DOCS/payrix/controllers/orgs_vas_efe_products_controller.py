...
from payrix.models.orgs_vas_efe_products_response_result import OrgsVASEfeProductsResponseResult
...
class OrgsVASEfeProductsController(BaseController):
    ...
    def get_orgs_vas_efe_products_id(self,
                                     id):
        """Does a GET request to /orgsVASEfeProducts/{id}.
    ...
    def put_orgs_vas_efe_products_id(self,
                                     id,
                                     body):
        """Does a PUT request to /orgsVASEfeProducts/{id}.
    ...
    def delete_orgs_vas_efe_products_id(self,
                                        id):
        """Does a DELETE request to /orgsVASEfeProducts/{id}.
    ...
    def get_orgs_vas_efe_products(self,
                                  ...
                                  page_number=None,
                                  page_limit=None):
        """Does a GET request to /orgsVASEfeProducts.
    ...
    def post_orgs_vas_efe_products(self,
                                   body,
                                   request_token=None):
        """Does a POST request to /orgsVASEfeProducts.
