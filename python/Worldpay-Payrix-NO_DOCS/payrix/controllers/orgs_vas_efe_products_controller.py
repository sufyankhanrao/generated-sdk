...
from payrix.models.orgs_vas_efe_products_response_result import (
    OrgsVASEfeProductsResponseResult,
)


class OrgsVASEfeProductsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize OrgsVASEfeProductsController object."""
        super(OrgsVASEfeProductsController, self).__init__(config)

    def get_orgs_vas_efe_products_id(self,
                                     id):
        """Perform a GET request to /orgsVASEfeProducts/{id}.

        Query orgsVASEfeProducts.

        Args:
            id (str): The ID of this resource, or the (unknown) ID associated
                with the Orgs VAS EfeProducts.

        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for retrieve Orgs VAS EfeProducts.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(OrgsVASEfeProductsResponseResult.from_dictionary)
    ...
    def put_orgs_vas_efe_products_id(self,
                                     id,
                                     body):
        """Perform a PUT request to /orgsVASEfeProducts/{id}.

        Update orgsVASEfeProducts.

        Args:
            id (str): The ID of this Orgs VAS EfeProducts.
            body (OrgsVASEfeProductsPutRequest): Update Orgs VAS EfeProducts

        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. The
                response for update Orgs VAS Efe Products.
    ...
    def delete_orgs_vas_efe_products_id(self,
                                        id):
        """Perform a DELETE request to /orgsVASEfeProducts/{id}.
    ...
    def get_orgs_vas_efe_products(self,
                                  ...
                                  page_number=None,
                                  page_limit=None):
        """Perform a GET request to /orgsVASEfeProducts.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on Orgs VAS EfeProducts
    ...
    def post_orgs_vas_efe_products(self,
                                   body,
                                   request_token=None):
        """Perform a POST request to /orgsVASEfeProducts.

        Create a orgsVASEfeProducts.

        Args:
            body (OrgsVASEfeProductsPostRequest): The request body parameter.
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create Orgs VAS EfeProducts
