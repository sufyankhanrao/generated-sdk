...
from payrix.models.terminal_txn_results_response_result import TerminalTxnResultsResponseResult
...
class TerminalTransactionResultsController(BaseController):
    ...
    def get_terminal_txn_results_id(self,
                                    id,
                                    request_token=None):
        """Does a GET request to /terminalTxnResults/{id}.
    ...
    def get_terminal_txn_results(self,
                                 ...
                                 page_number=None,
                                 page_limit=None):
        """Does a GET request to /terminalTxnResults.
