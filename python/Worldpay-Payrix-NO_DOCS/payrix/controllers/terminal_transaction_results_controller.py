...
from payrix.models.terminal_txn_results_response_result import (
    TerminalTxnResultsResponseResult,
)


class TerminalTransactionResultsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize TerminalTransactionResultsController object."""
        super(TerminalTransactionResultsController, self).__init__(config)

    def get_terminal_txn_results_id(self,
                                    id,
                                    request_token=None):
        """Perform a GET request to /terminalTxnResults/{id}.

        Querying a terminalTxnResults resource represents the result of a
        Transaction from a processor, which may be approved, declined, or
        raise an error.

        Args:
            id (str): The ID of this terminal transaction result.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                the response for the query on the Terminal Transaction Results
                resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(TerminalTxnResultsResponseResult.from_dictionary)
    ...
    def get_terminal_txn_results(self,
                                 ...
                                 page_number=None,
                                 page_limit=None):
        """Perform a GET request to /terminalTxnResults.

        Querying a terminalTxnResults resource represents the result of a
        Transaction from a processor, which can be approved, declined, or
        raise an error.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on terminalTxnResults resource
