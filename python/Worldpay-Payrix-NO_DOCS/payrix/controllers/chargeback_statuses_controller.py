...
from payrix.models.chargeback_statuses_response_result import ChargebackStatusesResponseResult
...
class ChargebackStatusesController(BaseController):
    ...
    def get_chargeback_statuses_id(self,
                                   id,
                                   request_token=None):
        """Does a GET request to /chargebackStatuses/{id}.
    ...
    def get_chargeback_statuses(self,
                                ...
                                page_number=None,
                                page_limit=None):
        """Does a GET request to /chargebackStatuses.
