...
from payrix.models.chargeback_statuses_response_result import (
    ChargebackStatusesResponseResult,
)


class ChargebackStatusesController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize ChargebackStatusesController object."""
        super(ChargebackStatusesController, self).__init__(config)

    def get_chargeback_statuses_id(self,
                                   id,
                                   request_token=None):
        """Perform a GET request to /chargebackStatuses/{id}.

        Query ChargebackStatuses. A ChargebackStatuses is the logged status
        changes of a Chargeback, The resource for each Chargeback gives
        details of the Chargeback, including the reason why it occurred and
        the date when it occurred.

        Args:
            id (str): The Chargeback Status ID of this resource.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for retrieving chargebackStatuse response.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(ChargebackStatusesResponseResult.from_dictionary)
    ...
    def get_chargeback_statuses(self,
                                ...
                                page_number=None,
                                page_limit=None):
        """Perform a GET request to /chargebackStatuses.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on chargebackStatuses resource
