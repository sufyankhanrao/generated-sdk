...
from payrix.models.alert_actions_response_result import (
...
class AlertActionsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize AlertActionsController object."""
        super(AlertActionsController, self).__init__(config)

    def get_alert_actions_id(self,
                             id,
                             request_token=None):
        """Perform a GET request to /alertActions/{id}.

        Query an alertAction; An alertAction resource represents a particular
        instance of an Alert that is sent out through one particular channel,
        for example, SMS, mobile application notification, or email, each
        alertAction being associated with an Alert resource.

        Args:
            id (str): The ID of this resource and The Alert Action ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Response for query on alertActions resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(AlertActionsResponseResult.from_dictionary)
    ...
    def put_alert_actions_id(self,
                             ...
                             body,
                             request_token=None):
        """Perform a PUT request to /alertActions/{id}.

        Update an alertAction representing a particular instance of an Alert
        that is sent out through one particular channel, for example, SMS,
        mobile application notification, or email, each being associated with
        an Alert resource.

        Args:
            id (str): The ID of this resource and The Alert Action ID.
            body (AlertActionsPutRequest): Update Alert Action Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for update on alertActions resource Update Alert Action
                Response
    ...
    def delete_alert_actions_id(self,
                                id,
                                request_token=None):
        """Perform a DELETE request to /alertActions/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Alert Action Response for the alertActions resource.
    ...
    def get_alert_actions(self,
                          ...
                          page_number=None,
                          page_limit=None):
        """Perform a GET request to /alertActions.

        Query an alertAction representing a particular instance of an Alert
        that is sent out through one particular channel. For example, SMS,
        mobile application notification, or email, each being associated with
        an Alert resource.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Retrieve
                Alert Actions Response for query on alertActions resource.
    ...
    def post_alert_actions(self,
                           body,
                           request_token=None):
        """Perform a POST request to /alertActions.

        Create an alertAction, which represents a particular instance of an
        Alert sent out through one particular channel, such as SMS, mobile
        application notification, or email, and each alertAction is associated
        with an Alert resource.

        Args:
            body (AlertActionsPostRequest): Create Alert Action Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for creating an alert action on the alertActions resource.
                Create Alert Action Response.
