...
from payrix.models.note_documents_response_result import (
    NoteDocumentsResponseResult,
)


class NoteDocumentsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize NoteDocumentsController object."""
        super(NoteDocumentsController, self).__init__(config)

    def get_note_documents_id(self,
                              id,
                              request_token=None):
        """Perform a GET request to /noteDocuments/{id}.

        Query a Note Document that represents a file that is related to a
        specific note record.

        Args:
            id (str): The ID of this note document.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for retrieve note document response.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(NoteDocumentsResponseResult.from_dictionary)
    ...
    def put_note_documents_id(self,
                              ...
                              body,
                              request_token=None):
        """Perform a PUT request to /noteDocuments/{id}.

        Update a note document, which represents a file related to a specific
        note record.

        Args:
            id (str): The ID of this note document.
            body (NoteDocumentsPutRequest): Update Note Document Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for update on noteDocuments resource: Update Note Document
                Response
    ...
    def delete_note_documents_id(self,
                                 id,
                                 request_token=None):
        """Perform a DELETE request to /noteDocuments/{id}.

        Delete a Note Document, which represents a file related to a specific
        note record.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                response for deleting a note document on the noteDocuments
                resource is the Delete Note Document Response.
    ...
    def get_note_documents(self,
                           ...
                           page_number=None,
                           page_limit=None):
        """Perform a GET request to /noteDocuments.

        Query a Note Document, which represents a file that is related to a
        specific note record and documents resources.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on noteDocuments resource
    ...
    def post_note_documents(self,
                            body,
                            request_token=None):
        """Perform a POST request to /noteDocuments.

        Create a note document, representing a file related to a specific note
        record.

        Args:
            body (NoteDocumentsPostRequest): Create Note Document Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. The
                response for creating a note document on the noteDocuments
                resource.
