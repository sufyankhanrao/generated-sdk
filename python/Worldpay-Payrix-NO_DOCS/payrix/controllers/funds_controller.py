...
from payrix.models.funds_response_result import (
    FundsResponseResult,
)
...
class FundsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize FundsController object."""
        super(FundsController, self).__init__(config)

    def get_funds_id(self,
                     id,
                     request_token=None):
        """Perform a GET request to /funds/{id}.

        Query a Fund, which represents a sum of money held by an Entity, and
        some of the amount can be marked as reserved or available.

        Args:
            id (str): The ID of this resource and The Fund ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                fund response for query on funds resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(FundsResponseResult.from_dictionary)
    ...
    def get_funds(self,
                  ...
                  page_number=None,
                  page_limit=None):
        """Perform a GET request to /funds.

        Query a Fund that represents a sum of money held by an Entity, some of
        which can be marked as reserved or available.
