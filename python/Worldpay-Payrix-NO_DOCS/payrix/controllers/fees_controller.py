...
from payrix.models.fees_response_result import (
    FeesResponseResult,
)
...
class FeesController(BaseController):
    ...
    def __init__(self, config):
        """Initialize FeesController object."""
        super(FeesController, self).__init__(config)

    def get_fees_id(self,
                    id,
                    request_token=None):
        """Perform a GET request to /fees/{id}.

        Query a Fee that is an amount one Entity can charge another Entity
        according to a particular schedule, or based on certain events.

        Args:
            id (str): The ID of this resource and The Fee ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                fee response for query on fees resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(FeesResponseResult.from_dictionary)
    ...
    def put_fees_id(self,
                    ...
                    body,
                    request_token=None):
        """Perform a PUT request to /fees/{id}.

        Update a Fee that is an amount one Entity can charge another Entity
        according to a particular schedule, or based on certain events.

        Args:
            id (str): The ID of this resource and The Fee ID.
            body (FeesPutRequest): Update Fee Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for update on fees resource Update Fee Response
    ...
    def delete_fees_id(self,
                       id,
                       request_token=None):
        """Perform a DELETE request to /fees/{id}.

        Delete a Fee that is an amount one Entity can charge another Entity
        according to a particular schedule, or based on certain events.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                response for delete on fees resource is a Delete Fee Response.
    ...
    def get_fees(self,
                 ...
                 page_number=None,
                 page_limit=None):
        """Perform a GET request to /fees.

        Query a Fee that is an amount that one Entity can charge another
        Entity according to a particular schedule, or based on certain events,
        such as being charged weekly, after boarding, or when an overdraft is
        used.
    ...
    def post_fees(self,
                  body,
                  request_token=None):
        """Perform a POST request to /fees.

        Create a Fee that is an amount one Entity can charge another Entity
        according to a particular schedule or based on certain events.For
        example, Fees can be charged on a weekly basis, after boarding, or
        when an overdraft is used to cover a charge.

        Args:
            body (FeesPostRequest): Create Fee Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
