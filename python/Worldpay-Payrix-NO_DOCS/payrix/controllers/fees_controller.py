...
from payrix.models.fees_response_result import FeesResponseResult
...
class FeesController(BaseController):
    ...
    def delete_fees_id(self,
                       id,
                       request_token=None):
        """Does a DELETE request to /fees/{id}.
