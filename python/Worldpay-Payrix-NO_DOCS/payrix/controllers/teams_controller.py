...
from payrix.models.teams_response_result import (
    TeamsResponseResult,
)
...
class TeamsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize TeamsController object."""
    ...
    def get_teams_id(self,
        ...
        Query a Team, which is a collection of Logins that you can associate
        by creating teamLogin resources.

        Args:
            id (str): The ID of this team.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Team Response for query on teams resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(TeamsResponseResult.from_dictionary)
    ...
    def put_teams_id(self,
                     ...
                     body,
                     request_token=None):
        """Perform a PUT request to /teams/{id}.

        Update a Team, A Team is a collection of Logins, You can associate
        Logins with a Team by creating teamLogin resources.

        Args:
            id (str): The ID of this team.
            body (TeamsPutRequest): Update Team Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for update on teams resource Update Team Response
    ...
    def delete_teams_id(self,
        ...
        Delete a Team, A Team is a collection of Logins, You can associate
        Logins with a Team by creating teamLogin resources.
    ...
    def get_teams(self,
                  ...
                  page_number=None,
                  page_limit=None):
        """Perform a GET request to /teams.
    ...
    def post_teams(self,
                   body,
                   request_token=None):
        """Perform a POST request to /teams.
        ...
        Args:
            body (TeamsPostRequest): Create Team Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
