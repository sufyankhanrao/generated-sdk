...
from payrix.models.plans_response_result import (
    PlansResponseResult,
)
...
class PlansController(BaseController):
    ...
    def __init__(self, config):
        """Initialize PlansController object."""
        super(PlansController, self).__init__(config)

    def get_plans_id(self,
                     id,
                     request_token=None):
        """Perform a GET request to /plans/{id}.

        Query a Plan that represents a recurring type of payment that charges
        a certain amount on a weekly, monthly, quarterly, or annual basis,
        once created, allowing association with a Subscription and user.

        Args:
            id (str): The ID of this plan.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(PlansResponseResult.from_dictionary)
    ...
    def put_plans_id(self,
                     ...
                     body,
                     request_token=None):
        """Perform a PUT request to /plans/{id}.

        Update a Plan that represents a recurring type of payment that charges
        a certain amount on a weekly, monthly, quarterly, or annual basis,
        once created, allowing association with a Subscription and user.

        Args:
            id (str): The ID of this plan.
            body (PlansPutRequest): Update plan Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
    ...
    def delete_plans_id(self,
                        id,
                        request_token=None):
        """Perform a DELETE request to /plans/{id}.

        Delete a Plan that represents a recurring type of payment that charges
        a certain amount on a weekly, monthly, quarterly, or annual basis,
        once created, allowing association with a Subscription and user.
    ...
    def get_plans(self,
                  ...
                  page_number=None,
                  page_limit=None):
        """Perform a GET request to /plans.

        Query a Plan.
        A Plan represents a recurring type of payment that charges a certain
        amount on a weekly, monthly, quarterly, or annual basis.
        Once you create a Plan, you can associate a Subscription and user with
        it.
    ...
    def post_plans(self,
                   body,
                   request_token=None):
        """Perform a POST request to /plans.

        Create a Plan that represents a recurring type of payment that charges
        a certain amount on a weekly, monthly, quarterly, or annual basis,
        which once created, allows you to associate a Subscription and user
        with it.

        Args:
            body (PlansPostRequest): The request body parameter.
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
