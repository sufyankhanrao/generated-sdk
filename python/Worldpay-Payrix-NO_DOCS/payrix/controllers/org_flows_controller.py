...
from payrix.models.org_flows_response_result import (
    OrgFlowsResponseResult,
)


class OrgFlowsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize OrgFlowsController object."""
        super(OrgFlowsController, self).__init__(config)

    def get_org_flows_id(self,
                         id,
                         request_token=None):
        """Perform a GET request to /orgFlows/{id}.

        Query an Org Flow represents a way to trigger the addition or removal
        of the Merchants associated with a Login to a particular Org,
        optionally setting this addition or removal to be recursive, affecting
        all Merchants in any child Logins.

        Args:
            id (str): The ID of this resource, also known as The Org Flow ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                an Org Flow Response for query on orgFlows resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(OrgFlowsResponseResult.from_dictionary)
    ...
    def put_org_flows_id(self,
                         ...
                         body,
                         request_token=None):
        """Perform a PUT request to /orgFlows/{id}.

        Update an Org Flow. An orgFlows resource represents a way to trigger
        the addition or removal of the Merchants associated with a Login to a
        particular Org, optionally set to be recursive, affecting all
        Merchants in any child Logins.

        Args:
            id (str): The ID of this resource and The Org Flow ID.
            body (OrgFlowsPutRequest): Update an Org Flow Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Update an
                Org Flow Response for orgFlows resource.
    ...
    def delete_org_flows_id(self,
                            id,
                            request_token=None):
        """Perform a DELETE request to /orgFlows/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                response for deleting an Org Flow resource.
    ...
    def get_org_flows(self,
                      ...
                      page_number=None,
                      page_limit=None):
        """Perform a GET request to /orgFlows.

        Query an orgFlows resource.
        An orgFlows resource represents a way to trigger the addition or
        removal of the Merchants associated with a Login to a particular Org.
        You can optionally set this addition or removal to be recursive,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on orgFlows resource
    ...
    def post_org_flows(self,
                       body,
                       request_token=None):
        """Perform a POST request to /orgFlows.
        ...
        Args:
            body (OrgFlowsPostRequest): Create Org Flow Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on orgFlows resource
