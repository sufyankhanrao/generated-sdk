...
from payrix.models.vendors_response_result import (
...
class VendorsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize VendorsController object."""
        super(VendorsController, self).__init__(config)

    def get_vendors_id(self,
                       id,
                       request_token=None):
        """Perform a GET request to /vendors/{id}.

        Querying a Vendor resource represents a third-party vendor who
        interacts with the API, for example, a referral platform.

        Args:
            id (str): The ID of this resource, The Vendor ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for retrieving vendor response.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(VendorsResponseResult.from_dictionary)
    ...
    def put_vendors_id(self,
                       ...
                       body,
                       request_token=None):
        """Perform a PUT request to /vendors/{id}.

        Manage a Vendor resource.
        Details:
        Update a Vendor resource. A Vendor resource represents a third-party
        vendor who interacts with the API, for example, a referral platform.
        Query a Vendor resource.

        Args:
            id (str): The ID of this resource and The Vendor ID.
            body (VendorsPutRequest): Update Vendor Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for update on vendor's response.
    ...
    def delete_vendors_id(self,
                          id,
                          request_token=None):
        """Perform a DELETE request to /vendors/{id}.

        Delete a Vendor or Vendors resource that represents a third-party
        vendor who interacts with the API, for example, a referral platform.
    ...
    def get_vendors(self,
                    ...
                    page_number=None,
                    page_limit=None):
        """Perform a GET request to /vendors.

        Query a Vendor resource. A Vendor resource represents a third-party
        vendor who interacts with the API, for example, a referral platform.
