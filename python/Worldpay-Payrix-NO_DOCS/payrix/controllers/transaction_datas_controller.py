...
from payrix.models.txn_datas_response_result import (
    TxnDatasResponseResult,
)


class TransactionDatasController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize TransactionDatasController object."""
        super(TransactionDatasController, self).__init__(config)

    def get_txn_datas_id(self,
                         id,
                         request_token=None):
        """Perform a GET request to /txnDatas/{id}.

        Query a txnDatas resource.
        A txnDatas resource represents data associated with a Transaction - in
        particular, a Base64 encoded image of a signature captured at the time
        of entering the Transaction.

        Args:
            id (str): The ID of this resource and The TXN datas ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on txnDatas resource
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(TxnDatasResponseResult.from_dictionary)
    ...
    def get_txn_datas(self,
                      ...
                      page_number=None,
                      page_limit=None):
        """Perform a GET request to /txnDatas.
    ...
    def post_txn_datas(self,
                       body,
                       request_token=None):
        """Perform a POST request to /txnDatas.

        Create a txnData. A txnDatas resource represents data associated with
        a Transaction - in particular, a Base64 encoded image of a signature
        captured at the time of entering the Transaction.

        Args:
            body (TxnDatasPostRequest): Create txnDatas Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on txnDatas resource
