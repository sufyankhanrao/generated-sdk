...
from payrix.models.txn_datas_response_result import TxnDatasResponseResult
...
class TransactionDatasController(BaseController):
    ...
    def get_txn_datas_id(self,
                         id,
                         request_token=None):
        """Does a GET request to /txnDatas/{id}.
    ...
    def get_txn_datas(self,
                      ...
                      page_number=None,
                      page_limit=None):
        """Does a GET request to /txnDatas.
    ...
    def post_txn_datas(self,
                       body,
                       request_token=None):
        """Does a POST request to /txnDatas.
