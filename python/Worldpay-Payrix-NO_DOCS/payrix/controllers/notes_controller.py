...
from payrix.models.notes_response_result import NotesResponseResult
...
class NotesController(BaseController):
    ...
    def get_notes_id(self,
                     id,
                     request_token=None):
        """Does a GET request to /notes/{id}.
    ...
    def put_notes_id(self,
                     ...
                     body,
                     request_token=None):
        """Does a PUT request to /notes/{id}.
    ...
    def delete_notes_id(self,
                        id,
                        request_token=None):
        """Does a DELETE request to /notes/{id}.
