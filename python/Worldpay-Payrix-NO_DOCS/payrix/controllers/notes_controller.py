...
from payrix.models.notes_response_result import (
    NotesResponseResult,
)
...
class NotesController(BaseController):
    ...
    def __init__(self, config):
        """Initialize NotesController object."""
        super(NotesController, self).__init__(config)

    def get_notes_id(self,
                     id,
                     request_token=None):
        """Perform a GET request to /notes/{id}.

        Query a Notes resource that represents risk management notes, reviews,
        and releases for a Hold, Txn, and Entity specific data.

        Args:
            id (str): The ID of this note.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(NotesResponseResult.from_dictionary)
    ...
    def put_notes_id(self,
                     ...
                     body,
                     request_token=None):
        """Perform a PUT request to /notes/{id}.

        Update a Note.

        Args:
            id (str): The ID of this note.
            body (NotesPutRequest): Update Note Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
    ...
    def delete_notes_id(self,
                        id,
                        request_token=None):
        """Perform a DELETE request to /notes/{id}.
    ...
    def get_notes(self,
                  ...
                  page_number=None,
                  page_limit=None):
        """Perform a GET request to /notes.
    ...
    def post_notes(self,
                   body,
                   request_token=None):
        """Perform a POST request to /notes.

        Create a Notes resource that represents risk management notes,
        reviews, and releases for a Hold, Txn, and Entity-specific data.

        Args:
            body (NotesPostRequest): Create Note Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
