...
from payrix.models.disbursements_response_result import DisbursementsResponseResult
...
class DisbursementsController(BaseController):
    ...
    def get_disbursements_id(self,
                             id,
                             request_token=None):
        """Does a GET request to /disbursements/{id}.
    ...
    def get_disbursements(self,
                          ...
                          page_number=None,
                          page_limit=None):
        """Does a GET request to /disbursements.
