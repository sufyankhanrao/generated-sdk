...
from payrix.models.disbursements_response_result import (
...
class DisbursementsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize DisbursementsController object."""
        super(DisbursementsController, self).__init__(config)

    def get_disbursements_id(self,
                             id,
                             request_token=None):
        """Perform a GET request to /disbursements/{id}.

        Query a Disbursement, which represents a record of an occasion where
        money is either paid to a bank account or received from a bank account.

        Args:
            id (str): The ID of this disbursement.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                the Response for the query on the Disbursements resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(DisbursementsResponseResult.from_dictionary)
    ...
    def get_disbursements(self,
                          ...
                          page_number=None,
                          page_limit=None):
        """Perform a GET request to /disbursements.

        Query Disbursements, each of which represents a record of an occasion
        where money is either paid to a bank account or received from a bank
        account.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Retrieve
                the Disbursements Response for query on disbursements resource.
