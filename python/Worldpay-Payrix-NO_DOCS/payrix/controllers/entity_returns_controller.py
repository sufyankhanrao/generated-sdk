...
from payrix.models.entity_returns_response_result import EntityReturnsResponseResult
...
class EntityReturnsController(BaseController):
    ...
    def get_entity_returns_id(self,
                              id,
                              request_token=None):
        """Does a GET request to /entityReturns/{id}.
    ...
    def get_entity_returns(self,
                           ...
                           page_number=None,
                           page_limit=None):
        """Does a GET request to /entityReturns.
