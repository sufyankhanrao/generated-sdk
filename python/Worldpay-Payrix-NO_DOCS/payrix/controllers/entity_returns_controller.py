...
from payrix.models.entity_returns_response_result import (
    EntityReturnsResponseResult,
)


class EntityReturnsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize EntityReturnsController object."""
        super(EntityReturnsController, self).__init__(config)

    def get_entity_returns_id(self,
                              id,
                              request_token=None):
        """Perform a GET request to /entityReturns/{id}.

        Query an EntityReturn represents an ACH transaction or disbursement
        that has been rejected, which will block ACH creations or send out
        related to its entity and payment.

        Args:
            id (str): The ID of this entity return.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                an Entity Returns Response for query on entity.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(EntityReturnsResponseResult.from_dictionary)
    ...
    def get_entity_returns(self,
                           ...
                           page_number=None,
                           page_limit=None):
        """Perform a GET request to /entityReturns.

        Query an EntityReturn represents an ACH transaction or disbursement
        that has been rejected. The EntityReturn will block ACH creations or
        send out related to its entity and payment.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on entityReturns resource
