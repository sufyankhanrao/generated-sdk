...
from payrix.models.billing_modifiers_response_result import (
    BillingModifiersResponseResult,
)


class BillingModifiersController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize BillingModifiersController object."""
        super(BillingModifiersController, self).__init__(config)

    def get_billing_modifiers_id(self,
                                 id,
                                 request_token=None):
        """Perform a GET request to /billingModifiers/{id}.

        Query a Billing Modifier that can change the total amount of the
        billing or whoever will pay it, such as applying a 10% markup on the
        fee total for a specific org.

        Args:
            id (str): The ID of this billing modifer.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                the response for the query on the billingModifiers resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(BillingModifiersResponseResult.from_dictionary)
    ...
    def put_billing_modifiers_id(self,
                                 ...
                                 body,
                                 request_token=None):
        """Perform a PUT request to /billingModifiers/{id}.

        Update a Billing Modifier that can change the total amount of the
        billing or whoever will pay it, such as applying a 10% markup on the
        fee total for a specific org.

        Args:
            id (str): The ID of this billing modifer.
            body (BillingModifiersPutRequest): Update Billing Modifer Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for update on billingModifiers resource: Update Billing
                Modifier Response
    ...
    def delete_billing_modifiers_id(self,
                                    id,
                                    request_token=None):
        """Perform a DELETE request to /billingModifiers/{id}.

        Delete a Billing Modifier that can change the total amount of the
        billing or whoever will pay it.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for delete on BillingModifiers resource: Delete Billing
                Modifier Response
    ...
    def get_billing_modifiers(self,
                              ...
                              page_number=None,
                              page_limit=None):
        """Perform a GET request to /billingModifiers.

        Query a Billing Modifier that can change the total amount of the
        billing or determine who will pay it. For example, a Billing Modifier
        may apply a 10% markup on the fee total for a specific organization.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Retrieve
                the Response for query on billingModifiers resource.
    ...
    def post_billing_modifiers(self,
                               body,
                               request_token=None):
        """Perform a POST request to /billingModifiers.

        Create a Billing Modifier that can change the total amount of the
        billing or adjust who will pay it, such as applying a 10% markup on
        the fee total for a specific organization.

        Args:
            body (BillingModifiersPostRequest): Create Billing Modifier Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                response for creating a billing modifier is the Create Billing
                Modifier Response.
