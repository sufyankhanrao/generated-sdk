...
from payrix.models.entities_response_result import (
...
class EntitiesController(BaseController):
    ...
    def __init__(self, config):
        """Initialize EntitiesController object."""
    ...
    def get_entities(self,
                     ...
                     page_number=None,
                     page_limit=None):
        """Perform a GET request to /entities.

        Query entities. An Entity is the top-level resource of a business in
        the API, describing the details of that business in its fields. Each
        entity can describe a Merchant, a Partner, or a Facilitator (payment
        facilitator).
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(EntitiesResponseResult.from_dictionary)
    ...
    def post_entities(self,
                      body,
                      request_token=None):
        """Perform a POST request to /entities.

        Create an Entity, the top-level resource of a business in the API,
        describing its details through fields. An entity can represent a
        Merchant, a Partner, or a Facilitator (payment facilitator).

        Args:
            body (EntitiesPostRequest): Create Entity Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                create entity response for the entities resource.
    ...
    def get_entities_id(self,
                        id,
                        request_token=None):
        """Perform a GET request to /entities/{id}.

        Query an Entity, which is the top-level resource of a business in the
        API and describes the details of that business in its fields. An
        Entity can describe a Merchant, a Partner, or a Facilitator (payment
        facilitator).

        Args:
            id (str): The ID of this entity.
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                an Entity response for query on entities resource.
    ...
    def put_entities_id(self,
                        ...
                        body,
                        request_token=None):
        """Perform a PUT request to /entities/{id}.

        Update an Entity, which is the top-level resource of a business in the
        API and describes the details of that business in its fields. An
        Entity can be a Merchant, a Partner, or a Facilitator (payment
        facilitator).

        Args:
            id (str): The ID of this entity.
            body (EntitiesPutRequest): Update Entity Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for update on entities resource Update Entity Response
    ...
    def delete_entities_id(self,
                           id,
                           request_token=None):
        """Perform a DELETE request to /entities/{id}.

        Delete an Entity, which is the top-level resource of a business in the
        API and describes the details of that business in its fields,
        including a Merchant, a Partner, or a Facilitator (payment
        facilitator).
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. The
                response for deleting an entity on the entities resource.
