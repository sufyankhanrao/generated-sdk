...
from payrix.models.token_results_response_result import (
    TokenResultsResponseResult,
)


class TokenResultsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize TokenResultsController object."""
        super(TokenResultsController, self).__init__(config)

    def get_token_results_id(self,
                             id,
                             request_token=None):
        """Perform a GET request to /tokenResults/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Token Results for query on tokenResults. resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(TokenResultsResponseResult.from_dictionary)
    ...
    def get_token_results(self,
                          ...
                          page_number=None,
                          page_limit=None):
        """Perform a GET request to /tokenResults.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on tokenResults resource.
