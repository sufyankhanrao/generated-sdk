...
from payrix.models.token_results_response_result import TokenResultsResponseResult
...
class TokenResultsController(BaseController):
    ...
    def get_token_results_id(self,
                             id,
                             request_token=None):
        """Does a GET request to /tokenResults/{id}.
    ...
    def get_token_results(self,
                          ...
                          page_number=None,
                          page_limit=None):
        """Does a GET request to /tokenResults.
