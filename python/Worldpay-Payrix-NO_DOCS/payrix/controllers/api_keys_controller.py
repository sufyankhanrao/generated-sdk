...
from payrix.models.apikeys_response_result import (
...
class APIKeysController(BaseController):
    ...
    def __init__(self, config):
        """Initialize APIKeysController object."""
        super(APIKeysController, self).__init__(config)

    def get_apikeys_id(self,
                       id,
                       request_token=None):
        """Perform a GET request to /apikeys/{id}.

        Query an API key that represents a permanent method of authentication
        to the API, remaining active until marked as inactive or deleted.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on API Keys Resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(ApikeysResponseResult.from_dictionary)
    ...
    def put_apikeys_id(self,
                       ...
                       body,
                       request_token=None):
        """Perform a PUT request to /apikeys/{id}.

        Update an API key, which represents a permanent method of
        authentication to the API. Each API key remains active until you mark
        it as inactive or delete it.

        Args:
            id (str): The ID of this resource and The API Key ID.
            body (ApiKeysPutRequest): Update API Key Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
    ...
    def delete_apikeys_id(self,
                          id,
                          request_token=None):
        """Perform a DELETE request to /apikeys/{id}.

        Delete an API key that represents a permanent method of authentication
        to the API and remains active until marked as inactive or deleted.
    ...
    def get_apikeys(self,
                    ...
                    page_number=None,
                    page_limit=None):
        """Perform a GET request to /apikeys.

        Query API keys that each represents a permanent method of
        authentication to the API and remains active until marked as inactive
        or deleted.
    ...
    def post_apikeys(self,
                     body,
                     request_token=None):
        """Perform a POST request to /apikeys.

        Create an API key that represents a permanent method of authentication
        to the API. The API key remains active until marked as inactive or
        deleted.

        Args:
            body (ApiKeysPostRequest): Create API Key Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        return super().new_api_call_builder.request(
            ...
            .header_param(Parameter()
                          ...
                          .value("application/json"))
            .body_serializer(APIHelper.json_serialize)
            .auth(Or(Single("apiKey"), Single("sessionKey"),
                Single("txnSessionKey"), And(Single("username"), Single("password")))),
        ).response(
            ResponseHandler()
            .deserializer(APIHelper.json_deserialize)
            .deserialize_into(ApikeysResponseResult.from_dictionary)
