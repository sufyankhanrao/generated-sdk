...
from payrix.models.host_themes_response_result import (
    HostThemesResponseResult,
)


class HostThemesController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize HostThemesController object."""
        super(HostThemesController, self).__init__(config)

    def get_host_themes_id(self,
                           id,
                           request_token=None):
        """Perform a GET request to /hostThemes/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on hostThemes resource
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(HostThemesResponseResult.from_dictionary)
    ...
    def get_host_themes(self,
                        ...
                        page_number=None,
                        page_limit=None):
        """Perform a GET request to /hostThemes.
