...
from payrix.models.fee_modifiers_response_result import (
    FeeModifiersResponseResult,
)


class FeeModifiersController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize FeeModifiersController object."""
        super(FeeModifiersController, self).__init__(config)

    def get_fee_modifiers_id(self,
                             id,
                             request_token=None):
        """Perform a GET request to /feeModifiers/{id}.

        Query a Fee Modifier that can change the total amount of the fee or
        whoever will pay it, such as applying a 10% markup on the fee total
        for a specific org.

        Args:
            id (str): The ID of this resource or The Fee Modifier ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Fee Modifier Response for query on feeModifiers resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(FeeModifiersResponseResult.from_dictionary)
    ...
    def put_fee_modifiers_id(self,
                             ...
                             body,
                             request_token=None):
        """Perform a PUT request to /feeModifiers/{id}.

        Update a Fee Modifier that can change the total amount of the fee or
        whoever will pay it, such as applying a 10% markup on the fee total
        for a specific org.

        Args:
            id (str): The ID of this resource or The Fee Modifier ID.
            body (FeeModifiersPutRequest): Update Fee Modifier Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for update on FeeModifiers resource: Update Fee Modifier
                Response
    ...
    def delete_fee_modifiers_id(self,
                                id,
                                request_token=None):
        """Perform a DELETE request to /feeModifiers/{id}.

        Delete a Fee Modifier that can change the total amount of the fee or
        whoever will pay it, such as applying a 10% markup on the fee total
        for a specific org.

        Args:
            id (str): The Fee Modifier ID of this resource.
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for delete on FeeModifiers response.
    ...
    def get_fee_modifiers(self,
                          ...
                          page_number=None,
                          page_limit=None):
        """Perform a GET request to /feeModifiers.

        Query a Fee Modifier that can change the total amount of the fee or
        whoever will pay it. For example, a Fee Modifier could apply a 10%
        markup on the fee total for a specific org.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on feeModifiers resource
    ...
    def post_fee_modifiers(self,
                           body,
                           request_token=None):
        """Perform a POST request to /feeModifiers.

        Create a Fee Modifier that can change the total amount of the fee or
        the party responsible for paying it. For example, a Fee Modifier could
        apply a 10% markup on the fee total for a specific org.

        Args:
            body (FeeModifiersPostRequest): Create Fee Modifier Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on feeModifiers resource
