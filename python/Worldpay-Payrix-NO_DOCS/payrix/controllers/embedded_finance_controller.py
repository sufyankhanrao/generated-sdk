...
from payrix.models.embedded_finance_response_result import (
    EmbeddedFinanceResponseResult,
)


class EmbeddedFinanceController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize EmbeddedFinanceController object."""
        super(EmbeddedFinanceController, self).__init__(config)

    def get_embedded_finance_id(self,
                                id,
                                request_token=None):
        """Perform a GET request to /embeddedFinance/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                embeddedFinance Response for query on embeddedFinance resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(EmbeddedFinanceResponseResult.from_dictionary)
    ...
    def put_embedded_finance_id(self,
                                ...
                                body,
                                request_token=None):
        """Perform a PUT request to /embeddedFinance/{id}.

        Update a embeddedFinance.

        Args:
            id (str): The ID of this resource.
            body (EmbeddedFinancePutRequest): Update embeddedFinance Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for update on embeddedFinance resource Update embeddedFinance
                Response
    ...
    def get_embedded_finance(self,
                             ...
                             page_number=None,
                             page_limit=None):
        """Perform a GET request to /embeddedFinance.
    ...
    def post_embedded_finance(self,
                              body,
                              request_token=None):
        """Perform a POST request to /embeddedFinance.

        Create a embeddedFinance.

        Args:
            body (EmbeddedFinancePostRequest): Create embeddedFinance
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                embeddedFinance Response for creating embeddedFinance.
