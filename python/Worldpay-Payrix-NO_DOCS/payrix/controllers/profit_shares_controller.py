...
from payrix.models.profit_shares_response_result import (
    ProfitSharesResponseResult,
)


class ProfitSharesController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize ProfitSharesController object."""
        super(ProfitSharesController, self).__init__(config)

    def get_profit_shares_id(self,
                             id,
                             request_token=None):
        """Perform a GET request to /profitShares/{id}.

        Query a ProfitShare resource, which will cause an entity to have its
        earnings/expenses shared with another entity.

        Args:
            id (str): The ID of this resource, The Profit Share ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                the Response for the Profit Shares resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(ProfitSharesResponseResult.from_dictionary)
    ...
    def put_profit_shares_id(self,
                             ...
                             body,
                             request_token=None):
        """Perform a PUT request to /profitShares/{id}.

        Update a ProfitShare resource, which causes an entity's
        earnings/expenses to be shared with another entity.

        Args:
            id (str): The ID of this resource, The Profit Share ID.
            body (ProfitSharesPutRequest): Update Profit Share Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for update on Profit Shares resource.
    ...
    def delete_profit_shares_id(self,
                                id,
                                request_token=None):
        """Perform a DELETE request to /profitShares/{id}.

        Delete a ProfitShare resource, which causes an entity's
        earnings/expenses to be shared with another entity.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                response for delete on profitShares resource is the Delete
    ...
    def get_profit_shares(self,
                          ...
                          page_number=None,
                          page_limit=None):
        """Perform a GET request to /profitShares.

        Query a ProfitShare resource.
        A ProfitShare resource will cause an entity to have it's
        earnings/expenses shared with another entity.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on profitShares resource
    ...
    def post_profit_shares(self,
                           body,
                           request_token=None):
        """Perform a POST request to /profitShares.
        ...
        Args:
            body (ProfitSharesPostRequest): Create Profit Share Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. esponse
                for create on profitShares resource
