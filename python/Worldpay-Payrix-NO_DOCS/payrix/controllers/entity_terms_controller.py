...
from payrix.models.entity_terms_response_result import EntityTermsResponseResult
...
class EntityTermsController(BaseController):
    ...
    def get_entity_terms_id(self,
                            id,
                            request_token=None):
        """Does a GET request to /entityTerms/{id}.
    ...
    def get_entity_terms(self,
                         ...
                         page_number=None,
                         page_limit=None):
        """Does a GET request to /entityTerms.
    ...
    def post_entity_terms(self,
                          body,
                          request_token=None):
        """Does a POST request to /entityTerms.
