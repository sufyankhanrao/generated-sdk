...
from payrix.models.entity_terms_response_result import (
    EntityTermsResponseResult,
)


class EntityTermsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize EntityTermsController object."""
        super(EntityTermsController, self).__init__(config)

    def get_entity_terms_id(self,
                            id,
                            request_token=None):
        """Perform a GET request to /entityTerms/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on entityTerms resource
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(EntityTermsResponseResult.from_dictionary)
    ...
    def get_entity_terms(self,
                         ...
                         page_number=None,
                         page_limit=None):
        """Perform a GET request to /entityTerms.
    ...
    def post_entity_terms(self,
                          body,
                          request_token=None):
        """Perform a POST request to /entityTerms.

        Create an entityTerms.

        Args:
            body (EntityTermsPostRequest): The request body parameter.
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on entityTerms resource
