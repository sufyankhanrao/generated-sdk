...
from payrix.models.entity_datas_response_result import (
    EntityDatasResponseResult,
)


class EntityDataController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize EntityDataController object."""
        super(EntityDataController, self).__init__(config)

    def get_entity_datas_id(self,
                            id,
                            request_token=None):
        """Perform a GET request to /entityDatas/{id}.

        Query an EntityDatas containing information about that entity, such as
        the signature for the terms and conditions.

        Args:
            id (str): The ID of this entity data.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                an Entity Data Response for query on entityDatas resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(EntityDatasResponseResult.from_dictionary)
    ...
    def get_entity_datas(self,
                         ...
                         page_number=None,
                         page_limit=None):
        """Perform a GET request to /entityDatas.

        Query an EntityDatas, which is the data related to an entity
        containing information about that entity such as the signature for the
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Retrieve
                an Entity Data Response for the query on entityDatas resource.
    ...
    def post_entity_datas(self,
                          body,
                          request_token=None):
        """Perform a POST request to /entityDatas.

        Create an EntityDatas containing the data related to an entity,
        including information such as the signature for the terms and
        conditions.

        Args:
            body (EntityDataPostRequest): Create Entity Data Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                create on entityDatas response.
