...
from payrix.models.entity_datas_response_result import EntityDatasResponseResult
...
class EntityDataController(BaseController):
    ...
    def get_entity_datas_id(self,
                            id,
                            request_token=None):
        """Does a GET request to /entityDatas/{id}.
    ...
    def get_entity_datas(self,
                         ...
                         page_number=None,
                         page_limit=None):
        """Does a GET request to /entityDatas.
    ...
    def post_entity_datas(self,
                          body,
                          request_token=None):
        """Does a POST request to /entityDatas.
