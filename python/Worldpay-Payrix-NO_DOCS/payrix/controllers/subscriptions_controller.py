...
from payrix.models.subscription_response_result import (
...
class SubscriptionsController(BaseController):
    ...
    def get_subscriptions_id(self,
                             id,
                             request_token=None):
        """Perform a GET request to /subscriptions/{id}.

        Query a Subscription that specifies both starting and ending dates and
        charges the customer according to the schedule in the associated Plan
        during the interval between these dates.

        Args:
            id (str): The ID of this subscription.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for retrieve subscription response.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(SubscriptionResponseResult.from_dictionary)
    ...
    def put_subscriptions_id(self,
                             ...
                             body,
                             request_token=None):
        """Perform a PUT request to /subscriptions/{id}.

        Update a Subscription, A Subscription specifies both starting and
        ending dates and the customer is charged according to the schedule in
        the associated Plan during the interval between these dates.

        Args:
            id (str): The ID of this subscription.
            body (SubscriptionsPutRequest): Update Subscription Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for update on subscriptions resource Update Subscription
                Response
    ...
    def delete_subscriptions_id(self,
                                id,
                                request_token=None):
        """Perform a DELETE request to /subscriptions/{id}.

        Delete a Subscription. A Subscription is a scheduled invocation of a
        particular Plan over a certain period of time, specifying both
        starting and ending dates, and the customer is charged according to
        the schedule in the associated Plan during the interval between these
        dates.
    ...
    def get_subscriptions(self,
        ...
        A Subscription is a scheduled invocation of a particular Plan over a
        certain period of time.
        A Subscription specifies both starting and ending dates and the
        customer is charged according to the schedule in the associated Plan
        during the interval between these dates.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on subscriptions resource
    ...
    def post_subscriptions(self,
        ...
        Args:
            body (SubscriptionsPostRequest): Create Subscription Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on subscriptions resource
