...
from payrix.models.chargebacks_response_result import (
...
class ChargebacksController(BaseController):
    ...
    def __init__(self, config):
        """Initialize ChargebacksController object."""
        super(ChargebacksController, self).__init__(config)

    def get_chargebacks_id(self,
                           id,
                           request_token=None):
        """Perform a GET request to /chargebacks/{id}.

        Query a Chargeback. A Chargeback is the reversal of a Transaction and
        means that the funds have been returned to their source. The resource
        for a Chargeback gives details of the Chargeback, including the reason
        why it occurred and the date when it occurred.

        Args:
            id (str): The ID of the Chargeback.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on chargebacks resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(ChargebacksResponseResult.from_dictionary)
    ...
    def get_chargebacks(self,
                        ...
                        page_number=None,
                        page_limit=None):
        """Perform a GET request to /chargebacks.

        Query Chargebacks. A Chargeback is the reversal of a Transaction,
        meaning that the funds have been returned to their source. The
        resource for each Chargeback gives details of the Chargeback,
        including the reason why it occurred and the date when it occurred.
