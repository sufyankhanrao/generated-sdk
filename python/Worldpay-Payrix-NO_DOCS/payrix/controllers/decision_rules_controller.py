...
from payrix.models.decision_rules_response_result import (
    DecisionRulesResponseResult,
)


class DecisionRulesController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize DecisionRulesController object."""
        super(DecisionRulesController, self).__init__(config)

    def get_decision_rules_id(self,
                              id,
                              request_token=None):
        """Perform a GET request to /decisionRules/{id}.

        Query a Decision Rule that makes a Decision apply only in certain
        circumstances, such as applying an administration charge if a payment
        is under $50.

        Args:
            id (str): The ID of this resource and The Decision Rule ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                the Response for query on decisionRules resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(DecisionRulesResponseResult.from_dictionary)
    ...
    def put_decision_rules_id(self,
                              ...
                              body,
                              request_token=None):
        """Perform a PUT request to /decisionRules/{id}.

        Update a Decision Rule that makes a Decision apply only in certain
        circumstances, for example, applying an administration charge if a
        payment is under $50.

        Args:
            id (str): The ID of this resource and The Decision Rule ID.
            body (DecisionRulesPutRequest): Update Decision Rule Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for update on Decision Rules resource: Update Decision Rule
                Response
    ...
    def delete_decision_rules_id(self,
                                 id,
                                 request_token=None):
        """Perform a DELETE request to /decisionRules/{id}.

        Delete a Decision Rule that makes a Decision apply only in certain
        circumstances, for example, applying an administration charge if a
        payment is under $50.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                response for deleting a decision rule.
...
Details: None
    ...
    def get_decision_rules(self,
                           ...
                           page_number=None,
                           page_limit=None):
        """Perform a GET request to /decisionRules.

        Query a Decision Rule; A Decision Rule is a piece of conditional logic
        that makes a Decision apply only in certain circumstances, For
        example, a Decision Rule could apply an administration charge if a
        payment is under $50.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on decision rules resource.
    ...
    def post_decision_rules(self,
                            body,
                            request_token=None):
        """Perform a POST request to /decisionRules.

        Create a Decision Rule that makes a Decision apply only in certain
        circumstances, such as applying an administration charge if a payment
        is under $50.

        Args:
            body (DecisionRulesPostRequest): Create Decision Rule Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Decision Rule Response for create on decisionRules resource.
