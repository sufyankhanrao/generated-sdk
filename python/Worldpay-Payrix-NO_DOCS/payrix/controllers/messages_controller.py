...
from payrix.models.messages_response_result import (
...
class MessagesController(BaseController):
    ...
    def __init__(self, config):
        """Initialize MessagesController object."""
        super(MessagesController, self).__init__(config)

    def get_messages_id(self,
                        id,
                        request_token=None):
        """Perform a GET request to /messages/{id}.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(MessagesResponseResult.from_dictionary)
    ...
    def put_messages_id(self,
                        ...
                        body,
                        request_token=None):
        """Perform a PUT request to /messages/{id}.

        Update a messages or Message resource, which represents a message for
        a messageThread.

        Args:
            id (str): The ID of this message.
            body (MessagesPutRequest): Update Message Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for update on messages resource Update Message Response
    ...
    def get_messages(self,
                     ...
                     page_number=None,
                     page_limit=None):
        """Perform a GET request to /messages.

        Query a Message or query a messages resource that represents a message
        for a messageThreads.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on messages resource
    ...
    def post_messages(self,
                      body,
                      request_token=None):
        """Perform a POST request to /messages.

        Create a Messages resource, which represents a message for a
        messageThread.

        Args:
            body (MessagesPostRequest): Create Message Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                response for creating a message in the messages resource
