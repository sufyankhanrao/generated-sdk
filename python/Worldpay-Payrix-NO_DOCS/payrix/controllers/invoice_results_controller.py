...
from payrix.models.invoice_results_response_result import InvoiceResultsResponseResult
...
class InvoiceResultsController(BaseController):
    ...
    def get_invoice_results_id(self,
                               id,
                               request_token=None):
        """Does a GET request to /invoiceResults/{id}.
    ...
    def get_invoice_results(self,
                            ...
                            page_number=None,
                            page_limit=None):
        """Does a GET request to /invoiceResults.
    ...
    def post_invoice_results(self,
                             body,
                             request_token=None):
        """Does a POST request to /invoiceResults.
