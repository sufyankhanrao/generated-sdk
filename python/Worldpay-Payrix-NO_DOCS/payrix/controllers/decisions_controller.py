...
from payrix.models.decisions_response_result import (
...
class DecisionsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize DecisionsController object."""
        super(DecisionsController, self).__init__(config)

    def get_decisions_id(self,
                         id,
                         request_token=None):
        """Perform a GET request to /decisions/{id}.

        Query a Decision's resource.

        Args:
            id (str): The ID of this resource and The Decision ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Decision Response for query on decisions resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(DecisionsResponseResult.from_dictionary)
    ...
    def put_decisions_id(self,
                         ...
                         body,
                         request_token=None):
        """Perform a PUT request to /decisions/{id}.

        Update a Decisions resource, which represents the schedule and rules
        for a check done on Transactions.

        Args:
            id (str): The ID of this resource and The Decision ID.
            body (DecisionsPutRequest): Update Decision Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for update on decisions resource Update Decision Response
    ...
    def delete_decisions_id(self,
                            id,
                            request_token=None):
        """Perform a DELETE request to /decisions/{id}.

        Delete a Decision's resource, which represents the schedule and rules
        for a check done on Transactions.

        Args:
            id (str): The ID of this resource, also known as The Decision ID.
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                response for delete on decisions resource is Delete Decision
                Action Response.
    ...
    def get_decisions(self,
                      ...
                      page_number=None,
                      page_limit=None):
        """Perform a GET request to /decisions.

        Query a Decision's resource. A decisions resource represents the
        schedule and rules for a check done on Transactions.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Retrieve
                Decisions Response for query on decisions resource.
    ...
    def post_decisions(self,
                       body,
                       request_token=None):
        """Perform a POST request to /decisions.

        Create a Decisions resource that represents the schedule and rules for
        a check done on Transactions.

        Args:
            body (DecisionsPostRequest): Create Decision Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on decisions resource
