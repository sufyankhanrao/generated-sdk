...
from payrix.models.terminal_txn_metadatas_response_result import (
    TerminalTxnMetadatasResponseResult,
)


class TerminalTransactionsMetadatasController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize TerminalTransactionsMetadatasController object."""
        super(TerminalTransactionsMetadatasController, self).__init__(config)

    def get_terminal_txns_metadatas_id(self,
                                       id,
                                       request_token=None):
        """Perform a GET request to /terminalTxnMetadatas/{id}.

        Query a terminalTxnMetadatas resource.
        A terminalTxnMetadatas resource represents data from an EMV
        Transaction and/or returned by the credit card network associated with
        a Transaction.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Terminal Transaction Metadata Response
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(TerminalTxnMetadatasResponseResult.from_dictionary)
    ...
    def get_terminal_txns_metadatas(self,
                                    ...
                                    page_number=None,
                                    page_limit=None):
        """Perform a GET request to /terminalTxnMetadatas.
    ...
    def post_terminal_txns_metadatas(self,
                                     body,
                                     request_token=None):
        """Perform a POST request to /terminalTxnMetadatas.

        Create a terminalTxnMetadatas resource. A terminalTxnMetadatas
        resource represents data from an EMV Transaction and/or returned by
        the credit card network associated with a Transaction.

        Args:
            body (TerminalTxnsMetadatasPostRequest): Create Terminal
