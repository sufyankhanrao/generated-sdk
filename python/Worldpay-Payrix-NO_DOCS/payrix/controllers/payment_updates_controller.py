...
from payrix.models.payment_updates_response_result import PaymentUpdatesResponseResult
...
class PaymentUpdatesController(BaseController):
    ...
    def get_payment_updates_id(self,
                               id,
                               request_token=None):
        """Does a GET request to /paymentUpdates/{id}.
    ...
    def get_payment_updates(self,
                            ...
                            page_number=None,
                            page_limit=None):
        """Does a GET request to /paymentUpdates.
