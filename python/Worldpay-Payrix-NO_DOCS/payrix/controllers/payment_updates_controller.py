...
from payrix.models.payment_updates_response_result import (
...
class PaymentUpdatesController(BaseController):
    ...
    def __init__(self, config):
        """Initialize PaymentUpdatesController object."""
        super(PaymentUpdatesController, self).__init__(config)

    def get_payment_updates_id(self,
                               id,
                               request_token=None):
        """Perform a GET request to /paymentUpdates/{id}.

        _CONFLICT Query a Payment Update that holds information about the
        payment update, related to a payment, subscriptionToken or account,
        and owned by a paymentUpdateGroup.

        Args:
            id (str): The ID of this payment update.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for retrieve payment update response.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(PaymentUpdatesResponseResult.from_dictionary)
    ...
    def get_payment_updates(self,
                            ...
                            page_number=None,
                            page_limit=None):
        """Perform a GET request to /paymentUpdates.

        Query a PaymentUpdate.
        A PaymentUpdate holds information about the payment update. The
        paymentUpdate will be related to a payment, subscriptionToken or
        account, and owned by a paymentUpdateGroup.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on paymentUpdates resource
