...
from payrix.models.credentials_response_result import (
...
class CredentialsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize CredentialsController object."""
        super(CredentialsController, self).__init__(config)

    def get_credentials_id(self,
                           id,
                           request_token=None):
        """Perform a GET request to /credentials/{id}.

        Query a Credential resource that represents an authorization that a
        given Entity has to connect to an integration to perform a particular
        action, such as send Transactions to the processor, or board a
        Merchant with the processor.

        Args:
            id (str): The ID of this resource and The Credential ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for retrieve credential response.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(CredentialsResponseResult.from_dictionary)
    ...
    def put_credentials_id(self,
                           ...
                           body,
                           request_token=None):
        """Perform a PUT request to /credentials/{id}.

        Update a Credential resource represents an authorization that a given
        Entity has to connect to an integration to perform a particular action.

        Args:
            id (str): The ID of this resource and The Credential ID.
            body (CredentialsPutRequest): Update Credential Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for update on credentials resource Update Credential Response
    ...
    def delete_credentials_id(self,
                              id,
                              request_token=None):
        """Perform a DELETE request to /credentials/{id}.

        Delete a Credential resource. A Credential resource represents an
        authorization that a given Entity has to connect to an integration to
        perform a particular action, such as delete a Credential resource.
...
None.
    ...
    def get_credentials(self,
                        ...
                        page_number=None,
                        page_limit=None):
        """Perform a GET request to /credentials.

        Query a Credential resource. A Credential resource represents an
        authorization that a given Entity has to connect to an integration to
        perform a particular action, such as send Transactions to the
        processor, or board a Merchant with the processor
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Credentials Response for query on credentials resource.
    ...
    def post_credentials(self,
                         body,
                         request_token=None):
        """Perform a POST request to /credentials.

        Create a Credential resource that represents an authorization that a
        given Entity has to connect to an integration to perform a particular
        action, such as send Transactions to the processor, or board a
        Merchant with the processor.

        Args:
            body (CredentialsPostRequest): Create Credential Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. The
                Create Credential Response for create on credentials resource.
