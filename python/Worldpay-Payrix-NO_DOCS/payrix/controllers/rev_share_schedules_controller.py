...
from payrix.models.rev_share_schedules_response_result import (
    RevShareSchedulesResponseResult,
)


class RevShareSchedulesController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize RevShareSchedulesController object."""
        super(RevShareSchedulesController, self).__init__(config)

    def get_rev_share_schedules_id(self,
                                   id,
                                   request_token=None):
        """Perform a GET request to /revShareSchedules/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on revShareSchedules resource
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(RevShareSchedulesResponseResult.from_dictionary)
    ...
    def put_rev_share_schedules_id(self,
                                   ...
                                   body,
                                   request_token=None):
        """Perform a PUT request to /revShareSchedules/{id}.

        Update a revShareSchedule.

        Args:
            id (str): The ID of this resource.
            body (RevShareSchedulesPutRequest): The request body parameter.
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for update on revShareSchedules resource
    ...
    def delete_rev_share_schedules_id(self,
                                      id,
                                      request_token=None):
        """Perform a DELETE request to /revShareSchedules/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for delete on revShareSchedules resource
    ...
    def get_rev_share_schedules(self,
                                ...
                                page_number=None,
                                page_limit=None):
        """Perform a GET request to /revShareSchedules.
    ...
    def post_rev_share_schedules(self,
                                 body,
                                 request_token=None):
        """Perform a POST request to /revShareSchedules.

        Create a revShareSchedules.

        Args:
            body (RevShareSchedulesPostRequest): The request body parameter.
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on revShareSchedules resource
