...
from payrix.models.orgs_response_result import OrgsResponseResult
...
class OrgsController(BaseController):
    ...
    def delete_orgs_id(self,
                       id,
                       request_token=None):
        """Does a DELETE request to /orgs/{id}.
