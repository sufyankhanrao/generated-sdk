...
from payrix.models.orgs_response_result import (
    OrgsResponseResult,
)
...
class OrgsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize OrgsController object."""
        super(OrgsController, self).__init__(config)

    def get_orgs_id(self,
                    id,
                    request_token=None):
        """Perform a GET request to /orgs/{id}.

        Query an Org, which is a collection of Entities that you can associate
        with by creating orgEntity resources.

        Args:
            id (str): The ID of this resource and the Org ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                an Org Response for query on orgs resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(OrgsResponseResult.from_dictionary)
    ...
    def put_orgs_id(self,
                    ...
                    body,
                    request_token=None):
        """Perform a PUT request to /orgs/{id}.

        Update an Org, which is a collection of Entities that you can
        associate with other entities by creating orgEntity resources.

        Args:
            id (str): The ID of this resource and the Org ID.
            body (OrgsPutRequest): Update an Org Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for update on orgs resource: Update an Org Response
    ...
    def delete_orgs_id(self,
                       id,
                       request_token=None):
        """Perform a DELETE request to /orgs/{id}.

        Delete an Organization, which is a collection of Entities that you can
        associate with it by creating organization-entity resources.
    ...
    def get_orgs(self,
        ...
        Query an Org, which is a collection of Entities, To associate Entities
        with an Org use the [orgEntity]($e/Org%20Entities/getOrgEntitiesId)
        endpoint. You will need the created Org ID when adding entities, such
        as a Merchant, to the Organization.
    ...
    def post_orgs(self,
        ...
        Create an Org which is a collection of Entities, To associate Entities
        with an Org use the [orgEntity]($e/Org%20Entities/getOrgEntitiesId)
        endpoint. You will need the created Org ID when adding entities, such
        as a Merchant, to the Organization.

        Args:
            body (OrgsPostRequest): Create Org Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
