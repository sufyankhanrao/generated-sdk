...
from payrix.models.vas_efe_offers_response_result import VasEfeOffersResponseResult
...
class VASEfeOffersController(BaseController):
    ...
    def get_vas_efe_offers_id(self,
                              id,
                              request_token=None):
        """Does a GET request to /vasEfeOffers/{id}.
    ...
    def get_vas_efe_offers(self,
                           ...
                           page_number=None,
                           page_limit=None):
        """Does a GET request to /vasEfeOffers.
