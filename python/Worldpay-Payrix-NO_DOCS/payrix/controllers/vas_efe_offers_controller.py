...
from payrix.models.vas_efe_offers_response_result import (
    VasEfeOffersResponseResult,
)


class VASEfeOffersController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize VASEfeOffersController object."""
        super(VASEfeOffersController, self).__init__(config)

    def get_vas_efe_offers_id(self,
                              id,
                              request_token=None):
        """Perform a GET request to /vasEfeOffers/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on vasEfeOffers resource
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(VasEfeOffersResponseResult.from_dictionary)
    ...
    def get_vas_efe_offers(self,
                           ...
                           page_number=None,
                           page_limit=None):
        """Perform a GET request to /vasEfeOffers.
