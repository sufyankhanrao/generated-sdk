...
from payrix.models.apple_domains_response_result import AppleDomainsResponseResult
...
class AppleDomainsController(BaseController):
    ...
    def get_apple_domains_id(self,
                             id,
                             request_token=None):
        """Does a GET request to /appleDomains{id}.
    ...
    def get_apple_domains(self,
                          ...
                          page_number=None,
                          page_limit=None):
        """Does a GET request to /appleDomains.
