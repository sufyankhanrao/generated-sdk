...
from payrix.models.apple_domains_response_result import (
    AppleDomainsResponseResult,
)


class AppleDomainsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize AppleDomainsController object."""
        super(AppleDomainsController, self).__init__(config)

    def get_apple_domains_id(self,
                             id,
                             request_token=None):
        """Perform a GET request to /appleDomains{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on appleDomains resource
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(AppleDomainsResponseResult.from_dictionary)
    ...
    def get_apple_domains(self,
                          ...
                          page_number=None,
                          page_limit=None):
        """Perform a GET request to /appleDomains.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for querying and retrieving all appleDomains.
