...
from payrix.models.chargeback_documents_response_result import (
    ChargebackDocumentsResponseResult,
)


class ChargebackDocumentsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize ChargebackDocumentsController object."""
        super(ChargebackDocumentsController, self).__init__(config)

    def get_chargeback_documents_id(self,
                                    id,
                                    request_token=None):
        """Perform a GET request to /chargebackDocuments/{id}.

        Query a chargebackDocument. A chargebackDocument resource represents a
        file related to a Chargeback.

        Args:
            id (str): The ID of this chargeback document.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on chargebackDocuments resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(ChargebackDocumentsResponseResult.from_dictionary)
    ...
    def put_chargeback_documents_id(self,
                                    ...
                                    body,
                                    request_token=None):
        """Perform a PUT request to /chargebackDocuments/{id}.

        Update a chargebackDocument. A chargebackDocument resource represents
        a file related to a Chargeback.

        Args:
            id (str): The ID of this chargeback document.
            body (ChargebacksDocumentsPutRequest): Update Chargeback Document
                Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for updating a chargebackDocuments resource.
    ...
    def delete_chargeback_documents_id(self,
                                       id,
                                       request_token=None):
        """Perform a DELETE request to /chargebackDocuments/{id}.

        Delete a chargebackDocument. A chargebackDocument resource represents
        a file related to a Chargeback.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for deleting a chargebackDocuments resource.
    ...
    def get_chargeback_documents(self,
                                 ...
                                 page_number=None,
                                 page_limit=None):
        """Perform a GET request to /chargebackDocuments.

        Query chargebackDocuments, each representing a file related to a
        Chargeback.
    ...
    def post_chargeback_documents(self,
                                  body,
                                  request_token=None):
        """Perform a POST request to /chargebackDocuments.

        Create a chargebackDocument resource that represents a file related to
        a Chargeback.

        Args:
            body (ChargebackDocumentsPostRequest): Create Chargeback Document
                Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for creating a chargebackDocuments resource.
