...
from payrix.models.org_flow_actions_response_result import (
    OrgFlowActionsResponseResult,
)


class OrgFlowActionsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize OrgFlowActionsController object."""
        super(OrgFlowActionsController, self).__init__(config)

    def get_org_flow_actions_id(self,
                                id,
                                request_token=None):
        """Perform a GET request to /orgFlowActions/{id}.

        Query an Org Flow Actions resource.

        Args:
            id (str): The ID of this resource or The Org Flow Action ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                an Org Flow Action Response for the query on orgFlowActions
                resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(OrgFlowActionsResponseResult.from_dictionary)
    ...
    def put_org_flow_actions_id(self,
                                ...
                                body,
                                request_token=None):
        """Perform a PUT request to /orgFlowActions/{id}.

        Update an Org Flow Action.

        Args:
            id (str): The ID of this resource or The Org Flow Action ID.
            body (OrgFlowActionsPutRequest): Update an Org Flow Action Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for updating an Org Flow Action.
    ...
    def delete_org_flow_actions_id(self,
                                   id,
                                   request_token=None):
        """Perform a DELETE request to /orgFlowActions/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Org Flow Action Response for the orgFlowActions resource.
    ...
    def get_org_flow_actions(self,
                             ...
                             page_number=None,
                             page_limit=None):
        """Perform a GET request to /orgFlowActions.

        Query an orgFlowActions resource.
        An orgFlowActions resource lets you add an Entity defined in the
        associated orgFlow to an Org, or remove an Entity identified in the
        same way from an Org.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Retrieve
                the Org Flow Actions Response for query on orgFlowActions
                resource.
    ...
    def post_org_flow_actions(self,
                              body,
                              request_token=None):
        """Perform a POST request to /orgFlowActions.

        Create an Org Flow Action that lets you add an Entity defined in the
        associated orgFlow to an Org, or remove an Entity identified in the
        same way from an Org.

        Args:
            body (OrgFlowActionsPostRequest): Create Org Flow Action Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on orgFlowActions resource
