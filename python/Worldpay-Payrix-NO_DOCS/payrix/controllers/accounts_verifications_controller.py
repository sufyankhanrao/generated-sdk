...
from payrix.models.account_verifications_response_result import (
    AccountVerificationsResponseResult,
)


class AccountsVerificationsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize AccountsVerificationsController object."""
        super(AccountsVerificationsController, self).__init__(config)

    def get_account_verifications_id(self,
                                     id,
                                     request_token=None):
        """Perform a GET request to /accountVerifications/{id}.

        Retrieve a list of all account verifications that query an
        accountVerifications resource, representing attempts to verify the
        ownership of a particular bank account by verifying a known deposit
        amount or credential.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                the Response for query on accountVerifications resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(AccountVerificationsResponseResult.from_dictionary)
    ...
    def get_account_verifications(self,
                                  ...
                                  page_number=None,
                                  page_limit=None):
        """Perform a GET request to /accountVerifications.

        Retrieve a list of all account verifications representing attempts to
        verify the ownership of a particular bank account by verifying a known
        deposit amount or credential.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for querying the accountVerifications resource to retrieve
