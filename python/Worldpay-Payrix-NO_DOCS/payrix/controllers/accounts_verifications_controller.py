...
from payrix.models.account_verifications_response_result import AccountVerificationsResponseResult
...
class AccountsVerificationsController(BaseController):
    ...
    def get_account_verifications_id(self,
                                     id,
                                     request_token=None):
        """Does a GET request to /accountVerifications/{id}.
    ...
    def get_account_verifications(self,
                                  ...
                                  page_number=None,
                                  page_limit=None):
        """Does a GET request to /accountVerifications.
