...
from payrix.models.invoice_parameters_response_result import (
    InvoiceParametersResponseResult,
)


class InvoiceParametersController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize InvoiceParametersController object."""
        super(InvoiceParametersController, self).__init__(config)

    def get_invoice_parameters_id(self,
                                  id,
                                  request_token=None):
        """Perform a GET request to /invoiceParameters/{id}.

        Query an invoice parameter that holds a certain configuration used for
        creating an invoice such as dba, address, and apikey.

        Args:
            id (str): The ID of this invoice parameter.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for retrieve invoice parameter response.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(InvoiceParametersResponseResult.from_dictionary)
    ...
    def put_invoice_parameters_id(self,
                                  ...
                                  body,
                                  request_token=None):
        """Perform a PUT request to /invoiceParameters/{id}.

        Update an invoice parameter.

        Args:
            id (str): The ID of this invoice parameter.
            body (InvoiceParametersPutRequest): Update Invoice Parameter
                Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for update on invoiceParameters resource: Update Invoice
                Parameter Response
    ...
    def delete_invoice_parameters_id(self,
                                     id,
                                     request_token=None):
        """Perform a DELETE request to /invoiceParameters/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for deleting an invoice parameter.
    ...
    def get_invoice_parameters(self,
                               ...
                               page_number=None,
                               page_limit=None):
        """Perform a GET request to /invoiceParameters.

        Query an invoice parameter resource that holds a certain configuration
        used for creating an invoice, including dba, address, and api key.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Invoice Parameters Response for query on invoiceParameters
                resource.
    ...
    def post_invoice_parameters(self,
                                body,
                                request_token=None):
        """Perform a POST request to /invoiceParameters.

        Create an Invoice Parameter that holds a certain configuration used
        for creating an invoice such as dba, address, and apikey.

        Args:
            body (InvoiceParametersPostRequest): Create Invoice Parameter
                Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on invoiceParameters resource
