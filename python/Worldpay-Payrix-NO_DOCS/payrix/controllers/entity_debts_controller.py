...
from payrix.models.entity_debts_response_result import (
    EntityDebtsResponseResult,
)


class EntityDebtsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize EntityDebtsController object."""
        super(EntityDebtsController, self).__init__(config)

    def get_entity_debts_id(self,
                            id,
                            request_token=None):
        """Perform a GET request to /entityDebts/{id}.

        Query an EntityDebt resource.

        Args:
            id (str): The ID of this entity debt.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                an Entity Debt Response for the query on entityDebts resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(EntityDebtsResponseResult.from_dictionary)
    ...
    def get_entity_debts(self,
                         ...
                         page_number=None,
                         page_limit=None):
        """Perform a GET request to /entityDebts.

        Query an EntityDebt resource, which represents a record of a debt
        between entities or an entity and the System.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Retrieve
                an Entity Debts Response for the query on entityDebts resource.
