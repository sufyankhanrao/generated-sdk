...
from payrix.models.merchant_platform_statuses_response_result import (
    MerchantPlatformStatusesResponseResult,
)


class MerchantPlatformStatusesController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize MerchantPlatformStatusesController object."""
        super(MerchantPlatformStatusesController, self).__init__(config)

    def get_merchant_platform_statuses_id(self,
                                          id,
                                          request_token=None):
        """Perform a GET request to /merchantPlatformStatuses/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Merchant Platform Statuses Response for query on
                merchantPlatformStatuses. resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .path("/merchantPlatformStatuses/{id}")
            ...
            .deserialize_into(MerchantPlatformStatusesResponseResult.from_dictionary)
    ...
    def get_merchant_platform_statuses(self,
                                       ...
                                       page_number=None,
                                       page_limit=None):
        """Perform a GET request to /merchantPlatformStatuses.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on merchantPlatformStatuses resource
