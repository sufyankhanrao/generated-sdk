...
from payrix.models.merchant_platform_statuses_response_result import MerchantPlatformStatusesResponseResult
...
class MerchantPlatformStatusesController(BaseController):
    ...
    def get_merchant_platform_statuses_id(self,
                                          id,
                                          request_token=None):
        """Does a GET request to /merchantPlatformStatuses/{id}.
    ...
    def get_merchant_platform_statuses(self,
                                       ...
                                       page_number=None,
                                       page_limit=None):
        """Does a GET request to /merchantPlatformStatuses.
