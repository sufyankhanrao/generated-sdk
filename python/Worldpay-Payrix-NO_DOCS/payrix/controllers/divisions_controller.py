...
from payrix.models.divisions_response_result import (
...
class DivisionsController(BaseController):
    ...
    def get_divisions_id(self,
                         id,
                         request_token=None):
        """Perform a GET request to /divisions/{id}.

        Query a Division.

        Args:
            id (str): The ID of this resource, The Division ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Division Response for query on divisions resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(DivisionsResponseResult.from_dictionary)
    ...
    def put_divisions_id(self,
                         ...
                         body,
                         request_token=None):
        """Perform a PUT request to /divisions/{id}.

        Update a Division.

        Args:
            id (str): The ID of this resource, The Division ID.
            body (DivisionsPutRequest): Update Division Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for update on divisions resource Update Division Response
    ...
    def get_divisions(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Retrieve
                Divisions Response for query on divisions resource.
    ...
    def post_divisions(self,
        ...
        Args:
            body (DivisionsPostRequest): Create Division Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Division Response for creating divisions.
