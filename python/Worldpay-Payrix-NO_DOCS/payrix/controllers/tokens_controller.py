...
from payrix.models.tokens_response_result import TokensResponseResult
...
class TokensController(BaseController):
    ...
    def put_tokens_id(self,
                      id,
                      body):
        """Does a PUT request to /tokens/{id}.
    ...
    def delete_tokens_id(self,
                         id,
                         request_token=None):
        """Does a DELETE request to /tokens/{id}.
