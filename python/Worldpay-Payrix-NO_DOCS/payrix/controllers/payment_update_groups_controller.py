...
from payrix.models.payment_update_groups_response_result import PaymentUpdateGroupsResponseResult
...
class PaymentUpdateGroupsController(BaseController):
    ...
    def get_payment_update_groups_id(self,
                                     id,
                                     request_token=None):
        """Does a GET request to /paymentUpdateGroups/{id}.
    ...
    def get_payment_update_groups(self,
                                  ...
                                  page_number=None,
                                  page_limit=None):
        """Does a GET request to /paymentUpdateGroups.
