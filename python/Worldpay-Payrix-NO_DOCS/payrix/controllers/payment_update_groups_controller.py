...
from payrix.models.payment_update_groups_response_result import (
    PaymentUpdateGroupsResponseResult,
)


class PaymentUpdateGroupsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize PaymentUpdateGroupsController object."""
        super(PaymentUpdateGroupsController, self).__init__(config)

    def get_payment_update_groups_id(self,
                                     id,
                                     request_token=None):
        """Perform a GET request to /paymentUpdateGroups/{id}.

        Query a Payment Update Group that has a collection of payment updates
        owned by the merchant's entity.

        Args:
            id (str): The ID of this payment update group.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for retrieve payment update group response.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(PaymentUpdateGroupsResponseResult.from_dictionary)
    ...
    def get_payment_update_groups(self,
                                  ...
                                  page_number=None,
                                  page_limit=None):
        """Perform a GET request to /paymentUpdateGroups.

        Query a PaymentUpdateGroup.
        A PaymentUpdateGroup has a collection of paymentUpdates owned by the
        merchant's entity.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on paymentUpdateGroups resource
