...
from payrix.models.safer_payments_response_result import (
    SaferPaymentsResponseResult,
)


class SaferPaymentsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize SaferPaymentsController object."""
        super(SaferPaymentsController, self).__init__(config)

    def get_safer_payments_id(self,
                              id):
        """Perform a GET request to /saferPayments/{id}.

        Query Safer Payment.

        Args:
            id (str): The ID of this resource, or the (unknown) ID associated
                with the Safer Payments.

        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for retrieve Safer Payment.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(SaferPaymentsResponseResult.from_dictionary)
    ...
    def put_safer_payments_id(self,
                              id,
                              body):
        """Perform a PUT request to /saferPayments/{id}.

        Update Safer Payment.

        Args:
            id (str): The ID of this resource, or the (unknown) ID associated
                with the Safer Payment.
            body (SaferPaymentsPutRequest): Update Safer Payment Request

        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. The
                response for update Safer Payment.
    ...
    def get_safer_payments(self,
                           ...
                           page_number=None,
                           page_limit=None):
        """Perform a GET request to /saferPayments.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on Safer Payments resource
    ...
    def post_safer_payments(self,
                            body):
        """Perform a POST request to /saferPayments.

        Create a Safer Payment.

        Args:
            body (SaferPaymentsPostRequest): Create Safer Payment Request

        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. The
                response create Safer Payment. resource.
