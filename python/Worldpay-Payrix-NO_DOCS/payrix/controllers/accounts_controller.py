...
from payrix.models.accounts_response_result import (
...
class AccountsController(BaseController):
    ...
    def get_accounts_id(self,
        ...
        Query an Account. An Account represents a bank account associated with
        an Entity.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on accounts resource
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(AccountsResponseResult.from_dictionary)
    ...
    def put_accounts_id(self,
                        ...
                        body,
                        request_token=None):
        """Perform a PUT request to /accounts/{id}.

        Update an existing Account representing a bank account associated with
        an Entity.

        Args:
            id (str): The ID of the Account associated with the Entity's bank
                account.
            body (AccountsPutRequest): A request body for updating existing
                bank account information for one or more entities.
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for update on accounts resource
    ...
    def delete_accounts_id(self,
                           id,
                           request_token=None):
        """Perform a DELETE request to /accounts/{id}.

        Delete an Account. An Account represents a bank account associated
        with an Entity.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for delete on accounts resource.
    ...
    def get_accounts(self,
        ...
        Query Accounts that each represent a bank account associated with an
        Entity.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for querying and retrieving all bank accounts.
    ...
    def post_accounts(self,
                      body,
                      request_token=None):
        """Perform a POST request to /accounts.

        Create an account, representing a bank account, to associate bank
        information with an Entity.

        Args:
            body (AccountsPostRequest): Add Bank Account Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                response for creating an account on the accounts resource.
                This is the Add Bank Account Response.
