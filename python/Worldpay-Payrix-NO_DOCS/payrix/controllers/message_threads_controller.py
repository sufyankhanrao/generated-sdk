...
from payrix.models.message_threads_response_result import MessageThreadsResponseResult
...
class MessageThreadsController(BaseController):
    ...
    def get_message_threads_id(self,
                               id,
                               request_token=None):
        """Does a GET request to /messageThreads/{id}.
    ...
    def put_message_threads_id(self,
                               ...
                               body,
                               request_token=None):
        """Does a PUT request to /messageThreads/{id}.
    ...
    def get_message_threads(self,
                            ...
                            page_number=None,
                            page_limit=None):
        """Does a GET request to /messageThreads.
