...
from payrix.models.message_threads_response_result import (
...
class MessageThreadsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize MessageThreadsController object."""
        super(MessageThreadsController, self).__init__(config)

    def get_message_threads_id(self,
                               id,
                               request_token=None):
        """Perform a GET request to /messageThreads/{id}.

        Query a Message Thread that represents the sender, receiver, and
        subject of the Messages resources.

        Args:
            id (str): The ID of this message thread.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Response for query on messageThreads resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(MessageThreadsResponseResult.from_dictionary)
    ...
    def put_message_threads_id(self,
                               ...
                               body,
                               request_token=None):
        """Perform a PUT request to /messageThreads/{id}.

        Update a Message Thread that represents the sender, receiver, and
        subject of the Messages resources.

        Args:
            id (str): The ID of this message thread.
            body (MessageThreadsPutRequest): Update Message Thread Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for update on Message Threads resource: Update Message Thread
                Response.
    ...
    def get_message_threads(self,
                            ...
                            page_number=None,
                            page_limit=None):
        """Perform a GET request to /messageThreads.

        Query a Message Threads resource that represents the sender, receiver,
        and subject of the Messages resources
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Retrieve
                the Response for query on messageThreads resource.
