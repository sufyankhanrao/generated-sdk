...
from payrix.models.bins_response_result import (
    BinsResponseResult,
)


class BinsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize BinsController object."""
        super(BinsController, self).__init__(config)

    def get_bins_id(self,
                    id,
                    request_token=None):
        """Perform a GET request to /bins/{id}.

        Query a BIN, which holds information about the issuer of a card.

        Args:
            id (str): The ID of this resource and The BIN ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                BIN Response for query on bins resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(BinsResponseResult.from_dictionary)
    ...
    def get_bins(self,
                 ...
                 page_number=None,
                 page_limit=None):
        """Perform a GET request to /bins.

        Querying a BIN resource, which holds information about the issuer of a
        card.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Retrieve
                the Response for query on BINS resource.
