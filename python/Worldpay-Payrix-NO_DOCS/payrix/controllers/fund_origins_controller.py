...
from payrix.models.fund_origins_response_result import (
    FundOriginsResponseResult,
)


class FundOriginsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize FundOriginsController object."""
        super(FundOriginsController, self).__init__(config)

    def get_fund_origins_id(self,
                            id,
                            request_token=None):
        """Perform a GET request to /fundOrigins/{id}.

        Query a Fund Origin.

        Args:
            id (str): The ID of this resource and The Fund Origin ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                the Fund Origin Response for query on fundOrigins resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(FundOriginsResponseResult.from_dictionary)
    ...
    def get_fund_origins(self,
                         ...
                         page_number=None,
                         page_limit=None):
        """Perform a GET request to /fundOrigins.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on fundOrigins resource
