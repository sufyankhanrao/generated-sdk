...
from payrix.models.payout_flows_response_result import (
    PayoutFlowsResponseResult,
)


class PayoutFlowsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize PayoutFlowsController object."""
        super(PayoutFlowsController, self).__init__(config)

    def get_payout_flows_id(self,
                            id,
                            request_token=None):
        """Perform a GET request to /payoutFlows/{id}.

        Query a payoutFlows resource.
        A payoutFlows resource represents a way to set up a Payouts resource
        automatically for an Entity or Org when it is boarded, or when a bank
        account is associated.
        You can set up the schedule and amount for the Payouts in the
        payoutFlows resource.

        Args:
            id (str): The ID of this payout flow.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                the Response for query on Payout Flows resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(PayoutFlowsResponseResult.from_dictionary)
    ...
    def put_payout_flows_id(self,
                            ...
                            body,
                            request_token=None):
        """Perform a PUT request to /payoutFlows/{id}.

        Update a payoutFlows resource that represents a way to set up a
        Payouts resource automatically for an Entity or Org when it is
        boarded, or when a bank account is associated, allowing you to set up
        the schedule and amount for the Payouts in the payoutFlows resource.

        Args:
            id (str): The ID of this payout flow.
            body (PayoutFlowsPutRequest): Update Payout Flow Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
    ...
    def delete_payout_flows_id(self,
                               id,
                               request_token=None):
        """Perform a DELETE request to /payoutFlows/{id}.

        Delete a payoutFlows resource that represents a way to set up a
        Payouts resource automatically for an Entity or Org when it is
        boarded, or when a bank account is associated, allowing you to set up
        the schedule and amount for the Payouts in the payoutFlows resource.
    ...
    def get_payout_flows(self,
                         ...
                         page_number=None,
                         page_limit=None):
        """Perform a GET request to /payoutFlows.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Retrieve
                Response for query on payoutFlows resource to get the Payout
                Flow ID.
    ...
    def post_payout_flows(self,
                          body,
                          request_token=None):
        """Perform a POST request to /payoutFlows.
        ...
        Args:
            body (PayoutFlowsPostRequest): Create Payout Flow Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on payoutFlows resource
