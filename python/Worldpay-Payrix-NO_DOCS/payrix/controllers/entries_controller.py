...
from payrix.models.entries_response_result import (
...
class EntriesController(BaseController):
    ...
    def __init__(self, config):
        """Initialize EntriesController object."""
        super(EntriesController, self).__init__(config)

    def get_entries_id(self,
                       id,
                       request_token=None):
        """Perform a GET request to /entries/{id}.

        Query an Entry resource.

        Args:
            id (str): The ID of this resource and The Entry ID.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(EntriesResponseResult.from_dictionary)
    ...
    def get_entries(self,
                    ...
                    page_number=None,
                    page_limit=None):
        """Perform a GET request to /entries.

        Query an Entry resource. An Entry resource represents a record of
        amounts moving in or out of the funds held by an Entity. This could be
        a time-based activity such as a weekly or monthly summary, or an
        event-based activity such as a Capture, a Payout, or a Fee. In the
        case of an event-based activity, the Entry contains references to the
        activity in the appropriate field.
