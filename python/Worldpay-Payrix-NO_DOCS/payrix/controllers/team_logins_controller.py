...
from payrix.models.team_login_response_result import (
    TeamLoginResponseResult,
)


class TeamLoginsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize TeamLoginsController object."""
        super(TeamLoginsController, self).__init__(config)

    def get_team_logins_id(self,
                           id,
                           request_token=None):
        """Perform a GET request to /teamLogins/{id}.

        Query a teamLogins or Team Login resource that represents the link
        between a Login and a Team as well as the Login's rights on the Team,
        where the Login resource identified in its 'login' field is considered
        part of the Team.

        Args:
            id (str): The ID of this team login.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                the Response for the query on the Team Logins resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(TeamLoginResponseResult.from_dictionary)
    ...
    def put_team_logins_id(self,
                           ...
                           body,
                           request_token=None):
        """Perform a PUT request to /teamLogins/{id}.

        Update a teamLogins or Team Login resource, representing the link
        between a Login and a Team as well as the Login's rights on the Team,
        where the Login resource identified in its 'login' field is considered
        part of the Team.

        Args:
            id (str): The ID of this team's login.
            body (TeamLoginPutRequest): Update Team Login Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for update on Team Login Update Team Login Response.
    ...
    def delete_team_logins_id(self,
                              id,
                              request_token=None):
        """Perform a DELETE request to /teamLogins/{id}.

        Delete a Team Login, which represents the link between a Login and a
        Team as well as the Login's rights on the Team, where the Login
        resource identified in its 'login' field is considered part of the
        Team.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for Delete Team Login Response.
    ...
    def get_team_logins(self,
                        ...
                        page_number=None,
                        page_limit=None):
        """Perform a GET request to /teamLogins.

        Query a teamLogins resource.
        A teamLogins resource represents the link between a Login and a Team
        as well as the Login's rights on the Team. The Login resource
        identified in its 'login' field is considered part of the Team.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on teamLogins resource
    ...
    def post_team_logins(self,
                         body,
                         request_token=None):
        """Perform a POST request to /teamLogins.
        ...
        Args:
            body (TeamLoginPostRequest): Create Team Login Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on teamLogins resource
