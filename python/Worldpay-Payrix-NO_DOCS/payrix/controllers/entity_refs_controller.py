...
from payrix.models.entity_refs_response_result import (
    EntityRefsResponseResult,
)


class EntityRefsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize EntityRefsController object."""
        super(EntityRefsController, self).__init__(config)

    def get_entity_refs_id(self,
                           id,
                           request_token=None):
        """Perform a GET request to /entityRefs/{id}.

        Query an EntityRefs resource that represents a reference code issued
        by the Processor that represents a particular Entity.

        Args:
            id (str): The ID of this entity reference.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                response for retrieving an Entity Reference.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(EntityRefsResponseResult.from_dictionary)
    ...
    def get_entity_refs(self,
                        ...
                        page_number=None,
                        page_limit=None):
        """Perform a GET request to /entityRefs.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for retrieve an Entity References response.
