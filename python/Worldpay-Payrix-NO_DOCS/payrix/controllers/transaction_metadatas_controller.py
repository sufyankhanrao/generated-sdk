...
from payrix.models.txn_meta_datas_response_result import TxnMetaDatasResponseResult
...
class TransactionMetadatasController(BaseController):
    ...
    def get_txn_metadatas_id(self,
                             id,
                             request_token=None):
        """Does a GET request to /txnMetadatas/{id}.
    ...
    def get_txn_metadatas(self,
                          ...
                          page_number=None,
                          page_limit=None):
        """Does a GET request to /txnMetadatas.
