...
from payrix.models.txn_meta_datas_response_result import (
    TxnMetaDatasResponseResult,
)


class TransactionMetadatasController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize TransactionMetadatasController object."""
        super(TransactionMetadatasController, self).__init__(config)

    def get_txn_metadatas_id(self,
                             id,
                             request_token=None):
        """Perform a GET request to /txnMetadatas/{id}.

        Query a txnMetadatas resource.
        A txnMetadatas resource represents data from an EMV Transaction and/or
        returned by the credit card network associated with a Transaction.

        Args:
            id (str): The ID of this resource and The TXN Metadatas ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on txnMetadatas resource
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(TxnMetaDatasResponseResult.from_dictionary)
    ...
    def get_txn_metadatas(self,
                          ...
                          page_number=None,
                          page_limit=None):
        """Perform a GET request to /txnMetadatas.
