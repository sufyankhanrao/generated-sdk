...
from payrix.models.disbursement_results_response_result import (
    DisbursementResultsResponseResult,
)


class DisbursementResultsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize DisbursementResultsController object."""
        super(DisbursementResultsController, self).__init__(config)

    def get_disbursement_results_id(self,
                                    id,
                                    request_token=None):
        """Perform a GET request to /disbursementResults/{id}.

        Query a Disbursement Result resource, representing a reference code
        issued by the Payout facilitator when a Disbursement is paid.

        Args:
            id (str): The ID of this disbursement result.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                the Response for the query on the disbursementResults resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(DisbursementResultsResponseResult.from_dictionary)
    ...
    def get_disbursement_results(self,
                                 ...
                                 page_number=None,
                                 page_limit=None):
        """Perform a GET request to /disbursementResults.

        Query Disbursement Result resources, each of which represents a
        reference code issued by the Payout facilitator when a Disbursement is
        paid.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Retrieve
                Response for query on disbursementResults resource.
