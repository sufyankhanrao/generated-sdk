...
from payrix.models.terminal_txns_response_result import (
    TerminalTxnsResponseResult,
)


class TerminalTransactionsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize TerminalTransactionsController object."""
        super(TerminalTransactionsController, self).__init__(config)

    def get_terminal_txns_by_id(self,
                                id,
                                request_token=None):
        """Perform a GET request to /terminalTxns/{id}.

        Query a TerminalTxn holds all of the information to a related final
        transaction, which they are used to be reconciled with that actual,
        final transaction.

        Args:
            id (str): The ID of this resource and The Terminal Transaction ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                the Response for query on terminalTxns resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(TerminalTxnsResponseResult.from_dictionary)
    ...
    def update_terminal_txns_by_id(self,
                                   ...
                                   body,
                                   request_token=None):
        """Perform a PUT request to /terminalTxns/{id}.

        Update a TerminalTxn holds all of the information to a related final
        transaction and is used to be reconciled with that actual, final
        transaction.

        Args:
            id (str): The ID of this resource and The Terminal Transaction ID.
            body (TerminalTxnsPutRequest): Update Terminal Transaction Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for update on Terminal Txns resource: Update Terminal
    ...
    def delete_terminal_txns_by_id(self,
                                   id,
                                   request_token=None):
        """Perform a DELETE request to /terminalTxns/{id}.

        Delete a TerminalTxn that holds all of the information to a related
        final transaction and is used to be reconciled with that actual, final
        transaction.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Terminal Transaction Response for terminalTxns resource.
    ...
    def get_terminal_txns(self,
                          ...
                          page_number=None,
                          page_limit=None):
        """Perform a GET request to /terminalTxns.

        Query a TerminalTxn, which holds all of the information to a related
        final transaction and is used to reconcile with the actual, final
        transaction.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on terminalTxns resource
    ...
    def post_terminal_txns(self,
                           body,
                           request_token=None):
        """Perform a POST request to /terminalTxns.

        Create a TerminalTxn.
        TerminalTxns hold all of the information to a related final
        transaction. They are used to be reconcilliated with that actual,
        final transaction.

        Args:
            body (TerminalTxnsPostRequest): Create Terminal Transaction Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on terminalTxns resource
