...
from payrix.models.tax_form_requests_response_result import TaxFormRequestsResponseResult
...
class TaxFormRequestsController(BaseController):
    ...
    def get_tax_form_requests_id(self,
                                 id,
                                 request_token=None):
        """Does a GET request to /taxFormRequests/{id}.
    ...
    def get_tax_form_requests(self,
                              ...
                              page_number=None,
                              page_limit=None):
        """Does a GET request to /taxFormRequests.
    ...
    def post_tax_form_requests(self,
                               body,
                               request_token=None):
        """Does a POST request to /taxFormRequests.
