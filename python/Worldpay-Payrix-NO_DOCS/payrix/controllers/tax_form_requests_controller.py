...
from payrix.models.tax_form_requests_response_result import (
    TaxFormRequestsResponseResult,
)


class TaxFormRequestsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize TaxFormRequestsController object."""
        super(TaxFormRequestsController, self).__init__(config)

    def get_tax_form_requests_id(self,
                                 id,
                                 request_token=None):
        """Perform a GET request to /taxFormRequests/{id}.

        Query a taxFormRequests.

        Args:
            id (str): The ID of this Tax Form Requests.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for retrieve Tax Form Requests response.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(TaxFormRequestsResponseResult.from_dictionary)
    ...
    def get_tax_form_requests(self,
                              ...
                              page_number=None,
                              page_limit=None):
        """Perform a GET request to /taxFormRequests.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on taxFormRequests resource
    ...
    def post_tax_form_requests(self,
                               body,
                               request_token=None):
        """Perform a POST request to /taxFormRequests.

        Create a Tax Form Requests

        Args:
            body (TaxFormRequestsPostRequest): Create Tax Form Requests
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on taxFormRequests resource
