...
from payrix.models.merchant_results_response_result import (
    MerchantResultsResponseResult,
)


class MerchantResultsController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize MerchantResultsController object."""
        super(MerchantResultsController, self).__init__(config)

    def get_merchant_results_id(self,
                                id,
                                request_token=None):
        """Perform a GET request to /merchantResults/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                Merchant Results Response for query on merchantResults
                resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(MerchantResultsResponseResult.from_dictionary)
    ...
    def get_merchant_results(self,
                             ...
                             page_number=None,
                             page_limit=None):
        """Perform a GET request to /merchantResults.

        Query a Merchant Result. A Merchant Reusult is a result created after
        a boarding attempt, it will contain important information related to
        the boarding and attempt.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on merchantResults resource
