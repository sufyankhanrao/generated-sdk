...
from payrix.models.merchant_results_response_result import MerchantResultsResponseResult
...
class MerchantResultsController(BaseController):
    ...
    def get_merchant_results_id(self,
                                id,
                                request_token=None):
        """Does a GET request to /merchantResults/{id}.
    ...
    def get_merchant_results(self,
                             ...
                             page_number=None,
                             page_limit=None):
        """Does a GET request to /merchantResults.
