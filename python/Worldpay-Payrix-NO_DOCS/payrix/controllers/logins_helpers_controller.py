...
from payrix.models.logins_helpers_response_result import (
    LoginsHelpersResponseResult,
)


class LoginsHelpersController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize LoginsHelpersController object."""
        super(LoginsHelpersController, self).__init__(config)

    def get_logins_helpers_id(self,
                              id,
                              request_token=None):
        """Perform a GET request to /loginsHelpers/{id}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for query on loginsHelpers resource
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(LoginsHelpersResponseResult.from_dictionary)
    ...
    def put_logins_helpers_id(self,
                              ...
                              body,
                              request_token=None):
        """Perform a PUT request to /loginsHelpers/{id}.

        Update a loginsHelper.

        Args:
            id (str): The ID of this resource.
            body (LoginsHelpersPutRequest): The request body parameter.
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for update on loginsHelpers resource
    ...
    def get_logins_helpers(self,
                           ...
                           page_number=None,
                           page_limit=None):
        """Perform a GET request to /loginsHelpers.
