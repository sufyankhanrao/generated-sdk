...
from payrix.models.logins_helpers_response_result import LoginsHelpersResponseResult
...
class LoginsHelpersController(BaseController):
    ...
    def get_logins_helpers_id(self,
                              id,
                              request_token=None):
        """Does a GET request to /loginsHelpers/{id}.
    ...
    def put_logins_helpers_id(self,
                              ...
                              body,
                              request_token=None):
        """Does a PUT request to /loginsHelpers/{id}.
    ...
    def get_logins_helpers(self,
                           ...
                           page_number=None,
                           page_limit=None):
        """Does a GET request to /loginsHelpers.
