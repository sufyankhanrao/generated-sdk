...
from payrix.models.profit_share_rules_response_result import (
    ProfitShareRulesResponseResult,
)


class ProfitShareRulesController(BaseController):
    """A Controller to access Endpoints in the payrix API."""

    def __init__(self, config):
        """Initialize ProfitShareRulesController object."""
        super(ProfitShareRulesController, self).__init__(config)

    def get_profit_share_rules_id(self,
                                  id,
                                  request_token=None):
        """Perform a GET request to /profitShareRules/{id}.

        Query a ProfitShare Rule, which is a piece of conditional logic that
        makes a ProfitShare apply only in certain circumstances.

        Args:
            id (str): The ID of this resource and The Profit Share Rule ID.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                the Response for query on Profit Share Rules resource.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(ProfitShareRulesResponseResult.from_dictionary)
    ...
    def put_profit_share_rules_id(self,
                                  ...
                                  body,
                                  request_token=None):
        """Perform a PUT request to /profitShareRules/{id}.

        Update a ProfitShare Rule, which is a piece of conditional logic that
        makes a ProfitShare apply only in certain circumstances.

        Args:
            id (str): The ID of this resource and The Profit Share Rule ID.
            body (ProfitShareRulesPutRequest): Update Profit Share Rule Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
                first request is processed. Valid values can contain 1-100
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                for update on profitShareRules resource: Update Profit Share
                Rule Response
    ...
    def delete_profit_share_rules_id(self,
                                     id,
                                     request_token=None):
        """Perform a DELETE request to /profitShareRules/{id}.

        Delete a ProfitShare Rule, which is a piece of conditional logic that
        makes a ProfitShare apply only in certain circumstances.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                ...
                response for deleting a profit share rule.
...
Details: None.
    ...
    def get_profit_share_rules(self,
                               ...
                               page_number=None,
                               page_limit=None):
        """Perform a GET request to /profitShareRules.

        Query a ProfitShare Rule.
        A ProfitShare Rule is a piece of conditional logic that makes a
        ProfitShare apply only in certain circumstances.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for query on profitShareRules resource
    ...
    def post_profit_share_rules(self,
                                body,
                                request_token=None):
        """Perform a POST request to /profitShareRules.
        ...
        Args:
            body (ProfitShareRulesPostRequest): Create Profit Share Rule
                Request
            request_token (str, optional): A custom, one-time identifier for
                any API request (GET, PUT, POST, or DELETE). Blocks future
                requests with the same token for 48 hours, ensuring only the
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. Response
                for create on profitShareRules resource
