...
# Statement Entries Response Item

## Structure

`StatementEntriesResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[StatementEntriesResponse]`](../../doc/models/statement-entries-response.md) | Optional | The data object that the API returns for this request. |
