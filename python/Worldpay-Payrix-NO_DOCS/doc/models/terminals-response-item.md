...
# Terminals Response Item

## Structure

`TerminalsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[TerminalsResponse]`](../../doc/models/terminals-response.md) | Optional | The data object that the API returns for this request. |
