...
# Orgs VAS Revenue Boosts Response Item
...
|  --- | --- | --- | --- |
| `data` | [`List[OrgsVASRevenueBoostsResponse]`](../../doc/models/orgs-vas-revenue-boosts-response.md) | Optional | The data object that the API returns for this request. |
