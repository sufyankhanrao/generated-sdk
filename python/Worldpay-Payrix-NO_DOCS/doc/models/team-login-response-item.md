...
# Team Login Response Item

## Structure

`TeamLoginResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[TeamLoginResponse]`](../../doc/models/team-login-response.md) | Optional | The data object that the API returns for this request. |
