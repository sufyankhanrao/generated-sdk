...
# Pinless Debit Conversions Response Item

## Structure

`PinlessDebitConversionsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[PinlessDebitConversionsResponse]`](../../doc/models/pinless-debit-conversions-response.md) | Optional | The data object that the API returns for this request. |
