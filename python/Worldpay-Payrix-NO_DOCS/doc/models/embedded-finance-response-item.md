...
# Embedded Finance Response Item

## Structure

`EmbeddedFinanceResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[DivisionsResponse2]`](../../doc/models/divisions-response-2.md) | Optional | The data object that the API returns for this request. |
