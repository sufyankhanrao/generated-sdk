...
# Invoice Results Response Item

## Structure

`InvoiceResultsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[InvoiceResultResponse]`](../../doc/models/invoice-result-response.md) | Optional | The data object that the API returns for this request. |
