...
# Chargeback Statuses Response Item

## Structure

`ChargebackStatusesResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[ChargebackStatusesResponse]`](../../doc/models/chargeback-statuses-response.md) | Optional | The data object that the API returns for this request. |
