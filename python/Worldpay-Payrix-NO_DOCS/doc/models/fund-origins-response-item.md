...
# Fund Origins Response Item

## Structure

`FundOriginsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[FundOriginsResponse]`](../../doc/models/fund-origins-response.md) | Optional | The data object that the API returns for this request. |
