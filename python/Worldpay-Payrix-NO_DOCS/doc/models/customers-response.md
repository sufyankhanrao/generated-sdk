...
| `login` | `str` | Optional | The ID of the Login that owns this resource. |
...
| `auth_token_customer` | `str` | Optional | The customer reference from the authToken used for user authentication, if available. |
