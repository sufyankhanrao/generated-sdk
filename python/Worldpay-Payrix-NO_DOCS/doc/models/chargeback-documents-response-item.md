...
# Chargeback Documents Response Item

## Structure

`ChargebackDocumentsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[ChargebackDocumentsResponse]`](../../doc/models/chargeback-documents-response.md) | Optional | The data object that the API returns for this request. |
