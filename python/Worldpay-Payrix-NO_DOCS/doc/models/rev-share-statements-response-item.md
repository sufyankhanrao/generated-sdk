...
# Rev Share Statements Response Item

## Structure

`RevShareStatementsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[RevShareStatmentsResponse]`](../../doc/models/rev-share-statments-response.md) | Optional | The data object that the API returns for this request. |
