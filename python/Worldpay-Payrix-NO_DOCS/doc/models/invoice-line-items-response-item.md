...
# Invoice Line Items Response Item

## Structure

`InvoiceLineItemsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[InvoiceLineItemsResponse]`](../../doc/models/invoice-line-items-response.md) | Optional | The data object that the API returns for this request. |
