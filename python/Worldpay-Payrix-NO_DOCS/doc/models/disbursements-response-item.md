...
# Disbursements Response Item

## Structure

`DisbursementsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[DisbursementsResponse]`](../../doc/models/disbursements-response.md) | Optional | The data object that the API returns for this request. |
