...
# Entity Datas Response Item

## Structure

`EntityDatasResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[EntityDataResponse]`](../../doc/models/entity-data-response.md) | Optional | The data object that the API returns for this request. |
