...
# Entity Reserves Response Item

## Structure

`EntityReservesResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[EntityReservesResponse]`](../../doc/models/entity-reserves-response.md) | Optional | The data object that the API returns for this request. |
