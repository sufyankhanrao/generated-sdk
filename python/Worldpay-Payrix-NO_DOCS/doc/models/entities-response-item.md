...
# Entities Response Item

## Structure

`EntitiesResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[EntitiesResponse]`](../../doc/models/entities-response.md) | Optional | The data object that the API returns for this request. |
