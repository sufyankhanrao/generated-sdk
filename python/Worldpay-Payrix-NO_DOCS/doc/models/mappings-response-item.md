...
# Mappings Response Item

## Structure

`MappingsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[MappingsResponse]`](../../doc/models/mappings-response.md) | Optional | The data object that the API returns for this request. |
