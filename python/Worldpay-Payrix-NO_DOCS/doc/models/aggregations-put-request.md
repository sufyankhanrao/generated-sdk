...
# Aggregations Put Request

## Structure

`AggregationsPutRequest`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `login` | `str` | Optional | The identifier of the Login that owns this Aggregation. |
...
| `level` | [`LevelEnum`](../../doc/models/level-enum.md) | Optional | The level of user that this aggregation will run for.<br><br><details><br><summary>Valid Values</summary><br>- `admin` - **Admin User.**<br>- `division` - **Division-level User.**<br>- `merchant` - **Merchant-level User.**<br>- `partition` - **Partition-level User.**<br></details><br> |
...
| `totals` | `str` | Optional | The specification of the desired aggregation functions including count, sum, min and max. This field is stored as a text string and must be between 1 and 100 characters long. |
