...
# Disbursement Entries Response Item

## Structure

`DisbursementEntriesResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[DisbursementEntriesResponse]`](../../doc/models/disbursement-entries-response.md) | Optional | The data object that the API returns for this request. |
