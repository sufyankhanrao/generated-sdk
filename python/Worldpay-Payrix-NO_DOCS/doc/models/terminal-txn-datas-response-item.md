...
# Terminal Txn Datas Response Item
...
|  --- | --- | --- | --- |
| `data` | [`List[TerminalTxnsDatasResponse]`](../../doc/models/terminal-txns-datas-response.md) | Optional | The data object that the API returns for this request. |
