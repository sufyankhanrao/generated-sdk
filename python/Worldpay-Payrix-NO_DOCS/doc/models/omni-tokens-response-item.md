...
# Omni Tokens Response Item

## Structure

`OmniTokensResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[OmniTokensResponse]`](../../doc/models/omni-tokens-response.md) | Optional | The data object that the API returns for this request. |
