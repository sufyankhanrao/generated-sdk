...
# Terminal Txn Metadatas Response Item

## Structure

`TerminalTxnMetadatasResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[TerminalTxnsMetadatasResponse]`](../../doc/models/terminal-txns-metadatas-response.md) | Optional | The data object that the API returns for this request. |
