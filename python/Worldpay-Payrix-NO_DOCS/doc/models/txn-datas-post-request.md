...
|  --- | --- | --- | --- |
| `txn` | `str` | Required | The identifier of the Transaction associated with this TxnDatas resource. |
| `signature` | `str` | Required | The Base64 encoded image of the signature captured at the time of entering the Transaction. |
