...
# Apple Domains Response Item

## Structure

`AppleDomainsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[AppleDomainsResponse]`](../../doc/models/apple-domains-response.md) | Optional | The data object that the API returns for this request. |
