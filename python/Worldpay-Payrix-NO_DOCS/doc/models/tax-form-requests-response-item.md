...
# Tax Form Requests Response Item

## Structure

`TaxFormRequestsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[TaxFormRequestsResponse]`](../../doc/models/tax-form-requests-response.md) | Optional | The data object that the API returns for this request. |
