...
# Terminal Txns Response Item

## Structure

`TerminalTxnsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[TerminalTxnsResponse]`](../../doc/models/terminal-txns-response.md) | Optional | The data object that the API returns for this request. |
