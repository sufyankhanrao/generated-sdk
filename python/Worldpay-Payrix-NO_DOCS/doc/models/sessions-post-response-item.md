...
# Sessions Post Response Item

## Structure

`SessionsPostResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[SessionPostResponse]`](../../doc/models/session-post-response.md) | Optional | The data object that the API returns for this request. |
