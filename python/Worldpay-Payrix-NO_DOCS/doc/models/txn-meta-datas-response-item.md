...
# Txn Meta Datas Response Item

## Structure

`TxnMetaDatasResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[TxnMetadatasResponse]`](../../doc/models/txn-metadatas-response.md) | Optional | The data object that the API returns for this request. |
