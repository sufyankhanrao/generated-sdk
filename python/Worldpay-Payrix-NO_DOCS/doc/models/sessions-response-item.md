...
# Sessions Response Item

## Structure

`SessionsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[SessionResponse]`](../../doc/models/session-response.md) | Optional | The data object that the API returns for this request. |
