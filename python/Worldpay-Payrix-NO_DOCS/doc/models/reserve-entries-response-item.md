...
# Reserve Entries Response Item

## Structure

`ReserveEntriesResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[ReserveEntriesResponse]`](../../doc/models/reserve-entries-response.md) | Optional | The data object that the API returns for this request. |
