...
# Alert Actions Response Item

## Structure

`AlertActionsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[AlertActionsResponse]`](../../doc/models/alert-actions-response.md) | Optional | The data object that the API returns for this request. |
