...
# Entry Origins Response Item

## Structure

`EntryOriginsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[EntryOriginsResponse]`](../../doc/models/entry-origins-response.md) | Optional | The data object that the API returns for this request. |
