...
# Reserves Response Item

## Structure

`ReservesResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[ReservesResponse]`](../../doc/models/reserves-response.md) | Optional | The data object that the API returns for this request. |
