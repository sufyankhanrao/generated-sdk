...
# Logins Helpers Response Item

## Structure

`LoginsHelpersResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[LoginHelpersResponse]`](../../doc/models/login-helpers-response.md) | Optional | The data object that the API returns for this request. |
