...
# Message Threads Response Item

## Structure

`MessageThreadsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[MessageThreadsResponse]`](../../doc/models/message-threads-response.md) | Optional | The data object that the API returns for this request. |
