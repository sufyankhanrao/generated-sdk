...
# Payout Flows Response Item

## Structure

`PayoutFlowsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[PayoutFlowsResponse]`](../../doc/models/payout-flows-response.md) | Optional | The data object that the API returns for this request. |
