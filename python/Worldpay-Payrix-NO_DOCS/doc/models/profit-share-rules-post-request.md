...
# Profit Share Rules Post Request
...
|  --- | --- | --- | --- |
| `profit_share` | `str` | Required | The identifier of the ProfitShare that this ProfitShare Rule applies to. |
