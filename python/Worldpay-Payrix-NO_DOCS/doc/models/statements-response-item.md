...
# Statements Response Item

## Structure

`StatementsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[StatementsResponse]`](../../doc/models/statements-response.md) | Optional | The data object that the API returns for this request. |
