...
# Invoices Response Item

## Structure

`InvoicesResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[InvoicesResponse]`](../../doc/models/invoices-response.md) | Optional | The data object that the API returns for this request. |
