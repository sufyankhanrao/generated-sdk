...
# Alert Triggers Response Item

## Structure

`AlertTriggersResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[AlertTriggersResponse]`](../../doc/models/alert-triggers-response.md) | Optional | The data object that the API returns for this request. |
