...
# Vas Efe Offers Response Item

## Structure

`VasEfeOffersResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[VasEfeOffersResponse]`](../../doc/models/vas-efe-offers-response.md) | Optional | The data object that the API returns for this request. |
