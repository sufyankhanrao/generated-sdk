...
# Org Entities Response Item

## Structure

`OrgEntitiesResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[OrgEntitiesResponse]`](../../doc/models/org-entities-response.md) | Optional | The data object that the API returns for this request. |
