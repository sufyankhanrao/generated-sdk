...
# Decision Actions Response Item

## Structure

`DecisionActionsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[DecisionActionsResponse]`](../../doc/models/decision-actions-response.md) | Optional | The data object that the API returns for this request. |
