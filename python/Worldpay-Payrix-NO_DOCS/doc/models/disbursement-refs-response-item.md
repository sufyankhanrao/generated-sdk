...
# Disbursement Refs Response Item

## Structure

`DisbursementRefsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[DisbursementRefsResponse]`](../../doc/models/disbursement-refs-response.md) | Optional | The data object that the API returns for this request. |
