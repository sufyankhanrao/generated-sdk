...
# Orgs VAS Safer Payments Response Item

## Structure

`OrgsVASSaferPaymentsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[OrgsVASSaferPaymentsResponse]`](../../doc/models/orgs-vas-safer-payments-response.md) | Optional | The data object that the API returns for this request. |
