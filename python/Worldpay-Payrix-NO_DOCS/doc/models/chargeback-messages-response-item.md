...
# Chargeback Messages Response Item

## Structure

`ChargebackMessagesResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[ChargebackMessageResponse]`](../../doc/models/chargeback-message-response.md) | Optional | The data object that the API returns for this request. |
