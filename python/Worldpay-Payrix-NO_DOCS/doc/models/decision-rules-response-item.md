...
# Decision Rules Response Item

## Structure

`DecisionRulesResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[DecisionRulesResponse]`](../../doc/models/decision-rules-response.md) | Optional | The data object that the API returns for this request. |
