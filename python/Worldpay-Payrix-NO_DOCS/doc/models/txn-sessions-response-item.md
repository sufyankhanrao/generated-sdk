...
# Txn Sessions Response Item

## Structure

`TxnSessionsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[TxnSessionsResponse]`](../../doc/models/txn-sessions-response.md) | Optional | The data object that the API returns for this request. |
