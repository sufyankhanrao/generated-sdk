...
# Entity Returns Response Item

## Structure

`EntityReturnsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[EntityReturnsResponse]`](../../doc/models/entity-returns-response.md) | Optional | The data object that the API returns for this request. |
