...
| `address_1` | `str` | Required | The first line of the address associated with this Entity.<br>This field is stored as a string and must be between 1 and 500 characters long. |
...
| `email` | `str` | Required | The email address associated with this Entity.<br>This field is stored as a text string and must be between 1 and 100 characters long. |
...
| `ein` | `str` | Required | The IRS Employer Identification Number (EIN) for the Entity.<br>This field is stored as an integer and must be 9 characters long. |
| `locations` | `int` | Required | The number of locations at which this Entity does business.<br>This field is stored as an integer and must be between 1 and 1,000,000 characters long.<br><br>**Default**: `1` |
| `public` | [`EntitiesPublicEnum`](../../doc/models/entities-public-enum.md) | Required | Indicates whether this is a publicly held entity.<br><br><details><br><summary>Valid Values</summary><br>- `0` - **Private entity**<br>- `1` - **Public entity**<br></details><br>**Default**: `0`<br> |
...
| `global_business_id` | `str` | Required | The business registration number for the entity.<br>This field is stored as an alphanumeric and must be between 9 to 10 characters long |
| `accounts` | [`List[AccountsPostRequest]`](../../doc/models/accounts-post-request.md) | Optional | - |
...
| `contacts` | [`List[ContactsPostRequest]`](../../doc/models/contacts-post-request.md) | Optional | - |
| `credentials` | [`List[CredentialsPostRequest]`](../../doc/models/credentials-post-request.md) | Optional | - |
| `embedded_finance` | [`List[EmbeddedFinancePostRequest]`](../../doc/models/embedded-finance-post-request.md) | Optional | - |
| `entity_custom_fields` | [`List[EntityCustomFieldsPostRequest]`](../../doc/models/entity-custom-fields-post-request.md) | Optional | - |
| `entity_data` | [`List[EntityDataPostRequest]`](../../doc/models/entity-data-post-request.md) | Optional | - |
| `entity_refs` | [`List[EntityRefsPostRequest]`](../../doc/models/entity-refs-post-request.md) | Optional | - |
| `entity_routes` | [`List[EntityRoutesPostRequest]`](../../doc/models/entity-routes-post-request.md) | Optional | - |
| `entity_terms` | [`List[EntityTermsPostRequest]`](../../doc/models/entity-terms-post-request.md) | Optional | - |
| `org_entities` | [`List[OrgEntitiesPostRequest]`](../../doc/models/org-entities-post-request.md) | Optional | - |
| `omni_tokens` | [`List[OmniTokensPostRequest]`](../../doc/models/omni-tokens-post-request.md) | Optional | - |
| `forentity_profit_shares` | [`List[ProfitSharesPostRequest]`](../../doc/models/profit-shares-post-request.md) | Optional | - |
| `holds` | [`List[HoldsPostRequest]`](../../doc/models/holds-post-request.md) | Optional | - |
...
| `revenue_boosts` | [`List[RevenueBoostsPostRequest]`](../../doc/models/revenue-boosts-post-request.md) | Optional | - |
| `vendor` | [`VendorsPostRequest`](../../doc/models/vendors-post-request.md) | Optional | - |
| `fees` | [`List[FeesPostRequest]`](../../doc/models/fees-post-request.md) | Optional | - |
| `forentity_fees` | [`List[FeesPostRequest]`](../../doc/models/fees-post-request.md) | Optional | - |
| `safer_payments` | [`List[SaferPaymentsPostRequest]`](../../doc/models/safer-payments-post-request.md) | Optional | - |
