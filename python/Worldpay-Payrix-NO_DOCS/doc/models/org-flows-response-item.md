...
# Org Flows Response Item

## Structure

`OrgFlowsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[OrgFlowsResponse]`](../../doc/models/org-flows-response.md) | Optional | The data object that the API returns for this request. |
