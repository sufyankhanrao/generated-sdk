...
# Aggregation Results Response Item

## Structure

`AggregationResultsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[AggregationResultsResponse]`](../../doc/models/aggregation-results-response.md) | Optional | The data object that the API returns for this request. |
