...
# Payment Update Groups Response Item

## Structure

`PaymentUpdateGroupsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[PaymentUpdateGroupsResponse]`](../../doc/models/payment-update-groups-response.md) | Optional | The data object that the API returns for this request. |
