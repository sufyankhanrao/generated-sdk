...
# Merchants Response Item

## Structure

`MerchantsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[MerchantsResponse]`](../../doc/models/merchants-response.md) | Optional | The data object that the API returns for this request. |
