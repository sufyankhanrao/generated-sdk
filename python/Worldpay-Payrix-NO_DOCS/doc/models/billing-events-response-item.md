...
# Billing Events Response Item

## Structure

`BillingEventsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[BillingEventsResponse]`](../../doc/models/billing-events-response.md) | Optional | The data object that the API returns for this request. |
