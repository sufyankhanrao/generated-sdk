...
# Token Results Response Item

## Structure

`TokenResultsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[TokenResultsResponse]`](../../doc/models/token-results-response.md) | Optional | The data object that the API returns for this request. |
