...
| `deduct_from_balance` | [`DeductFromBalanceEnum`](../../doc/models/deduct-from-balance-enum.md) | Required | Whether to deduct the billing amount from the entity's account balance.<br><br><details><br><summary>Valid Values</summary><br>- `0` - **Do not deduct from balance.**<br>- `1` - **Deduct from balance.**<br></details><br>**Default**: `0`<br> |
