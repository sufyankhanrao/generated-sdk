...
# Chargebacks Response Item

## Structure

`ChargebacksResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[ChargebacksResponse]`](../../doc/models/chargebacks-response.md) | Optional | The data object that the API returns for this request. |
