...
# Rev Share Schedules Response Item
...
|  --- | --- | --- | --- |
| `data` | [`List[RevShareSchedulesResponse]`](../../doc/models/rev-share-schedules-response.md) | Optional | The data object that the API returns for this request. |
