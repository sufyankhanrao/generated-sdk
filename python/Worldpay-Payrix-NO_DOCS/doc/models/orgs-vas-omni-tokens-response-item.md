...
# Orgs VAS Omni Tokens Response Item

## Structure

`OrgsVASOmniTokensResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[OrgsVASOmniTokensResponse]`](../../doc/models/orgs-vas-omni-tokens-response.md) | Optional | The data object that the API returns for this request. |
