...
# Org Flow Actions Response Item

## Structure

`OrgFlowActionsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[OrgFlowActionsResponse]`](../../doc/models/org-flow-actions-response.md) | Optional | The data object that the API returns for this request. |
