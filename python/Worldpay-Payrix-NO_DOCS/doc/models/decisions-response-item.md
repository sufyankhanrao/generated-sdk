...
# Decisions Response Item

## Structure

`DecisionsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[DecisionsResponse]`](../../doc/models/decisions-response.md) | Optional | The data object that the API returns for this request. |
