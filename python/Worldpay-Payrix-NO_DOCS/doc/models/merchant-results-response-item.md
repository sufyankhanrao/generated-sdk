...
# Merchant Results Response Item

## Structure

`MerchantResultsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[MerchantResultsResponse]`](../../doc/models/merchant-results-response.md) | Optional | The data object that the API returns for this request. |
