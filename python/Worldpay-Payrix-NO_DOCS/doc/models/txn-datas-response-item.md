...
# Txn Datas Response Item

## Structure

`TxnDatasResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[TxnsDatasResponse]`](../../doc/models/txns-datas-response.md) | Optional | The data object that the API returns for this request. |
