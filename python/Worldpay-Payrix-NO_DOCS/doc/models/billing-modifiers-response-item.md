...
# Billing Modifiers Response Item

## Structure

`BillingModifiersResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[BillingModifiersResponse]`](../../doc/models/billing-modifiers-response.md) | Optional | The data object that the API returns for this request. |
