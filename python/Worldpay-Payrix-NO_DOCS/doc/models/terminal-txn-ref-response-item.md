...
# Terminal Txn Ref Response Item

## Structure

`TerminalTxnRefResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[TerminalTxnRefsResponse]`](../../doc/models/terminal-txn-refs-response.md) | Optional | The data object that the API returns for this request. |
