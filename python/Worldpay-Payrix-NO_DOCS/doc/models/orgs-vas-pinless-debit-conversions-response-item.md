...
# Orgs VAS Pinless Debit Conversions Response Item

## Structure

`OrgsVASPinlessDebitConversionsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[OrgsVASPinlessDebitConversionsResponse]`](../../doc/models/orgs-vas-pinless-debit-conversions-response.md) | Optional | The data object that the API returns for this request. |
