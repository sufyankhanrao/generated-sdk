...
# Fee Rules Response Item

## Structure

`FeeRulesResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[FeeRulesResponse]`](../../doc/models/fee-rules-response.md) | Optional | The data object that the API returns for this request. |
