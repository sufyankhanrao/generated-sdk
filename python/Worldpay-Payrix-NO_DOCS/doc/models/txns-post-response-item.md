...
# Txns Post Response Item

## Structure

`TxnsPostResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[TxnsPostResponse]`](../../doc/models/txns-post-response.md) | Optional | The data object that the API returns for this request. |
