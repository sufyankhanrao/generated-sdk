...
# Confirm Codes Response Item

## Structure

`ConfirmCodesResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[ConfirmCodesResponse]`](../../doc/models/confirm-codes-response.md) | Optional | The data object that the API returns for this request. |
