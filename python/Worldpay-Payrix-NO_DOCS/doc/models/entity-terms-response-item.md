...
# Entity Terms Response Item

## Structure

`EntityTermsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[EntityTermsResponse]`](../../doc/models/entity-terms-response.md) | Optional | The data object that the API returns for this request. |
