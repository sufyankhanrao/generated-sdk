...
# Auth Tokens Response Item

## Structure

`AuthTokensResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[AuthTokensResponse]`](../../doc/models/auth-tokens-response.md) | Optional | The data object that the API returns for this request. |
