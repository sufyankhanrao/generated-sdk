...
# Billing Modifiers Post Request

## Structure

`BillingModifiersPostRequest`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `billing` | `str` | Required | The identifier of the Billing that this Billing Modifier applies to. |
...
| `fromentity` | `str` | Required | The identifier of the Entity that is responsible for paying this Bill on behalf of the Entity specified in the 'entity' field. |
