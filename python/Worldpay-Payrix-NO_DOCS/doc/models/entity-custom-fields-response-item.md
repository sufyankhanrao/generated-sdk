...
# Entity Custom Fields Response Item

## Structure

`EntityCustomFieldsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[EntityCustomFieldsResponse]`](../../doc/models/entity-custom-fields-response.md) | Optional | The data object that the API returns for this request. |
