...
# Adjustments Response Item

## Structure

`AdjustmentsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[AdjustmentsResponse]`](../../doc/models/adjustments-response.md) | Optional | The data object that the API returns for this request. |
