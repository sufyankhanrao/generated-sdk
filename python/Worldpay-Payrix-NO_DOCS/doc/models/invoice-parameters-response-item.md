...
# Invoice Parameters Response Item

## Structure

`InvoiceParametersResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[InvoiceParametersResponse]`](../../doc/models/invoice-parameters-response.md) | Optional | The data object that the API returns for this request. |
