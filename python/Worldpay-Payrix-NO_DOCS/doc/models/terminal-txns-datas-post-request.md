...
# Terminal Txns Datas Post Request
...
|  --- | --- | --- | --- |
| `terminal_txn` | `str` | Required | The identifier of the TerminalTxn associated with this TerminalTxnDatas resource. |
| `signature` | `str` | Required | The Base64 encoded image of the signature captured at the time of entering the TerminalTxn. |
