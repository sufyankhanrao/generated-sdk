...
# Chargeback Message Results Response Item

## Structure

`ChargebackMessageResultsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[ChargebackMessageResultResponse]`](../../doc/models/chargeback-message-result-response.md) | Optional | The data object that the API returns for this request. |
