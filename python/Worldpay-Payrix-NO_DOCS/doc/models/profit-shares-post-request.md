...
|  --- | --- | --- | --- |
| `login` | `str` | Required | The identifier of the Login that owns this ProfitShare. |
| `entity` | `str` | Required | The identifier of the Entity that this ProfitShare refers to. This is the entity that will receive the split income/expense. |
...
| `amount` | `int` | Required | The percentage to be shared.<br>This field is specified as an integer between 1 and 10000.<br>Percentages are calculated over the income/expense amount. |
