...
# Decision Rules Post Request

## Structure

`DecisionRulesPostRequest`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `decision` | `str` | Required | The identifier of the Decision that this Decision Rule applies. |
