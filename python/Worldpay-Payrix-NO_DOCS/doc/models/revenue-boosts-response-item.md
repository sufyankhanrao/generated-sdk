...
|  --- | --- | --- | --- |
| `data` | [`List[RevenueBoostsResponse]`](../../doc/models/revenue-boosts-response.md) | Optional | The data object that the API returns for this request. |
