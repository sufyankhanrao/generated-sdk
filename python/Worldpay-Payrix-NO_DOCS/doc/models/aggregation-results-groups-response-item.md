...
# Aggregation Results Groups Response Item

## Structure

`AggregationResultsGroupsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[AggregationResultGroupsResponse]`](../../doc/models/aggregation-result-groups-response.md) | Optional | The data object that the API returns for this request. |
