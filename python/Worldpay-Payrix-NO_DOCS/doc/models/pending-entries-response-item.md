...
# Pending Entries Response Item

## Structure

`PendingEntriesResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[PendingEntriesResponse]`](../../doc/models/pending-entries-response.md) | Optional | The data object that the API returns for this request. |
