...
# Disbursement Results Response Item

## Structure

`DisbursementResultsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[DisbursementResultsResponse]`](../../doc/models/disbursement-results-response.md) | Optional | The data object that the API returns for this request. |
