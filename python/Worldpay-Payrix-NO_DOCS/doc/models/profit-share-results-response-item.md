...
# Profit Share Results Response Item

## Structure

`ProfitShareResultsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[ProfitShareResultsResponse]`](../../doc/models/profit-share-results-response.md) | Optional | The data object that the API returns for this request. |
