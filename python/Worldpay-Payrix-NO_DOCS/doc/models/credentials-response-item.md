...
|  --- | --- | --- | --- |
| `data` | [`List[CredentialsResponse]`](../../doc/models/credentials-response.md) | Optional | The data object that the API returns for this request. |
