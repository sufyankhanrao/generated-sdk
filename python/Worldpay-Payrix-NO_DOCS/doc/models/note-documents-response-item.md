...
# Note Documents Response Item

## Structure

`NoteDocumentsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[NoteDocumentsResponse]`](../../doc/models/note-documents-response.md) | Optional | The data object that the API returns for this request. |
