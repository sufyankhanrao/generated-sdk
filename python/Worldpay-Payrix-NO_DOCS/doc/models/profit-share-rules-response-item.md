...
# Profit Share Rules Response Item

## Structure

`ProfitShareRulesResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[ProfitShareRulesResponse]`](../../doc/models/profit-share-rules-response.md) | Optional | The data object that the API returns for this request. |
