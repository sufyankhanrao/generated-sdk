...
| `document_source` | [`DocumentSourceEnum`](../../doc/models/document-source-enum.md) | Optional | The source of the document. <details> <summary>Valid Values</summary><br><br>- `merchant` - **Merchant.**<br>- `issuer` - **Issuer.**<br><br></details><br> |
