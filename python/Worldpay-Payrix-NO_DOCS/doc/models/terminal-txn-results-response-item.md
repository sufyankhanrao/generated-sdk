...
# Terminal Txn Results Response Item

## Structure

`TerminalTxnResultsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[TerminalTxnResultsResponse]`](../../doc/models/terminal-txn-results-response.md) | Optional | The data object that the API returns for this request. |
