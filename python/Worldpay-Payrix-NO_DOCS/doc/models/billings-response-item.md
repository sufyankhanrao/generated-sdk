...
# Billings Response Item

## Structure

`BillingsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[BillingsResponse]`](../../doc/models/billings-response.md) | Optional | The data object that the API returns for this request. |
