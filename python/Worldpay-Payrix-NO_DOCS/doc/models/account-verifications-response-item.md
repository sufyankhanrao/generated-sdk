...
# Account Verifications Response Item

## Structure

`AccountVerificationsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[AccountVerificationResponse]`](../../doc/models/account-verification-response.md) | Optional | The data object that the API returns for this request. |
