...
|  --- | --- | --- | --- |
| `entity` | `str` | Optional | The identifier of the Entity that this Contact relates to. |
| `first` | `str` | Optional | The first name associated with this Contact. |
| `middle` | `str` | Optional | The middle name associated with this Contact. |
| `last` | `str` | Optional | The last name associated with this Contact. |
| `description` | `str` | Optional | A description of this Contact. |
| `email` | `str` | Optional | The email address of this Contact. |
