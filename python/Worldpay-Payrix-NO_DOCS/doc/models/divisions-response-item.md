...
# Divisions Response Item

## Structure

`DivisionsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[DivisionsResponse1]`](../../doc/models/divisions-response-1.md) | Optional | The data object that the API returns for this request. |
