...
# Merchant Platform Statuses Response Item

## Structure

`MerchantPlatformStatusesResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[MerchantPlatformStatusesResponse]`](../../doc/models/merchant-platform-statuses-response.md) | Optional | The data object that the API returns for this request. |
