...
|  --- | --- | --- | --- |
| `data` | [`List[SaferPaymentsResponse]`](../../doc/models/safer-payments-response.md) | Optional | The data object that the API returns for this request. |
