...
# Assessments Response Item

## Structure

`AssessmentsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[AssessmentsResponse]`](../../doc/models/assessments-response.md) | Optional | The data object that the API returns for this request. |
