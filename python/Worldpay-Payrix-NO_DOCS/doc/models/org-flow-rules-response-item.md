...
# Org Flow Rules Response Item

## Structure

`OrgFlowRulesResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[OrgFlowRulesResponse]`](../../doc/models/org-flow-rules-response.md) | Optional | The data object that the API returns for this request. |
