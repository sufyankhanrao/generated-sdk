...
# Orgs VAS Efe Products Response Item

## Structure

`OrgsVASEfeProductsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[OrgsVASEfeProductsResponse]`](../../doc/models/orgs-vas-efe-products-response.md) | Optional | The data object that the API returns for this request. |
