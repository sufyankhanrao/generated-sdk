...
# Invoice Items Response Item

## Structure

`InvoiceItemsResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[InvoiceItemsResponse]`](../../doc/models/invoice-items-response.md) | Optional | The data object that the API returns for this request. |
