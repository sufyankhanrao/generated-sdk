...
|  --- | --- | --- | --- |
| `data` | [`List[ProfitSharesResponse]`](../../doc/models/profit-shares-response.md) | Optional | The data object that the API returns for this request. |
