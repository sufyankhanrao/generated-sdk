...
# Payment Updates Response Item

## Structure

`PaymentUpdatesResponseItem`

## Fields

| Name | Type | Tags | Description |
|  --- | --- | --- | --- |
| `data` | [`List[PaymentUpdatesResponse]`](../../doc/models/payment-updates-response.md) | Optional | The data object that the API returns for this request. |
