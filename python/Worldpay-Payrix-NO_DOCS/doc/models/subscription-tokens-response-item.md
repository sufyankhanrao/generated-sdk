...
# Subscription Tokens Response Item
...
|  --- | --- | --- | --- |
| `data` | [`List[SubscriptionTokensResponse]`](../../doc/models/subscription-tokens-response.md) | Optional | The data object that the API returns for this request. |
