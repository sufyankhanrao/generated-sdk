...
```python
def get_embedded_finance_id(self,
                           id,
                           request_token=None)
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`EmbeddedFinanceResponseResult`](../../doc/models/embedded-finance-response-result.md).
...
result = embedded_finance_controller.get_embedded_finance_id(
    id,
...
```python
def put_embedded_finance_id(self,
                           id,
                           body,
                           request_token=None)
```
...
body = EmbeddedFinancePutRequest(
...
result = embedded_finance_controller.put_embedded_finance_id(
    id,
    body,
    request_token=request_token
)
...
result = embedded_finance_controller.get_embedded_finance(
    request_token=request_token,
    search=search,
    totals=totals,
...
```python
def post_embedded_finance(self,
                         body,
                         request_token=None)
```
