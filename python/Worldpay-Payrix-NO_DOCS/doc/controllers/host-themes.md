...
```python
host_themes_controller = client.host_themes
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`HostThemesResponseResult`](../../doc/models/host-themes-response-result.md).
...
result = host_themes_controller.get_host_themes_id(
    id,
...
result = host_themes_controller.get_host_themes(
    request_token=request_token,
    search=search,
    totals=totals,
