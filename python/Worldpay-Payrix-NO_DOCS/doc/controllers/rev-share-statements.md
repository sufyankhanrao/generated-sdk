...
```python
rev_share_statements_controller = client.rev_share_statements
```
...
```python
def get_rev_share_statements_id(self,
                               id,
                               request_token=None)
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`RevShareStatementsResponseResult`](../../doc/models/rev-share-statements-response-result.md).
...
result = rev_share_statements_controller.get_rev_share_statements_id(
    id,
...
```python
def get_rev_share_statements(self,
                            request_token=None,
                            search=None,
                            totals=None,
                            page_number=None,
...
result = rev_share_statements_controller.get_rev_share_statements(
    request_token=request_token,
    search=search,
    totals=totals,
