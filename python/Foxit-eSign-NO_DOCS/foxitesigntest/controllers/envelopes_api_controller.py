...
class EnvelopesAPIController(BaseController):
    ...
    def create_envelope_from_url(self,
                                 body):
        """Does a POST request to /folders/createfolder.
    ...
    def get_envelope_details(self,
                             folder_id):
        """Does a GET request to /folders/myfolder.
    ...
    def get_envelope_ids(self,
                         ...
                         date_to,
                         status='EXECUTED'):
        """Does a GET request to /folders/getAllFolderIdsByStatus.
    ...
    def modify_shared_envelope(self,
                               body):
        """Does a POST request to /folders/modifySharedFolder.
    ...
    def send_signature_reminder(self,
                                body):
        """Does a POST request to /folders/signaturereminder.
    ...
    def update_envelope_fields(self,
                               body):
        """Does a POST request to /folders/updateEnvelopeFields.
    ...
    def download_envelope_files(self,
                                folder_id):
        """Does a GET request to /folders/download.
    ...
    def move_envelopes_to_recycle_bin(self,
                                      body):
        """Does a POST request to /folders/movetorecyclebin.
    ...
    def regenerate_embedded_signing_session(self,
                                            body):
        """Does a POST request to /embedded/regenerateEmbeddedSigningSession.
    ...
    def get_envelope_activity_history(self,
                                      folder_id):
        """Does a GET request to /folders/viewActivityHistory.
    ...
    def send_draft_envelope(self,
                            body):
        """Does a POST request to /folders/sendDraftFolder.
    ...
    def download_single_document_pdf(self,
                                     folder_id,
                                     doc_number):
        """Does a GET request to /folders/document/download.
    ...
    def get_deleted_envelope_history(self,
                                     folder_id):
        """Does a GET request to /folders/deletedLog.
    ...
    def cancel_envelope(self,
                        body):
        """Does a POST request to /folders/cancelFolder.
    ...
    def update_envelope_recipients(self,
                                   body):
        """Does a POST request to /folders/updateFolder.
    ...
    def delete_envelopes(self,
                         body):
        """Does a POST request to /folders/delete.
