...
class TemplatesAPIController(BaseController):
    ...
    def get_templates_by_template_ids(self,
                                      body):
        """Does a POST request to /templates/templateDetails.
    ...
    def get_template_details(self,
                             template_id):
        """Does a GET request to /templates/mytemplate.
    ...
    def get_a_list_of_all_templates(self):
        """Does a GET request to /templates/list.
    ...
    def create_template_from_url(self,
                                 body):
        """Does a POST request to /templates/createtemplate.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserializer(APIHelper.dynamic_deserialize)
            .is_api_response(True)
            .local_error('401', 'The error will come when the access_token in the  headers is invalid or expired.', APIException)
        ).execute()

    def create_envelope_from_template(self,
                                      body):
        """Does a POST request to /templates/createFolder.
