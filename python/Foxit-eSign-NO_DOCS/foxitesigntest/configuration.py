...
from foxitesigntest.http.proxy_settings import (
    ProxySettings,
)
...
class Configuration(HttpClientConfiguration):
    ...
    def access_token(self):
        """Return AccessToken from BearerAuthCredentials."""
    ...
    def __init__(self, http_client_instance=None,
        ...
        self._bearer_auth_credentials =\
            self.create_auth_credentials_object(access_token,
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        environment = Environment.from_value(
            os.getenv("ENVIRONMENT"), Environment.US_SERVER)
