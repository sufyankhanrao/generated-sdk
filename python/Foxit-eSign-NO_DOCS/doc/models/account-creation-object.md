...
|  --- | --- | --- | --- |
| `client_id` | `str` | Required | The API `client_id` key which can be found in the API menu under the Settings Tab |
| `client_secret` | `str` | Required | The API `client_secret` key which can be found in the API menu under the Settings Tab |
