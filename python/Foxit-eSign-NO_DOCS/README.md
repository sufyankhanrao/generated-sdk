...
![Building SDK - Step 1](https://apidocs.io/illustration/python?workspaceFolder=Foxitesigntest-Python&step=installDependencies)

## Installation

The following section explains how to use the foxitesigntest library in a new project.

### 1. Open Project in an IDE

Open up a Python IDE like PyCharm. The basic workflow presented here is also applicable if you prefer using a different editor or IDE.

![Open project in PyCharm - Step 1](https://apidocs.io/illustration/python?workspaceFolder=Foxitesigntest-Python&step=pyCharm)

Click on `Open` in PyCharm to browse to your generated SDK directory and then click `OK`.

![Open project in PyCharm - Step 2](https://apidocs.io/illustration/python?workspaceFolder=Foxitesigntest-Python&step=openProject0)

The project files will be displayed in the side bar as follows:

![Open project in PyCharm - Step 3](https://apidocs.io/illustration/python?workspaceFolder=Foxitesigntest-Python&projectName=foxitesigntest&step=openProject1)

### 2. Add a new Test Project

Create a new directory by right clicking on the solution name as shown below:

![Add a new project in PyCharm - Step 1](https://apidocs.io/illustration/python?workspaceFolder=Foxitesigntest-Python&projectName=foxitesigntest&step=createDirectory)

Name the directory as "test".

![Add a new project in PyCharm - Step 2](https://apidocs.io/illustration/python?workspaceFolder=Foxitesigntest-Python&step=nameDirectory)

Add a python file to this project.

![Add a new project in PyCharm - Step 3](https://apidocs.io/illustration/python?workspaceFolder=Foxitesigntest-Python&projectName=foxitesigntest&step=createFile)

Name it "testSDK".

![Add a new project in PyCharm - Step 4](https://apidocs.io/illustration/python?workspaceFolder=Foxitesigntest-Python&projectName=foxitesigntest&step=nameFile)
...
![Add a new project in PyCharm - Step 5](https://apidocs.io/illustration/python?workspaceFolder=Foxitesigntest-Python&projectName=foxitesigntest&libraryName=foxitesigntest.foxitesigntest_client&className=FoxitesigntestClient&step=projectFiles)
...
![Run Test Project - Step 1](https://apidocs.io/illustration/python?workspaceFolder=Foxitesigntest-Python&projectName=foxitesigntest&libraryName=foxitesigntest.foxitesigntest_client&className=FoxitesigntestClient&step=runProject)
