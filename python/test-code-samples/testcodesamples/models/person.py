...
class Person(object):
    ...
    def from_dictionary(cls,
        ...
        birthday = dateutil.parser.parse(dictionary.get('birthday')).date() if dictionary.get('birthday') else APIHelper.SKIP
        birthtime = APIHelper.RFC3339DateTime.from_value(dictionary.get("birthtime")).datetime if dictionary.get("birthtime") else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'birthtime={(self.birthtime if hasattr(self, "birthtime") else None)!r}, '
                f'name={self.name!r}, '
                f'uid={self.uid!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'birthtime={(self.birthtime if hasattr(self, "birthtime") else None)!s}, '
                f'name={self.name!s}, '
                f'uid={self.uid!s}, '
...
class EmployeeRequired(Person):
    ...
    def __init__(self,
                 ...
                 person_type='Empl',
                 additional_properties=None):
        """Constructor for the EmployeeRequired class"""
        ...
        self.date_time_unix_var = APIHelper.apply_datetime_converter(date_time_unix_var, APIHelper.UnixDateTime) if date_time_unix_var else None 
        self.r_fc_1123_var = APIHelper.apply_datetime_converter(r_fc_1123_var, APIHelper.HttpDateTime) if r_fc_1123_var else None 
        self.r_fc_3339_var = APIHelper.apply_datetime_converter(r_fc_3339_var, APIHelper.RFC3339DateTime) if r_fc_3339_var else None 
    ...
    def from_dictionary(cls,
        ...
        boolean_var = dictionary.get("booleanVar") if "booleanVar" in dictionary.keys() else None
        object_var = dictionary.get("objectVar") if dictionary.get("objectVar") else None
        dynamic_var = dictionary.get("dynamicVar") if dictionary.get("dynamicVar") else None
        date_time_unix_var = APIHelper.UnixDateTime.from_value(dictionary.get("dateTimeUnixVar")).datetime if dictionary.get("dateTimeUnixVar") else None
        r_fc_1123_var = APIHelper.HttpDateTime.from_value(dictionary.get("rFC1123Var")).datetime if dictionary.get("rFC1123Var") else None
        r_fc_3339_var = APIHelper.RFC3339DateTime.from_value(dictionary.get("rFC3339Var")).datetime if dictionary.get("rFC3339Var") else None
        date_var = dateutil.parser.parse(dictionary.get('dateVar')).date() if dictionary.get('dateVar') else None
        dependents = None
...
class EmployeeOptional(Person):
    ...
    def __init__(self,
                 ...
                 person_type='Empl',
                 additional_properties=None):
        """Constructor for the EmployeeOptional class"""
    ...
    def from_dictionary(cls,
        ...
        boolean_var = dictionary.get("booleanVar") if "booleanVar" in dictionary.keys() else APIHelper.SKIP
        object_var = dictionary.get("objectVar") if dictionary.get("objectVar") else APIHelper.SKIP
        dynamic_var = dictionary.get("dynamicVar") if dictionary.get("dynamicVar") else APIHelper.SKIP
        date_time_unix_var = APIHelper.UnixDateTime.from_value(dictionary.get("dateTimeUnixVar")).datetime if dictionary.get("dateTimeUnixVar") else APIHelper.SKIP
        r_fc_1123_var = APIHelper.HttpDateTime.from_value(dictionary.get("rFC1123Var")).datetime if dictionary.get("rFC1123Var") else APIHelper.SKIP
        r_fc_3339_var = APIHelper.RFC3339DateTime.from_value(dictionary.get("rFC3339Var")).datetime if dictionary.get("rFC3339Var") else APIHelper.SKIP
        date_var = dateutil.parser.parse(dictionary.get('dateVar')).date() if dictionary.get('dateVar') else APIHelper.SKIP
        dependents = None
        if dictionary.get('dependents') is not None:
            dependents = [Person.from_dictionary(x) for x in dictionary.get('dependents')]
        else:
            dependents = APIHelper.SKIP
        hired_at = APIHelper.HttpDateTime.from_value(dictionary.get("hiredAt")).datetime if dictionary.get("hiredAt") else APIHelper.SKIP
        joining_day = dictionary.get("joiningDay") if dictionary.get("joiningDay") else 'Monday'
    ...
    def __repr__(self):
        ...
        return (f'{self.__class__.__name__}('
                ...
                f'boolean_var={(self.boolean_var if hasattr(self, "boolean_var") else None)!r}, '
                f'object_var={(self.object_var if hasattr(self, "object_var") else None)!r}, '
                f'dynamic_var={(self.dynamic_var if hasattr(self, "dynamic_var") else None)!r}, '
                f'date_time_unix_var={(self.date_time_unix_var if hasattr(self, "date_time_unix_var") else None)!r}, '
                f'r_fc_1123_var={(self.r_fc_1123_var if hasattr(self, "r_fc_1123_var") else None)!r}, '
                f'r_fc_3339_var={(self.r_fc_3339_var if hasattr(self, "r_fc_3339_var") else None)!r}, '
                f'date_var={(self.date_var if hasattr(self, "date_var") else None)!r}, '
                f'dependents={(self.dependents if hasattr(self, "dependents") else None)!r}, '
                f'hired_at={(self.hired_at if hasattr(self, "hired_at") else None)!r}, '
                f'joining_day={(self.joining_day if hasattr(self, "joining_day") else None)!r}, '
    ...
    def __str__(self):
        ...
        return (f'{self.__class__.__name__}('
                ...
                f'boolean_var={(self.boolean_var if hasattr(self, "boolean_var") else None)!s}, '
                f'object_var={(self.object_var if hasattr(self, "object_var") else None)!s}, '
                f'dynamic_var={(self.dynamic_var if hasattr(self, "dynamic_var") else None)!s}, '
                f'date_time_unix_var={(self.date_time_unix_var if hasattr(self, "date_time_unix_var") else None)!s}, '
                f'r_fc_1123_var={(self.r_fc_1123_var if hasattr(self, "r_fc_1123_var") else None)!s}, '
                f'r_fc_3339_var={(self.r_fc_3339_var if hasattr(self, "r_fc_3339_var") else None)!s}, '
                f'date_var={(self.date_var if hasattr(self, "date_var") else None)!s}, '
                f'dependents={(self.dependents if hasattr(self, "dependents") else None)!s}, '
                f'hired_at={(self.hired_at if hasattr(self, "hired_at") else None)!s}, '
                f'joining_day={(self.joining_day if hasattr(self, "joining_day") else None)!s}, '
...
class Boss(EmployeeRequired):
    ...
    def from_dictionary(cls,
        ...
        assistant = EmployeeRequired.from_dictionary(dictionary.get('assistant')) if dictionary.get('assistant') else None
        department = dictionary.get("department") if dictionary.get("department") else None
        boolean_var = dictionary.get("booleanVar") if "booleanVar" in dictionary.keys() else None
        object_var = dictionary.get("objectVar") if dictionary.get("objectVar") else None
        dynamic_var = dictionary.get("dynamicVar") if dictionary.get("dynamicVar") else None
