...
from testcodesamples.configuration import Configuration
...
from testcodesamples.controllers.native_types_controller\
    import NativeTypesController
from testcodesamples.controllers.custom_types_controller\
    import CustomTypesController
