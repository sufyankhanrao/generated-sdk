...
class CustomTypesController(BaseController):
    ...
    def multi_dimensional_model_array_required(self,
        ...
        Args:
            employee_array (List[EmployeeRequired]): The request form parameter.
            employee_array_optional (List[EmployeeRequired], optional): The request
                form parameter.
    ...
    def multi_dimensional_model_array_optional(self,
        ...
        Args:
            employee_array (List[EmployeeRequired], optional): The request form
                parameter.
            employee_array_optional (List[EmployeeOptional], optional): The request
                form parameter.
    ...
    def custom_type_map_of_array_and_array_of_map_required(self,
        ...
        Args:
            employee_array_of_map (EmployeeRequired): The request form parameter.
    ...
    def custom_type_map_of_array_and_array_of_map_optional(self,
        ...
        Args:
            employee_array_of_map (EmployeeRequired, optional): The request form
                parameter.
            employee_map_of_array (List[bool], optional): The request form parameter.
    ...
    def send_model_in_form_required(self,
        ...
        Args:
            ...
            model_optional (Dict[str, EmployeeRequired], optional): The request form
                parameter.
    ...
    def send_model_in_form_optional(self,
        ...
        Args:
            ...
            model_optional (Dict[str, EmployeeOptional], optional): The request form
                parameter.
