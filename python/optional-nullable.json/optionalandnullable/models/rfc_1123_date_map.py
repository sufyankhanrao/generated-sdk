...
class Rfc1123DateMap(object):

    """Implementation of the 'Rfc1123 date map' model.
    ...
    def __init__(self,
        ...
        """Constructor for the Rfc1123DateMap class"""
    ...
    def from_dictionary(cls,
        ...
        date_time_1 = APIHelper.HttpDateTime.from_value(dictionary.get("dateTime1")).datetime if dictionary.get("dateTime1") else None
