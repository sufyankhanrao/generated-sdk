...
from customqueryparameter.http.proxy_settings import (
    ProxySettings,
)
from customqueryparameter.models.suite_code_enum import (
    SuiteCodeEnum,
)
...
class Configuration(HttpClientConfiguration):
    ...
    @property
    def token(self):
        """Return Token from CustomQueryAuthenticationCredentials."""
        return self._custom_query_authentication_credentials.token

    @property
    def api_key(self):
        """Return ApiKey from CustomQueryAuthenticationCredentials."""
        return self._custom_query_authentication_credentials.api_key
    ...
    def __init__(self, http_client_instance=None,
        ...
        self._custom_query_authentication_credentials =\
            self.create_auth_credentials_object(
                token, api_key, custom_query_authentication_credentials)
    ...
    def clone_with(self, http_client_instance=None,
        ...
        custom_query_authentication_credentials = self.create_auth_credentials_object(
            ...
            or self.custom_query_authentication_credentials,
            stack_level=3)
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        default_config = cls(
            ...
            custom_query_authentication_credentials=CustomQueryAuthenticationCredentials.from_environment(),
        )
