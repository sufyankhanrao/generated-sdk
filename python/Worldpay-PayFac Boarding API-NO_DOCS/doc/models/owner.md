...
Please refer to the Beneficial Ownership section under Submerchant Boarding on the left hand side menu in the developer portal for specific requirements on Owner's SSN, DOB and other Owner attributes.They can be required based on Ownership Type and Ownership Percentage.
...
| `email` | `str` | Required | Email address of the contact. Must have @ and a .<br><br>**Constraints**: *Maximum Length*: `64` |
...
| `ssn` | `str` | Optional | Owner's SSN - Social Security Number. Please refer to the Beneficial Ownership section under Submerchant Boarding on the left hand side menu in the developer portal for specific requirements on Owner's SSN. https://developerengine.fisglobal.com/apis/payfac#PFBeneficialOwners<br><br>**Constraints**: *Pattern*: `^\d{9}$` |
| `dob` | `date` | Optional | Owner's Date of Birth. Please refer to the Beneficial Ownership section under Submerchant Boarding on the left hand side menu in the developer portal for specific requirements on Owner DOB.https://developerengine.fisglobal.com/apis/payfac#PFBeneficialOwners |
...
| `mtype` | [`TypeEnum`](../../doc/models/type-enum.md) | Required | Type of the Owner |
