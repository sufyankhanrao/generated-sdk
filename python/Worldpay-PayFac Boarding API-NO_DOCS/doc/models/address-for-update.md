...
| `address_line_2` | `str` | Required | Address Line 2. Field for Apt No, Suite No etc.<br><br>**Constraints**: *Maximum Length*: `40` |
...
| `country` | [`CountryEnum`](../../doc/models/country-enum.md) | Optional | Only USA and Canada is allowed now. |
