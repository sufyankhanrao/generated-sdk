...
from useragenttester.http.api_response import ApiResponse
from useragenttester.controllers.base_controller import BaseController
from apimatic_core.request_builder import RequestBuilder
from apimatic_core.response_handler import ResponseHandler
from apimatic_core.types.parameter import Parameter
from useragenttester.http.http_method_enum import HttpMethodEnum
from useragenttester.models.server_response import ServerResponse
...
class APIController(BaseController):
    ...
    def send_user_agent(self):
        """Does a GET request to /response/testUserAgent.
