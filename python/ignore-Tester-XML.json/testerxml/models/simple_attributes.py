...
class SimpleAttributes(object):
    ...
    def __init__(self,
        ...
        """Constructor for the SimpleAttributes class"""
    ...
    def from_dictionary(cls,
        ...
        nonreserved = dictionary.get("nonreserved") if dictionary.get("nonreserved") else None
        number_element = dictionary.get("number-element") if dictionary.get("number-element") else None
        precision = dictionary.get("precision") if dictionary.get("precision") else None
        boolean_element = dictionary.get("boolean-element") if "boolean-element" in dictionary.keys() else None
        attributes_type = dictionary.get("attributes_type") if dictionary.get("attributes_type") else 'SimpleAttributes'
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'attributes_type={(self.attributes_type if hasattr(self, "attributes_type") else None)!r})')
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'attributes_type={(self.attributes_type if hasattr(self, "attributes_type") else None)!s})')
...
class ModelWithInheritedAttributes(SimpleAttributes):
    ...
    def __init__(self,
        ...
        """Constructor for the ModelWithInheritedAttributes class"""
    ...
    def from_dictionary(cls,
        ...
        # Extract variables from the dictionary
        new_string_field = dictionary.get("NewStringField") if dictionary.get("NewStringField") else None
        string_element = dictionary.get("string-element") if dictionary.get("string-element") else None
        nonreserved = dictionary.get("nonreserved") if dictionary.get("nonreserved") else None
        number_element = dictionary.get("number-element") if dictionary.get("number-element") else None
        precision = dictionary.get("precision") if dictionary.get("precision") else None
        boolean_element = dictionary.get("boolean-element") if "boolean-element" in dictionary.keys() else None
        attributes_type = dictionary.get("attributes_type") if dictionary.get("attributes_type") else 'ModelWithInheritedAttributes'
        # Return an object of this model
