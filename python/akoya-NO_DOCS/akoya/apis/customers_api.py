...
from akoya.models.account_contact_entity import (
...
class CustomersApi(BaseApi):
    ...
    def __init__(self, config):
        """Initialize CustomersApi object."""
    ...
    def customer_info(self,
        ...
        """Perform a GET request to /customers/{version}/{providerId}/current.
    ...
    def get_account_holder(self,
                           ...
                           provider_id,
                           x_akoya_interaction_type=None):
        """Perform a GET request to /contacts/{version}/{providerId}/{accountId}.
