...
from akoya.models.akoya_account_info_product import (
    AkoyaAccountInfoProduct,
)


class AccountInformationApi(BaseApi):
    """A Controller to access Endpoints in the akoya API."""

    def __init__(self, config):
        """Initialize AccountInformationApi object."""
        super(AccountInformationApi, self).__init__(config)
    ...
    def get_accounts_info(self,
                          ...
                          mode=None,
                          account_ids=None):
        """Perform a GET request to /accounts-info/{version}/{providerId}.
