...
from akoya.models.transactions_entity import (
    TransactionsEntity,
)
from akoya.utilities.pagination.paged_iterable import (
    PagedIterable,
)
from akoya.utilities.pagination.paged_response import (
    LinkPagedResponse,
)
...
class TransactionsApi(BaseApi):
    ...
    def get_transactions(self,
                         ...
                         mode=None):
        """Perform a GET request to /transactions/{version}/{providerId}/{accountId}.
