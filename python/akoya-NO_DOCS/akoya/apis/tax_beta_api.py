...
class TaxBetaApi(BaseApi):
    ...
    def tax_forms_search(self,
                         ...
                         tax_forms=None,
                         account_id=None):
        """Perform a GET request to /tax-forms/{version}/{providerId}.
    ...
    def get_tax_form(self,
                     ...
                     tax_data_type=None,
                     accept=None):
        """Perform a GET request to /tax-forms/{version}/{providerId}/{taxFormId}.
        ...
        return super().new_api_call_builder.request(
            ...
            .is_api_response(True)
            .local_error("400",
                "Account ID is required for searching or validating authorizati"
                "on",
                ErrorErrorException)
            .local_error("404",
            ...
            .local_error("408",
                ...
                ErrorErrorException)
            .local_error("409",
                "Tax forms are not currently available for this account or this"
                " year",
                ErrorErrorException)
            .local_error("500",
                "Catch-all exception where request was not processed due to an "
