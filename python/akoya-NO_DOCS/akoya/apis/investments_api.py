...
from akoya.models.investments_details import (
    InvestmentsDetails,
)
from akoya.models.taxlots_response import TaxlotsResponse
...
class InvestmentsApi(BaseApi):
    ...
    def __init__(self, config):
        """Initialize InvestmentsApi object."""
        super(InvestmentsApi, self).__init__(config)
    ...
    def get_accounts(self,
                     ...
                     mode=None,
                     account_ids=None):
        """Perform a GET request to /accounts/{version}/{providerId}.
