...
class Form1042SRecipient(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form1042SRecipient instance."""
    ...
    def from_dictionary(cls,
        ...
        party_type =\
            dictionary.get("partyType")\
            if dictionary.get("partyType") else APIHelper.SKIP
        individual_name = IndividualName.from_dictionary(
            dictionary.get("individualName"))\
            if "individualName" in dictionary.keys() else APIHelper.SKIP
        business_name = BusinessName.from_dictionary(
            dictionary.get("businessName"))\
            if "businessName" in dictionary.keys() else APIHelper.SKIP
        address = Address.from_dictionary(
            dictionary.get("address"))\
            if "address" in dictionary.keys() else APIHelper.SKIP
        phone = TelephoneNumberPlusExtension.from_dictionary(
        ...
        ch_3_status_code =\
            dictionary.get("ch3StatusCode")\
            if dictionary.get("ch3StatusCode") else APIHelper.SKIP
        ch_4_status_code =\
            dictionary.get("ch4StatusCode")\
            if dictionary.get("ch4StatusCode") else APIHelper.SKIP
        giin =\
            dictionary.get("giin")\
            if dictionary.get("giin") else APIHelper.SKIP
        foreign_tin =\
            dictionary.get("foreignTin")\
            if dictionary.get("foreignTin") else APIHelper.SKIP
        lob_code =\
            dictionary.get("lobCode")\
            if dictionary.get("lobCode") else APIHelper.SKIP
        date_of_birth = dateutil.parser.parse(dictionary.get("dateOfBirth")).date()\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"party_type={(self.party_type
                     if hasattr(self, 'party_type') else None)!r}, "
                f"individual_name={(self.individual_name
                     if hasattr(self, 'individual_name') else None)!r}, "
                ...
                f"ch_3_status_code={(self.ch_3_status_code
                     if hasattr(self, 'ch_3_status_code') else None)!r}, "
                f"ch_4_status_code={(self.ch_4_status_code
                     if hasattr(self, 'ch_4_status_code') else None)!r}, "
                f"giin={(self.giin if hasattr(self, 'giin') else None)!r}, "
                f"foreign_tin={(self.foreign_tin
                     if hasattr(self, 'foreign_tin') else None)!r}, "
                f"lob_code={(self.lob_code
                     if hasattr(self, 'lob_code') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"party_type={(self.party_type
                     if hasattr(self, 'party_type') else None)!s}, "
                f"individual_name={(self.individual_name
                     if hasattr(self, 'individual_name') else None)!s}, "
                f"business_name={(self.business_name
                ...
                f"ch_3_status_code={(self.ch_3_status_code
                     if hasattr(self, 'ch_3_status_code') else None)!s}, "
                f"ch_4_status_code={(self.ch_4_status_code
                     if hasattr(self, 'ch_4_status_code') else None)!s}, "
                f"giin={(self.giin if hasattr(self, 'giin') else None)!s}, "
                f"foreign_tin={(self.foreign_tin
                     if hasattr(self, 'foreign_tin') else None)!s}, "
                f"lob_code={(self.lob_code
                     if hasattr(self, 'lob_code') else None)!s}, "
                f"date_of_birth={(self.date_of_birth
