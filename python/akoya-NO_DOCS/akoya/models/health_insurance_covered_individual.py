...
class HealthInsuranceCoveredIndividual(object):
    ...
    def __init__(self,
        ...
        """Initialize a HealthInsuranceCoveredIndividual instance."""
    ...
    def from_dictionary(cls,
        ...
        name = IndividualName.from_dictionary(
            dictionary.get("name"))\
        ...
        covered_all_12_months =\
            dictionary.get("coveredAll12Months")\
            if "coveredAll12Months" in dictionary.keys() else APIHelper.SKIP
        covered_months =\
            dictionary.get("coveredMonths")\
            if dictionary.get("coveredMonths") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"covered_all_12_months={(self.covered_all_12_months
                     if hasattr(self, 'covered_all_12_months') else None)!r}, "
                f"covered_months={(self.covered_months
                     if hasattr(self, 'covered_months') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"covered_all_12_months={(self.covered_all_12_months
                     if hasattr(self, 'covered_all_12_months') else None)!s}, "
                f"covered_months={(self.covered_months
                     if hasattr(self, 'covered_months') else None)!s}, "
