...
class RoyaltyIncomeStatement(object):
    ...
    def __init__(self,
        ...
        """Initialize a RoyaltyIncomeStatement instance."""
    ...
    def from_dictionary(cls,
        ...
        auto =\
            dictionary.get("auto")\
            if dictionary.get("auto") else APIHelper.SKIP
        cleaning =\
            dictionary.get("cleaning")\
            if dictionary.get("cleaning") else APIHelper.SKIP
        commissions =\
        ...
        management_fees =\
            dictionary.get("managementFees")\
            if dictionary.get("managementFees") else APIHelper.SKIP
        mortgage_interest =\
        ...
        depletion_expense =\
            dictionary.get("depletionExpense")\
            if dictionary.get("depletionExpense") else APIHelper.SKIP
        other_expenses = None
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"cleaning={(self.cleaning
                     if hasattr(self, 'cleaning') else None)!r}, "
                ...
                f"management_fees={(self.management_fees
                     if hasattr(self, 'management_fees') else None)!r}, "
                ...
                f"depletion_expense={(self.depletion_expense
                     if hasattr(self, 'depletion_expense') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"cleaning={(self.cleaning
                     if hasattr(self, 'cleaning') else None)!s}, "
                f"commissions={(self.commissions
                ...
                f"management_fees={(self.management_fees
                     if hasattr(self, 'management_fees') else None)!s}, "
                f"mortgage_interest={(self.mortgage_interest
                ...
                f"depletion_expense={(self.depletion_expense
                     if hasattr(self, 'depletion_expense') else None)!s}, "
                f"other_expenses={(self.other_expenses
