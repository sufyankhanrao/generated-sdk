...
from akoya.models.account_holder_entity import (
    AccountHolderEntity,
)
...
class AccountContactEntity(object):
    ...
    def __init__(self,
        ...
        """Initialize a AccountContactEntity instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("holders") is not None:
            holders = [
                AccountHolderEntity.from_dictionary(x)
                    for x in dictionary.get("holders")
            ]
        else:
            holders = APIHelper.SKIP
        emails =\
        ...
        if dictionary.get("addresses") is not None:
            addresses = [
                DeliveryAddress.from_dictionary(x)
        ...
        if dictionary.get("telephones") is not None:
            telephones = [
                TelephoneNumber.from_dictionary(x)
                    for x in dictionary.get("telephones")
            ]
        else:
            telephones = APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"holders={(self.holders
                     if hasattr(self, 'holders') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"holders={(self.holders
                     if hasattr(self, 'holders') else None)!s}, "
