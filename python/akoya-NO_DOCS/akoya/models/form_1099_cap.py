...
class Form1099Cap(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form1099Cap instance."""
    ...
    def from_dictionary(cls,
        ...
        aggregate_amount =\
            dictionary.get("aggregateAmount")\
            if dictionary.get("aggregateAmount") else APIHelper.SKIP
        number_of_shares =\
            dictionary.get("numberOfShares")\
            if dictionary.get("numberOfShares") else APIHelper.SKIP
        stock_classes =\
            dictionary.get("stockClasses")\
            if dictionary.get("stockClasses") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"aggregate_amount={(self.aggregate_amount
                     if hasattr(self, 'aggregate_amount') else None)!r}, "
                f"number_of_shares={(self.number_of_shares
                     if hasattr(self, 'number_of_shares') else None)!r}, "
                f"stock_classes={(self.stock_classes
                     if hasattr(self, 'stock_classes') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"aggregate_amount={(self.aggregate_amount
                     if hasattr(self, 'aggregate_amount') else None)!s}, "
                f"number_of_shares={(self.number_of_shares
                     if hasattr(self, 'number_of_shares') else None)!s}, "
                f"stock_classes={(self.stock_classes
                     if hasattr(self, 'stock_classes') else None)!s}, "
