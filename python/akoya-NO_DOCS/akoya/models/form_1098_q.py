...
class Form1098Q(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form1098Q instance."""
    ...
    def from_dictionary(cls,
        ...
        plan_number =\
            dictionary.get("planNumber")\
            if dictionary.get("planNumber") else APIHelper.SKIP
        plan_name =\
            dictionary.get("planName")\
            if dictionary.get("planName") else APIHelper.SKIP
        plan_sponsor_id =\
            dictionary.get("planSponsorId")\
            if dictionary.get("planSponsorId") else APIHelper.SKIP
        annuity_amount =\
            dictionary.get("annuityAmount")\
            if dictionary.get("annuityAmount") else APIHelper.SKIP
        start_date = dateutil.parser.parse(dictionary.get("startDate")).date()\
            if dictionary.get("startDate") else APIHelper.SKIP
        can_be_accelerated =\
            dictionary.get("canBeAccelerated")\
            if "canBeAccelerated" in dictionary.keys() else APIHelper.SKIP
        total_premiums =\
            dictionary.get("totalPremiums")\
            if dictionary.get("totalPremiums") else APIHelper.SKIP
        fair_market_value =\
        ...
        if dictionary.get("premiums") is not None:
            premiums = [
                DateAndAmount.from_dictionary(x)
                    for x in dictionary.get("premiums")
            ]
        else:
            premiums = APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"plan_number={(self.plan_number
                     if hasattr(self, 'plan_number') else None)!r}, "
                f"plan_name={(self.plan_name
                     if hasattr(self, 'plan_name') else None)!r}, "
                f"plan_sponsor_id={(self.plan_sponsor_id
                     if hasattr(self, 'plan_sponsor_id') else None)!r}, "
                f"annuity_amount={(self.annuity_amount
                     if hasattr(self, 'annuity_amount') else None)!r}, "
                f"start_date={(self.start_date
                     if hasattr(self, 'start_date') else None)!r}, "
                f"can_be_accelerated={(self.can_be_accelerated
                     if hasattr(self, 'can_be_accelerated') else None)!r}, "
                f"total_premiums={(self.total_premiums
                     if hasattr(self, 'total_premiums') else None)!r}, "
                f"fair_market_value={(self.fair_market_value
                     if hasattr(self, 'fair_market_value') else None)!r}, "
                f"premiums={(self.premiums
                     if hasattr(self, 'premiums') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"plan_number={(self.plan_number
                     if hasattr(self, 'plan_number') else None)!s}, "
                f"plan_name={(self.plan_name
                     if hasattr(self, 'plan_name') else None)!s}, "
                f"plan_sponsor_id={(self.plan_sponsor_id
                     if hasattr(self, 'plan_sponsor_id') else None)!s}, "
                f"annuity_amount={(self.annuity_amount
                     if hasattr(self, 'annuity_amount') else None)!s}, "
                f"start_date={(self.start_date
                     if hasattr(self, 'start_date') else None)!s}, "
                f"can_be_accelerated={(self.can_be_accelerated
                     if hasattr(self, 'can_be_accelerated') else None)!s}, "
                f"total_premiums={(self.total_premiums
                     if hasattr(self, 'total_premiums') else None)!s}, "
                f"fair_market_value={(self.fair_market_value
                     if hasattr(self, 'fair_market_value') else None)!s}, "
                f"premiums={(self.premiums
                     if hasattr(self, 'premiums') else None)!s}, "
