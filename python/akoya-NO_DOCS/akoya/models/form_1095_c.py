...
from akoya.models.offer_of_health_insurance_coverage import (
...
class Form1095C(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form1095C instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("links") is not None:
            ...
            links = APIHelper.SKIP
        self_insured_coverage =\
            dictionary.get("selfInsuredCoverage")\
            if "selfInsuredCoverage" in dictionary.keys() else APIHelper.SKIP
        offers_of_coverage = None
        if dictionary.get("offersOfCoverage") is not None:
            offers_of_coverage = [
                OfferOfHealthInsuranceCoverage.from_dictionary(x)
                    for x in dictionary.get("offersOfCoverage")
            ]
        else:
            offers_of_coverage = APIHelper.SKIP
        employee_age =\
            dictionary.get("employeeAge")\
            if dictionary.get("employeeAge") else APIHelper.SKIP
        plan_start_month =\
            dictionary.get("planStartMonth")\
            if dictionary.get("planStartMonth") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"self_insured_coverage={(self.self_insured_coverage
                     if hasattr(self, 'self_insured_coverage') else None)!r}, "
                f"offers_of_coverage={(self.offers_of_coverage
                     if hasattr(self, 'offers_of_coverage') else None)!r}, "
                f"employee_age={(self.employee_age
                     if hasattr(self, 'employee_age') else None)!r}, "
                f"plan_start_month={(self.plan_start_month
                     if hasattr(self, 'plan_start_month') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"self_insured_coverage={(self.self_insured_coverage
                     if hasattr(self, 'self_insured_coverage') else None)!s}, "
                f"offers_of_coverage={(self.offers_of_coverage
                     if hasattr(self, 'offers_of_coverage') else None)!s}, "
                f"employee_age={(self.employee_age
                     if hasattr(self, 'employee_age') else None)!s}, "
                f"plan_start_month={(self.plan_start_month
                     if hasattr(self, 'plan_start_month') else None)!s}, "
                f"covered_individuals={(self.covered_individuals
