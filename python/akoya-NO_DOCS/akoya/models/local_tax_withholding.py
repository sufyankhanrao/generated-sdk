...
class LocalTaxWithholding(object):
    ...
    def __init__(self,
        ...
        """Initialize a LocalTaxWithholding instance."""
    ...
    def from_dictionary(cls,
        ...
        tax_withheld =\
            dictionary.get("taxWithheld")\
            if dictionary.get("taxWithheld") else APIHelper.SKIP
        locality_name =\
            dictionary.get("localityName")\
            if dictionary.get("localityName") else APIHelper.SKIP
        income =\
            dictionary.get("income")\
            if dictionary.get("income") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"tax_withheld={(self.tax_withheld
                     if hasattr(self, 'tax_withheld') else None)!r}, "
                f"locality_name={(self.locality_name
                     if hasattr(self, 'locality_name') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"tax_withheld={(self.tax_withheld
                     if hasattr(self, 'tax_withheld') else None)!s}, "
                f"locality_name={(self.locality_name
                     if hasattr(self, 'locality_name') else None)!s}, "
