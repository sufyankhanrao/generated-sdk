...
class Form1099Ls(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form1099Ls instance."""
    ...
    def from_dictionary(cls,
        ...
        sale_date = dateutil.parser.parse(dictionary.get("saleDate")).date()\
            if dictionary.get("saleDate") else APIHelper.SKIP
        issuer_name =\
            dictionary.get("issuerName")\
            if dictionary.get("issuerName") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"issuer_name={(self.issuer_name
                     if hasattr(self, 'issuer_name') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"issuer_name={(self.issuer_name
                     if hasattr(self, 'issuer_name') else None)!s}, "
                f"contact_name_address={(self.contact_name_address
