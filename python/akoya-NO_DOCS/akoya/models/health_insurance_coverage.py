...
class HealthInsuranceCoverage(object):
    ...
    def __init__(self,
        ...
        """Initialize a HealthInsuranceCoverage instance."""
        ...
        if advance_premium_tax_credit_payment is not APIHelper.SKIP:
            self.advance_premium_tax_credit_payment =\
                 advance_premium_tax_credit_payment
    ...
    def from_dictionary(cls,
        ...
        enrollment_premium =\
            dictionary.get("enrollmentPremium")\
            if dictionary.get("enrollmentPremium") else APIHelper.SKIP
        slcsp_premium =\
            dictionary.get("slcspPremium")\
            if dictionary.get("slcspPremium") else APIHelper.SKIP
        advance_premium_tax_credit_payment =\
            dictionary.get("advancePremiumTaxCreditPayment")\
            if dictionary.get("advancePremiumTaxCreditPayment") else APIHelper.SKIP
        month =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"enrollment_premium={(self.enrollment_premium
                     if hasattr(self, 'enrollment_premium') else None)!r}, "
                f"slcsp_premium={(self.slcsp_premium
                     if hasattr(self, 'slcsp_premium') else None)!r}, "
                f"advance_premium_tax_credit_payment={(self.advance_premium_tax_credit_payment
                     if hasattr(self, 'advance_premium_tax_credit_payment') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"enrollment_premium={(self.enrollment_premium
                     if hasattr(self, 'enrollment_premium') else None)!s}, "
                f"slcsp_premium={(self.slcsp_premium
                     if hasattr(self, 'slcsp_premium') else None)!s}, "
                f"advance_premium_tax_credit_payment={(self.advance_premium_tax_credit_payment
                     if hasattr(self, 'advance_premium_tax_credit_payment') else None)!s}, "
