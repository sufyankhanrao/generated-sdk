...
class TaxRefundDirectDeposit(object):
    ...
    def __init__(self,
        ...
        """Initialize a TaxRefundDirectDeposit instance."""
    ...
    def from_dictionary(cls,
        ...
        institution_name =\
            dictionary.get("institutionName")\
            if dictionary.get("institutionName") else APIHelper.SKIP
        ...
        account_nick_name =\
            dictionary.get("accountNickName")\
            if dictionary.get("accountNickName") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"institution_name={(self.institution_name
                     if hasattr(self, 'institution_name') else None)!r}, "
                f"rtn={(self.rtn if hasattr(self, 'rtn') else None)!r}, "
                f"account_number={(self.account_number
                     if hasattr(self, 'account_number') else None)!r}, "
                f"account_nick_name={(self.account_nick_name
                     if hasattr(self, 'account_nick_name') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"institution_name={(self.institution_name
                     if hasattr(self, 'institution_name') else None)!s}, "
                f"rtn={(self.rtn if hasattr(self, 'rtn') else None)!s}, "
                f"account_number={(self.account_number
                     if hasattr(self, 'account_number') else None)!s}, "
                f"account_nick_name={(self.account_nick_name
                     if hasattr(self, 'account_nick_name') else None)!s}, "
