...
class Links(object):
    ...
    def from_dictionary(cls,
        ...
        next = HrefLink.from_dictionary(
            dictionary.get("next"))\
            if "next" in dictionary.keys() else APIHelper.SKIP
        prev = HrefLink.from_dictionary(
            dictionary.get("prev"))\
            if "prev" in dictionary.keys() else APIHelper.SKIP
