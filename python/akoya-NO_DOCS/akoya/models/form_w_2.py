...
class FormW2(object):
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("links") is not None:
            ...
            links = APIHelper.SKIP
        control_number =\
            dictionary.get("controlNumber")\
            if dictionary.get("controlNumber") else APIHelper.SKIP
        wages =\
        ...
        social_security_wages =\
            dictionary.get("socialSecurityWages")\
            if dictionary.get("socialSecurityWages") else APIHelper.SKIP
        social_security_tax_withheld =\
            dictionary.get("socialSecurityTaxWithheld")\
            if dictionary.get("socialSecurityTaxWithheld") else APIHelper.SKIP
        medicare_wages =\
            dictionary.get("medicareWages")\
            if dictionary.get("medicareWages") else APIHelper.SKIP
        medicare_tax_withheld =\
            dictionary.get("medicareTaxWithheld")\
            if dictionary.get("medicareTaxWithheld") else APIHelper.SKIP
        social_security_tips =\
            dictionary.get("socialSecurityTips")\
            if dictionary.get("socialSecurityTips") else APIHelper.SKIP
        allocated_tips =\
            dictionary.get("allocatedTips")\
            if dictionary.get("allocatedTips") else APIHelper.SKIP
        dependent_care_benefit =\
            dictionary.get("dependentCareBenefit")\
            if dictionary.get("dependentCareBenefit") else APIHelper.SKIP
        non_qualified_plan =\
            dictionary.get("nonQualifiedPlan")\
            if dictionary.get("nonQualifiedPlan") else APIHelper.SKIP
        codes = None
        if dictionary.get("codes") is not None:
            ...
            codes = APIHelper.SKIP
        statutory =\
            dictionary.get("statutory")\
            if "statutory" in dictionary.keys() else APIHelper.SKIP
        retirement_plan =\
            dictionary.get("retirementPlan")\
            if "retirementPlan" in dictionary.keys() else APIHelper.SKIP
        third_party_sick_pay =\
            dictionary.get("thirdPartySickPay")\
            if "thirdPartySickPay" in dictionary.keys() else APIHelper.SKIP
        espp_qualified =\
            dictionary.get("esppQualified")\
            if dictionary.get("esppQualified") else APIHelper.SKIP
        espp_non_qualified =\
            dictionary.get("esppNonQualified")\
            if dictionary.get("esppNonQualified") else APIHelper.SKIP
        other = None
        if dictionary.get("other") is not None:
            other = [
                DescriptionAndAmount.from_dictionary(x)
                    for x in dictionary.get("other")
            ]
        else:
            other = APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"control_number={(self.control_number
                     if hasattr(self, 'control_number') else None)!r}, "
                ...
                f"social_security_wages={(self.social_security_wages
                     if hasattr(self, 'social_security_wages') else None)!r}, "
                f"social_security_tax_withheld={(self.social_security_tax_withheld
                     if hasattr(self, 'social_security_tax_withheld') else None)!r}, "
                f"medicare_wages={(self.medicare_wages
                     if hasattr(self, 'medicare_wages') else None)!r}, "
                f"medicare_tax_withheld={(self.medicare_tax_withheld
                     if hasattr(self, 'medicare_tax_withheld') else None)!r}, "
                f"social_security_tips={(self.social_security_tips
                     if hasattr(self, 'social_security_tips') else None)!r}, "
                f"allocated_tips={(self.allocated_tips
                     if hasattr(self, 'allocated_tips') else None)!r}, "
                f"dependent_care_benefit={(self.dependent_care_benefit
                     if hasattr(self, 'dependent_care_benefit') else None)!r}, "
                f"non_qualified_plan={(self.non_qualified_plan
                     if hasattr(self, 'non_qualified_plan') else None)!r}, "
                f"codes={(self.codes if hasattr(self, 'codes') else None)!r}, "
                f"statutory={(self.statutory
                     if hasattr(self, 'statutory') else None)!r}, "
                f"retirement_plan={(self.retirement_plan
                     if hasattr(self, 'retirement_plan') else None)!r}, "
                f"third_party_sick_pay={(self.third_party_sick_pay
                     if hasattr(self, 'third_party_sick_pay') else None)!r}, "
                f"espp_qualified={(self.espp_qualified
                     if hasattr(self, 'espp_qualified') else None)!r}, "
                f"espp_non_qualified={(self.espp_non_qualified
                     if hasattr(self, 'espp_non_qualified') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"control_number={(self.control_number
                     if hasattr(self, 'control_number') else None)!s}, "
                f"wages={(self.wages if hasattr(self, 'wages') else None)!s}, "
                f"federal_tax_withheld={(self.federal_tax_withheld
                     if hasattr(self, 'federal_tax_withheld') else None)!s}, "
                f"social_security_wages={(self.social_security_wages
                     if hasattr(self, 'social_security_wages') else None)!s}, "
                f"social_security_tax_withheld={(self.social_security_tax_withheld
                     if hasattr(self, 'social_security_tax_withheld') else None)!s}, "
                f"medicare_wages={(self.medicare_wages
                     if hasattr(self, 'medicare_wages') else None)!s}, "
                f"medicare_tax_withheld={(self.medicare_tax_withheld
                     if hasattr(self, 'medicare_tax_withheld') else None)!s}, "
                f"social_security_tips={(self.social_security_tips
                     if hasattr(self, 'social_security_tips') else None)!s}, "
                f"allocated_tips={(self.allocated_tips
                     if hasattr(self, 'allocated_tips') else None)!s}, "
                f"dependent_care_benefit={(self.dependent_care_benefit
                     if hasattr(self, 'dependent_care_benefit') else None)!s}, "
                f"non_qualified_plan={(self.non_qualified_plan
                     if hasattr(self, 'non_qualified_plan') else None)!s}, "
                f"codes={(self.codes if hasattr(self, 'codes') else None)!s}, "
                f"statutory={(self.statutory
                     if hasattr(self, 'statutory') else None)!s}, "
                f"retirement_plan={(self.retirement_plan
                     if hasattr(self, 'retirement_plan') else None)!s}, "
                f"third_party_sick_pay={(self.third_party_sick_pay
                     if hasattr(self, 'third_party_sick_pay') else None)!s}, "
                f"espp_qualified={(self.espp_qualified
                     if hasattr(self, 'espp_qualified') else None)!s}, "
                f"espp_non_qualified={(self.espp_non_qualified
                     if hasattr(self, 'espp_non_qualified') else None)!s}, "
