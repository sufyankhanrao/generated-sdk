...
class FarmIncomeStatement(object):
    ...
    def __init__(self,
        ...
        """Initialize a FarmIncomeStatement instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("links") is not None:
            ...
            links = APIHelper.SKIP
        crop_or_activity =\
            dictionary.get("cropOrActivity")\
            if dictionary.get("cropOrActivity") else APIHelper.SKIP
        sales =\
            dictionary.get("sales")\
            if dictionary.get("sales") else APIHelper.SKIP
        cost_of_items_sold =\
            dictionary.get("costOfItemsSold")\
            if dictionary.get("costOfItemsSold") else APIHelper.SKIP
        sales_of_raised =\
            dictionary.get("salesOfRaised")\
            if dictionary.get("salesOfRaised") else APIHelper.SKIP
        coop_distributions =\
            dictionary.get("coopDistributions")\
            if dictionary.get("coopDistributions") else APIHelper.SKIP
        ag_program_payments =\
            dictionary.get("agProgramPayments")\
            if dictionary.get("agProgramPayments") else APIHelper.SKIP
        ccc_loans =\
            dictionary.get("cccLoans")\
            if dictionary.get("cccLoans") else APIHelper.SKIP
        crop_insurance_proceeds =\
            dictionary.get("cropInsuranceProceeds")\
            if dictionary.get("cropInsuranceProceeds") else APIHelper.SKIP
        custom_hire_income =\
            dictionary.get("customHireIncome")\
            if dictionary.get("customHireIncome") else APIHelper.SKIP
        other_income = None
        if dictionary.get("otherIncome") is not None:
            ...
            other_income = APIHelper.SKIP
        car_and_truck =\
            dictionary.get("carAndTruck")\
            if dictionary.get("carAndTruck") else APIHelper.SKIP
        chemicals =\
            dictionary.get("chemicals")\
            if dictionary.get("chemicals") else APIHelper.SKIP
        conservation =\
            dictionary.get("conservation")\
            if dictionary.get("conservation") else APIHelper.SKIP
        custom_hire_expenses =\
            dictionary.get("customHireExpenses")\
            if dictionary.get("customHireExpenses") else APIHelper.SKIP
        depreciation =\
            dictionary.get("depreciation")\
            if dictionary.get("depreciation") else APIHelper.SKIP
        employee_benefit_programs =\
            dictionary.get("employeeBenefitPrograms")\
            if dictionary.get("employeeBenefitPrograms") else APIHelper.SKIP
        feed =\
            dictionary.get("feed")\
            if dictionary.get("feed") else APIHelper.SKIP
        fertilizers =\
            dictionary.get("fertilizers")\
            if dictionary.get("fertilizers") else APIHelper.SKIP
        freight =\
            dictionary.get("freight")\
            if dictionary.get("freight") else APIHelper.SKIP
        fuel =\
            dictionary.get("fuel")\
            if dictionary.get("fuel") else APIHelper.SKIP
        insurance =\
            dictionary.get("insurance")\
            if dictionary.get("insurance") else APIHelper.SKIP
        mortgage_interest =\
            dictionary.get("mortgageInterest")\
            if dictionary.get("mortgageInterest") else APIHelper.SKIP
        other_interest =\
            dictionary.get("otherInterest")\
            if dictionary.get("otherInterest") else APIHelper.SKIP
        labor_hired =\
            dictionary.get("laborHired")\
            if dictionary.get("laborHired") else APIHelper.SKIP
        pension =\
            dictionary.get("pension")\
            if dictionary.get("pension") else APIHelper.SKIP
        equipment_rent =\
            dictionary.get("equipmentRent")\
            if dictionary.get("equipmentRent") else APIHelper.SKIP
        other_rent =\
            dictionary.get("otherRent")\
            if dictionary.get("otherRent") else APIHelper.SKIP
        repairs =\
            dictionary.get("repairs")\
            if dictionary.get("repairs") else APIHelper.SKIP
        seeds =\
            dictionary.get("seeds")\
            if dictionary.get("seeds") else APIHelper.SKIP
        storage =\
            dictionary.get("storage")\
            if dictionary.get("storage") else APIHelper.SKIP
        supplies =\
            dictionary.get("supplies")\
            if dictionary.get("supplies") else APIHelper.SKIP
        taxes =\
            dictionary.get("taxes")\
            if dictionary.get("taxes") else APIHelper.SKIP
        utilities =\
            dictionary.get("utilities")\
            if dictionary.get("utilities") else APIHelper.SKIP
        veterinary =\
            dictionary.get("veterinary")\
            if dictionary.get("veterinary") else APIHelper.SKIP
        other_expenses = None
        if dictionary.get("otherExpenses") is not None:
            other_expenses = [
                DescriptionAndAmount.from_dictionary(x)
                    for x in dictionary.get("otherExpenses")
            ]
        else:
            other_expenses = APIHelper.SKIP
        ...
        if dictionary.get("capitalExpenditures") is not None:
            capital_expenditures = [
                DateAndAmount.from_dictionary(x)
                    for x in dictionary.get("capitalExpenditures")
            ]
        else:
            capital_expenditures = APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"crop_or_activity={(self.crop_or_activity
                     if hasattr(self, 'crop_or_activity') else None)!r}, "
                f"sales={(self.sales if hasattr(self, 'sales') else None)!r}, "
                f"cost_of_items_sold={(self.cost_of_items_sold
                     if hasattr(self, 'cost_of_items_sold') else None)!r}, "
                f"sales_of_raised={(self.sales_of_raised
                     if hasattr(self, 'sales_of_raised') else None)!r}, "
                f"coop_distributions={(self.coop_distributions
                     if hasattr(self, 'coop_distributions') else None)!r}, "
                f"ag_program_payments={(self.ag_program_payments
                     if hasattr(self, 'ag_program_payments') else None)!r}, "
                f"ccc_loans={(self.ccc_loans
                     if hasattr(self, 'ccc_loans') else None)!r}, "
                f"crop_insurance_proceeds={(self.crop_insurance_proceeds
                     if hasattr(self, 'crop_insurance_proceeds') else None)!r}, "
                f"custom_hire_income={(self.custom_hire_income
                     if hasattr(self, 'custom_hire_income') else None)!r}, "
                f"other_income={(self.other_income
                     if hasattr(self, 'other_income') else None)!r}, "
                f"car_and_truck={(self.car_and_truck
                     if hasattr(self, 'car_and_truck') else None)!r}, "
                f"chemicals={(self.chemicals
                     if hasattr(self, 'chemicals') else None)!r}, "
                f"conservation={(self.conservation
                     if hasattr(self, 'conservation') else None)!r}, "
                f"custom_hire_expenses={(self.custom_hire_expenses
                     if hasattr(self, 'custom_hire_expenses') else None)!r}, "
                f"depreciation={(self.depreciation
                     if hasattr(self, 'depreciation') else None)!r}, "
                f"employee_benefit_programs={(self.employee_benefit_programs
                     if hasattr(self, 'employee_benefit_programs') else None)!r}, "
                f"feed={(self.feed if hasattr(self, 'feed') else None)!r}, "
                f"fertilizers={(self.fertilizers
                     if hasattr(self, 'fertilizers') else None)!r}, "
                f"freight={(self.freight
                     if hasattr(self, 'freight') else None)!r}, "
                f"fuel={(self.fuel if hasattr(self, 'fuel') else None)!r}, "
                f"insurance={(self.insurance
                     if hasattr(self, 'insurance') else None)!r}, "
                f"mortgage_interest={(self.mortgage_interest
                     if hasattr(self, 'mortgage_interest') else None)!r}, "
                f"other_interest={(self.other_interest
                     if hasattr(self, 'other_interest') else None)!r}, "
                f"labor_hired={(self.labor_hired
                     if hasattr(self, 'labor_hired') else None)!r}, "
                f"pension={(self.pension
                     if hasattr(self, 'pension') else None)!r}, "
                f"equipment_rent={(self.equipment_rent
                     if hasattr(self, 'equipment_rent') else None)!r}, "
                f"other_rent={(self.other_rent
                     if hasattr(self, 'other_rent') else None)!r}, "
                f"repairs={(self.repairs
                     if hasattr(self, 'repairs') else None)!r}, "
                f"seeds={(self.seeds if hasattr(self, 'seeds') else None)!r}, "
                f"storage={(self.storage
                     if hasattr(self, 'storage') else None)!r}, "
                f"supplies={(self.supplies
                     if hasattr(self, 'supplies') else None)!r}, "
                f"taxes={(self.taxes if hasattr(self, 'taxes') else None)!r}, "
                f"utilities={(self.utilities
                     if hasattr(self, 'utilities') else None)!r}, "
                f"veterinary={(self.veterinary
                     if hasattr(self, 'veterinary') else None)!r}, "
                f"other_expenses={(self.other_expenses
                     if hasattr(self, 'other_expenses') else None)!r}, "
                f"capital_expenditures={(self.capital_expenditures
                     if hasattr(self, 'capital_expenditures') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"crop_or_activity={(self.crop_or_activity
                     if hasattr(self, 'crop_or_activity') else None)!s}, "
                f"sales={(self.sales if hasattr(self, 'sales') else None)!s}, "
                f"cost_of_items_sold={(self.cost_of_items_sold
                     if hasattr(self, 'cost_of_items_sold') else None)!s}, "
                f"sales_of_raised={(self.sales_of_raised
                     if hasattr(self, 'sales_of_raised') else None)!s}, "
                f"coop_distributions={(self.coop_distributions
                     if hasattr(self, 'coop_distributions') else None)!s}, "
                f"ag_program_payments={(self.ag_program_payments
                     if hasattr(self, 'ag_program_payments') else None)!s}, "
                f"ccc_loans={(self.ccc_loans
                     if hasattr(self, 'ccc_loans') else None)!s}, "
                f"crop_insurance_proceeds={(self.crop_insurance_proceeds
                     if hasattr(self, 'crop_insurance_proceeds') else None)!s}, "
                f"custom_hire_income={(self.custom_hire_income
                     if hasattr(self, 'custom_hire_income') else None)!s}, "
                f"other_income={(self.other_income
                     if hasattr(self, 'other_income') else None)!s}, "
                f"car_and_truck={(self.car_and_truck
                     if hasattr(self, 'car_and_truck') else None)!s}, "
                f"chemicals={(self.chemicals
                     if hasattr(self, 'chemicals') else None)!s}, "
                f"conservation={(self.conservation
                     if hasattr(self, 'conservation') else None)!s}, "
                f"custom_hire_expenses={(self.custom_hire_expenses
                     if hasattr(self, 'custom_hire_expenses') else None)!s}, "
                f"depreciation={(self.depreciation
                     if hasattr(self, 'depreciation') else None)!s}, "
                f"employee_benefit_programs={(self.employee_benefit_programs
                     if hasattr(self, 'employee_benefit_programs') else None)!s}, "
                f"feed={(self.feed if hasattr(self, 'feed') else None)!s}, "
                f"fertilizers={(self.fertilizers
                     if hasattr(self, 'fertilizers') else None)!s}, "
                f"freight={(self.freight
                     if hasattr(self, 'freight') else None)!s}, "
                f"fuel={(self.fuel if hasattr(self, 'fuel') else None)!s}, "
                f"insurance={(self.insurance
                     if hasattr(self, 'insurance') else None)!s}, "
                f"mortgage_interest={(self.mortgage_interest
                     if hasattr(self, 'mortgage_interest') else None)!s}, "
                f"other_interest={(self.other_interest
                     if hasattr(self, 'other_interest') else None)!s}, "
                f"labor_hired={(self.labor_hired
                     if hasattr(self, 'labor_hired') else None)!s}, "
                f"pension={(self.pension
                     if hasattr(self, 'pension') else None)!s}, "
                f"equipment_rent={(self.equipment_rent
                     if hasattr(self, 'equipment_rent') else None)!s}, "
                f"other_rent={(self.other_rent
                     if hasattr(self, 'other_rent') else None)!s}, "
                f"repairs={(self.repairs
                     if hasattr(self, 'repairs') else None)!s}, "
                f"seeds={(self.seeds if hasattr(self, 'seeds') else None)!s}, "
                f"storage={(self.storage
                     if hasattr(self, 'storage') else None)!s}, "
                f"supplies={(self.supplies
                     if hasattr(self, 'supplies') else None)!s}, "
                f"taxes={(self.taxes if hasattr(self, 'taxes') else None)!s}, "
                f"utilities={(self.utilities
                     if hasattr(self, 'utilities') else None)!s}, "
                f"veterinary={(self.veterinary
                     if hasattr(self, 'veterinary') else None)!s}, "
                f"other_expenses={(self.other_expenses
                     if hasattr(self, 'other_expenses') else None)!s}, "
                f"capital_expenditures={(self.capital_expenditures
                     if hasattr(self, 'capital_expenditures') else None)!s}, "
