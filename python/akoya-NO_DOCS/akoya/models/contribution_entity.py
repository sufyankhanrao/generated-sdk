...
class ContributionEntity(object):
    ...
    def __init__(self,
        ...
        """Initialize a ContributionEntity instance."""
        ...
        if employee_defer_pre_tax_percentage is not APIHelper.SKIP:
            self.employee_defer_pre_tax_percentage =\
                 employee_defer_pre_tax_percentage
    ...
    def from_dictionary(cls,
        ...
        employer_match_percentage =\
            dictionary.get("employerMatchPercentage")\
            if dictionary.get("employerMatchPercentage") else APIHelper.SKIP
        employer_match_amount =\
            dictionary.get("employerMatchAmount")\
            if dictionary.get("employerMatchAmount") else APIHelper.SKIP
        employee_pre_tax_amount =\
            dictionary.get("employeePreTaxAmount")\
            if dictionary.get("employeePreTaxAmount") else APIHelper.SKIP
        employee_pre_tax_percentage =\
            dictionary.get("employeePreTaxPercentage")\
            if dictionary.get("employeePreTaxPercentage") else APIHelper.SKIP
        employee_after_tax_amount =\
            dictionary.get("employeeAfterTaxAmount")\
            if dictionary.get("employeeAfterTaxAmount") else APIHelper.SKIP
        employee_after_tax_percentage =\
            dictionary.get("employeeAfterTaxPercentage")\
            if dictionary.get("employeeAfterTaxPercentage") else APIHelper.SKIP
        employee_defer_pre_tax_amount =\
            dictionary.get("employeeDeferPreTaxAmount")\
            if dictionary.get("employeeDeferPreTaxAmount") else APIHelper.SKIP
        employee_defer_pre_tax_percentage =\
            dictionary.get("employeeDeferPreTaxPercentage")\
            if dictionary.get("employeeDeferPreTaxPercentage") else APIHelper.SKIP
        employee_year_to_date =\
            dictionary.get("employeeYearToDate")\
            if dictionary.get("employeeYearToDate") else APIHelper.SKIP
        employer_year_to_date =\
            dictionary.get("employerYearToDate")\
            if dictionary.get("employerYearToDate") else APIHelper.SKIP
        rollover_contribution_percentage =\
            dictionary.get("rolloverContributionPercentage")\
            if dictionary.get("rolloverContributionPercentage") else APIHelper.SKIP
        rollover_contribution_amount =\
            dictionary.get("rolloverContributionAmount")\
            if dictionary.get("rolloverContributionAmount") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"employer_match_percentage={(self.employer_match_percentage
                     if hasattr(self, 'employer_match_percentage') else None)!r}, "
                f"employer_match_amount={(self.employer_match_amount
                     if hasattr(self, 'employer_match_amount') else None)!r}, "
                f"employee_pre_tax_amount={(self.employee_pre_tax_amount
                     if hasattr(self, 'employee_pre_tax_amount') else None)!r}, "
                f"employee_pre_tax_percentage={(self.employee_pre_tax_percentage
                     if hasattr(self, 'employee_pre_tax_percentage') else None)!r}, "
                f"employee_after_tax_amount={(self.employee_after_tax_amount
                     if hasattr(self, 'employee_after_tax_amount') else None)!r}, "
                f"employee_after_tax_percentage={(self.employee_after_tax_percentage
                     if hasattr(self, 'employee_after_tax_percentage') else None)!r}, "
                f"employee_defer_pre_tax_amount={(self.employee_defer_pre_tax_amount
                     if hasattr(self, 'employee_defer_pre_tax_amount') else None)!r}, "
                f"employee_defer_pre_tax_percentage={(self.employee_defer_pre_tax_percentage
                     if hasattr(self, 'employee_defer_pre_tax_percentage') else None)!r}, "
                f"employee_year_to_date={(self.employee_year_to_date
                     if hasattr(self, 'employee_year_to_date') else None)!r}, "
                f"employer_year_to_date={(self.employer_year_to_date
                     if hasattr(self, 'employer_year_to_date') else None)!r}, "
                f"rollover_contribution_percentage={(self.rollover_contribution_percentage
                     if hasattr(self, 'rollover_contribution_percentage') else None)!r}, "
                f"rollover_contribution_amount={(self.rollover_contribution_amount
                     if hasattr(self, 'rollover_contribution_amount') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"employer_match_percentage={(self.employer_match_percentage
                     if hasattr(self, 'employer_match_percentage') else None)!s}, "
                f"employer_match_amount={(self.employer_match_amount
                     if hasattr(self, 'employer_match_amount') else None)!s}, "
                f"employee_pre_tax_amount={(self.employee_pre_tax_amount
                     if hasattr(self, 'employee_pre_tax_amount') else None)!s}, "
                f"employee_pre_tax_percentage={(self.employee_pre_tax_percentage
                     if hasattr(self, 'employee_pre_tax_percentage') else None)!s}, "
                f"employee_after_tax_amount={(self.employee_after_tax_amount
                     if hasattr(self, 'employee_after_tax_amount') else None)!s}, "
                f"employee_after_tax_percentage={(self.employee_after_tax_percentage
                     if hasattr(self, 'employee_after_tax_percentage') else None)!s}, "
                f"employee_defer_pre_tax_amount={(self.employee_defer_pre_tax_amount
                     if hasattr(self, 'employee_defer_pre_tax_amount') else None)!s}, "
                f"employee_defer_pre_tax_percentage={(self.employee_defer_pre_tax_percentage
                     if hasattr(self, 'employee_defer_pre_tax_percentage') else None)!s}, "
                f"employee_year_to_date={(self.employee_year_to_date
                     if hasattr(self, 'employee_year_to_date') else None)!s}, "
                f"employer_year_to_date={(self.employer_year_to_date
                     if hasattr(self, 'employer_year_to_date') else None)!s}, "
                f"rollover_contribution_percentage={(self.rollover_contribution_percentage
                     if hasattr(self, 'rollover_contribution_percentage') else None)!s}, "
                f"rollover_contribution_amount={(self.rollover_contribution_amount
                     if hasattr(self, 'rollover_contribution_amount') else None)!s}, "
