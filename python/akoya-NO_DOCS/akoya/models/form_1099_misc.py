...
class Form1099Misc(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form1099Misc instance."""
        ...
        if non_qualified_deferred_compensation is not APIHelper.SKIP:
            self.non_qualified_deferred_compensation =\
                 non_qualified_deferred_compensation
    ...
    def from_dictionary(cls,
        ...
        rents =\
            dictionary.get("rents")\
            if dictionary.get("rents") else APIHelper.SKIP
        royalties =\
        ...
        fishing_boat_proceeds =\
            dictionary.get("fishingBoatProceeds")\
            if dictionary.get("fishingBoatProceeds") else APIHelper.SKIP
        medical_health_payment =\
            dictionary.get("medicalHealthPayment")\
            if dictionary.get("medicalHealthPayment") else APIHelper.SKIP
        payer_direct_sales =\
            dictionary.get("payerDirectSales")\
            if "payerDirectSales" in dictionary.keys() else APIHelper.SKIP
        substitute_payments =\
            dictionary.get("substitutePayments")\
            if dictionary.get("substitutePayments") else APIHelper.SKIP
        crop_insurance =\
            dictionary.get("cropInsurance")\
            if dictionary.get("cropInsurance") else APIHelper.SKIP
        second_tin_notice =\
            dictionary.get("secondTinNotice")\
            if "secondTinNotice" in dictionary.keys() else APIHelper.SKIP
        gross_attorney =\
            dictionary.get("grossAttorney")\
            if dictionary.get("grossAttorney") else APIHelper.SKIP
        fish_purchased =\
            dictionary.get("fishPurchased")\
            if dictionary.get("fishPurchased") else APIHelper.SKIP
        section_409_a_deferrals =\
            dictionary.get("section409ADeferrals")\
            if dictionary.get("section409ADeferrals") else APIHelper.SKIP
        foreign_account_tax_compliance =\
            dictionary.get("foreignAccountTaxCompliance")\
            if "foreignAccountTaxCompliance" in dictionary.keys() else APIHelper.SKIP
        excess_golden =\
            dictionary.get("excessGolden")\
            if dictionary.get("excessGolden") else APIHelper.SKIP
        non_qualified_deferred_compensation =\
            dictionary.get("nonQualifiedDeferredCompensation")\
            if dictionary.get("nonQualifiedDeferredCompensation") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"fishing_boat_proceeds={(self.fishing_boat_proceeds
                     if hasattr(self, 'fishing_boat_proceeds') else None)!r}, "
                f"medical_health_payment={(self.medical_health_payment
                     if hasattr(self, 'medical_health_payment') else None)!r}, "
                f"payer_direct_sales={(self.payer_direct_sales
                     if hasattr(self, 'payer_direct_sales') else None)!r}, "
                f"substitute_payments={(self.substitute_payments
                     if hasattr(self, 'substitute_payments') else None)!r}, "
                f"crop_insurance={(self.crop_insurance
                     if hasattr(self, 'crop_insurance') else None)!r}, "
                f"second_tin_notice={(self.second_tin_notice
                     if hasattr(self, 'second_tin_notice') else None)!r}, "
                f"gross_attorney={(self.gross_attorney
                     if hasattr(self, 'gross_attorney') else None)!r}, "
                f"fish_purchased={(self.fish_purchased
                     if hasattr(self, 'fish_purchased') else None)!r}, "
                f"section_409_a_deferrals={(self.section_409_a_deferrals
                     if hasattr(self, 'section_409_a_deferrals') else None)!r}, "
                ...
                f"excess_golden={(self.excess_golden
                     if hasattr(self, 'excess_golden') else None)!r}, "
                f"non_qualified_deferred_compensation={(self.non_qualified_deferred_compensation
                     if hasattr(self, 'non_qualified_deferred_compensation') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"fishing_boat_proceeds={(self.fishing_boat_proceeds
                     if hasattr(self, 'fishing_boat_proceeds') else None)!s}, "
                f"medical_health_payment={(self.medical_health_payment
                     if hasattr(self, 'medical_health_payment') else None)!s}, "
                f"payer_direct_sales={(self.payer_direct_sales
                     if hasattr(self, 'payer_direct_sales') else None)!s}, "
                f"substitute_payments={(self.substitute_payments
                     if hasattr(self, 'substitute_payments') else None)!s}, "
                f"crop_insurance={(self.crop_insurance
                     if hasattr(self, 'crop_insurance') else None)!s}, "
                f"second_tin_notice={(self.second_tin_notice
                     if hasattr(self, 'second_tin_notice') else None)!s}, "
                f"gross_attorney={(self.gross_attorney
                     if hasattr(self, 'gross_attorney') else None)!s}, "
                f"fish_purchased={(self.fish_purchased
                     if hasattr(self, 'fish_purchased') else None)!s}, "
                f"section_409_a_deferrals={(self.section_409_a_deferrals
                     if hasattr(self, 'section_409_a_deferrals') else None)!s}, "
                f"foreign_account_tax_compliance={(self.foreign_account_tax_compliance
                     if hasattr(self, 'foreign_account_tax_compliance') else None)!s}, "
                f"excess_golden={(self.excess_golden
                     if hasattr(self, 'excess_golden') else None)!s}, "
                f"non_qualified_deferred_compensation={(self.non_qualified_deferred_compensation
                     if hasattr(self, 'non_qualified_deferred_compensation') else None)!s}, "
                f"state_and_local={(self.state_and_local
