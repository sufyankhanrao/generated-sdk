...
from akoya.models.description_and_amount import (
...
class Form1120SK1(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form1120SK1 instance."""
    ...
    def from_dictionary(cls,
        ...
        corporation_beginning_shares =\
            dictionary.get("corporationBeginningShares")\
            if dictionary.get("corporationBeginningShares") else APIHelper.SKIP
        corporation_ending_shares =\
            dictionary.get("corporationEndingShares")\
            if dictionary.get("corporationEndingShares") else APIHelper.SKIP
        percent_ownership =\
            dictionary.get("percentOwnership")\
            if dictionary.get("percentOwnership") else APIHelper.SKIP
        beginning_shares =\
            dictionary.get("beginningShares")\
            if dictionary.get("beginningShares") else APIHelper.SKIP
        ending_shares =\
            dictionary.get("endingShares")\
            if dictionary.get("endingShares") else APIHelper.SKIP
        beginning_loans =\
            dictionary.get("beginningLoans")\
            if dictionary.get("beginningLoans") else APIHelper.SKIP
        ending_loans =\
            dictionary.get("endingLoans")\
            if dictionary.get("endingLoans") else APIHelper.SKIP
        ordinary_income =\
        ...
        if dictionary.get("otherIncome") is not None:
            other_income = [
                DescriptionAndAmount.from_dictionary(x)
        ...
        if dictionary.get("basisItems") is not None:
            basis_items = [
                CodeAndAmount.from_dictionary(x)
                    for x in dictionary.get("basisItems")
            ]
        else:
            basis_items = APIHelper.SKIP
        other_info = None
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"corporation_beginning_shares={(self.corporation_beginning_shares
                     if hasattr(self, 'corporation_beginning_shares') else None)!r}, "
                f"corporation_ending_shares={(self.corporation_ending_shares
                     if hasattr(self, 'corporation_ending_shares') else None)!r}, "
                f"percent_ownership={(self.percent_ownership
                     if hasattr(self, 'percent_ownership') else None)!r}, "
                f"beginning_shares={(self.beginning_shares
                     if hasattr(self, 'beginning_shares') else None)!r}, "
                f"ending_shares={(self.ending_shares
                     if hasattr(self, 'ending_shares') else None)!r}, "
                f"beginning_loans={(self.beginning_loans
                     if hasattr(self, 'beginning_loans') else None)!r}, "
                f"ending_loans={(self.ending_loans
                     if hasattr(self, 'ending_loans') else None)!r}, "
                ...
                f"basis_items={(self.basis_items
                     if hasattr(self, 'basis_items') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"corporation_beginning_shares={(self.corporation_beginning_shares
                     if hasattr(self, 'corporation_beginning_shares') else None)!s}, "
                f"corporation_ending_shares={(self.corporation_ending_shares
                     if hasattr(self, 'corporation_ending_shares') else None)!s}, "
                f"percent_ownership={(self.percent_ownership
                     if hasattr(self, 'percent_ownership') else None)!s}, "
                f"beginning_shares={(self.beginning_shares
                     if hasattr(self, 'beginning_shares') else None)!s}, "
                f"ending_shares={(self.ending_shares
                     if hasattr(self, 'ending_shares') else None)!s}, "
                f"beginning_loans={(self.beginning_loans
                     if hasattr(self, 'beginning_loans') else None)!s}, "
                f"ending_loans={(self.ending_loans
                     if hasattr(self, 'ending_loans') else None)!s}, "
                f"ordinary_income={(self.ordinary_income
                ...
                f"basis_items={(self.basis_items
                     if hasattr(self, 'basis_items') else None)!s}, "
                f"other_info={(self.other_info
