...
class SecurityDetailIrsForm1099B(object):
    ...
    def __init__(self,
        ...
        """Initialize a SecurityDetailIrsForm1099B instance."""
    ...
    def from_dictionary(cls,
        ...
        checkbox_on_form_8949 =\
            dictionary.get("checkboxOnForm8949")\
            if dictionary.get("checkboxOnForm8949") else APIHelper.SKIP
        security_name =\
            dictionary.get("securityName")\
            if dictionary.get("securityName") else APIHelper.SKIP
        number_of_shares =\
            dictionary.get("numberOfShares")\
            if dictionary.get("numberOfShares") else APIHelper.SKIP
        sale_description =\
            dictionary.get("saleDescription")\
            if dictionary.get("saleDescription") else APIHelper.SKIP
        date_acquired = dateutil.parser.parse(dictionary.get("dateAcquired")).date()\
            if dictionary.get("dateAcquired") else APIHelper.SKIP
        various_dates_acquired =\
            dictionary.get("variousDatesAcquired")\
            if "variousDatesAcquired" in dictionary.keys() else APIHelper.SKIP
        date_of_sale = dateutil.parser.parse(dictionary.get("dateOfSale")).date()\
            if dictionary.get("dateOfSale") else APIHelper.SKIP
        sales_price =\
            dictionary.get("salesPrice")\
            if dictionary.get("salesPrice") else APIHelper.SKIP
        accrued_market_discount =\
            dictionary.get("accruedMarketDiscount")\
            if dictionary.get("accruedMarketDiscount") else APIHelper.SKIP
        adjustment_codes = None
        if dictionary.get("adjustmentCodes") is not None:
            adjustment_codes = [
                CodeAndAmount.from_dictionary(x)
                    for x in dictionary.get("adjustmentCodes")
            ]
        else:
            adjustment_codes = APIHelper.SKIP
        cost_basis =\
            dictionary.get("costBasis")\
            if dictionary.get("costBasis") else APIHelper.SKIP
        corrected_cost_basis =\
            dictionary.get("correctedCostBasis")\
            if dictionary.get("correctedCostBasis") else APIHelper.SKIP
        wash_sale_loss_disallowed =\
            dictionary.get("washSaleLossDisallowed")\
            if dictionary.get("washSaleLossDisallowed") else APIHelper.SKIP
        long_or_short =\
            dictionary.get("longOrShort")\
            if dictionary.get("longOrShort") else APIHelper.SKIP
        ordinary =\
            dictionary.get("ordinary")\
            if "ordinary" in dictionary.keys() else APIHelper.SKIP
        collectible =\
            dictionary.get("collectible")\
            if "collectible" in dictionary.keys() else APIHelper.SKIP
        qof =\
            dictionary.get("qof")\
            if "qof" in dictionary.keys() else APIHelper.SKIP
        federal_tax_withheld =\
            dictionary.get("federalTaxWithheld")\
            if dictionary.get("federalTaxWithheld") else APIHelper.SKIP
        noncovered_security =\
            dictionary.get("noncoveredSecurity")\
            if "noncoveredSecurity" in dictionary.keys() else APIHelper.SKIP
        gross_or_net =\
            dictionary.get("grossOrNet")\
            if dictionary.get("grossOrNet") else APIHelper.SKIP
        loss_not_allowed =\
            dictionary.get("lossNotAllowed")\
            if "lossNotAllowed" in dictionary.keys() else APIHelper.SKIP
        basis_reported =\
            dictionary.get("basisReported")\
            if "basisReported" in dictionary.keys() else APIHelper.SKIP
        ...
        cusip =\
            ...
            if dictionary.get("cusip") else APIHelper.SKIP
        foreign_account_tax_compliance =\
            dictionary.get("foreignAccountTaxCompliance")\
            if "foreignAccountTaxCompliance" in dictionary.keys() else APIHelper.SKIP
        expired_option =\
            dictionary.get("expiredOption")\
            if dictionary.get("expiredOption") else APIHelper.SKIP
        investment_sale_type =\
            dictionary.get("investmentSaleType")\
            if dictionary.get("investmentSaleType") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"checkbox_on_form_8949={(self.checkbox_on_form_8949
                     if hasattr(self, 'checkbox_on_form_8949') else None)!r}, "
                f"security_name={(self.security_name
                     if hasattr(self, 'security_name') else None)!r}, "
                f"number_of_shares={(self.number_of_shares
                     if hasattr(self, 'number_of_shares') else None)!r}, "
                f"sale_description={(self.sale_description
                     if hasattr(self, 'sale_description') else None)!r}, "
                f"date_acquired={(self.date_acquired
                     if hasattr(self, 'date_acquired') else None)!r}, "
                f"various_dates_acquired={(self.various_dates_acquired
                     if hasattr(self, 'various_dates_acquired') else None)!r}, "
                f"date_of_sale={(self.date_of_sale
                     if hasattr(self, 'date_of_sale') else None)!r}, "
                f"sales_price={(self.sales_price
                     if hasattr(self, 'sales_price') else None)!r}, "
                f"accrued_market_discount={(self.accrued_market_discount
                     if hasattr(self, 'accrued_market_discount') else None)!r}, "
                f"adjustment_codes={(self.adjustment_codes
                     if hasattr(self, 'adjustment_codes') else None)!r}, "
                f"cost_basis={(self.cost_basis
                     if hasattr(self, 'cost_basis') else None)!r}, "
                f"corrected_cost_basis={(self.corrected_cost_basis
                     if hasattr(self, 'corrected_cost_basis') else None)!r}, "
                f"wash_sale_loss_disallowed={(self.wash_sale_loss_disallowed
                     if hasattr(self, 'wash_sale_loss_disallowed') else None)!r}, "
                f"long_or_short={(self.long_or_short
                     if hasattr(self, 'long_or_short') else None)!r}, "
                f"ordinary={(self.ordinary
                     if hasattr(self, 'ordinary') else None)!r}, "
                f"collectible={(self.collectible
                     if hasattr(self, 'collectible') else None)!r}, "
                ...
                f"noncovered_security={(self.noncovered_security
                     if hasattr(self, 'noncovered_security') else None)!r}, "
                f"gross_or_net={(self.gross_or_net
                     if hasattr(self, 'gross_or_net') else None)!r}, "
                f"loss_not_allowed={(self.loss_not_allowed
                     if hasattr(self, 'loss_not_allowed') else None)!r}, "
                f"basis_reported={(self.basis_reported
                     if hasattr(self, 'basis_reported') else None)!r}, "
                ...
                f"expired_option={(self.expired_option
                     if hasattr(self, 'expired_option') else None)!r}, "
                f"investment_sale_type={(self.investment_sale_type
                     if hasattr(self, 'investment_sale_type') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"checkbox_on_form_8949={(self.checkbox_on_form_8949
                     if hasattr(self, 'checkbox_on_form_8949') else None)!s}, "
                f"security_name={(self.security_name
                     if hasattr(self, 'security_name') else None)!s}, "
                f"number_of_shares={(self.number_of_shares
                     if hasattr(self, 'number_of_shares') else None)!s}, "
                f"sale_description={(self.sale_description
                     if hasattr(self, 'sale_description') else None)!s}, "
                f"date_acquired={(self.date_acquired
                     if hasattr(self, 'date_acquired') else None)!s}, "
                f"various_dates_acquired={(self.various_dates_acquired
                     if hasattr(self, 'various_dates_acquired') else None)!s}, "
                f"date_of_sale={(self.date_of_sale
                     if hasattr(self, 'date_of_sale') else None)!s}, "
                f"sales_price={(self.sales_price
                     if hasattr(self, 'sales_price') else None)!s}, "
                f"accrued_market_discount={(self.accrued_market_discount
                     if hasattr(self, 'accrued_market_discount') else None)!s}, "
                f"adjustment_codes={(self.adjustment_codes
                     if hasattr(self, 'adjustment_codes') else None)!s}, "
                f"cost_basis={(self.cost_basis
                     if hasattr(self, 'cost_basis') else None)!s}, "
                f"corrected_cost_basis={(self.corrected_cost_basis
                     if hasattr(self, 'corrected_cost_basis') else None)!s}, "
                f"wash_sale_loss_disallowed={(self.wash_sale_loss_disallowed
                     if hasattr(self, 'wash_sale_loss_disallowed') else None)!s}, "
                f"long_or_short={(self.long_or_short
                     if hasattr(self, 'long_or_short') else None)!s}, "
                f"ordinary={(self.ordinary
                     if hasattr(self, 'ordinary') else None)!s}, "
                f"collectible={(self.collectible
                     if hasattr(self, 'collectible') else None)!s}, "
                f"qof={(self.qof if hasattr(self, 'qof') else None)!s}, "
                f"federal_tax_withheld={(self.federal_tax_withheld
                     if hasattr(self, 'federal_tax_withheld') else None)!s}, "
                f"noncovered_security={(self.noncovered_security
                     if hasattr(self, 'noncovered_security') else None)!s}, "
                f"gross_or_net={(self.gross_or_net
                     if hasattr(self, 'gross_or_net') else None)!s}, "
                f"loss_not_allowed={(self.loss_not_allowed
                     if hasattr(self, 'loss_not_allowed') else None)!s}, "
                f"basis_reported={(self.basis_reported
                     if hasattr(self, 'basis_reported') else None)!s}, "
                f"state_and_local={(self.state_and_local
                ...
                f"expired_option={(self.expired_option
                     if hasattr(self, 'expired_option') else None)!s}, "
                f"investment_sale_type={(self.investment_sale_type
                     if hasattr(self, 'investment_sale_type') else None)!s}, "
