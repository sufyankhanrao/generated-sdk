...
class Form1099Patr(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form1099Patr instance."""
    ...
    def from_dictionary(cls,
        ...
        patronage_dividends =\
            dictionary.get("patronageDividends")\
            if dictionary.get("patronageDividends") else APIHelper.SKIP
        nonpatronage_distributions =\
            dictionary.get("nonpatronageDistributions")\
            if dictionary.get("nonpatronageDistributions") else APIHelper.SKIP
        per_unit_retain_allocations =\
            dictionary.get("perUnitRetainAllocations")\
            if dictionary.get("perUnitRetainAllocations") else APIHelper.SKIP
        federal_tax_withheld =\
            dictionary.get("federalTaxWithheld")\
            if dictionary.get("federalTaxWithheld") else APIHelper.SKIP
        redemption =\
            dictionary.get("redemption")\
            if dictionary.get("redemption") else APIHelper.SKIP
        section_199_deduction =\
            dictionary.get("section199Deduction")\
            if dictionary.get("section199Deduction") else APIHelper.SKIP
        qualified_payments =\
            dictionary.get("qualifiedPayments")\
            if dictionary.get("qualifiedPayments") else APIHelper.SKIP
        section_199_qualified_items =\
            dictionary.get("section199QualifiedItems")\
            if dictionary.get("section199QualifiedItems") else APIHelper.SKIP
        section_199_sstb_items =\
            dictionary.get("section199SstbItems")\
            if dictionary.get("section199SstbItems") else APIHelper.SKIP
        investment_credit =\
            dictionary.get("investmentCredit")\
            if dictionary.get("investmentCredit") else APIHelper.SKIP
        work_opportunity_credit =\
            dictionary.get("workOpportunityCredit")\
            if dictionary.get("workOpportunityCredit") else APIHelper.SKIP
        other_credits_and_deductions =\
            dictionary.get("otherCreditsAndDeductions")\
            if dictionary.get("otherCreditsAndDeductions") else APIHelper.SKIP
        specified_coop =\
            dictionary.get("specifiedCoop")\
            if "specifiedCoop" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"patronage_dividends={(self.patronage_dividends
                     if hasattr(self, 'patronage_dividends') else None)!r}, "
                f"nonpatronage_distributions={(self.nonpatronage_distributions
                     if hasattr(self, 'nonpatronage_distributions') else None)!r}, "
                f"per_unit_retain_allocations={(self.per_unit_retain_allocations
                     if hasattr(self, 'per_unit_retain_allocations') else None)!r}, "
                ...
                f"redemption={(self.redemption
                     if hasattr(self, 'redemption') else None)!r}, "
                f"section_199_deduction={(self.section_199_deduction
                     if hasattr(self, 'section_199_deduction') else None)!r}, "
                f"qualified_payments={(self.qualified_payments
                     if hasattr(self, 'qualified_payments') else None)!r}, "
                f"section_199_qualified_items={(self.section_199_qualified_items
                     if hasattr(self, 'section_199_qualified_items') else None)!r}, "
                f"section_199_sstb_items={(self.section_199_sstb_items
                     if hasattr(self, 'section_199_sstb_items') else None)!r}, "
                f"investment_credit={(self.investment_credit
                     if hasattr(self, 'investment_credit') else None)!r}, "
                f"work_opportunity_credit={(self.work_opportunity_credit
                     if hasattr(self, 'work_opportunity_credit') else None)!r}, "
                f"other_credits_and_deductions={(self.other_credits_and_deductions
                     if hasattr(self, 'other_credits_and_deductions') else None)!r}, "
                f"specified_coop={(self.specified_coop
                     if hasattr(self, 'specified_coop') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"patronage_dividends={(self.patronage_dividends
                     if hasattr(self, 'patronage_dividends') else None)!s}, "
                f"nonpatronage_distributions={(self.nonpatronage_distributions
                     if hasattr(self, 'nonpatronage_distributions') else None)!s}, "
                f"per_unit_retain_allocations={(self.per_unit_retain_allocations
                     if hasattr(self, 'per_unit_retain_allocations') else None)!s}, "
                f"federal_tax_withheld={(self.federal_tax_withheld
                     if hasattr(self, 'federal_tax_withheld') else None)!s}, "
                f"redemption={(self.redemption
                     if hasattr(self, 'redemption') else None)!s}, "
                f"section_199_deduction={(self.section_199_deduction
                     if hasattr(self, 'section_199_deduction') else None)!s}, "
                f"qualified_payments={(self.qualified_payments
                     if hasattr(self, 'qualified_payments') else None)!s}, "
                f"section_199_qualified_items={(self.section_199_qualified_items
                     if hasattr(self, 'section_199_qualified_items') else None)!s}, "
                f"section_199_sstb_items={(self.section_199_sstb_items
                     if hasattr(self, 'section_199_sstb_items') else None)!s}, "
                f"investment_credit={(self.investment_credit
                     if hasattr(self, 'investment_credit') else None)!s}, "
                f"work_opportunity_credit={(self.work_opportunity_credit
                     if hasattr(self, 'work_opportunity_credit') else None)!s}, "
                f"other_credits_and_deductions={(self.other_credits_and_deductions
                     if hasattr(self, 'other_credits_and_deductions') else None)!s}, "
                f"specified_coop={(self.specified_coop
                     if hasattr(self, 'specified_coop') else None)!s}, "
                f"state_and_local={(self.state_and_local
