...
class PaymentNetworkSupportedByAccount(object):
    ...
    def __init__(self,
        ...
        """Initialize a PaymentNetworkSupportedByAccount instance."""
    ...
    def from_dictionary(cls,
        ...
        bank_id =\
            ...
            if dictionary.get("bankId") else APIHelper.SKIP
        identifier =\
            dictionary.get("identifier")\
            if dictionary.get("identifier") else APIHelper.SKIP
        identifier_type =\
            dictionary.get("identifierType")\
            if dictionary.get("identifierType") else APIHelper.SKIP
        mtype =\
            dictionary.get("type")\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"bank_id={(self.bank_id
                     if hasattr(self, 'bank_id') else None)!r}, "
                f"identifier={(self.identifier
                     if hasattr(self, 'identifier') else None)!r}, "
                f"identifier_type={(self.identifier_type
                     if hasattr(self, 'identifier_type') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"bank_id={(self.bank_id
                     if hasattr(self, 'bank_id') else None)!s}, "
                f"identifier={(self.identifier
                     if hasattr(self, 'identifier') else None)!s}, "
                f"identifier_type={(self.identifier_type
                     if hasattr(self, 'identifier_type') else None)!s}, "
