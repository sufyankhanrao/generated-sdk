...
from akoya.models.health_insurance_coverage import (
    HealthInsuranceCoverage,
)
from akoya.models.health_insurance_marketplace_covered_individual import (
...
class Form1095A(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form1095A instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("links") is not None:
            ...
            links = APIHelper.SKIP
        marketplace_id =\
            dictionary.get("marketplaceId")\
            if dictionary.get("marketplaceId") else APIHelper.SKIP
        marketplace_policy_number =\
            dictionary.get("marketplacePolicyNumber")\
            if dictionary.get("marketplacePolicyNumber") else APIHelper.SKIP
        policy_issuer_name =\
            dictionary.get("policyIssuerName")\
            if dictionary.get("policyIssuerName") else APIHelper.SKIP
        recipient_date_of_birth = dateutil.parser.parse(dictionary.get("recipientDateOfBirth")).date()\
            if dictionary.get("recipientDateOfBirth") else APIHelper.SKIP
        spouse_name =\
            dictionary.get("spouseName")\
            if dictionary.get("spouseName") else APIHelper.SKIP
        spouse_tin =\
            dictionary.get("spouseTin")\
            if dictionary.get("spouseTin") else APIHelper.SKIP
        spouse_date_of_birth = dateutil.parser.parse(dictionary.get("spouseDateOfBirth")).date()\
            if dictionary.get("spouseDateOfBirth") else APIHelper.SKIP
        policy_start_date = dateutil.parser.parse(dictionary.get("policyStartDate")).date()\
            if dictionary.get("policyStartDate") else APIHelper.SKIP
        policy_termination_date = dateutil.parser.parse(dictionary.get("policyTerminationDate")).date()\
            if dictionary.get("policyTerminationDate") else APIHelper.SKIP
        covered_individuals = None
        if dictionary.get("coveredIndividuals") is not None:
            covered_individuals = [
                HealthInsuranceMarketplaceCoveredIndividual.from_dictionary(x)
                    for x in dictionary.get("coveredIndividuals")
            ]
        else:
            covered_individuals = APIHelper.SKIP
        coverages = None
        if dictionary.get("coverages") is not None:
            coverages = [
                HealthInsuranceCoverage.from_dictionary(x)
                    for x in dictionary.get("coverages")
            ]
        else:
            coverages = APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"marketplace_id={(self.marketplace_id
                     if hasattr(self, 'marketplace_id') else None)!r}, "
                f"marketplace_policy_number={(self.marketplace_policy_number
                     if hasattr(self, 'marketplace_policy_number') else None)!r}, "
                f"policy_issuer_name={(self.policy_issuer_name
                     if hasattr(self, 'policy_issuer_name') else None)!r}, "
                f"recipient_date_of_birth={(self.recipient_date_of_birth
                     if hasattr(self, 'recipient_date_of_birth') else None)!r}, "
                f"spouse_name={(self.spouse_name
                     if hasattr(self, 'spouse_name') else None)!r}, "
                f"spouse_tin={(self.spouse_tin
                     if hasattr(self, 'spouse_tin') else None)!r}, "
                f"spouse_date_of_birth={(self.spouse_date_of_birth
                     if hasattr(self, 'spouse_date_of_birth') else None)!r}, "
                f"policy_start_date={(self.policy_start_date
                     if hasattr(self, 'policy_start_date') else None)!r}, "
                f"policy_termination_date={(self.policy_termination_date
                     if hasattr(self, 'policy_termination_date') else None)!r}, "
                f"covered_individuals={(self.covered_individuals
                     if hasattr(self, 'covered_individuals') else None)!r}, "
                f"coverages={(self.coverages
                     if hasattr(self, 'coverages') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"marketplace_id={(self.marketplace_id
                     if hasattr(self, 'marketplace_id') else None)!s}, "
                f"marketplace_policy_number={(self.marketplace_policy_number
                     if hasattr(self, 'marketplace_policy_number') else None)!s}, "
                f"policy_issuer_name={(self.policy_issuer_name
                     if hasattr(self, 'policy_issuer_name') else None)!s}, "
                f"recipient_date_of_birth={(self.recipient_date_of_birth
                     if hasattr(self, 'recipient_date_of_birth') else None)!s}, "
                f"spouse_name={(self.spouse_name
                     if hasattr(self, 'spouse_name') else None)!s}, "
                f"spouse_tin={(self.spouse_tin
                     if hasattr(self, 'spouse_tin') else None)!s}, "
                f"spouse_date_of_birth={(self.spouse_date_of_birth
                     if hasattr(self, 'spouse_date_of_birth') else None)!s}, "
                f"policy_start_date={(self.policy_start_date
                     if hasattr(self, 'policy_start_date') else None)!s}, "
                f"policy_termination_date={(self.policy_termination_date
                     if hasattr(self, 'policy_termination_date') else None)!s}, "
                f"covered_individuals={(self.covered_individuals
                     if hasattr(self, 'covered_individuals') else None)!s}, "
                f"coverages={(self.coverages
                     if hasattr(self, 'coverages') else None)!s}, "
