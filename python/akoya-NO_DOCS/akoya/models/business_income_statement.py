...
class BusinessIncomeStatement(object):
    ...
    def __init__(self,
        ...
        """Initialize a BusinessIncomeStatement instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("links") is not None:
            ...
            links = APIHelper.SKIP
        business_name =\
            dictionary.get("businessName")\
            if dictionary.get("businessName") else APIHelper.SKIP
        sales =\
            dictionary.get("sales")\
            if dictionary.get("sales") else APIHelper.SKIP
        returns =\
            dictionary.get("returns")\
            if dictionary.get("returns") else APIHelper.SKIP
        other_income = None
        if dictionary.get("otherIncome") is not None:
            ...
            other_income = APIHelper.SKIP
        advertising =\
            dictionary.get("advertising")\
            if dictionary.get("advertising") else APIHelper.SKIP
        car_and_truck =\
            dictionary.get("carAndTruck")\
            if dictionary.get("carAndTruck") else APIHelper.SKIP
        commissions =\
            dictionary.get("commissions")\
            if dictionary.get("commissions") else APIHelper.SKIP
        contract_labor =\
            dictionary.get("contractLabor")\
            if dictionary.get("contractLabor") else APIHelper.SKIP
        depletion =\
            dictionary.get("depletion")\
            if dictionary.get("depletion") else APIHelper.SKIP
        depreciation =\
            dictionary.get("depreciation")\
            if dictionary.get("depreciation") else APIHelper.SKIP
        employee_benefits =\
            dictionary.get("employeeBenefits")\
            if dictionary.get("employeeBenefits") else APIHelper.SKIP
        insurance =\
        ...
        legal =\
            dictionary.get("legal")\
            if dictionary.get("legal") else APIHelper.SKIP
        office =\
            dictionary.get("office")\
            if dictionary.get("office") else APIHelper.SKIP
        pension =\
        ...
        travel =\
            dictionary.get("travel")\
            if dictionary.get("travel") else APIHelper.SKIP
        meals =\
            dictionary.get("meals")\
            if dictionary.get("meals") else APIHelper.SKIP
        utilities =\
            dictionary.get("utilities")\
            if dictionary.get("utilities") else APIHelper.SKIP
        wages =\
            dictionary.get("wages")\
            if dictionary.get("wages") else APIHelper.SKIP
        other_expenses = None
        if dictionary.get("otherExpenses") is not None:
            ...
            other_expenses = APIHelper.SKIP
        beginning_inventory =\
            dictionary.get("beginningInventory")\
            if dictionary.get("beginningInventory") else APIHelper.SKIP
        purchases =\
            dictionary.get("purchases")\
            if dictionary.get("purchases") else APIHelper.SKIP
        cost_of_labor =\
            dictionary.get("costOfLabor")\
            if dictionary.get("costOfLabor") else APIHelper.SKIP
        materials =\
            dictionary.get("materials")\
            if dictionary.get("materials") else APIHelper.SKIP
        other_costs = None
        if dictionary.get("otherCosts") is not None:
            other_costs = [
                DescriptionAndAmount.from_dictionary(x)
                    for x in dictionary.get("otherCosts")
            ]
        else:
            other_costs = APIHelper.SKIP
        ending_inventory =\
            dictionary.get("endingInventory")\
            if dictionary.get("endingInventory") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"contract_labor={(self.contract_labor
                     if hasattr(self, 'contract_labor') else None)!r}, "
                f"depletion={(self.depletion
                     if hasattr(self, 'depletion') else None)!r}, "
                f"depreciation={(self.depreciation
                     if hasattr(self, 'depreciation') else None)!r}, "
                f"employee_benefits={(self.employee_benefits
                     if hasattr(self, 'employee_benefits') else None)!r}, "
                ...
                f"beginning_inventory={(self.beginning_inventory
                     if hasattr(self, 'beginning_inventory') else None)!r}, "
                f"purchases={(self.purchases
                     if hasattr(self, 'purchases') else None)!r}, "
                f"cost_of_labor={(self.cost_of_labor
                     if hasattr(self, 'cost_of_labor') else None)!r}, "
                f"materials={(self.materials
                     if hasattr(self, 'materials') else None)!r}, "
                f"other_costs={(self.other_costs
                     if hasattr(self, 'other_costs') else None)!r}, "
                f"ending_inventory={(self.ending_inventory
                     if hasattr(self, 'ending_inventory') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"business_name={(self.business_name
                     if hasattr(self, 'business_name') else None)!s}, "
                f"sales={(self.sales if hasattr(self, 'sales') else None)!s}, "
                f"returns={(self.returns
                     if hasattr(self, 'returns') else None)!s}, "
                f"other_income={(self.other_income
                     if hasattr(self, 'other_income') else None)!s}, "
                f"advertising={(self.advertising
                     if hasattr(self, 'advertising') else None)!s}, "
                f"car_and_truck={(self.car_and_truck
                     if hasattr(self, 'car_and_truck') else None)!s}, "
                f"commissions={(self.commissions
                     if hasattr(self, 'commissions') else None)!s}, "
                f"contract_labor={(self.contract_labor
                     if hasattr(self, 'contract_labor') else None)!s}, "
                f"depletion={(self.depletion
                     if hasattr(self, 'depletion') else None)!s}, "
                f"depreciation={(self.depreciation
                     if hasattr(self, 'depreciation') else None)!s}, "
                f"employee_benefits={(self.employee_benefits
                     if hasattr(self, 'employee_benefits') else None)!s}, "
                f"insurance={(self.insurance
                ...
                f"beginning_inventory={(self.beginning_inventory
                     if hasattr(self, 'beginning_inventory') else None)!s}, "
                f"purchases={(self.purchases
                     if hasattr(self, 'purchases') else None)!s}, "
                f"cost_of_labor={(self.cost_of_labor
                     if hasattr(self, 'cost_of_labor') else None)!s}, "
                f"materials={(self.materials
                     if hasattr(self, 'materials') else None)!s}, "
                f"other_costs={(self.other_costs
                     if hasattr(self, 'other_costs') else None)!s}, "
                f"ending_inventory={(self.ending_inventory
                     if hasattr(self, 'ending_inventory') else None)!s}, "
                f"capital_expenditures={(self.capital_expenditures
