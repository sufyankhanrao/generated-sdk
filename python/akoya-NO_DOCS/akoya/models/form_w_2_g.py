...
class FormW2G(object):
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("links") is not None:
            ...
            links = APIHelper.SKIP
        winnings =\
            dictionary.get("winnings")\
            if dictionary.get("winnings") else APIHelper.SKIP
        date_won = dateutil.parser.parse(dictionary.get("dateWon")).date()\
            if dictionary.get("dateWon") else APIHelper.SKIP
        type_of_wager =\
            dictionary.get("typeOfWager")\
            if dictionary.get("typeOfWager") else APIHelper.SKIP
        federal_tax_withheld =\
            dictionary.get("federalTaxWithheld")\
            if dictionary.get("federalTaxWithheld") else APIHelper.SKIP
        transaction =\
            dictionary.get("transaction")\
            if dictionary.get("transaction") else APIHelper.SKIP
        race =\
            dictionary.get("race")\
            if dictionary.get("race") else APIHelper.SKIP
        identical_winnings =\
            dictionary.get("identicalWinnings")\
            if dictionary.get("identicalWinnings") else APIHelper.SKIP
        cashier =\
            dictionary.get("cashier")\
            if dictionary.get("cashier") else APIHelper.SKIP
        window =\
            dictionary.get("window")\
            if dictionary.get("window") else APIHelper.SKIP
        first_id =\
            dictionary.get("firstId")\
            if dictionary.get("firstId") else APIHelper.SKIP
        second_id =\
            dictionary.get("secondId")\
            if dictionary.get("secondId") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"winnings={(self.winnings
                     if hasattr(self, 'winnings') else None)!r}, "
                f"date_won={(self.date_won
                     if hasattr(self, 'date_won') else None)!r}, "
                f"type_of_wager={(self.type_of_wager
                     if hasattr(self, 'type_of_wager') else None)!r}, "
                ...
                f"transaction={(self.transaction
                     if hasattr(self, 'transaction') else None)!r}, "
                f"race={(self.race if hasattr(self, 'race') else None)!r}, "
                f"identical_winnings={(self.identical_winnings
                     if hasattr(self, 'identical_winnings') else None)!r}, "
                f"cashier={(self.cashier
                     if hasattr(self, 'cashier') else None)!r}, "
                f"window={(self.window if hasattr(self, 'window') else None)!r}, "
                f"first_id={(self.first_id
                     if hasattr(self, 'first_id') else None)!r}, "
                f"second_id={(self.second_id
                     if hasattr(self, 'second_id') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"winnings={(self.winnings
                     if hasattr(self, 'winnings') else None)!s}, "
                f"date_won={(self.date_won
                     if hasattr(self, 'date_won') else None)!s}, "
                f"type_of_wager={(self.type_of_wager
                     if hasattr(self, 'type_of_wager') else None)!s}, "
                f"federal_tax_withheld={(self.federal_tax_withheld
                     if hasattr(self, 'federal_tax_withheld') else None)!s}, "
                f"transaction={(self.transaction
                     if hasattr(self, 'transaction') else None)!s}, "
                f"race={(self.race if hasattr(self, 'race') else None)!s}, "
                f"identical_winnings={(self.identical_winnings
                     if hasattr(self, 'identical_winnings') else None)!s}, "
                f"cashier={(self.cashier
                     if hasattr(self, 'cashier') else None)!s}, "
                f"window={(self.window if hasattr(self, 'window') else None)!s}, "
                f"first_id={(self.first_id
                     if hasattr(self, 'first_id') else None)!s}, "
                f"second_id={(self.second_id
                     if hasattr(self, 'second_id') else None)!s}, "
                f"state_and_local={(self.state_and_local
