...
class Form1099S(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form1099S instance."""
    ...
    def from_dictionary(cls,
        ...
        date_of_closing = dateutil.parser.parse(dictionary.get("dateOfClosing")).date()\
            if dictionary.get("dateOfClosing") else APIHelper.SKIP
        gross_proceeds =\
            dictionary.get("grossProceeds")\
            if dictionary.get("grossProceeds") else APIHelper.SKIP
        address_or_legal_description =\
            dictionary.get("addressOrLegalDescription")\
            if dictionary.get("addressOrLegalDescription") else APIHelper.SKIP
        received_other_consideration =\
            dictionary.get("receivedOtherConsideration")\
            if "receivedOtherConsideration" in dictionary.keys() else APIHelper.SKIP
        foreign_person =\
            dictionary.get("foreignPerson")\
            if "foreignPerson" in dictionary.keys() else APIHelper.SKIP
        real_estate_tax =\
            dictionary.get("realEstateTax")\
            if dictionary.get("realEstateTax") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"date_of_closing={(self.date_of_closing
                     if hasattr(self, 'date_of_closing') else None)!r}, "
                f"gross_proceeds={(self.gross_proceeds
                     if hasattr(self, 'gross_proceeds') else None)!r}, "
                f"address_or_legal_description={(self.address_or_legal_description
                     if hasattr(self, 'address_or_legal_description') else None)!r}, "
                f"received_other_consideration={(self.received_other_consideration
                     if hasattr(self, 'received_other_consideration') else None)!r}, "
                f"foreign_person={(self.foreign_person
                     if hasattr(self, 'foreign_person') else None)!r}, "
                f"real_estate_tax={(self.real_estate_tax
                     if hasattr(self, 'real_estate_tax') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"date_of_closing={(self.date_of_closing
                     if hasattr(self, 'date_of_closing') else None)!s}, "
                f"gross_proceeds={(self.gross_proceeds
                     if hasattr(self, 'gross_proceeds') else None)!s}, "
                f"address_or_legal_description={(self.address_or_legal_description
                     if hasattr(self, 'address_or_legal_description') else None)!s}, "
                f"received_other_consideration={(self.received_other_consideration
                     if hasattr(self, 'received_other_consideration') else None)!s}, "
                f"foreign_person={(self.foreign_person
                     if hasattr(self, 'foreign_person') else None)!s}, "
                f"real_estate_tax={(self.real_estate_tax
                     if hasattr(self, 'real_estate_tax') else None)!s}, "
