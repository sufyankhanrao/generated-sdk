...
class OpenOrderEntity(object):
    ...
    def __init__(self,
        ...
        """Initialize a OpenOrderEntity instance."""
        ...
        if order_date is not APIHelper.SKIP:
            self.order_date =\
                ...
                order_date, APIHelper.RFC3339DateTime) if order_date else None
    ...
    def from_dictionary(cls,
        ...
        order_type =\
            ...
            if dictionary.get("orderType") else APIHelper.SKIP
        order_date = APIHelper.RFC3339DateTime.from_value(
            dictionary.get("orderDate")).datetime\
        ...
        order_duration =\
            dictionary.get("orderDuration")\
            if dictionary.get("orderDuration") else APIHelper.SKIP
        sub_account =\
            dictionary.get("subAccount")\
            if dictionary.get("subAccount") else APIHelper.SKIP
        limit_price =\
            dictionary.get("limitPrice")\
            if dictionary.get("limitPrice") else APIHelper.SKIP
        stop_price =\
            dictionary.get("stopPrice")\
            if dictionary.get("stopPrice") else APIHelper.SKIP
        inv_401_k_source =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"order_type={(self.order_type
                     if hasattr(self, 'order_type') else None)!r}, "
                ...
                f"order_duration={(self.order_duration
                     if hasattr(self, 'order_duration') else None)!r}, "
                f"sub_account={(self.sub_account
                     if hasattr(self, 'sub_account') else None)!r}, "
                f"limit_price={(self.limit_price
                     if hasattr(self, 'limit_price') else None)!r}, "
                f"stop_price={(self.stop_price
                     if hasattr(self, 'stop_price') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"order_type={(self.order_type
                     if hasattr(self, 'order_type') else None)!s}, "
                f"order_date={(self.order_date
                ...
                f"order_duration={(self.order_duration
                     if hasattr(self, 'order_duration') else None)!s}, "
                f"sub_account={(self.sub_account
                     if hasattr(self, 'sub_account') else None)!s}, "
                f"limit_price={(self.limit_price
                     if hasattr(self, 'limit_price') else None)!s}, "
                f"stop_price={(self.stop_price
                     if hasattr(self, 'stop_price') else None)!s}, "
                f"inv_401_k_source={(self.inv_401_k_source
