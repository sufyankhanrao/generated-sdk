...
class Form1041K1(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form1041K1 instance."""
    ...
    def from_dictionary(cls,
        ...
        form_1041_t =\
            dictionary.get("form1041T")\
            if "form1041T" in dictionary.keys() else APIHelper.SKIP
        date_1041_t = dateutil.parser.parse(dictionary.get("date1041T")).date()\
            if dictionary.get("date1041T") else APIHelper.SKIP
        final_1041 =\
            dictionary.get("final1041")\
            if "final1041" in dictionary.keys() else APIHelper.SKIP
        domestic =\
        ...
        gain_28_rate =\
            dictionary.get("gain28Rate")\
            if dictionary.get("gain28Rate") else APIHelper.SKIP
        unrecaptured_1250_gain =\
            dictionary.get("unrecaptured1250Gain")\
            if dictionary.get("unrecaptured1250Gain") else APIHelper.SKIP
        other_portfolio_income =\
            dictionary.get("otherPortfolioIncome")\
            if dictionary.get("otherPortfolioIncome") else APIHelper.SKIP
        ordinary_business_income =\
            dictionary.get("ordinaryBusinessIncome")\
            if dictionary.get("ordinaryBusinessIncome") else APIHelper.SKIP
        net_rental_real_estate_income =\
        ...
        if dictionary.get("directlyApportionedDeductions") is not None:
            directly_apportioned_deductions = [
                CodeAndAmount.from_dictionary(x)
                    for x in dictionary.get("directlyApportionedDeductions")
            ]
        else:
            directly_apportioned_deductions = APIHelper.SKIP
        estate_tax_deduction =\
            dictionary.get("estateTaxDeduction")\
            if dictionary.get("estateTaxDeduction") else APIHelper.SKIP
        final_year_deductions = None
        if dictionary.get("finalYearDeductions") is not None:
            final_year_deductions = [
                CodeAndAmount.from_dictionary(x)
                    for x in dictionary.get("finalYearDeductions")
            ]
        else:
            final_year_deductions = APIHelper.SKIP
        fiduciary = TaxParty.from_dictionary(
            dictionary.get("fiduciary"))\
            if "fiduciary" in dictionary.keys() else APIHelper.SKIP
        amt_adjustments = None
        if dictionary.get("amtAdjustments") is not None:
            amt_adjustments = [
                CodeAndAmount.from_dictionary(x)
                    for x in dictionary.get("amtAdjustments")
            ]
        else:
            amt_adjustments = APIHelper.SKIP
        credits = None
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"form_1041_t={(self.form_1041_t
                     if hasattr(self, 'form_1041_t') else None)!r}, "
                f"date_1041_t={(self.date_1041_t
                     if hasattr(self, 'date_1041_t') else None)!r}, "
                f"final_1041={(self.final_1041
                     if hasattr(self, 'final_1041') else None)!r}, "
                ...
                f"gain_28_rate={(self.gain_28_rate
                     if hasattr(self, 'gain_28_rate') else None)!r}, "
                f"unrecaptured_1250_gain={(self.unrecaptured_1250_gain
                     if hasattr(self, 'unrecaptured_1250_gain') else None)!r}, "
                f"other_portfolio_income={(self.other_portfolio_income
                     if hasattr(self, 'other_portfolio_income') else None)!r}, "
                f"ordinary_business_income={(self.ordinary_business_income
                     if hasattr(self, 'ordinary_business_income') else None)!r}, "
                ...
                f"directly_apportioned_deductions={(self.directly_apportioned_deductions
                     if hasattr(self, 'directly_apportioned_deductions') else None)!r}, "
                f"estate_tax_deduction={(self.estate_tax_deduction
                     if hasattr(self, 'estate_tax_deduction') else None)!r}, "
                f"final_year_deductions={(self.final_year_deductions
                     if hasattr(self, 'final_year_deductions') else None)!r}, "
                f"fiduciary={(self.fiduciary
                     if hasattr(self, 'fiduciary') else None)!r}, "
                f"amt_adjustments={(self.amt_adjustments
                     if hasattr(self, 'amt_adjustments') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"form_1041_t={(self.form_1041_t
                     if hasattr(self, 'form_1041_t') else None)!s}, "
                f"date_1041_t={(self.date_1041_t
                     if hasattr(self, 'date_1041_t') else None)!s}, "
                f"final_1041={(self.final_1041
                     if hasattr(self, 'final_1041') else None)!s}, "
                f"domestic={(self.domestic
                ...
                f"gain_28_rate={(self.gain_28_rate
                     if hasattr(self, 'gain_28_rate') else None)!s}, "
                f"unrecaptured_1250_gain={(self.unrecaptured_1250_gain
                     if hasattr(self, 'unrecaptured_1250_gain') else None)!s}, "
                f"other_portfolio_income={(self.other_portfolio_income
                     if hasattr(self, 'other_portfolio_income') else None)!s}, "
                f"ordinary_business_income={(self.ordinary_business_income
                     if hasattr(self, 'ordinary_business_income') else None)!s}, "
                f"net_rental_real_estate_income={(self.net_rental_real_estate_income
                     if hasattr(self, 'net_rental_real_estate_income') else None)!s}, "
                f"other_rental_income={(self.other_rental_income
                     if hasattr(self, 'other_rental_income') else None)!s}, "
                f"directly_apportioned_deductions={(self.directly_apportioned_deductions
                     if hasattr(self, 'directly_apportioned_deductions') else None)!s}, "
                f"estate_tax_deduction={(self.estate_tax_deduction
                     if hasattr(self, 'estate_tax_deduction') else None)!s}, "
                f"final_year_deductions={(self.final_year_deductions
                     if hasattr(self, 'final_year_deductions') else None)!s}, "
                f"fiduciary={(self.fiduciary
                     if hasattr(self, 'fiduciary') else None)!s}, "
                f"amt_adjustments={(self.amt_adjustments
                     if hasattr(self, 'amt_adjustments') else None)!s}, "
                f"credits={(self.credits
