...
class Form5498Qa(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form5498Qa instance."""
    ...
    def from_dictionary(cls,
        ...
        able_contributions =\
            dictionary.get("ableContributions")\
            if dictionary.get("ableContributions") else APIHelper.SKIP
        rollovers =\
            dictionary.get("rollovers")\
            if dictionary.get("rollovers") else APIHelper.SKIP
        cumulative_contributions =\
            dictionary.get("cumulativeContributions")\
            if dictionary.get("cumulativeContributions") else APIHelper.SKIP
        fair_market_value =\
            dictionary.get("fairMarketValue")\
            if dictionary.get("fairMarketValue") else APIHelper.SKIP
        opened_in_tax_year =\
            dictionary.get("openedInTaxYear")\
            if "openedInTaxYear" in dictionary.keys() else APIHelper.SKIP
        basis_of_disability_code =\
            dictionary.get("basisOfDisabilityCode")\
            if dictionary.get("basisOfDisabilityCode") else APIHelper.SKIP
        type_of_disability_code =\
            dictionary.get("typeOfDisabilityCode")\
            if dictionary.get("typeOfDisabilityCode") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"able_contributions={(self.able_contributions
                     if hasattr(self, 'able_contributions') else None)!r}, "
                f"rollovers={(self.rollovers
                     if hasattr(self, 'rollovers') else None)!r}, "
                f"cumulative_contributions={(self.cumulative_contributions
                     if hasattr(self, 'cumulative_contributions') else None)!r}, "
                f"fair_market_value={(self.fair_market_value
                     if hasattr(self, 'fair_market_value') else None)!r}, "
                f"opened_in_tax_year={(self.opened_in_tax_year
                     if hasattr(self, 'opened_in_tax_year') else None)!r}, "
                f"basis_of_disability_code={(self.basis_of_disability_code
                     if hasattr(self, 'basis_of_disability_code') else None)!r}, "
                f"type_of_disability_code={(self.type_of_disability_code
                     if hasattr(self, 'type_of_disability_code') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"able_contributions={(self.able_contributions
                     if hasattr(self, 'able_contributions') else None)!s}, "
                f"rollovers={(self.rollovers
                     if hasattr(self, 'rollovers') else None)!s}, "
                f"cumulative_contributions={(self.cumulative_contributions
                     if hasattr(self, 'cumulative_contributions') else None)!s}, "
                f"fair_market_value={(self.fair_market_value
                     if hasattr(self, 'fair_market_value') else None)!s}, "
                f"opened_in_tax_year={(self.opened_in_tax_year
                     if hasattr(self, 'opened_in_tax_year') else None)!s}, "
                f"basis_of_disability_code={(self.basis_of_disability_code
                     if hasattr(self, 'basis_of_disability_code') else None)!s}, "
                f"type_of_disability_code={(self.type_of_disability_code
                     if hasattr(self, 'type_of_disability_code') else None)!s}, "
