...
class Form1099Int(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form1099Int instance."""
    ...
    def from_dictionary(cls,
        ...
        payer_rtn =\
            dictionary.get("payerRtn")\
            if dictionary.get("payerRtn") else APIHelper.SKIP
        interest_income =\
            dictionary.get("interestIncome")\
            if dictionary.get("interestIncome") else APIHelper.SKIP
        early_withdrawal_penalty =\
            dictionary.get("earlyWithdrawalPenalty")\
            if dictionary.get("earlyWithdrawalPenalty") else APIHelper.SKIP
        us_bond_interest =\
            dictionary.get("usBondInterest")\
            if dictionary.get("usBondInterest") else APIHelper.SKIP
        federal_tax_withheld =\
        ...
        tax_exempt_interest =\
            dictionary.get("taxExemptInterest")\
            if dictionary.get("taxExemptInterest") else APIHelper.SKIP
        specified_pab_interest =\
            dictionary.get("specifiedPabInterest")\
            if dictionary.get("specifiedPabInterest") else APIHelper.SKIP
        market_discount =\
            dictionary.get("marketDiscount")\
            if dictionary.get("marketDiscount") else APIHelper.SKIP
        bond_premium =\
            dictionary.get("bondPremium")\
            if dictionary.get("bondPremium") else APIHelper.SKIP
        us_bond_premium =\
            dictionary.get("usBondPremium")\
            if dictionary.get("usBondPremium") else APIHelper.SKIP
        tax_exempt_bond_premium =\
            dictionary.get("taxExemptBondPremium")\
            if dictionary.get("taxExemptBondPremium") else APIHelper.SKIP
        cusip_number =\
            dictionary.get("cusipNumber")\
            if dictionary.get("cusipNumber") else APIHelper.SKIP
        ...
        if dictionary.get("stateTaxExemptIncome") is not None:
            state_tax_exempt_income = [
                DescriptionAndAmount.from_dictionary(x)
                    for x in dictionary.get("stateTaxExemptIncome")
            ]
        else:
            state_tax_exempt_income = APIHelper.SKIP
        second_tin_notice =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"payer_rtn={(self.payer_rtn
                     if hasattr(self, 'payer_rtn') else None)!r}, "
                f"interest_income={(self.interest_income
                     if hasattr(self, 'interest_income') else None)!r}, "
                f"early_withdrawal_penalty={(self.early_withdrawal_penalty
                     if hasattr(self, 'early_withdrawal_penalty') else None)!r}, "
                f"us_bond_interest={(self.us_bond_interest
                     if hasattr(self, 'us_bond_interest') else None)!r}, "
                ...
                f"tax_exempt_interest={(self.tax_exempt_interest
                     if hasattr(self, 'tax_exempt_interest') else None)!r}, "
                f"specified_pab_interest={(self.specified_pab_interest
                     if hasattr(self, 'specified_pab_interest') else None)!r}, "
                f"market_discount={(self.market_discount
                     if hasattr(self, 'market_discount') else None)!r}, "
                f"bond_premium={(self.bond_premium
                     if hasattr(self, 'bond_premium') else None)!r}, "
                f"us_bond_premium={(self.us_bond_premium
                     if hasattr(self, 'us_bond_premium') else None)!r}, "
                f"tax_exempt_bond_premium={(self.tax_exempt_bond_premium
                     if hasattr(self, 'tax_exempt_bond_premium') else None)!r}, "
                f"cusip_number={(self.cusip_number
                     if hasattr(self, 'cusip_number') else None)!r}, "
                ...
                f"state_tax_exempt_income={(self.state_tax_exempt_income
                     if hasattr(self, 'state_tax_exempt_income') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"payer_rtn={(self.payer_rtn
                     if hasattr(self, 'payer_rtn') else None)!s}, "
                f"interest_income={(self.interest_income
                     if hasattr(self, 'interest_income') else None)!s}, "
                f"early_withdrawal_penalty={(self.early_withdrawal_penalty
                     if hasattr(self, 'early_withdrawal_penalty') else None)!s}, "
                f"us_bond_interest={(self.us_bond_interest
                     if hasattr(self, 'us_bond_interest') else None)!s}, "
                f"federal_tax_withheld={(self.federal_tax_withheld
                ...
                f"tax_exempt_interest={(self.tax_exempt_interest
                     if hasattr(self, 'tax_exempt_interest') else None)!s}, "
                f"specified_pab_interest={(self.specified_pab_interest
                     if hasattr(self, 'specified_pab_interest') else None)!s}, "
                f"market_discount={(self.market_discount
                     if hasattr(self, 'market_discount') else None)!s}, "
                f"bond_premium={(self.bond_premium
                     if hasattr(self, 'bond_premium') else None)!s}, "
                f"us_bond_premium={(self.us_bond_premium
                     if hasattr(self, 'us_bond_premium') else None)!s}, "
                f"tax_exempt_bond_premium={(self.tax_exempt_bond_premium
                     if hasattr(self, 'tax_exempt_bond_premium') else None)!s}, "
                f"cusip_number={(self.cusip_number
                     if hasattr(self, 'cusip_number') else None)!s}, "
                f"state_and_local={(self.state_and_local
                     if hasattr(self, 'state_and_local') else None)!s}, "
                f"foreign_incomes={(self.foreign_incomes
                     if hasattr(self, 'foreign_incomes') else None)!s}, "
                f"state_tax_exempt_income={(self.state_tax_exempt_income
                     if hasattr(self, 'state_tax_exempt_income') else None)!s}, "
                f"second_tin_notice={(self.second_tin_notice
