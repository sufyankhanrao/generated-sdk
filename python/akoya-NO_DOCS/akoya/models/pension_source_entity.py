...
class PensionSourceEntity(object):
    ...
    def __init__(self,
        ...
        """Initialize a PensionSourceEntity instance."""
        ...
        if as_of_date is not APIHelper.SKIP:
            self.as_of_date =\
                ...
                as_of_date, APIHelper.RFC3339DateTime) if as_of_date else None
    ...
    def from_dictionary(cls,
        ...
        payment_option =\
            dictionary.get("paymentOption")\
            if dictionary.get("paymentOption") else APIHelper.SKIP
        as_of_date = APIHelper.RFC3339DateTime.from_value(
            dictionary.get("asOfDate")).datetime\
            if dictionary.get("asOfDate") else APIHelper.SKIP
        frequency =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"payment_option={(self.payment_option
                     if hasattr(self, 'payment_option') else None)!r}, "
                f"as_of_date={(self.as_of_date
                     if hasattr(self, 'as_of_date') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"payment_option={(self.payment_option
                     if hasattr(self, 'payment_option') else None)!s}, "
                f"as_of_date={(self.as_of_date
                     if hasattr(self, 'as_of_date') else None)!s}, "
                f"frequency={(self.frequency
