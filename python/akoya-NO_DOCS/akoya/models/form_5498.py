...
class Form5498(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form5498 instance."""
    ...
    def from_dictionary(cls,
        ...
        ira_contributions =\
            dictionary.get("iraContributions")\
            if dictionary.get("iraContributions") else APIHelper.SKIP
        rollover_contributions =\
            dictionary.get("rolloverContributions")\
            if dictionary.get("rolloverContributions") else APIHelper.SKIP
        roth_ira_conversion =\
            dictionary.get("rothIraConversion")\
            if dictionary.get("rothIraConversion") else APIHelper.SKIP
        recharacterized_contributions =\
            dictionary.get("recharacterizedContributions")\
            if dictionary.get("recharacterizedContributions") else APIHelper.SKIP
        fair_market_value =\
            dictionary.get("fairMarketValue")\
            if dictionary.get("fairMarketValue") else APIHelper.SKIP
        life_insurance_cost =\
            dictionary.get("lifeInsuranceCost")\
            if dictionary.get("lifeInsuranceCost") else APIHelper.SKIP
        ira =\
            dictionary.get("ira")\
            if "ira" in dictionary.keys() else APIHelper.SKIP
        sep =\
            dictionary.get("sep")\
            if "sep" in dictionary.keys() else APIHelper.SKIP
        simple =\
            dictionary.get("simple")\
            if "simple" in dictionary.keys() else APIHelper.SKIP
        roth_ira =\
            dictionary.get("rothIra")\
            if "rothIra" in dictionary.keys() else APIHelper.SKIP
        sep_contributions =\
            dictionary.get("sepContributions")\
            if dictionary.get("sepContributions") else APIHelper.SKIP
        simple_contributions =\
            dictionary.get("simpleContributions")\
            if dictionary.get("simpleContributions") else APIHelper.SKIP
        roth_ira_contributions =\
            dictionary.get("rothIraContributions")\
            if dictionary.get("rothIraContributions") else APIHelper.SKIP
        rmd_next_year =\
            dictionary.get("rmdNextYear")\
            if "rmdNextYear" in dictionary.keys() else APIHelper.SKIP
        rmd_date = dateutil.parser.parse(dictionary.get("rmdDate")).date()\
            if dictionary.get("rmdDate") else APIHelper.SKIP
        rmd_amount =\
            dictionary.get("rmdAmount")\
            if dictionary.get("rmdAmount") else APIHelper.SKIP
        postponed_contribution =\
            dictionary.get("postponedContribution")\
            if dictionary.get("postponedContribution") else APIHelper.SKIP
        postponed_year =\
            dictionary.get("postponedYear")\
            if dictionary.get("postponedYear") else APIHelper.SKIP
        postponed_code =\
            dictionary.get("postponedCode")\
            if dictionary.get("postponedCode") else APIHelper.SKIP
        repayments =\
            dictionary.get("repayments")\
            if dictionary.get("repayments") else APIHelper.SKIP
        repay_code =\
            dictionary.get("repayCode")\
            if dictionary.get("repayCode") else APIHelper.SKIP
        fmv_specified_assets =\
            dictionary.get("fmvSpecifiedAssets")\
            if dictionary.get("fmvSpecifiedAssets") else APIHelper.SKIP
        specified_codes =\
            dictionary.get("specifiedCodes")\
            if dictionary.get("specifiedCodes") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"ira_contributions={(self.ira_contributions
                     if hasattr(self, 'ira_contributions') else None)!r}, "
                f"rollover_contributions={(self.rollover_contributions
                     if hasattr(self, 'rollover_contributions') else None)!r}, "
                f"roth_ira_conversion={(self.roth_ira_conversion
                     if hasattr(self, 'roth_ira_conversion') else None)!r}, "
                f"recharacterized_contributions={(self.recharacterized_contributions
                     if hasattr(self, 'recharacterized_contributions') else None)!r}, "
                f"fair_market_value={(self.fair_market_value
                     if hasattr(self, 'fair_market_value') else None)!r}, "
                f"life_insurance_cost={(self.life_insurance_cost
                     if hasattr(self, 'life_insurance_cost') else None)!r}, "
                ...
                f"roth_ira={(self.roth_ira
                     if hasattr(self, 'roth_ira') else None)!r}, "
                f"sep_contributions={(self.sep_contributions
                     if hasattr(self, 'sep_contributions') else None)!r}, "
                f"simple_contributions={(self.simple_contributions
                     if hasattr(self, 'simple_contributions') else None)!r}, "
                f"roth_ira_contributions={(self.roth_ira_contributions
                     if hasattr(self, 'roth_ira_contributions') else None)!r}, "
                f"rmd_next_year={(self.rmd_next_year
                     if hasattr(self, 'rmd_next_year') else None)!r}, "
                f"rmd_date={(self.rmd_date
                     if hasattr(self, 'rmd_date') else None)!r}, "
                f"rmd_amount={(self.rmd_amount
                     if hasattr(self, 'rmd_amount') else None)!r}, "
                f"postponed_contribution={(self.postponed_contribution
                     if hasattr(self, 'postponed_contribution') else None)!r}, "
                f"postponed_year={(self.postponed_year
                     if hasattr(self, 'postponed_year') else None)!r}, "
                f"postponed_code={(self.postponed_code
                     if hasattr(self, 'postponed_code') else None)!r}, "
                f"repayments={(self.repayments
                     if hasattr(self, 'repayments') else None)!r}, "
                f"repay_code={(self.repay_code
                     if hasattr(self, 'repay_code') else None)!r}, "
                f"fmv_specified_assets={(self.fmv_specified_assets
                     if hasattr(self, 'fmv_specified_assets') else None)!r}, "
                f"specified_codes={(self.specified_codes
                     if hasattr(self, 'specified_codes') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"ira_contributions={(self.ira_contributions
                     if hasattr(self, 'ira_contributions') else None)!s}, "
                f"rollover_contributions={(self.rollover_contributions
                     if hasattr(self, 'rollover_contributions') else None)!s}, "
                f"roth_ira_conversion={(self.roth_ira_conversion
                     if hasattr(self, 'roth_ira_conversion') else None)!s}, "
                f"recharacterized_contributions={(self.recharacterized_contributions
                     if hasattr(self, 'recharacterized_contributions') else None)!s}, "
                f"fair_market_value={(self.fair_market_value
                     if hasattr(self, 'fair_market_value') else None)!s}, "
                f"life_insurance_cost={(self.life_insurance_cost
                     if hasattr(self, 'life_insurance_cost') else None)!s}, "
                ...
                f"roth_ira={(self.roth_ira
                     if hasattr(self, 'roth_ira') else None)!s}, "
                f"sep_contributions={(self.sep_contributions
                     if hasattr(self, 'sep_contributions') else None)!s}, "
                f"simple_contributions={(self.simple_contributions
                     if hasattr(self, 'simple_contributions') else None)!s}, "
                f"roth_ira_contributions={(self.roth_ira_contributions
                     if hasattr(self, 'roth_ira_contributions') else None)!s}, "
                f"rmd_next_year={(self.rmd_next_year
                     if hasattr(self, 'rmd_next_year') else None)!s}, "
                f"rmd_date={(self.rmd_date
                     if hasattr(self, 'rmd_date') else None)!s}, "
                f"rmd_amount={(self.rmd_amount
                     if hasattr(self, 'rmd_amount') else None)!s}, "
                f"postponed_contribution={(self.postponed_contribution
                     if hasattr(self, 'postponed_contribution') else None)!s}, "
                f"postponed_year={(self.postponed_year
                     if hasattr(self, 'postponed_year') else None)!s}, "
                f"postponed_code={(self.postponed_code
                     if hasattr(self, 'postponed_code') else None)!s}, "
                f"repayments={(self.repayments
                     if hasattr(self, 'repayments') else None)!s}, "
                f"repay_code={(self.repay_code
                     if hasattr(self, 'repay_code') else None)!s}, "
                f"fmv_specified_assets={(self.fmv_specified_assets
                     if hasattr(self, 'fmv_specified_assets') else None)!s}, "
                f"specified_codes={(self.specified_codes
                     if hasattr(self, 'specified_codes') else None)!s}, "
