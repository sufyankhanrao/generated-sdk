...
class Form1099ConsolidatedStatement(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form1099ConsolidatedStatement instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("links") is not None:
            ...
            links = APIHelper.SKIP
        margin_interest_paid =\
            dictionary.get("marginInterestPaid")\
            if dictionary.get("marginInterestPaid") else APIHelper.SKIP
        payment_in_lieu_paid =\
            dictionary.get("paymentInLieuPaid")\
            if dictionary.get("paymentInLieuPaid") else APIHelper.SKIP
        advisor_fees_paid =\
            dictionary.get("advisorFeesPaid")\
            if dictionary.get("advisorFeesPaid") else APIHelper.SKIP
        other_fees_paid =\
            dictionary.get("otherFeesPaid")\
            if dictionary.get("otherFeesPaid") else APIHelper.SKIP
        corporate_bond_interest_paid =\
            dictionary.get("corporateBondInterestPaid")\
            if dictionary.get("corporateBondInterestPaid") else APIHelper.SKIP
        us_bond_interest_paid =\
            dictionary.get("usBondInterestPaid")\
            if dictionary.get("usBondInterestPaid") else APIHelper.SKIP
        tax_exempt_interest_paid =\
            dictionary.get("taxExemptInterestPaid")\
            if dictionary.get("taxExemptInterestPaid") else APIHelper.SKIP
        specified_pab_interest_paid =\
            dictionary.get("specifiedPabInterestPaid")\
            if dictionary.get("specifiedPabInterestPaid") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"margin_interest_paid={(self.margin_interest_paid
                     if hasattr(self, 'margin_interest_paid') else None)!r}, "
                f"payment_in_lieu_paid={(self.payment_in_lieu_paid
                     if hasattr(self, 'payment_in_lieu_paid') else None)!r}, "
                f"advisor_fees_paid={(self.advisor_fees_paid
                     if hasattr(self, 'advisor_fees_paid') else None)!r}, "
                f"other_fees_paid={(self.other_fees_paid
                     if hasattr(self, 'other_fees_paid') else None)!r}, "
                f"corporate_bond_interest_paid={(self.corporate_bond_interest_paid
                     if hasattr(self, 'corporate_bond_interest_paid') else None)!r}, "
                f"us_bond_interest_paid={(self.us_bond_interest_paid
                     if hasattr(self, 'us_bond_interest_paid') else None)!r}, "
                f"tax_exempt_interest_paid={(self.tax_exempt_interest_paid
                     if hasattr(self, 'tax_exempt_interest_paid') else None)!r}, "
                f"specified_pab_interest_paid={(self.specified_pab_interest_paid
                     if hasattr(self, 'specified_pab_interest_paid') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"margin_interest_paid={(self.margin_interest_paid
                     if hasattr(self, 'margin_interest_paid') else None)!s}, "
                f"payment_in_lieu_paid={(self.payment_in_lieu_paid
                     if hasattr(self, 'payment_in_lieu_paid') else None)!s}, "
                f"advisor_fees_paid={(self.advisor_fees_paid
                     if hasattr(self, 'advisor_fees_paid') else None)!s}, "
                f"other_fees_paid={(self.other_fees_paid
                     if hasattr(self, 'other_fees_paid') else None)!s}, "
                f"corporate_bond_interest_paid={(self.corporate_bond_interest_paid
                     if hasattr(self, 'corporate_bond_interest_paid') else None)!s}, "
                f"us_bond_interest_paid={(self.us_bond_interest_paid
                     if hasattr(self, 'us_bond_interest_paid') else None)!s}, "
                f"tax_exempt_interest_paid={(self.tax_exempt_interest_paid
                     if hasattr(self, 'tax_exempt_interest_paid') else None)!s}, "
                f"specified_pab_interest_paid={(self.specified_pab_interest_paid
                     if hasattr(self, 'specified_pab_interest_paid') else None)!s}, "
