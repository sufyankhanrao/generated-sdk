...
class AccountHolderEntity(object):
    ...
    Attributes:
        ...
        accounts (List[str]): Optional list of accounts associated with the
            customer
        relationship (AccountHolderEntityRelationship): Customer's
    ...
    def __init__(self,
        ...
        """Initialize a AccountHolderEntity instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("addresses") is not None:
            addresses = [
                AddressInfo.from_dictionary(x)
                    for x in dictionary.get("addresses")
            ]
        else:
            addresses = APIHelper.SKIP
        telephones =\
            dictionary.get("telephones")\
            if "telephones" in dictionary.keys() else APIHelper.SKIP
        email =\
        ...
        relationship =\
            ...
            if dictionary.get("relationship") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"telephones={(self.telephones
                     if hasattr(self, 'telephones') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"telephones={(self.telephones
                     if hasattr(self, 'telephones') else None)!s}, "
