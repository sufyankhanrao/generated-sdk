...
class Form1099R(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form1099R instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("links") is not None:
            ...
            links = APIHelper.SKIP
        allocable_to_irr =\
            dictionary.get("allocableToIRR")\
            if dictionary.get("allocableToIRR") else APIHelper.SKIP
        first_year_of_roth =\
            dictionary.get("firstYearOfRoth")\
            if dictionary.get("firstYearOfRoth") else APIHelper.SKIP
        recipient_account_number =\
            dictionary.get("recipientAccountNumber")\
            if dictionary.get("recipientAccountNumber") else APIHelper.SKIP
        gross_distribution =\
            dictionary.get("grossDistribution")\
            if dictionary.get("grossDistribution") else APIHelper.SKIP
        taxable_amount =\
            dictionary.get("taxableAmount")\
            if dictionary.get("taxableAmount") else APIHelper.SKIP
        taxable_amount_not_determined =\
            dictionary.get("taxableAmountNotDetermined")\
            if "taxableAmountNotDetermined" in dictionary.keys() else APIHelper.SKIP
        total_distribution =\
            dictionary.get("totalDistribution")\
            if "totalDistribution" in dictionary.keys() else APIHelper.SKIP
        capital_gain =\
            dictionary.get("capitalGain")\
            if dictionary.get("capitalGain") else APIHelper.SKIP
        federal_tax_withheld =\
            dictionary.get("federalTaxWithheld")\
            if dictionary.get("federalTaxWithheld") else APIHelper.SKIP
        employee_contributions =\
            dictionary.get("employeeContributions")\
            if dictionary.get("employeeContributions") else APIHelper.SKIP
        net_unrealized_appreciation =\
            dictionary.get("netUnrealizedAppreciation")\
            if dictionary.get("netUnrealizedAppreciation") else APIHelper.SKIP
        distribution_codes =\
            dictionary.get("distributionCodes")\
            if dictionary.get("distributionCodes") else APIHelper.SKIP
        ira_sep_simple =\
            dictionary.get("iraSepSimple")\
            if "iraSepSimple" in dictionary.keys() else APIHelper.SKIP
        other_amount =\
            dictionary.get("otherAmount")\
            if dictionary.get("otherAmount") else APIHelper.SKIP
        other_percent =\
            dictionary.get("otherPercent")\
            if dictionary.get("otherPercent") else APIHelper.SKIP
        your_percent_of_total =\
            dictionary.get("yourPercentOfTotal")\
            if dictionary.get("yourPercentOfTotal") else APIHelper.SKIP
        total_employee_contributions =\
            dictionary.get("totalEmployeeContributions")\
            if dictionary.get("totalEmployeeContributions") else APIHelper.SKIP
        foreign_account_tax_compliance =\
            dictionary.get("foreignAccountTaxCompliance")\
            if "foreignAccountTaxCompliance" in dictionary.keys() else APIHelper.SKIP
        date_of_payment = dateutil.parser.parse(dictionary.get("dateOfPayment")).date()\
            if dictionary.get("dateOfPayment") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"allocable_to_irr={(self.allocable_to_irr
                     if hasattr(self, 'allocable_to_irr') else None)!r}, "
                f"first_year_of_roth={(self.first_year_of_roth
                     if hasattr(self, 'first_year_of_roth') else None)!r}, "
                f"recipient_account_number={(self.recipient_account_number
                     if hasattr(self, 'recipient_account_number') else None)!r}, "
                f"gross_distribution={(self.gross_distribution
                     if hasattr(self, 'gross_distribution') else None)!r}, "
                f"taxable_amount={(self.taxable_amount
                     if hasattr(self, 'taxable_amount') else None)!r}, "
                f"taxable_amount_not_determined={(self.taxable_amount_not_determined
                     if hasattr(self, 'taxable_amount_not_determined') else None)!r}, "
                f"total_distribution={(self.total_distribution
                     if hasattr(self, 'total_distribution') else None)!r}, "
                f"capital_gain={(self.capital_gain
                     if hasattr(self, 'capital_gain') else None)!r}, "
                f"federal_tax_withheld={(self.federal_tax_withheld
                     if hasattr(self, 'federal_tax_withheld') else None)!r}, "
                f"employee_contributions={(self.employee_contributions
                     if hasattr(self, 'employee_contributions') else None)!r}, "
                f"net_unrealized_appreciation={(self.net_unrealized_appreciation
                     if hasattr(self, 'net_unrealized_appreciation') else None)!r}, "
                f"distribution_codes={(self.distribution_codes
                     if hasattr(self, 'distribution_codes') else None)!r}, "
                f"ira_sep_simple={(self.ira_sep_simple
                     if hasattr(self, 'ira_sep_simple') else None)!r}, "
                f"other_amount={(self.other_amount
                     if hasattr(self, 'other_amount') else None)!r}, "
                f"other_percent={(self.other_percent
                     if hasattr(self, 'other_percent') else None)!r}, "
                f"your_percent_of_total={(self.your_percent_of_total
                     if hasattr(self, 'your_percent_of_total') else None)!r}, "
                f"total_employee_contributions={(self.total_employee_contributions
                     if hasattr(self, 'total_employee_contributions') else None)!r}, "
                ...
                f"date_of_payment={(self.date_of_payment
                     if hasattr(self, 'date_of_payment') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"allocable_to_irr={(self.allocable_to_irr
                     if hasattr(self, 'allocable_to_irr') else None)!s}, "
                f"first_year_of_roth={(self.first_year_of_roth
                     if hasattr(self, 'first_year_of_roth') else None)!s}, "
                f"recipient_account_number={(self.recipient_account_number
                     if hasattr(self, 'recipient_account_number') else None)!s}, "
                f"gross_distribution={(self.gross_distribution
                     if hasattr(self, 'gross_distribution') else None)!s}, "
                f"taxable_amount={(self.taxable_amount
                     if hasattr(self, 'taxable_amount') else None)!s}, "
                f"taxable_amount_not_determined={(self.taxable_amount_not_determined
                     if hasattr(self, 'taxable_amount_not_determined') else None)!s}, "
                f"total_distribution={(self.total_distribution
                     if hasattr(self, 'total_distribution') else None)!s}, "
                f"capital_gain={(self.capital_gain
                     if hasattr(self, 'capital_gain') else None)!s}, "
                f"federal_tax_withheld={(self.federal_tax_withheld
                     if hasattr(self, 'federal_tax_withheld') else None)!s}, "
                f"employee_contributions={(self.employee_contributions
                     if hasattr(self, 'employee_contributions') else None)!s}, "
                f"net_unrealized_appreciation={(self.net_unrealized_appreciation
                     if hasattr(self, 'net_unrealized_appreciation') else None)!s}, "
                f"distribution_codes={(self.distribution_codes
                     if hasattr(self, 'distribution_codes') else None)!s}, "
                f"ira_sep_simple={(self.ira_sep_simple
                     if hasattr(self, 'ira_sep_simple') else None)!s}, "
                f"other_amount={(self.other_amount
                     if hasattr(self, 'other_amount') else None)!s}, "
                f"other_percent={(self.other_percent
                     if hasattr(self, 'other_percent') else None)!s}, "
                f"your_percent_of_total={(self.your_percent_of_total
                     if hasattr(self, 'your_percent_of_total') else None)!s}, "
                f"total_employee_contributions={(self.total_employee_contributions
                     if hasattr(self, 'total_employee_contributions') else None)!s}, "
                f"foreign_account_tax_compliance={(self.foreign_account_tax_compliance
                     if hasattr(self, 'foreign_account_tax_compliance') else None)!s}, "
                f"date_of_payment={(self.date_of_payment
                     if hasattr(self, 'date_of_payment') else None)!s}, "
                f"state_and_local={(self.state_and_local
