...
from akoya.models.tax_form_attribute import (
    TaxFormAttribute,
)
...
class Form1065K1(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form1065K1 instance."""
        ...
        if nonrecourse_liability_share_begin is not APIHelper.SKIP:
            self.nonrecourse_liability_share_begin =\
                 nonrecourse_liability_share_begin
    ...
    def from_dictionary(cls,
        ...
        tax_year =\
            dictionary.get("taxYear")\
            if dictionary.get("taxYear") else APIHelper.SKIP
        corrected =\
            dictionary.get("corrected")\
            if "corrected" in dictionary.keys() else APIHelper.SKIP
        account_id =\
            dictionary.get("accountId")\
            if dictionary.get("accountId") else APIHelper.SKIP
        tax_form_id =\
            dictionary.get("taxFormId")\
            if dictionary.get("taxFormId") else APIHelper.SKIP
        tax_form_date = dateutil.parser.parse(dictionary.get("taxFormDate")).date()\
            if dictionary.get("taxFormDate") else APIHelper.SKIP
        additional_information =\
            dictionary.get("additionalInformation")\
            if dictionary.get("additionalInformation") else APIHelper.SKIP
        tax_form_type =\
            dictionary.get("taxFormType")\
            if dictionary.get("taxFormType") else APIHelper.SKIP
        issuer = TaxParty.from_dictionary(
            dictionary.get("issuer"))\
            if "issuer" in dictionary.keys() else APIHelper.SKIP
        recipient = TaxParty.from_dictionary(
            dictionary.get("recipient"))\
            if "recipient" in dictionary.keys() else APIHelper.SKIP
        attributes = None
        if dictionary.get("attributes") is not None:
            attributes = [
                TaxFormAttribute.from_dictionary(x)
                    for x in dictionary.get("attributes")
            ]
        else:
            attributes = APIHelper.SKIP
        error = Error.from_dictionary(
            dictionary.get("error"))\
            if "error" in dictionary.keys() else APIHelper.SKIP
        links = None
        if dictionary.get("links") is not None:
            links = [
                HateoasLink.from_dictionary(x)
                    for x in dictionary.get("links")
            ]
        else:
            links = APIHelper.SKIP
        fiscal_year_begin = dateutil.parser.parse(dictionary.get("fiscalYearBegin")).date()\
            if dictionary.get("fiscalYearBegin") else APIHelper.SKIP
        fiscal_year_end = dateutil.parser.parse(dictionary.get("fiscalYearEnd")).date()\
            if dictionary.get("fiscalYearEnd") else APIHelper.SKIP
        final_k_1 =\
            dictionary.get("finalK1")\
            if "finalK1" in dictionary.keys() else APIHelper.SKIP
        amended_k_1 =\
            dictionary.get("amendedK1")\
            if "amendedK1" in dictionary.keys() else APIHelper.SKIP
        irs_center =\
            dictionary.get("irsCenter")\
            if dictionary.get("irsCenter") else APIHelper.SKIP
        publicly_traded =\
            dictionary.get("publiclyTraded")\
            if "publiclyTraded" in dictionary.keys() else APIHelper.SKIP
        general_partner =\
            dictionary.get("generalPartner")\
            if "generalPartner" in dictionary.keys() else APIHelper.SKIP
        limited_partner =\
            dictionary.get("limitedPartner")\
            if "limitedPartner" in dictionary.keys() else APIHelper.SKIP
        domestic =\
            dictionary.get("domestic")\
            if "domestic" in dictionary.keys() else APIHelper.SKIP
        foreign =\
            dictionary.get("foreign")\
            if "foreign" in dictionary.keys() else APIHelper.SKIP
        disregarded_entity =\
            dictionary.get("disregardedEntity")\
            if "disregardedEntity" in dictionary.keys() else APIHelper.SKIP
        disregarded_entity_tin =\
            dictionary.get("disregardedEntityTin")\
            if dictionary.get("disregardedEntityTin") else APIHelper.SKIP
        disregarded_entity_name =\
            dictionary.get("disregardedEntityName")\
            if dictionary.get("disregardedEntityName") else APIHelper.SKIP
        entity_type =\
            dictionary.get("entityType")\
            if dictionary.get("entityType") else APIHelper.SKIP
        retirement_plan =\
            dictionary.get("retirementPlan")\
            if "retirementPlan" in dictionary.keys() else APIHelper.SKIP
        profit_share_begin =\
            dictionary.get("profitShareBegin")\
            if dictionary.get("profitShareBegin") else APIHelper.SKIP
        profit_share_end =\
            dictionary.get("profitShareEnd")\
            if dictionary.get("profitShareEnd") else APIHelper.SKIP
        loss_share_begin =\
            dictionary.get("lossShareBegin")\
            if dictionary.get("lossShareBegin") else APIHelper.SKIP
        loss_share_end =\
            dictionary.get("lossShareEnd")\
            if dictionary.get("lossShareEnd") else APIHelper.SKIP
        capital_share_begin =\
            dictionary.get("capitalShareBegin")\
            if dictionary.get("capitalShareBegin") else APIHelper.SKIP
        capital_share_end =\
            dictionary.get("capitalShareEnd")\
            if dictionary.get("capitalShareEnd") else APIHelper.SKIP
        decrease_due_to_sale_or_exchange =\
            dictionary.get("decreaseDueToSaleOrExchange")\
            if "decreaseDueToSaleOrExchange" in dictionary.keys() else APIHelper.SKIP
        decrease_due_to_sale =\
            dictionary.get("decreaseDueToSale")\
            if "decreaseDueToSale" in dictionary.keys() else APIHelper.SKIP
        decrease_due_to_exchange =\
            dictionary.get("decreaseDueToExchange")\
            if "decreaseDueToExchange" in dictionary.keys() else APIHelper.SKIP
        nonrecourse_liability_share_begin =\
            dictionary.get("nonrecourseLiabilityShareBegin")\
            if dictionary.get("nonrecourseLiabilityShareBegin") else APIHelper.SKIP
        nonrecourse_liability_share_end =\
            dictionary.get("nonrecourseLiabilityShareEnd")\
            if dictionary.get("nonrecourseLiabilityShareEnd") else APIHelper.SKIP
        qualified_liability_share_begin =\
            dictionary.get("qualifiedLiabilityShareBegin")\
            if dictionary.get("qualifiedLiabilityShareBegin") else APIHelper.SKIP
        qualified_liability_share_end =\
            dictionary.get("qualifiedLiabilityShareEnd")\
            if dictionary.get("qualifiedLiabilityShareEnd") else APIHelper.SKIP
        recourse_liability_share_begin =\
            dictionary.get("recourseLiabilityShareBegin")\
            if dictionary.get("recourseLiabilityShareBegin") else APIHelper.SKIP
        recourse_liability_share_end =\
            dictionary.get("recourseLiabilityShareEnd")\
            if dictionary.get("recourseLiabilityShareEnd") else APIHelper.SKIP
        includes_lower_tier_liability =\
            dictionary.get("includesLowerTierLiability")\
            if "includesLowerTierLiability" in dictionary.keys() else APIHelper.SKIP
        liability_subject_to_guarantees =\
            dictionary.get("liabilitySubjectToGuarantees")\
            if "liabilitySubjectToGuarantees" in dictionary.keys() else APIHelper.SKIP
        capital_account_begin =\
            dictionary.get("capitalAccountBegin")\
            if dictionary.get("capitalAccountBegin") else APIHelper.SKIP
        capital_account_contributions =\
            dictionary.get("capitalAccountContributions")\
            if dictionary.get("capitalAccountContributions") else APIHelper.SKIP
        capital_account_increase =\
            dictionary.get("capitalAccountIncrease")\
            if dictionary.get("capitalAccountIncrease") else APIHelper.SKIP
        capital_account_other =\
            dictionary.get("capitalAccountOther")\
            if dictionary.get("capitalAccountOther") else APIHelper.SKIP
        capital_account_withdrawals =\
            dictionary.get("capitalAccountWithdrawals")\
            if dictionary.get("capitalAccountWithdrawals") else APIHelper.SKIP
        capital_account_end =\
            dictionary.get("capitalAccountEnd")\
            if dictionary.get("capitalAccountEnd") else APIHelper.SKIP
        built_in_gain =\
            dictionary.get("builtInGain")\
            if "builtInGain" in dictionary.keys() else APIHelper.SKIP
        unrecognized_section_704_begin =\
            dictionary.get("unrecognizedSection704Begin")\
            if dictionary.get("unrecognizedSection704Begin") else APIHelper.SKIP
        unrecognized_section_704_end =\
            dictionary.get("unrecognizedSection704End")\
            if dictionary.get("unrecognizedSection704End") else APIHelper.SKIP
        ordinary_income =\
            dictionary.get("ordinaryIncome")\
            if dictionary.get("ordinaryIncome") else APIHelper.SKIP
        net_rental_real_estate_income =\
            dictionary.get("netRentalRealEstateIncome")\
            if dictionary.get("netRentalRealEstateIncome") else APIHelper.SKIP
        other_rental_income =\
            dictionary.get("otherRentalIncome")\
            if dictionary.get("otherRentalIncome") else APIHelper.SKIP
        guaranteed_payment_services =\
            dictionary.get("guaranteedPaymentServices")\
            if dictionary.get("guaranteedPaymentServices") else APIHelper.SKIP
        guaranteed_payment_capital =\
            dictionary.get("guaranteedPaymentCapital")\
            if dictionary.get("guaranteedPaymentCapital") else APIHelper.SKIP
        guaranteed_payment =\
            dictionary.get("guaranteedPayment")\
            if dictionary.get("guaranteedPayment") else APIHelper.SKIP
        interest_income =\
            dictionary.get("interestIncome")\
            if dictionary.get("interestIncome") else APIHelper.SKIP
        ordinary_dividends =\
            dictionary.get("ordinaryDividends")\
            if dictionary.get("ordinaryDividends") else APIHelper.SKIP
        qualified_dividends =\
            dictionary.get("qualifiedDividends")\
            if dictionary.get("qualifiedDividends") else APIHelper.SKIP
        dividend_equivalents =\
            dictionary.get("dividendEquivalents")\
            if dictionary.get("dividendEquivalents") else APIHelper.SKIP
        royalties =\
            dictionary.get("royalties")\
            if dictionary.get("royalties") else APIHelper.SKIP
        net_short_term_gain =\
            dictionary.get("netShortTermGain")\
            if dictionary.get("netShortTermGain") else APIHelper.SKIP
        net_long_term_gain =\
            dictionary.get("netLongTermGain")\
            if dictionary.get("netLongTermGain") else APIHelper.SKIP
        collectibles_gain =\
            dictionary.get("collectiblesGain")\
            if dictionary.get("collectiblesGain") else APIHelper.SKIP
        unrecaptured_1250_gain =\
            dictionary.get("unrecaptured1250Gain")\
            if dictionary.get("unrecaptured1250Gain") else APIHelper.SKIP
        net_1231_gain =\
            dictionary.get("net1231Gain")\
            if dictionary.get("net1231Gain") else APIHelper.SKIP
        other_income = None
        if dictionary.get("otherIncome") is not None:
            other_income = [
                CodeAndAmount.from_dictionary(x)
                    for x in dictionary.get("otherIncome")
            ]
        else:
            other_income = APIHelper.SKIP
        section_179_deduction =\
            dictionary.get("section179Deduction")\
            if dictionary.get("section179Deduction") else APIHelper.SKIP
        other_deductions = None
        if dictionary.get("otherDeductions") is not None:
            other_deductions = [
                CodeAndAmount.from_dictionary(x)
                    for x in dictionary.get("otherDeductions")
            ]
        else:
            other_deductions = APIHelper.SKIP
        ...
        if dictionary.get("selfEmployment") is not None:
            self_employment = [
                CodeAndAmount.from_dictionary(x)
                    for x in dictionary.get("selfEmployment")
            ]
        else:
            self_employment = APIHelper.SKIP
        credits = None
        if dictionary.get("credits") is not None:
            ...
            credits = APIHelper.SKIP
        schedule_k_3 =\
            dictionary.get("scheduleK3")\
            if "scheduleK3" in dictionary.keys() else APIHelper.SKIP
        amt_items = None
        if dictionary.get("amtItems") is not None:
            amt_items = [
                CodeAndAmount.from_dictionary(x)
                    for x in dictionary.get("amtItems")
            ]
        else:
            amt_items = APIHelper.SKIP
        ...
        if dictionary.get("taxExemptIncome") is not None:
            tax_exempt_income = [
                CodeAndAmount.from_dictionary(x)
                    for x in dictionary.get("taxExemptIncome")
            ]
        else:
            tax_exempt_income = APIHelper.SKIP
        distributions = None
        if dictionary.get("distributions") is not None:
            distributions = [
                CodeAndAmount.from_dictionary(x)
                    for x in dictionary.get("distributions")
            ]
        else:
            distributions = APIHelper.SKIP
        other_info = None
        if dictionary.get("otherInfo") is not None:
            other_info = [
                CodeAndAmount.from_dictionary(x)
                    for x in dictionary.get("otherInfo")
            ]
        else:
            other_info = APIHelper.SKIP
        foreign_tax_paid =\
            dictionary.get("foreignTaxPaid")\
            if dictionary.get("foreignTaxPaid") else APIHelper.SKIP
        multiple_at_risk_activities =\
            dictionary.get("multipleAtRiskActivities")\
            if "multipleAtRiskActivities" in dictionary.keys() else APIHelper.SKIP
        multiple_passive_activities =\
            dictionary.get("multiplePassiveActivities")\
            if "multiplePassiveActivities" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"tax_year={(self.tax_year
                     if hasattr(self, 'tax_year') else None)!r}, "
                f"corrected={(self.corrected
                     if hasattr(self, 'corrected') else None)!r}, "
                f"account_id={(self.account_id
                     if hasattr(self, 'account_id') else None)!r}, "
                f"tax_form_id={(self.tax_form_id
                     if hasattr(self, 'tax_form_id') else None)!r}, "
                f"tax_form_date={(self.tax_form_date
                     if hasattr(self, 'tax_form_date') else None)!r}, "
                f"additional_information={(self.additional_information
                     if hasattr(self, 'additional_information') else None)!r}, "
                f"tax_form_type={(self.tax_form_type
                     if hasattr(self, 'tax_form_type') else None)!r}, "
                ...
                f"fiscal_year_begin={(self.fiscal_year_begin
                     if hasattr(self, 'fiscal_year_begin') else None)!r}, "
                f"fiscal_year_end={(self.fiscal_year_end
                     if hasattr(self, 'fiscal_year_end') else None)!r}, "
                f"final_k_1={(self.final_k_1
                     if hasattr(self, 'final_k_1') else None)!r}, "
                f"amended_k_1={(self.amended_k_1
                     if hasattr(self, 'amended_k_1') else None)!r}, "
                f"irs_center={(self.irs_center
                     if hasattr(self, 'irs_center') else None)!r}, "
                f"publicly_traded={(self.publicly_traded
                     if hasattr(self, 'publicly_traded') else None)!r}, "
                f"general_partner={(self.general_partner
                     if hasattr(self, 'general_partner') else None)!r}, "
                f"limited_partner={(self.limited_partner
                     if hasattr(self, 'limited_partner') else None)!r}, "
                f"domestic={(self.domestic
                     if hasattr(self, 'domestic') else None)!r}, "
                f"foreign={(self.foreign
                     if hasattr(self, 'foreign') else None)!r}, "
                f"disregarded_entity={(self.disregarded_entity
                     if hasattr(self, 'disregarded_entity') else None)!r}, "
                f"disregarded_entity_tin={(self.disregarded_entity_tin
                     if hasattr(self, 'disregarded_entity_tin') else None)!r}, "
                f"disregarded_entity_name={(self.disregarded_entity_name
                     if hasattr(self, 'disregarded_entity_name') else None)!r}, "
                f"entity_type={(self.entity_type
                     if hasattr(self, 'entity_type') else None)!r}, "
                f"retirement_plan={(self.retirement_plan
                     if hasattr(self, 'retirement_plan') else None)!r}, "
                f"profit_share_begin={(self.profit_share_begin
                     if hasattr(self, 'profit_share_begin') else None)!r}, "
                f"profit_share_end={(self.profit_share_end
                     if hasattr(self, 'profit_share_end') else None)!r}, "
                f"loss_share_begin={(self.loss_share_begin
                     if hasattr(self, 'loss_share_begin') else None)!r}, "
                f"loss_share_end={(self.loss_share_end
                     if hasattr(self, 'loss_share_end') else None)!r}, "
                f"capital_share_begin={(self.capital_share_begin
                     if hasattr(self, 'capital_share_begin') else None)!r}, "
                f"capital_share_end={(self.capital_share_end
                     if hasattr(self, 'capital_share_end') else None)!r}, "
                f"decrease_due_to_sale_or_exchange={(self.decrease_due_to_sale_or_exchange
                     if hasattr(self, 'decrease_due_to_sale_or_exchange') else None)!r}, "
                f"decrease_due_to_sale={(self.decrease_due_to_sale
                     if hasattr(self, 'decrease_due_to_sale') else None)!r}, "
                f"decrease_due_to_exchange={(self.decrease_due_to_exchange
                     if hasattr(self, 'decrease_due_to_exchange') else None)!r}, "
                f"nonrecourse_liability_share_begin={(self.nonrecourse_liability_share_begin
                     if hasattr(self, 'nonrecourse_liability_share_begin') else None)!r}, "
                f"nonrecourse_liability_share_end={(self.nonrecourse_liability_share_end
                     if hasattr(self, 'nonrecourse_liability_share_end') else None)!r}, "
                f"qualified_liability_share_begin={(self.qualified_liability_share_begin
                     if hasattr(self, 'qualified_liability_share_begin') else None)!r}, "
                f"qualified_liability_share_end={(self.qualified_liability_share_end
                     if hasattr(self, 'qualified_liability_share_end') else None)!r}, "
                f"recourse_liability_share_begin={(self.recourse_liability_share_begin
                     if hasattr(self, 'recourse_liability_share_begin') else None)!r}, "
                f"recourse_liability_share_end={(self.recourse_liability_share_end
                     if hasattr(self, 'recourse_liability_share_end') else None)!r}, "
                f"includes_lower_tier_liability={(self.includes_lower_tier_liability
                     if hasattr(self, 'includes_lower_tier_liability') else None)!r}, "
                f"liability_subject_to_guarantees={(self.liability_subject_to_guarantees
                     if hasattr(self, 'liability_subject_to_guarantees') else None)!r}, "
                f"capital_account_begin={(self.capital_account_begin
                     if hasattr(self, 'capital_account_begin') else None)!r}, "
                f"capital_account_contributions={(self.capital_account_contributions
                     if hasattr(self, 'capital_account_contributions') else None)!r}, "
                f"capital_account_increase={(self.capital_account_increase
                     if hasattr(self, 'capital_account_increase') else None)!r}, "
                f"capital_account_other={(self.capital_account_other
                     if hasattr(self, 'capital_account_other') else None)!r}, "
                f"capital_account_withdrawals={(self.capital_account_withdrawals
                     if hasattr(self, 'capital_account_withdrawals') else None)!r}, "
                f"capital_account_end={(self.capital_account_end
                     if hasattr(self, 'capital_account_end') else None)!r}, "
                f"built_in_gain={(self.built_in_gain
                     if hasattr(self, 'built_in_gain') else None)!r}, "
                f"unrecognized_section_704_begin={(self.unrecognized_section_704_begin
                     if hasattr(self, 'unrecognized_section_704_begin') else None)!r}, "
                f"unrecognized_section_704_end={(self.unrecognized_section_704_end
                     if hasattr(self, 'unrecognized_section_704_end') else None)!r}, "
                f"ordinary_income={(self.ordinary_income
                     if hasattr(self, 'ordinary_income') else None)!r}, "
                f"net_rental_real_estate_income={(self.net_rental_real_estate_income
                     if hasattr(self, 'net_rental_real_estate_income') else None)!r}, "
                f"other_rental_income={(self.other_rental_income
                     if hasattr(self, 'other_rental_income') else None)!r}, "
                f"guaranteed_payment_services={(self.guaranteed_payment_services
                     if hasattr(self, 'guaranteed_payment_services') else None)!r}, "
                f"guaranteed_payment_capital={(self.guaranteed_payment_capital
                     if hasattr(self, 'guaranteed_payment_capital') else None)!r}, "
                f"guaranteed_payment={(self.guaranteed_payment
                     if hasattr(self, 'guaranteed_payment') else None)!r}, "
                f"interest_income={(self.interest_income
                     if hasattr(self, 'interest_income') else None)!r}, "
                f"ordinary_dividends={(self.ordinary_dividends
                     if hasattr(self, 'ordinary_dividends') else None)!r}, "
                f"qualified_dividends={(self.qualified_dividends
                     if hasattr(self, 'qualified_dividends') else None)!r}, "
                f"dividend_equivalents={(self.dividend_equivalents
                     if hasattr(self, 'dividend_equivalents') else None)!r}, "
                f"royalties={(self.royalties
                     if hasattr(self, 'royalties') else None)!r}, "
                f"net_short_term_gain={(self.net_short_term_gain
                     if hasattr(self, 'net_short_term_gain') else None)!r}, "
                f"net_long_term_gain={(self.net_long_term_gain
                     if hasattr(self, 'net_long_term_gain') else None)!r}, "
                f"collectibles_gain={(self.collectibles_gain
                     if hasattr(self, 'collectibles_gain') else None)!r}, "
                f"unrecaptured_1250_gain={(self.unrecaptured_1250_gain
                     if hasattr(self, 'unrecaptured_1250_gain') else None)!r}, "
                f"net_1231_gain={(self.net_1231_gain
                     if hasattr(self, 'net_1231_gain') else None)!r}, "
                f"other_income={(self.other_income
                     if hasattr(self, 'other_income') else None)!r}, "
                f"section_179_deduction={(self.section_179_deduction
                     if hasattr(self, 'section_179_deduction') else None)!r}, "
                f"other_deductions={(self.other_deductions
                     if hasattr(self, 'other_deductions') else None)!r}, "
                f"self_employment={(self.self_employment
                     if hasattr(self, 'self_employment') else None)!r}, "
                f"credits={(self.credits
                     if hasattr(self, 'credits') else None)!r}, "
                f"schedule_k_3={(self.schedule_k_3
                     if hasattr(self, 'schedule_k_3') else None)!r}, "
                f"amt_items={(self.amt_items
                     if hasattr(self, 'amt_items') else None)!r}, "
                f"tax_exempt_income={(self.tax_exempt_income
                     if hasattr(self, 'tax_exempt_income') else None)!r}, "
                f"distributions={(self.distributions
                     if hasattr(self, 'distributions') else None)!r}, "
                f"other_info={(self.other_info
                     if hasattr(self, 'other_info') else None)!r}, "
                f"foreign_tax_paid={(self.foreign_tax_paid
                     if hasattr(self, 'foreign_tax_paid') else None)!r}, "
                f"multiple_at_risk_activities={(self.multiple_at_risk_activities
                     if hasattr(self, 'multiple_at_risk_activities') else None)!r}, "
                f"multiple_passive_activities={(self.multiple_passive_activities
                     if hasattr(self, 'multiple_passive_activities') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"tax_year={(self.tax_year
                     if hasattr(self, 'tax_year') else None)!s}, "
                f"corrected={(self.corrected
                     if hasattr(self, 'corrected') else None)!s}, "
                f"account_id={(self.account_id
                     if hasattr(self, 'account_id') else None)!s}, "
                f"tax_form_id={(self.tax_form_id
                     if hasattr(self, 'tax_form_id') else None)!s}, "
                f"tax_form_date={(self.tax_form_date
                     if hasattr(self, 'tax_form_date') else None)!s}, "
                f"additional_information={(self.additional_information
                     if hasattr(self, 'additional_information') else None)!s}, "
                f"tax_form_type={(self.tax_form_type
                     if hasattr(self, 'tax_form_type') else None)!s}, "
                ...
                f"fiscal_year_begin={(self.fiscal_year_begin
                     if hasattr(self, 'fiscal_year_begin') else None)!s}, "
                f"fiscal_year_end={(self.fiscal_year_end
                     if hasattr(self, 'fiscal_year_end') else None)!s}, "
                f"final_k_1={(self.final_k_1
                     if hasattr(self, 'final_k_1') else None)!s}, "
                f"amended_k_1={(self.amended_k_1
                     if hasattr(self, 'amended_k_1') else None)!s}, "
                f"irs_center={(self.irs_center
                     if hasattr(self, 'irs_center') else None)!s}, "
                f"publicly_traded={(self.publicly_traded
                     if hasattr(self, 'publicly_traded') else None)!s}, "
                f"general_partner={(self.general_partner
                     if hasattr(self, 'general_partner') else None)!s}, "
                f"limited_partner={(self.limited_partner
                     if hasattr(self, 'limited_partner') else None)!s}, "
                f"domestic={(self.domestic
                     if hasattr(self, 'domestic') else None)!s}, "
                f"foreign={(self.foreign
                     if hasattr(self, 'foreign') else None)!s}, "
                f"disregarded_entity={(self.disregarded_entity
                     if hasattr(self, 'disregarded_entity') else None)!s}, "
                f"disregarded_entity_tin={(self.disregarded_entity_tin
                     if hasattr(self, 'disregarded_entity_tin') else None)!s}, "
                f"disregarded_entity_name={(self.disregarded_entity_name
                     if hasattr(self, 'disregarded_entity_name') else None)!s}, "
                f"entity_type={(self.entity_type
                     if hasattr(self, 'entity_type') else None)!s}, "
                f"retirement_plan={(self.retirement_plan
                     if hasattr(self, 'retirement_plan') else None)!s}, "
                f"profit_share_begin={(self.profit_share_begin
                     if hasattr(self, 'profit_share_begin') else None)!s}, "
                f"profit_share_end={(self.profit_share_end
                     if hasattr(self, 'profit_share_end') else None)!s}, "
                f"loss_share_begin={(self.loss_share_begin
                     if hasattr(self, 'loss_share_begin') else None)!s}, "
                f"loss_share_end={(self.loss_share_end
                     if hasattr(self, 'loss_share_end') else None)!s}, "
                f"capital_share_begin={(self.capital_share_begin
                     if hasattr(self, 'capital_share_begin') else None)!s}, "
                f"capital_share_end={(self.capital_share_end
                     if hasattr(self, 'capital_share_end') else None)!s}, "
                f"decrease_due_to_sale_or_exchange={(self.decrease_due_to_sale_or_exchange
                     if hasattr(self, 'decrease_due_to_sale_or_exchange') else None)!s}, "
                f"decrease_due_to_sale={(self.decrease_due_to_sale
                     if hasattr(self, 'decrease_due_to_sale') else None)!s}, "
                f"decrease_due_to_exchange={(self.decrease_due_to_exchange
                     if hasattr(self, 'decrease_due_to_exchange') else None)!s}, "
                f"nonrecourse_liability_share_begin={(self.nonrecourse_liability_share_begin
                     if hasattr(self, 'nonrecourse_liability_share_begin') else None)!s}, "
                f"nonrecourse_liability_share_end={(self.nonrecourse_liability_share_end
                     if hasattr(self, 'nonrecourse_liability_share_end') else None)!s}, "
                f"qualified_liability_share_begin={(self.qualified_liability_share_begin
                     if hasattr(self, 'qualified_liability_share_begin') else None)!s}, "
                f"qualified_liability_share_end={(self.qualified_liability_share_end
                     if hasattr(self, 'qualified_liability_share_end') else None)!s}, "
                f"recourse_liability_share_begin={(self.recourse_liability_share_begin
                     if hasattr(self, 'recourse_liability_share_begin') else None)!s}, "
                f"recourse_liability_share_end={(self.recourse_liability_share_end
                     if hasattr(self, 'recourse_liability_share_end') else None)!s}, "
                f"includes_lower_tier_liability={(self.includes_lower_tier_liability
                     if hasattr(self, 'includes_lower_tier_liability') else None)!s}, "
                f"liability_subject_to_guarantees={(self.liability_subject_to_guarantees
                     if hasattr(self, 'liability_subject_to_guarantees') else None)!s}, "
                f"capital_account_begin={(self.capital_account_begin
                     if hasattr(self, 'capital_account_begin') else None)!s}, "
                f"capital_account_contributions={(self.capital_account_contributions
                     if hasattr(self, 'capital_account_contributions') else None)!s}, "
                f"capital_account_increase={(self.capital_account_increase
                     if hasattr(self, 'capital_account_increase') else None)!s}, "
                f"capital_account_other={(self.capital_account_other
                     if hasattr(self, 'capital_account_other') else None)!s}, "
                f"capital_account_withdrawals={(self.capital_account_withdrawals
                     if hasattr(self, 'capital_account_withdrawals') else None)!s}, "
                f"capital_account_end={(self.capital_account_end
                     if hasattr(self, 'capital_account_end') else None)!s}, "
                f"built_in_gain={(self.built_in_gain
                     if hasattr(self, 'built_in_gain') else None)!s}, "
                f"unrecognized_section_704_begin={(self.unrecognized_section_704_begin
                     if hasattr(self, 'unrecognized_section_704_begin') else None)!s}, "
                f"unrecognized_section_704_end={(self.unrecognized_section_704_end
                     if hasattr(self, 'unrecognized_section_704_end') else None)!s}, "
                f"ordinary_income={(self.ordinary_income
                     if hasattr(self, 'ordinary_income') else None)!s}, "
                f"net_rental_real_estate_income={(self.net_rental_real_estate_income
                     if hasattr(self, 'net_rental_real_estate_income') else None)!s}, "
                f"other_rental_income={(self.other_rental_income
                     if hasattr(self, 'other_rental_income') else None)!s}, "
                f"guaranteed_payment_services={(self.guaranteed_payment_services
                     if hasattr(self, 'guaranteed_payment_services') else None)!s}, "
                f"guaranteed_payment_capital={(self.guaranteed_payment_capital
                     if hasattr(self, 'guaranteed_payment_capital') else None)!s}, "
                f"guaranteed_payment={(self.guaranteed_payment
                     if hasattr(self, 'guaranteed_payment') else None)!s}, "
                f"interest_income={(self.interest_income
                     if hasattr(self, 'interest_income') else None)!s}, "
                f"ordinary_dividends={(self.ordinary_dividends
                     if hasattr(self, 'ordinary_dividends') else None)!s}, "
                f"qualified_dividends={(self.qualified_dividends
                     if hasattr(self, 'qualified_dividends') else None)!s}, "
                f"dividend_equivalents={(self.dividend_equivalents
                     if hasattr(self, 'dividend_equivalents') else None)!s}, "
                f"royalties={(self.royalties
                     if hasattr(self, 'royalties') else None)!s}, "
                f"net_short_term_gain={(self.net_short_term_gain
                     if hasattr(self, 'net_short_term_gain') else None)!s}, "
                f"net_long_term_gain={(self.net_long_term_gain
                     if hasattr(self, 'net_long_term_gain') else None)!s}, "
                f"collectibles_gain={(self.collectibles_gain
                     if hasattr(self, 'collectibles_gain') else None)!s}, "
                f"unrecaptured_1250_gain={(self.unrecaptured_1250_gain
                     if hasattr(self, 'unrecaptured_1250_gain') else None)!s}, "
                f"net_1231_gain={(self.net_1231_gain
                     if hasattr(self, 'net_1231_gain') else None)!s}, "
                f"other_income={(self.other_income
                     if hasattr(self, 'other_income') else None)!s}, "
                f"section_179_deduction={(self.section_179_deduction
                     if hasattr(self, 'section_179_deduction') else None)!s}, "
                f"other_deductions={(self.other_deductions
                     if hasattr(self, 'other_deductions') else None)!s}, "
                f"self_employment={(self.self_employment
                     if hasattr(self, 'self_employment') else None)!s}, "
                f"credits={(self.credits
                     if hasattr(self, 'credits') else None)!s}, "
                f"schedule_k_3={(self.schedule_k_3
                     if hasattr(self, 'schedule_k_3') else None)!s}, "
                f"amt_items={(self.amt_items
                     if hasattr(self, 'amt_items') else None)!s}, "
                f"tax_exempt_income={(self.tax_exempt_income
                     if hasattr(self, 'tax_exempt_income') else None)!s}, "
                f"distributions={(self.distributions
                     if hasattr(self, 'distributions') else None)!s}, "
                f"other_info={(self.other_info
                     if hasattr(self, 'other_info') else None)!s}, "
                f"foreign_tax_paid={(self.foreign_tax_paid
                     if hasattr(self, 'foreign_tax_paid') else None)!s}, "
                f"multiple_at_risk_activities={(self.multiple_at_risk_activities
                     if hasattr(self, 'multiple_at_risk_activities') else None)!s}, "
                f"multiple_passive_activities={(self.multiple_passive_activities
                     if hasattr(self, 'multiple_passive_activities') else None)!s}, "
