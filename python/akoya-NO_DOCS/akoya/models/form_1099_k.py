...
from akoya.models.telephone_number_plus_extension import (
...
class Form1099K(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form1099K instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("links") is not None:
            ...
            links = APIHelper.SKIP
        payment_settlement_entity =\
            dictionary.get("paymentSettlementEntity")\
            if "paymentSettlementEntity" in dictionary.keys() else APIHelper.SKIP
        electronic_payment_facilitator =\
            dictionary.get("electronicPaymentFacilitator")\
            if "electronicPaymentFacilitator" in dictionary.keys() else APIHelper.SKIP
        payment_card =\
            dictionary.get("paymentCard")\
            if "paymentCard" in dictionary.keys() else APIHelper.SKIP
        third_party_network =\
            dictionary.get("thirdPartyNetwork")\
            if "thirdPartyNetwork" in dictionary.keys() else APIHelper.SKIP
        pse_name =\
            dictionary.get("pseName")\
            if dictionary.get("pseName") else APIHelper.SKIP
        pse_phone = TelephoneNumberPlusExtension.from_dictionary(
            dictionary.get("psePhone"))\
            if "psePhone" in dictionary.keys() else APIHelper.SKIP
        account_number =\
            dictionary.get("accountNumber")\
            if dictionary.get("accountNumber") else APIHelper.SKIP
        gross_amount =\
            dictionary.get("grossAmount")\
            if dictionary.get("grossAmount") else APIHelper.SKIP
        card_not_present =\
            dictionary.get("cardNotPresent")\
            if dictionary.get("cardNotPresent") else APIHelper.SKIP
        merchant_category_code =\
            dictionary.get("merchantCategoryCode")\
            if dictionary.get("merchantCategoryCode") else APIHelper.SKIP
        number_of_transactions =\
            dictionary.get("numberOfTransactions")\
            if dictionary.get("numberOfTransactions") else APIHelper.SKIP
        federal_tax_withheld =\
        ...
        if dictionary.get("monthAmounts") is not None:
            month_amounts = [
                MonthAndAmount.from_dictionary(x)
                    for x in dictionary.get("monthAmounts")
            ]
        else:
            month_amounts = APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"payment_settlement_entity={(self.payment_settlement_entity
                     if hasattr(self, 'payment_settlement_entity') else None)!r}, "
                f"electronic_payment_facilitator={(self.electronic_payment_facilitator
                     if hasattr(self, 'electronic_payment_facilitator') else None)!r}, "
                f"payment_card={(self.payment_card
                     if hasattr(self, 'payment_card') else None)!r}, "
                f"third_party_network={(self.third_party_network
                     if hasattr(self, 'third_party_network') else None)!r}, "
                f"pse_name={(self.pse_name
                     if hasattr(self, 'pse_name') else None)!r}, "
                f"pse_phone={(self.pse_phone
                     if hasattr(self, 'pse_phone') else None)!r}, "
                ...
                f"card_not_present={(self.card_not_present
                     if hasattr(self, 'card_not_present') else None)!r}, "
                f"merchant_category_code={(self.merchant_category_code
                     if hasattr(self, 'merchant_category_code') else None)!r}, "
                f"number_of_transactions={(self.number_of_transactions
                     if hasattr(self, 'number_of_transactions') else None)!r}, "
                f"federal_tax_withheld={(self.federal_tax_withheld
                     if hasattr(self, 'federal_tax_withheld') else None)!r}, "
                f"month_amounts={(self.month_amounts
                     if hasattr(self, 'month_amounts') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"payment_settlement_entity={(self.payment_settlement_entity
                     if hasattr(self, 'payment_settlement_entity') else None)!s}, "
                f"electronic_payment_facilitator={(self.electronic_payment_facilitator
                     if hasattr(self, 'electronic_payment_facilitator') else None)!s}, "
                f"payment_card={(self.payment_card
                     if hasattr(self, 'payment_card') else None)!s}, "
                f"third_party_network={(self.third_party_network
                     if hasattr(self, 'third_party_network') else None)!s}, "
                f"pse_name={(self.pse_name
                     if hasattr(self, 'pse_name') else None)!s}, "
                f"pse_phone={(self.pse_phone
                     if hasattr(self, 'pse_phone') else None)!s}, "
                f"account_number={(self.account_number
                     if hasattr(self, 'account_number') else None)!s}, "
                f"gross_amount={(self.gross_amount
                     if hasattr(self, 'gross_amount') else None)!s}, "
                f"card_not_present={(self.card_not_present
                     if hasattr(self, 'card_not_present') else None)!s}, "
                f"merchant_category_code={(self.merchant_category_code
                     if hasattr(self, 'merchant_category_code') else None)!s}, "
                f"number_of_transactions={(self.number_of_transactions
                     if hasattr(self, 'number_of_transactions') else None)!s}, "
                f"federal_tax_withheld={(self.federal_tax_withheld
                     if hasattr(self, 'federal_tax_withheld') else None)!s}, "
                f"month_amounts={(self.month_amounts
                     if hasattr(self, 'month_amounts') else None)!s}, "
                f"state_and_local={(self.state_and_local
