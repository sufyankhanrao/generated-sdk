...
class MutualFundSecurityEntity(object):
    ...
    def __init__(self,
        ...
        """Initialize a MutualFundSecurityEntity instance."""
        ...
        if yield_as_of_date is not APIHelper.SKIP:
            self.yield_as_of_date =\
                 APIHelper.apply_datetime_converter(
                yield_as_of_date, APIHelper.RFC3339DateTime) if yield_as_of_date else None
    ...
    def from_dictionary(cls,
        ...
        mutual_fund_type =\
            dictionary.get("mutualFundType")\
            if dictionary.get("mutualFundType") else APIHelper.SKIP
        units_street =\
            dictionary.get("unitsStreet")\
            if dictionary.get("unitsStreet") else APIHelper.SKIP
        units_user =\
            dictionary.get("unitsUser")\
            if dictionary.get("unitsUser") else APIHelper.SKIP
        reinvest_dividends =\
            dictionary.get("reinvestDividends")\
            if "reinvestDividends" in dictionary.keys() else APIHelper.SKIP
        reinvest_capital_gains =\
            dictionary.get("reinvestCapitalGains")\
            if "reinvestCapitalGains" in dictionary.keys() else APIHelper.SKIP
        myield =\
            dictionary.get("yield")\
            if dictionary.get("yield") else APIHelper.SKIP
        yield_as_of_date = APIHelper.RFC3339DateTime.from_value(
            dictionary.get("yieldAsOfDate")).datetime\
            if dictionary.get("yieldAsOfDate") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"mutual_fund_type={(self.mutual_fund_type
                     if hasattr(self, 'mutual_fund_type') else None)!r}, "
                f"units_street={(self.units_street
                     if hasattr(self, 'units_street') else None)!r}, "
                f"units_user={(self.units_user
                     if hasattr(self, 'units_user') else None)!r}, "
                f"reinvest_dividends={(self.reinvest_dividends
                     if hasattr(self, 'reinvest_dividends') else None)!r}, "
                f"reinvest_capital_gains={(self.reinvest_capital_gains
                     if hasattr(self, 'reinvest_capital_gains') else None)!r}, "
                f"myield={(self.myield if hasattr(self, 'myield') else None)!r}, "
                f"yield_as_of_date={(self.yield_as_of_date
                     if hasattr(self, 'yield_as_of_date') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                f"mutual_fund_type={(self.mutual_fund_type
                     if hasattr(self, 'mutual_fund_type') else None)!s}, "
                f"units_street={(self.units_street
                     if hasattr(self, 'units_street') else None)!s}, "
                f"units_user={(self.units_user
                     if hasattr(self, 'units_user') else None)!s}, "
                f"reinvest_dividends={(self.reinvest_dividends
                     if hasattr(self, 'reinvest_dividends') else None)!s}, "
                f"reinvest_capital_gains={(self.reinvest_capital_gains
                     if hasattr(self, 'reinvest_capital_gains') else None)!s}, "
                f"myield={(self.myield if hasattr(self, 'myield') else None)!s}, "
                f"yield_as_of_date={(self.yield_as_of_date
                     if hasattr(self, 'yield_as_of_date') else None)!s}, "
