...
class Form1099C(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form1099C instance."""
    ...
    def from_dictionary(cls,
        ...
        date_of_event = dateutil.parser.parse(dictionary.get("dateOfEvent")).date()\
            if dictionary.get("dateOfEvent") else APIHelper.SKIP
        amount_discharged =\
            dictionary.get("amountDischarged")\
            if dictionary.get("amountDischarged") else APIHelper.SKIP
        interest_included =\
            dictionary.get("interestIncluded")\
            if dictionary.get("interestIncluded") else APIHelper.SKIP
        debt_description =\
            dictionary.get("debtDescription")\
            if dictionary.get("debtDescription") else APIHelper.SKIP
        personally_liable =\
            dictionary.get("personallyLiable")\
            if "personallyLiable" in dictionary.keys() else APIHelper.SKIP
        debt_code =\
            dictionary.get("debtCode")\
            if dictionary.get("debtCode") else APIHelper.SKIP
        fair_market_value =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"date_of_event={(self.date_of_event
                     if hasattr(self, 'date_of_event') else None)!r}, "
                f"amount_discharged={(self.amount_discharged
                     if hasattr(self, 'amount_discharged') else None)!r}, "
                f"interest_included={(self.interest_included
                     if hasattr(self, 'interest_included') else None)!r}, "
                f"debt_description={(self.debt_description
                     if hasattr(self, 'debt_description') else None)!r}, "
                f"personally_liable={(self.personally_liable
                     if hasattr(self, 'personally_liable') else None)!r}, "
                f"debt_code={(self.debt_code
                     if hasattr(self, 'debt_code') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"date_of_event={(self.date_of_event
                     if hasattr(self, 'date_of_event') else None)!s}, "
                f"amount_discharged={(self.amount_discharged
                     if hasattr(self, 'amount_discharged') else None)!s}, "
                f"interest_included={(self.interest_included
                     if hasattr(self, 'interest_included') else None)!s}, "
                f"debt_description={(self.debt_description
                     if hasattr(self, 'debt_description') else None)!s}, "
                f"personally_liable={(self.personally_liable
                     if hasattr(self, 'personally_liable') else None)!s}, "
                f"debt_code={(self.debt_code
                     if hasattr(self, 'debt_code') else None)!s}, "
                f"fair_market_value={(self.fair_market_value
