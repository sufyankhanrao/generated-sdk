...
class TaxStatement(object):
    ...
    def __init__(self,
        ...
        """Initialize a TaxStatement instance."""
    ...
    def from_dictionary(cls,
        ...
        tax_statement_id =\
            dictionary.get("taxStatementId")\
            if dictionary.get("taxStatementId") else APIHelper.SKIP
        ...
        tax_data_type =\
            dictionary.get("taxDataType")\
            if dictionary.get("taxDataType") else APIHelper.SKIP
        forms = None
        if dictionary.get("forms") is not None:
            forms = [
                TaxData.from_dictionary(x)
                    for x in dictionary.get("forms")
            ]
        else:
            forms = APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"tax_statement_id={(self.tax_statement_id
                     if hasattr(self, 'tax_statement_id') else None)!r}, "
                f"issuer={(self.issuer if hasattr(self, 'issuer') else None)!r}, "
                f"recipient={(self.recipient
                     if hasattr(self, 'recipient') else None)!r}, "
                f"tax_data_type={(self.tax_data_type
                     if hasattr(self, 'tax_data_type') else None)!r}, "
