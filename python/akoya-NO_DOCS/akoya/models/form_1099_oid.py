...
class Form1099Oid(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form1099Oid instance."""
    ...
    def from_dictionary(cls,
        ...
        original_issue_discount =\
            dictionary.get("originalIssueDiscount")\
            if dictionary.get("originalIssueDiscount") else APIHelper.SKIP
        other_periodic_interest =\
            dictionary.get("otherPeriodicInterest")\
            if dictionary.get("otherPeriodicInterest") else APIHelper.SKIP
        early_withdrawal_penalty =\
        ...
        acquisition_premium =\
            dictionary.get("acquisitionPremium")\
            if dictionary.get("acquisitionPremium") else APIHelper.SKIP
        oid_description =\
            dictionary.get("oidDescription")\
            if dictionary.get("oidDescription") else APIHelper.SKIP
        discount_on_treasury_obligations =\
            dictionary.get("discountOnTreasuryObligations")\
            if dictionary.get("discountOnTreasuryObligations") else APIHelper.SKIP
        investment_expenses =\
        ...
        tax_exempt_oid =\
            dictionary.get("taxExemptOid")\
            if dictionary.get("taxExemptOid") else APIHelper.SKIP
        ...
        if dictionary.get("stateExemptOid") is not None:
            state_exempt_oid = [
                DescriptionAndAmount.from_dictionary(x)
                    for x in dictionary.get("stateExemptOid")
            ]
        else:
            state_exempt_oid = APIHelper.SKIP
        second_tin_notice =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"original_issue_discount={(self.original_issue_discount
                     if hasattr(self, 'original_issue_discount') else None)!r}, "
                f"other_periodic_interest={(self.other_periodic_interest
                     if hasattr(self, 'other_periodic_interest') else None)!r}, "
                ...
                f"acquisition_premium={(self.acquisition_premium
                     if hasattr(self, 'acquisition_premium') else None)!r}, "
                f"oid_description={(self.oid_description
                     if hasattr(self, 'oid_description') else None)!r}, "
                f"discount_on_treasury_obligations={(self.discount_on_treasury_obligations
                     if hasattr(self, 'discount_on_treasury_obligations') else None)!r}, "
                ...
                f"tax_exempt_oid={(self.tax_exempt_oid
                     if hasattr(self, 'tax_exempt_oid') else None)!r}, "
                f"state_and_local={(self.state_and_local
                     if hasattr(self, 'state_and_local') else None)!r}, "
                f"state_exempt_oid={(self.state_exempt_oid
                     if hasattr(self, 'state_exempt_oid') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"original_issue_discount={(self.original_issue_discount
                     if hasattr(self, 'original_issue_discount') else None)!s}, "
                f"other_periodic_interest={(self.other_periodic_interest
                     if hasattr(self, 'other_periodic_interest') else None)!s}, "
                f"early_withdrawal_penalty={(self.early_withdrawal_penalty
                ...
                f"acquisition_premium={(self.acquisition_premium
                     if hasattr(self, 'acquisition_premium') else None)!s}, "
                f"oid_description={(self.oid_description
                     if hasattr(self, 'oid_description') else None)!s}, "
                f"discount_on_treasury_obligations={(self.discount_on_treasury_obligations
                     if hasattr(self, 'discount_on_treasury_obligations') else None)!s}, "
                f"investment_expenses={(self.investment_expenses
                     if hasattr(self, 'investment_expenses') else None)!s}, "
                f"bond_premium={(self.bond_premium
                     if hasattr(self, 'bond_premium') else None)!s}, "
                f"tax_exempt_oid={(self.tax_exempt_oid
                     if hasattr(self, 'tax_exempt_oid') else None)!s}, "
                f"state_and_local={(self.state_and_local
                     if hasattr(self, 'state_and_local') else None)!s}, "
                f"state_exempt_oid={(self.state_exempt_oid
                     if hasattr(self, 'state_exempt_oid') else None)!s}, "
                f"second_tin_notice={(self.second_tin_notice
