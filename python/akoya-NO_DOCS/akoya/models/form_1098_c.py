...
class Form1098C(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form1098C instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("links") is not None:
            ...
            links = APIHelper.SKIP
        date_of_contribution = dateutil.parser.parse(dictionary.get("dateOfContribution")).date()\
            if dictionary.get("dateOfContribution") else APIHelper.SKIP
        odometer_mileage =\
            dictionary.get("odometerMileage")\
            if dictionary.get("odometerMileage") else APIHelper.SKIP
        car_year =\
            dictionary.get("carYear")\
            if dictionary.get("carYear") else APIHelper.SKIP
        make =\
            dictionary.get("make")\
        ...
        arms_length_transaction =\
            dictionary.get("armsLengthTransaction")\
            if "armsLengthTransaction" in dictionary.keys() else APIHelper.SKIP
        date_of_sale = dateutil.parser.parse(dictionary.get("dateOfSale")).date()\
            if dictionary.get("dateOfSale") else APIHelper.SKIP
        gross_proceeds =\
            dictionary.get("grossProceeds")\
            if dictionary.get("grossProceeds") else APIHelper.SKIP
        not_transferred_before =\
            dictionary.get("notTransferredBefore")\
            if "notTransferredBefore" in dictionary.keys() else APIHelper.SKIP
        needy_individual =\
            dictionary.get("needyIndividual")\
            if "needyIndividual" in dictionary.keys() else APIHelper.SKIP
        description_of_improvements =\
            dictionary.get("descriptionOfImprovements")\
            if dictionary.get("descriptionOfImprovements") else APIHelper.SKIP
        goods_in_exchange =\
            dictionary.get("goodsInExchange")\
            if "goodsInExchange" in dictionary.keys() else APIHelper.SKIP
        value_of_exchange =\
            dictionary.get("valueOfExchange")\
            if dictionary.get("valueOfExchange") else APIHelper.SKIP
        intangible_religious =\
            dictionary.get("intangibleReligious")\
            if "intangibleReligious" in dictionary.keys() else APIHelper.SKIP
        description_of_goods =\
            dictionary.get("descriptionOfGoods")\
            if dictionary.get("descriptionOfGoods") else APIHelper.SKIP
        max_deduction_applies =\
            dictionary.get("maxDeductionApplies")\
            if "maxDeductionApplies" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"date_of_contribution={(self.date_of_contribution
                     if hasattr(self, 'date_of_contribution') else None)!r}, "
                f"odometer_mileage={(self.odometer_mileage
                     if hasattr(self, 'odometer_mileage') else None)!r}, "
                f"car_year={(self.car_year
                     if hasattr(self, 'car_year') else None)!r}, "
                ...
                f"arms_length_transaction={(self.arms_length_transaction
                     if hasattr(self, 'arms_length_transaction') else None)!r}, "
                f"date_of_sale={(self.date_of_sale
                     if hasattr(self, 'date_of_sale') else None)!r}, "
                f"gross_proceeds={(self.gross_proceeds
                     if hasattr(self, 'gross_proceeds') else None)!r}, "
                f"not_transferred_before={(self.not_transferred_before
                     if hasattr(self, 'not_transferred_before') else None)!r}, "
                f"needy_individual={(self.needy_individual
                     if hasattr(self, 'needy_individual') else None)!r}, "
                f"description_of_improvements={(self.description_of_improvements
                     if hasattr(self, 'description_of_improvements') else None)!r}, "
                f"goods_in_exchange={(self.goods_in_exchange
                     if hasattr(self, 'goods_in_exchange') else None)!r}, "
                f"value_of_exchange={(self.value_of_exchange
                     if hasattr(self, 'value_of_exchange') else None)!r}, "
                f"intangible_religious={(self.intangible_religious
                     if hasattr(self, 'intangible_religious') else None)!r}, "
                f"description_of_goods={(self.description_of_goods
                     if hasattr(self, 'description_of_goods') else None)!r}, "
                f"max_deduction_applies={(self.max_deduction_applies
                     if hasattr(self, 'max_deduction_applies') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"date_of_contribution={(self.date_of_contribution
                     if hasattr(self, 'date_of_contribution') else None)!s}, "
                f"odometer_mileage={(self.odometer_mileage
                     if hasattr(self, 'odometer_mileage') else None)!s}, "
                f"car_year={(self.car_year
                     if hasattr(self, 'car_year') else None)!s}, "
                ...
                f"arms_length_transaction={(self.arms_length_transaction
                     if hasattr(self, 'arms_length_transaction') else None)!s}, "
                f"date_of_sale={(self.date_of_sale
                     if hasattr(self, 'date_of_sale') else None)!s}, "
                f"gross_proceeds={(self.gross_proceeds
                     if hasattr(self, 'gross_proceeds') else None)!s}, "
                f"not_transferred_before={(self.not_transferred_before
                     if hasattr(self, 'not_transferred_before') else None)!s}, "
                f"needy_individual={(self.needy_individual
                     if hasattr(self, 'needy_individual') else None)!s}, "
                f"description_of_improvements={(self.description_of_improvements
                     if hasattr(self, 'description_of_improvements') else None)!s}, "
                f"goods_in_exchange={(self.goods_in_exchange
                     if hasattr(self, 'goods_in_exchange') else None)!s}, "
                f"value_of_exchange={(self.value_of_exchange
                     if hasattr(self, 'value_of_exchange') else None)!s}, "
                f"intangible_religious={(self.intangible_religious
                     if hasattr(self, 'intangible_religious') else None)!s}, "
                f"description_of_goods={(self.description_of_goods
                     if hasattr(self, 'description_of_goods') else None)!s}, "
                f"max_deduction_applies={(self.max_deduction_applies
                     if hasattr(self, 'max_deduction_applies') else None)!s}, "
