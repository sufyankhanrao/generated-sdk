...
from akoya.models.fi_attribute_entity import (
    FiAttributeEntity,
)
...
class InvestmentTransaction(object):
    ...
    def __init__(self,
        ...
        """Initialize a InvestmentTransaction instance."""
        ...
        if posted_timestamp is not APIHelper.SKIP:
            self.posted_timestamp =\
                 APIHelper.apply_datetime_converter(
                posted_timestamp, APIHelper.RFC3339DateTime) if posted_timestamp else None
        ...
        if transaction_timestamp is not APIHelper.SKIP:
            self.transaction_timestamp =\
                 APIHelper.apply_datetime_converter(
                transaction_timestamp, APIHelper.RFC3339DateTime) if transaction_timestamp else None
    ...
    def from_dictionary(cls,
        ...
        debit_credit_memo =\
            dictionary.get("debitCreditMemo")\
            if dictionary.get("debitCreditMemo") else APIHelper.SKIP
        description =\
            dictionary.get("description")\
            if dictionary.get("description") else APIHelper.SKIP
        image_ids =\
            dictionary.get("imageIds")\
            if dictionary.get("imageIds") else APIHelper.SKIP
        fi_attributes = None
        if dictionary.get("fiAttributes") is not None:
            fi_attributes = [
                FiAttributeEntity.from_dictionary(x)
                    for x in dictionary.get("fiAttributes")
            ]
        else:
            fi_attributes = APIHelper.SKIP
        foreign_amount =\
            dictionary.get("foreignAmount")\
            if dictionary.get("foreignAmount") else APIHelper.SKIP
        foreign_currency =\
            dictionary.get("foreignCurrency")\
            if dictionary.get("foreignCurrency") else APIHelper.SKIP
        line_item = None
        if dictionary.get("lineItem") is not None:
            line_item = [
                LineItem.from_dictionary(x)
                    for x in dictionary.get("lineItem")
            ]
        else:
            line_item = APIHelper.SKIP
        links = None
        ...
        posted_timestamp = APIHelper.RFC3339DateTime.from_value(
            dictionary.get("postedTimestamp")).datetime\
            if dictionary.get("postedTimestamp") else APIHelper.SKIP
        reference =\
            dictionary.get("reference")\
            if dictionary.get("reference") else APIHelper.SKIP
        reference_transaction_id =\
            dictionary.get("referenceTransactionId")\
            if dictionary.get("referenceTransactionId") else APIHelper.SKIP
        status =\
            dictionary.get("status")\
            if dictionary.get("status") else APIHelper.SKIP
        sub_category =\
            dictionary.get("subCategory")\
            if dictionary.get("subCategory") else APIHelper.SKIP
        transaction_id =\
        ...
        transaction_timestamp = APIHelper.RFC3339DateTime.from_value(
            dictionary.get("transactionTimestamp")).datetime\
            if dictionary.get("transactionTimestamp") else APIHelper.SKIP
        accrued_interest =\
            dictionary.get("accruedInterest")\
            if dictionary.get("accruedInterest") else APIHelper.SKIP
        commission =\
            dictionary.get("commission")\
            if dictionary.get("commission") else APIHelper.SKIP
        confirmation_number =\
            dictionary.get("confirmationNumber")\
            if dictionary.get("confirmationNumber") else APIHelper.SKIP
        face_value =\
            dictionary.get("faceValue")\
            if dictionary.get("faceValue") else APIHelper.SKIP
        fees =\
            dictionary.get("fees")\
            if dictionary.get("fees") else APIHelper.SKIP
        fractional_cash =\
            dictionary.get("fractionalCash")\
            if dictionary.get("fractionalCash") else APIHelper.SKIP
        gain =\
            dictionary.get("gain")\
            if dictionary.get("gain") else APIHelper.SKIP
        income_type =\
            dictionary.get("incomeType")\
            if dictionary.get("incomeType") else APIHelper.SKIP
        inv_401_k_source =\
            dictionary.get("inv401kSource")\
            if dictionary.get("inv401kSource") else APIHelper.SKIP
        load =\
            dictionary.get("load")\
            if dictionary.get("load") else APIHelper.SKIP
        loan_id =\
            dictionary.get("loanId")\
            if dictionary.get("loanId") else APIHelper.SKIP
        loan_interest =\
            dictionary.get("loanInterest")\
            if dictionary.get("loanInterest") else APIHelper.SKIP
        loan_principal =\
            dictionary.get("loanPrincipal")\
            if dictionary.get("loanPrincipal") else APIHelper.SKIP
        markup =\
            dictionary.get("markup")\
            if dictionary.get("markup") else APIHelper.SKIP
        new_units =\
            dictionary.get("newUnits")\
            if dictionary.get("newUnits") else APIHelper.SKIP
        old_units =\
            dictionary.get("oldUnits")\
            if dictionary.get("oldUnits") else APIHelper.SKIP
        payroll_date =\
            dictionary.get("payrollDate")\
            if dictionary.get("payrollDate") else APIHelper.SKIP
        penalty =\
            dictionary.get("penalty")\
            if dictionary.get("penalty") else APIHelper.SKIP
        position_type =\
            dictionary.get("positionType")\
            if dictionary.get("positionType") else APIHelper.SKIP
        price =\
            dictionary.get("price")\
            if dictionary.get("price") else APIHelper.SKIP
        prior_year_contrib =\
            dictionary.get("priorYearContrib")\
            if "priorYearContrib" in dictionary.keys() else APIHelper.SKIP
        running_balance =\
            dictionary.get("runningBalance")\
            if dictionary.get("runningBalance") else APIHelper.SKIP
        security_id =\
            dictionary.get("securityId")\
            if dictionary.get("securityId") else APIHelper.SKIP
        security_id_type =\
            dictionary.get("securityIdType")\
            if dictionary.get("securityIdType") else APIHelper.SKIP
        security_type =\
            dictionary.get("securityType")\
            if dictionary.get("securityType") else APIHelper.SKIP
        shares =\
            dictionary.get("shares")\
            if dictionary.get("shares") else APIHelper.SKIP
        split_ratio_denominator =\
            dictionary.get("splitRatioDenominator")\
            if dictionary.get("splitRatioDenominator") else APIHelper.SKIP
        split_ratio_numerator =\
            dictionary.get("splitRatioNumerator")\
            if dictionary.get("splitRatioNumerator") else APIHelper.SKIP
        state_withholding =\
            dictionary.get("stateWithholding")\
            if dictionary.get("stateWithholding") else APIHelper.SKIP
        sub_account_fund =\
            dictionary.get("subAccountFund")\
            if dictionary.get("subAccountFund") else APIHelper.SKIP
        sub_account_sec =\
            dictionary.get("subAccountSec")\
            if dictionary.get("subAccountSec") else APIHelper.SKIP
        symbol =\
            dictionary.get("symbol")\
            if dictionary.get("symbol") else APIHelper.SKIP
        taxes =\
            dictionary.get("taxes")\
            if dictionary.get("taxes") else APIHelper.SKIP
        tax_exempt =\
            dictionary.get("taxExempt")\
            if "taxExempt" in dictionary.keys() else APIHelper.SKIP
        transaction_reason =\
            dictionary.get("transactionReason")\
            if dictionary.get("transactionReason") else APIHelper.SKIP
        transaction_type =\
            dictionary.get("transactionType")\
            if dictionary.get("transactionType") else APIHelper.SKIP
        transfer_action =\
            dictionary.get("transferAction")\
            if dictionary.get("transferAction") else APIHelper.SKIP
        unit_price =\
            dictionary.get("unitPrice")\
            if dictionary.get("unitPrice") else APIHelper.SKIP
        units =\
            dictionary.get("units")\
            if dictionary.get("units") else APIHelper.SKIP
        unit_type =\
            dictionary.get("unitType")\
            if dictionary.get("unitType") else APIHelper.SKIP
        withholding =\
            dictionary.get("withholding")\
            if dictionary.get("withholding") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"debit_credit_memo={(self.debit_credit_memo
                     if hasattr(self, 'debit_credit_memo') else None)!r}, "
                f"description={(self.description
                     if hasattr(self, 'description') else None)!r}, "
                f"image_ids={(self.image_ids
                     if hasattr(self, 'image_ids') else None)!r}, "
                f"fi_attributes={(self.fi_attributes
                     if hasattr(self, 'fi_attributes') else None)!r}, "
                f"foreign_amount={(self.foreign_amount
                     if hasattr(self, 'foreign_amount') else None)!r}, "
                f"foreign_currency={(self.foreign_currency
                     if hasattr(self, 'foreign_currency') else None)!r}, "
                f"line_item={(self.line_item
                     if hasattr(self, 'line_item') else None)!r}, "
                f"links={(self.links if hasattr(self, 'links') else None)!r}, "
                f"memo={(self.memo if hasattr(self, 'memo') else None)!r}, "
                f"posted_timestamp={(self.posted_timestamp
                     if hasattr(self, 'posted_timestamp') else None)!r}, "
                f"reference={(self.reference
                     if hasattr(self, 'reference') else None)!r}, "
                f"reference_transaction_id={(self.reference_transaction_id
                     if hasattr(self, 'reference_transaction_id') else None)!r}, "
                f"status={(self.status if hasattr(self, 'status') else None)!r}, "
                f"sub_category={(self.sub_category
                     if hasattr(self, 'sub_category') else None)!r}, "
                f"transaction_id={(self.transaction_id
                     if hasattr(self, 'transaction_id') else None)!r}, "
                f"transaction_timestamp={(self.transaction_timestamp
                     if hasattr(self, 'transaction_timestamp') else None)!r}, "
                f"accrued_interest={(self.accrued_interest
                     if hasattr(self, 'accrued_interest') else None)!r}, "
                f"commission={(self.commission
                     if hasattr(self, 'commission') else None)!r}, "
                f"confirmation_number={(self.confirmation_number
                     if hasattr(self, 'confirmation_number') else None)!r}, "
                f"face_value={(self.face_value
                     if hasattr(self, 'face_value') else None)!r}, "
                f"fees={(self.fees if hasattr(self, 'fees') else None)!r}, "
                f"fractional_cash={(self.fractional_cash
                     if hasattr(self, 'fractional_cash') else None)!r}, "
                f"gain={(self.gain if hasattr(self, 'gain') else None)!r}, "
                f"income_type={(self.income_type
                     if hasattr(self, 'income_type') else None)!r}, "
                f"inv_401_k_source={(self.inv_401_k_source
                     if hasattr(self, 'inv_401_k_source') else None)!r}, "
                f"load={(self.load if hasattr(self, 'load') else None)!r}, "
                f"loan_id={(self.loan_id
                     if hasattr(self, 'loan_id') else None)!r}, "
                f"loan_interest={(self.loan_interest
                     if hasattr(self, 'loan_interest') else None)!r}, "
                f"loan_principal={(self.loan_principal
                     if hasattr(self, 'loan_principal') else None)!r}, "
                f"markup={(self.markup if hasattr(self, 'markup') else None)!r}, "
                f"new_units={(self.new_units
                     if hasattr(self, 'new_units') else None)!r}, "
                f"old_units={(self.old_units
                     if hasattr(self, 'old_units') else None)!r}, "
                f"payroll_date={(self.payroll_date
                     if hasattr(self, 'payroll_date') else None)!r}, "
                f"penalty={(self.penalty
                     if hasattr(self, 'penalty') else None)!r}, "
                f"position_type={(self.position_type
                     if hasattr(self, 'position_type') else None)!r}, "
                f"price={(self.price if hasattr(self, 'price') else None)!r}, "
                f"prior_year_contrib={(self.prior_year_contrib
                     if hasattr(self, 'prior_year_contrib') else None)!r}, "
                f"running_balance={(self.running_balance
                     if hasattr(self, 'running_balance') else None)!r}, "
                f"security_id={(self.security_id
                     if hasattr(self, 'security_id') else None)!r}, "
                f"security_id_type={(self.security_id_type
                     if hasattr(self, 'security_id_type') else None)!r}, "
                f"security_type={(self.security_type
                     if hasattr(self, 'security_type') else None)!r}, "
                f"shares={(self.shares if hasattr(self, 'shares') else None)!r}, "
                f"split_ratio_denominator={(self.split_ratio_denominator
                     if hasattr(self, 'split_ratio_denominator') else None)!r}, "
                f"split_ratio_numerator={(self.split_ratio_numerator
                     if hasattr(self, 'split_ratio_numerator') else None)!r}, "
                f"state_withholding={(self.state_withholding
                     if hasattr(self, 'state_withholding') else None)!r}, "
                f"sub_account_fund={(self.sub_account_fund
                     if hasattr(self, 'sub_account_fund') else None)!r}, "
                f"sub_account_sec={(self.sub_account_sec
                     if hasattr(self, 'sub_account_sec') else None)!r}, "
                ...
                f"transaction_reason={(self.transaction_reason
                     if hasattr(self, 'transaction_reason') else None)!r}, "
                f"transaction_type={(self.transaction_type
                     if hasattr(self, 'transaction_type') else None)!r}, "
                f"transfer_action={(self.transfer_action
                     if hasattr(self, 'transfer_action') else None)!r}, "
                ...
                f"unit_type={(self.unit_type
                     if hasattr(self, 'unit_type') else None)!r}, "
                f"withholding={(self.withholding
                     if hasattr(self, 'withholding') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"debit_credit_memo={(self.debit_credit_memo
                     if hasattr(self, 'debit_credit_memo') else None)!s}, "
                f"description={(self.description
                     if hasattr(self, 'description') else None)!s}, "
                f"image_ids={(self.image_ids
                     if hasattr(self, 'image_ids') else None)!s}, "
                f"fi_attributes={(self.fi_attributes
                     if hasattr(self, 'fi_attributes') else None)!s}, "
                f"foreign_amount={(self.foreign_amount
                     if hasattr(self, 'foreign_amount') else None)!s}, "
                f"foreign_currency={(self.foreign_currency
                     if hasattr(self, 'foreign_currency') else None)!s}, "
                f"line_item={(self.line_item
                     if hasattr(self, 'line_item') else None)!s}, "
                f"links={(self.links if hasattr(self, 'links') else None)!s}, "
                f"memo={(self.memo if hasattr(self, 'memo') else None)!s}, "
                f"posted_timestamp={(self.posted_timestamp
                     if hasattr(self, 'posted_timestamp') else None)!s}, "
                f"reference={(self.reference
                     if hasattr(self, 'reference') else None)!s}, "
                f"reference_transaction_id={(self.reference_transaction_id
                     if hasattr(self, 'reference_transaction_id') else None)!s}, "
                f"status={(self.status if hasattr(self, 'status') else None)!s}, "
                f"sub_category={(self.sub_category
                     if hasattr(self, 'sub_category') else None)!s}, "
                f"transaction_id={(self.transaction_id
                     if hasattr(self, 'transaction_id') else None)!s}, "
                f"transaction_timestamp={(self.transaction_timestamp
                     if hasattr(self, 'transaction_timestamp') else None)!s}, "
                f"accrued_interest={(self.accrued_interest
                     if hasattr(self, 'accrued_interest') else None)!s}, "
                f"commission={(self.commission
                     if hasattr(self, 'commission') else None)!s}, "
                f"confirmation_number={(self.confirmation_number
                     if hasattr(self, 'confirmation_number') else None)!s}, "
                f"face_value={(self.face_value
                     if hasattr(self, 'face_value') else None)!s}, "
                f"fees={(self.fees if hasattr(self, 'fees') else None)!s}, "
                f"fractional_cash={(self.fractional_cash
                     if hasattr(self, 'fractional_cash') else None)!s}, "
                f"gain={(self.gain if hasattr(self, 'gain') else None)!s}, "
                f"income_type={(self.income_type
                     if hasattr(self, 'income_type') else None)!s}, "
                f"inv_401_k_source={(self.inv_401_k_source
                     if hasattr(self, 'inv_401_k_source') else None)!s}, "
                f"load={(self.load if hasattr(self, 'load') else None)!s}, "
                f"loan_id={(self.loan_id
                     if hasattr(self, 'loan_id') else None)!s}, "
                f"loan_interest={(self.loan_interest
                     if hasattr(self, 'loan_interest') else None)!s}, "
                f"loan_principal={(self.loan_principal
                     if hasattr(self, 'loan_principal') else None)!s}, "
                f"markup={(self.markup if hasattr(self, 'markup') else None)!s}, "
                f"new_units={(self.new_units
                     if hasattr(self, 'new_units') else None)!s}, "
                f"old_units={(self.old_units
                     if hasattr(self, 'old_units') else None)!s}, "
                f"payroll_date={(self.payroll_date
                     if hasattr(self, 'payroll_date') else None)!s}, "
                f"penalty={(self.penalty
                     if hasattr(self, 'penalty') else None)!s}, "
                f"position_type={(self.position_type
                     if hasattr(self, 'position_type') else None)!s}, "
                f"price={(self.price if hasattr(self, 'price') else None)!s}, "
                f"prior_year_contrib={(self.prior_year_contrib
                     if hasattr(self, 'prior_year_contrib') else None)!s}, "
                f"running_balance={(self.running_balance
                     if hasattr(self, 'running_balance') else None)!s}, "
                f"security_id={(self.security_id
                     if hasattr(self, 'security_id') else None)!s}, "
                f"security_id_type={(self.security_id_type
                     if hasattr(self, 'security_id_type') else None)!s}, "
                f"security_type={(self.security_type
                     if hasattr(self, 'security_type') else None)!s}, "
                f"shares={(self.shares if hasattr(self, 'shares') else None)!s}, "
                f"split_ratio_denominator={(self.split_ratio_denominator
                     if hasattr(self, 'split_ratio_denominator') else None)!s}, "
                f"split_ratio_numerator={(self.split_ratio_numerator
                     if hasattr(self, 'split_ratio_numerator') else None)!s}, "
                f"state_withholding={(self.state_withholding
                     if hasattr(self, 'state_withholding') else None)!s}, "
                f"sub_account_fund={(self.sub_account_fund
                     if hasattr(self, 'sub_account_fund') else None)!s}, "
                f"sub_account_sec={(self.sub_account_sec
                     if hasattr(self, 'sub_account_sec') else None)!s}, "
                ...
                f"transaction_reason={(self.transaction_reason
                     if hasattr(self, 'transaction_reason') else None)!s}, "
                f"transaction_type={(self.transaction_type
                     if hasattr(self, 'transaction_type') else None)!s}, "
                f"transfer_action={(self.transfer_action
                     if hasattr(self, 'transfer_action') else None)!s}, "
                f"unit_price={(self.unit_price
                     if hasattr(self, 'unit_price') else None)!s}, "
                f"units={(self.units if hasattr(self, 'units') else None)!s}, "
                f"unit_type={(self.unit_type
                     if hasattr(self, 'unit_type') else None)!s}, "
                f"withholding={(self.withholding
                     if hasattr(self, 'withholding') else None)!s}, "
