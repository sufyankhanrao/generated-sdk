...
class FormW2C(object):
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("links") is not None:
            ...
            links = APIHelper.SKIP
        corrected_tin_or_name =\
            dictionary.get("correctedTinOrName")\
            if "correctedTinOrName" in dictionary.keys() else APIHelper.SKIP
        previous_employee_tin =\
            dictionary.get("previousEmployeeTin")\
            if dictionary.get("previousEmployeeTin") else APIHelper.SKIP
        previous_employee_name = IndividualName.from_dictionary(
            dictionary.get("previousEmployeeName"))\
            if "previousEmployeeName" in dictionary.keys() else APIHelper.SKIP
        original_w_2 = FormW2.from_dictionary(
            dictionary.get("originalW2"))\
            if "originalW2" in dictionary.keys() else APIHelper.SKIP
        corrected_w_2 = FormW2.from_dictionary(
            dictionary.get("correctedW2"))\
            if "correctedW2" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"corrected_tin_or_name={(self.corrected_tin_or_name
                     if hasattr(self, 'corrected_tin_or_name') else None)!r}, "
                f"previous_employee_tin={(self.previous_employee_tin
                     if hasattr(self, 'previous_employee_tin') else None)!r}, "
                f"previous_employee_name={(self.previous_employee_name
                     if hasattr(self, 'previous_employee_name') else None)!r}, "
                f"original_w_2={(self.original_w_2
                     if hasattr(self, 'original_w_2') else None)!r}, "
                f"corrected_w_2={(self.corrected_w_2
                     if hasattr(self, 'corrected_w_2') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"corrected_tin_or_name={(self.corrected_tin_or_name
                     if hasattr(self, 'corrected_tin_or_name') else None)!s}, "
                f"previous_employee_tin={(self.previous_employee_tin
                     if hasattr(self, 'previous_employee_tin') else None)!s}, "
                f"previous_employee_name={(self.previous_employee_name
                     if hasattr(self, 'previous_employee_name') else None)!s}, "
                f"original_w_2={(self.original_w_2
                     if hasattr(self, 'original_w_2') else None)!s}, "
                f"corrected_w_2={(self.corrected_w_2
                     if hasattr(self, 'corrected_w_2') else None)!s}, "
