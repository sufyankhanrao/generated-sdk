...
class Form1099Div(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form1099Div instance."""
    ...
    def from_dictionary(cls,
        ...
        total_capital_gain =\
            dictionary.get("totalCapitalGain")\
            if dictionary.get("totalCapitalGain") else APIHelper.SKIP
        unrecaptured_1250_gain =\
            dictionary.get("unrecaptured1250Gain")\
            if dictionary.get("unrecaptured1250Gain") else APIHelper.SKIP
        section_1202_gain =\
            dictionary.get("section1202Gain")\
            if dictionary.get("section1202Gain") else APIHelper.SKIP
        collectibles_gain =\
            dictionary.get("collectiblesGain")\
            if dictionary.get("collectiblesGain") else APIHelper.SKIP
        section_897_dividends =\
            dictionary.get("section897Dividends")\
            if dictionary.get("section897Dividends") else APIHelper.SKIP
        section_897_capital_gain =\
            dictionary.get("section897CapitalGain")\
            if dictionary.get("section897CapitalGain") else APIHelper.SKIP
        non_taxable_distribution =\
            dictionary.get("nonTaxableDistribution")\
            if dictionary.get("nonTaxableDistribution") else APIHelper.SKIP
        federal_tax_withheld =\
            dictionary.get("federalTaxWithheld")\
            if dictionary.get("federalTaxWithheld") else APIHelper.SKIP
        section_199_a_dividends =\
            dictionary.get("section199ADividends")\
            if dictionary.get("section199ADividends") else APIHelper.SKIP
        investment_expenses =\
            dictionary.get("investmentExpenses")\
            if dictionary.get("investmentExpenses") else APIHelper.SKIP
        foreign_tax_paid =\
            dictionary.get("foreignTaxPaid")\
            if dictionary.get("foreignTaxPaid") else APIHelper.SKIP
        foreign_country =\
            dictionary.get("foreignCountry")\
            if dictionary.get("foreignCountry") else APIHelper.SKIP
        cash_liquidation =\
            dictionary.get("cashLiquidation")\
            if dictionary.get("cashLiquidation") else APIHelper.SKIP
        non_cash_liquidation =\
            dictionary.get("nonCashLiquidation")\
            if dictionary.get("nonCashLiquidation") else APIHelper.SKIP
        foreign_account_tax_compliance =\
            dictionary.get("foreignAccountTaxCompliance")\
            if "foreignAccountTaxCompliance" in dictionary.keys() else APIHelper.SKIP
        tax_exempt_interest_dividend =\
            dictionary.get("taxExemptInterestDividend")\
            if dictionary.get("taxExemptInterestDividend") else APIHelper.SKIP
        specified_pab_interest_dividend =\
            dictionary.get("specifiedPabInterestDividend")\
            if dictionary.get("specifiedPabInterestDividend") else APIHelper.SKIP
        state_and_local = None
        if dictionary.get("stateAndLocal") is not None:
            state_and_local = [
                StateAndLocalTaxWithholding.from_dictionary(x)
                    for x in dictionary.get("stateAndLocal")
            ]
        else:
            state_and_local = APIHelper.SKIP
        ...
        if dictionary.get("foreignIncomes") is not None:
            foreign_incomes = [
                DescriptionAndAmount.from_dictionary(x)
                    for x in dictionary.get("foreignIncomes")
            ]
        else:
            foreign_incomes = APIHelper.SKIP
        ...
        if dictionary.get("stateTaxExemptIncomes") is not None:
            state_tax_exempt_incomes = [
                DescriptionAndAmount.from_dictionary(x)
                    for x in dictionary.get("stateTaxExemptIncomes")
            ]
        else:
            state_tax_exempt_incomes = APIHelper.SKIP
        second_tin_notice =\
            dictionary.get("secondTinNotice")\
            if "secondTinNotice" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"total_capital_gain={(self.total_capital_gain
                     if hasattr(self, 'total_capital_gain') else None)!r}, "
                f"unrecaptured_1250_gain={(self.unrecaptured_1250_gain
                     if hasattr(self, 'unrecaptured_1250_gain') else None)!r}, "
                f"section_1202_gain={(self.section_1202_gain
                     if hasattr(self, 'section_1202_gain') else None)!r}, "
                f"collectibles_gain={(self.collectibles_gain
                     if hasattr(self, 'collectibles_gain') else None)!r}, "
                f"section_897_dividends={(self.section_897_dividends
                     if hasattr(self, 'section_897_dividends') else None)!r}, "
                f"section_897_capital_gain={(self.section_897_capital_gain
                     if hasattr(self, 'section_897_capital_gain') else None)!r}, "
                f"non_taxable_distribution={(self.non_taxable_distribution
                     if hasattr(self, 'non_taxable_distribution') else None)!r}, "
                f"federal_tax_withheld={(self.federal_tax_withheld
                     if hasattr(self, 'federal_tax_withheld') else None)!r}, "
                f"section_199_a_dividends={(self.section_199_a_dividends
                     if hasattr(self, 'section_199_a_dividends') else None)!r}, "
                f"investment_expenses={(self.investment_expenses
                     if hasattr(self, 'investment_expenses') else None)!r}, "
                f"foreign_tax_paid={(self.foreign_tax_paid
                     if hasattr(self, 'foreign_tax_paid') else None)!r}, "
                f"foreign_country={(self.foreign_country
                     if hasattr(self, 'foreign_country') else None)!r}, "
                f"cash_liquidation={(self.cash_liquidation
                     if hasattr(self, 'cash_liquidation') else None)!r}, "
                f"non_cash_liquidation={(self.non_cash_liquidation
                     if hasattr(self, 'non_cash_liquidation') else None)!r}, "
                f"foreign_account_tax_compliance={(self.foreign_account_tax_compliance
                     if hasattr(self, 'foreign_account_tax_compliance') else None)!r}, "
                f"tax_exempt_interest_dividend={(self.tax_exempt_interest_dividend
                     if hasattr(self, 'tax_exempt_interest_dividend') else None)!r}, "
                f"specified_pab_interest_dividend={(self.specified_pab_interest_dividend
                     if hasattr(self, 'specified_pab_interest_dividend') else None)!r}, "
                f"state_and_local={(self.state_and_local
                     if hasattr(self, 'state_and_local') else None)!r}, "
                f"foreign_incomes={(self.foreign_incomes
                     if hasattr(self, 'foreign_incomes') else None)!r}, "
                f"state_tax_exempt_incomes={(self.state_tax_exempt_incomes
                     if hasattr(self, 'state_tax_exempt_incomes') else None)!r}, "
                f"second_tin_notice={(self.second_tin_notice
                     if hasattr(self, 'second_tin_notice') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"total_capital_gain={(self.total_capital_gain
                     if hasattr(self, 'total_capital_gain') else None)!s}, "
                f"unrecaptured_1250_gain={(self.unrecaptured_1250_gain
                     if hasattr(self, 'unrecaptured_1250_gain') else None)!s}, "
                f"section_1202_gain={(self.section_1202_gain
                     if hasattr(self, 'section_1202_gain') else None)!s}, "
                f"collectibles_gain={(self.collectibles_gain
                     if hasattr(self, 'collectibles_gain') else None)!s}, "
                f"section_897_dividends={(self.section_897_dividends
                     if hasattr(self, 'section_897_dividends') else None)!s}, "
                f"section_897_capital_gain={(self.section_897_capital_gain
                     if hasattr(self, 'section_897_capital_gain') else None)!s}, "
                f"non_taxable_distribution={(self.non_taxable_distribution
                     if hasattr(self, 'non_taxable_distribution') else None)!s}, "
                f"federal_tax_withheld={(self.federal_tax_withheld
                     if hasattr(self, 'federal_tax_withheld') else None)!s}, "
                f"section_199_a_dividends={(self.section_199_a_dividends
                     if hasattr(self, 'section_199_a_dividends') else None)!s}, "
                f"investment_expenses={(self.investment_expenses
                     if hasattr(self, 'investment_expenses') else None)!s}, "
                f"foreign_tax_paid={(self.foreign_tax_paid
                     if hasattr(self, 'foreign_tax_paid') else None)!s}, "
                f"foreign_country={(self.foreign_country
                     if hasattr(self, 'foreign_country') else None)!s}, "
                f"cash_liquidation={(self.cash_liquidation
                     if hasattr(self, 'cash_liquidation') else None)!s}, "
                f"non_cash_liquidation={(self.non_cash_liquidation
                     if hasattr(self, 'non_cash_liquidation') else None)!s}, "
                f"foreign_account_tax_compliance={(self.foreign_account_tax_compliance
                     if hasattr(self, 'foreign_account_tax_compliance') else None)!s}, "
                f"tax_exempt_interest_dividend={(self.tax_exempt_interest_dividend
                     if hasattr(self, 'tax_exempt_interest_dividend') else None)!s}, "
                f"specified_pab_interest_dividend={(self.specified_pab_interest_dividend
                     if hasattr(self, 'specified_pab_interest_dividend') else None)!s}, "
                f"state_and_local={(self.state_and_local
                     if hasattr(self, 'state_and_local') else None)!s}, "
                f"foreign_incomes={(self.foreign_incomes
                     if hasattr(self, 'foreign_incomes') else None)!s}, "
                f"state_tax_exempt_incomes={(self.state_tax_exempt_incomes
                     if hasattr(self, 'state_tax_exempt_incomes') else None)!s}, "
                f"second_tin_notice={(self.second_tin_notice
                     if hasattr(self, 'second_tin_notice') else None)!s}, "
