...
class Form1098T(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form1098T instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("links") is not None:
            ...
            links = APIHelper.SKIP
        student_tin_certification =\
            dictionary.get("studentTinCertification")\
            if "studentTinCertification" in dictionary.keys() else APIHelper.SKIP
        account_number =\
            dictionary.get("accountNumber")\
            if dictionary.get("accountNumber") else APIHelper.SKIP
        half_time =\
            dictionary.get("halfTime")\
            if "halfTime" in dictionary.keys() else APIHelper.SKIP
        qualified_tuition_fees =\
            dictionary.get("qualifiedTuitionFees")\
            if dictionary.get("qualifiedTuitionFees") else APIHelper.SKIP
        adjustment_prior_year =\
            dictionary.get("adjustmentPriorYear")\
            if dictionary.get("adjustmentPriorYear") else APIHelper.SKIP
        scholarship =\
            dictionary.get("scholarship")\
            if dictionary.get("scholarship") else APIHelper.SKIP
        adjust_scholarship =\
            dictionary.get("adjustScholarship")\
            if dictionary.get("adjustScholarship") else APIHelper.SKIP
        include_jan_mar =\
            dictionary.get("includeJanMar")\
            if "includeJanMar" in dictionary.keys() else APIHelper.SKIP
        graduate =\
            dictionary.get("graduate")\
            if "graduate" in dictionary.keys() else APIHelper.SKIP
        insurance_refund =\
            dictionary.get("insuranceRefund")\
            if dictionary.get("insuranceRefund") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"student_tin_certification={(self.student_tin_certification
                     if hasattr(self, 'student_tin_certification') else None)!r}, "
                f"account_number={(self.account_number
                     if hasattr(self, 'account_number') else None)!r}, "
                f"half_time={(self.half_time
                     if hasattr(self, 'half_time') else None)!r}, "
                f"qualified_tuition_fees={(self.qualified_tuition_fees
                     if hasattr(self, 'qualified_tuition_fees') else None)!r}, "
                f"adjustment_prior_year={(self.adjustment_prior_year
                     if hasattr(self, 'adjustment_prior_year') else None)!r}, "
                f"scholarship={(self.scholarship
                     if hasattr(self, 'scholarship') else None)!r}, "
                f"adjust_scholarship={(self.adjust_scholarship
                     if hasattr(self, 'adjust_scholarship') else None)!r}, "
                f"include_jan_mar={(self.include_jan_mar
                     if hasattr(self, 'include_jan_mar') else None)!r}, "
                f"graduate={(self.graduate
                     if hasattr(self, 'graduate') else None)!r}, "
                f"insurance_refund={(self.insurance_refund
                     if hasattr(self, 'insurance_refund') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"student_tin_certification={(self.student_tin_certification
                     if hasattr(self, 'student_tin_certification') else None)!s}, "
                f"account_number={(self.account_number
                     if hasattr(self, 'account_number') else None)!s}, "
                f"half_time={(self.half_time
                     if hasattr(self, 'half_time') else None)!s}, "
                f"qualified_tuition_fees={(self.qualified_tuition_fees
                     if hasattr(self, 'qualified_tuition_fees') else None)!s}, "
                f"adjustment_prior_year={(self.adjustment_prior_year
                     if hasattr(self, 'adjustment_prior_year') else None)!s}, "
                f"scholarship={(self.scholarship
                     if hasattr(self, 'scholarship') else None)!s}, "
                f"adjust_scholarship={(self.adjust_scholarship
                     if hasattr(self, 'adjust_scholarship') else None)!s}, "
                f"include_jan_mar={(self.include_jan_mar
                     if hasattr(self, 'include_jan_mar') else None)!s}, "
                f"graduate={(self.graduate
                     if hasattr(self, 'graduate') else None)!s}, "
                f"insurance_refund={(self.insurance_refund
                     if hasattr(self, 'insurance_refund') else None)!s}, "
