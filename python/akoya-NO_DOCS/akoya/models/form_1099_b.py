...
from akoya.models.security_detail_irs_form_1099_b import (
...
class Form1099B(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form1099B instance."""
        ...
        if unrealized_profit_open_contracts_begin is not APIHelper.SKIP:
            self.unrealized_profit_open_contracts_begin =\
                 unrealized_profit_open_contracts_begin
        if unrealized_profit_open_contracts_end is not APIHelper.SKIP:
            self.unrealized_profit_open_contracts_end =\
                 unrealized_profit_open_contracts_end
    ...
    def from_dictionary(cls,
        ...
        profit_on_closed_contracts =\
            dictionary.get("profitOnClosedContracts")\
            if dictionary.get("profitOnClosedContracts") else APIHelper.SKIP
        unrealized_profit_open_contracts_begin =\
            dictionary.get("unrealizedProfitOpenContractsBegin")\
            if dictionary.get("unrealizedProfitOpenContractsBegin") else APIHelper.SKIP
        unrealized_profit_open_contracts_end =\
            dictionary.get("unrealizedProfitOpenContractsEnd")\
            if dictionary.get("unrealizedProfitOpenContractsEnd") else APIHelper.SKIP
        aggregate_profit_on_contracts =\
            dictionary.get("aggregateProfitOnContracts")\
            if dictionary.get("aggregateProfitOnContracts") else APIHelper.SKIP
        bartering =\
            dictionary.get("bartering")\
            if dictionary.get("bartering") else APIHelper.SKIP
        security_details = None
        if dictionary.get("securityDetails") is not None:
            security_details = [
                SecurityDetailIrsForm1099B.from_dictionary(x)
                    for x in dictionary.get("securityDetails")
            ]
        else:
            security_details = APIHelper.SKIP
        second_tin_notice =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"profit_on_closed_contracts={(self.profit_on_closed_contracts
                     if hasattr(self, 'profit_on_closed_contracts') else None)!r}, "
                f"unrealized_profit_open_contracts_begin={(self.unrealized_profit_open_contracts_begin
                     if hasattr(self, 'unrealized_profit_open_contracts_begin') else None)!r}, "
                f"unrealized_profit_open_contracts_end={(self.unrealized_profit_open_contracts_end
                     if hasattr(self, 'unrealized_profit_open_contracts_end') else None)!r}, "
                f"aggregate_profit_on_contracts={(self.aggregate_profit_on_contracts
                     if hasattr(self, 'aggregate_profit_on_contracts') else None)!r}, "
                f"bartering={(self.bartering
                     if hasattr(self, 'bartering') else None)!r}, "
                f"security_details={(self.security_details
                     if hasattr(self, 'security_details') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"profit_on_closed_contracts={(self.profit_on_closed_contracts
                     if hasattr(self, 'profit_on_closed_contracts') else None)!s}, "
                f"unrealized_profit_open_contracts_begin={(self.unrealized_profit_open_contracts_begin
                     if hasattr(self, 'unrealized_profit_open_contracts_begin') else None)!s}, "
                f"unrealized_profit_open_contracts_end={(self.unrealized_profit_open_contracts_end
                     if hasattr(self, 'unrealized_profit_open_contracts_end') else None)!s}, "
                f"aggregate_profit_on_contracts={(self.aggregate_profit_on_contracts
                     if hasattr(self, 'aggregate_profit_on_contracts') else None)!s}, "
                f"bartering={(self.bartering
                     if hasattr(self, 'bartering') else None)!s}, "
                f"security_details={(self.security_details
                     if hasattr(self, 'security_details') else None)!s}, "
                f"second_tin_notice={(self.second_tin_notice
