...
class Form1099G(object):
    ...
    def __init__(self,
        ...
        """Initialize a Form1099G instance."""
    ...
    def from_dictionary(cls,
        ...
        unemployment_compensation =\
            dictionary.get("unemploymentCompensation")\
            if dictionary.get("unemploymentCompensation") else APIHelper.SKIP
        tax_refund =\
            dictionary.get("taxRefund")\
            if dictionary.get("taxRefund") else APIHelper.SKIP
        refund_year =\
            dictionary.get("refundYear")\
            if dictionary.get("refundYear") else APIHelper.SKIP
        federal_tax_withheld =\
            dictionary.get("federalTaxWithheld")\
            if dictionary.get("federalTaxWithheld") else APIHelper.SKIP
        rtaa_payments =\
            dictionary.get("rtaaPayments")\
            if dictionary.get("rtaaPayments") else APIHelper.SKIP
        grants =\
            dictionary.get("grants")\
            if dictionary.get("grants") else APIHelper.SKIP
        agriculture_payments =\
            dictionary.get("agriculturePayments")\
            if dictionary.get("agriculturePayments") else APIHelper.SKIP
        business_income =\
            dictionary.get("businessIncome")\
            if "businessIncome" in dictionary.keys() else APIHelper.SKIP
        market_gain =\
            dictionary.get("marketGain")\
            if dictionary.get("marketGain") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"unemployment_compensation={(self.unemployment_compensation
                     if hasattr(self, 'unemployment_compensation') else None)!r}, "
                f"tax_refund={(self.tax_refund
                     if hasattr(self, 'tax_refund') else None)!r}, "
                f"refund_year={(self.refund_year
                     if hasattr(self, 'refund_year') else None)!r}, "
                f"federal_tax_withheld={(self.federal_tax_withheld
                     if hasattr(self, 'federal_tax_withheld') else None)!r}, "
                f"rtaa_payments={(self.rtaa_payments
                     if hasattr(self, 'rtaa_payments') else None)!r}, "
                f"grants={(self.grants if hasattr(self, 'grants') else None)!r}, "
                f"agriculture_payments={(self.agriculture_payments
                     if hasattr(self, 'agriculture_payments') else None)!r}, "
                f"business_income={(self.business_income
                     if hasattr(self, 'business_income') else None)!r}, "
                f"market_gain={(self.market_gain
                     if hasattr(self, 'market_gain') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"unemployment_compensation={(self.unemployment_compensation
                     if hasattr(self, 'unemployment_compensation') else None)!s}, "
                f"tax_refund={(self.tax_refund
                     if hasattr(self, 'tax_refund') else None)!s}, "
                f"refund_year={(self.refund_year
                     if hasattr(self, 'refund_year') else None)!s}, "
                f"federal_tax_withheld={(self.federal_tax_withheld
                     if hasattr(self, 'federal_tax_withheld') else None)!s}, "
                f"rtaa_payments={(self.rtaa_payments
                     if hasattr(self, 'rtaa_payments') else None)!s}, "
                f"grants={(self.grants if hasattr(self, 'grants') else None)!s}, "
                f"agriculture_payments={(self.agriculture_payments
                     if hasattr(self, 'agriculture_payments') else None)!s}, "
                f"business_income={(self.business_income
                     if hasattr(self, 'business_income') else None)!s}, "
                f"market_gain={(self.market_gain
                     if hasattr(self, 'market_gain') else None)!s}, "
                f"state_and_local={(self.state_and_local
