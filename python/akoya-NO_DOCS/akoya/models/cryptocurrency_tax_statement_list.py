...
from akoya.models.gain_or_loss_from_cryptocurrency_transaction import (
...
class CryptocurrencyTaxStatementList(object):
    ...
    def __init__(self,
        ...
        """Initialize a CryptocurrencyTaxStatementList instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("gainsAndLosses") is not None:
            gains_and_losses = [
                GainOrLossFromCryptocurrencyTransaction.from_dictionary(x)
                    for x in dictionary.get("gainsAndLosses")
            ]
        else:
            gains_and_losses = APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"gains_and_losses={(self.gains_and_losses
                     if hasattr(self, 'gains_and_losses') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"gains_and_losses={(self.gains_and_losses
                     if hasattr(self, 'gains_and_losses') else None)!s}, "
