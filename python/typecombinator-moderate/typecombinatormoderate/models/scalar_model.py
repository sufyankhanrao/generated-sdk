...
class ScalarModel(object):
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'outer_array={(self.outer_array if hasattr(self, "outer_array") else None)!r}, '
                f'outer_map={(self.outer_map if hasattr(self, "outer_map") else None)!r}, '
                f'inner_nullable={(self.inner_nullable if hasattr(self, "inner_nullable") else None)!r}, '
                f'inner_array_with_nullable={(self.inner_array_with_nullable if hasattr(self, "inner_array_with_nullable") else None)!r}, '
                f'inner_map_with_nullable={(self.inner_map_with_nullable if hasattr(self, "inner_map_with_nullable") else None)!r})')

    def __str__(self):
        return (f'{self.__class__.__name__}('
                f'single_inner_map={self.single_inner_map!s}, '
                f'all_inner_array={self.all_inner_array!s}, '
                f'outer_array={(self.outer_array if hasattr(self, "outer_array") else None)!s}, '
                f'outer_map={(self.outer_map if hasattr(self, "outer_map") else None)!s}, '
                f'inner_nullable={(self.inner_nullable if hasattr(self, "inner_nullable") else None)!s}, '
                f'inner_array_with_nullable={(self.inner_array_with_nullable if hasattr(self, "inner_array_with_nullable") else None)!s}, '
                f'inner_map_with_nullable={(self.inner_map_with_nullable if hasattr(self, "inner_map_with_nullable") else None)!s})')
