...
from mindbodypublicapi.http.proxy_settings import (
    ProxySettings,
)
...
class Configuration(HttpClientConfiguration):
    ...
    environments = {
        Environment.PRODUCTION: {
            Server.DEFAULT: "https://api.mindbodyonline.com",
        },
    }
    ...
    def create_auth_credentials_object(api_key,
        ...
        warnings.warn(message=("The 'api_key' params are deprecated. Use 'custo"
                               "m_header_authentication_credentials' param inst"
                               "ead."),
