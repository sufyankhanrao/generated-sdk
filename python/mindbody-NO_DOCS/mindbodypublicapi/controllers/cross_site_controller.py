...
from mindbodypublicapi.models.copy_credit_card_response import (
...
class CrossSiteController(BaseController):
    ...
    def __init__(self, config):
        """Initialize CrossSiteController object."""
        super(CrossSiteController, self).__init__(config)
    ...
    def copy_credit_card(self,
                         ...
                         site_id,
                         authorization=None):
        """Perform a POST request to /public/v{version}/crossSite/copycreditcard.

        Copies the credit card information from one client to another,
        regardless of site.
        The source and target clients must have the same email address.

        Args:
            version (str): version of the api.
            request (CopyCreditCardRequest): The request body parameter.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(CopyCreditCardResponse.from_dictionary)
