...
class PricingOptionController(BaseController):

    """A Controller to access Endpoints in the mindbodypublicapi API."""
    def __init__(self, config):
        super(PricingOptionController, self).__init__(config)
    ...
    def update_pricing_option(self,
                              ...
                              site_id,
                              authorization=None):
        """Does a POST request to /public/v{version}/pricingoption/updatepricingoption.

        Update Pricing Option data such as name, details, price, discontinued
        using PricingOptionId(product id)

        Args:
            version (str): version of the api.
            request (UpdatePricingOptionRequest): The request body parameter.
