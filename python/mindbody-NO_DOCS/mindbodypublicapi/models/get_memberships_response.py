...
from mindbodypublicapi.models.membership import Membership
...
class GetMembershipsResponse(object):
    ...
    def __init__(self,
        ...
        """Constructor for the GetMembershipsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Memberships') is not None:
            memberships = [Membership.from_dictionary(x) for x in dictionary.get('Memberships')]
        else:
            memberships = APIHelper.SKIP
