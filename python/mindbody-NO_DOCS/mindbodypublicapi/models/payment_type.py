...
class PaymentType(object):
    ...
    def from_dictionary(cls,
        ...
        payment_type_name = dictionary.get("PaymentTypeName") if dictionary.get("PaymentTypeName") else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'payment_type_name={(self.payment_type_name if hasattr(self, "payment_type_name") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'payment_type_name={(self.payment_type_name if hasattr(self, "payment_type_name") else None)!s}, '
