...
class IssueResponse(object):
    ...
    def __init__(self,
                 ...
                 user=APIHelper.SKIP):
        """Constructor for the IssueResponse class"""
        ...
        if expires is not APIHelper.SKIP:
            self.expires = APIHelper.apply_datetime_converter(expires, APIHelper.RFC3339DateTime) if expires else None 
    ...
    def from_dictionary(cls,
        ...
        expires = APIHelper.RFC3339DateTime.from_value(dictionary.get("Expires")).datetime if dictionary.get("Expires") else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'expires={(self.expires if hasattr(self, "expires") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'expires={(self.expires if hasattr(self, "expires") else None)!s}, '
