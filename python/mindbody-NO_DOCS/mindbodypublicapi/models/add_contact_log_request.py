...
from mindbodypublicapi.models.add_contact_log_type import (
    AddContactLogType,
)
...
class AddContactLogRequest(object):
    ...
    def __init__(self,
                 ...
                 test=APIHelper.SKIP):
        """Initialize a AddContactLogRequest instance."""
    ...
    def from_dictionary(cls,
        ...
        contact_method =\
            ...
            if dictionary.get("ContactMethod") else None
        assigned_to_staff_id =\
        ...
        if dictionary.get("Types") is not None:
            types = [
                AddContactLogType.from_dictionary(x)
