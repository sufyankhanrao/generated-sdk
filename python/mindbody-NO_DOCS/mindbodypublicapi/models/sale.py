...
from mindbodypublicapi.models.purchased_item import PurchasedItem
from mindbodypublicapi.models.sale_payment import SalePayment
...
class Sale(object):
    ...
    def __init__(self,
        ...
        if sale_date is not APIHelper.SKIP:
            self.sale_date = APIHelper.apply_datetime_converter(sale_date, APIHelper.RFC3339DateTime) if sale_date else None 
        ...
        if original_sale_date_time is not APIHelper.SKIP:
            self.original_sale_date_time = APIHelper.apply_datetime_converter(original_sale_date_time, APIHelper.RFC3339DateTime) if original_sale_date_time else None 
    ...
    def from_dictionary(cls,
        ...
        sale_date = APIHelper.RFC3339DateTime.from_value(dictionary.get("SaleDate")).datetime if dictionary.get("SaleDate") else APIHelper.SKIP
        sale_time = dictionary.get("SaleTime") if dictionary.get("SaleTime") else APIHelper.SKIP
        ...
        original_sale_date_time = APIHelper.RFC3339DateTime.from_value(dictionary.get("OriginalSaleDateTime")).datetime if dictionary.get("OriginalSaleDateTime") else APIHelper.SKIP
        ...
        recipient_client_id = dictionary.get("RecipientClientId") if dictionary.get("RecipientClientId") else APIHelper.SKIP
        purchased_items = None
        if dictionary.get('PurchasedItems') is not None:
            purchased_items = [PurchasedItem.from_dictionary(x) for x in dictionary.get('PurchasedItems')]
        else:
            purchased_items = APIHelper.SKIP
        ...
        if dictionary.get('Payments') is not None:
            payments = [SalePayment.from_dictionary(x) for x in dictionary.get('Payments')]
        else:
            payments = APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'sale_time={(self.sale_time if hasattr(self, "sale_time") else None)!r}, '
                f'sale_date_time={(self.sale_date_time if hasattr(self, "sale_date_time") else None)!r}, '
                f'original_sale_date_time={(self.original_sale_date_time if hasattr(self, "original_sale_date_time") else None)!r}, '
                ...
                f'recipient_client_id={(self.recipient_client_id if hasattr(self, "recipient_client_id") else None)!r}, '
                f'purchased_items={(self.purchased_items if hasattr(self, "purchased_items") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'sale_time={(self.sale_time if hasattr(self, "sale_time") else None)!s}, '
                f'sale_date_time={(self.sale_date_time if hasattr(self, "sale_date_time") else None)!s}, '
                f'original_sale_date_time={(self.original_sale_date_time if hasattr(self, "original_sale_date_time") else None)!s}, '
                ...
                f'recipient_client_id={(self.recipient_client_id if hasattr(self, "recipient_client_id") else None)!s}, '
                f'purchased_items={(self.purchased_items if hasattr(self, "purchased_items") else None)!s}, '
