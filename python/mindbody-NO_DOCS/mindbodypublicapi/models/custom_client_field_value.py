...
class CustomClientFieldValue(object):
    ...
    def __init__(self,
                 ...
                 name=APIHelper.SKIP):
        """Constructor for the CustomClientFieldValue class"""
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'data_type={(self.data_type if hasattr(self, "data_type") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'data_type={(self.data_type if hasattr(self, "data_type") else None)!s}, '
