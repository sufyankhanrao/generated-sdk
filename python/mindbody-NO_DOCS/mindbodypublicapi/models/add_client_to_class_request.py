...
class AddClientToClassRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a AddClientToClassRequest instance."""
        ...
        if cross_regional_booking_client_service_site_id is not APIHelper.SKIP:
            self.cross_regional_booking_client_service_site_id =\
                 cross_regional_booking_client_service_site_id
    ...
    def from_dictionary(cls,
        ...
        require_payment =\
            dictionary.get("RequirePayment")\
            if "RequirePayment" in dictionary.keys() else APIHelper.SKIP
        waitlist =\
        ...
        cross_regional_booking =\
            dictionary.get("CrossRegionalBooking")\
            if "CrossRegionalBooking" in dictionary.keys() else APIHelper.SKIP
        cross_regional_booking_client_service_site_id =\
            dictionary.get("CrossRegionalBookingClientServiceSiteId")\
            if dictionary.get("CrossRegionalBookingClientServiceSiteId") else APIHelper.SKIP
        unique_id =\
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"require_payment={(self.require_payment
                     if hasattr(self, 'require_payment') else None)!r}, "
                ...
                f"cross_regional_booking={(self.cross_regional_booking
                     if hasattr(self, 'cross_regional_booking') else None)!r}, "
                f"cross_regional_booking_client_service_site_id={(self.cross_regional_booking_client_service_site_id
                     if hasattr(self, 'cross_regional_booking_client_service_site_id') else None)!r}, "
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"require_payment={(self.require_payment
                     if hasattr(self, 'require_payment') else None)!s}, "
                f"waitlist={(self.waitlist
                ...
                f"cross_regional_booking={(self.cross_regional_booking
                     if hasattr(self, 'cross_regional_booking') else None)!s}, "
                f"cross_regional_booking_client_service_site_id={(self.cross_regional_booking_client_service_site_id
                     if hasattr(self, 'cross_regional_booking_client_service_site_id') else None)!s}, "
                f"unique_id={(self.unique_id
