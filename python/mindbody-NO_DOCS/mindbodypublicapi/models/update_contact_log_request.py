...
from mindbodypublicapi.models.update_contact_log_comment import UpdateContactLogComment
from mindbodypublicapi.models.update_contact_log_type import UpdateContactLogType
...
class UpdateContactLogRequest(object):
    ...
    def __init__(self,
        ...
        """Constructor for the UpdateContactLogRequest class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Comments') is not None:
            comments = [UpdateContactLogComment.from_dictionary(x) for x in dictionary.get('Comments')]
        else:
            comments = APIHelper.SKIP
        types = None
        if dictionary.get('Types') is not None:
            types = [UpdateContactLogType.from_dictionary(x) for x in dictionary.get('Types')]
        else:
            types = APIHelper.SKIP
