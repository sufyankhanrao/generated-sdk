...
class MobileProvider(object):
    ...
    def __init__(self,
        ...
        """Initialize a MobileProvider instance."""
    ...
    def from_dictionary(cls,
        ...
        provider_name =\
            ...
            if dictionary.get("ProviderName") else APIHelper.SKIP
        provider_address =\
            dictionary.get("ProviderAddress")\
            if dictionary.get("ProviderAddress") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"provider_address={(self.provider_address
                     if hasattr(self, 'provider_address') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"provider_address={(self.provider_address
                     if hasattr(self, 'provider_address') else None)!s})")
