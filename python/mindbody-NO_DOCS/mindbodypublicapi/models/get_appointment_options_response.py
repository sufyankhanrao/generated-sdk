...
from mindbodypublicapi.models.appointment_option import AppointmentOption
...
class GetAppointmentOptionsResponse(object):
    ...
    def __init__(self,
        ...
        """Constructor for the GetAppointmentOptionsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Options') is not None:
            options = [AppointmentOption.from_dictionary(x) for x in dictionary.get('Options')]
        else:
            options = APIHelper.SKIP
