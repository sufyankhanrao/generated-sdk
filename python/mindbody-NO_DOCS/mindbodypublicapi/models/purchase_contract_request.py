...
from mindbodypublicapi.models.credit_card_info import (
    CreditCardInfo,
)
from mindbodypublicapi.models.stored_card_info import (
    StoredCardInfo,
)
...
class PurchaseContractRequest(object):
    ...
    def __init__(self,
        ...
        """Initialize a PurchaseContractRequest instance."""
        ...
        if prorate_date is not APIHelper.SKIP:
            self.prorate_date =\
                 APIHelper.apply_datetime_converter(
                prorate_date, APIHelper.RFC3339DateTime) if prorate_date else None
    ...
    def from_dictionary(cls,
        ...
        contract_id =\
            ...
            if dictionary.get("ContractId") else None
        test =\
            dictionary.get("Test")\
        ...
        first_payment_occurs =\
            dictionary.get("FirstPaymentOccurs")\
            if dictionary.get("FirstPaymentOccurs") else APIHelper.SKIP
        client_signature =\
            dictionary.get("ClientSignature")\
            if dictionary.get("ClientSignature") else APIHelper.SKIP
        promotion_code =\
            dictionary.get("PromotionCode")\
            if dictionary.get("PromotionCode") else APIHelper.SKIP
        promotion_codes =\
            dictionary.get("PromotionCodes")\
            if dictionary.get("PromotionCodes") else APIHelper.SKIP
        credit_card_info = CreditCardInfo.from_dictionary(
            dictionary.get("CreditCardInfo"))\
            if "CreditCardInfo" in dictionary.keys() else APIHelper.SKIP
        stored_card_info = StoredCardInfo.from_dictionary(
            dictionary.get("StoredCardInfo"))\
            if "StoredCardInfo" in dictionary.keys() else APIHelper.SKIP
        send_notifications =\
            dictionary.get("SendNotifications")\
            if "SendNotifications" in dictionary.keys() else APIHelper.SKIP
        sales_rep_id =\
            dictionary.get("SalesRepId")\
            if dictionary.get("SalesRepId") else APIHelper.SKIP
        use_direct_debit =\
            dictionary.get("UseDirectDebit")\
            if "UseDirectDebit" in dictionary.keys() else APIHelper.SKIP
        consumer_present =\
        ...
        prorate_date = APIHelper.RFC3339DateTime.from_value(
            dictionary.get("ProrateDate")).datetime\
            if dictionary.get("ProrateDate") else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"first_payment_occurs={(self.first_payment_occurs
                     if hasattr(self, 'first_payment_occurs') else None)!r}, "
                f"client_signature={(self.client_signature
                     if hasattr(self, 'client_signature') else None)!r}, "
                f"promotion_code={(self.promotion_code
                     if hasattr(self, 'promotion_code') else None)!r}, "
                f"promotion_codes={(self.promotion_codes
                     if hasattr(self, 'promotion_codes') else None)!r}, "
                f"credit_card_info={(self.credit_card_info
                     if hasattr(self, 'credit_card_info') else None)!r}, "
                f"stored_card_info={(self.stored_card_info
                     if hasattr(self, 'stored_card_info') else None)!r}, "
                f"send_notifications={(self.send_notifications
                     if hasattr(self, 'send_notifications') else None)!r}, "
                f"sales_rep_id={(self.sales_rep_id
                     if hasattr(self, 'sales_rep_id') else None)!r}, "
                f"use_direct_debit={(self.use_direct_debit
                     if hasattr(self, 'use_direct_debit') else None)!r}, "
                ...
                f"prorate_date={(self.prorate_date
                     if hasattr(self, 'prorate_date') else None)!r})")
    ...
    def __str__(self):
        ...
        return (f"{self.__class__.__name__}("
                ...
                f"first_payment_occurs={(self.first_payment_occurs
                     if hasattr(self, 'first_payment_occurs') else None)!s}, "
                f"client_signature={(self.client_signature
                     if hasattr(self, 'client_signature') else None)!s}, "
                f"promotion_code={(self.promotion_code
                     if hasattr(self, 'promotion_code') else None)!s}, "
                f"promotion_codes={(self.promotion_codes
                     if hasattr(self, 'promotion_codes') else None)!s}, "
                f"credit_card_info={(self.credit_card_info
                     if hasattr(self, 'credit_card_info') else None)!s}, "
                f"stored_card_info={(self.stored_card_info
                     if hasattr(self, 'stored_card_info') else None)!s}, "
                f"send_notifications={(self.send_notifications
                     if hasattr(self, 'send_notifications') else None)!s}, "
                f"sales_rep_id={(self.sales_rep_id
                     if hasattr(self, 'sales_rep_id') else None)!s}, "
                f"use_direct_debit={(self.use_direct_debit
                     if hasattr(self, 'use_direct_debit') else None)!s}, "
                f"consumer_present={(self.consumer_present
                     if hasattr(self, 'consumer_present') else None)!s}, "
                f"payment_authentication_callback_url={(self.payment_authentication_callback_url
                     if hasattr(self, 'payment_authentication_callback_url') else None)!s}, "
                f"prorate_date={(self.prorate_date
                     if hasattr(self, 'prorate_date') else None)!s})")
