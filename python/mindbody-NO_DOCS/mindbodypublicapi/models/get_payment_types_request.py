...
class GetPaymentTypesRequest(object):
    ...
    """Implementation of the 'GetPaymentTypesRequest' model.

    Get Payment Types Request Model

    Attributes:
        active (bool): When `true`, the response only contains payment types
            which are activated.  When `false`, only deactivated payment types
            are returned.  Default: **All Payment Types**
    ...
    def __init__(self,
        ...
        """Constructor for the GetPaymentTypesRequest class"""
