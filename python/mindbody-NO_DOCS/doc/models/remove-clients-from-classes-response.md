...
| `classes` | [`List[Class]`](../../doc/models/class.md) | Optional | Contains information about the classes from which the clients were removed. |
| `errors` | [`List[ApiError]`](../../doc/models/api-error.md) | Optional | Contains information about the errors |
